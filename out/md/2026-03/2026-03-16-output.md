...
3. [High-Probability Bounds for SGD under the Polyak-Lojasiewicz Condition with Markovian Noise](#user-content-link3)
**Authors:** Avik Kar, Siddharth Chandak, Rahul Singh, Eric Moulines, Shalabh Bhatnagar, Nicholas Bambos

4. [Self-Indexing KVCache: Predicting Sparse Attention from Compressed Keys](#user-content-link4)
**Authors:** Xu Yang, Jiapeng Zhang, Dongyang Zhao, Guo Chen, Zhuo Tang

5. [On Interpolation Formulas Describing Neural Network Generalization](#user-content-link5)
**Authors:** Jin Guo, Roy Y. He, Jean-Michel Morel

6. [Power-Law Spectrum of the Random Feature Model](#user-content-link6)
**Authors:** Elliot Paquette, Ke Liang Xiao, Yizhe Zhu

7. [Gradient Atoms: Unsupervised Discovery, Attribution and Steering of Model Behaviors via Sparse Decomposition of Training Gradients](#user-content-link7)
**Authors:** J Rosser

8. [GradMem: Learning to Write Context into Memory with Test-Time Gradient Descent](#user-content-link8)
...
10. [Enhancing LLM Training via Spectral Clipping](#user-content-link10)
**Authors:** Xiaowen Jiang, Andrei Semenov, Sebastian U. Stich

11. [FlashHead: Efficient Drop-In Replacement for the Classification Head in Language Model Inference](#user-content-link11)
**Authors:** Wilhelm Tranheden, Shahnawaz Ahmed, Devdatt Dubhashi, Jonna Matthiesen, Hannes von Essen

12. [From Specification to Architecture: A Theory Compiler for Knowledge-Guided Machine Learning](#user-content-link12)
**Authors:** Asela Hevapathige, Yu Xia, Sachith Seneviratne, Saman Halgamuge

13. [Rigorous Asymptotics for First-Order Algorithms Through the Dynamical Cavity Method](#user-content-link13)
**Authors:** Yatin Dandi, David Gamarnik, Francisco Pernice, Lenka Zdeborová

14. [Disentangling Dynamical Systems: Causal Representation Learning Meets Local Sparse Attention](#user-content-link14)
**Authors:** Markus W. Baumgartner, Anson Lei, Joe Watson, Ingmar Posner

15. [OxyGen: Unified KV Cache Management for Vision-Language-Action Models under Multi-Task Parallelism](#user-content-link15)
**Authors:** Xiangyu Li, Huaizhi Tang, Xin Ding, Weijun Wang, Ting Cao, Yunxin Liu

16. [The Phenomenology of Hallucinations](#user-content-link16)
**Authors:** Valeria Ruscio, Keiran Thompson

17. [Sampling Boltzmann distributions via normalizing flow approximation of transport maps](#user-content-link17)
**Authors:** Zia Ur Rehman, Gero Friesecke

18. [Convergence of Two Time-Scale Stochastic Approximation: A Martingale Approach](#user-content-link18)
**Authors:** Mathukumalli Vidyasagar

19. [TMPDiff: Temporal Mixed-Precision for Diffusion Models](#user-content-link19)
**Authors:** Basile Lewandowski, Simon Kurz, Aditya Shankar, Robert Birke, Jian-Jia Chen, Lydia Y. Chen

20. [Effective Sparsity: A Unified Framework via Normalized Entropy and the Effective Number of Nonzeros](#user-content-link20)
**Authors:** Haoyu He, Hao Wang, Jiashan Wang, Hao Zeng

21. [Windowed Fourier Propagator: A Frequency-Local Neural Operator for Wave Equations in Inhomogeneous Media](#user-content-link21)
...
23. [Delightful Policy Gradient](#user-content-link23)
**Authors:** Ian Osband

24. [Solving physics-constrained inverse problems with conditional flow matching](#user-content-link24)
**Authors:** Agnimitra Dasgupta, Ali Fardisi, Mehrnegar Aminy, Brianna Binder, Bryan Shaddy, Assad Oberai

25. [Pixel-level Scene Understanding in One Token: Visual States Need What-is-Where Composition](#user-content-link25)
**Authors:** Seokmin Lee, Yunghee Lee, Byeonghyun Pak, Byeongju Woo

26. [Localizing and Editing Knowledge in Large Audio-Language Models](#user-content-link26)
**Authors:** Sung Kyun Chung, Jiaheng Dong, Qiuchi Hu, Gongping Huang, Hong Jia, Ting Dang

27. [Diffusion Reinforcement Learning via Centered Reward Distillation](#user-content-link27)
**Authors:** Yuanzhi Zhu, Xi Wang, Stéphane Lathuilière, Vicky Kalogeiton

28. [Locally Linear Continual Learning for Time Series based on VC-Theoretical Generalization Bounds](#user-content-link28)
**Authors:** Yan V. G. Ferreira, Igor B. Lima, Pedro H. G. Mapa S., Felipe V. Campos, Antonio P. Braga

29. [SVD Contextual Sparsity Predictors for Fast LLM Inference](#user-content-link29)
**Authors:** Georgii Serbin, Kirill Koshkin, Zhongao Sun, Anastasiya Bistrigova, C. C. Korikov

30. [Align Forward, Adapt Backward: Closing the Discretization Gap in Logic Gate Networks](#user-content-link30)
**Authors:** Youngsung Kim

31. [Learning to Forget: Sleep-Inspired Memory Consolidation for Resolving Proactive Interference in Large Language Models](#user-content-link31)
**Authors:** Ying Xie

32. [True 4-Bit Quantized Convolutional Neural Network Training on CPU: Achieving Full-Precision Parity](#user-content-link32)
**Authors:** Shivnath Tathe

33. [AR-Flow VAE: A Structured Autoregressive Flow Prior Variational Autoencoder for Unsupervised Blind Source Separation](#user-content-link33)
**Authors:** Yuan-Hao Wei, Fu-Hao Deng, Lin-Yong Cui, Yan-Jie Sun

34. [Is the reconstruction loss culprit? An attempt to outperform JEPA](#user-content-link34)
**Authors:** Alexey Potapov, Oleg Shcherbakov, Ivan Kravchenko

35. [Spectral Edge Dynamics of Training Trajectories: Signal--Noise Geometry Across Scales](#user-content-link35)
**Authors:** Yongzhong Xu

36. [IGU-LoRA: Adaptive Rank Allocation via Integrated Gradients and Uncertainty-Aware Scoring](#user-content-link36)
**Authors:** Xuan Cui, Huiyue Li, Run Zeng, Yunfei Zhao, Jinrui Qian, Wei Duan, Bo Liu, Zhanpeng Zhou

37. [Human-like Object Grouping in Self-supervised Vision Transformers](#user-content-link37)
**Authors:** Hossein Adeli, Seoyoung Ahn, Andrew Luo, Mengmi Zhang, Nikolaus Kriegeskorte, Gregory Zelinsky

38. [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](#user-content-link38)
**Authors:** Surendra Pathak, Bo Han

39. [WestWorld: A Knowledge-Encoded Scalable Trajectory World Model for Diverse Robotic Systems](#user-content-link39)
**Authors:** Yuchen Wang, Jiangtao Kong, Sizhe Wei, Xiaochang Li, Haohong Lin, Hongjue Zhao, Tianyi Zhou, Lu Gan, Huajie Shao

40. [Repetition Without Exclusivity: Scale Sensitivity of Referential Mechanisms in Child-Scale Language Models](#user-content-link40)
**Authors:** Jon-Paul Cacioli

41. [SPARQ: Spiking Early-Exit Neural Networks for Energy-Efficient Edge AI](#user-content-link41)
**Authors:** Parth Patne, Mahdi Taheri, Ali Mahani, Maksim Jenihhin, Reza Mahani, Christian Herglotz

42. [DASH: Dynamic Audio-Driven Semantic Chunking for Efficient Omnimodal Token Compression](#user-content-link42)
**Authors:** Bingzhou Li, Tao Huang

43. [Discriminative Flow Matching Via Local Generative Predictors](#user-content-link43)
...
**Comment:** Model architecture: introduces matrix-valued nonlinear RNN states as a scalable alternative building block beyond transformer-style expressivity limits.
...
**Comment:** Replaces attention with a Fourier-solved convection-diffusion-reaction state-space block, giving near-linear-complexity core architecture for vision models.
...
## 3. [High-Probability Bounds for SGD under the Polyak-Lojasiewicz Condition with Markovian Noise](https://arxiv.org/abs/2603.14514) <a id="link3"></a>
...
**Comment:** Optimization theory: first uniform-in-time high-probability SGD bounds under the PL condition with Markovian noise.
...
## 4. [Self-Indexing KVCache: Predicting Sparse Attention from Compressed Keys](https://arxiv.org/abs/2603.14224) <a id="link4"></a>
...
**Comment:** Model efficiency: unifies KV-cache compression and sparse attention retrieval via self-indexing 1-bit compressed keys.
...
## 5. [On Interpolation Formulas Describing Neural Network Generalization](https://arxiv.org/abs/2603.13872) <a id="link5"></a>
...
**Comment:** Representation learning theory: extends Domingos-style interpolation formulas to stochastic training via a stochastic gradient kernel.
...
## 6. [Power-Law Spectrum of the Random Feature Model](https://arxiv.org/abs/2603.14578) <a id="link6"></a>
...
**Comment:** Theory of representations: proves power-law spectra are preserved through random feature mappings up to logarithmic factors.
...
## 7. [Gradient Atoms: Unsupervised Discovery, Attribution and Steering of Model Behaviors via Sparse Decomposition of Training Gradients](https://arxiv.org/abs/2603.14665) <a id="link7"></a>
...
**Comment:** Representation learning via sparse dictionary decomposition of per-document training gradients to discover and steer latent model behaviors.
...
## 8. [GradMem: Learning to Write Context into Memory with Test-Time Gradient Descent](https://arxiv.org/abs/2603.13875) <a id="link8"></a>
...
**Comment:** Proposes a new compressive-memory write mechanism for transformers using test-time gradient descent on memory tokens.
...
**Comment:** Analyzes training dynamics of transformers to explain how next-token prediction gradients induce apparently redundant internal features.
...
## 10. [Enhancing LLM Training via Spectral Clipping](https://arxiv.org/abs/2603.14315) <a id="link10"></a>
...
**Comment:** Provides a theoretically grounded optimizer modification for LLM training using spectral clipping with efficient Newton-Schulz implementation.
...
## 11. [FlashHead: Efficient Drop-In Replacement for the Classification Head in Language Model Inference](https://arxiv.org/abs/2603.14591) <a id="link11"></a>
...
**Comment:** Inference-efficiency method replacing the LM output head with retrieval-style structured clustering, multiprobe search, and selective quantization.
...
## 12. [From Specification to Architecture: A Theory Compiler for Knowledge-Guided Machine Learning](https://arxiv.org/abs/2603.14369) <a id="link12"></a>
...
**Comment:** Foundational architecture idea: compile formal domain theories into provably constrained neural architectures by construction.
...
## 13. [Rigorous Asymptotics for First-Order Algorithms Through the Dynamical Cavity Method](https://arxiv.org/abs/2603.14573) <a id="link13"></a>
...
**Comment:** Theory for optimization dynamics: rigorous formalization of the dynamical cavity method yielding DMFT equations for broad first-order algorithms.
...
## 14. [Disentangling Dynamical Systems: Causal Representation Learning Meets Local Sparse Attention](https://arxiv.org/abs/2603.14483) <a id="link14"></a>
...
**Comment:** Representation learning theory: identifiability theorem for disentangling dynamical-system parameters, instantiated with sparse-attention transformers.
...
## 15. [OxyGen: Unified KV Cache Management for Vision-Language-Action Models under Multi-Task Parallelism](https://arxiv.org/abs/2603.14371) <a id="link15"></a>
...
**Comment:** High-performance inference systems: unified KV-cache management enabling cross-task sharing and continuous batching in multi-task transformer-like VLAs.
...
## 16. [The Phenomenology of Hallucinations](https://arxiv.org/abs/2603.13911) <a id="link16"></a>
...
**Comment:** Representation analysis: identifies geometric decoupling between internal uncertainty signals and output logits as a mechanism for hallucinations.
...
## 17. [Sampling Boltzmann distributions via normalizing flow approximation of transport maps](https://arxiv.org/abs/2603.14258) <a id="link17"></a>
...
**Comment:** Theory for generative architectures: establishes existence and approximation guarantees for normalizing flows on low-regularity Boltzmann distributions.
...
## 18. [Convergence of Two Time-Scale Stochastic Approximation: A Martingale Approach](https://arxiv.org/abs/2603.14481) <a id="link18"></a>
...
**Comment:** Foundational stochastic-approximation theory proving almost-sure convergence and sharper rates for nonlinear two-time-scale updates.
...
## 19. [TMPDiff: Temporal Mixed-Precision for Diffusion Models](https://arxiv.org/abs/2603.14062) <a id="link19"></a>
...
**Comment:** Compression/efficiency method introducing timestep-wise mixed-precision quantization for diffusion inference with adaptive scheduling.
...
## 20. [Effective Sparsity: A Unified Framework via Normalized Entropy and the Effective Number of Nonzeros](https://arxiv.org/abs/2603.13826) <a id="link20"></a>
...
**Comment:** Theoretical sparsity framework replacing l0 cardinality with entropy-based effective sparsity and proving RIP recovery guarantees.
...
## 21. [Windowed Fourier Propagator: A Frequency-Local Neural Operator for Wave Equations in Inhomogeneous Media](https://arxiv.org/abs/2603.14289) <a id="link21"></a>
...
**Comment:** Neural operator architecture exploiting frequency locality and superposition for efficient wave propagation modeling.
...
**Comment:** Foundational theory/systems work on linear sketching recovery, identifying an information-loss mechanism and proposing a generative sketching framework with lightweight recovery.
...
## 23. [Delightful Policy Gradient](https://arxiv.org/abs/2603.14608) <a id="link23"></a>
...
**Comment:** Foundational RL optimization method introducing a new policy-gradient weighting based on advantage and surprisal, with theory and broad empirical validation.
...
## 24. [Solving physics-constrained inverse problems with conditional flow matching](https://arxiv.org/abs/2603.14135) <a id="link24"></a>
...
**Comment:** Flow-matching methodology for Bayesian inverse problems plus analysis of finite-data degeneracy and overtraining behavior.
...
## 25. [Pixel-level Scene Understanding in One Token: Visual States Need What-is-Where Composition](https://arxiv.org/abs/2603.13904) <a id="link25"></a>
...
**Comment:** Visual state representation learning via a bottleneck-token reconstruction objective that explicitly encodes what-is-where composition.
...
## 26. [Localizing and Editing Knowledge in Large Audio-Language Models](https://arxiv.org/abs/2603.14343) <a id="link26"></a>
...
**Comment:** Representation analysis and targeted editing of where factual knowledge is stored across audio, text, and cross-modal modules in LALMs.
...
## 27. [Diffusion Reinforcement Learning via Centered Reward Distillation](https://arxiv.org/abs/2603.14128) <a id="link27"></a>
...
**Comment:** Diffusion RL objective derived from KL-regularized reward maximization with centering and KL controls to prevent distribution drift.
...
## 28. [Locally Linear Continual Learning for Time Series based on VC-Theoretical Generalization Bounds](https://arxiv.org/abs/2603.13674) <a id="link28"></a>
...
**Comment:** Develops an interpretable dynamic piecewise-linear architecture for continual time-series learning with VC-theoretic generalization bounds guiding model growth.
...
## 29. [SVD Contextual Sparsity Predictors for Fast LLM Inference](https://arxiv.org/abs/2603.14110) <a id="link29"></a>
...
**Comment:** Inference efficiency: training-free SVD-based contextual sparsity predictors for conditional FFN computation in LLMs.
...
## 30. [Align Forward, Adapt Backward: Closing the Discretization Gap in Logic Gate Networks](https://arxiv.org/abs/2603.14157) <a id="link30"></a>
...
**Comment:** Core architecture analysis: studies training-inference discretization gap in hard/soft component selection and proposes CAGE.
...
## 31. [Learning to Forget: Sleep-Inspired Memory Consolidation for Resolving Proactive Interference in Large Language Models](https://arxiv.org/abs/2603.14517) <a id="link31"></a>
...
**Comment:** Introduces a transformer KV-cache memory-consolidation mechanism with learned forgetting/compression and a claimed O(n) to O(log n) interference reduction.
...
## 32. [True 4-Bit Quantized Convolutional Neural Network Training on CPU: Achieving Full-Precision Parity](https://arxiv.org/abs/2603.13931) <a id="link32"></a>
...
**Comment:** Model compression/efficiency via true 4-bit training from scratch on commodity CPUs with a new soft clipping quantization method.
...
## 33. [AR-Flow VAE: A Structured Autoregressive Flow Prior Variational Autoencoder for Unsupervised Blind Source Separation](https://arxiv.org/abs/2603.14441) <a id="link33"></a>
...
**Comment:** Core autoencoder methodology: a VAE with parameter-adaptive autoregressive flow priors that structurally separate latent sources.
...
## 34. [Is the reconstruction loss culprit? An attempt to outperform JEPA](https://arxiv.org/abs/2603.14131) <a id="link34"></a>
...
**Comment:** Representation-learning study isolating reconstruction-vs-prediction effects and proposing gated predictive autoencoders for predictable-component selection.
...
## 35. [Spectral Edge Dynamics of Training Trajectories: Signal--Noise Geometry Across Scales](https://arxiv.org/abs/2603.15678) <a id="link35"></a>
...
**Comment:** Representation-learning/training-dynamics analysis of transformer optimization via spectral edge geometry of parameter-update trajectories.
...
## 36. [IGU-LoRA: Adaptive Rank Allocation via Integrated Gradients and Uncertainty-Aware Scoring](https://arxiv.org/abs/2603.13792) <a id="link36"></a>
...
**Comment:** Adaptive low-rank fine-tuning with layerwise rank allocation using integrated gradients and uncertainty-aware scoring.
...
## 37. [Human-like Object Grouping in Self-supervised Vision Transformers](https://arxiv.org/abs/2603.13994) <a id="link37"></a>
...
**Comment:** Representation learning analysis linking object-centric patch similarity structure in self-supervised ViTs to human-like grouping behavior.
...
## 38. [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](https://arxiv.org/abs/2603.14549) <a id="link38"></a>
...
**Comment:** Model efficiency paper proposing training-free, KV-cache-compatible token pruning and merging for LVLM inference based on attention-shift-aware selection.
...
## 39. [WestWorld: A Knowledge-Encoded Scalable Trajectory World Model for Diverse Robotic Systems](https://arxiv.org/abs/2603.14392) <a id="link39"></a>
...
**Comment:** System-aware Mixture-of-Experts architecture with dynamic routing across diverse robotic systems is the clearest foundational contribution.
...
## 40. [Repetition Without Exclusivity: Scale Sensitivity of Referential Mechanisms in Child-Scale Language Models](https://arxiv.org/abs/2603.13696) <a id="link40"></a>
...
**Comment:** Systematic analysis of how GPT-2-scale models encode referential mechanisms and context sensitivity directly targets representation learning.
...
## 41. [SPARQ: Spiking Early-Exit Neural Networks for Energy-Efficient Edge AI](https://arxiv.org/abs/2603.14380) <a id="link41"></a>
...
**Comment:** Model-efficiency architecture combining spiking networks, quantization-aware training, and input-adaptive early exits for low-energy inference.
...
## 42. [DASH: Dynamic Audio-Driven Semantic Chunking for Efficient Omnimodal Token Compression](https://arxiv.org/abs/2603.15685) <a id="link42"></a>
...
**Comment:** Training-free multimodal token compression via dynamic semantic chunking and structure-aware token retention is a clear efficiency method.
...
## 43. [Discriminative Flow Matching Via Local Generative Predictors](https://arxiv.org/abs/2603.13928) <a id="link43"></a>
...
**Comment:** Reformulates discriminative prediction as flow matching with independent local predictors and memory/parallelism-aware block updates.
