...
<table>
    ...
    <tbody>
        <tr><td><a href="#topic-architecture-training">Architecture and Training Dynamics</a></td><td align="center">66</td></tr>
        <tr><td><a href="#topic-efficiency-scaling">Efficiency, Compression, and Large-Scale Training</a></td><td align="center">31</td></tr>
        <tr><td><a href="#topic-representation-structure">Representation Learning Theory and Structure</a></td><td align="center">48</td></tr>
        <tr><td><a href="#topic-memory-systems">Memory Structures and Agent Memory Systems</a></td><td align="center">12</td></tr>
        <tr><td><a href="#topic-world-models-open-ended-rl">World Models, Exploration, and Open-Ended Reinforcement Learning</a></td><td align="center">26</td></tr>
    </tbody>
</table>

**Table of contents by topic:**

## [Architecture and Training Dynamics](#topic-architecture-training) (66)
...
2. [ELF: Embedded Language Flows](#paper-2605-10938)
...
4. [Attention Drift: What Autoregressive Speculative Decoding Models Learn](#paper-2605-09992)
**Authors:** Do\u{g}a\c{c} Eldenk, Payal Mohapatra, Yigitcan Comlek, Kaan Oktay, Hongyang Zhang, Stephen Xia

5. [Sparsity Moves Computation: How FFN Architecture Reshapes Attention in Small Transformers](#paper-2605-09403)
**Authors:** Gabriel Smithline, Chris Mascioli

6. [A Single-Layer Model Can Do Language Modeling](#paper-2605-10643)
**Authors:** Zanmin Wang

7. [TIDES: Implicit Time-Awareness in Selective State Space Models](#paper-2605-09742)
**Authors:** Taylan Soydan, Miguel A. Bessa, Dirk Mohr, Rui Barreira

8. [FRACTAL: SSM with Fractional Recurrent Architecture for Computational Temporal Analysis of Long Sequences](#paper-2605-08833)
**Authors:** Mengqi Li, Wensheng Lin, Jinshuai Yang, Lixin Li

9. [Complex-Valued Phase-Coherent Transformer](#paper-2605-10123)
**Authors:** Leona Hioki

10. [DECO: Sparse Mixture-of-Experts with Dense-Comparable Performance on End-Side Devices](#paper-2605-10933)
**Authors:** Chenyang Song, Weilin Zhao, Xu Han, Chaojun Xiao, Yingfa Chen, Zhiyuan Liu

11. [Geometry Conflict: Explaining and Controlling Forgetting in LLM Continual Post-Training](#paper-2605-09608)
...
12. [Block-Wise Differentiable Sinkhorn Attention: Tail-Refinement Gradients with a Gap-Aware Dustbin Bridge](#paper-2605-08123)
**Authors:** Dylan Forde

13. [A Qualitative Test-Risk Mechanism for Scaling Behavior in Normalized Residual Networks](#paper-2605-08297)
**Authors:** Daning Cheng, Zeyu Liu, Jun Sun, Fen Xia, Boyang Zhang, Dongping Liu, Yunquan Zhang

14. [SDG-MoE: Signed Debate Graph Mixture-of-Experts](#paper-2605-08322)
...
15. [Key-Value Means](#paper-2605-09877)
**Authors:** Daniel Goldstein, Eugene Cheah

16. [Continuity Laws for Sequential Models](#paper-2605-08539)
**Authors:** Annan Yu, Dongwei Lyu, N. Benjamin Erichson

17. [Muown: Row-Norm Control for Muon Optimization](#paper-2605-10797)
**Authors:** Kai Lion, Florian H\"ubler, Bingcong Li, Antonio Orvieto, Niao He

18. [Kaczmarz Linear Attention](#paper-2605-08587)
**Authors:** Jiaxuan Zou, Ruifeng Ren, Yong Liu

19. [Scaling Limits of Long-Context Transformers](#paper-2605-08505)
**Authors:** Giuseppe Bruno, Shi Chen, Zhengjiang Lin, Yury Polyanskiy, Philippe Rigollet

20. [Learning Theory of Transformers: Local-to-Global Approximation via Softmax Partition of Unity](#paper-2605-08811)
**Authors:** Zhongjie Shi, Wenjing Liao

21. [Transformers Can Implement Preconditioned Richardson Iteration for In-Context Gaussian Kernel Regression](#paper-2605-08475)
**Authors:** Mingsong Yan, Dongyang Li, Charles Kulick, Sui Tang

22. [Mixture of Layers with Hybrid Attention](#paper-2605-09516)
**Authors:** Ivan Ternovtsii, Yurii Bilak

23. [Sparse Layers are Critical to Scaling Looped Language Models](#paper-2605-09165)
**Authors:** Ryan Lee, Jacob Biloki, Edward J. Hu, Jonathan May

24. [Self-Attention as a Covariance Readout: A Unified View of In-Context Learning and Repetition](#paper-2605-10466)
**Authors:** Haoren Xu, Guanhua Fang

25. [Kinetic theory for Transformers and the lost-in-the-middle phenomenon](#paper-2605-09213)
**Authors:** Mitia Duerinckx, Borjan Geshkovski, Stefano Rossi

26. [Predicting Plasticity in Deep Continual Learning: A Theoretical Perspective](#paper-2605-09044)
**Authors:** Jiuqi Wang, Jayanth Srinivasa, Claire Chen, Shuze Daniel Liu, Ali Payani, Shangtong Zhang

27. [Positional LSH: Binary Block Matrix Approximation for Attention with Linear Biases](#paper-2605-09472)
**Authors:** Daniel Wolfson, Tal Wagner

28. [Scratchpad Patching: Decoupling Compute from Patch Size in Byte-Level Language Models](#paper-2605-09630)
**Authors:** Lin Zheng, Vasilisa Bashlovkina, Timothy Dozat, Dan Garrette, Laura Rimell, Joshua Maynez

29. [Path-Dependent Denoising: A Non-Conservative Field Perspective on Order Collapse in Diffusion Language Models](#paper-2605-09303)
**Authors:** Jeonseong Kim

30. [Teaching LLMs to See Graphs: Unifying Text and Structural Reasoning](#paper-2605-10247)
**Authors:** Dario Vajda

31. [Lattice Deduction Transformers](#paper-2605-08605)
**Authors:** Liam Davis, Leopold Haller, Alberto Alfarano, Mark Santolucito

32. [Embedding Dimension Lower Bounds for Universality of Deep Sets and Janossy Pooling](#paper-2605-08377)
**Authors:** Ali Syed, Aditya Nambiar, Jonathan W. Siegel

33. [bViT: Investigating Single-Block Recurrence in Vision Transformers for Image Recognition](#paper-2605-10661)
**Authors:** Michal Byra, Pawel Olszowiec, Grzegorz Stefanski, Grzegorz Gruszczynski, Alberto Presta

34. [Quantifying Concentration Phenomena of Mean-Field Transformers in the Low-Temperature Regime](#paper-2605-10931)
**Authors:** Albert Alcalde, Leon Bungert, Konstantin Riedl, Tim Roith

35. [Normalization Equivariance for Arbitrary Backbones, with Application to Image Denoising](#paper-2605-08193)
**Authors:** Youssef Saied, Fran\c{c}ois Fleuret

36. [The Power of Second Order Methods for Sequence Preconditioning](#paper-2605-08390)
**Authors:** Annie Marsden, Elad Hazan

37. [NoiseRater: Meta-Learned Noise Valuation for Diffusion Model Training](#paper-2605-08144)
...
38. [Why Do Aligned LLMs Remain Jailbreakable: Refusal-Escape Directions, Operator-Level Sources, and Safety-Utility Trade-off](#paper-2605-08878)
**Authors:** Yu Chen, Yuanhao Liu, Qi Cao

39. [On Variance Reduction in Learning Mean Flows](#paper-2605-09235)
**Authors:** Juanwu Lu, Ziran Wang

40. [Infinite Mask Diffusion for Few-Step Distillation](#paper-2605-10518)
**Authors:** Jaehoon Yoo, Wonjung Kim, Chanhyuk Lee, Seunghoon Hong

41. [Phases of Muon: When Muon Eclipses SignSGD](#paper-2605-09552)
**Authors:** Elliot Paquette, Noah Marshall, Lucas Benigni, Guangyuan Wang, Atish Agarwala, Courtney Paquette

42. [Controlling Transient Amplification Improves Long-horizon Rollouts](#paper-2605-08856)
**Authors:** Adeel Pervez, Francesco Locatello

43. [Convergence Analysis of Newton's Method for Neural Networks in the Overparameterized Limit](#paper-2605-08352)
**Authors:** Konstantin Riedl, Konstantinos Spiliopoulos, Justin Sirignano

44. [Optimizer-Induced Mode Connectivity: From AdamW to Muon](#paper-2605-09991)
**Authors:** Fangzhao Zhang, Sungyoon Kim, Erica Zhang, Yiqi Jiang, Mert Pilanci

45. [Fitting Multilinear Polynomials for Logic Gate Networks](#paper-2605-08657)
**Authors:** Youngsung Kim

46. [Hyperparameter Transfer for Dense Associative Memories](#paper-2605-10164)
**Authors:** Roi Holtzman, Dmitry Krotov, Boris Hanin

47. [Structured Recurrent Mixers for Massively Parallelized Sequence Generation](#paper-2605-08696)
**Authors:** Benjamin L. Badger

48. [Dimension-Free Saddle-Point Escape in Muon](#paper-2605-09331)
**Authors:** Yanlin Long, Yufei Gu, Zeke Xie

49. [Parameterized Complexity of Stationarity Testing for Piecewise-Affine Functions and Shallow CNN Losses](#paper-2605-10219)
**Authors:** Yuhan Ye

50. [Minimal Filling Architectures of Polynomial Neural Networks: Counterexamples, Frontier Search, and Defects](#paper-2605-09609)
**Authors:** Kevin Dao, Jose Israel Rodriguez

51. [CATO: Charted Attention for Neural PDE Operators](#paper-2605-09016)
**Authors:** Chun-Wun Cheng, Sifan Wang, Carola-Bibiane Sch\"onlieb, Angelica I. Aviles-Rivero

52. [RAwR: Role-Aware Rewiring via Approximate Equitable Partition](#paper-2605-09457)
...
53. [When Attention Beats Fourier: Multi-Scale Transformers for PDE Solving on Irregular Domains](#paper-2605-08318)
**Authors:** Brandon Yee, Pairie Koh, Jack Rodriguez, Mihir Tekal

54. [Exactness Matters for Physical Rule Enforcement](#paper-2605-08285)
**Authors:** Bum Jun Kim

55. [Exact Fixed-Point Constraints in Neural-ODEs with Provable Universality](#paper-2605-10613)
...
57. [Elucidating Representation Degradation Problem in Diffusion Model Training](#paper-2605-10790)
**Authors:** Zhipeng Yao, Dazhou Li, Zitong Zhang, Durude Mahee, Fan Zhu, Wenbin Zhang, Xinwei He, Yeying Jin, Rui Yu

58. [A Game Theoretic Free Energy Analysis of Higher Order Synergy in Attention Heads of Large Language Models](#paper-2605-09515)
**Authors:** Djamel Bouchaffra

59. [The Cancellation Hypothesis in Critic-Free RL: From Outcome Rewards to Token Credits](#paper-2605-08666)
**Authors:** Tianhao Cheng, Zeyu Huang, Zihan Qiu, Yu Cheng, Edoardo Ponti, Yinghui Xu, Ivan Titov, Zenglin Xu

60. [Why Zeroth-Order Adaptation May Forget Less: A Randomized Shaping Theory](#paper-2605-10658)
**Authors:** Yao Shu, Jian Mu, Zhongxiang Dai

61. [Recovering Physical Dynamics from Discrete Observations via Intrinsic Differential Consistency](#paper-2605-08454)
**Authors:** Yuxiang Luo, Andrew Perrault

62. [RelFlexformer: Efficient Attention 3D-Transformers for Integrable Relative Positional Encodings](#paper-2605-10706)
**Authors:** Byeongchan Kim, Arijit Sehanobish, Avinava Dubey, Min-hwan Oh, Krzysztof Choromanski

63. [Improving Generalization by Permutation Routing Across Model Copies](#paper-2605-09256)
**Authors:** Shuhei Kashiwamura, Timothee Leleu

64. [The Extrapolation Cliff in On-Policy Distillation of Near-Deterministic Structured Outputs](#paper-2605-08737)
**Authors:** Xin Li, Hao Jiang, Annan Wang, Yichi Zhang, Chau Yuen

65. [HyperTransport: Amortized Conditioning of T2I Generative Models](#paper-2605-08254)
**Authors:** Valentino Maiorca, Eleonora Gualdoni, Xavier Suau, Marco Cuturi, Luca Zappella, Pau Rodr\'iguez

66. [Don't Fix the Basis -- Learn It: Spectral Representation with Adaptive Basis Learning for PDEs](#paper-2605-10451)
**Authors:** Xuxiang Zhao, Angelica I. Aviles-Rivero

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (31)

1. [Make Each Token Count: Towards Improving Long-Context Performance with KV Cache Eviction](#paper-2605-09649)
**Authors:** Ngoc Bui, Hieu Trung Nguyen, Arman Cohan, Rex Ying

2. [BCJR-QAT: A Differentiable Relaxation of Trellis-Coded Weight Quantization](#paper-2605-10655)
**Authors:** Venugopalan Iyengar

3. [PARD-2: Target-Aligned Parallel Draft Model for Dual-Mode Speculative Decoding](#paper-2605-08632)
**Authors:** Zihao An, Taichi Liu, Ziqiong Liu, Dong Li, Ruofeng Liu, Emad Barsoum

4. [AdaPreLoRA: Adafactor Preconditioned Low-Rank Adaptation](#paper-2605-08734)
**Authors:** Ziyun Liu, Fengmiao Bian, Jian-Feng Cai

5. [ReLibra: Routing-Replay-Guided Load Balancing for MoE Training in Reinforcement Learning](#paper-2605-08639)
**Authors:** Chao Jin, Xinming Wei, Yinmin Zhong, Chengxu Yang, Bingyang Wu, Ruidong Zhu, Zili Zhang, Yuliang Liu, Xin Jin

6. [Test-Time Speculation](#paper-2605-09329)
**Authors:** Avinash Kumar, Sujay Sanghavi, Poulami Das

7. [Queryable LoRA: Instruction-Regularized Routing Over Shared Low-Rank Update Atoms](#paper-2605-08423)
**Authors:** Omatharv Bharat Vaidya, Connor T. Jerzak, Nhat Ho, Chandrajit Bajaj

8. [Not All Thoughts Need HBM: Semantics-Aware Memory Hierarchy for LLM Reasoning](#paper-2605-09490)
**Authors:** Aojie Yuan, Tianqi Shen, Dajun Zhang

9. [Nectar: Neural Estimation of Cached-Token Attention via Regression](#paper-2605-09778)
**Authors:** Jo\~ao Monteiro, Michal Klein, Pierre Ablin, Marco Cuturi

10. [TileQ: Efficient Low-Rank Quantization of Mixture-of-Experts with 2D Tiling](#paper-2605-09281)
**Authors:** Hongyaoxing Gu, Xinzhe Chen, Lijuan Hu, Fangfang Liu

11. [RubiConv -- Efficient Boundary-Respecting Convolutions](#paper-2605-08451)
**Authors:** Linda Friso, Annie Marsden, Xinyi Chen, Arushi Gupta, Peter Bartlett, Mark Braverman, Elad Hazan

12. [LAQuant: A Simple Overhead-free Large Reasoning Model Quantization by Layer-wise Lookahead Loss](#paper-2605-08755)
**Authors:** Euntae Choi, Sumin Song, Sungjoo Yoo

13. [ConQuR: Corner Aligned Activation Quantization via Optimized Rotations for LLMs](#paper-2605-10793)
...
15. [Accelerating Zeroth-Order Spectral Optimization with Partial Orthogonalization from Power Iteration](#paper-2605-09034)
**Authors:** Jiahe Chen, Ziye Ma

16. [GELATO: Generative Entropy- and Lyapunov-based Adaptive Token Offloading for Device-Edge Speculative LLM Inference](#paper-2605-10124)
**Authors:** Zengzipeng Tang, Yuxuan Sun, Wei Chen, Jianwen Ding, Bo Ai

17. [AdaPaD: Adaptive Parallel Deflation for PEFT with Self-Correcting Rank Discovery](#paper-2605-10741)
**Authors:** Barbara Su, Fangshuo Liao, Anastasios Kyrillidis

18. [KV-RM: Regularizing KV-Cache Movement for Static-Graph LLM Serving](#paper-2605-09735)
**Authors:** Zhiqing Zhong, Zhijing Ye, Jian Zhang, Weijian Zheng, Bolun Sun, Xiaodong Yu

19. [Practical Scaling Laws: Converting Compute into Performance in a Data-Constrained World](#paper-2605-09189)
**Authors:** Christopher M. Bryant, Hao Liu

20. [Locking Pretrained Weights via Deep Low-Rank Residual Distillation](#paper-2605-10777)
**Authors:** Keitaro Sakamoto, Pierre Ablin, Federico Danieli, Marco Cuturi

21. [Selection Plateau and a Sparsity-Dependent Hierarchy of Pruning Features](#paper-2605-09345)
**Authors:** Guangqi Li, Yongxin Li

22. [Compute Where it Counts: Self Optimizing Language Models](#paper-2605-10875)
**Authors:** Yash Akhauri, Mohamed S. Abdelfattah

23. [Intrinsic Muon: Spectral Optimization on Riemannian Matrix Manifolds](#paper-2605-09238)
...
25. [Lakestream: A Consistent and Brokerless Data Plane for Large Foundation Model Training](#paper-2605-09994)
...
26. [Adversary-Robust Learning from Fully Asynchronous Directional Derivative Estimates](#paper-2605-09337)
**Authors:** Anik Kumar Paul, Nibedita Roy, Nagesh Talagani, Swetha Ganesh, Gugan Thoppe, Alexandre Reiffers-Masson

27. [Core-Halo Decomposition: Decentralizing Large-Scale Fixed-Point Problems](#paper-2605-08681)
**Authors:** Haixiang, Yang Xu, Jiefu Zhang, Xudong Wu, Zihan Zhou, Jun He, Jiayu Chen

28. [Function-Space ADMM for Decentralized Federated Learning: A Control Theoretic Perspective](#paper-2605-09356)
**Authors:** Akihito Taya, Yuuki Nishiyama, Kaoru Sezaki

29. [BubbleSpec: Turning Long-Tail Bubbles into Speculative Rollout Drafts for Synchronous Reinforcement Learning](#paper-2605-08862)
**Authors:** Yuhang Xu, Kaibin Tian, Yang Tian, Zhice Yang, Yifeng Yu, Yan Li, Shengzhong Liu, Fan Wu, Guihai Chen

30. [TRAM: Training Approximate Multiplier Structures for Low-Power AI Accelerators](#paper-2605-08231)
**Authors:** Chang Meng, Hanyu Wang, Yuyang Ye, Mingfei Yu, Wayne Burleson, Giovanni De Micheli

31. [Unveiling High-Probability Generalization in Decentralized SGD](#paper-2605-10205)
**Authors:** Jiahuan Wang, Ping Luo, Ziqing Wen, Dongsheng Li, Tao Sun

## [Representation Learning Theory and Structure](#topic-representation-structure) (48)

1. [Learnability and Competition in High-Dimensional Multi-Component ICA](#paper-2605-08552)
**Authors:** Eser Ilke Genc, Samet Demir, Zafer Dogan

2. [fmxcoders: Factorized Masked Crosscoders for Cross-Layer Feature Discovery](#paper-2605-09438)
**Authors:** Andreas D. Demou, Panagiotis Koromilas, James Oldfield, Yannis Panagakis, Mihalis A. Nicolaou

3. [Anchoring the Eigengap: Cross-Modal Spectral Stabilization for Sample-Efficient Representation Learning](#paper-2605-08764)
...
4. [Causal Dimensionality of Transformer Representations: Measurement, Scaling, and Layer Structure](#paper-2605-08740)
**Authors:** Nilesh Sarkar, Dawar Jyoti Deka

5. [The two clocks and the innovation window: When and how generative models learn rules](#paper-2605-10019)
**Authors:** Binxu Wang, Emma Lucia Byrnes Finn, Bingbin Liu

6. [Bilinear autoencoders find interpretable manifolds](#paper-2605-08891)
**Authors:** Thomas Dooms, Ward Gauderis, Geraint Wiggins, Jose Oramas

7. [The Geometric Structure of Models Learning Sparse Data](#paper-2605-08464)
**Authors:** Thomas Walker, T. Mitchell Roddenberry, Ahmed Imtiaz Humayun, Randall Balestriero, Richard Baraniuk

8. [Beyond Language: Format-Agnostic Reasoning Subspaces in Large Language Models](#paper-2605-09496)
**Authors:** Aojie Yuan, Zhiyuan Su

9. [The Global Empirical NTK: Self-Referential Bias and Dimensionality of Gradient Descent Learning](#paper-2605-08746)
**Authors:** James Hazelden, Laura Driscoll, Eli Shlizerman, Eric Shea-Brown

10. [Sharp feature-learning transitions and Bayes-optimal neural scaling laws in extensive-width networks](#paper-2605-10395)
**Authors:** Minh-Toan Nguyen, Jean Barbier

11. [Tensor Product Representation Probes Reveal Shared Structure Across Linear Directions](#paper-2605-09967)
**Authors:** Andrew Lee, Fernanda Vi\'egas, Martin Wattenberg

12. [Model Capacity Determines Grokking through Competing Memorisation and Generalisation Speeds](#paper-2605-09724)
**Authors:** Yiding Song, Hanming Ye

13. [Repeated-Token Counting Reveals a Dissociation Between Representations and Outputs](#paper-2605-09239)
**Authors:** Sohan Venkatesh

14. [The Geometry of Forgetting: Temporal Knowledge Drift as an Independent Axis in LLM Representations](#paper-2605-09195)
**Authors:** Rania Elbadry, Ahmed Heakl, Fan Zhang, Dani Bouch, Yuxia Wang, Preslav Nakov, Zhuohan Xie

15. [The Benefits of Temporal Correlations: SGD Learns k-Juntas from Random Walks Efficiently](#paper-2605-10237)
**Authors:** Elisabetta Cornacchia, Dan Mikulincer, Elchanan Mossel

16. [SMIXAE: Towards Unsupervised Manifold Discovery in Language Models](#paper-2605-09224)
**Authors:** Collin Francel

17. [The Polynomial Counting Capabilities of Message Passing Neural Networks](#paper-2605-10393)
**Authors:** Marco S\"alzer, Pascal Bergstr\"a{\ss}er, Anthony W. Lin

18. [The Wittgensteinian Representation Hypothesis: Is Language the Attractor of Multimodal Convergence?](#paper-2605-09352)
**Authors:** Zhaoyang Zhang, Run Shao, Dongyue Wu, Jiajie Teng, Chao Tao, Jingdong Chen, Haifeng Li

19. [From Syntax to Semantics: Unveiling the Emergence of Chirality in SMILES Translation Models](#paper-2605-09949)
**Authors:** Zehao Li, Yasuhiro Yoshikai, Shumpei Nemoto, Hiroyuki Kusuhara, Tadahaya Mizuno

20. [Cross-Family Universality of Behavioral Axes via Anchor-Projected Representations](#paper-2605-09875)
**Authors:** Su-Hyeon Kim, Yo-Sub Han

21. [HH-SAE: Discovering and Steering Hierarchical Knowledge of Complex Manifolds](#paper-2605-10536)
**Authors:** Honghan Wu, Tianyan Wang, Jiacong Mi, Zhoyang Jiang, Yunsoo Kim

22. [The Propagation Field: A Geometric Substrate Theory of Deep Learning](#paper-2605-08529)
**Authors:** Xingrui Gu

23. [Neural Information Causality](#paper-2605-09316)
**Authors:** Jeongho Bang, Marcin Paw{\l}owski

24. [Neural Weight Norm = Kolmogorov Complexity](#paper-2605-10878)
**Authors:** Tiberiu Musat

25. [Hidden Error Awareness in Chain-of-Thought Reasoning: The Signal Is Diagnostic, Not Causal](#paper-2605-09502)
**Authors:** Aojie Yuan, Zhiyuan Julian Su, Haiyue Zhang, Yi Nian, Yue Zhao

26. [Towards Effective Theory of LLMs: A Representation Learning Approach](#paper-2605-09294)
**Authors:** Muhammed Ustaomeroglu, Guannan Qu

27. [Belief or Circuitry? Causal Evidence for In-Context Graph Learning](#paper-2605-08405)
**Authors:** Katharine Kowalyshyn, Timothy Duggan, Daniel Little, Michael C Hughes

28. [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](#paper-2605-09314)
**Authors:** Xiangkun Sun, Lingkai Kong, Aoqi Zhang, Liang Zeng, Tonghan Wang

29. [Reasoning emerges from constrained inference manifolds in large language models](#paper-2605-08142)
...
30. [What Time Is It? How Data Geometry Makes Time Conditioning Optional for Flow Matching](#paper-2605-08344)
**Authors:** Alec Helbling, Sebastian Gutierrez Hernandez, Benjamin Hoover, Duen Horng Chau, Parikshit Ram

31. [Deterministic Decomposition of Stochastic Generative Dynamics](#paper-2605-08794)
**Authors:** Xingyu Song, Yuan Mei, Naoya Takeishi

32. [Diagnosing Spectral Ceilings in Equivariant Neural Force Fields](#paper-2605-08286)
**Authors:** Hyunmog Kim

33. [Generalization Error Bounds for Picard-Type Operator Learning in Nonlinear Parabolic PDEs](#paper-2605-10277)
**Authors:** Koichi Taniguchi, Sho Sonoda

34. [A Single Neuron Is Sufficient to Bypass Safety Alignment in Large Language Models](#paper-2605-08513)
**Authors:** Hamid Kazemi, Atoosa Chegini, Maria Safi

35. [Physical probes expose and alleviate chemical-environment collapse in molecular representations](#paper-2605-10429)
**Authors:** Jiebin Fang, Zidi Yan, Churu Mao, Yongjun Jiang, Xinyi Tang, Lei Miao, Dan Lu, Yun Huang, Wanjing Ding, Zhongjun Ma

36. [A Deep Risk Estimator for Known Operator Learning](#paper-2605-08517)
**Authors:** Andreas Maier, Md Hasan, Paulina Conrad, Paula Andrea Perez-Toro

37. [Mistake-Bounded Language Generation](#paper-2605-10809)
**Authors:** Jon Kleinberg, Charlotte Peale, Omer Reingold

38. [In-Context Fixation: When Demonstrated Labels Override Semantics in Few-Shot Classification](#paper-2605-08295)
**Authors:** Ming Liu

39. [Measuring and Decomposing Mode Separation via the Canonical Diffusion](#paper-2605-08777)
**Authors:** Shaul Tolkovsky, Ori Meidler, Or Zuk

40. [Intrinsic Guardrails: How Semantic Geometry of Personality Interacts with Emergent Misalignment in LLMs](#paper-2605-10633)
**Authors:** Krishak Aneja, Manas Mittal, Anmol Goel, Ponnurangam Kumaraguru, Vamshi Krishna Bonagiri

41. [Optimality of Sub-network Laplace Approximations: New Results and Methods](#paper-2605-09075)
**Authors:** Swarnali Raha, Kshitij Khare, Rohit K Patra

42. [Embeddings for Preferences, Not Semantics](#paper-2605-08360)
**Authors:** Carter Blair, Ariel D. Procaccia, Milind Tambe

43. [Characterizing the Generalization Error of Random Feature Regression with Arbitrary Data-Augmentation](#paper-2605-10290)
**Authors:** Lucas Morisset, Alain Durmus, Adrien Hardy

44. [Non-Parametric Rehearsal Learning via Conditional Mean Embeddings](#paper-2605-08999)
**Authors:** Wen-Bo Du, Tian-Zuo Wang, Han-Jia Ye, Zhi-Hua Zhou

45. [The Pok\'emon Theorem and other Fairness Impossibility Results](#paper-2605-09221)
**Authors:** Daniel Matsui Smola, Alex Smola

46. [Mitigating Many-shot Jailbreak Attacks with One Single Demonstration](#paper-2605-08277)
**Authors:** Kejia Chen, Jiawen Zhang, Boheng Li, Pengcheng Li, Jian Lou, Zunlei Feng, Mingli Song, Ruoxi Jia, Tianwei Zhang

47. [Prospective Compression in Human Abstraction Learning](#paper-2605-09985)
...
48. [Skill-CMIB: Multimodal Agent Skill for Consistent Action via Conditional Multimodal Information Bottleneck](#paper-2605-08526)
**Authors:** Zihan Huang, Junda Wu, Tong Yu, Qianqi Yan, Rohan Surana, Uttaran Bhattacharya, Lina Yao, Xin Eric Wang, Julian McAuley

## [Memory Structures and Agent Memory Systems](#topic-memory-systems) (12)

1. [HoReN: Normalized Hopfield Retrieval for Large-Scale Sequential Model Editing](#paper-2605-08143)
**Authors:** Yuan Fang, Yi Xie, Xuming Ran

2. [VORT: Adaptive Power-Law Memory for NLP Transformers](#paper-2605-08966)
**Authors:** Nabil Mlaiki

3. [Continuous Latent Contexts Enable Efficient Online Learning in Transformers](#paper-2605-09867)
**Authors:** Emile Anand, Abdullah Ateyeh, Xinyuan Cao, Max Dabagia

4. [Factual recall in linear associative memories: sharp asymptotics and mechanistic insights](#paper-2605-10795)
**Authors:** Alessio Giorlandino, Sebastian Goldt, Antoine Maillard

5. [Towards Understanding Continual Factual Knowledge Acquisition of Language Models: From Theory to Algorithm](#paper-2605-10640)
**Authors:** Haoyu Wang, Yifan Shang, Zhongxiang Sun, Weijie Yu, Xiao Zhang, Jun Xu

6. [Workspace Optimization: How to Train Your Agent](#paper-2605-09650)
**Authors:** Elad Sarafian, Gal Kaplun, Ron Banner, Daniel Soudry, Boris Ginsburg

7. [EquiMem: Calibrating Shared Memory in Multi-Agent Debate via Game-Theoretic Equilibrium](#paper-2605-09278)
**Authors:** Yuqiao Meng, Sakshi Sunil Narvekar, Luoxi Tang, Rupali Rajendra Vaje, Yingxue Zhang, Muchao Ye, Zhaohan Xi

8. [SkillMaster: Toward Autonomous Skill Mastery in LLM Agents](#paper-2605-08693)
**Authors:** Min Yang, Jinghua Piao, Xu Xia, Xiaochong Lan, Jiaju Chen, Yongshun Gong, Yong Li

9. [The Echo Amplifies the Knowledge: Somatic Marker Analogues in Language Models via Emotion Vector Re-Injection](#paper-2605-08611)
**Authors:** Jared Glover

10. [HS-FNO: History-Space Fourier Neural Operator for Non-Markovian Partial Differential Equations](#paper-2605-09523)
**Authors:** Lennon J. Shikhman

11. [Consolidation-Expansion Operator Mechanics:A Unified Framework for Adaptive Learning](#paper-2605-09968)
**Authors:** Debashis Guha

12. [CoCoDA: Co-evolving Compositional DAG for Tool-Augmented Agents](#paper-2605-08399)
**Authors:** Ziyang Yu, Qiyue Li, Liang Zhao

## [World Models, Exploration, and Open-Ended Reinforcement Learning](#topic-world-models-open-ended-rl) (26)

1. [Latent Geometry Beyond Search: Amortizing Planning in World Models](#paper-2605-08732)
**Authors:** Hoang Nguyen, Xiaohao Xu, Xiaonan Huang

2. [LaWM: Least Action World Models for Long-Horizon Physical Consistency from Visual Observations](#paper-2605-08279)
**Authors:** Qixin Xiao, Maani Ghaffari

3. [From Passive Reuse to Active Reasoning: Grounding Large Language Models for Neuro-Symbolic Experience Replay](#paper-2605-09419)
**Authors:** Yanan Xiao, Yixiang Tang, Zechen Feng, Lu Jiang, Minghao Yin, Pengyang Wang

4. [Path-Coupled Bellman Flows for Distributional Reinforcement Learning](#paper-2605-08253)
**Authors:** Boyang Xu, Qing Zou, Siqin Yang, Hao Yan

5. [Revisiting Policy Gradients for Restricted Policy Classes: Escaping Myopic Local Optima with $k$-step Policy Gradients](#paper-2605-10909)
**Authors:** Alex DeWeese, Guannan Qu

6. [ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](#paper-2605-10819)
...
7. [Do multimodal models imagine electric sheep?](#paper-2605-09693)
**Authors:** Santhosh Kumar Ramakrishnan, Carl Vondrick, Raja Giryes, Philipp Kr\"ahenb\"uhl, Vladlen Koltun

8. [The Reciprocity Gradient](#paper-2605-08323)
**Authors:** Yue Lin, Pascal Poupart, Shuhui Zhu, Dan Qiao, Wenhao Li, Yuan Liu, Hongyuan Zha, Baoxiang Wang

9. [Quantile-Coupled Flow Matching for Distributional Reinforcement Learning](#paper-2605-08515)
**Authors:** Michael Groom, Victor-Alexandru Darvariu, Lars Kunze, James Wilson, Nick Hawes

10. [Generative Actor-Critic with Soft Bridge Policies](#paper-2605-08733)
**Authors:** Ke He, Le He, Shunpu Tang, Yafei Wang, Lisheng Fan

11. [Zero-shot Imitation Learning by Latent Topology Mapping](#paper-2605-08450)
**Authors:** Maxwell J. Jacobson, Yexiang Xue

12. [One for All: A Non-Linear Transformer can Enable Cross-Domain Generalization for In-Context Reinforcement Learning](#paper-2605-09727)
...
14. [Natural Policy Gradient as Doubly Smoothed Policy Iteration: A Bellman-Operator Framework](#paper-2605-10671)
**Authors:** Phalguni Nanda, Zaiwei Chen

15. [Policy Gradient Methods for Non-Markovian Reinforcement Learning](#paper-2605-10816)
**Authors:** Avik Kar, Siddharth Chandak, Rahul Singh, Soumitra Sinhahajari, Eric Moulines, Shalabh Bhatnagar, Nicholas Bambos

16. [Learning When to Stop: Selective Imitation Learning Under Arbitrary Dynamics Shift](#paper-2605-09183)
**Authors:** Surbhi Goel, Jonathan Pei, James Wang

17. [On Characterizing Learnability for Adversarial Noisy Bandits](#paper-2605-09200)
**Authors:** Steve Hanneke, Kun Wang

18. [Central Limit Theorem for Two-Time-Scale Approximate Distributionally Robust RL](#paper-2605-08417)
**Authors:** Shengbo Wang, Zexi Zhang

19. [Near-Optimal Last-Iterate Convergence for Zero-Sum Games with Bandit Feedback and Opponent Actions](#paper-2605-09363)
**Authors:** Soumita Hait, Ping Li, Haipeng Luo, Mengxiao Zhang

20. [Beyond Static Bias: Adaptive Multi-Fidelity Bandits with Improving Proxies](#paper-2605-08558)
**Authors:** Muyun Lu, Haoyang Hong, Huazheng Wang, Ying Lin

21. [SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning](#paper-2605-09423)
**Authors:** Haoqiang Kang, Xiaokang Ye, Yuhan Liu, Siddhant Hitesh Mantri, Lingjun Mao, James Fleming, Drishti Regmi, Lianhui Qin

22. [Continual Harness: Online Adaptation for Self-Improving Foundation Agents](#paper-2605-09998)
**Authors:** Seth Karten, Joel Zhang, Tersoo Upaa Jr, Ruirong Feng, Wenzhe Li, Chengshuai Shi, Chi Jin, Kiran Vodrahalli

23. [When to Re-Commit: Temporal Abstraction Discovery for Long-Horizon Vision-Language Reasoning](#paper-2605-09860)
**Authors:** Chen Li, Zhantao Yang, Fangyi Chen, Han Zhang, Anudeepsekhar Bolimera, Marios Savvides

24. [The Value of Mechanistic Priors in Sequential Decision Making](#paper-2605-10018)
**Authors:** Itai Shufaro, Gal Benor, Shie Mannor

25. [Shields to Guarantee Probabilistic Safety in MDPs](#paper-2605-10888)
**Authors:** Linus Heck, Filip Mac\'ak, Roman Andriushchenko, Milan \v{C}e\v{s}ka, Sebastian Junges

26. [Switching-Geometry Analysis of Deflated Q-Value Iteration](#paper-2605-10811)
**Authors:** Donghwan Lee

---

## Architecture and Training Dynamics (66) <a id="topic-architecture-training"></a>
...
### 2. [ELF: Embedded Language Flows](https://arxiv.org/abs/2605.10938) <a id="paper-2605-10938"></a>
...
### 4. [Attention Drift: What Autoregressive Speculative Decoding Models Learn](https://arxiv.org/abs/2605.09992) <a id="paper-2605-09992"></a>
...
### 5. [Sparsity Moves Computation: How FFN Architecture Reshapes Attention in Small Transformers](https://arxiv.org/abs/2605.09403) <a id="paper-2605-09403"></a>
...
### 6. [A Single-Layer Model Can Do Language Modeling](https://arxiv.org/abs/2605.10643) <a id="paper-2605-10643"></a>
...
### 7. [TIDES: Implicit Time-Awareness in Selective State Space Models](https://arxiv.org/abs/2605.09742) <a id="paper-2605-09742"></a>
...
### 8. [FRACTAL: SSM with Fractional Recurrent Architecture for Computational Temporal Analysis of Long Sequences](https://arxiv.org/abs/2605.08833) <a id="paper-2605-08833"></a>
...
### 9. [Complex-Valued Phase-Coherent Transformer](https://arxiv.org/abs/2605.10123) <a id="paper-2605-10123"></a>
...
### 10. [DECO: Sparse Mixture-of-Experts with Dense-Comparable Performance on End-Side Devices](https://arxiv.org/abs/2605.10933) <a id="paper-2605-10933"></a>
...
### 11. [Geometry Conflict: Explaining and Controlling Forgetting in LLM Continual Post-Training](https://arxiv.org/abs/2605.09608) <a id="paper-2605-09608"></a>
...
### 12. [Block-Wise Differentiable Sinkhorn Attention: Tail-Refinement Gradients with a Gap-Aware Dustbin Bridge](https://arxiv.org/abs/2605.08123) <a id="paper-2605-08123"></a>
...
### 13. [A Qualitative Test-Risk Mechanism for Scaling Behavior in Normalized Residual Networks](https://arxiv.org/abs/2605.08297) <a id="paper-2605-08297"></a>
...
### 14. [SDG-MoE: Signed Debate Graph Mixture-of-Experts](https://arxiv.org/abs/2605.08322) <a id="paper-2605-08322"></a>
...
### 15. [Key-Value Means](https://arxiv.org/abs/2605.09877) <a id="paper-2605-09877"></a>
...
### 16. [Continuity Laws for Sequential Models](https://arxiv.org/abs/2605.08539) <a id="paper-2605-08539"></a>
...
### 17. [Muown: Row-Norm Control for Muon Optimization](https://arxiv.org/abs/2605.10797) <a id="paper-2605-10797"></a>
...
### 18. [Kaczmarz Linear Attention](https://arxiv.org/abs/2605.08587) <a id="paper-2605-08587"></a>
...
### 19. [Scaling Limits of Long-Context Transformers](https://arxiv.org/abs/2605.08505) <a id="paper-2605-08505"></a>
...
### 20. [Learning Theory of Transformers: Local-to-Global Approximation via Softmax Partition of Unity](https://arxiv.org/abs/2605.08811) <a id="paper-2605-08811"></a>
...
### 21. [Transformers Can Implement Preconditioned Richardson Iteration for In-Context Gaussian Kernel Regression](https://arxiv.org/abs/2605.08475) <a id="paper-2605-08475"></a>
...
### 22. [Mixture of Layers with Hybrid Attention](https://arxiv.org/abs/2605.09516) <a id="paper-2605-09516"></a>
...
### 23. [Sparse Layers are Critical to Scaling Looped Language Models](https://arxiv.org/abs/2605.09165) <a id="paper-2605-09165"></a>
...
### 24. [Self-Attention as a Covariance Readout: A Unified View of In-Context Learning and Repetition](https://arxiv.org/abs/2605.10466) <a id="paper-2605-10466"></a>
...
### 25. [Kinetic theory for Transformers and the lost-in-the-middle phenomenon](https://arxiv.org/abs/2605.09213) <a id="paper-2605-09213"></a>
...
### 26. [Predicting Plasticity in Deep Continual Learning: A Theoretical Perspective](https://arxiv.org/abs/2605.09044) <a id="paper-2605-09044"></a>
...
### 27. [Positional LSH: Binary Block Matrix Approximation for Attention with Linear Biases](https://arxiv.org/abs/2605.09472) <a id="paper-2605-09472"></a>
...
### 28. [Scratchpad Patching: Decoupling Compute from Patch Size in Byte-Level Language Models](https://arxiv.org/abs/2605.09630) <a id="paper-2605-09630"></a>
...
### 29. [Path-Dependent Denoising: A Non-Conservative Field Perspective on Order Collapse in Diffusion Language Models](https://arxiv.org/abs/2605.09303) <a id="paper-2605-09303"></a>
...
### 30. [Teaching LLMs to See Graphs: Unifying Text and Structural Reasoning](https://arxiv.org/abs/2605.10247) <a id="paper-2605-10247"></a>
...
### 31. [Lattice Deduction Transformers](https://arxiv.org/abs/2605.08605) <a id="paper-2605-08605"></a>
...
### 32. [Embedding Dimension Lower Bounds for Universality of Deep Sets and Janossy Pooling](https://arxiv.org/abs/2605.08377) <a id="paper-2605-08377"></a>
...
### 33. [bViT: Investigating Single-Block Recurrence in Vision Transformers for Image Recognition](https://arxiv.org/abs/2605.10661) <a id="paper-2605-10661"></a>
...
### 34. [Quantifying Concentration Phenomena of Mean-Field Transformers in the Low-Temperature Regime](https://arxiv.org/abs/2605.10931) <a id="paper-2605-10931"></a>
...
### 35. [Normalization Equivariance for Arbitrary Backbones, with Application to Image Denoising](https://arxiv.org/abs/2605.08193) <a id="paper-2605-08193"></a>
...
### 36. [The Power of Second Order Methods for Sequence Preconditioning](https://arxiv.org/abs/2605.08390) <a id="paper-2605-08390"></a>
...
### 37. [NoiseRater: Meta-Learned Noise Valuation for Diffusion Model Training](https://arxiv.org/abs/2605.08144) <a id="paper-2605-08144"></a>
...
### 38. [Why Do Aligned LLMs Remain Jailbreakable: Refusal-Escape Directions, Operator-Level Sources, and Safety-Utility Trade-off](https://arxiv.org/abs/2605.08878) <a id="paper-2605-08878"></a>
...
### 39. [On Variance Reduction in Learning Mean Flows](https://arxiv.org/abs/2605.09235) <a id="paper-2605-09235"></a>
...
### 40. [Infinite Mask Diffusion for Few-Step Distillation](https://arxiv.org/abs/2605.10518) <a id="paper-2605-10518"></a>
...
### 41. [Phases of Muon: When Muon Eclipses SignSGD](https://arxiv.org/abs/2605.09552) <a id="paper-2605-09552"></a>
...
### 42. [Controlling Transient Amplification Improves Long-horizon Rollouts](https://arxiv.org/abs/2605.08856) <a id="paper-2605-08856"></a>
...
### 43. [Convergence Analysis of Newton's Method for Neural Networks in the Overparameterized Limit](https://arxiv.org/abs/2605.08352) <a id="paper-2605-08352"></a>
...
### 44. [Optimizer-Induced Mode Connectivity: From AdamW to Muon](https://arxiv.org/abs/2605.09991) <a id="paper-2605-09991"></a>
...
### 45. [Fitting Multilinear Polynomials for Logic Gate Networks](https://arxiv.org/abs/2605.08657) <a id="paper-2605-08657"></a>
...
### 46. [Hyperparameter Transfer for Dense Associative Memories](https://arxiv.org/abs/2605.10164) <a id="paper-2605-10164"></a>
...
### 47. [Structured Recurrent Mixers for Massively Parallelized Sequence Generation](https://arxiv.org/abs/2605.08696) <a id="paper-2605-08696"></a>
...
### 48. [Dimension-Free Saddle-Point Escape in Muon](https://arxiv.org/abs/2605.09331) <a id="paper-2605-09331"></a>
...
### 49. [Parameterized Complexity of Stationarity Testing for Piecewise-Affine Functions and Shallow CNN Losses](https://arxiv.org/abs/2605.10219) <a id="paper-2605-10219"></a>
...
### 50. [Minimal Filling Architectures of Polynomial Neural Networks: Counterexamples, Frontier Search, and Defects](https://arxiv.org/abs/2605.09609) <a id="paper-2605-09609"></a>
...
### 51. [CATO: Charted Attention for Neural PDE Operators](https://arxiv.org/abs/2605.09016) <a id="paper-2605-09016"></a>
...
### 52. [RAwR: Role-Aware Rewiring via Approximate Equitable Partition](https://arxiv.org/abs/2605.09457) <a id="paper-2605-09457"></a>
...
### 53. [When Attention Beats Fourier: Multi-Scale Transformers for PDE Solving on Irregular Domains](https://arxiv.org/abs/2605.08318) <a id="paper-2605-08318"></a>
...
### 54. [Exactness Matters for Physical Rule Enforcement](https://arxiv.org/abs/2605.08285) <a id="paper-2605-08285"></a>
...
### 55. [Exact Fixed-Point Constraints in Neural-ODEs with Provable Universality](https://arxiv.org/abs/2605.10613) <a id="paper-2605-10613"></a>
...
### 57. [Elucidating Representation Degradation Problem in Diffusion Model Training](https://arxiv.org/abs/2605.10790) <a id="paper-2605-10790"></a>
...
### 58. [A Game Theoretic Free Energy Analysis of Higher Order Synergy in Attention Heads of Large Language Models](https://arxiv.org/abs/2605.09515) <a id="paper-2605-09515"></a>
...
### 59. [The Cancellation Hypothesis in Critic-Free RL: From Outcome Rewards to Token Credits](https://arxiv.org/abs/2605.08666) <a id="paper-2605-08666"></a>
...
### 60. [Why Zeroth-Order Adaptation May Forget Less: A Randomized Shaping Theory](https://arxiv.org/abs/2605.10658) <a id="paper-2605-10658"></a>
...
### 61. [Recovering Physical Dynamics from Discrete Observations via Intrinsic Differential Consistency](https://arxiv.org/abs/2605.08454) <a id="paper-2605-08454"></a>
...
### 62. [RelFlexformer: Efficient Attention 3D-Transformers for Integrable Relative Positional Encodings](https://arxiv.org/abs/2605.10706) <a id="paper-2605-10706"></a>
...
### 63. [Improving Generalization by Permutation Routing Across Model Copies](https://arxiv.org/abs/2605.09256) <a id="paper-2605-09256"></a>
...
### 64. [The Extrapolation Cliff in On-Policy Distillation of Near-Deterministic Structured Outputs](https://arxiv.org/abs/2605.08737) <a id="paper-2605-08737"></a>
...
### 65. [HyperTransport: Amortized Conditioning of T2I Generative Models](https://arxiv.org/abs/2605.08254) <a id="paper-2605-08254"></a>
...
### 66. [Don't Fix the Basis -- Learn It: Spectral Representation with Adaptive Basis Learning for PDEs](https://arxiv.org/abs/2605.10451) <a id="paper-2605-10451"></a>
...
## Efficiency, Compression, and Large-Scale Training (31) <a id="topic-efficiency-scaling"></a>

### 1. [Make Each Token Count: Towards Improving Long-Context Performance with KV Cache Eviction](https://arxiv.org/abs/2605.09649) <a id="paper-2605-09649"></a>
...
### 2. [BCJR-QAT: A Differentiable Relaxation of Trellis-Coded Weight Quantization](https://arxiv.org/abs/2605.10655) <a id="paper-2605-10655"></a>
...
### 3. [PARD-2: Target-Aligned Parallel Draft Model for Dual-Mode Speculative Decoding](https://arxiv.org/abs/2605.08632) <a id="paper-2605-08632"></a>
...
### 4. [AdaPreLoRA: Adafactor Preconditioned Low-Rank Adaptation](https://arxiv.org/abs/2605.08734) <a id="paper-2605-08734"></a>
...
### 5. [ReLibra: Routing-Replay-Guided Load Balancing for MoE Training in Reinforcement Learning](https://arxiv.org/abs/2605.08639) <a id="paper-2605-08639"></a>
...
### 6. [Test-Time Speculation](https://arxiv.org/abs/2605.09329) <a id="paper-2605-09329"></a>
...
### 7. [Queryable LoRA: Instruction-Regularized Routing Over Shared Low-Rank Update Atoms](https://arxiv.org/abs/2605.08423) <a id="paper-2605-08423"></a>
...
### 8. [Not All Thoughts Need HBM: Semantics-Aware Memory Hierarchy for LLM Reasoning](https://arxiv.org/abs/2605.09490) <a id="paper-2605-09490"></a>
...
### 9. [Nectar: Neural Estimation of Cached-Token Attention via Regression](https://arxiv.org/abs/2605.09778) <a id="paper-2605-09778"></a>
...
### 10. [TileQ: Efficient Low-Rank Quantization of Mixture-of-Experts with 2D Tiling](https://arxiv.org/abs/2605.09281) <a id="paper-2605-09281"></a>
...
### 11. [RubiConv -- Efficient Boundary-Respecting Convolutions](https://arxiv.org/abs/2605.08451) <a id="paper-2605-08451"></a>
...
### 12. [LAQuant: A Simple Overhead-free Large Reasoning Model Quantization by Layer-wise Lookahead Loss](https://arxiv.org/abs/2605.08755) <a id="paper-2605-08755"></a>
...
### 13. [ConQuR: Corner Aligned Activation Quantization via Optimized Rotations for LLMs](https://arxiv.org/abs/2605.10793) <a id="paper-2605-10793"></a>
...
### 15. [Accelerating Zeroth-Order Spectral Optimization with Partial Orthogonalization from Power Iteration](https://arxiv.org/abs/2605.09034) <a id="paper-2605-09034"></a>
...
### 16. [GELATO: Generative Entropy- and Lyapunov-based Adaptive Token Offloading for Device-Edge Speculative LLM Inference](https://arxiv.org/abs/2605.10124) <a id="paper-2605-10124"></a>
...
### 17. [AdaPaD: Adaptive Parallel Deflation for PEFT with Self-Correcting Rank Discovery](https://arxiv.org/abs/2605.10741) <a id="paper-2605-10741"></a>
...
### 18. [KV-RM: Regularizing KV-Cache Movement for Static-Graph LLM Serving](https://arxiv.org/abs/2605.09735) <a id="paper-2605-09735"></a>
...
### 19. [Practical Scaling Laws: Converting Compute into Performance in a Data-Constrained World](https://arxiv.org/abs/2605.09189) <a id="paper-2605-09189"></a>
...
### 20. [Locking Pretrained Weights via Deep Low-Rank Residual Distillation](https://arxiv.org/abs/2605.10777) <a id="paper-2605-10777"></a>
...
### 21. [Selection Plateau and a Sparsity-Dependent Hierarchy of Pruning Features](https://arxiv.org/abs/2605.09345) <a id="paper-2605-09345"></a>
...
### 22. [Compute Where it Counts: Self Optimizing Language Models](https://arxiv.org/abs/2605.10875) <a id="paper-2605-10875"></a>
...
### 23. [Intrinsic Muon: Spectral Optimization on Riemannian Matrix Manifolds](https://arxiv.org/abs/2605.09238) <a id="paper-2605-09238"></a>
...
### 25. [Lakestream: A Consistent and Brokerless Data Plane for Large Foundation Model Training](https://arxiv.org/abs/2605.09994) <a id="paper-2605-09994"></a>
...
### 26. [Adversary-Robust Learning from Fully Asynchronous Directional Derivative Estimates](https://arxiv.org/abs/2605.09337) <a id="paper-2605-09337"></a>
...
### 27. [Core-Halo Decomposition: Decentralizing Large-Scale Fixed-Point Problems](https://arxiv.org/abs/2605.08681) <a id="paper-2605-08681"></a>
...
### 28. [Function-Space ADMM for Decentralized Federated Learning: A Control Theoretic Perspective](https://arxiv.org/abs/2605.09356) <a id="paper-2605-09356"></a>
...
### 29. [BubbleSpec: Turning Long-Tail Bubbles into Speculative Rollout Drafts for Synchronous Reinforcement Learning](https://arxiv.org/abs/2605.08862) <a id="paper-2605-08862"></a>
...
### 30. [TRAM: Training Approximate Multiplier Structures for Low-Power AI Accelerators](https://arxiv.org/abs/2605.08231) <a id="paper-2605-08231"></a>
...
### 31. [Unveiling High-Probability Generalization in Decentralized SGD](https://arxiv.org/abs/2605.10205) <a id="paper-2605-10205"></a>
...
## Representation Learning Theory and Structure (48) <a id="topic-representation-structure"></a>

### 1. [Learnability and Competition in High-Dimensional Multi-Component ICA](https://arxiv.org/abs/2605.08552) <a id="paper-2605-08552"></a>
...
### 2. [fmxcoders: Factorized Masked Crosscoders for Cross-Layer Feature Discovery](https://arxiv.org/abs/2605.09438) <a id="paper-2605-09438"></a>
...
### 3. [Anchoring the Eigengap: Cross-Modal Spectral Stabilization for Sample-Efficient Representation Learning](https://arxiv.org/abs/2605.08764) <a id="paper-2605-08764"></a>
...
### 4. [Causal Dimensionality of Transformer Representations: Measurement, Scaling, and Layer Structure](https://arxiv.org/abs/2605.08740) <a id="paper-2605-08740"></a>
...
### 5. [The two clocks and the innovation window: When and how generative models learn rules](https://arxiv.org/abs/2605.10019) <a id="paper-2605-10019"></a>
...
### 6. [Bilinear autoencoders find interpretable manifolds](https://arxiv.org/abs/2605.08891) <a id="paper-2605-08891"></a>
...
### 7. [The Geometric Structure of Models Learning Sparse Data](https://arxiv.org/abs/2605.08464) <a id="paper-2605-08464"></a>
...
### 8. [Beyond Language: Format-Agnostic Reasoning Subspaces in Large Language Models](https://arxiv.org/abs/2605.09496) <a id="paper-2605-09496"></a>
...
### 9. [The Global Empirical NTK: Self-Referential Bias and Dimensionality of Gradient Descent Learning](https://arxiv.org/abs/2605.08746) <a id="paper-2605-08746"></a>
...
### 10. [Sharp feature-learning transitions and Bayes-optimal neural scaling laws in extensive-width networks](https://arxiv.org/abs/2605.10395) <a id="paper-2605-10395"></a>
...
### 11. [Tensor Product Representation Probes Reveal Shared Structure Across Linear Directions](https://arxiv.org/abs/2605.09967) <a id="paper-2605-09967"></a>
...
### 12. [Model Capacity Determines Grokking through Competing Memorisation and Generalisation Speeds](https://arxiv.org/abs/2605.09724) <a id="paper-2605-09724"></a>
...
### 13. [Repeated-Token Counting Reveals a Dissociation Between Representations and Outputs](https://arxiv.org/abs/2605.09239) <a id="paper-2605-09239"></a>
...
### 14. [The Geometry of Forgetting: Temporal Knowledge Drift as an Independent Axis in LLM Representations](https://arxiv.org/abs/2605.09195) <a id="paper-2605-09195"></a>
...
### 15. [The Benefits of Temporal Correlations: SGD Learns k-Juntas from Random Walks Efficiently](https://arxiv.org/abs/2605.10237) <a id="paper-2605-10237"></a>
...
### 16. [SMIXAE: Towards Unsupervised Manifold Discovery in Language Models](https://arxiv.org/abs/2605.09224) <a id="paper-2605-09224"></a>
...
### 17. [The Polynomial Counting Capabilities of Message Passing Neural Networks](https://arxiv.org/abs/2605.10393) <a id="paper-2605-10393"></a>
...
### 18. [The Wittgensteinian Representation Hypothesis: Is Language the Attractor of Multimodal Convergence?](https://arxiv.org/abs/2605.09352) <a id="paper-2605-09352"></a>
...
### 19. [From Syntax to Semantics: Unveiling the Emergence of Chirality in SMILES Translation Models](https://arxiv.org/abs/2605.09949) <a id="paper-2605-09949"></a>
...
### 20. [Cross-Family Universality of Behavioral Axes via Anchor-Projected Representations](https://arxiv.org/abs/2605.09875) <a id="paper-2605-09875"></a>
...
### 21. [HH-SAE: Discovering and Steering Hierarchical Knowledge of Complex Manifolds](https://arxiv.org/abs/2605.10536) <a id="paper-2605-10536"></a>
...
### 22. [The Propagation Field: A Geometric Substrate Theory of Deep Learning](https://arxiv.org/abs/2605.08529) <a id="paper-2605-08529"></a>
...
### 23. [Neural Information Causality](https://arxiv.org/abs/2605.09316) <a id="paper-2605-09316"></a>
...
### 24. [Neural Weight Norm = Kolmogorov Complexity](https://arxiv.org/abs/2605.10878) <a id="paper-2605-10878"></a>
...
### 25. [Hidden Error Awareness in Chain-of-Thought Reasoning: The Signal Is Diagnostic, Not Causal](https://arxiv.org/abs/2605.09502) <a id="paper-2605-09502"></a>
...
### 26. [Towards Effective Theory of LLMs: A Representation Learning Approach](https://arxiv.org/abs/2605.09294) <a id="paper-2605-09294"></a>
...
### 27. [Belief or Circuitry? Causal Evidence for In-Context Graph Learning](https://arxiv.org/abs/2605.08405) <a id="paper-2605-08405"></a>
...
### 28. [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](https://arxiv.org/abs/2605.09314) <a id="paper-2605-09314"></a>
...
### 29. [Reasoning emerges from constrained inference manifolds in large language models](https://arxiv.org/abs/2605.08142) <a id="paper-2605-08142"></a>
...
### 30. [What Time Is It? How Data Geometry Makes Time Conditioning Optional for Flow Matching](https://arxiv.org/abs/2605.08344) <a id="paper-2605-08344"></a>
...
### 31. [Deterministic Decomposition of Stochastic Generative Dynamics](https://arxiv.org/abs/2605.08794) <a id="paper-2605-08794"></a>
...
### 32. [Diagnosing Spectral Ceilings in Equivariant Neural Force Fields](https://arxiv.org/abs/2605.08286) <a id="paper-2605-08286"></a>
...
### 33. [Generalization Error Bounds for Picard-Type Operator Learning in Nonlinear Parabolic PDEs](https://arxiv.org/abs/2605.10277) <a id="paper-2605-10277"></a>
...
### 34. [A Single Neuron Is Sufficient to Bypass Safety Alignment in Large Language Models](https://arxiv.org/abs/2605.08513) <a id="paper-2605-08513"></a>
...
### 35. [Physical probes expose and alleviate chemical-environment collapse in molecular representations](https://arxiv.org/abs/2605.10429) <a id="paper-2605-10429"></a>
...
### 36. [A Deep Risk Estimator for Known Operator Learning](https://arxiv.org/abs/2605.08517) <a id="paper-2605-08517"></a>
...
### 37. [Mistake-Bounded Language Generation](https://arxiv.org/abs/2605.10809) <a id="paper-2605-10809"></a>
...
### 38. [In-Context Fixation: When Demonstrated Labels Override Semantics in Few-Shot Classification](https://arxiv.org/abs/2605.08295) <a id="paper-2605-08295"></a>
...
### 39. [Measuring and Decomposing Mode Separation via the Canonical Diffusion](https://arxiv.org/abs/2605.08777) <a id="paper-2605-08777"></a>
...
### 40. [Intrinsic Guardrails: How Semantic Geometry of Personality Interacts with Emergent Misalignment in LLMs](https://arxiv.org/abs/2605.10633) <a id="paper-2605-10633"></a>
...
### 41. [Optimality of Sub-network Laplace Approximations: New Results and Methods](https://arxiv.org/abs/2605.09075) <a id="paper-2605-09075"></a>
...
### 42. [Embeddings for Preferences, Not Semantics](https://arxiv.org/abs/2605.08360) <a id="paper-2605-08360"></a>
...
### 43. [Characterizing the Generalization Error of Random Feature Regression with Arbitrary Data-Augmentation](https://arxiv.org/abs/2605.10290) <a id="paper-2605-10290"></a>
...
### 44. [Non-Parametric Rehearsal Learning via Conditional Mean Embeddings](https://arxiv.org/abs/2605.08999) <a id="paper-2605-08999"></a>
...
### 45. [The Pok\'emon Theorem and other Fairness Impossibility Results](https://arxiv.org/abs/2605.09221) <a id="paper-2605-09221"></a>
...
### 46. [Mitigating Many-shot Jailbreak Attacks with One Single Demonstration](https://arxiv.org/abs/2605.08277) <a id="paper-2605-08277"></a>
...
### 47. [Prospective Compression in Human Abstraction Learning](https://arxiv.org/abs/2605.09985) <a id="paper-2605-09985"></a>
...
### 48. [Skill-CMIB: Multimodal Agent Skill for Consistent Action via Conditional Multimodal Information Bottleneck](https://arxiv.org/abs/2605.08526) <a id="paper-2605-08526"></a>
...
## Memory Structures and Agent Memory Systems (12) <a id="topic-memory-systems"></a>

### 1. [HoReN: Normalized Hopfield Retrieval for Large-Scale Sequential Model Editing](https://arxiv.org/abs/2605.08143) <a id="paper-2605-08143"></a>
...
### 2. [VORT: Adaptive Power-Law Memory for NLP Transformers](https://arxiv.org/abs/2605.08966) <a id="paper-2605-08966"></a>
...
### 3. [Continuous Latent Contexts Enable Efficient Online Learning in Transformers](https://arxiv.org/abs/2605.09867) <a id="paper-2605-09867"></a>
...
### 4. [Factual recall in linear associative memories: sharp asymptotics and mechanistic insights](https://arxiv.org/abs/2605.10795) <a id="paper-2605-10795"></a>
...
### 5. [Towards Understanding Continual Factual Knowledge Acquisition of Language Models: From Theory to Algorithm](https://arxiv.org/abs/2605.10640) <a id="paper-2605-10640"></a>
...
### 6. [Workspace Optimization: How to Train Your Agent](https://arxiv.org/abs/2605.09650) <a id="paper-2605-09650"></a>
...
### 7. [EquiMem: Calibrating Shared Memory in Multi-Agent Debate via Game-Theoretic Equilibrium](https://arxiv.org/abs/2605.09278) <a id="paper-2605-09278"></a>
...
### 8. [SkillMaster: Toward Autonomous Skill Mastery in LLM Agents](https://arxiv.org/abs/2605.08693) <a id="paper-2605-08693"></a>
...
### 9. [The Echo Amplifies the Knowledge: Somatic Marker Analogues in Language Models via Emotion Vector Re-Injection](https://arxiv.org/abs/2605.08611) <a id="paper-2605-08611"></a>
...
### 10. [HS-FNO: History-Space Fourier Neural Operator for Non-Markovian Partial Differential Equations](https://arxiv.org/abs/2605.09523) <a id="paper-2605-09523"></a>
...
### 11. [Consolidation-Expansion Operator Mechanics:A Unified Framework for Adaptive Learning](https://arxiv.org/abs/2605.09968) <a id="paper-2605-09968"></a>
...
### 12. [CoCoDA: Co-evolving Compositional DAG for Tool-Augmented Agents](https://arxiv.org/abs/2605.08399) <a id="paper-2605-08399"></a>
...
## World Models, Exploration, and Open-Ended Reinforcement Learning (26) <a id="topic-world-models-open-ended-rl"></a>

### 1. [Latent Geometry Beyond Search: Amortizing Planning in World Models](https://arxiv.org/abs/2605.08732) <a id="paper-2605-08732"></a>
...
### 2. [LaWM: Least Action World Models for Long-Horizon Physical Consistency from Visual Observations](https://arxiv.org/abs/2605.08279) <a id="paper-2605-08279"></a>
...
### 3. [From Passive Reuse to Active Reasoning: Grounding Large Language Models for Neuro-Symbolic Experience Replay](https://arxiv.org/abs/2605.09419) <a id="paper-2605-09419"></a>
...
### 4. [Path-Coupled Bellman Flows for Distributional Reinforcement Learning](https://arxiv.org/abs/2605.08253) <a id="paper-2605-08253"></a>
...
### 5. [Revisiting Policy Gradients for Restricted Policy Classes: Escaping Myopic Local Optima with $k$-step Policy Gradients](https://arxiv.org/abs/2605.10909) <a id="paper-2605-10909"></a>
...
### 6. [ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](https://arxiv.org/abs/2605.10819) <a id="paper-2605-10819"></a>
...
### 7. [Do multimodal models imagine electric sheep?](https://arxiv.org/abs/2605.09693) <a id="paper-2605-09693"></a>
...
### 8. [The Reciprocity Gradient](https://arxiv.org/abs/2605.08323) <a id="paper-2605-08323"></a>
...
### 9. [Quantile-Coupled Flow Matching for Distributional Reinforcement Learning](https://arxiv.org/abs/2605.08515) <a id="paper-2605-08515"></a>
...
### 10. [Generative Actor-Critic with Soft Bridge Policies](https://arxiv.org/abs/2605.08733) <a id="paper-2605-08733"></a>
...
### 11. [Zero-shot Imitation Learning by Latent Topology Mapping](https://arxiv.org/abs/2605.08450) <a id="paper-2605-08450"></a>
...
### 12. [One for All: A Non-Linear Transformer can Enable Cross-Domain Generalization for In-Context Reinforcement Learning](https://arxiv.org/abs/2605.09727) <a id="paper-2605-09727"></a>
...
### 14. [Natural Policy Gradient as Doubly Smoothed Policy Iteration: A Bellman-Operator Framework](https://arxiv.org/abs/2605.10671) <a id="paper-2605-10671"></a>
...
### 15. [Policy Gradient Methods for Non-Markovian Reinforcement Learning](https://arxiv.org/abs/2605.10816) <a id="paper-2605-10816"></a>
...
### 16. [Learning When to Stop: Selective Imitation Learning Under Arbitrary Dynamics Shift](https://arxiv.org/abs/2605.09183) <a id="paper-2605-09183"></a>
...
### 17. [On Characterizing Learnability for Adversarial Noisy Bandits](https://arxiv.org/abs/2605.09200) <a id="paper-2605-09200"></a>
...
### 18. [Central Limit Theorem for Two-Time-Scale Approximate Distributionally Robust RL](https://arxiv.org/abs/2605.08417) <a id="paper-2605-08417"></a>
...
### 19. [Near-Optimal Last-Iterate Convergence for Zero-Sum Games with Bandit Feedback and Opponent Actions](https://arxiv.org/abs/2605.09363) <a id="paper-2605-09363"></a>
...
### 20. [Beyond Static Bias: Adaptive Multi-Fidelity Bandits with Improving Proxies](https://arxiv.org/abs/2605.08558) <a id="paper-2605-08558"></a>
...
### 21. [SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning](https://arxiv.org/abs/2605.09423) <a id="paper-2605-09423"></a>
...
### 22. [Continual Harness: Online Adaptation for Self-Improving Foundation Agents](https://arxiv.org/abs/2605.09998) <a id="paper-2605-09998"></a>
...
### 23. [When to Re-Commit: Temporal Abstraction Discovery for Long-Horizon Vision-Language Reasoning](https://arxiv.org/abs/2605.09860) <a id="paper-2605-09860"></a>
...
### 24. [The Value of Mechanistic Priors in Sequential Decision Making](https://arxiv.org/abs/2605.10018) <a id="paper-2605-10018"></a>
...
### 25. [Shields to Guarantee Probabilistic Safety in MDPs](https://arxiv.org/abs/2605.10888) <a id="paper-2605-10888"></a>
...
### 26. [Switching-Geometry Analysis of Deflated Q-Value Iteration](https://arxiv.org/abs/2605.10811) <a id="paper-2605-10811"></a>
