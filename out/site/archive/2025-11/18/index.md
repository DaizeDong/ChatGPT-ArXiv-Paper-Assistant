<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../17"><img src="../../../assets/nav/day/2025-11-18-prev.svg" alt="Previous Day 2025-11-17"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-18-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../19"><img src="../../../assets/nav/day/2025-11-18-next.svg" alt="Next Day 2025-11-19"></a></div></div>

# Personalized Daily ArXiv Papers 2025-11-18

| *[gpt-5]*   | Prompt   | Completion   | Total   |
|:-----------:|:--------:|:------------:|:-------:|
| **Token**   | 96454    | 83154        | 179608  |
| **Cost**    | $0.12    | $0.83        | $0.95   |
...
2. [Pre-Attention Expert Prediction and Prefetching for Mixture-of-Experts Large Language Models](#user-content-link2)
**Authors:** Shien Zhu, Samuel Bohl, Robin Oester, Gustavo Alonso

3. [EcoSpa: Efficient Transformer Training with Coupled Sparsity](#user-content-link3)
...
4. [SpecQuant: Spectral Decomposition and Adaptive Truncation for Ultra-Low-Bit LLMs Quantization](#user-content-link4)
**Authors:** Zhixiong Zhao, Fangxin Liu, Junjie Wang, Chenyang Guan, Zongwu Wang, Li Jiang, Haibing Guan

5. [On the Fundamental Limits of LLMs at Scale](#user-content-link5)
...
6. [ParaDySe: A Parallel-Strategy Switching Framework for Dynamic Sequence Lengths in Transformer](#user-content-link6)
**Authors:** Zhixin Ou, Peng Liang, Jianchen Han, Baihui Liu, Linbo Qiao

7. [Connectivity-Guided Sparsification of 2-FWL GNNs: Preserving Full Expressivity with Improved Efficiency](#user-content-link7)
**Authors:** Rongqin Chen, Fan Mo, Pak Lon Ip, Shenghui Zhang, Dan Wu, Ye Li, Leong Hou U

8. [Understanding InfoNCE: Transition Probability Matrix Induced Feature Clustering](#user-content-link8)
**Authors:** Ge Cheng, Shuo Wang, Yun Zhang

9. [$\pi$-Attention: Periodic Sparse Transformers for Efficient Long-Context Modeling](#user-content-link9)
**Authors:** Dong Liu, Yanxuan Yu

10. [Training Instabilities Induce Flatness Bias in Gradient Descent](#user-content-link10)
**Authors:** Lawrence Wang, Stephen J. Roberts

11. [QUILL: An Algorithm-Architecture Co-Design for Cache-Local Deformable Attention](#user-content-link11)
**Authors:** Hyunwoo Oh, Hanning Chen, Sanggeon Yun, Yang Ni, Wenjun Huang, Tamoghno Das, Suyeon Jang, Mohsen Imani

12. [Weight-sparse transformers have interpretable circuits](#user-content-link12)
**Authors:** Leo Gao, Achyuta Rajaram, Jacob Coxon, Soham V. Govande, Bowen Baker, Dan Mossing

13. [PCA++: How Uniformity Induces Robustness to Background Noise in Contrastive Learning](#user-content-link13)
**Authors:** Mingqi Wu, Qiang Sun, Yi Yang

14. [T-SAR: A Full-Stack Co-design for CPU-Only Ternary LLM Inference via In-Place SIMD ALU Reorganization](#user-content-link14)
...
15. [Stratified Knowledge-Density Super-Network for Scalable Vision Transformers](#user-content-link15)
**Authors:** Longhua Li, Lei Qi, Xin Geng

16. [OTARo: Once Tuning for All Precisions toward Robust On-Device LLMs](#user-content-link16)
**Authors:** Shaoyuan Chen, Zhixuan Chen, Dawei Yang, Zhihang Yuan, Qiang Wu

17. [The Anatomy of a Triton Attention Kernel](#user-content-link17)
**Authors:** Burkhard Ringlein, Jan van Lunteren, Radu Stoica, Thomas Parnell

18. [Decoupling Positional and Symbolic Attention Behavior in Transformers](#user-content-link18)
**Authors:** Felipe Urrutia, Jorge Salas, Alexander Kozachinskiy, Cristian Buc Calderon, Hector Pasten, Cristobal Rojas

19. [Sample Complexity of Agnostic Multiclass Classification: Natarajan Dimension Strikes Back](#user-content-link19)
**Authors:** Alon Cohen, Liad Erez, Steve Hanneke, Tomer Koren, Yishay Mansour, Shay Moran, Qian Zhang

20. [CAO: Curvature-Adaptive Optimization via Periodic Low-Rank Hessian Sketching](#user-content-link20)
**Authors:** Wenzhang Du (Mahanakorn University of Technology, International College, Bangkok, Thailand)

21. [Clifford Algebraic Rotor Embeddings : Maybe embeddings should start to CARE](#user-content-link21)
**Authors:** Sameeksha Sriram, Ayush Paliwal, Alexander S. Ecker, Chase van de Geijn

22. [Do traveling waves make good positional encodings?](#user-content-link22)
**Authors:** Chase van de Geijn, Ayush Paliwal, Timo L\"uddecke, Alexander S. Ecker

23. [Uncertainty Makes It Stable: Curiosity-Driven Quantized Mixture-of-Experts](#user-content-link23)
...
24. [Beyond One-Way Pruning: Bidirectional Pruning-Regrowth for Extreme Accuracy-Sparsity Tradeoff](#user-content-link24)
**Authors:** Junchen Liu, Yi Sheng

25. [Likelihood-guided Regularization in Attention Based Models](#user-content-link25)
**Authors:** Mohamed Salem, Inyoung Kim

26. [Self-Adaptive Graph Mixture of Models](#user-content-link26)
...
27. [BitSnap: Checkpoint Sparsification and Quantization in LLM Training](#user-content-link27)
**Authors:** Qingping Li, Yanxin Peng, Baodong Wu, Shigang Li, Guohao Dai, Shengen Yan, Yu Wang

28. [Harli: Harvest Underutilized Resources in LLM Serving with Finetuning Tasks](#user-content-link28)
**Authors:** Ao Xu, Han Zhao, Weihao Cui, Quan Chen, Yukang Chen, Shulai Zhang, Shuang Chen, Jiemin Jiang, Zhibin Yu, Minyi Guo

29. [Coordinate Descent for Network Linearization](#user-content-link29)
**Authors:** Vlad Rakhlin, Amir Jevnisek, Shai Avidan

30. [Symmetry-Aware Graph Metanetwork Autoencoders: Model Merging through Parameter Canonicalization](#user-content-link30)
**Authors:** Odysseas Boufalis, Jorge Carrasco-Pollo, Joshua Rosenthal, Eduardo Terres-Caballero, Alejandro Garc\'ia-Castellanos

31. [On the Dimension-Free Approximation of Deep Neural Networks for Symmetric Korobov Functions](#user-content-link31)
**Authors:** Yulong Lu, Tong Mao, Jinchao Xu, Yahong Yang

32. [DIGing--SGLD: Decentralized and Scalable Langevin Sampling over Time--Varying Networks](#user-content-link32)
**Authors:** Waheed U. Bajwa, Mert Gurbuzbalaban, Mustafa Ali Kutbay, Lingjiong Zhu, Muhammad Zulqarnain

33. [Leveraging Parameter Space Symmetries for Reasoning Skill Transfer in LLMs](#user-content-link33)
**Authors:** Stefan Horoi, Sangwoo Cho, Supriyo Chakraborty, Shi-Xiong Zhang, Sambit Sahu, Guy Wolf, Genta Indra Winata

34. [Larger Datasets Can Be Repeated More: A Theoretical Analysis of Multi-Epoch Scaling in Linear Regression](#user-content-link34)
**Authors:** Tingkai Yan, Haodong Wen, Binghui Li, Kairong Luo, Wenguang Chen, Kaifeng Lyu

35. [On the Entropy Calibration of Language Models](#user-content-link35)
**Authors:** Steven Cao, Gregory Valiant, Percy Liang

36. [X-VMamba: Explainable Vision Mamba](#user-content-link36)
**Authors:** Mohamed A. Mabrok, Yalda Zafari

37. [BSO: Binary Spiking Online Optimization Algorithm](#user-content-link37)
**Authors:** Yu Liang, Yu Yang, Wenjie Wei, Ammar Belatreche, Shuai Wang, Malu Zhang, Yang Yang

38. [Cmprsr: Abstractive Token-Level Question-Agnostic Prompt Compressor](#user-content-link38)
...
39. [Tab-PET: Graph-Based Positional Encodings for Tabular Transformers](#user-content-link39)
**Authors:** Yunze Leng, Rohan Ghosh, Mehul Motani

40. [PAS: A Training-Free Stabilizer for Temporal Encoding in Video LLMs](#user-content-link40)
**Authors:** Bowen Sun, Yujun Cai, Ming-Hsuan Yang, Hang Wu, Yiwei Wang

41. [Contrastive Entropy Bounds for Density and Conditional Density Decomposition](#user-content-link41)
**Authors:** Bo Hu, Jose C. Principe

42. [Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs](#user-content-link42)
**Authors:** Jeongwhan Choi, Seungjun Park, Sumin Park, Sung-Bae Cho, Noseong Park

43. [BlinDNO: A Distributional Neural Operator for Dynamical System Reconstruction from Time-Label-Free data](#user-content-link43)
**Authors:** Zhijun Zeng, Junqing Chen, Zuoqiang Shi

44. [Sumudu Neural Operator for ODEs and PDEs](#user-content-link44)
**Authors:** Ben Zelenskiy, Saibilila Abudukelimu, George Flint, Kevin Zhu, Sunishchal Dev

45. [SLMQuant:Benchmarking Small Language Model Quantization for Practical Deployment](#user-content-link45)
**Authors:** Jiacheng Wang, Yejun Zeng, Jinyang Guo, Yuqing Ma, Aishan Liu, Xianglong Liu

46. [Genomic Next-Token Predictors are In-Context Learners](#user-content-link46)
**Authors:** Nathan Breslow, Aayush Mishra, Mahler Revsine, Michael C. Schatz, Anqi Liu, Daniel Khashabi

47. [To Align or Not to Align: Strategic Multimodal Representation Alignment for Optimal Performance](#user-content-link47)
**Authors:** Wanlong Fang, Tianle Zhang, Alvin Chan

48. [Retrofit: Continual Learning with Bounded Forgetting for Security Applications](#user-content-link48)
**Authors:** Yiling He, Junchi Lei, Hongyu She, Shuo Shao, Xinran Zheng, Yiping Liu, Zhan Qin, Lorenzo Cavallaro

---

## 1. [Virtual Width Networks](https://arxiv.org/abs/2511.11238) <a id="link1"></a>
...
**Comment:** Model Architecture and Efficiency: Virtual Width Networks decouple representational width from backbone compute, with scaling relation for loss reduction.
...
## 2. [Pre-Attention Expert Prediction and Prefetching for Mixture-of-Experts Large Language Models](https://arxiv.org/abs/2511.10676) <a id="link2"></a>
...
**Comment:** High-Performance MoE Systems: pre-attention expert prediction/prefetching with lightweight linear routers and ranking-aware loss enabling first-layer prefetch and high-accuracy routing.
...
## 3. [EcoSpa: Efficient Transformer Training with Coupled Sparsity](https://arxiv.org/abs/2511.11641) <a id="link3"></a>
...
**Comment:** Model Compression and Efficiency: structured sparsity with coupled pruning of multiplicatively interacting Transformer weight pairs for efficient training/inference.
...
## 4. [SpecQuant: Spectral Decomposition and Adaptive Truncation for Ultra-Low-Bit LLMs Quantization](https://arxiv.org/abs/2511.11663) <a id="link4"></a>
...
**Comment:** Model Compression and Efficiency - ultra-low-bit LLM quantization using spectral (Fourier) decomposition and adaptive truncation for weights/activations.
...
## 5. [On the Fundamental Limits of LLMs at Scale](https://arxiv.org/abs/2511.12869) <a id="link5"></a>
...
**Comment:** Representation Learning/Training Limits: unified theoretical framework on fundamental scaling ceilings (computability, information-theoretic, geometry) with mitigation paths (sparse/hierarchical attention).
...
## 6. [ParaDySe: A Parallel-Strategy Switching Framework for Dynamic Sequence Lengths in Transformer](https://arxiv.org/abs/2511.13198) <a id="link6"></a>
...
**Comment:** High Performance Computing: dynamic, layer-wise parallel strategy switching for LLM training with sequence-aware memory/time cost models and hot-switching runtime.
...
## 7. [Connectivity-Guided Sparsification of 2-FWL GNNs: Preserving Full Expressivity with Improved Efficiency](https://arxiv.org/abs/2511.12838) <a id="link7"></a>
...
**Comment:** Model Compression/Efficiency: topology-guided sparsification of higher-order GNNs preserving full 2-FWL expressivity with theory.
...
## 8. [Understanding InfoNCE: Transition Probability Matrix Induced Feature Clustering](https://arxiv.org/abs/2511.12180) <a id="link8"></a>
...
**Comment:** Representation Learning: theoretical analysis of InfoNCE via transition matrices and a new SC-InfoNCE objective.
...
## 9. [$\pi$-Attention: Periodic Sparse Transformers for Efficient Long-Context Modeling](https://arxiv.org/abs/2511.10696) <a id="link9"></a>
...
**Comment:** Model Architecture/Efficiency: periodic sparse attention with deterministic stride skips and adaptive fusion achieving linear complexity and provable receptive field gains for long-context Transformers.
...
## 10. [Training Instabilities Induce Flatness Bias in Gradient Descent](https://arxiv.org/abs/2511.12558) <a id="link10"></a>
...
**Comment:** Training Dynamics/Representation Learning: shows that large-stepsize-induced instabilities bias GD toward flatter minima (RPE mechanism), extending to SGD/Adam and improving generalization.
...
## 11. [QUILL: An Algorithm-Architecture Co-Design for Cache-Local Deformable Attention](https://arxiv.org/abs/2511.13679) <a id="link11"></a>
...
**Comment:** Algorithm-Architecture Co-Design: cache-local deformable attention accelerator with schedule-aware prefetching and fused kernels achieving large throughput/energy gains and mixed-precision quantization.
...
## 12. [Weight-sparse transformers have interpretable circuits](https://arxiv.org/abs/2511.13653) <a id="link12"></a>
...
**Comment:** Model Compression and Efficiency + Representation Learning: train/prune weight-sparse Transformers to yield interpretable circuits and analyze capability–interpretability tradeoffs.
...
## 13. [PCA++: How Uniformity Induces Robustness to Background Noise in Contrastive Learning](https://arxiv.org/abs/2511.12278) <a id="link13"></a>
...
**Comment:** Representation Learning: proposes uniformity-constrained contrastive PCA (closed-form generalized eigenproblem) with high-dimensional analysis clarifying uniformity’s role.
...
## 14. [T-SAR: A Full-Stack Co-design for CPU-Only Ternary LLM Inference via In-Place SIMD ALU Reorganization](https://arxiv.org/abs/2511.13676) <a id="link14"></a>
...
**Comment:** Model Compression and Efficiency + Systems co-design: CPU-only ternary LLM inference via in-register SIMD LUT generation eliminating memory bottlenecks.
...
## 15. [Stratified Knowledge-Density Super-Network for Scalable Vision Transformers](https://arxiv.org/abs/2511.11683) <a id="link15"></a>
...
**Comment:** Model Compression and Architecture: ViT super-network via weighted PCA attention contraction and importance-aware dropout for stratified knowledge and flexible subnets.
...
## 16. [OTARo: Once Tuning for All Precisions toward Robust On-Device LLMs](https://arxiv.org/abs/2511.13147) <a id="link16"></a>
...
**Comment:** Model Compression and Efficiency - quantization framework (SEFP) enabling multi-precision switching post once-tuning with robustness across bit-widths.
...
## 17. [The Anatomy of a Triton Attention Kernel](https://arxiv.org/abs/2511.11581) <a id="link17"></a>
...
**Comment:** High Performance Computing - Triton-based paged attention kernel with auto-tuning and cross-vendor portability achieving SOTA inference efficiency.
...
## 18. [Decoupling Positional and Symbolic Attention Behavior in Transformers](https://arxiv.org/abs/2511.11579) <a id="link18"></a>
...
**Comment:** Strongly matches Model Architecture analysis and Representation Learning: theoretical and empirical dissection of Transformer attention with RoPE, defining metrics for positional vs symbolic head behavior and causal control via frequency access.
...
## 19. [Sample Complexity of Agnostic Multiclass Classification: Natarajan Dimension Strikes Back](https://arxiv.org/abs/2511.12659) <a id="link19"></a>
...
**Comment:** Foundational Learning Theory: near-tight agnostic multiclass sample complexity in terms of DS and Natarajan dimensions.
...
## 20. [CAO: Curvature-Adaptive Optimization via Periodic Low-Rank Hessian Sketching](https://arxiv.org/abs/2511.12548) <a id="link20"></a>
...
**Comment:** Compression/Efficiency: curvature-adaptive optimizer using periodic low-rank Hessian sketching to precondition gradients with theoretical guarantees.
...
## 21. [Clifford Algebraic Rotor Embeddings : Maybe embeddings should start to CARE](https://arxiv.org/abs/2511.11665) <a id="link21"></a>
...
**Comment:** Model Architecture: generalization of Rotary Positional Embeddings via quaternions and Clifford algebra (CARE).
...
## 22. [Do traveling waves make good positional encodings?](https://arxiv.org/abs/2511.11668) <a id="link22"></a>
...
**Comment:** Model Architecture: new positional encoding (RollPE) framed as traveling waves with equivalence/links to RoPE.
...
## 23. [Uncertainty Makes It Stable: Curiosity-Driven Quantized Mixture-of-Experts](https://arxiv.org/abs/2511.11743) <a id="link23"></a>
...
**Comment:** Model Compression and Efficiency: quantization (4-bit) and uncertainty-driven routing in a quantized Mixture-of-Experts to stabilize latency and save energy.
...
## 24. [Beyond One-Way Pruning: Bidirectional Pruning-Regrowth for Extreme Accuracy-Sparsity Tradeoff](https://arxiv.org/abs/2511.11675) <a id="link24"></a>
...
**Comment:** Model Compression and Efficiency: bidirectional pruning–regrowth strategy to recover accuracy at extreme sparsity, improving accuracy–sparsity tradeoff.
...
## 25. [Likelihood-guided Regularization in Attention Based Models](https://arxiv.org/abs/2511.13221) <a id="link25"></a>
...
**Comment:** Compression/Efficiency: likelihood-guided variational Ising regularization for ViTs enabling structured sparsity and dynamic pruning.
...
## 26. [Self-Adaptive Graph Mixture of Models](https://arxiv.org/abs/2511.13062) <a id="link26"></a>
...
**Comment:** Model Architecture: graph Mixture-of-Models with topology-aware gating and expert pruning; mixture approach across heterogeneous GNNs.
...
## 27. [BitSnap: Checkpoint Sparsification and Quantization in LLM Training](https://arxiv.org/abs/2511.12376) <a id="link27"></a>
...
**Comment:** Model Compression and Efficiency - checkpoint sparsification and quantization tailored to LLM training for storage/memory/fault-tolerance efficiency.
...
## 28. [Harli: Harvest Underutilized Resources in LLM Serving with Finetuning Tasks](https://arxiv.org/abs/2511.11729) <a id="link28"></a>
...
**Comment:** High Performance Computing - systems-level co-location of PEFT finetuning with decode instances via unified memory allocator, latency predictor, and scheduler.
...
## 29. [Coordinate Descent for Network Linearization](https://arxiv.org/abs/2511.11781) <a id="link29"></a>
...
**Comment:** Model Compression and Efficiency - discrete optimization (coordinate descent) to reduce ReLU count for sparsity/latency in private inference.
...
## 30. [Symmetry-Aware Graph Metanetwork Autoencoders: Model Merging through Parameter Canonicalization](https://arxiv.org/abs/2511.12601) <a id="link30"></a>
...
**Comment:** Model Architecture/Representation: parameter-space canonicalization exploiting permutation and scaling symmetries via ScaleGMN autoencoders for robust model merging.
...
## 31. [On the Dimension-Free Approximation of Deep Neural Networks for Symmetric Korobov Functions](https://arxiv.org/abs/2511.12398) <a id="link31"></a>
...
**Comment:** Foundational approximation/generalization theory: dimension-free approximation rates for symmetric functions with symmetric DNNs.
...
## 32. [DIGing--SGLD: Decentralized and Scalable Langevin Sampling over Time--Varying Networks](https://arxiv.org/abs/2511.12836) <a id="link32"></a>
...
**Comment:** High Performance Computing: decentralized SGLD with gradient tracking over time-varying networks and finite-time convergence guarantees.
...
## 33. [Leveraging Parameter Space Symmetries for Reasoning Skill Transfer in LLMs](https://arxiv.org/abs/2511.10850) <a id="link33"></a>
...
**Comment:** Model Architecture/Training Methodology: aligns Transformer parameter spaces via permutation/rotation/scaling symmetries to enable effective task arithmetic and skill transfer.
...
## 34. [Larger Datasets Can Be Repeated More: A Theoretical Analysis of Multi-Epoch Scaling in Linear Regression](https://arxiv.org/abs/2511.13421) <a id="link34"></a>
...
**Comment:** Training dynamics/scaling laws: theoretical analysis of multi-epoch data reuse (effective reuse rate) informing data-scaling under limited data.
...
## 35. [On the Entropy Calibration of Language Models](https://arxiv.org/abs/2511.11966) <a id="link35"></a>
...
**Comment:** Representation Learning/Training Dynamics - entropy calibration theory and scaling for LMs with implications for sampling/truncation strategies.
...
## 36. [X-VMamba: Explainable Vision Mamba](https://arxiv.org/abs/2511.12694) <a id="link36"></a>
...
**Comment:** Model Architecture/Interpretability: controllability-based Jacobian/Gramian analysis for Vision Mamba (SSMs), giving attention-like insights with linear complexity.
...
## 37. [BSO: Binary Spiking Online Optimization Algorithm](https://arxiv.org/abs/2511.12502) <a id="link37"></a>
...
**Comment:** Compression/Efficiency: memory-efficient online training for Binary Spiking Neural Networks via flip-signal updates and temporal-aware thresholds with regret bounds.
...
## 38. [Cmprsr: Abstractive Token-Level Question-Agnostic Prompt Compressor](https://arxiv.org/abs/2511.12281) <a id="link38"></a>
...
**Comment:** Compression/Efficiency: LLM-as-a-compressor for prompt compression with GRPO/SFT to balance target compression rate and downstream fidelity.
...
## 39. [Tab-PET: Graph-Based Positional Encodings for Tabular Transformers](https://arxiv.org/abs/2511.13338) <a id="link39"></a>
...
**Comment:** Model Architecture: graph-derived positional encodings for tabular Transformers with theory (effective-rank reduction).
...
## 40. [PAS: A Training-Free Stabilizer for Temporal Encoding in Video LLMs](https://arxiv.org/abs/2511.10979) <a id="link40"></a>
...
**Comment:** Model Architecture/Representation Learning: analyzes multimodal RoPE’s induced time kernel and introduces a training-free, multi-phase aggregation to stabilize attention under temporal shifts (theoretical Lipschitz stability).
...
## 41. [Contrastive Entropy Bounds for Density and Conditional Density Decomposition](https://arxiv.org/abs/2511.12903) <a id="link41"></a>
...
**Comment:** Representation Learning Theory: Hilbert-space operator formulation connecting autoencoders and MDNs with trace/nuclear-norm objectives and contrastive entropy bounds.
...
## 42. [Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs](https://arxiv.org/abs/2511.13010) <a id="link42"></a>
...
**Comment:** Model Architecture: augments MPNNs with fractal nodes to enable efficient long-range message passing and mitigate over-squashing, challenging the need for graph Transformers.
...
## 43. [BlinDNO: A Distributional Neural Operator for Dynamical System Reconstruction from Time-Label-Free data](https://arxiv.org/abs/2511.12316) <a id="link43"></a>
...
**Comment:** Model Architecture: permutation-invariant distribution-to-function neural operator with attention-based mixer for inverse dynamics without time labels.
...
## 44. [Sumudu Neural Operator for ODEs and PDEs](https://arxiv.org/abs/2511.11762) <a id="link44"></a>
...
**Comment:** Model Architecture: proposes Sumudu Neural Operator, a new operator class for ODE/PDE solving and zero-shot super-resolution.
...
## 45. [SLMQuant:Benchmarking Small Language Model Quantization for Practical Deployment](https://arxiv.org/abs/2511.13023) <a id="link45"></a>
...
**Comment:** Model Compression and Efficiency: first benchmark focused on quantization of small language models; identifies sensitivity differences and design principles.
...
## 46. [Genomic Next-Token Predictors are In-Context Learners](https://arxiv.org/abs/2511.12797) <a id="link46"></a>
...
**Comment:** Representation Learning/Training dynamics: demonstrates emergent in-context learning from next-token prediction in genomic sequences under controlled tasks.
...
## 47. [To Align or Not to Align: Strategic Multimodal Representation Alignment for Optimal Performance](https://arxiv.org/abs/2511.12121) <a id="link47"></a>
...
**Comment:** Representation Learning: controlled contrastive module to tune cross-modal alignment strength; identifies optimal alignment vs redundancy trade-offs.
...
## 48. [Retrofit: Continual Learning with Bounded Forgetting for Security Applications](https://arxiv.org/abs/2511.11439) <a id="link48"></a>
...
**Comment:** Compression/Efficiency: parameter-level merging with low-rank and sparse updates enabling data-free continual learning with bounded forgetting.
