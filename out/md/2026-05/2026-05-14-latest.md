...
1. [A Unified Framework for Critical Scaling of Inverse Temperature in Self-Attention](#paper-2605-12697)
**Authors:** Tomohiro Hayase, Ryo Karakida

2. [Effective Context in Transformers: An Analysis of Fragmentation and Tokenization](#paper-2605-13485)
**Authors:** Amirmehdi Jafari Fesharaki, Mohammadamin Rami, Aslan Tchamkerten

3. [ASAP: Amortized Doubly-Stochastic Attention via Sliced Dual Projection](#paper-2605-12879)
**Authors:** Huy Tran, Max Milkert, David Hyde

4. [State-Space NTK Collapse Near Bifurcations](#paper-2605-12763)
**Authors:** James Hazelden, Eric Shea-Brown

5. [Spectral Flattening Is All Muon Needs: How Orthogonalization Controls Learning Rate and Convergence](#paper-2605-13079)
**Authors:** Tien-Phat Nguyen, Truong Nguyen, Minh-Phuc Truong, Tuc Nguyen, James Bailey, Trung Le

6. [Parallel-in-Time Training of Recurrent Neural Networks for Dynamical Systems Reconstruction](#paper-2605-12683)
**Authors:** Florian Hess, Florian G\"otz, Daniel Durstewitz

7. [EMO: Frustratingly Easy Progressive Training of Extendable MoE](#paper-2605-13247)
**Authors:** Linghao Jin, Chufan Shi, Huijuan Wang, Nuan Wen, Zhengzhong Liu, Eric Xing, Xuezhe Ma

8. [The critical slowing down in diffusion models](#paper-2605-12597)
**Authors:** Luca Maria Del Bono, Giulio Biroli, Patrick Charbonneau, Marylou Gabri\'e

9. [Inference-Time Machine Unlearning via Gated Activation Redirection](#paper-2605-12765)
...
10. [Negation Neglect: When models fail to learn negations in training](#paper-2605-13829)
**Authors:** Harry Mayne, Lev McKinney, Jan Dubi\'nski, Adam Karvonen, James Chua, Owain Evans

11. [Discrete Stochastic Localization for Non-autoregressive Generation](#paper-2605-12836)
...
1. [Rescaled Asynchronous SGD: Optimal Distributed Optimization under Data and System Heterogeneity](#paper-2605-13434)
**Authors:** Ammar Mahran, Artavazd Maranjyan, Peter Richt\'arik

2. [Attention Once Is All You Need: Efficient Streaming Inference with Stateful Transformers](#paper-2605-13784)
**Authors:** Victor Norgren

3. [DP-Muon: Differentially Private Optimization via Matrix-Orthogonalized Momentum](#paper-2605-12994)
**Authors:** Jihwan Kim, Chenglin Fan

4. [Provable Quantization with Randomized Hadamard Transform](#paper-2605-13810)
**Authors:** Ying Feng, Piotr Indyk, Michael Kapralov, Dmitry Krachun, Boris Prokhorov

5. [Scaling Laws for Mixture Pretraining Under Data Constraints](#paper-2605-12715)
**Authors:** Anastasiia Sedova, Skyler Seto, Natalie Schluter, Pierre Ablin

6. [DP-KFC: Data-Free Preconditioning for Privacy-Preserving Deep Learning](#paper-2605-13418)
...
7. [KVServe: Service-Aware KV Cache Compression for Communication-Efficient Disaggregated LLM Serving](#paper-2605-13734)
...
1. [The Mechanism of Weak-to-Strong Generalization: Feature Elicitation from Latent Knowledge](#paper-2605-12908)
**Authors:** Ryoya Awano, Taiji Suzuki

2. [WriteSAE: Sparse Autoencoders for Recurrent State](#paper-2605-12770)
**Authors:** Jack Young
...
4. [From Generalist to Specialist Representation](#paper-2605-12733)
...
6. [Support-Conditioned Flow Matching Is Kernel Smoothing](#paper-2605-13386)
**Authors:** Daniel Matsui Smola

## [Memory Structures and Agent Memory Systems](#topic-memory-systems) (2)

1. [Cognifold: Always-On Proactive Memory via Cognitive Folding](#paper-2605-13438)
**Authors:** Suli Wang, Yiqun Duan, Yu Deng, Rundong Zhao, Dai Shi, Xinliang Zhou

2. [When Attention Closes: How LLMs Lose the Thread in Multi-Turn Interaction](#paper-2605-12922)
...
1. [Delightful Exploration](#paper-2605-13287)
**Authors:** Ian Osband

2. [Ergodic Trajectory Design by Learned Pushforward Maps: Provable Coverage via Conditional Flow Matching](#paper-2605-13063)
**Authors:** Ehsan Aghazadeh, Masoud Malekzadeh, Ahmad Ghasemi, Hossein Pishro-Nik

3. [Q-Flow: Stable and Expressive Reinforcement Learning with Flow-Based Policy](#paper-2605-13435)
**Authors:** JaeHyeok Doo, Byeongguk Jeon, Seonghyeon Ye, Kimin Lee, Minjoon Seo

4. [State-Centric Decision Process](#paper-2605-12755)
**Authors:** Sungheon Jeong, Ryozo Masukawa, Sanggeon Yun, Mahdi Imani, Mohsen Imani

5. [Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning](#paper-2605-13335)
**Authors:** Qinchuan Cheng, Zhantao Gong, Pengzhan Sun, Angela Yao, Xulei Yang, Shijie Li

6. [Macro-Action Based Multi-Agent Instruction Following through Value Cancellation](#paper-2605-12655)
**Authors:** Wo Wei Lin, Ethan Rathbun, Enrico Marchesini Xiang Zhi Tan

7. [Self-Supervised On-Policy Reinforcement Learning via Contrastive Proximal Policy Optimisation](#paper-2605-13554)
...
### 1. [A Unified Framework for Critical Scaling of Inverse Temperature in Self-Attention](https://arxiv.org/abs/2605.12697) <a id="paper-2605-12697"></a>
...
### 2. [Effective Context in Transformers: An Analysis of Fragmentation and Tokenization](https://arxiv.org/abs/2605.13485) <a id="paper-2605-13485"></a>
...
### 3. [ASAP: Amortized Doubly-Stochastic Attention via Sliced Dual Projection](https://arxiv.org/abs/2605.12879) <a id="paper-2605-12879"></a>
...
### 4. [State-Space NTK Collapse Near Bifurcations](https://arxiv.org/abs/2605.12763) <a id="paper-2605-12763"></a>
...
### 5. [Spectral Flattening Is All Muon Needs: How Orthogonalization Controls Learning Rate and Convergence](https://arxiv.org/abs/2605.13079) <a id="paper-2605-13079"></a>
...
### 6. [Parallel-in-Time Training of Recurrent Neural Networks for Dynamical Systems Reconstruction](https://arxiv.org/abs/2605.12683) <a id="paper-2605-12683"></a>
...
### 7. [EMO: Frustratingly Easy Progressive Training of Extendable MoE](https://arxiv.org/abs/2605.13247) <a id="paper-2605-13247"></a>
...
### 8. [The critical slowing down in diffusion models](https://arxiv.org/abs/2605.12597) <a id="paper-2605-12597"></a>
...
### 9. [Inference-Time Machine Unlearning via Gated Activation Redirection](https://arxiv.org/abs/2605.12765) <a id="paper-2605-12765"></a>
...
### 10. [Negation Neglect: When models fail to learn negations in training](https://arxiv.org/abs/2605.13829) <a id="paper-2605-13829"></a>
...
### 11. [Discrete Stochastic Localization for Non-autoregressive Generation](https://arxiv.org/abs/2605.12836) <a id="paper-2605-12836"></a>
...
### 1. [Rescaled Asynchronous SGD: Optimal Distributed Optimization under Data and System Heterogeneity](https://arxiv.org/abs/2605.13434) <a id="paper-2605-13434"></a>
...
### 2. [Attention Once Is All You Need: Efficient Streaming Inference with Stateful Transformers](https://arxiv.org/abs/2605.13784) <a id="paper-2605-13784"></a>
...
### 3. [DP-Muon: Differentially Private Optimization via Matrix-Orthogonalized Momentum](https://arxiv.org/abs/2605.12994) <a id="paper-2605-12994"></a>
...
### 4. [Provable Quantization with Randomized Hadamard Transform](https://arxiv.org/abs/2605.13810) <a id="paper-2605-13810"></a>
...
### 5. [Scaling Laws for Mixture Pretraining Under Data Constraints](https://arxiv.org/abs/2605.12715) <a id="paper-2605-12715"></a>
...
### 6. [DP-KFC: Data-Free Preconditioning for Privacy-Preserving Deep Learning](https://arxiv.org/abs/2605.13418) <a id="paper-2605-13418"></a>
...
### 7. [KVServe: Service-Aware KV Cache Compression for Communication-Efficient Disaggregated LLM Serving](https://arxiv.org/abs/2605.13734) <a id="paper-2605-13734"></a>
...
### 1. [The Mechanism of Weak-to-Strong Generalization: Feature Elicitation from Latent Knowledge](https://arxiv.org/abs/2605.12908) <a id="paper-2605-12908"></a>
...
### 2. [WriteSAE: Sparse Autoencoders for Recurrent State](https://arxiv.org/abs/2605.12770) <a id="paper-2605-12770"></a>
...
### 4. [From Generalist to Specialist Representation](https://arxiv.org/abs/2605.12733) <a id="paper-2605-12733"></a>
...
### 6. [Support-Conditioned Flow Matching Is Kernel Smoothing](https://arxiv.org/abs/2605.13386) <a id="paper-2605-13386"></a>
...
### 1. [Cognifold: Always-On Proactive Memory via Cognitive Folding](https://arxiv.org/abs/2605.13438) <a id="paper-2605-13438"></a>
...
### 2. [When Attention Closes: How LLMs Lose the Thread in Multi-Turn Interaction](https://arxiv.org/abs/2605.12922) <a id="paper-2605-12922"></a>
...
### 1. [Delightful Exploration](https://arxiv.org/abs/2605.13287) <a id="paper-2605-13287"></a>
...
### 2. [Ergodic Trajectory Design by Learned Pushforward Maps: Provable Coverage via Conditional Flow Matching](https://arxiv.org/abs/2605.13063) <a id="paper-2605-13063"></a>
...
### 3. [Q-Flow: Stable and Expressive Reinforcement Learning with Flow-Based Policy](https://arxiv.org/abs/2605.13435) <a id="paper-2605-13435"></a>
...
### 4. [State-Centric Decision Process](https://arxiv.org/abs/2605.12755) <a id="paper-2605-12755"></a>
...
### 5. [Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning](https://arxiv.org/abs/2605.13335) <a id="paper-2605-13335"></a>
...
### 6. [Macro-Action Based Multi-Agent Instruction Following through Value Cancellation](https://arxiv.org/abs/2605.12655) <a id="paper-2605-12655"></a>
...
### 7. [Self-Supervised On-Policy Reinforcement Learning via Contrastive Proximal Policy Optimisation](https://arxiv.org/abs/2605.13554) <a id="paper-2605-13554"></a>
