<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../26"><img src="../../../assets/nav/day/2026-01-27-prev.svg" alt="Previous Day 2026-01-26"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-01-27-center.svg" alt="Monthly Overview 2026-01"></a></div><div style="width: 33.33%; text-align: right;"><a href="../28"><img src="../../../assets/nav/day/2026-01-27-next.svg" alt="Next Day 2026-01-28"></a></div></div>
...
## 1. [LongCat-Flash-Thinking-2601 Technical Report](https://arxiv.org/abs/2601.16725) <a id="link1"></a>
...
## 2. [Superlinear Multi-Step Attention](https://arxiv.org/abs/2601.18401) <a id="link2"></a>
...
## 3. [LatentMoE: Toward Optimal Accuracy per FLOP and Parameter in Mixture of Experts](https://arxiv.org/abs/2601.18089) <a id="link3"></a>
...
## 4. [GRIP: Algorithm-Agnostic Machine Unlearning for Mixture-of-Experts via Geometric Router Constraints](https://arxiv.org/abs/2601.16905) <a id="link4"></a>
...
## 5. [Space Filling Curves is All You Need: Communication-Avoiding Matrix Multiplication Made Simple](https://arxiv.org/abs/2601.16294) <a id="link5"></a>
...
## 6. [Crystal-KV: Efficient KV Cache Management for Chain-of-Thought LLMs via Answer-First Principle](https://arxiv.org/abs/2601.16986) <a id="link6"></a>
...
## 7. [Sparsity-Aware Low-Rank Representation for Efficient Fine-Tuning of Large Language Models](https://arxiv.org/abs/2601.16991) <a id="link7"></a>
...
## 8. [FlashMoE: Reducing SSD I/O Bottlenecks via ML-Based Cache Replacement for Mixture-of-Experts Inference on Edge Devices](https://arxiv.org/abs/2601.17063) <a id="link8"></a>
...
## 9. [Least-Loaded Expert Parallelism: Load Balancing An Imbalanced Mixture-of-Experts](https://arxiv.org/abs/2601.17111) <a id="link9"></a>
...
## 10. [$\infty$-MoE: Generalizing Mixture of Experts to Infinite Experts](https://arxiv.org/abs/2601.17680) <a id="link10"></a>
...
## 11. [AGZO: Activation-Guided Zeroth-Order Optimization for LLM Fine-Tuning](https://arxiv.org/abs/2601.17261) <a id="link11"></a>
...
## 12. [A Scalable Measure of Loss Landscape Curvature for Analyzing the Training Dynamics of LLMs](https://arxiv.org/abs/2601.16979) <a id="link12"></a>
...
## 13. [FP8-RL: A Practical and Stable Low-Precision Stack for LLM Reinforcement Learning](https://arxiv.org/abs/2601.18150) <a id="link13"></a>
...
## 14. [LipNeXt: Scaling up Lipschitz-based Certified Robustness to Billion-parameter Models](https://arxiv.org/abs/2601.18513) <a id="link14"></a>
...
## 15. [Neural Network Approximation: A View from Polytope Decomposition](https://arxiv.org/abs/2601.18264) <a id="link15"></a>
...
## 16. [Power-based Partial Attention: Bridging Linear-Complexity and Full Attention](https://arxiv.org/abs/2601.17334) <a id="link16"></a>
...
## 17. [S$^3$-Attention:Attention-Aligned Endogenous Retrieval for Memory-Bounded Long-Context Inference](https://arxiv.org/abs/2601.17702) <a id="link17"></a>
...
## 18. [E2Former-V2: On-the-Fly Equivariant Attention with Linear Activation Memory](https://arxiv.org/abs/2601.16622) <a id="link18"></a>
...
## 19. [Finite-Time Analysis of Gradient Descent for Shallow Transformers](https://arxiv.org/abs/2601.16514) <a id="link19"></a>
...
## 20. [A Collision-Free Hot-Tier Extension for Engram-Style Conditional Memory: A Controlled Study of Training Dynamics](https://arxiv.org/abs/2601.16531) <a id="link20"></a>
...
## 21. [Fast KVzip: Efficient and Accurate LLM Inference with Gated KV Eviction](https://arxiv.org/abs/2601.17668) <a id="link21"></a>
...
## 22. [From LLMs to LRMs: Rethinking Pruning for Reasoning-Centric Models](https://arxiv.org/abs/2601.18091) <a id="link22"></a>
...
## 23. [Jacobian Scopes: token-level causal attributions in LLMs](https://arxiv.org/abs/2601.16407) <a id="link23"></a>
...
## 24. [Split-on-Share: Mixture of Sparse Experts for Task-Agnostic Continual Learning](https://arxiv.org/abs/2601.17616) <a id="link24"></a>
...
## 25. [TensorLens: End-to-End Transformer Analysis via High-Order Attention Tensors](https://arxiv.org/abs/2601.17958) <a id="link25"></a>
...
## 26. [Low-Rank Tensor Approximation of Weights in Large Language Models via Cosine Lanczos Bidiagonalization](https://arxiv.org/abs/2601.17112) <a id="link26"></a>
...
## 27. [LLM-42: Enabling Determinism in LLM Inference with Verified Speculation](https://arxiv.org/abs/2601.17768) <a id="link27"></a>
...
## 28. [Stability as a Liability:Systematic Breakdown of Linguistic Structure in LLMs](https://arxiv.org/abs/2601.18588) <a id="link28"></a>
...
## 29. [Nonlinear multi-study factor analysis](https://arxiv.org/abs/2601.18128) <a id="link29"></a>
...
## 30. [NewPINNs: Physics-Informing Neural Networks Using Conventional Solvers for Partial Differential Equations](https://arxiv.org/abs/2601.17207) <a id="link30"></a>
...
## 31. [Attention-MoA: Enhancing Mixture-of-Agents via Inter-Agent Semantic Attention and Deep Residual Synthesis](https://arxiv.org/abs/2601.16596) <a id="link31"></a>
...
## 32. [Gradient Regularized Natural Gradients](https://arxiv.org/abs/2601.18420) <a id="link32"></a>
...
## 33. [A Constrained Optimization Perspective of Unrolled Transformers](https://arxiv.org/abs/2601.17257) <a id="link33"></a>
...
## 34. [Process-Tensor Tomography of SGD: Measuring Non-Markovian Memory via Back-Flow of Distinguishability](https://arxiv.org/abs/2601.16563) <a id="link34"></a>
...
## 35. [Sparse RBF Networks for PDEs and nonlocal equations: function space theory, operator calculus, and training algorithms](https://arxiv.org/abs/2601.17562) <a id="link35"></a>
...
## 36. [Spelling Bee Embeddings for Language Modeling](https://arxiv.org/abs/2601.18030) <a id="link36"></a>
...
## 37. [Kareus: Joint Reduction of Dynamic and Static Energy in Large Model Training](https://arxiv.org/abs/2601.17654) <a id="link37"></a>
