<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../13"><img src="../../../assets/nav/day/2026-01-14-prev.svg" alt="Previous Day 2026-01-13"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-01-14-center.svg" alt="Monthly Overview 2026-01"></a></div><div style="width: 33.33%; text-align: right;"><a href="../15"><img src="../../../assets/nav/day/2026-01-14-next.svg" alt="Next Day 2026-01-15"></a></div></div>
...
## 1. [Hierarchical Sparse Plus Low Rank Compression of LLM](https://arxiv.org/abs/2601.07839) <a id="link1"></a>
...
## 2. [Reasoning Beyond Chain-of-Thought: A Latent Computational Mode in Large Language Models](https://arxiv.org/abs/2601.08058) <a id="link2"></a>
...
## 3. [Sherry: Hardware-Efficient 1.25-Bit Ternary Quantization via Fine-grained Sparsification](https://arxiv.org/abs/2601.07892) <a id="link3"></a>
...
## 4. [WaveFormer: Frequency-Time Decoupled Vision Modeling with Wave Equation](https://arxiv.org/abs/2601.08602) <a id="link4"></a>
...
## 5. [Towards Principled Design of Mixture-of-Experts Language Models under Memory and Inference Constraints](https://arxiv.org/abs/2601.08215) <a id="link5"></a>
...
## 6. [KVzap: Fast, Adaptive, and Faithful KV Cache Pruning](https://arxiv.org/abs/2601.07891) <a id="link6"></a>
...
## 7. [Towards Specialized Generalists: A Multi-Task MoE-LoRA Framework for Domain-Specific LLM Adaptation](https://arxiv.org/abs/2601.07935) <a id="link7"></a>
...
## 8. [Demystifying the Slash Pattern in Attention: The Role of RoPE](https://arxiv.org/abs/2601.08297) <a id="link8"></a>
...
## 9. [Multiplex Thinking: Reasoning via Token-wise Branch-and-Merge](https://arxiv.org/abs/2601.08808) <a id="link9"></a>
...
## 10. [Controlled LLM Training on Spectral Sphere](https://arxiv.org/abs/2601.08393) <a id="link10"></a>
...
## 11. [LDLT L-Lipschitz Network Weight Parameterization Initialization](https://arxiv.org/abs/2601.08253) <a id="link11"></a>
...
## 12. [Parallel Context-of-Experts Decoding for Retrieval Augmented Generation](https://arxiv.org/abs/2601.08670) <a id="link12"></a>
...
## 13. [Towards A Unified PAC-Bayesian Framework for Norm-based Generalization Bounds](https://arxiv.org/abs/2601.08100) <a id="link13"></a>
...
## 14. [M$^2$FMoE: Multi-Resolution Multi-View Frequency Mixture-of-Experts for Extreme-Adaptive Time Series Forecasting](https://arxiv.org/abs/2601.08631) <a id="link14"></a>
...
## 15. [Deconstructing Pre-training: Knowledge Attribution Analysis in MoE and Dense Models](https://arxiv.org/abs/2601.08383) <a id="link15"></a>
...
## 16. [Sliced-Wasserstein Distribution Alignment Loss Improves the Ultra-Low-Bit Quantization of Large Language Models](https://arxiv.org/abs/2601.07878) <a id="link16"></a>
...
## 17. [YaPO: Learnable Sparse Activation Steering Vectors for Domain Adaptation](https://arxiv.org/abs/2601.08441) <a id="link17"></a>
...
## 18. [HIPPO: Accelerating Video Large Language Models Inference via Holistic-aware Parallel Speculative Decoding](https://arxiv.org/abs/2601.08273) <a id="link18"></a>
...
## 19. [Deep Exploration of Epoch-wise Double Descent in Noisy Data: Signal Separation, Large Activation, and Benign Overfitting](https://arxiv.org/abs/2601.08316) <a id="link19"></a>
...
## 20. [ORBIT: On-policy Exploration-Exploitation for Controllable Multi-Budget Reasoning](https://arxiv.org/abs/2601.08310) <a id="link20"></a>
...
## 21. [Hyperbolic Heterogeneous Graph Transformer](https://arxiv.org/abs/2601.08251) <a id="link21"></a>
...
## 22. [Representations of Text and Images Align From Layer One](https://arxiv.org/abs/2601.08017) <a id="link22"></a>
...
## 23. [NOVAK: Unified adaptive optimizer for deep neural networks](https://arxiv.org/abs/2601.07876) <a id="link23"></a>
...
## 24. [Mechanisms are Transferable: Data-Efficient Low-Resource Adaptation via Circuit-Targeted Supervised Fine-Tuning](https://arxiv.org/abs/2601.08146) <a id="link24"></a>
...
## 25. [Supervised Spike Agreement Dependent Plasticity for Fast Local Learning in Spiking Neural Networks](https://arxiv.org/abs/2601.08526) <a id="link25"></a>
