...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">401050</td>
            <td align="center">39246</td>
            <td align="center">440296</td>
            <td rowspan="2" align="center">1047</td>
            <td rowspan="2" align="center">672</td>
...
<table>
    ...
    <tbody>
        <tr><td><a href="#topic-architecture-training">Architecture and Training Dynamics</a></td><td align="center">51</td></tr>
...
## [Architecture and Training Dynamics](#topic-architecture-training) (51)

1. [Revisiting Transformer Layer Parameterization Through Causal Energy Minimization](#paper-2605-07588)
**Authors:** Jin Xu, Camille Couturier, Victor R\"uhle, Saravan Rajmohan, James Hensman

2. [OrScale: Orthogonalised Optimization with Layer-Wise Trust-Ratio Scaling](#paper-2605-07815)
**Authors:** Yuxuan Lou, Yang You

3. [Toeplitz MLP Mixers are Low Complexity, Information-Rich Sequence Models](#paper-2605-06683)
**Authors:** Benjamin L. Badger, Ethan Roland

4. [Tool Calling is Linearly Readable and Steerable in Language Models](#paper-2605-07990)
...
5. [Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions](#paper-2605-07984)
**Authors:** Nicole Ma, Nick Rui

6. [Fast Byte Latent Transformer](#paper-2605-08044)
...
7. [Pretraining Induces a Reusable Spectral Basis for Downstream Task Adaptation](#paper-2605-07302)
**Authors:** Junjie Yu, Yue Wang, Zihan Deng, Yan Zhu, Wenxiao Ma, Quanying Liu

8. [Training-Induced Escape from Token Clustering in a Mean-Field Formulation of Transformers](#paper-2605-07772)
**Authors:** Noboru Isobe, Daisuke Inoue, Masaaki Imaizumi

9. [STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation](#paper-2605-08029)
...
10. [The Position Curse: LLMs Struggle to Locate the Last Few Items in a List](#paper-2605-07127)
**Authors:** Zhanqi Zhang, Hua-Dong Xiong, Robert C. Wilson, Mikio Aoi, Marcelo G. Mattar, Li Ji-An

11. [Cross-Attention and Encoder-Decoder Transformers: A Logical Characterization](#paper-2605-07705)
**Authors:** Veeti Ahvonen, Damian Heiman, Antti Kuusisto, Miguel Moreno, Matias Selin

12. [A Rod Flow Model for Adam at the Edge of Stability](#paper-2605-06821)
**Authors:** Eric Regis, Sinho Chewi

13. [Beyond LoRA vs. Full Fine-Tuning: Gradient-Guided Optimizer Routing for LLM Adaptation](#paper-2605-07111)
**Authors:** Haozhan Tang, Xiuqi Zhu, Xinyin Zhang, Boxun Li, Virginia Smith, Kevin Kuo

14. [PolarAdamW: Disentangling Spectral Control and Schur Gauge-Equivariance in Matrix Optimisation](#paper-2605-07067)
**Authors:** Haozhou Zhang

15. [GazeVLM: Active Vision via Internal Attention Control for Multimodal Reasoning](#paper-2605-07817)
**Authors:** Brown Ebouky, Gabriele Carrino, Niccolo Avogaro, Christoph Studer, Andrea Bartezzaghi, Mattia Rigotti

16. [Does Your Neural Network Extrapolate? Feature Engineering as Identifiability Bias for OOD Generalization](#paper-2605-07483)
**Authors:** Leonel Aguilar, Jan Nagler, Christoph Hoelscher, Nino Antulov-Fantulin

17. [When Does a Language Model Commit? A Finite-Answer Theory of Pre-Verbalization Commitment](#paper-2605-06723)
**Authors:** Long Zhang, Wei-neng Chen, Feng-feng Wei, Zi-bo Qin

18. [Learning Large-Scale Modular Addition with an Auxiliary Modulus](#paper-2605-07648)
**Authors:** Hanato Kikuchi, Ryosuke Masuya, Kazuhiko Kawamoto, Hiroshi Kera

19. [Rethinking State Tracking in Recurrent Models Through Error Control Dynamics](#paper-2605-07755)
**Authors:** Jiwan Chung, Heechan Choi, Seon Joo Kim

20. [Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training](#paper-2605-07063)
**Authors:** Pingbang Hu, Xueshen Liu, Z. Morley Mao, Jiaqi W. Ma

21. [KL for a KL: On-Policy Distillation with Control Variate Baseline](#paper-2605-07865)
**Authors:** Minjae Oh, Sangjun Song, Gyubin Choi, Yunho Choi, Yohan Jo

22. [Muon with Nesterov Momentum: Heavy-Tailed Noise and (Randomized) Inexact Polar Decomposition](#paper-2605-06884)
**Authors:** Sayantan Choudhury, Xiaoran Cheng, Martin Tak\'a\v{c}, Sen Na, Mladen Kolar

23. [Continuous First, Discrete Later: VQ-VAEs Without Dimensional Collapse](#paper-2605-06870)
**Authors:** Xinyu Zhao, Nikita Karagodin, Hamed Hassani, Sinan Hersek, Paul Pu Liang, Yury Polyanskiy

24. [Randomness is sometimes necessary for coordination](#paper-2605-06825)
**Authors:** Rohan Patil, Jai Malegaonkar, Henrik I. Christensen

25. [Characterizing and Correcting Effective Target Shift in Online Learning](#paper-2605-07886)
**Authors:** Ziyan Li, Naoki Hiratani

26. [Tree SAE: Learning Hierarchical Feature Structures in Sparse Autoencoders](#paper-2605-07922)
**Authors:** Tue M. Cao, Hoang X. Nhat, Raed Alharbi, My T. Thai

27. [Bilevel Graph Structure Learning, Revisited: Inner-Channel Origins of the Reported Gain](#paper-2605-07577)
**Authors:** Minkyoung Kim, Beakcheol Jang

28. [When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification](#paper-2605-07120)
**Authors:** Wenjie Guan, Jelena Bradic

29. [PLOT: Progressive Localization via Optimal Transport in Neural Causal Abstraction](#paper-2605-06979)
**Authors:** Jonathn Chang, Arya Datla, Ziv Goldfeld

30. [MEMOREPAIR: Barrier-First Cascade Repair in Agentic Memory](#paper-2605-07242)
**Authors:** Yang Zhao, Chengxiao Dai, Mengying Kou, Yue Xiu

31. [Every Feedforward Neural Network Definable in an o-Minimal Structure Has Finite Sample Complexity](#paper-2605-07097)
**Authors:** Anastasis Kratsios, Gregory Cousins, Haitz S\'aez de Oc\'ariz Borde, Bum Jun Kim, Simone Brugiapaglia

32. [CASCADE: Case-Based Continual Adaptation for Large Language Models During Deployment](#paper-2605-06702)
**Authors:** Siyuan Guo, Yali Du, Hechang Chen, Yi Chang, Jun Wang

33. [Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning](#paper-2605-07980)
**Authors:** Chris Elliott, Daniel Murfet

34. [Extracting Search Trees from LLM Reasoning Traces Reveals Myopic Planning](#paper-2605-06840)
**Authors:** Sixing Chen, Ji-An Li, Saner Cakir, Sinan Akcali, Kayla Lee, Marcelo G. Mattar

35. [Convergence and Emergence of In-Context Reinforcement Learning with Chain of Thought](#paper-2605-07123)
**Authors:** Zixuan Xie, Xinyu Liu, Rohan Chandra, Shangtong Zhang

36. [Predictive but Not Plannable: RC-aux for Latent World Models](#paper-2605-07278)
**Authors:** Wenyuan Li, Guang Li, Keisuke Maeda, Takahiro Ogawa, Miki Haseyama

37. [Bifurcation Models: Learning Set-Valued Solution Maps with Weight-Tied Dynamics](#paper-2605-07277)
**Authors:** Caleb Jore, Jialin Liu

38. [Why DDIM Hallucinates More than DDPM: A Theoretical Analysis of Reverse Dynamics](#paper-2605-06831)
**Authors:** Muhammad H. Ashiq, Samanyu Arora, Abhinav N. Harish, Ishaan Kharbanda, Hung Yun Tseng, Grigorios G. Chrysos

39. [Structured Coupling for Flow Matching](#paper-2605-07676)
**Authors:** Xavier Sumba, Carles Balsells-Rodas, Yingzhen Li

40. [Self-Programmed Execution for Language-Model Agents](#paper-2605-06898)
**Authors:** Luke J. O'Connor

41. [A Theory of Online Learning with Autoregressive Chain-of-Thought Reasoning](#paper-2605-06819)
**Authors:** Ilan Doron-Arad, Idan Mehalel, Elchanan Mossel

42. [Drifting Field Policy: A One-Step Generative Policy via Wasserstein Gradient Flow](#paper-2605-07727)
**Authors:** Juil Koo, Mingue Park, Jiwon Choi, Yunhong Min, Minhyuk Sung

43. [Normalizing Trajectory Models](#paper-2605-08078)
**Authors:** Jiatao Gu, Tianrong Chen, Ying Shen, David Berthelot, Shuangfei Zhai, Josh Susskind

44. [Distributional simplicity bias and effective convexity in Energy Based Models](#paper-2605-07844)
**Authors:** Aur\'elien Decelle, Alfonso de Jes\'us Navas G\'omez, Beatriz Seoane

45. [AGWM: Affordance-Grounded World Models for Environments with Compositional Prerequisites](#paper-2605-06841)
...
46. [Learned Lagrangian Models of PDEs via Euler-Lagrange Residual Minimization](#paper-2605-07157)
**Authors:** Lyra Zhornyak, Eric Forgoston, M. Ani Hsieh

47. [Learning Visual Feature-Based World Models via Residual Latent Action](#paper-2605-07079)
**Authors:** Xinyu Zhang, Zhengtong Xu, Yutian Tao, Yeping Wang, Yu She, Abdeslam Boularias

48. [On the Divergence of Differential Temporal Difference Learning without Local Clocks](#paper-2605-06874)
**Authors:** David Antrobius, Shangtong Zhang

49. [Interpreting Reinforcement Learning Agents with Susceptibilities](#paper-2605-08007)
**Authors:** Chris Elliott, Einar Urdshals, David Quarel, Daniel Murfet

50. [Globally Optimal Training of Spiking Neural Networks via Parameter Reconstruction](#paper-2605-08022)
**Authors:** Himanshu Udupi, Xiaocong Yang, ChengXiang Zhai

51. [Finite-Time Analysis of MCTS in Continuous POMDP Planning](#paper-2605-07703)
**Authors:** Da Kong, Vadim Indelman

## [Training Algorithms That Change What Is Possible](#topic-training-systems) (2)

1. [Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?](#paper-2605-07072)
**Authors:** Andy Dong, Ayfer \"Ozg\"ur

2. [Resource-Element Energy Difference for Noncoherent Over-the-Air Federated Learning](#paper-2605-07263)
**Authors:** Hao Chen, Zavareh Bozorgasl

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (10)

1. [Star Elastic: Many-in-One Reasoning LLMs with Efficient Budget Control](#paper-2605-07182)
...
2. [MISA: Mixture of Indexer Sparse Attention for Long-Context LLM Inference](#paper-2605-07363)
**Authors:** Ruijie Zhou, Fanxu Meng, Yufei Xu, Tongxuan Liu, Guangming Lu, Muhan Zhang, Wenjie Pei

3. [The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](#paper-2605-07686)
**Authors:** Wenhua Nie, Junlin Liu, Jianan Wu, Zijie Meng, Yilong Fan, Zhang Zijian, Haoran Zheng, Jyh-Shing Roger Jang

4. [Direction-Preserving Number Representations](#paper-2605-07662)
**Authors:** Bardia Zadeh, George A. Constantinides

5. [Beyond Factor Aggregation: Gauge-Aware Low-Rank Server Representations for Federated LoRA](#paper-2605-06733)
**Authors:** Jinqian Chen, Chang Liu, Jihua Zhu

6. [Future Validity is the Missing Statistic: From Impossibility to $\Phi$-Estimation for Grammar-Faithful Speculative Decoding](#paper-2605-07698)
**Authors:** Wenhua Nie, Zijie Meng, Kun Zou, Zheng Lin, Ziwei Li, Haoran Zheng, Jyh-Shing Roger Jang, Hao Zhang

7. [An Efficient Hybrid Sparse Attention with CPU-GPU Parallelism for Long-Context Inference](#paper-2605-07719)
**Authors:** Feiyu Yao, Zhixiong Niu, Xiaqing Li, Yongqiang Xiong, Juan Fang, Qian Wang

8. [Same Signal, Opposite Meaning: Direction-Informed Adaptive Learning for LLM Agents](#paper-2605-06908)
**Authors:** Ziming Li, Jiatan Huang, Xiaoguang Guo, Guilin Wang, Chuxu Zhang

9. [CSR: Infinite-Horizon Real-Time Policies with Massive Cached State Representations](#paper-2605-07325)
**Authors:** Robin Karlsson, Go Suzui

10. [When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](#paper-2605-07969)
**Authors:** Ahmad Aghapour, Erhan Bayraktar

---

## Architecture and Training Dynamics (51) <a id="topic-architecture-training"></a>

### 1. [Revisiting Transformer Layer Parameterization Through Causal Energy Minimization](https://arxiv.org/abs/2605.07588) <a id="paper-2605-07588"></a>
...
**Comment:** Derives tied attention and shared-projection MLP layers from energy updates, then shows stable language-model training.

**Topic Match:** Directly examines which layer parameters can be shared or constrained, with experiments matching its stated hundred-million-parameter scope.
...
### 2. [OrScale: Orthogonalised Optimization with Layer-Wise Trust-Ratio Scaling](https://arxiv.org/abs/2605.07815) <a id="paper-2605-07815"></a>
...
**Comment:** Uses the actual applied update norm to prevent failure modes in layer-adaptive Muon optimization.

**Topic Match:** Directly addresses optimizer parameterization, weight-decay stability, and learning-rate transfer, with language-model pretraining through 1.1B parameters.
...
### 3. [Toeplitz MLP Mixers are Low Complexity, Information-Rich Sequence Models](https://arxiv.org/abs/2605.06683) <a id="paper-2605-06683"></a>
...
**Comment:** Replaces attention with causal Toeplitz mixing and investigates the resulting information-retention behavior.

**Topic Match:** An attention replacement changes the language-model layer itself and states its computational costs; experimental scales and named baselines are unspecified.
...
### 4. [Tool Calling is Linearly Readable and Steerable in Language Models](https://arxiv.org/abs/2605.07990) <a id="paper-2605-07990"></a>
...
**Comment:** Matched-magnitude interventions isolate tool selection to the output direction for the tool name's first token.

**Topic Match:** Causal decomposition of attention and output-layer directions explains an internal selection mechanism across model families.
...
### 5. [Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions](https://arxiv.org/abs/2605.07984) <a id="paper-2605-07984"></a>
...
**Comment:** Identifies a five-head causal handoff in Gemma-3-27B that separates active rhyme computation from merely decodable information.

**Topic Match:** Causal interventions establish which attention heads and token positions actually drive a trained model's computation.
...
### 6. [Fast Byte Latent Transformer](https://arxiv.org/abs/2605.08044) <a id="paper-2605-08044"></a>
...
**Comment:** An auxiliary blockwise diffusion objective trains BLT to generate multiple bytes per decoding step.

**Topic Match:** BLT-D changes the byte-level training objective and generation mechanism, making architecture the primary contribution.
...
### 7. [Pretraining Induces a Reusable Spectral Basis for Downstream Task Adaptation](https://arxiv.org/abs/2605.07302) <a id="paper-2605-07302"></a>
...
**Comment:** Tests whether stable pretrained singular directions contain transferable structure by freezing them during adaptation.

**Topic Match:** The central analysis links pretraining scale to reusable weight geometry; coefficient-only tuning provides a functional probe of that structure.
...
### 8. [Training-Induced Escape from Token Clustering in a Mean-Field Formulation of Transformers](https://arxiv.org/abs/2605.07772) <a id="paper-2605-07772"></a>
...
**Comment:** Training a parameter-linear FFN can reverse attention-driven token clustering near the final layers of a mean-field Transformer.

**Topic Match:** Directly analyses how FFN optimisation changes the dynamics of representations across Transformer layers.
...
### 9. [STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation](https://arxiv.org/abs/2605.08029) <a id="paper-2605-08029"></a>
...
**Comment:** Residual coupling gives language and image-flow streams a shared causal attention structure.

**Topic Match:** The central contribution is the architecture coupling language and flow streams for joint text-image generation.
...
### 10. [The Position Curse: LLMs Struggle to Locate the Last Few Items in a List](https://arxiv.org/abs/2605.07127) <a id="paper-2605-07127"></a>
...
**Comment:** Finds a persistent backward-versus-forward indexing asymmetry across open and frontier language models.

**Topic Match:** Positional processing is the nearest topic, but the contribution is capability testing and a new fine-tuning dataset, not benchmark-validity auditing.
...
### 11. [Cross-Attention and Encoder-Decoder Transformers: A Logical Characterization](https://arxiv.org/abs/2605.07705) <a id="paper-2605-07705"></a>
...
**Comment:** Characterizes encoder-decoder cross-attention using temporal logic under floating-point arithmetic and soft attention.

**Topic Match:** The architectural connection is the expressive capacity of cross-attention and masking; practical training consequences remain indirect.
...
### 12. [A Rod Flow Model for Adam at the Edge of Stability](https://arxiv.org/abs/2605.06821) <a id="paper-2605-06821"></a>
...
**Comment:** Models Adam's edge-of-stability dynamics in joint parameter–momentum space.

**Topic Match:** Optimizer stability is directly adjacent to the topic, but the abstract establishes no language-model training setting for the proposed dynamics.
...
### 13. [Beyond LoRA vs. Full Fine-Tuning: Gradient-Guided Optimizer Routing for LLM Adaptation](https://arxiv.org/abs/2605.07111) <a id="paper-2605-07111"></a>
...
**Comment:** Routes optimizer updates between full-rank and low-rank adaptation while preserving gradient access to both paths.

**Topic Match:** Optimizer design is the nearest fit, but parameter-efficient fine-tuning is the core subject; the routing operates between adaptation methods.
...
### 14. [PolarAdamW: Disentangling Spectral Control and Schur Gauge-Equivariance in Matrix Optimisation](https://arxiv.org/abs/2605.07067) <a id="paper-2605-07067"></a>
...
**Comment:** Holds polar spectral control fixed while breaking basis equivariance, then tests the resulting performance reversal.

**Topic Match:** The optimizer dissociation fits architectural analysis conceptually, but the trained models perform image classification and point-cloud regression.
...
### 15. [GazeVLM: Active Vision via Internal Attention Control for Multimodal Reasoning](https://arxiv.org/abs/2605.07817) <a id="paper-2605-07817"></a>
...
**Comment:** Generated gaze tokens dynamically bias causal attention toward selected visual regions.

**Topic Match:** Attention-mask design is the closest fit; the core training contribution targets GRPO-based visual reasoning.
...
### 16. [Does Your Neural Network Extrapolate? Feature Engineering as Identifiability Bias for OOD Generalization](https://arxiv.org/abs/2605.07483) <a id="paper-2605-07483"></a>
...
**Comment:** Varies representation while holding architecture and in-distribution fit fixed to isolate extrapolation behavior.

**Topic Match:** Representation and architectural inductive bias are the nearest fit, but the demonstrated tasks concern scientific extrapolation rather than language-model training.
...
### 17. [When Does a Language Model Commit? A Finite-Answer Theory of Pre-Verbalization Commitment](https://arxiv.org/abs/2605.06723) <a id="paper-2605-06723"></a>
...
**Comment:** Defines finite-answer stabilization directly from continuation probabilities and measures its lead over visible answers.

**Topic Match:** Internal-state analysis is the nearest connection; the contribution measures answer preference without establishing the mechanism producing it.
...
### 18. [Learning Large-Scale Modular Addition with an Auxiliary Modulus](https://arxiv.org/abs/2605.07648) <a id="paper-2605-07648"></a>
...
**Comment:** An auxiliary training modulus reduces wrap-around difficulty while preserving the input distribution.

**Topic Match:** Training-curriculum design is the nearest connection; the demonstrated task is modular-arithmetic learning.
...
### 19. [Rethinking State Tracking in Recurrent Models Through Error Control Dynamics](https://arxiv.org/abs/2605.07755) <a id="paper-2605-07755"></a>
...
**Comment:** Separates recurrent expressivity from error correction using a threshold that predicts tracking failure.

**Topic Match:** Recurrent error-control mechanisms are the nearest fit; the demonstrated subject is symbolic group-state tracking, with no language-model training experiment specified.
...
### 20. [Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training](https://arxiv.org/abs/2605.07063) <a id="paper-2605-07063"></a>
...
**Comment:** Projects target-data updates onto directions permitted by a general-data-induced regularizer.

**Topic Match:** Update geometry connects to optimiser design, but the core contribution is post-training data regularization.
...
### 21. [KL for a KL: On-Policy Distillation with Control Variate Baseline](https://arxiv.org/abs/2605.07865) <a id="paper-2605-07865"></a>
...
**Comment:** Uses an analytic reverse-KL control variate to reduce on-policy distillation gradient variance.

**Topic Match:** Optimization dynamics is the nearest category, but the contribution is post-training distillation without an architectural destabilization mechanism.
...
### 22. [Muon with Nesterov Momentum: Heavy-Tailed Noise and (Randomized) Inexact Polar Decomposition](https://arxiv.org/abs/2605.06884) <a id="paper-2605-06884"></a>
...
**Comment:** Quantifies how inexact polar decomposition affects Muon's Nesterov updates under heavy-tailed noise.

**Topic Match:** Optimizer theory is the nearest category, but stochastic convergence analysis is the core subject and language-model training evidence is unspecified.
...
### 23. [Continuous First, Discrete Later: VQ-VAEs Without Dimensional Collapse](https://arxiv.org/abs/2605.06870) <a id="paper-2605-06870"></a>
...
**Comment:** Identifies quantization-induced suppression of low-variance directions and prevents collapse with an autoencoder warm-up.

**Topic Match:** Training-collapse analysis is the nearest topic, but the models being trained are image and audio autoencoders.
...
### 24. [Randomness is sometimes necessary for coordination](https://arxiv.org/abs/2605.06825) <a id="paper-2605-06825"></a>
...
**Comment:** Random rank-based attention masks break coordination symmetry while retaining full parameter sharing.

**Topic Match:** Attention design is the nearest topic; the trained models are cooperative reinforcement-learning policies.
...
### 25. [Characterizing and Correcting Effective Target Shift in Online Learning](https://arxiv.org/abs/2605.07886) <a id="paper-2605-07886"></a>
...
**Comment:** Expresses online kernel regression as offline regression with shifted targets and derives an exact target correction.

**Topic Match:** Optimisation dynamics provide the connection, but the study concerns kernel regression and continual image classification.
...
### 26. [Tree SAE: Learning Hierarchical Feature Structures in Sparse Autoencoders](https://arxiv.org/abs/2605.07922) <a id="paper-2605-07922"></a>
...
**Comment:** Adds a reconstruction constraint to establish functional dependence between hierarchical SAE features.

**Topic Match:** Representation analysis is the nearest connection, but the contribution organizes extracted features without explaining the training mechanism that produced them.
...
### 27. [Bilevel Graph Structure Learning, Revisited: Inner-Channel Origins of the Reported Gain](https://arxiv.org/abs/2605.07577) <a id="paper-2605-07577"></a>
...
**Comment:** Freezes graph rewiring while preserving inner-loop training to isolate the source of bilevel gains.

**Topic Match:** Training-dynamics attribution is the nearest category, but the contribution concerns graph learning and forecasting.
...
### 28. [When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification](https://arxiv.org/abs/2605.07120) <a id="paper-2605-07120"></a>
...
**Comment:** Separates vocabulary size from token-collision geometry when analysing fresh-symbol classification margins.

**Topic Match:** Transformer-kernel symmetry is the closest connection; the core subject is symbolic generalization in a classification testbed.
...
### 29. [PLOT: Progressive Localization via Optimal Transport in Neural Causal Abstraction](https://arxiv.org/abs/2605.06979) <a id="paper-2605-06979"></a>
...
**Comment:** Optimal-transport couplings localise intervention sites before fine-grained causal alignment.

**Topic Match:** Causal-analysis tooling is the nearest architectural connection; the contribution accelerates interpretability workflows.
...
### 30. [MEMOREPAIR: Barrier-First Cascade Repair in Agentic Memory](https://arxiv.org/abs/2605.07242) <a id="paper-2605-07242"></a>
...
**Comment:** Reduces dependency-consistent memory repair to an exact minimum-cut selection problem.

**Topic Match:** Architecture is the nearest label for its dependency-management contract, but the core contribution concerns external agent memory.
...
### 31. [Every Feedforward Neural Network Definable in an o-Minimal Structure Has Finite Sample Complexity](https://arxiv.org/abs/2605.07097) <a id="paper-2605-07097"></a>
...
**Comment:** Derives finite PAC sample complexity from definability for fixed feedforward architectures with unbounded parameters.

**Topic Match:** General architectural learnability is the nearest connection; no specific language-model construction or training mechanism is established.
...
### 32. [CASCADE: Case-Based Continual Adaptation for Large Language Models During Deployment](https://arxiv.org/abs/2605.06702) <a id="paper-2605-06702"></a>
...
**Comment:** Uses contextual-bandit selection to govern reuse of accumulated cases.

**Topic Match:** Adaptation is the nearest conceptual connection, but the contribution is deployment-time agent memory without parameter training.
...
### 33. [Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning](https://arxiv.org/abs/2605.07980) <a id="paper-2605-07980"></a>
...
**Comment:** Relates data perturbations to structural changes through a posterior-covariance Jacobian.

**Topic Match:** Training-response analysis is the nearest connection; this is an interpretability primer presenting existing susceptibility theory.
...
### 34. [Extracting Search Trees from LLM Reasoning Traces Reveals Myopic Planning](https://arxiv.org/abs/2605.06840) <a id="paper-2605-06840"></a>
...
**Comment:** Causal pruning attributes move selection to shallow search nodes despite deeper reasoning traces.

**Topic Match:** The core subject is planning in game-playing reasoning traces, with an indirect connection to model architecture.
...
### 35. [Convergence and Emergence of In-Context Reinforcement Learning with Chain of Thought](https://arxiv.org/abs/2605.07123) <a id="paper-2605-07123"></a>
...
**Comment:** Shows how a linear Transformer's generated chain of thought can implement repeated temporal-difference updates.

**Topic Match:** Computation-level analysis is the nearest fit, but the core setting is theoretical in-context reinforcement learning and policy evaluation.
...
### 36. [Predictive but Not Plannable: RC-aux for Latent World Models](https://arxiv.org/abs/2605.07278) <a id="paper-2605-07278"></a>
...
**Comment:** Adds budget-conditioned reachability supervision to align latent geometry with attainable plans.

**Topic Match:** Representation-shaping objectives are the architectural connection, but they train a world model for planning rather than a language model.
...
### 37. [Bifurcation Models: Learning Set-Valued Solution Maps with Weight-Tied Dynamics](https://arxiv.org/abs/2605.07277) <a id="paper-2605-07277"></a>
...
**Comment:** Weight-tied equilibrium dynamics represent multiple solution branches without selecting one branch as the training label.

**Topic Match:** Dynamical architecture is the closest topic; the trained models represent scientific solution sets.
...
### 38. [Why DDIM Hallucinates More than DDPM: A Theoretical Analysis of Reverse Dynamics](https://arxiv.org/abs/2605.06831) <a id="paper-2605-06831"></a>
...
**Comment:** Explains when DDIM dynamics become trapped between modes and how DDPM stochasticity permits escape.

**Topic Match:** Diffusion dynamics are the nearest architectural connection; the study concerns Gaussian-mixture sampling without language-model training.
...
### 39. [Structured Coupling for Flow Matching](https://arxiv.org/abs/2605.07676) <a id="paper-2605-07676"></a>
...
**Comment:** A shared recognition network couples structured latent-variable learning to flow-velocity estimation.

**Topic Match:** Generative architecture supplies the connection, but the core contribution is latent-variable representation learning without a language-model setting.
...
### 40. [Self-Programmed Execution for Language-Model Agents](https://arxiv.org/abs/2605.06898) <a id="paper-2605-06898"></a>
...
**Comment:** Replaces a fixed agent orchestrator with model-generated, self-editing executable state.

**Topic Match:** Architecture is the nearest registry label, but the replacement concerns an external agent harness and uses existing models without training.
...
### 41. [A Theory of Online Learning with Autoregressive Chain-of-Thought Reasoning](https://arxiv.org/abs/2605.06819) <a id="paper-2605-06819"></a>
...
**Comment:** Shows that observing full autoregressive trajectories removes generation-horizon dependence from online mistake bounds.

**Topic Match:** Autoregressive learning theory is the closest topic; the central question concerns chain-of-thought feedback and reasoning learnability.
...
### 42. [Drifting Field Policy: A One-Step Generative Policy via Wasserstein Gradient Flow](https://arxiv.org/abs/2605.07727) <a id="paper-2605-07727"></a>
...
**Comment:** Derives a one-step generative policy update from Wasserstein gradient flow and critic-selected actions.

**Topic Match:** Generative parameterization and optimization are the nearest category, but the trained models are robotic control policies.
...
### 43. [Normalizing Trajectory Models](https://arxiv.org/abs/2605.08078) <a id="paper-2605-08078"></a>
...
**Comment:** Replaces Gaussian reverse transitions with conditional normalizing flows that retain exact trajectory likelihood.

**Topic Match:** Generative architecture and training objectives are the nearest category, but the demonstrated model is a text-to-image generator.
...
### 44. [Distributional simplicity bias and effective convexity in Energy Based Models](https://arxiv.org/abs/2605.07844) <a id="paper-2605-07844"></a>
...
**Comment:** Explains lower-order-first learning through the effective interaction dynamics of energy-based models.

**Topic Match:** Optimisation dynamics are the closest topic; the analysis concerns energy-based distributions over binary variables.
...
### 45. [AGWM: Affordance-Grounded World Models for Environments with Compositional Prerequisites](https://arxiv.org/abs/2605.06841) <a id="paper-2605-06841"></a>
...
**Comment:** Explicitly represents changing action prerequisites as a dependency graph inside a world model.

**Topic Match:** The contribution changes a predictive model's architecture, but its subject is environment dynamics and action affordances.
...
### 46. [Learned Lagrangian Models of PDEs via Euler-Lagrange Residual Minimization](https://arxiv.org/abs/2605.07157) <a id="paper-2605-07157"></a>
...
**Comment:** Separates learned dynamics error from conservation error using Euler-Lagrange residual minimization.

**Topic Match:** Optimization-based model dynamics is the nearest category, but the subject is numerical integration of learned physical systems.
...
### 47. [Learning Visual Feature-Based World Models via Residual Latent Action](https://arxiv.org/abs/2605.07079) <a id="paper-2605-07079"></a>
...
**Comment:** Uses residual visual features as latent actions for generative transition modeling.

**Topic Match:** Latent parameterization is the architectural connection, but the trained systems are visual world models and robot policies.
...
### 48. [On the Divergence of Differential Temporal Difference Learning without Local Clocks](https://arxiv.org/abs/2605.06874) <a id="paper-2605-06874"></a>
...
**Comment:** Constructs a case where global-clock differential TD diverges while local-clock updates converge.

**Topic Match:** Learning-rate stability is the nearest connection; the algorithm estimates values in average-reward reinforcement learning.
...
### 49. [Interpreting Reinforcement Learning Agents with Susceptibilities](https://arxiv.org/abs/2605.08007) <a id="paper-2605-08007"></a>
...
**Comment:** Extends susceptibility measurements to regret and tracks stagewise internal changes in a gridworld agent.

**Topic Match:** Training-response analysis is the nearest connection; the core subject is reinforcement-learning interpretability.
...
### 50. [Globally Optimal Training of Spiking Neural Networks via Parameter Reconstruction](https://arxiv.org/abs/2605.08022) <a id="paper-2605-08022"></a>
...
**Comment:** Extends convexification to recurrent threshold networks and reconstructs spiking-network parameters.

**Topic Match:** Training parameterization is the nearest category, but spiking neural networks are explicitly excluded and no language-model setting is identified.
...
### 51. [Finite-Time Analysis of MCTS in Continuous POMDP Planning](https://arxiv.org/abs/2605.07703) <a id="paper-2605-07703"></a>
...
**Comment:** Derives finite-time concentration bounds for tree-search estimates with adaptive observation partitioning.

**Topic Match:** Algorithmic theory is the nearest connection; the contribution concerns POMDP planning, outside language-model training.
...
### 1. [Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?](https://arxiv.org/abs/2605.07072) <a id="paper-2605-07072"></a>
...
**Comment:** Fixing each example's participation count improves privacy amplification over Poisson subsampling, particularly at low noise.

**Topic Match:** Training-algorithm design is the nearest category; the result concerns differential-privacy accounting without a language-model training study.
...
### 2. [Resource-Element Energy Difference for Noncoherent Over-the-Air Federated Learning](https://arxiv.org/abs/2605.07263) <a id="paper-2605-07263"></a>
...
**Comment:** Aggregates signed federated updates without instantaneous channel information or coherent phase alignment.

**Topic Match:** Distributed optimization is the nearest category, but the work concerns wireless federated image classification rather than language-model training.
...
### 1. [Star Elastic: Many-in-One Reasoning LLMs with Efficient Budget Control](https://arxiv.org/abs/2605.07182) <a id="paper-2605-07182"></a>
...
**Comment:** Jointly trains nested model sizes to reduce the number of separate model-family training runs.

**Topic Match:** Compression and nested structure are the closest fit, but the savings depend on an existing parent and a distillation stage; unconditional training gains are not established.
...
### 2. [MISA: Mixture of Indexer Sparse Attention for Long-Context LLM Inference](https://arxiv.org/abs/2605.07363) <a id="paper-2605-07363"></a>
...
**Comment:** Routes each attention-indexer query to a small subset of scoring heads.

**Topic Match:** Sparse-attention efficiency is the closest fit; the contribution accelerates long-context inference rather than changing expert training or specialization.
...
### 3. [The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](https://arxiv.org/abs/2605.07686) <a id="paper-2605-07686"></a>
...
**Comment:** Separates reasoning-token and answer-token budgets to expose truncation-induced accuracy losses.

**Topic Match:** Compute-budget efficiency is the nearest category, but the core contribution concerns excluded test-time scaling and CoT reasoning.
...
### 4. [Direction-Preserving Number Representations](https://arxiv.org/abs/2605.07662) <a id="paper-2605-07662"></a>
...
**Comment:** Quantifies how scalar alphabets and block dimension constrain directional accuracy at a fixed bit width.

**Topic Match:** Quantization-format geometry is the closest topic; language-model training stability or trainability is not demonstrated.
...
### 5. [Beyond Factor Aggregation: Gauge-Aware Low-Rank Server Representations for Federated LoRA](https://arxiv.org/abs/2605.06733) <a id="paper-2605-06733"></a>
...
**Comment:** Gauge-invariant server coordinates aggregate equivalent LoRA updates consistently and support different client ranks.

**Topic Match:** Low-rank representation is the nearest topic; the core subject is federated parameter-efficient fine-tuning.
...
### 6. [Future Validity is the Missing Statistic: From Impossibility to $\Phi$-Estimation for Grammar-Faithful Speculative Decoding](https://arxiv.org/abs/2605.07698) <a id="paper-2605-07698"></a>
...
**Comment:** Identifies future completion validity as the missing correction for grammar-conditional sampling.

**Topic Match:** Speculative decoding is the nearest efficiency connection; the contribution audits an inference sampling law rather than training mechanisms or benchmark validity.
...
### 7. [An Efficient Hybrid Sparse Attention with CPU-GPU Parallelism for Long-Context Inference](https://arxiv.org/abs/2605.07719) <a id="paper-2605-07719"></a>
...
**Comment:** Jointly allocates sparse KV budgets and schedules attention work across CPU and GPU.

**Topic Match:** The work concerns sparse-attention efficiency, with gains from inference budgeting and execution scheduling rather than a new training capability.
...
### 8. [Same Signal, Opposite Meaning: Direction-Informed Adaptive Learning for LLM Agents](https://arxiv.org/abs/2605.06908) <a id="paper-2605-06908"></a>
...
**Comment:** Learns whether extra agent computation helps from counterfactual rollouts.

**Topic Match:** Compute efficiency is the nearest category, but the contribution is agent gating during inference.
...
### 9. [CSR: Infinite-Horizon Real-Time Policies with Massive Cached State Representations](https://arxiv.org/abs/2605.07325) <a id="paper-2605-07325"></a>
...
**Comment:** Derives prefix-stability conditions for preserving KV-cache reuse during continuous interaction.

**Topic Match:** Cache efficiency is the nearest fit, but the contribution is inference latency and state management for embodied deployment.
...
### 10. [When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](https://arxiv.org/abs/2605.07969) <a id="paper-2605-07969"></a>
...
**Comment:** Replaces ambient-dimensional diffusion discretization bounds with latent-entropy dependence for Gaussian-mixture targets.

**Topic Match:** Sampling complexity is the nearest efficiency connection; no language-model training result is stated.
