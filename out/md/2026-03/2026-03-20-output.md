...
1. [SOL-ExecBench: Speed-of-Light Benchmarking for Real-World GPU Kernels Against Hardware Limits](#user-content-link1)
...
3. [AIMER: Calibration-Free Task-Agnostic MoE Pruning](#user-content-link3)
**Authors:** Zongfang Liu, Shengkun Tang, Yifan Shen, Huan Wang, Xin Yuan

4. [Computational and Statistical Hardness of Calibration Distance](#user-content-link4)
**Authors:** Mingda Qiao

5. [From Topic to Transition Structure: Unsupervised Concept Discovery at Corpus Scale via Predictive Associative Memory](#user-content-link5)
**Authors:** Jason Dury

6. [Learning Decision-Sufficient Representations for Linear Optimization](#user-content-link6)
**Authors:** Yuhan Ye, Saurabh Amin, Asuman Ozdaglar

7. [Seasoning Generative Models for a Generalization Aftertaste](#user-content-link7)
**Authors:** Hisham Husain, Valentin De Bortoli, Richard Nock

8. [Uniform a priori bounds and error analysis for the Adam stochastic gradient descent optimization method](#user-content-link8)
**Authors:** Steffen Dereich, Thang Do, Arnulf Jentzen

9. [AS2 -- Attention-Based Soft Answer Sets: An End-to-End Differentiable Neuro-Soft-Symbolic Reasoning Architecture](#user-content-link9)
...
11. [Towards Verifiable AI with Lightweight Cryptographic Proofs of Inference](#user-content-link11)
**Authors:** Pranay Anchuri, Matteo Campanelli, Paul Cesaretti, Rosario Gennaro, Tushar M. Jois, Hasan S. Kayman, Tugce Ozdemir

12. [Secure Linear Alignment of Large Language Models](#user-content-link12)
**Authors:** Matt Gorbett, Suman Jana

13. [An SO(3)-equivariant reciprocal-space neural potential for long-range interactions](#user-content-link13)
**Authors:** Linfeng Zhang, Taoyong Cui, Dongzhan Zhou, Lei Bai, Sufei Zhang, Luca Rossi, Mao Su, Wanli Ouyang, Pheng-Ann Heng

14. [Optimal Splitting of Language Models from Mixtures to Specialized Domains](#user-content-link14)
**Authors:** Skyler Seto, Pierre Ablin, Anastasiia Filippova, Jiayuan Ye, Louis Bethune, Angelos Katharopoulos, David Grangier

15. [Transformers Learn Robust In-Context Regression under Distributional Uncertainty](#user-content-link15)
**Authors:** Hoang T. H. Cao, Hai D. V. Trinh, Tho Quan, Lan V. Truong

16. [SpecForge: A Flexible and Efficient Open-Source Training Framework for Speculative Decoding](#user-content-link16)
...
17. [UT-ACA: Uncertainty-Triggered Adaptive Context Allocation for Long-Context Inference](#user-content-link17)
**Authors:** Lang Zhou, Shuxuan Li, Zhuohao Li, Shi Liu, Zhilin Zhao, Wei-Shi Zheng

18. [Foundations of Schrödinger Bridges for Generative Modeling](#user-content-link18)
**Authors:** Sophia Tang

19. [DyMoE: Dynamic Expert Orchestration with Mixed-Precision Quantization for Efficient MoE Inference on Edge](#user-content-link19)
**Authors:** Yuegui Huang, Zhiyuan Fang, Weiqi Luo, Ruoyu Wu, Wuhui Chen, Zibin Zheng

20. [Hierarchical Latent Structure Learning through Online Inference](#user-content-link20)
**Authors:** Ines Aitsahalia, Kiyohito Iigaya

21. [TARo: Token-level Adaptive Routing for LLM Test-time Alignment](#user-content-link21)
**Authors:** Arushi Rai, Qiang Zhang, Hanqing Zeng, Yunkai Zhang, Dipesh Tamboli, Xiangjun Fan, Zhuokai Zhao, Lizhu Zhang

22. [Nemotron-Cascade 2: Post-Training LLMs with Cascade RL and Multi-Domain On-Policy Distillation](#user-content-link22)
...
23. [D-Mem: A Dual-Process Memory System for LLM Agents](#user-content-link23)
**Authors:** Zhixing You, Jiachen Yuan, Jason Cai

---

## 1. [SOL-ExecBench: Speed-of-Light Benchmarking for Real-World GPU Kernels Against Hardware Limits](https://arxiv.org/abs/2603.19173) <a id="link1"></a>
...
## 3. [AIMER: Calibration-Free Task-Agnostic MoE Pruning](https://arxiv.org/abs/2603.18492) <a id="link3"></a>
...
## 4. [Computational and Statistical Hardness of Calibration Distance](https://arxiv.org/abs/2603.18391) <a id="link4"></a>
...
## 5. [From Topic to Transition Structure: Unsupervised Concept Discovery at Corpus Scale via Predictive Associative Memory](https://arxiv.org/abs/2603.18420) <a id="link5"></a>
...
**Comment:** Representation learning: unsupervised corpus-scale concept discovery via a contrastive associative-memory objective that isolates transition structure rather than topical semantics.
...
## 6. [Learning Decision-Sufficient Representations for Linear Optimization](https://arxiv.org/abs/2603.18551) <a id="link6"></a>
...
**Comment:** Representation learning: develops decision-sufficient compressed representations with hardness results, polynomial algorithms, and PAC bounds tied to intrinsic decision-relevant dimension.
...
## 7. [Seasoning Generative Models for a Generalization Aftertaste](https://arxiv.org/abs/2603.18817) <a id="link7"></a>
...
**Comment:** Representation learning theory: proves discriminator-guided refinement can improve generative-model generalization, with bounds governed by discriminator-class complexity.
...
## 8. [Uniform a priori bounds and error analysis for the Adam stochastic gradient descent optimization method](https://arxiv.org/abs/2603.18899) <a id="link8"></a>
...
**Comment:** Representation learning/training dynamics theory: first unconditional error analysis for Adam via uniform a priori bounds in strongly convex stochastic optimization.
...
## 9. [AS2 -- Attention-Based Soft Answer Sets: An End-to-End Differentiable Neuro-Soft-Symbolic Reasoning Architecture](https://arxiv.org/abs/2603.18436) <a id="link9"></a>
...
**Comment:** Model architecture: proposes a fully differentiable neuro-symbolic reasoning architecture using a soft fixed-point approximation to ASP consequence operators.
...
**Comment:** Transformer architecture innovation: Gibbs/Ising attention with game-theoretic token valuation and convergence analysis.
...
## 11. [Towards Verifiable AI with Lightweight Cryptographic Proofs of Inference](https://arxiv.org/abs/2603.19025) <a id="link11"></a>
...
**Comment:** Systems-level method for verifiable large-model inference using lightweight sampling-based proofs with execution-trace commitments.
...
## 12. [Secure Linear Alignment of Large Language Models](https://arxiv.org/abs/2603.18908) <a id="link12"></a>
...
**Comment:** Studies representational convergence via linear alignment between independently trained LLMs, directly probing shared representations.
...
## 13. [An SO(3)-equivariant reciprocal-space neural potential for long-range interactions](https://arxiv.org/abs/2603.18389) <a id="link13"></a>
...
**Comment:** Core architecture innovation: SO(3)-equivariant reciprocal-space message passing to model long-range interactions consistently.
...
## 14. [Optimal Splitting of Language Models from Mixtures to Specialized Domains](https://arxiv.org/abs/2603.19149) <a id="link14"></a>
...
**Comment:** Scaling-law method for optimal compute allocation between pretraining and specialization when splitting language models into domain-specific models.
...
## 15. [Transformers Learn Robust In-Context Regression under Distributional Uncertainty](https://arxiv.org/abs/2603.18564) <a id="link15"></a>
...
**Comment:** Analyzes Transformer in-context regression under broad distributional uncertainty, probing a core capability of the architecture.
...
## 16. [SpecForge: A Flexible and Efficient Open-Source Training Framework for Speculative Decoding](https://arxiv.org/abs/2603.18567) <a id="link16"></a>
...
**Comment:** Production-oriented training framework for speculative decoding with hybrid parallelism and optimized kernels, matching large-model systems work.
...
## 17. [UT-ACA: Uncertainty-Triggered Adaptive Context Allocation for Long-Context Inference](https://arxiv.org/abs/2603.18446) <a id="link17"></a>
...
**Comment:** Inference efficiency method: adaptive KV-cache/context allocation driven by token-level uncertainty for long-context decoding.
...
## 18. [Foundations of Schrödinger Bridges for Generative Modeling](https://arxiv.org/abs/2603.18992) <a id="link18"></a>
...
**Comment:** Builds mathematical foundations for Schrödinger bridges as a unifying framework behind diffusion, score, and flow-based generative models.
...
## 19. [DyMoE: Dynamic Expert Orchestration with Mixed-Precision Quantization for Efficient MoE Inference on Edge](https://arxiv.org/abs/2603.19172) <a id="link19"></a>
...
**Comment:** Targets efficient MoE inference with dynamic expert orchestration and mixed-precision quantization on edge hardware.
...
## 20. [Hierarchical Latent Structure Learning through Online Inference](https://arxiv.org/abs/2603.19139) <a id="link20"></a>
...
**Comment:** Online hierarchical latent-variable inference via nested CRP plus sequential Monte Carlo for representation learning in sequential data.
...
## 21. [TARo: Token-level Adaptive Routing for LLM Test-time Alignment](https://arxiv.org/abs/2603.18411) <a id="link21"></a>
...
**Comment:** Token-level adaptive routing is a conditional/dynamic network mechanism for inference-time control of LLM reasoning.
...
## 22. [Nemotron-Cascade 2: Post-Training LLMs with Cascade RL and Multi-Domain On-Policy Distillation](https://arxiv.org/abs/2603.19220) <a id="link22"></a>
...
**Comment:** Mixture-of-Experts post-training recipe combining Cascade RL with multi-domain on-policy distillation for a compact high-capacity model.
...
## 23. [D-Mem: A Dual-Process Memory System for LLM Agents](https://arxiv.org/abs/2603.18631) <a id="link23"></a>
...
**Comment:** Systems-level memory architecture for LLM agents with dynamic quality gating between retrieval and full-deliberation modes.
