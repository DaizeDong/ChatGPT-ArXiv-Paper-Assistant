...
1. [Attention to Mamba: A Recipe for Cross-Architecture Distillation](#paper-2604-14191)
**Authors:** Abhinav Moudgil, Ningyuan Huang, Eeshan Gunesh Dhekane, Pau Rodr\'iguez, Luca Zappella, Federico Danieli

2. [Gating Enables Curvature: A Geometric Expressivity Gap in Attention](#paper-2604-14702)
...
4. [Weight Patching: Toward Source-Level Mechanistic Localization in LLMs](#paper-2604-13694)
**Authors:** Chenghao Sun, Chengsheng Zhang, Guanzheng Qin, Rui Dai, Xinmei Tian

5. [Expressivity of Transformers: A Tropical Geometry Perspective](#paper-2604-14727)
**Authors:** Ye Su, Yong Liu

6. [Spectral Entropy Collapse as an Empirical Signature of Delayed Generalisation in Grokking](#paper-2604-13123)
**Authors:** Truong Xuan Khanh, Truong Quynh Hoa, Luu Duc Trung, Phan Thanh Duc

7. [Reinforcement Learning via Value Gradient Flow](#paper-2604-14265)
**Authors:** Haoran Xu, Kaiwen Hu, Somayeh Sojoudi, Amy Zhang

8. [Can Cross-Layer Transcoders Replace Vision Transformer Activations? An Interpretable Perspective on Vision](#paper-2604-13304)
...
10. [HAMSA: Scanning-Free Vision State Space Models via SpectralPulseNet](#paper-2604-14724)
**Authors:** Badri N. Patro, Vijay S. Agneeswaran

11. [Constraint-based Pre-training: From Structured Constraints to Scalable Model Initialization](#paper-2604-14769)
**Authors:** Fu Feng, Yucheng Xie, Ruixiao Shi, Jing Wang, Xin Geng

12. [Metric-Aware Principal Component Analysis (MAPCA):A Unified Framework for Scale-Invariant Representation Learning](#paper-2604-14249)
**Authors:** Michael Leznik

13. [Bridging MARL to SARL: An Order-Independent Multi-Agent Transformer via Latent Consensus](#paper-2604-13472)
**Authors:** Zijian Zhao, Jing Gao, Sen Li

14. [From Order to Distribution: A Spectral Characterization of Forgetting in Continual Learning](#paper-2604-13460)
**Authors:** Zonghuan Xu, Xingjun Ma

15. [Learning Ad Hoc Network Dynamics via Graph-Structured World Models](#paper-2604-14811)
**Authors:** Can Karacelebi, Yusuf Talha Sahin, Elif Surer, Ertan Onur

16. [Adaptive Memory Crystallization for Autonomous AI Agent Learning in Dynamic Environments](#paper-2604-13085)
**Authors:** Rajat Khanda, Mohammad Baqar Sambuddha Chakrabarti, Satyasaran Changdar

17. [A Nonlinear Separation Principle: Applications to Neural Networks, Control and Learning](#paper-2604-15238)
**Authors:** Anand Gokhale, Anton V. Proskurnikov, Yu Kawano, Francesco Bullo

18. [Blazing the trails before beating the path: Sample-efficient Monte-Carlo planning](#paper-2604-14974)
**Authors:** Jean-Bastien Grill, Michal Valko, R\'emi Munos

19. [Identifiability of Potentially Degenerate Gaussian Mixture Models With Piecewise Affine Mixing](#paper-2604-13218)
**Authors:** Danru Xu, S\'ebastien Lachapelle, Sara Magliacane

20. [Optimistic Policy Learning under Pessimistic Adversaries with Regret and Violation Guarantees](#paper-2604-14243)
**Authors:** Sourav Ganguly, Kartik Pandit, Arnob Ghosh

21. [Golden Handcuffs make safer AI agents](#paper-2604-13609)
**Authors:** Aram Ebtekar, Michael K. Cohen

22. [Wasserstein Formulation of Reinforcement Learning. An Optimal Transport Perspective on Policy Optimization](#paper-2604-14765)
...
2. [Prism: Symbolic Superoptimization of Tensor Programs](#paper-2604-15272)
**Authors:** Mengdi Wu, Xiaoyu Jiang, Oded Padon, Zhihao Jia

3. [SparseBalance: Load-Balanced Long Context Training with Dynamic Sparse Attention](#paper-2604-13847)
...
1. [Awakening Dormant Experts:Counterfactual Routing to Mitigate MoE Hallucinations](#paper-2604-14246)
...
1. [AdaSplash-2: Faster Differentiable Sparse Attention](#paper-2604-15180)
**Authors:** Nuno Gon\c{c}alves, Hugo Pitorro, Vlad Niculae, Edoardo Ponti, Lei Li, Andre Martins, Marcos Treviso

2. [Adaptive Test-Time Compute Allocation for Reasoning LLMs via Constrained Policy Optimization](#paper-2604-14853)
...
### 1. [Attention to Mamba: A Recipe for Cross-Architecture Distillation](https://arxiv.org/abs/2604.14191) <a id="paper-2604-14191"></a>
...
**Comment:** Principled initialization enables complete replacement of attention blocks during Transformer-to-Mamba distillation.

**Topic Match:** Attention-free architectural conversion is supported by initialization and mixer ablations at 1B scale; the recipe requires two distillation stages.
...
### 2. [Gating Enables Curvature: A Geometric Expressivity Gap in Attention](https://arxiv.org/abs/2604.14702) <a id="paper-2604-14702"></a>
...
**Comment:** A geometric account of attention gating predicts curvature gains and a nonlinear-versus-linear task distinction.

**Topic Match:** Directly analyzes what multiplicative gating changes inside attention, with a testable prediction about when its expressivity matters.
...
### 4. [Weight Patching: Toward Source-Level Mechanistic Localization in LLMs](https://arxiv.org/abs/2604.13694) <a id="paper-2604-13694"></a>
...
**Comment:** Causal weight swaps distinguish capability-bearing parameters from signal aggregation, routing, and downstream execution.

**Topic Match:** The relevant contribution is intervention-based analysis of how model computation is organized, extending beyond feature inventories.
...
### 5. [Expressivity of Transformers: A Tropical Geometry Perspective](https://arxiv.org/abs/2604.14727) <a id="paper-2604-14727"></a>
...
**Comment:** Derives head- and depth-dependent expressivity bounds from attention's geometric partition structure.

**Topic Match:** Analyzes the architectural role of multiple attention heads and depth, although the usable result rests on substantial mathematical formalism.
...
### 6. [Spectral Entropy Collapse as an Empirical Signature of Delayed Generalisation in Grokking](https://arxiv.org/abs/2604.13123) <a id="paper-2604-13123"></a>
...
**Comment:** Norm-matched interventions test whether representation-entropy collapse controls grokking onset.

**Topic Match:** Training dynamics are the closest fit, but the demonstration is confined to one-layer transformers on group-theoretic tasks.
...
### 7. [Reinforcement Learning via Value Gradient Flow](https://arxiv.org/abs/2604.14265) <a id="paper-2604-14265"></a>
...
### 8. [Can Cross-Layer Transcoders Replace Vision Transformer Activations? An Interpretable Perspective on Vision](https://arxiv.org/abs/2604.13304) <a id="paper-2604-13304"></a>
...
**Comment:** Cross-layer sparse reconstructions expose which MLP-layer contributions determine the final representation.

**Topic Match:** Architecture analysis is the nearest fit, but the experiments and contribution concern CLIP vision encoders.
...
### 10. [HAMSA: Scanning-Free Vision State Space Models via SpectralPulseNet](https://arxiv.org/abs/2604.14724) <a id="paper-2604-14724"></a>
...
**Comment:** Spectral filtering replaces image scans and state-space discretization with input-dependent frequency gating.

**Topic Match:** The component replacements are specific to vision SSMs, with image classification and dense-prediction validation.
...
### 11. [Constraint-based Pre-training: From Structured Constraints to Scalable Model Initialization](https://arxiv.org/abs/2604.14769) <a id="paper-2604-14769"></a>
...
**Comment:** Separates reusable weight templates from size-specific scalers to initialize models at different depths and widths.

**Topic Match:** Cross-scale parameterization is the nearest fit, but the demonstrated training settings are perception and embodied control.
...
### 12. [Metric-Aware Principal Component Analysis (MAPCA):A Unified Framework for Scale-Invariant Representation Learning](https://arxiv.org/abs/2604.14249) <a id="paper-2604-14249"></a>
...
**Comment:** Distinguishes input whitening from output whitening through metric-dependent spectral geometry.

**Topic Match:** Closest to representation geometry, but the contribution concerns PCA and self-supervised objectives without a language-model training setting.
...
### 13. [Bridging MARL to SARL: An Order-Independent Multi-Agent Transformer via Latent Consensus](https://arxiv.org/abs/2604.13472) <a id="paper-2604-13472"></a>
...
**Comment:** A shared latent consensus factors joint control into simultaneous, order-independent agent actions.

**Topic Match:** Transformer architecture is the nearest category, but the trained model is a cooperative multi-agent control policy.
...
### 14. [From Order to Distribution: A Spectral Characterization of Forgetting in Continual Learning](https://arxiv.org/abs/2604.13460) <a id="paper-2604-13460"></a>
...
### 15. [Learning Ad Hoc Network Dynamics via Graph-Structured World Models](https://arxiv.org/abs/2604.14811) <a id="paper-2604-14811"></a>
...
**Comment:** Per-node recurrent states and cross-node attention preserve graph structure in a learned dynamics model.

**Topic Match:** Recurrent architecture is the nearest category, but the trained model predicts wireless-network dynamics.
...
### 16. [Adaptive Memory Crystallization for Autonomous AI Agent Learning in Dynamic Environments](https://arxiv.org/abs/2604.13085) <a id="paper-2604-13085"></a>
...
**Comment:** A stochastic consolidation process links memory stability and capacity to continual-learning performance bounds.

**Topic Match:** The nearest connection is learning dynamics, but the core system manages agent experience memory in continual reinforcement learning.
...
### 17. [A Nonlinear Separation Principle: Applications to Neural Networks, Control and Learning](https://arxiv.org/abs/2604.15238) <a id="paper-2604-15238"></a>
...
**Comment:** Derives contraction certificates and an unconstrained parameterization for stable implicit neural networks.

**Topic Match:** Stability and parameterization are the nearest fit, but the applications concern control systems and image classification.
...
### 18. [Blazing the trails before beating the path: Sample-efficient Monte-Carlo planning](https://arxiv.org/abs/2604.14974) <a id="paper-2604-14974"></a>
...
**Comment:** Makes Monte-Carlo planning sample complexity depend on the quantity of near-optimal reachable states.

**Topic Match:** Algorithmic learning theory is the nearest fit; the contribution concerns MDP planning rather than training language models.
...
### 19. [Identifiability of Potentially Degenerate Gaussian Mixture Models With Piecewise Affine Mixing](https://arxiv.org/abs/2604.13218) <a id="paper-2604-13218"></a>
...
### 20. [Optimistic Policy Learning under Pessimistic Adversaries with Regret and Violation Guarantees](https://arxiv.org/abs/2604.14243) <a id="paper-2604-14243"></a>
...
### 21. [Golden Handcuffs make safer AI agents](https://arxiv.org/abs/2604.13609) <a id="paper-2604-13609"></a>
...
### 22. [Wasserstein Formulation of Reinforcement Learning. An Optimal Transport Perspective on Policy Optimization](https://arxiv.org/abs/2604.14765) <a id="paper-2604-14765"></a>
...
**Comment:** Formulates policy optimization as Wasserstein gradient flow with an explicit policy-space gradient and Hessian.

**Topic Match:** Optimizer geometry is the nearest category, but the framework addresses reinforcement-learning policies without an LM training setting.
...
### 2. [Prism: Symbolic Superoptimization of Tensor Programs](https://arxiv.org/abs/2604.15272) <a id="paper-2604-15272"></a>
...
**Comment:** Symbolic tensor-program families enable semantic pruning before concrete implementations are autotuned.

**Topic Match:** Closest to training systems, but symbolic superoptimization improves execution of existing workloads rather than changing training algorithms.
...
### 3. [SparseBalance: Load-Balanced Long Context Training with Dynamic Sparse Attention](https://arxiv.org/abs/2604.13847) <a id="paper-2604-13847"></a>
...
**Comment:** Dynamic sparsity adjustment couples workload balancing with accuracy recovery during distributed training.

**Topic Match:** The central contribution is workload balancing for existing sparse long-context training, without a new training invariant.
...
### 1. [Awakening Dormant Experts:Counterfactual Routing to Mitigate MoE Hallucinations](https://arxiv.org/abs/2604.14246) <a id="paper-2604-14246"></a>
...
**Comment:** Counterfactual expert ablations redirect a fixed activation budget toward causally useful experts.

**Topic Match:** Expert assignment and layer-wise allocation are the core contribution, making this a routing-design match; total probing cost remains unclear.
...
### 1. [AdaSplash-2: Faster Differentiable Sparse Attention](https://arxiv.org/abs/2604.15180) <a id="paper-2604-15180"></a>
...
**Comment:** Histogram-based initialization reduces sparse-attention normalization to typically one or two iterations.

**Topic Match:** Accelerates an existing entmax primitive through numerical initialization and GPU execution, with speed gains conditional on sufficient sparsity.
...
### 2. [Adaptive Test-Time Compute Allocation for Reasoning LLMs via Constrained Policy Optimization](https://arxiv.org/abs/2604.14853) <a id="paper-2604-14853"></a>
...
**Comment:** Learns per-input compute allocations from a constrained oracle while holding average inference budget fixed.

**Topic Match:** Resource allocation is closest to efficiency, but the core subject is reasoning-time inference and test-time scaling.
