<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../20"><img src="../../../assets/nav/day/2026-02-23-prev.svg" alt="Previous Day 2026-02-20"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-23-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../24"><img src="../../../assets/nav/day/2026-02-23-next.svg" alt="Next Day 2026-02-24"></a></div></div>
...
1. [Grassmannian Mixture-of-Experts: Concentration-Controlled Routing on Subspace Manifolds](#user-content-link1)
**Authors:** Ibne Farabi Shihab, Sanjeda Akter, Anuj Sharma

2. [SeedFlood: A Step Toward Scalable Decentralized Training of LLMs](#user-content-link2)
**Authors:** Jihun Kim, Namhoon Lee

3. [ScaleBITS: Scalable Bitwidth Search for Hardware-Aligned Mixed-Precision LLMs](#user-content-link3)
**Authors:** Xinlin Li, Timothy Chou, Josh Fromm, Zichang Liu, Yunjie Pan, Christina Fragouli

4. [Cut Less, Fold More: Model Compression through the Lens of Projection Geometry](#user-content-link4)
**Authors:** Olga Saukh, Dong Wang, Haris \v{S}iki\'c, Yun Cheng, Lothar Thiele

5. [Turbo Connection: Reasoning as Information Flow from Higher to Lower Layers](#user-content-link5)
**Authors:** Mohan Tang, Sidi Lu

6. [Unifying approach to uniform expressivity of graph neural networks](#user-content-link6)
**Authors:** Huan Luo, Jonni Virtema

7. [RAT+: Train Dense, Infer Sparse -- Recurrence Augmented Attention for Dilated Inference](#user-content-link7)
**Authors:** Xiuying Wei, Caglar Gulcehre

8. [Bayesian Optimality of In-Context Learning with Selective State Spaces](#user-content-link8)
**Authors:** Di Zhang, Jiaqi Xing

9. [JPmHC Dynamical Isometry via Orthogonal Hyper-Connections](#user-content-link9)
**Authors:** Biswa Sengupta, Jinhua Wang, Leo Brunswic

10. [Calibrated Adaptation: Bayesian Stiefel Manifold Priors for Reliable Parameter-Efficient Fine-Tuning](#user-content-link10)
**Authors:** Ibne Farabi Shihab, Sanjeda Akter, Anuj Sharma

11. [Neural-HSS: Hierarchical Semi-Separable Neural PDE Solver](#user-content-link11)
**Authors:** Pietro Sittoni, Emanuele Zangrando, Angelo A. Casulli, Nicola Guglielmi, Francesco Tudisco

12. [GeneZip: Region-Aware Compression for Long Context DNA Modeling](#user-content-link12)
**Authors:** Jianan Zhao, Xixian Liu, Zhihao Zhan, Xinyu Yuan, Hongyu Guo, Jian Tang

13. [Topological Exploration of High-Dimensional Empirical Risk Landscapes: general approach, and applications to phase retrieval](#user-content-link13)
**Authors:** Antoine Maillard, Tony Bonnaire, Giulio Biroli

14. [UBio-MolFM: A Universal Molecular Foundation Model for Bio-Systems](#user-content-link14)
...
15. [Asynchronous Heavy-Tailed Optimization](#user-content-link15)
**Authors:** Junfei Sun, Dixi Yao, Xuchen Gong, Tahseen Rabbani, Manzil Zaheer, Tian Li

16. [Dual Length Codes for Lossless Compression of BFloat16](#user-content-link16)
...
17. [Breaking the Correlation Plateau: On the Optimization and Capacity Limits of Attention-Based Regressors](#user-content-link17)
**Authors:** Jingquan Yan, Yuwei Miao, Peiran Yu, Junzhou Huang

18. [A Geometric Probe of the Accuracy-Robustness Trade-off: Sharp Boundaries in Symmetry-Breaking Dimensional Expansion](#user-content-link18)
**Authors:** Yu Bai, Zhe Wang, Jiarui Zhang, Dong-Xiao Zhang, Yinjun Gao, Jun-Jie Zhang

19. [Influence-Preserving Proxies for Gradient-Based Data Selection in LLM Fine-tuning](#user-content-link19)
**Authors:** Sirui Chen, Yunzhe Qi, Mengting Ai, Yifan Sun, Ruizhong Qiu, Jiaru Zou, Jingrui He

20. [Provable Adversarial Robustness in In-Context Learning](#user-content-link20)
**Authors:** Di Zhang

21. [Advection-Diffusion on Graphs: A Bakry-Emery Laplacian for Spectral Graph Neural Networks](#user-content-link21)
**Authors:** Pierre-Gabriel Berlureau, Ali Hariri, Victor Kawasaki-Borruat, Mia Zosso, Pierre Vandergheynst

22. [Learning Long-Range Dependencies with Temporal Predictive Coding](#user-content-link22)
**Authors:** Tom Potter, Oliver Rhodes

23. [Asking Forever: Universal Activations Behind Turn Amplification in Conversational LLMs](#user-content-link23)
**Authors:** Zachary Coalson, Bo Fang, Sanghyun Hong

24. [PHAST: Port-Hamiltonian Architecture for Structured Temporal Dynamics Forecasting](#user-content-link24)
**Authors:** Shubham Bhardwaj, Chandrajit Bajaj

25. [ADAPT: Hybrid Prompt Optimization for LLM Feature Visualization](#user-content-link25)
**Authors:** Jo\~ao N. Cardoso, Arlindo L. Oliveira, Bruno Martins

---

## 1. [Grassmannian Mixture-of-Experts: Concentration-Controlled Routing on Subspace Manifolds](https://arxiv.org/abs/2602.17798) <a id="link1"></a>
...
## 2. [SeedFlood: A Step Toward Scalable Decentralized Training of LLMs](https://arxiv.org/abs/2602.18181) <a id="link2"></a>
...
## 3. [ScaleBITS: Scalable Bitwidth Search for Hardware-Aligned Mixed-Precision LLMs](https://arxiv.org/abs/2602.17698) <a id="link3"></a>
...
## 4. [Cut Less, Fold More: Model Compression through the Lens of Projection Geometry](https://arxiv.org/abs/2602.18116) <a id="link4"></a>
...
## 5. [Turbo Connection: Reasoning as Information Flow from Higher to Lower Layers](https://arxiv.org/abs/2602.17993) <a id="link5"></a>
...
## 6. [Unifying approach to uniform expressivity of graph neural networks](https://arxiv.org/abs/2602.18409) <a id="link6"></a>
...
## 7. [RAT+: Train Dense, Infer Sparse -- Recurrence Augmented Attention for Dilated Inference](https://arxiv.org/abs/2602.18196) <a id="link7"></a>
...
## 8. [Bayesian Optimality of In-Context Learning with Selective State Spaces](https://arxiv.org/abs/2602.17744) <a id="link8"></a>
...
## 9. [JPmHC Dynamical Isometry via Orthogonal Hyper-Connections](https://arxiv.org/abs/2602.18308) <a id="link9"></a>
...
## 10. [Calibrated Adaptation: Bayesian Stiefel Manifold Priors for Reliable Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2602.17809) <a id="link10"></a>
...
## 11. [Neural-HSS: Hierarchical Semi-Separable Neural PDE Solver](https://arxiv.org/abs/2602.18248) <a id="link11"></a>
...
## 12. [GeneZip: Region-Aware Compression for Long Context DNA Modeling](https://arxiv.org/abs/2602.17739) <a id="link12"></a>
...
## 13. [Topological Exploration of High-Dimensional Empirical Risk Landscapes: general approach, and applications to phase retrieval](https://arxiv.org/abs/2602.17779) <a id="link13"></a>
...
## 14. [UBio-MolFM: A Universal Molecular Foundation Model for Bio-Systems](https://arxiv.org/abs/2602.17709) <a id="link14"></a>
...
## 15. [Asynchronous Heavy-Tailed Optimization](https://arxiv.org/abs/2602.18002) <a id="link15"></a>
...
## 16. [Dual Length Codes for Lossless Compression of BFloat16](https://arxiv.org/abs/2602.17849) <a id="link16"></a>
...
## 17. [Breaking the Correlation Plateau: On the Optimization and Capacity Limits of Attention-Based Regressors](https://arxiv.org/abs/2602.17898) <a id="link17"></a>
...
## 18. [A Geometric Probe of the Accuracy-Robustness Trade-off: Sharp Boundaries in Symmetry-Breaking Dimensional Expansion](https://arxiv.org/abs/2602.17948) <a id="link18"></a>
...
## 19. [Influence-Preserving Proxies for Gradient-Based Data Selection in LLM Fine-tuning](https://arxiv.org/abs/2602.17835) <a id="link19"></a>
...
**Comment:** Compression/Efficiency: low-rank compression plus gradient/logit alignment to build influence-preserving proxies for scalable LLM data selection.
...
## 20. [Provable Adversarial Robustness in In-Context Learning](https://arxiv.org/abs/2602.17743) <a id="link20"></a>
...
**Comment:** Theory of In-Context Learning: provable adversarial robustness bounds for linear self-attention Transformers under Wasserstein shifts (capacity/sample complexity).
...
## 21. [Advection-Diffusion on Graphs: A Bakry-Emery Laplacian for Spectral Graph Neural Networks](https://arxiv.org/abs/2602.18141) <a id="link21"></a>
...
**Comment:** Model Architecture (GNNs): Bakry-Emery Laplacian with learnable potential yielding adaptive advection–diffusion in spectral GNNs (mu-ChebNet).
...
## 22. [Learning Long-Range Dependencies with Temporal Predictive Coding](https://arxiv.org/abs/2602.18131) <a id="link22"></a>
...
**Comment:** Training/Efficiency: combines Temporal Predictive Coding with approximate RTRL for local, parallelizable spatio-temporal credit assignment as an alternative to BPTT.
...
## 23. [Asking Forever: Universal Activations Behind Turn Amplification in Conversational LLMs](https://arxiv.org/abs/2602.17778) <a id="link23"></a>
...
**Comment:** Representation Learning/Mechanistic Interpretability: identifies a universal activation subspace driving clarification-seeking and turn amplification across prompts and models.
...
## 24. [PHAST: Port-Hamiltonian Architecture for Structured Temporal Dynamics Forecasting](https://arxiv.org/abs/2602.17998) <a id="link24"></a>
...
**Comment:** Model Architecture: introduces a port-Hamiltonian neural architecture with low-rank PSD/SPD parameterizations and stable integrators for long-horizon dynamics.
...
## 25. [ADAPT: Hybrid Prompt Optimization for LLM Feature Visualization](https://arxiv.org/abs/2602.17867) <a id="link25"></a>
...
**Comment:** Representation Learning: feature visualization for LLM directions via hybrid prompt optimization tailored to discrete text.
