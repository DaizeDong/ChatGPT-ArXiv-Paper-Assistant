<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../10"><img src="../../../assets/nav/day/2025-11-11-prev.svg" alt="Previous Day 2025-11-10"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-11-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../12"><img src="../../../assets/nav/day/2025-11-11-next.svg" alt="Next Day 2025-11-12"></a></div></div>
...
1. [MoSKA: Mixture of Shared KV Attention for Efficient Long-Sequence LLM Inference](#user-content-link1)
**Authors:** Myunghyun Rhee, Sookyung Choi, Euiseok Kim, Joonseop Sim, Youngpyo Joo, Hoshik Kim

2. [Route Experts by Sequence, not by Token](#user-content-link2)
...
3. [Lethe: Layer- and Time-Adaptive KV Cache Pruning for Reasoning-Intensive LLM Serving](#user-content-link3)
**Authors:** Hui Zeng, Daming Zhao, Pengfei Yang, Wenxuan Hou, Tianyang Zheng, Hui Li, Weiye Ji, Jidong Zhai

4. [How Particle-System Random Batch Methods Enhance Graph Transformer: Memory Efficiency and Parallel Computing Strategy](#user-content-link4)
...
6. [Rethinking Parameter Sharing as Graph Coloring for Structured Compression](#user-content-link6)
**Authors:** Boyang Zhang, Daning Cheng, Yunquan Zhang

7. [PuzzleMoE: Efficient Compression of Large Mixture-of-Experts Models via Sparse Expert Merging and Bit-packed inference](#user-content-link7)
**Authors:** Yushu Zhao, Zheng Wang, Minjia Zhang

8. [Routing Manifold Alignment Improves Generalization of Mixture-of-Experts LLMs](#user-content-link8)
**Authors:** Zhongyang Li, Ziyue Li, Tianyi Zhou

9. [Next-Latent Prediction Transformers Learn Compact World Models](#user-content-link9)
**Authors:** Jayden Teoh, Manan Tomar, Kwangjun Ahn, Edward S. Hu, Pratyusha Sharma, Riashat Islam, Alex Lamb, John Langford

10. [Adam symmetry theorem: characterization of the convergence of the stochastic Adam optimizer](#user-content-link10)
**Authors:** Steffen Dereich, Thang Do, Arnulf Jentzen, Philippe von Wurstemberger

11. [Transformers Provably Learn Chain-of-Thought Reasoning with Length Generalization](#user-content-link11)
**Authors:** Yu Huang, Zixin Wen, Aarti Singh, Yuejie Chi, Yuxin Chen

12. [A Fully Polynomial-Time Algorithm for Robustly Learning Halfspaces over the Hypercube](#user-content-link12)
**Authors:** Gautam Chandrasekaran, Adam R. Klivans, Konstantinos Stavropoulos, Arsen Vasilyan

13. [Can Training Dynamics of Scale-Invariant Neural Networks Be Explained by the Thermodynamics of an Ideal Gas?](#user-content-link13)
**Authors:** Ildus Sadrtdinov, Ekaterina Lobacheva, Ivan Klimov, Mikhail I. Katsnelson, Dmitry Vetrov

14. [Make It Long, Keep It Fast: End-to-End 10k-Sequence Modeling at Billion Scale on Douyin](#user-content-link14)
...
15. [MobileLLM-Pro Technical Report](#user-content-link15)
...
16. [The Few Govern the Many:Unveiling Few-Layer Dominance for Time Series Models](#user-content-link16)
**Authors:** Xin Qiu, Junlong Tong, Yirong Sun, Yunpu Ma, Xiaoyu Shen

17. [Depth-induced NTK: Bridging Over-parameterized Neural Networks and Deep Neural Kernels](#user-content-link17)
**Authors:** Yong-Ming Tian, Shuang Liang, Shao-Qun Zhang, Feng-Lei Fan

18. [LoRA on the Go: Instance-level Dynamic LoRA Selection and Merging](#user-content-link18)
**Authors:** Seungeon Lee, Soumi Das, Manish Gupta, Krishna P. Gummadi

19. [Teaching Pretrained Language Models to Think Deeper with Retrofitted Recurrence](#user-content-link19)
...
20. [TuckA: Hierarchical Compact Tensor Experts for Efficient Fine-Tuning](#user-content-link20)
**Authors:** Qifeng Lei, Zhiyong Yang, Qianqian Xu, Cong Hua, Peisong Wen, Qingming Huang

21. [P3-LLM: An Integrated NPU-PIM Accelerator for LLM Inference Using Hybrid Numerical Formats](#user-content-link21)
**Authors:** Yuzong Chen, Chao Fang, Xilai Dai, Yuheng Wu, Thierry Tambe, Marian Verhelst, Mohamed S. Abdelfattah

22. [Precision-Scalable Microscaling Datapaths with Optimized Reduction Tree for Efficient NPU Integration](#user-content-link22)
**Authors:** Stef Cuyckens, Xiaoling Yi, Robin Geens, Joren Dumoulin, Martin Wiesner, Chao Fang, Marian Verhelst

23. [Temporal Sparse Autoencoders: Leveraging the Sequential Nature of Language for Interpretability](#user-content-link23)
**Authors:** Usha Bhalla, Alex Oesterling, Claudio Mayrink Verdun, Himabindu Lakkaraju, Flavio P. Calmon

24. [QUARK: Quantization-Enabled Circuit Sharing for Transformer Acceleration by Exploiting Common Patterns in Nonlinear Operations](#user-content-link24)
**Authors:** Zhixiong Zhao, Haomin Li, Fangxin Liu, Yuncheng Lu, Zongwu Wang, Tao Yang, Li Jiang, Haibing Guan

25. [MI-to-Mid Distilled Compression (M2M-DC): An Hybrid-Information-Guided-Block Pruning with Progressive Inner Slicing Approach to Model Compression](#user-content-link25)
**Authors:** Lionel Levine, Sajjad Ghiasvand, Haniyeh Ehsani Oskouie, Majid Sarrafzadeh

26. [CAMP-HiVe: Cyclic Pair Merging based Efficient DNN Pruning with Hessian-Vector Approximation for Resource-Constrained Systems](#user-content-link26)
**Authors:** Mohammad Helal Uddin, Sai Krishna Ghanta, Liam Seymour, Sabur Baidya

27. [Learning to Focus: Focal Attention for Selective and Scalable Transformers](#user-content-link27)
**Authors:** Dhananjay Ram, Wei Xia, Stefano Soatto

28. [Understanding the role of depth in the neural tangent kernel for overparameterized neural networks](#user-content-link28)
**Authors:** William St-Arnaud, Margarida Carvalho, Golnoosh Farnadi

29. [Minimum Width of Deep Narrow Networks for Universal Approximation](#user-content-link29)
**Authors:** Xiao-Song Yang, Qi Zhou, Xuan Zhou

30. [Beyond Redundancy: Diverse and Specialized Multi-Expert Sparse Autoencoder](#user-content-link30)
**Authors:** Zhen Xu, Zhen Tan, Song Wang, Kaidi Xu, Tianlong Chen

31. [Rank-1 LoRAs Encode Interpretable Reasoning Signals](#user-content-link31)
**Authors:** Jake Ward, Paul Riechers, Adam Shai

32. [Diversified Flow Matching with Translation Identifiability](#user-content-link32)
**Authors:** Sagar Shrestha, Xiao Fu

33. [TNT: Improving Chunkwise Training for Test-Time Memorization](#user-content-link33)
...
35. [DyKAF: Dynamical Kronecker Approximation of the Fisher Information Matrix for Gradient Preconditioning](#user-content-link35)
**Authors:** Nikolay Yudin, Ekaterina Grishina, Andrey Veprikov, Alexandr Beznosikov, Maxim Rakhuba

36. [Provable Benefit of Curriculum in Transformer Tree-Reasoning Post-Training](#user-content-link36)
**Authors:** Dake Bu, Wei Huang, Andi Han, Atsushi Nitanda, Hau-San Wong, Qingfu Zhang, Taiji Suzuki

37. [A Provably-Correct and Robust Convex Model for Smooth Separable NMF](#user-content-link37)
**Authors:** Junjun Pan, Valentin Leplat, Michael Ng, Nicolas Gillis

38. [Physics-Informed Design of Input Convex Neural Networks for Consistency Optimal Transport Flow Matching](#user-content-link38)
**Authors:** Fanghui Song, Zhongjian Wang, Jiebao Sun

39. [C3PO: Optimized Large Language Model Cascades with Probabilistic Cost Constraints for Reasoning](#user-content-link39)
**Authors:** Antonios Valkanas, Soumyasundar Pal, Pavel Rumiantsev, Yingxue Zhang, Mark Coates

40. [On the Convergence and Stability of Distributed Sub-model Training](#user-content-link40)
**Authors:** Yuyang Deng, Fuli Qiao, Mehrdad Mahdavi

41. [How Wide and How Deep? Mitigating Over-Squashing of GNNs via Channel Capacity Constrained Estimation](#user-content-link41)
**Authors:** Zinuo You, Jin Zheng, John Cartlidge

42. [Rep2Text: Decoding Full Text from a Single LLM Token Representation](#user-content-link42)
**Authors:** Haiyan Zhao, Zirui He, Fan Yang, Ali Payani, Mengnan Du

43. [From Kernels to Attention: A Transformer Framework for Density and Score Estimation](#user-content-link43)
**Authors:** Vasily Ilin, Peter Sushko

44. [First is Not Really Better Than Last: Evaluating Layer Choice and Aggregation Strategies in Language Model Data Influence Estimation](#user-content-link44)
**Authors:** Dmytro Vitel, Anshuman Chhabra

45. [Beyond Fixed Depth: Adaptive Graph Neural Networks for Node Classification Under Varying Homophily](#user-content-link45)
**Authors:** Asela Hevapathige, Asiri Wijesinghe, Ahad N. Zehmakan

46. [Sampling and Loss Weights in Multi-Domain Training](#user-content-link46)
**Authors:** Mahdi Salmani, Pratik Worah, Meisam Razaviyayn, Vahab Mirrokni

47. [Magnitude-Modulated Equivariant Adapter for Parameter-Efficient Fine-Tuning of Equivariant Graph Neural Networks](#user-content-link47)
**Authors:** Dian Jin, Yancheng Yuan, Xiaoming Tao

48. [An Efficient Gradient-Aware Error-Bounded Lossy Compressor for Federated Learning](#user-content-link48)
**Authors:** Zhijing Ye, Sheng Di, Jiamin Wang, Zhiqing Zhong, Zhaorui Zhang, Xiaodong Yu

49. [Mixtures of SubExperts for Large Language Continual Learning](#user-content-link49)
**Authors:** Haeyong Kang

50. [Non-Negative Stiefel Approximating Flow: Orthogonalish Matrix Optimization for Interpretable Embeddings](#user-content-link50)
...
51. [Vocabulary In-Context Learning in Transformers: Benefits of Positional Encoding](#user-content-link51)
**Authors:** Qian Ma, Ruoxiang Xu, Yongqiang Cai

52. [Walsh-Hadamard Neural Operators for Solving PDEs with Discontinuous Coefficients](#user-content-link52)
**Authors:** Giorrgio M. Cavallazzi, Miguel Perex Cuadrado, Alfredo Pinelli

53. [Transolver is a Linear Transformer: Revisiting Physics-Attention through the Lens of Linear Attention](#user-content-link53)
**Authors:** Wenjie Hu, Sidun Liu, Peng Qiao, Zhenglun Sun, Yong Dou

54. [Recursive Dynamics in Fast-Weights Homeostatic Reentry Networks: Toward Reflective Intelligence](#user-content-link54)
**Authors:** B. G. Chae

---

## 1. [MoSKA: Mixture of Shared KV Attention for Efficient Long-Sequence LLM Inference](https://arxiv.org/abs/2511.06010) <a id="link1"></a>
...
## 2. [Route Experts by Sequence, not by Token](https://arxiv.org/abs/2511.06494) <a id="link2"></a>
...
## 3. [Lethe: Layer- and Time-Adaptive KV Cache Pruning for Reasoning-Intensive LLM Serving](https://arxiv.org/abs/2511.06029) <a id="link3"></a>
...
## 4. [How Particle-System Random Batch Methods Enhance Graph Transformer: Memory Efficiency and Parallel Computing Strategy](https://arxiv.org/abs/2511.06044) <a id="link4"></a>
...
## 6. [Rethinking Parameter Sharing as Graph Coloring for Structured Compression](https://arxiv.org/abs/2511.06786) <a id="link6"></a>
...
## 7. [PuzzleMoE: Efficient Compression of Large Mixture-of-Experts Models via Sparse Expert Merging and Bit-packed inference](https://arxiv.org/abs/2511.04805) <a id="link7"></a>
...
## 8. [Routing Manifold Alignment Improves Generalization of Mixture-of-Experts LLMs](https://arxiv.org/abs/2511.07419) <a id="link8"></a>
...
## 9. [Next-Latent Prediction Transformers Learn Compact World Models](https://arxiv.org/abs/2511.05963) <a id="link9"></a>
...
## 10. [Adam symmetry theorem: characterization of the convergence of the stochastic Adam optimizer](https://arxiv.org/abs/2511.06675) <a id="link10"></a>
...
## 11. [Transformers Provably Learn Chain-of-Thought Reasoning with Length Generalization](https://arxiv.org/abs/2511.07378) <a id="link11"></a>
...
## 12. [A Fully Polynomial-Time Algorithm for Robustly Learning Halfspaces over the Hypercube](https://arxiv.org/abs/2511.07244) <a id="link12"></a>
...
## 13. [Can Training Dynamics of Scale-Invariant Neural Networks Be Explained by the Thermodynamics of an Ideal Gas?](https://arxiv.org/abs/2511.07308) <a id="link13"></a>
...
## 14. [Make It Long, Keep It Fast: End-to-End 10k-Sequence Modeling at Billion Scale on Douyin](https://arxiv.org/abs/2511.06077) <a id="link14"></a>
...
## 15. [MobileLLM-Pro Technical Report](https://arxiv.org/abs/2511.06719) <a id="link15"></a>
...
## 16. [The Few Govern the Many:Unveiling Few-Layer Dominance for Time Series Models](https://arxiv.org/abs/2511.07237) <a id="link16"></a>
...
## 17. [Depth-induced NTK: Bridging Over-parameterized Neural Networks and Deep Neural Kernels](https://arxiv.org/abs/2511.05585) <a id="link17"></a>
...
## 18. [LoRA on the Go: Instance-level Dynamic LoRA Selection and Merging](https://arxiv.org/abs/2511.07129) <a id="link18"></a>
...
## 19. [Teaching Pretrained Language Models to Think Deeper with Retrofitted Recurrence](https://arxiv.org/abs/2511.07384) <a id="link19"></a>
...
## 20. [TuckA: Hierarchical Compact Tensor Experts for Efficient Fine-Tuning](https://arxiv.org/abs/2511.06859) <a id="link20"></a>
...
## 21. [P3-LLM: An Integrated NPU-PIM Accelerator for LLM Inference Using Hybrid Numerical Formats](https://arxiv.org/abs/2511.06838) <a id="link21"></a>
...
## 22. [Precision-Scalable Microscaling Datapaths with Optimized Reduction Tree for Efficient NPU Integration](https://arxiv.org/abs/2511.06313) <a id="link22"></a>
...
## 23. [Temporal Sparse Autoencoders: Leveraging the Sequential Nature of Language for Interpretability](https://arxiv.org/abs/2511.05541) <a id="link23"></a>
...
## 24. [QUARK: Quantization-Enabled Circuit Sharing for Transformer Acceleration by Exploiting Common Patterns in Nonlinear Operations](https://arxiv.org/abs/2511.06767) <a id="link24"></a>
...
## 25. [MI-to-Mid Distilled Compression (M2M-DC): An Hybrid-Information-Guided-Block Pruning with Progressive Inner Slicing Approach to Model Compression](https://arxiv.org/abs/2511.06842) <a id="link25"></a>
...
## 26. [CAMP-HiVe: Cyclic Pair Merging based Efficient DNN Pruning with Hessian-Vector Approximation for Resource-Constrained Systems](https://arxiv.org/abs/2511.06265) <a id="link26"></a>
...
## 27. [Learning to Focus: Focal Attention for Selective and Scalable Transformers](https://arxiv.org/abs/2511.06818) <a id="link27"></a>
...
## 28. [Understanding the role of depth in the neural tangent kernel for overparameterized neural networks](https://arxiv.org/abs/2511.07272) <a id="link28"></a>
...
## 29. [Minimum Width of Deep Narrow Networks for Universal Approximation](https://arxiv.org/abs/2511.06837) <a id="link29"></a>
...
## 30. [Beyond Redundancy: Diverse and Specialized Multi-Expert Sparse Autoencoder](https://arxiv.org/abs/2511.05745) <a id="link30"></a>
...
## 31. [Rank-1 LoRAs Encode Interpretable Reasoning Signals](https://arxiv.org/abs/2511.06739) <a id="link31"></a>
...
## 32. [Diversified Flow Matching with Translation Identifiability](https://arxiv.org/abs/2511.05558) <a id="link32"></a>
...
## 33. [TNT: Improving Chunkwise Training for Test-Time Memorization](https://arxiv.org/abs/2511.07343) <a id="link33"></a>
...
## 35. [DyKAF: Dynamical Kronecker Approximation of the Fisher Information Matrix for Gradient Preconditioning](https://arxiv.org/abs/2511.06477) <a id="link35"></a>
...
## 36. [Provable Benefit of Curriculum in Transformer Tree-Reasoning Post-Training](https://arxiv.org/abs/2511.07372) <a id="link36"></a>
...
## 37. [A Provably-Correct and Robust Convex Model for Smooth Separable NMF](https://arxiv.org/abs/2511.07109) <a id="link37"></a>
...
## 38. [Physics-Informed Design of Input Convex Neural Networks for Consistency Optimal Transport Flow Matching](https://arxiv.org/abs/2511.06042) <a id="link38"></a>
...
## 39. [C3PO: Optimized Large Language Model Cascades with Probabilistic Cost Constraints for Reasoning](https://arxiv.org/abs/2511.07396) <a id="link39"></a>
...
## 40. [On the Convergence and Stability of Distributed Sub-model Training](https://arxiv.org/abs/2511.06132) <a id="link40"></a>
...
## 41. [How Wide and How Deep? Mitigating Over-Squashing of GNNs via Channel Capacity Constrained Estimation](https://arxiv.org/abs/2511.06443) <a id="link41"></a>
...
## 42. [Rep2Text: Decoding Full Text from a Single LLM Token Representation](https://arxiv.org/abs/2511.06571) <a id="link42"></a>
...
## 43. [From Kernels to Attention: A Transformer Framework for Density and Score Estimation](https://arxiv.org/abs/2511.05924) <a id="link43"></a>
...
## 44. [First is Not Really Better Than Last: Evaluating Layer Choice and Aggregation Strategies in Language Model Data Influence Estimation](https://arxiv.org/abs/2511.04715) <a id="link44"></a>
...
## 45. [Beyond Fixed Depth: Adaptive Graph Neural Networks for Node Classification Under Varying Homophily](https://arxiv.org/abs/2511.06608) <a id="link45"></a>
...
## 46. [Sampling and Loss Weights in Multi-Domain Training](https://arxiv.org/abs/2511.06913) <a id="link46"></a>
...
## 47. [Magnitude-Modulated Equivariant Adapter for Parameter-Efficient Fine-Tuning of Equivariant Graph Neural Networks](https://arxiv.org/abs/2511.06696) <a id="link47"></a>
...
## 48. [An Efficient Gradient-Aware Error-Bounded Lossy Compressor for Federated Learning](https://arxiv.org/abs/2511.05770) <a id="link48"></a>
...
## 49. [Mixtures of SubExperts for Large Language Continual Learning](https://arxiv.org/abs/2511.06237) <a id="link49"></a>
...
## 50. [Non-Negative Stiefel Approximating Flow: Orthogonalish Matrix Optimization for Interpretable Embeddings](https://arxiv.org/abs/2511.06425) <a id="link50"></a>
...
## 51. [Vocabulary In-Context Learning in Transformers: Benefits of Positional Encoding](https://arxiv.org/abs/2511.06376) <a id="link51"></a>
...
## 52. [Walsh-Hadamard Neural Operators for Solving PDEs with Discontinuous Coefficients](https://arxiv.org/abs/2511.07347) <a id="link52"></a>
...
## 53. [Transolver is a Linear Transformer: Revisiting Physics-Attention through the Lens of Linear Attention](https://arxiv.org/abs/2511.06294) <a id="link53"></a>
...
## 54. [Recursive Dynamics in Fast-Weights Homeostatic Reentry Networks: Toward Reflective Intelligence](https://arxiv.org/abs/2511.06798) <a id="link54"></a>
