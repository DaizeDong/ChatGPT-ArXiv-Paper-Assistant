<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../12"><img src="../../../assets/nav/day/2026-02-13-prev.svg" alt="Previous Day 2026-02-12"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-13-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../16"><img src="../../../assets/nav/day/2026-02-13-next.svg" alt="Next Day 2026-02-16"></a></div></div>
...
## 2. [RAM-Net: Expressive Linear Attention with Selectively Addressable Memory](https://arxiv.org/abs/2602.11958) <a id="link2"></a>
...
## 3. [Extending Puzzle for Mixture-of-Experts Reasoning Models with Application to GPT-OSS Acceleration](https://arxiv.org/abs/2602.11937) <a id="link3"></a>
...
## 4. [Krause Synchronization Transformers](https://arxiv.org/abs/2602.11534) <a id="link4"></a>
...
## 5. [LAER-MoE: Load-Adaptive Expert Re-layout for Efficient Mixture-of-Experts Training](https://arxiv.org/abs/2602.11686) <a id="link5"></a>
...
## 6. [KBVQ-MoE: KLT-guided SVD with Bias-Corrected Vector Quantization for MoE Large Language Models](https://arxiv.org/abs/2602.11184) <a id="link6"></a>
...
## 7. [Retrieval-Aware Distillation for Transformer-SSM Hybrids](https://arxiv.org/abs/2602.11374) <a id="link7"></a>
...
## 8. [MELINOE: Fine-Tuning Enables Memory-Efficient Inference for Mixture-of-Experts Models](https://arxiv.org/abs/2602.11192) <a id="link8"></a>
...
## 9. [Learning to Forget Attention: Memory Consolidation for Adaptive Compute Reduction](https://arxiv.org/abs/2602.12204) <a id="link9"></a>
...
## 10. [From Atoms to Trees: Building a Structured Feature Forest with Hierarchical Sparse Autoencoders](https://arxiv.org/abs/2602.11881) <a id="link10"></a>
...
## 11. [Spectra: Rethinking Optimizers for LLMs Under Spectral Anisotropy](https://arxiv.org/abs/2602.11185) <a id="link11"></a>
...
## 12. [GHOST: Unmasking Phantom States in Mamba2 via Grouped Hidden-state Output-aware Selection & Truncation](https://arxiv.org/abs/2602.11408) <a id="link12"></a>
...
## 13. [Improved state mixing in higher-order and block diagonal linear recurrent networks](https://arxiv.org/abs/2602.12021) <a id="link13"></a>
...
## 14. [Sparse Semantic Dimension as a Generalization Certificate for LLMs](https://arxiv.org/abs/2602.11388) <a id="link14"></a>
...
## 15. [HiFloat4 Format for Language Model Inference](https://arxiv.org/abs/2602.11287) <a id="link15"></a>
...
## 16. [SpiralFormer: Looped Transformers Can Learn Hierarchical Dependencies via Multi-Resolution Recursion](https://arxiv.org/abs/2602.11698) <a id="link16"></a>
...
## 17. [MiniCPM-SALA: Hybridizing Sparse and Linear Attention for Efficient Long-Context Modeling](https://arxiv.org/abs/2602.11761) <a id="link17"></a>
...
## 18. [PrefillShare: A Shared Prefill Module for KV Reuse in Multi-LLM Disaggregated Serving](https://arxiv.org/abs/2602.12029) <a id="link18"></a>
...
## 19. [Towards Compressive and Scalable Recurrent Memory](https://arxiv.org/abs/2602.11212) <a id="link19"></a>
...
## 20. [Prototype Transformer: Towards Language Model Architectures Interpretable by Design](https://arxiv.org/abs/2602.11852) <a id="link20"></a>
...
## 21. [HLA: Hadamard Linear Attention](https://arxiv.org/abs/2602.12128) <a id="link21"></a>
...
## 22. [Predicting LLM Output Length via Entropy-Guided Representations](https://arxiv.org/abs/2602.11812) <a id="link22"></a>
...
## 23. [The Implicit Bias of Logit Regularization](https://arxiv.org/abs/2602.12039) <a id="link23"></a>
...
## 24. [Protein Circuit Tracing via Cross-layer Transcoders](https://arxiv.org/abs/2602.12026) <a id="link24"></a>
...
## 25. [MonarchRT: Efficient Attention for Real-Time Video Generation](https://arxiv.org/abs/2602.12271) <a id="link25"></a>
...
## 26. [Efficient Analysis of the Distilled Neural Tangent Kernel](https://arxiv.org/abs/2602.11320) <a id="link26"></a>
...
## 27. [ThinkRouter: Efficient Reasoning via Routing Thinking between Latent and Discrete Spaces](https://arxiv.org/abs/2602.11683) <a id="link27"></a>
...
## 28. [Manifold-Aware Temporal Domain Generalization for Large Language Models](https://arxiv.org/abs/2602.11965) <a id="link28"></a>
...
## 29. [Beyond Parameter Arithmetic: Sparse Complementary Fusion for Distribution-Aware Model Merging](https://arxiv.org/abs/2602.11717) <a id="link29"></a>
...
## 30. [RooflineBench: A Benchmarking Framework for On-Device LLMs via Roofline Analysis](https://arxiv.org/abs/2602.11506) <a id="link30"></a>
...
## 31. [Enforcing Reciprocity in Operator Learning for Seismic Wave Propagation](https://arxiv.org/abs/2602.11631) <a id="link31"></a>
...
## 32. [Differentially Private and Communication Efficient Large Language Model Split Inference via Stochastic Quantization and Soft Prompt](https://arxiv.org/abs/2602.11513) <a id="link32"></a>
...
## 33. [Hierarchical Concept Embedding & Pursuit for Interpretable Image Classification](https://arxiv.org/abs/2602.11448) <a id="link33"></a>
...
## 34. [In-Context Function Learning in Large Language Models](https://arxiv.org/abs/2602.11863) <a id="link34"></a>
...
## 35. [The Observer Effect in World Models: Invasive Adaptation Corrupts Latent Physics](https://arxiv.org/abs/2602.12218) <a id="link35"></a>
...
## 36. [TAVAE: A VAE with Adaptable Priors Explains Contextual Modulation in the Visual Cortex](https://arxiv.org/abs/2602.11956) <a id="link36"></a>
