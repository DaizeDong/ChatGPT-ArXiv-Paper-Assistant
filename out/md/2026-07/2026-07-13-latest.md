...
2. [WSqD: A Horizon-Free Learning Rate Schedule for Large Model Training](#paper-2607-10959)
**Authors:** Jianhao Ma, Yuxin Chen

3. [CHASE: Cache-Hole-Adapted Skip Exit for Looped State-Space Language Models](#paper-2607-10110)
**Authors:** Zhenxuan Yu, Takeshi Kojima, Yutaka Matsuo, Yusuke Iwasawa

4. [Learning in Curved Weight Space:Exponential-Linear Weight Reparameterization for Improved Optimization](#paper-2607-09967)
**Authors:** Ethan Smith

5. [AutoNorm: Understanding Adaptive Normalization in Transformers through Differentiable Gating](#paper-2607-10593)
**Authors:** Piyush Kaushik Bhattacharyya, Divyanshu Rai, Swastik Singh, Kumar Aakash, Ayush Ranjan, Krutika Verma

6. [From Self-Attention to Connection Laplacian: A Unified Operator View of Transformers](#paper-2607-10677)
**Authors:** Binbin Lin, Wei Chen, Yalun Li, Wenxiao Wang, Jieping Ye, Xiaofei He

7. [LayerNorm as Implicit Gain Control in Looped Transformers](#paper-2607-10681)
**Authors:** Matthias M. M. Buehlmaier

8. [MLPs are Hebbians: Constructing Efficient Fact-Storing MLPs for Transformers](#paper-2607-10034)
**Authors:** Roberto Garcia, Jerry Liu, Ronny Junkins, Sabri Eyuboglu, Atri Rudra, Christopher Ré

9. [Conservation Laws for Diffusion Models](#paper-2607-10067)
**Authors:** Ziv Aharoni, Henry D. Pfister

10. [Self-Guided Test-Time Training for Long-Context LLMs](#paper-2607-09415)
...
11. [LionVote: Per-Layer Learning Rate Adaptation for Lion](#paper-2607-09266)
**Authors:** Kris Atallah

12. [When Data Imbalance Helps: Robust Generalization Through Shortcut Saturation](#paper-2607-10116)
**Authors:** Cheng-Ting Chou, Duc Binh Hoang

13. [Interference and Retention in Continual Learning](#paper-2607-09202)
**Authors:** Julius Störk

14. [Exploring More to Solve More: Boosting Diversity in Text Diffusion Models via Entropy-Based Guidance](#paper-2608-00024)
**Authors:** Jingwei Zhang, Haoyu Lei, Zijin Feng, Jiacheng Sun, Farzan Farnia

15. [Adaptive Compute in Latent World Models: When Depth Helps, Hurts, or Doesn't Matter](#paper-2607-10203)
...
17. [Energy-guided Recursive Model](#paper-2607-10128)
**Authors:** Yifei Zhao, Ying Tang

18. [Fully Trainable Deep Differentiable Logic Gate Networks and Lookup Table Networks](#paper-2607-09399)
**Authors:** Wout Mommen, Lars Keuninckx, Matthias Hartmann, Werner Van Leekwijck, Piet Wambacq

19. [From Atoms to Entropy: Optimal Noise Allocation for Diffusion Training in the Convex Regime](#paper-2607-20540)
...
20. [Next-Dense-Stride Prediction for Multimodal Autoregressive Visual Modeling](#paper-2607-09892)
**Authors:** Chicago Y. Park, Jialin Mao, Xiaojian Xu, Taha Kass-Hout, Ulugbek S. Kamilov, Cao Xiao

21. [On Locality and Length Generalization in Visual Reasoning](#paper-2607-09061)
**Authors:** Pulkit Madan, Sanjay Haresh, Reza Ebrahimi, Sunny Panchal, Apratim Bhattacharyya, Roland Memisevic

22. [Foveation-Guided Dynamic Token Selection for Robust and Efficient Vision Transformers](#paper-2607-09480)
**Authors:** Ibrahim Batuhan Akkaya, Kishaan Jeeveswaran, Bahram Zonooz, Elahe Arani

23. [Understanding Schedule-Free Methods in Nonconvex Optimization: Rate Guarantees and Escaping Saddles](#paper-2607-09167)
**Authors:** Jiseok Chae, Donghwan Kim

24. [Source-Lifted Flow Matching for Intervenable Multimodal Imitation](#paper-2607-10206)
**Authors:** He Zhang, Ying Sun, Pengteng Li, Ziyang Chen, Yiren Zhao, Ziyang Rao, Weiyu Guo, Yandong Guo, Hui Xiong

25. [Singular perturbations and hierarchical learning in two-layer neural networks](#paper-2607-10869)
**Authors:** Cédric Gerbelot, Jean-Christophe Mourrat

26. [Robustly Invertible Nonlinear Dynamics and the BiLipREN: From Inversion-Based Control to Generative Trajectory Modelling](#paper-2607-10026)
...
1. [Codec-Gauge: Learning Compression-Friendly Gauges for Transformer KV Caches](#paper-2607-20538)
**Authors:** Yitao Jiang, Yaoqing Yang, Luyang Zhao, Muhao Chen, Devin Balkcom

2. [Seeing is Free, Speaking is Not: Uncovering the True Energy Bottleneck in Edge VLM Inference](#paper-2607-09520)
**Authors:** Junfei Zhan, Haoxun Shen, Mingang Guo, Zixuan Huang, Tengjiao He

3. [KV-PRM: Efficient Process Reward Modeling via KV-Cache Transfer for Multi-Agent Test-Time Scaling](#paper-2607-09153)
**Authors:** Peng Kuang, Haibo Jin, Xiaoyu Han, Yanli Wang, Xiaopeng Yuan, Ye Yu, Kaidi Xu, Haohan Wang

4. [Reliability Scaling Laws for Quantized Large Language Models](#paper-2607-10855)
**Authors:** Sirine Ayadi, Sándor Daróczi, Stephan Günnemann, Bertrand Charpentier

5. [Super-Tuning: From Activation-Aware Pruning to Sparse Fine-Tuning](#paper-2607-09287)
**Authors:** Ivan Ilin, Philip Zmushko, Peter Richtárik

6. [MemDecay: Region-Aware KV Cache Eviction for Efficient LLM Agent Inference](#paper-2607-10582)
**Authors:** Venkatesha Matam, Keon Kim

7. [Structured Thoughts For Improved Reasoning And Context Pruning](#paper-2607-10386)
...
8. [STEEL: Sparsity-Aware Fused Attention for Energy-Efficient Long-Sequence Inference on AMD's XDNA NPU](#paper-2607-09385)
**Authors:** Victor J. B. Jung, Gagandeep Singh, Joseph Melber, Kristof Denolf, Francesco Conti, Luca Benini

9. [CARE-LoRA: Compressed Activation REconstruction for Memory-Efficient LoRA](#paper-2607-11940)
...
11. [IterCOMP: Reasoning-aware Adaptive Prompt Compression for Multi-hop Question Answering](#paper-2608-13588)
**Authors:** JungMin Yun, YoungBin Kim

12. [Adaptive Model Compression (AMC): Saliency-Driven Resource Allocation for Ultra-Low-Power Transformer Inference](#paper-2607-10109)
**Authors:** Jiayin Hu, Kai Yuan, Vanessa Hu, Xuetao Yin, Jianhua Li, Sean Suchter

13. [Dependency-Aware Chain-of-Thought Compression for Financial Reasoning](#paper-2609-00413)
**Authors:** Wenjun Wu, Lei Fu, Kejian Tong, Tao Ning, Sichen Zhao

14. [IB-Flow: Information Bottleneck-Guided CFG Distillation for Few-Step Text-to-Image Generation](#paper-2607-09133)
...
**Comment:** Replaces fixed RoPE frequencies with learned scalars, validated through pretraining from 52M to 2.5B parameters.

**Topic Match:** Directly changes positional encoding inside pretrained language-model layers, with comparisons against RoPE and partial RoPE across scales.
...
### 2. [WSqD: A Horizon-Free Learning Rate Schedule for Large Model Training](https://arxiv.org/abs/2607.10959) <a id="paper-2607-10959"></a>
...
**Comment:** Holds peak learning rate fixed while varying pretraining duration through a horizon-independent inverse-square-root base schedule.

**Topic Match:** Decouples peak-rate selection from the training horizon; the terminal cooldown still requires an endpoint decision.
...
### 3. [CHASE: Cache-Hole-Adapted Skip Exit for Looped State-Space Language Models](https://arxiv.org/abs/2607.10110) <a id="paper-2607-10110"></a>
...
### 4. [Learning in Curved Weight Space:Exponential-Linear Weight Reparameterization for Improved Optimization](https://arxiv.org/abs/2607.09967) <a id="paper-2607-09967"></a>
...
### 5. [AutoNorm: Understanding Adaptive Normalization in Transformers through Differentiable Gating](https://arxiv.org/abs/2607.10593) <a id="paper-2607-10593"></a>
...
**Comment:** Stabilizes learned normalization selection by freezing noisy differentiable gates.

**Topic Match:** Layer-wise normalization choice and gate-induced optimization instability directly match the centre line, although the language-model evidence is small-scale.
...
### 6. [From Self-Attention to Connection Laplacian: A Unified Operator View of Transformers](https://arxiv.org/abs/2607.10677) <a id="paper-2607-10677"></a>
...
**Comment:** Identifies multi-head attention as an edge-dependent transport operator and measures its learned geometry.

**Topic Match:** Analyzes the computation performed by trained attention layers across 124M-8B models and encoder/decoder structures.
...
### 7. [LayerNorm as Implicit Gain Control in Looped Transformers](https://arxiv.org/abs/2607.10681) <a id="paper-2607-10681"></a>
...
**Comment:** Identifies the carry as a stabilizer and the nonlinear recurrence as the main memory path in pre-LayerNorm looped transformers.

**Topic Match:** Directly analyzes normalization, recurrent Jacobians, and training-induced allocation of computation; empirical verification remains CPU-scale.
...
### 8. [MLPs are Hebbians: Constructing Efficient Fact-Storing MLPs for Transformers](https://arxiv.org/abs/2607.10034) <a id="paper-2607-10034"></a>
...
**Comment:** Constructs Transformer-compatible MLPs with optimal factual-storage scaling by controlling decoding margin.

**Topic Match:** The core is a constructive account of storage and decoding inside Transformer MLPs; evidence concerns constructed factual-recall systems.
...
### 9. [Conservation Laws for Diffusion Models](https://arxiv.org/abs/2607.10067) <a id="paper-2607-10067"></a>
...
**Comment:** Expresses diffusion cross-entropy through local posterior derivatives, yielding a marginal-posterior training objective.

**Topic Match:** The discrete-diffusion objective and noise-path analysis have an explicit text8 demonstration, providing a concrete language-model connection.
...
### 10. [Self-Guided Test-Time Training for Long-Context LLMs](https://arxiv.org/abs/2607.09415) <a id="paper-2607-09415"></a>
...
**Comment:** Selecting question-relevant spans isolates which context tokens support useful parameter adaptation.

**Topic Match:** The contribution concerns long-context test-time adaptation, an explicitly excluded core subject.
...
### 11. [LionVote: Per-Layer Learning Rate Adaptation for Lion](https://arxiv.org/abs/2607.09266) <a id="paper-2607-09266"></a>
...
**Comment:** Layer-specific diagnostics adapt Lion's learning rates to heterogeneous parameter groups.

**Topic Match:** Optimizer design is the closest topic, but the contribution and its explicitly limited gains concern vision-model training.
...
### 12. [When Data Imbalance Helps: Robust Generalization Through Shortcut Saturation](https://arxiv.org/abs/2607.10116) <a id="paper-2607-10116"></a>
...
**Comment:** Links shortcut saturation to gradient conflict and circuit reorganization during training.

**Topic Match:** Training dynamics is the closest fit; the demonstration concerns synthetic parity classification with tiny transformers, without a language-model training setting.
...
### 13. [Interference and Retention in Continual Learning](https://arxiv.org/abs/2607.09202) <a id="paper-2607-09202"></a>
...
**Comment:** Interference geometry identifies when allocation of parameter directions can structurally eliminate forgetting.

**Topic Match:** Training dynamics are central, but the abstract establishes no language-model setting for its continual-learning claims.
...
### 14. [Exploring More to Solve More: Boosting Diversity in Text Diffusion Models via Entropy-Based Guidance](https://arxiv.org/abs/2608.00024) <a id="paper-2608-00024"></a>
...
**Comment:** Semantic kernel entropy supplies a guidance signal for the fidelity-diversity tradeoff in text diffusion.

**Topic Match:** Discrete text diffusion is the nearest architectural topic, but the contribution modifies inference-time sampling of existing models.
...
### 15. [Adaptive Compute in Latent World Models: When Depth Helps, Hurts, or Doesn't Matter](https://arxiv.org/abs/2607.10203) <a id="paper-2607-10203"></a>
...
**Comment:** Controlled interventions identify how exit supervision can make shallow rollouts outperform full-depth predictions.

**Topic Match:** Depth allocation and training-induced computation are architectural mechanisms, but the core subject is latent world models and planning.
...
**Comment:** Traces self-distillation collapse to teacher gradients at high-entropy student decision points.

**Topic Match:** Optimization dynamics supplies the nearest label; the collapse concerns post-training reasoning behavior, without establishing architectural destabilization.
...
### 17. [Energy-guided Recursive Model](https://arxiv.org/abs/2607.10128) <a id="paper-2607-10128"></a>
...
**Comment:** Explicit Hopfield energies provide an intrinsic criterion for selecting recurrent computation trajectories.

**Topic Match:** Recurrent computation is architectural, but the core subject is test-time reasoning on puzzles rather than language-model training.
...
### 18. [Fully Trainable Deep Differentiable Logic Gate Networks and Lookup Table Networks](https://arxiv.org/abs/2607.09399) <a id="paper-2607-09399"></a>
...
**Comment:** Joint optimization of wiring and gate functions opens a structural training axis in logic networks.

**Topic Match:** The contribution changes network architecture and training, but its models perform small-scale image classification.
...
### 19. [From Atoms to Entropy: Optimal Noise Allocation for Diffusion Training in the Convex Regime](https://arxiv.org/abs/2607.20540) <a id="paper-2607-20540"></a>
...
**Comment:** Derives finite-support noise allocations and a square-root entropy proxy under explicit coupling assumptions.

**Topic Match:** Noise allocation is a training-dynamics topic, but the abstract identifies no explicit language-model experiment; its named settings are synthetic distributions and images.
...
### 20. [Next-Dense-Stride Prediction for Multimodal Autoregressive Visual Modeling](https://arxiv.org/abs/2607.09892) <a id="paper-2607-09892"></a>
...
**Comment:** Uses progressively denser prediction strides to obtain coarse-to-fine generation from one latent grid.

**Topic Match:** Autoregressive factorization is architectural, but the trained generators produce medical and natural images.
...
### 21. [On Locality and Length Generalization in Visual Reasoning](https://arxiv.org/abs/2607.09061) <a id="paper-2607-09061"></a>
...
**Comment:** Local recurrent perception tests whether global shortcuts cause failures of length generalization.

**Topic Match:** Attention locality is the nearest architectural topic, but the trained models and demonstrations are visual.
...
### 22. [Foveation-Guided Dynamic Token Selection for Robust and Efficient Vision Transformers](https://arxiv.org/abs/2607.09480) <a id="paper-2607-09480"></a>
...
**Comment:** Couples learned fixation with foveated embeddings for dynamic token selection.

**Topic Match:** Adaptive token selection is architectural, but the models are vision transformers evaluated for classification and robustness.
...
### 23. [Understanding Schedule-Free Methods in Nonconvex Optimization: Rate Guarantees and Escaping Saddles](https://arxiv.org/abs/2607.09167) <a id="paper-2607-09167"></a>
...
**Comment:** Establishes nonconvex convergence rates and strict-saddle avoidance for standard schedule-free updates.

**Topic Match:** Optimizer theory is the nearest category; the core is stochastic-gradient convergence analysis without a language-model training setting.
...
### 24. [Source-Lifted Flow Matching for Intervenable Multimodal Imitation](https://arxiv.org/abs/2607.10206) <a id="paper-2607-10206"></a>
...
**Comment:** Orthogonal source lifting separates controllable flow branches while retaining one shared velocity field.

**Topic Match:** The architectural mechanism trains robot imitation policies, outside the language-model training scope.
...
### 25. [Singular perturbations and hierarchical learning in two-layer neural networks](https://arxiv.org/abs/2607.10869) <a id="paper-2607-10869"></a>
...
**Comment:** Proves sharp timescale thresholds for hierarchical feature learning when two layers train at different speeds.

**Topic Match:** Learning dynamics is the nearest category; the subject is population gradient flow in an infinite-width two-layer network, outside language-model training.
...
### 26. [Robustly Invertible Nonlinear Dynamics and the BiLipREN: From Inversion-Based Control to Generative Trajectory Modelling](https://arxiv.org/abs/2607.10026) <a id="paper-2607-10026"></a>
...
**Comment:** Constructively enforces stable, bounded-gain forward and inverse recurrent dynamics.

**Topic Match:** Recurrent parameterization supplies the architectural connection; the applications are control, trajectory optimization, and signal-space generative modeling.
...
### 1. [Codec-Gauge: Learning Compression-Friendly Gauges for Transformer KV Caches](https://arxiv.org/abs/2607.20538) <a id="paper-2607-20538"></a>
...
**Comment:** Learns orthogonal KV coordinates while holding cache bit rates and backend coding rules fixed.

**Topic Match:** Compression fidelity is the nearest topic; the core is post-training inference-cache quantization and compression.
...
### 2. [Seeing is Free, Speaking is Not: Uncovering the True Energy Bottleneck in Edge VLM Inference](https://arxiv.org/abs/2607.09520) <a id="paper-2607-09520"></a>
...
**Comment:** Profiles how decoding length dominates measured edge-VLM energy across model families and hardware platforms.

**Topic Match:** Energy efficiency provides the nearest label; the contribution profiles inference costs and does not change model training.
...
### 3. [KV-PRM: Efficient Process Reward Modeling via KV-Cache Transfer for Multi-Agent Test-Time Scaling](https://arxiv.org/abs/2607.09153) <a id="paper-2607-09153"></a>
...
**Comment:** Reuses generator KV states to score a trajectory with one verifier token.

**Topic Match:** Avoiding repeated encoding is an efficiency contribution, but the core application is process-reward scoring for multi-agent test-time scaling.
...
### 4. [Reliability Scaling Laws for Quantized Large Language Models](https://arxiv.org/abs/2607.10855) <a id="paper-2607-10855"></a>
...
**Comment:** Total-bit scaling reveals different trends for predictive accuracy and perturbation reliability.

**Topic Match:** Quantization is central, but this is a deployment reliability evaluation rather than a training mechanism or benchmark-validity audit.
...
### 5. [Super-Tuning: From Activation-Aware Pruning to Sparse Fine-Tuning](https://arxiv.org/abs/2607.09287) <a id="paper-2607-09287"></a>
...
**Comment:** Reuses activation-weighted pruning scores to choose a fixed sparse parameter-update support.

**Topic Match:** Sparse updates supply the efficiency connection, but the contribution is a PEFT variant built from existing pruning and adapter primitives.
...
### 6. [MemDecay: Region-Aware KV Cache Eviction for Efficient LLM Agent Inference](https://arxiv.org/abs/2607.10582) <a id="paper-2607-10582"></a>
...
**Comment:** Uses region-specific priorities and decay rates to retain semantically important KV-cache pages.

**Topic Match:** Cache-memory management supplies the nearest efficiency label; the contribution is an inference policy for agent contexts.
...
### 7. [Structured Thoughts For Improved Reasoning And Context Pruning](https://arxiv.org/abs/2607.10386) <a id="paper-2607-10386"></a>
...
**Comment:** Separating exploratory scratch work from conclusions makes reasoning traces selectively prunable.

**Topic Match:** The method compresses reasoning context through supervised post-training, with an explicitly reported accuracy tradeoff.
...
### 8. [STEEL: Sparsity-Aware Fused Attention for Energy-Efficient Long-Sequence Inference on AMD's XDNA NPU](https://arxiv.org/abs/2607.09385) <a id="paper-2607-09385"></a>
...
**Comment:** Maps causal FlashAttention onto XDNA NPUs using sparsity-aware pipeline placement.

**Topic Match:** Inference efficiency is the closest label; kernel dataflow and pipeline scheduling fall under the explicit systems-speed exclusion.
...
### 9. [CARE-LoRA: Compressed Activation REconstruction for Memory-Efficient LoRA](https://arxiv.org/abs/2607.11940) <a id="paper-2607-11940"></a>
...
**Comment:** Reconstructs LoRA gradient signals from compressed branch activations to reduce retained activation memory.

**Topic Match:** Activation-memory compression is the closest efficiency topic; parameter-efficient fine-tuning is the explicitly excluded core subject.
...
**Comment:** Structured parallel drafting generates candidates within the target model without an auxiliary draft network.

**Topic Match:** The nearest topic is efficiency, but the contribution accelerates inference without changing model training.
...
### 11. [IterCOMP: Reasoning-aware Adaptive Prompt Compression for Multi-hop Question Answering](https://arxiv.org/abs/2608.13588) <a id="paper-2608-13588"></a>
...
**Comment:** Iterative evidence selection compresses prompts while tracking dependencies across multi-hop questions.

**Topic Match:** The efficiency gain comes from compressing RAG inputs at inference, outside foundational model training.
...
### 12. [Adaptive Model Compression (AMC): Saliency-Driven Resource Allocation for Ultra-Low-Power Transformer Inference](https://arxiv.org/abs/2607.10109) <a id="paper-2607-10109"></a>
...
**Comment:** Allocates rank and numerical precision according to token saliency.

**Topic Match:** Compression is the closest category; the claimed outcome is hardware-level inference energy and throughput with an accuracy trade-off.
...
### 13. [Dependency-Aware Chain-of-Thought Compression for Financial Reasoning](https://arxiv.org/abs/2609.00413) <a id="paper-2609-00413"></a>
...
**Comment:** Dependency-aware segment selection compresses reasoning traces while preserving their logical links.

**Topic Match:** Compression targets financial reasoning traces at inference rather than model parameters or training requirements.
...
### 14. [IB-Flow: Information Bottleneck-Guided CFG Distillation for Few-Step Text-to-Image Generation](https://arxiv.org/abs/2607.09133) <a id="paper-2607-09133"></a>
