<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../18"><img src="../../../assets/nav/day/2025-11-19-prev.svg" alt="Previous Day 2025-11-18"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-19-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../20"><img src="../../../assets/nav/day/2025-11-19-next.svg" alt="Next Day 2025-11-20"></a></div></div>
...
1. [Compiling to linear neurons](#user-content-link1)
**Authors:** Joey Velez-Ginorio, Nada Amin, Konrad Kording, Steve Zdancewic

2. [MoE-SpeQ: Speculative Quantized Decoding with Proactive Expert Prefetching and Offloading for Mixture-of-Experts](#user-content-link2)
**Authors:** Wenfeng Wang, Jiacheng Liu, Xiaofeng Hou, Xinfeng Xia, Peng Tang, Mingxuan Zhang, Chao Li, Minyi Guo

3. [10Cache: Heterogeneous Resource-Aware Tensor Caching and Migration for LLM Training](#user-content-link3)
**Authors:** Sabiha Afroz, Redwan Ibne Seraj Khan, Hadeel Albahar, Jingoo Han, Ali R. Butt

4. [Near-Lossless Model Compression Enables Longer Context Inference in DNA Large Language Models](#user-content-link4)
...
6. [ParallelKittens: Systematic and Practical Simplification of Multi-GPU AI Kernels](#user-content-link6)
**Authors:** Stuart H. Sul, Simran Arora, Benjamin F. Spector, Christopher R\'e

7. [Library Liberation: Competitive Performance Matmul Through Compiler-composed Nanokernels](#user-content-link7)
**Authors:** Arun Thangamani, Md Asghar Ahmad Shahid, Adam Siemieniuk, Rolf Morel, Renato Golin, Alexander Heinecke

8. [Improved Convergence in Parameter-Agnostic Error Feedback through Momentum](#user-content-link8)
**Authors:** Abdurakhmon Sadiev, Yury Demidovich, Igor Sokolov, Grigory Malinovsky, Sarit Khirirat, Peter Richt\'arik

9. [A Disentangled Low-Rank RNN Framework for Uncovering Neural Connectivity and Dynamics](#user-content-link9)
**Authors:** Chengrui Li, Yunmiao Wang, Yule Wang, Weihan Li, Dieter Jaeger, Anqi Wu

10. [AdaTok: Adaptive Token Compression with Object-Aware Representations for Efficient Multimodal LLMs](#user-content-link10)
**Authors:** Xinliang Zhang, Lei Zhu, Hangzhou He, Shuang Zeng, Ourui Fu, Jiakui Hu, Zhengjian Yao, Yanye Lu

11. [MoETTA: Test-Time Adaptation Under Mixed Distribution Shifts with MoE-LayerNorm](#user-content-link11)
**Authors:** Xiao Fan, Jingyan Jiang, Zhaoru Chen, Fanding Huang, Xiao Chen, Qinting Jiang, Bowen Zhang, Xing Tang, Zhi Wang

12. [Weight Variance Amplifier Improves Accuracy in High-Sparsity One-Shot Pruning](#user-content-link12)
**Authors:** Vincent-Daniel Yun, Junhyuk Jo, Sunwoo Lee

13. [AdamHD: Decoupled Huber Decay Regularization for Language Model Pre-Training](#user-content-link13)
**Authors:** Fu-Ming Guo, Yingfang Fan

14. [On the Gradient Complexity of Private Optimization with Private Oracles](#user-content-link14)
**Authors:** Michael Menart, Aleksandar Nikolov

15. [Towards a Unified Analysis of Neural Networks in Nonparametric Instrumental Variable Regression: Optimization and Generalization](#user-content-link15)
**Authors:** Zonghao Chen, Atsushi Nitanda, Arthur Gretton, Taiji Suzuki

16. [Principled Coarse-Grained Acceptance for Speculative Decoding in Speech](#user-content-link16)
**Authors:** Moran Yanuka, Paul Dixon, Eyal Finkelshtein, Daniel Rotman, Raja Giryes

17. [What happens when nanochat meets DiLoCo?](#user-content-link17)
...
19. [Beat the long tail: Distribution-Aware Speculative Decoding for RL Training](#user-content-link19)
...
20. [Splat Regression Models](#user-content-link20)
**Authors:** Mara Daniels, Philippe Rigollet

21. [Complex-Weighted Convolutional Networks: Provable Expressiveness via Complex Diffusion](#user-content-link21)
**Authors:** Cristina L\'opez Amado, Tassilo Schwarz, Yu Tian, Renaud Lambiotte

22. [Exploring Transferability of Self-Supervised Learning by Task Conflict Calibration](#user-content-link22)
**Authors:** Huijie Guo, Jingyao Wang, Peizheng Guo, Xingchen Shen, Changwen Zheng, Wenwen Qiang

23. [Compute-in-Memory Implementation of State Space Models for Event Sequence Processing](#user-content-link23)
**Authors:** Xiaoyu Zhang, Mingtao Hu, Sen Lu, Soohyeon Kim, Eric Yeu-Jer Lee, Yuyang Liu, Wei D. Lu

24. [Task Addition and Weight Disentanglement in Closed-Vocabulary Models](#user-content-link24)
**Authors:** Adam Hazimeh, Alessandro Favero, Pascal Frossard

---

## 1. [Compiling to linear neurons](https://arxiv.org/abs/2511.13769) <a id="link1"></a>
...
## 2. [MoE-SpeQ: Speculative Quantized Decoding with Proactive Expert Prefetching and Offloading for Mixture-of-Experts](https://arxiv.org/abs/2511.14102) <a id="link2"></a>
...
## 3. [10Cache: Heterogeneous Resource-Aware Tensor Caching and Migration for LLM Training](https://arxiv.org/abs/2511.14124) <a id="link3"></a>
...
## 4. [Near-Lossless Model Compression Enables Longer Context Inference in DNA Large Language Models](https://arxiv.org/abs/2511.14694) <a id="link4"></a>
...
## 6. [ParallelKittens: Systematic and Practical Simplification of Multi-GPU AI Kernels](https://arxiv.org/abs/2511.13940) <a id="link6"></a>
...
## 7. [Library Liberation: Competitive Performance Matmul Through Compiler-composed Nanokernels](https://arxiv.org/abs/2511.13764) <a id="link7"></a>
...
## 8. [Improved Convergence in Parameter-Agnostic Error Feedback through Momentum](https://arxiv.org/abs/2511.14501) <a id="link8"></a>
...
## 9. [A Disentangled Low-Rank RNN Framework for Uncovering Neural Connectivity and Dynamics](https://arxiv.org/abs/2511.13899) <a id="link9"></a>
...
## 10. [AdaTok: Adaptive Token Compression with Object-Aware Representations for Efficient Multimodal LLMs](https://arxiv.org/abs/2511.14169) <a id="link10"></a>
...
## 11. [MoETTA: Test-Time Adaptation Under Mixed Distribution Shifts with MoE-LayerNorm](https://arxiv.org/abs/2511.13760) <a id="link11"></a>
...
## 12. [Weight Variance Amplifier Improves Accuracy in High-Sparsity One-Shot Pruning](https://arxiv.org/abs/2511.14282) <a id="link12"></a>
...
## 13. [AdamHD: Decoupled Huber Decay Regularization for Language Model Pre-Training](https://arxiv.org/abs/2511.14721) <a id="link13"></a>
...
## 14. [On the Gradient Complexity of Private Optimization with Private Oracles](https://arxiv.org/abs/2511.13999) <a id="link14"></a>
...
## 15. [Towards a Unified Analysis of Neural Networks in Nonparametric Instrumental Variable Regression: Optimization and Generalization](https://arxiv.org/abs/2511.14710) <a id="link15"></a>
...
## 16. [Principled Coarse-Grained Acceptance for Speculative Decoding in Speech](https://arxiv.org/abs/2511.13732) <a id="link16"></a>
...
## 17. [What happens when nanochat meets DiLoCo?](https://arxiv.org/abs/2511.13761) <a id="link17"></a>
...
## 19. [Beat the long tail: Distribution-Aware Speculative Decoding for RL Training](https://arxiv.org/abs/2511.13841) <a id="link19"></a>
...
## 20. [Splat Regression Models](https://arxiv.org/abs/2511.14042) <a id="link20"></a>
...
## 21. [Complex-Weighted Convolutional Networks: Provable Expressiveness via Complex Diffusion](https://arxiv.org/abs/2511.13937) <a id="link21"></a>
...
## 22. [Exploring Transferability of Self-Supervised Learning by Task Conflict Calibration](https://arxiv.org/abs/2511.13787) <a id="link22"></a>
...
## 23. [Compute-in-Memory Implementation of State Space Models for Event Sequence Processing](https://arxiv.org/abs/2511.13912) <a id="link23"></a>
...
## 24. [Task Addition and Weight Disentanglement in Closed-Vocabulary Models](https://arxiv.org/abs/2511.14569) <a id="link24"></a>
