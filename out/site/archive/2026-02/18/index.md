<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../17"><img src="../../../assets/nav/day/2026-02-18-prev.svg" alt="Previous Day 2026-02-17"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-18-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../19"><img src="../../../assets/nav/day/2026-02-18-next.svg" alt="Next Day 2026-02-19"></a></div></div>
...
## 1. [A unified theory of feature learning in RNNs and DNNs](https://arxiv.org/abs/2602.15593) <a id="link1"></a>
...
## 2. [Approximation Theory for Lipschitz Continuous Transformers](https://arxiv.org/abs/2602.15503) <a id="link2"></a>
...
## 3. [ExpertWeaver: Unlocking the Inherent MoE in Dense LLMs with GLU Activation Patterns](https://arxiv.org/abs/2602.15521) <a id="link3"></a>
...
## 4. [Avey-B](https://arxiv.org/abs/2602.15814) <a id="link4"></a>
...
## 5. [COMPOT: Calibration-Optimized Matrix Procrustes Orthogonalization for Transformers Compression](https://arxiv.org/abs/2602.15200) <a id="link5"></a>
...
## 6. [1-Bit Wonder: Improving QAT Performance in the Low-Bit Regime through K-Means Quantization](https://arxiv.org/abs/2602.15563) <a id="link6"></a>
...
## 7. [Uniform error bounds for quantized dynamical models](https://arxiv.org/abs/2602.15586) <a id="link7"></a>
...
## 8. [Logit Distance Bounds Representational Similarity](https://arxiv.org/abs/2602.15438) <a id="link8"></a>
...
## 9. [How Vision Becomes Language: A Layer-wise Information-Theoretic Analysis of Multimodal Reasoning](https://arxiv.org/abs/2602.15580) <a id="link9"></a>
...
## 10. [Continuous-Time Piecewise-Linear Recurrent Neural Networks](https://arxiv.org/abs/2602.15649) <a id="link10"></a>
...
## 11. [On Surprising Effectiveness of Masking Updates in Adaptive Optimizers](https://arxiv.org/abs/2602.15322) <a id="link11"></a>
...
## 12. [Beyond ReLU: Bifurcation, Oversmoothing, and Topological Priors](https://arxiv.org/abs/2602.15634) <a id="link12"></a>
...
## 13. [PolyNODE: Variable-dimension Neural ODEs on M-polyfolds](https://arxiv.org/abs/2602.15128) <a id="link13"></a>
...
## 14. [The Information Geometry of Softmax: Probing and Steering](https://arxiv.org/abs/2602.15293) <a id="link14"></a>
...
## 15. [The Geometry of Alignment Collapse: When Fine-Tuning Breaks Safety](https://arxiv.org/abs/2602.15799) <a id="link15"></a>
...
## 16. [Panini: Continual Learning in Token Space via Structured Memory](https://arxiv.org/abs/2602.15156) <a id="link16"></a>
...
## 17. [Size Transferability of Graph Transformers with Convolutional Positional Encodings](https://arxiv.org/abs/2602.15239) <a id="link17"></a>
...
## 18. [CrispEdit: Low-Curvature Projections for Scalable Non-Destructive LLM Editing](https://arxiv.org/abs/2602.15823) <a id="link18"></a>
...
## 19. [Universal priors: solving empirical Bayes via Bayesian inference and pretraining](https://arxiv.org/abs/2602.15136) <a id="link19"></a>
...
## 20. [Spanning the Visual Analogy Space with a Weight Basis of LoRAs](https://arxiv.org/abs/2602.15727) <a id="link20"></a>
...
## 21. [The Equalizer: Introducing Shape-Gain Decomposition in Neural Audio Codecs](https://arxiv.org/abs/2602.15491) <a id="link21"></a>
...
## 22. [Seeing to Generalize: How Visual Data Corrects Binding Shortcuts](https://arxiv.org/abs/2602.15183) <a id="link22"></a>
...
## 23. [Refine Now, Query Fast: A Decoupled Refinement Paradigm for Implicit Neural Fields](https://arxiv.org/abs/2602.15155) <a id="link23"></a>
...
## 24. [Neural-POD: A Plug-and-Play Neural Operator Framework for Infinite-Dimensional Functional Nonlinear Proper Orthogonal Decomposition](https://arxiv.org/abs/2602.15632) <a id="link24"></a>
...
## 25. [Fast and Effective On-policy Distillation from Reasoning Prefixes](https://arxiv.org/abs/2602.15260) <a id="link25"></a>
...
## 26. [Complex-Valued Unitary Representations as Classification Heads for Improved Uncertainty Quantification in Deep Neural Networks](https://arxiv.org/abs/2602.15283) <a id="link26"></a>
...
## 27. [FlashMem: Supporting Modern DNN Workloads on Mobile with GPU Memory Hierarchy Optimizations](https://arxiv.org/abs/2602.15379) <a id="link27"></a>
...
## 28. [Functional Central Limit Theorem for Stochastic Gradient Descent](https://arxiv.org/abs/2602.15538) <a id="link28"></a>
