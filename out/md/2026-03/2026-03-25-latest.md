...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">172617</td>
            <td align="center">6842</td>
            <td align="center">179459</td>
...
1. [Sparser, Faster, Lighter Transformer Language Models](#user-content-link1)
**Authors:** Edoardo Cetin, Stefano Peluchetti, Emilio Castillo, Akira Naruse, Mana Murakami, Llion Jones

2. [Scaling Attention via Feature Sparsity](#user-content-link2)
**Authors:** Yan Xie, Tiansheng Wen, Tangda Huang, Bo Chen, Chenyu You, Stefanie Jegelka, Yifei Wang

3. [Problems with Chinchilla Approach 2: Systematic Biases in IsoFLOP Parabola Fits](#user-content-link3)
**Authors:** Eric Czech, Zhiwei Xu, Yael Elmatad, Yixin Wang, William Held

4. [Hybrid Associative Memories](#user-content-link4)
**Authors:** Leon Lufkin, Tom\'as Figliolia, Beren Millidge, Kamesh Krishnamurthy

5. [Mitigating Premature Discretization with Progressive Quantization for Robust Vector Tokenization](#user-content-link5)
**Authors:** Wenhao Zhao, Qiran Zou, Zhouhan Lin, Dianbo Liu

6. [Sparse but Critical: A Token-Level Analysis of Distributional Shifts in RLVR Fine-Tuning of LLMs](#user-content-link6)
**Authors:** Haoming Meng, Kexin Huang, Shaohang Wei, Chiyu Ma, Shuo Yang, Xue Wang, Guoyin Wang, Bolin Ding, Jingren Zhou

7. [Transformers Trained via Gradient Descent Can Provably Learn a Class of Teacher Models](#user-content-link7)
**Authors:** Chenyang Zhang, Qingyue Zhao, Quanquan Gu, Yuan Cao

8. [Asymptotic Learning Curves for Diffusion Models with Random Features Score and Manifold Data](#user-content-link8)
**Authors:** Anand Jerry George, Nicolas Macris

9. [SafeSeek: Universal Attribution of Safety Circuits in Language Models](#user-content-link9)
**Authors:** Miao Yu, Siyuan Fu, Moayad Aloqaily, Zhenhong Zhou, Safa Otoum, Xing fan, Kun Wang, Yufei Guo, Qingsong Wen

10. [Whether, Not Which: Mechanistic Interpretability Reveals Dissociable Affect Reception and Emotion Categorization in LLMs](#user-content-link10)
**Authors:** Michael Keeman

11. [ForestPrune: High-ratio Visual Token Compression for Video Multimodal Large Language Models via Spatial-Temporal Forest Modeling](#user-content-link11)
**Authors:** Shaobo Ju, Baiyang Song, Tao Chen, Jiapeng Zhang, Qiong Wu, Chao Chang, HuaiXi Wang, Yiyi Zhou, Rongrong Ji

12. [Functional Component Ablation Reveals Specialization Patterns in Hybrid Language Model Architectures](#user-content-link12)
**Authors:** Hector Borobia, Elies Segu\'i-Mas, Guillermina Tormo-Carb\'o

13. [FAAR: Format-Aware Adaptive Rounding for NVFP4](#user-content-link13)
**Authors:** Hanglin Li, Shuchang Tian, Chen Lin, Zhiyong Zhao, Kun Zhan

14. [DAQ: Delta-Aware Quantization for Post-Training LLM Weight Compression](#user-content-link14)
**Authors:** Xiaoming Yu, Shize Tang, Guanghua Yu, Linchuan Xie, Song Liu, Jianchen Zhu, Feng Li

15. [The Coordinate System Problem in Persistent Structural Memory for Neural Architectures](#user-content-link15)
**Authors:** Abhinaba Basu

16. [Off-Policy Value-Based Reinforcement Learning for Large Language Models](#user-content-link16)
...
17. [Conditionally Identifiable Latent Representation for Multivariate Time Series with Structural Dynamics](#user-content-link17)
**Authors:** Minkey Chang, Jae-Young Kim

18. [MCLR: Improving Conditional Modeling in Visual Generative Models via Inter-Class Likelihood-Ratio Maximization and Establishing the Equivalence between Classifier-Free Guidance and Alignment Objectives](#user-content-link18)
**Authors:** Xiang Li, Yixuan Jia, Xiao Li, Jeffrey A. Fessler, Rongrong Wang, Qing Qu

19. [VISion On Request: Enhanced VLLM efficiency with sparse, dynamically selected, vision-language interactions](#user-content-link19)
**Authors:** Adrian Bulat, Alberto Baldrati, Ioannis Maniadis Metaxas, Yassine Ouali, Georgios Tzimiropoulos

20. [Permutation-Symmetrized Diffusion for Unconditional Molecular Generation](#user-content-link20)
**Authors:** Gyeonghoon Ko, Juho Lee

21. [Unveiling the Mechanism of Continuous Representation Full-Waveform Inversion: A Wave Based Neural Tangent Kernel Framework](#user-content-link21)
**Authors:** Ruihua Chen, Yisi Luo, Bangyu Wu, Deyu Meng

22. [Robust Safety Monitoring of Language Models via Activation Watermarking](#user-content-link22)
**Authors:** Toluwani Aremu, Daniil Ognev, Samuele Poppi, Nils Lukas

23. [A Learning Method with Gap-Aware Generation for Heterogeneous DAG Scheduling](#user-content-link23)
**Authors:** Ruisong Zhou, Haijun Zou, Li Zhou, Chumin Sun, Zaiwen Wen

24. [Stability-Preserving Online Adaptation of Neural Closed-loop Maps](#user-content-link24)
**Authors:** Danilo Saccani, Luca Furieri, Giancarlo Ferrari-Trecate

25. [A One-Inclusion Graph Approach to Multi-Group Learning](#user-content-link25)
**Authors:** Noah Bergam, Samuel Deng, Daniel Hsu

26. [Bridging the Know-Act Gap via Task-Level Autoregressive Reasoning](#user-content-link26)
...
27. [Improving LLM Predictions via Inter-Layer Structural Encoders](#user-content-link27)
**Authors:** Tom Ulanovski (Tel Aviv University), Eyal Blyachman (Tel Aviv University), Maya Bechler-Speicher (Meta)

28. [Between the Layers Lies the Truth: Uncertainty Estimation in LLMs Using Intra-Layer Local Information Scores](#user-content-link28)
**Authors:** Zvi N. Badash, Yonatan Belinkov, Moti Freiman

29. [Towards The Implicit Bias on Multiclass Separable Data Under Norm Constraints](#user-content-link29)
**Authors:** Shengping Xie, Zekun Wu, Quan Chen, Kaixu Tang

30. [Graph Signal Processing Meets Mamba2: Adaptive Filter Bank via Delta Modulation](#user-content-link30)
**Authors:** Yehjin Shin, Seojin Kim, Noseong Park

31. [Latent Semantic Manifolds in Large Language Models](#user-content-link31)
**Authors:** Mohamed A. Mabrok

32. [SortedRL: Accelerating RL Training for LLMs through Online Length-Aware Scheduling](#user-content-link32)
...
33. [KALAVAI: Predicting When Independent Specialist Fusion Works -- A Quantitative Model for Post-Hoc Cooperative LLM Training](#user-content-link33)
**Authors:** Ramchand Kumaresan

34. [Demystifying Low-Rank Knowledge Distillation in Large Language Models: Convergence, Generalization, and Information-Theoretic Guarantees](#user-content-link34)
**Authors:** Alberlucia Rafael Soarez, Daniel Kim, Mariana Costa, Alejandro Torre

35. [Three Creates All: You Only Sample 3 Steps](#user-content-link35)
**Authors:** Yuren Cai, Guangyi Wang, Zongqing Li, Li Li, Zhihui Liu, Songzhi Su

36. [TIPS: Turn-Level Information-Potential Reward Shaping for Search-Augmented LLMs](#user-content-link36)
**Authors:** Yutao Xie, Nathaniel Thomas, Nicklas Hansen, Yang Fu, Li Erran Li, Xiaolong Wang

37. [AuthorMix: Modular Authorship Style Transfer via Layer-wise Adapter Mixing](#user-content-link37)
**Authors:** Sarubi Thillainathan, Ji-Ung Lee, Michael Sullivan, Alexander Koller

38. [ARGENT: Adaptive Hierarchical Image-Text Representations](#user-content-link38)
**Authors:** Chuong Huynh, Hossein Souri, Abhinav Kumar, Vitali Petsiuk, Deen Dayal Mohan, Suren Kumar

39. [A Theoretical Framework for Energy-Aware Gradient Pruning in Federated Learning](#user-content-link39)
**Authors:** Emmanouil M. Athanasakos

40. [Language Models Can Explain Visual Features via Steering](#user-content-link40)
...
41. [PersonalQ: Select, Quantize, and Serve Personalized Diffusion Models for Efficient Inference](#user-content-link41)
**Authors:** Qirui Wang, Qi Guo, Yiding Sun, Junkai Yang, Dongxu Zhang, Shanmin Pang, Qing Guo

42. [Trained Persistent Memory for Frozen Decoder-Only LLMs](#user-content-link42)
**Authors:** Hong Jeong

43. [Beyond the Mean: Distribution-Aware Loss Functions for Bimodal Regression](#user-content-link43)
**Authors:** Abolfazl Mohammadi-Seif, Carlos Soares, Rita P. Ribeiro, Ricardo Baeza-Yates

44. [AI Mental Models: Learned Intuition and Deliberation in a Bounded Neural Architecture](#user-content-link44)
**Authors:** Laurence Anthony

45. [KARMA: Knowledge-Action Regularized Multimodal Alignment for Personalized Search at Taobao](#user-content-link45)
**Authors:** Zhi Sun, Wenming Zhang, Yi Wei, Liren Yu, Zhixuan Zhang, Dan Ou, Haihong Tang

46. [RelayS2S: A Dual-Path Speculative Generation for Real-Time Dialogue](#user-content-link46)
**Authors:** Long Mai

47. [Universal and efficient graph neural networks with dynamic attention for machine learning interatomic potentials](#user-content-link47)
**Authors:** Shuyu Bi, Zhede Zhao, Qiangchao Sun, Tao Hu, Xionggang Lu, Hongwei Cheng

48. [TorR: Towards Brain-Inspired Task-Oriented Reasoning via Cache-Oriented Algorithm-Architecture Co-design](#user-content-link48)
**Authors:** Hyunwoo Oh, SungHeon Jeong, Suyeon Jang, Hanning Chen, Sanggeon Yun, Tamoghno Das, Mohsen Imani

---

## 1. [Sparser, Faster, Lighter Transformer Language Models](https://arxiv.org/abs/2603.23198) <a id="link1"></a>
...
## 2. [Scaling Attention via Feature Sparsity](https://arxiv.org/abs/2603.22300) <a id="link2"></a>
...
## 3. [Problems with Chinchilla Approach 2: Systematic Biases in IsoFLOP Parabola Fits](https://arxiv.org/abs/2603.22339) <a id="link3"></a>
...
## 4. [Hybrid Associative Memories](https://arxiv.org/abs/2603.22325) <a id="link4"></a>
...
## 5. [Mitigating Premature Discretization with Progressive Quantization for Robust Vector Tokenization](https://arxiv.org/abs/2603.22304) <a id="link5"></a>
...
## 6. [Sparse but Critical: A Token-Level Analysis of Distributional Shifts in RLVR Fine-Tuning of LLMs](https://arxiv.org/abs/2603.22446) <a id="link6"></a>
...
## 7. [Transformers Trained via Gradient Descent Can Provably Learn a Class of Teacher Models](https://arxiv.org/abs/2603.22801) <a id="link7"></a>
...
## 8. [Asymptotic Learning Curves for Diffusion Models with Random Features Score and Manifold Data](https://arxiv.org/abs/2603.22962) <a id="link8"></a>
...
## 9. [SafeSeek: Universal Attribution of Safety Circuits in Language Models](https://arxiv.org/abs/2603.23268) <a id="link9"></a>
...
## 10. [Whether, Not Which: Mechanistic Interpretability Reveals Dissociable Affect Reception and Emotion Categorization in LLMs](https://arxiv.org/abs/2603.22295) <a id="link10"></a>
...
## 11. [ForestPrune: High-ratio Visual Token Compression for Video Multimodal Large Language Models via Spatial-Temporal Forest Modeling](https://arxiv.org/abs/2603.22911) <a id="link11"></a>
...
## 12. [Functional Component Ablation Reveals Specialization Patterns in Hybrid Language Model Architectures](https://arxiv.org/abs/2603.22473) <a id="link12"></a>
...
## 13. [FAAR: Format-Aware Adaptive Rounding for NVFP4](https://arxiv.org/abs/2603.22370) <a id="link13"></a>
...
## 14. [DAQ: Delta-Aware Quantization for Post-Training LLM Weight Compression](https://arxiv.org/abs/2603.22324) <a id="link14"></a>
...
## 15. [The Coordinate System Problem in Persistent Structural Memory for Neural Architectures](https://arxiv.org/abs/2603.22858) <a id="link15"></a>
...
## 16. [Off-Policy Value-Based Reinforcement Learning for Large Language Models](https://arxiv.org/abs/2603.23355) <a id="link16"></a>
...
## 17. [Conditionally Identifiable Latent Representation for Multivariate Time Series with Structural Dynamics](https://arxiv.org/abs/2603.22886) <a id="link17"></a>
...
## 18. [MCLR: Improving Conditional Modeling in Visual Generative Models via Inter-Class Likelihood-Ratio Maximization and Establishing the Equivalence between Classifier-Free Guidance and Alignment Objectives](https://arxiv.org/abs/2603.22364) <a id="link18"></a>
...
## 19. [VISion On Request: Enhanced VLLM efficiency with sparse, dynamically selected, vision-language interactions](https://arxiv.org/abs/2603.23495) <a id="link19"></a>
...
## 20. [Permutation-Symmetrized Diffusion for Unconditional Molecular Generation](https://arxiv.org/abs/2603.23255) <a id="link20"></a>
...
## 21. [Unveiling the Mechanism of Continuous Representation Full-Waveform Inversion: A Wave Based Neural Tangent Kernel Framework](https://arxiv.org/abs/2603.22362) <a id="link21"></a>
...
## 22. [Robust Safety Monitoring of Language Models via Activation Watermarking](https://arxiv.org/abs/2603.23171) <a id="link22"></a>
...
## 23. [A Learning Method with Gap-Aware Generation for Heterogeneous DAG Scheduling](https://arxiv.org/abs/2603.23249) <a id="link23"></a>
...
## 24. [Stability-Preserving Online Adaptation of Neural Closed-loop Maps](https://arxiv.org/abs/2603.22469) <a id="link24"></a>
...
## 25. [A One-Inclusion Graph Approach to Multi-Group Learning](https://arxiv.org/abs/2603.23208) <a id="link25"></a>
...
## 26. [Bridging the Know-Act Gap via Task-Level Autoregressive Reasoning](https://arxiv.org/abs/2603.22619) <a id="link26"></a>
...
## 27. [Improving LLM Predictions via Inter-Layer Structural Encoders](https://arxiv.org/abs/2603.22665) <a id="link27"></a>
...
## 28. [Between the Layers Lies the Truth: Uncertainty Estimation in LLMs Using Intra-Layer Local Information Scores](https://arxiv.org/abs/2603.22299) <a id="link28"></a>
...
## 29. [Towards The Implicit Bias on Multiclass Separable Data Under Norm Constraints](https://arxiv.org/abs/2603.22824) <a id="link29"></a>
...
## 30. [Graph Signal Processing Meets Mamba2: Adaptive Filter Bank via Delta Modulation](https://arxiv.org/abs/2603.22333) <a id="link30"></a>
...
## 31. [Latent Semantic Manifolds in Large Language Models](https://arxiv.org/abs/2603.22301) <a id="link31"></a>
...
## 32. [SortedRL: Accelerating RL Training for LLMs through Online Length-Aware Scheduling](https://arxiv.org/abs/2603.23414) <a id="link32"></a>
...
## 33. [KALAVAI: Predicting When Independent Specialist Fusion Works -- A Quantitative Model for Post-Hoc Cooperative LLM Training](https://arxiv.org/abs/2603.22755) <a id="link33"></a>
...
## 34. [Demystifying Low-Rank Knowledge Distillation in Large Language Models: Convergence, Generalization, and Information-Theoretic Guarantees](https://arxiv.org/abs/2603.22355) <a id="link34"></a>
...
## 35. [Three Creates All: You Only Sample 3 Steps](https://arxiv.org/abs/2603.22375) <a id="link35"></a>
...
## 36. [TIPS: Turn-Level Information-Potential Reward Shaping for Search-Augmented LLMs](https://arxiv.org/abs/2603.22293) <a id="link36"></a>
...
## 37. [AuthorMix: Modular Authorship Style Transfer via Layer-wise Adapter Mixing](https://arxiv.org/abs/2603.23069) <a id="link37"></a>
...
## 38. [ARGENT: Adaptive Hierarchical Image-Text Representations](https://arxiv.org/abs/2603.23311) <a id="link38"></a>
...
## 39. [A Theoretical Framework for Energy-Aware Gradient Pruning in Federated Learning](https://arxiv.org/abs/2603.22465) <a id="link39"></a>
...
## 40. [Language Models Can Explain Visual Features via Steering](https://arxiv.org/abs/2603.22593) <a id="link40"></a>
...
## 41. [PersonalQ: Select, Quantize, and Serve Personalized Diffusion Models for Efficient Inference](https://arxiv.org/abs/2603.22943) <a id="link41"></a>
...
## 42. [Trained Persistent Memory for Frozen Decoder-Only LLMs](https://arxiv.org/abs/2603.22329) <a id="link42"></a>
...
## 43. [Beyond the Mean: Distribution-Aware Loss Functions for Bimodal Regression](https://arxiv.org/abs/2603.22328) <a id="link43"></a>
...
## 44. [AI Mental Models: Learned Intuition and Deliberation in a Bounded Neural Architecture](https://arxiv.org/abs/2603.22561) <a id="link44"></a>
...
## 45. [KARMA: Knowledge-Action Regularized Multimodal Alignment for Personalized Search at Taobao](https://arxiv.org/abs/2603.22779) <a id="link45"></a>
...
## 46. [RelayS2S: A Dual-Path Speculative Generation for Real-Time Dialogue](https://arxiv.org/abs/2603.23346) <a id="link46"></a>
...
## 47. [Universal and efficient graph neural networks with dynamic attention for machine learning interatomic potentials](https://arxiv.org/abs/2603.22810) <a id="link47"></a>
...
## 48. [TorR: Towards Brain-Inspired Task-Oriented Reasoning via Cache-Oriented Algorithm-Architecture Co-design](https://arxiv.org/abs/2603.22855) <a id="link48"></a>
