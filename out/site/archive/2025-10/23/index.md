<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../22"><img src="../../../assets/nav/day/2025-10-23-prev.svg" alt="Previous Day 2025-10-22"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-10-23-center.svg" alt="Monthly Overview 2025-10"></a></div><div style="width: 33.33%; text-align: right;"><a href="../24"><img src="../../../assets/nav/day/2025-10-23-next.svg" alt="Next Day 2025-10-24"></a></div></div>
...
## 1. [Transformers are Inherently Succinct](https://arxiv.org/abs/2510.19315) <a id="link1"></a>
...
## 2. [HybridEP: Scaling Expert Parallelism to Cross-Datacenter Scenario via Hybrid Expert/Data Transmission](https://arxiv.org/abs/2510.19470) <a id="link2"></a>
...
## 3. [ARA: Adaptive Rank Allocation for Efficient Large Language Model SVD Compression](https://arxiv.org/abs/2510.19389) <a id="link3"></a>
...
## 4. [Transformers are almost optimal metalearners for linear classification](https://arxiv.org/abs/2510.19797) <a id="link4"></a>
...
## 5. [MoE-Prism: Disentangling Monolithic Experts for Elastic MoE Services via Model-System Co-Designs](https://arxiv.org/abs/2510.19366) <a id="link5"></a>
...
## 6. [NeuroAda: Activating Each Neuron's Potential for Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2510.18940) <a id="link6"></a>
...
## 7. [Fast Inference via Hierarchical Speculative Decoding](https://arxiv.org/abs/2510.19705) <a id="link7"></a>
...
## 8. [A Derandomization Framework for Structure Discovery: Applications in Neural Networks and Beyond](https://arxiv.org/abs/2510.19382) <a id="link8"></a>
...
## 9. [ELUTQ: Efficient LUT-Aware Quantization for Deploying Large Language Models on Edge Devices](https://arxiv.org/abs/2510.19482) <a id="link9"></a>
...
## 10. [When Do Transformers Learn Heuristics for Graph Connectivity?](https://arxiv.org/abs/2510.19753) <a id="link10"></a>
...
## 11. [Energy-Efficient and Dequantization-Free Q-LLMs: A Spiking Neural Network Approach to Salient Value Mitigation](https://arxiv.org/abs/2510.19498) <a id="link11"></a>
...
## 12. [Data Efficient Any Transformer-to-Mamba Distillation via Attention Bridge](https://arxiv.org/abs/2510.19266) <a id="link12"></a>
...
## 13. [CPSVD: Enhancing Large Language Model Compression via Column-Preserving Singular Value Decomposition](https://arxiv.org/abs/2510.19385) <a id="link13"></a>
...
## 14. [GaLLoP: Gradient-based Sparse Learning on Low-Magnitude Parameters](https://arxiv.org/abs/2510.19778) <a id="link14"></a>
...
## 15. [AdaSPEC: Selective Knowledge Distillation for Efficient Speculative Decoders](https://arxiv.org/abs/2510.19779) <a id="link15"></a>
...
## 16. [Feature Space Adaptation for Robust Model Fine-Tuning](https://arxiv.org/abs/2510.19155) <a id="link16"></a>
...
## 17. [Latent Space Factorization in LoRA](https://arxiv.org/abs/2510.19640) <a id="link17"></a>
...
## 18. [Every Attention Matters: An Efficient Hybrid Architecture for Long-Context Reasoning](https://arxiv.org/abs/2510.19338) <a id="link18"></a>
...
## 19. [MetaCluster: Enabling Deep Compression of Kolmogorov-Arnold Network](https://arxiv.org/abs/2510.19105) <a id="link19"></a>
...
## 20. [Study of Training Dynamics for Memory-Constrained Fine-Tuning](https://arxiv.org/abs/2510.19675) <a id="link20"></a>
...
## 21. [RLBoost: Harvesting Preemptible Resources for Cost-Efficient Reinforcement Learning on LLMs](https://arxiv.org/abs/2510.19225) <a id="link21"></a>
...
## 22. [Category learning in deep neural networks: Information content and geometry of internal representations](https://arxiv.org/abs/2510.19021) <a id="link22"></a>
...
## 23. [Memo: Training Memory-Efficient Embodied Agents with Reinforcement Learning](https://arxiv.org/abs/2510.19732) <a id="link23"></a>
...
## 24. [Understanding the Implicit Biases of Design Choices for Time Series Foundation Models](https://arxiv.org/abs/2510.19236) <a id="link24"></a>
...
## 26. [Weight Decay may matter more than muP for Learning Rate Transfer in Practice](https://arxiv.org/abs/2510.19093) <a id="link26"></a>
...
## 27. [Enabling Reconfiguration-Communication Overlap for Collective Communication in Optical Networks](https://arxiv.org/abs/2510.19322) <a id="link27"></a>
...
## 28. [Knowledge Distillation of Uncertainty using Deep Latent Factor Model](https://arxiv.org/abs/2510.19290) <a id="link28"></a>
