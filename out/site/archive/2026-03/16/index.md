<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../14"><img src="../../../assets/nav/day/2026-03-16-prev.svg" alt="Previous Day 2026-03-14"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-03-16-center.svg" alt="Monthly Overview 2026-03"></a></div><div style="width: 33.33%; text-align: right;"><a href="../17"><img src="../../../assets/nav/day/2026-03-16-next.svg" alt="Next Day 2026-03-17"></a></div></div>
...
## 1. [M$^2$RNN: Non-Linear RNNs with Matrix-Valued States for Scalable Language Modeling](https://arxiv.org/abs/2603.14360) <a id="link1"></a>
...
## 2. [PDE-SSM: A Spectral State Space Approach to Spatial Mixing in Diffusion Transformers](https://arxiv.org/abs/2603.13663) <a id="link2"></a>
...
## 3. [Self-Indexing KVCache: Predicting Sparse Attention from Compressed Keys](https://arxiv.org/abs/2603.14224) <a id="link3"></a>
...
## 4. [Rigorous Asymptotics for First-Order Algorithms Through the Dynamical Cavity Method](https://arxiv.org/abs/2603.14573) <a id="link4"></a>
...
## 5. [Gradient Atoms: Unsupervised Discovery, Attribution and Steering of Model Behaviors via Sparse Decomposition of Training Gradients](https://arxiv.org/abs/2603.14665) <a id="link5"></a>
...
## 6. [FlashHead: Efficient Drop-In Replacement for the Classification Head in Language Model Inference](https://arxiv.org/abs/2603.14591) <a id="link6"></a>
...
## 7. [GradMem: Learning to Write Context into Memory with Test-Time Gradient Descent](https://arxiv.org/abs/2603.13875) <a id="link7"></a>
...
## 8. [On Interpolation Formulas Describing Neural Network Generalization](https://arxiv.org/abs/2603.13872) <a id="link8"></a>
...
## 9. [Understanding the Emergence of Seemingly Useless Features in Next-Token Predictors](https://arxiv.org/abs/2603.14087) <a id="link9"></a>
...
## 10. [Spectral Edge Dynamics of Training Trajectories: Signal--Noise Geometry Across Scales](https://arxiv.org/abs/2603.15678) <a id="link10"></a>
...
## 11. [The Phenomenology of Hallucinations](https://arxiv.org/abs/2603.13911) <a id="link11"></a>
...
## 12. [Enhancing LLM Training via Spectral Clipping](https://arxiv.org/abs/2603.14315) <a id="link12"></a>
...
## 13. [Power-Law Spectrum of the Random Feature Model](https://arxiv.org/abs/2603.14578) <a id="link13"></a>
...
## 14. [Effective Sparsity: A Unified Framework via Normalized Entropy and the Effective Number of Nonzeros](https://arxiv.org/abs/2603.13826) <a id="link14"></a>
...
## 15. [High-Probability Bounds for SGD under the Polyak-Lojasiewicz Condition with Markovian Noise](https://arxiv.org/abs/2603.14514) <a id="link15"></a>
...
## 16. [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](https://arxiv.org/abs/2603.14549) <a id="link16"></a>
...
## 17. [Learning to Forget: Sleep-Inspired Memory Consolidation for Resolving Proactive Interference in Large Language Models](https://arxiv.org/abs/2603.14517) <a id="link17"></a>
...
## 18. [SVD Contextual Sparsity Predictors for Fast LLM Inference](https://arxiv.org/abs/2603.14110) <a id="link18"></a>
...
## 19. [Disentangling Dynamical Systems: Causal Representation Learning Meets Local Sparse Attention](https://arxiv.org/abs/2603.14483) <a id="link19"></a>
...
## 20. [OxyGen: Unified KV Cache Management for Vision-Language-Action Models under Multi-Task Parallelism](https://arxiv.org/abs/2603.14371) <a id="link20"></a>
...
## 21. [Interleaved Resampling and Refitting: Data and Compute-Efficient Evaluation of Black-Box Predictors](https://arxiv.org/abs/2603.14218) <a id="link21"></a>
...
## 22. [On the (Generative) Linear Sketching Problem](https://arxiv.org/abs/2603.14474) <a id="link22"></a>
...
## 23. [Sampling Boltzmann distributions via normalizing flow approximation of transport maps](https://arxiv.org/abs/2603.14258) <a id="link23"></a>
...
## 24. [Windowed Fourier Propagator: A Frequency-Local Neural Operator for Wave Equations in Inhomogeneous Media](https://arxiv.org/abs/2603.14289) <a id="link24"></a>
...
## 25. [Convergence of Two Time-Scale Stochastic Approximation: A Martingale Approach](https://arxiv.org/abs/2603.14481) <a id="link25"></a>
...
## 26. [TMPDiff: Temporal Mixed-Precision for Diffusion Models](https://arxiv.org/abs/2603.14062) <a id="link26"></a>
...
## 27. [$K-$means with learned metrics](https://arxiv.org/abs/2603.14601) <a id="link27"></a>
...
## 28. [SuperLocalMemory V3: Information-Geometric Foundations for Zero-LLM Enterprise Agent Memory](https://arxiv.org/abs/2603.14588) <a id="link28"></a>
...
## 29. [D-MEM: Dopamine-Gated Agentic Memory via Reward Prediction Error Routing](https://arxiv.org/abs/2603.14597) <a id="link29"></a>
...
## 30. [ZOTTA: Test-Time Adaptation with Gradient-Free Zeroth-Order Optimization](https://arxiv.org/abs/2603.14254) <a id="link30"></a>
...
## 31. [From Specification to Architecture: A Theory Compiler for Knowledge-Guided Machine Learning](https://arxiv.org/abs/2603.14369) <a id="link31"></a>
...
## 32. [Look Where It Matters: High-Resolution Crops Retrieval for Efficient VLMs](https://arxiv.org/abs/2603.16932) <a id="link32"></a>
...
## 33. [Structure-Dependent Regret and Constraint Violation Bounds for Online Convex Optimization with Time-Varying Constraints](https://arxiv.org/abs/2603.14319) <a id="link33"></a>
...
## 34. [AEX: Non-Intrusive Multi-Hop Attestation and Provenance for LLM APIs](https://arxiv.org/abs/2603.14283) <a id="link34"></a>
...
## 35. [Towards One-for-All Anomaly Detection for Tabular Data](https://arxiv.org/abs/2603.14407) <a id="link35"></a>
...
## 36. [Not All Latent Spaces Are Flat: Hyperbolic Concept Control](https://arxiv.org/abs/2603.14093) <a id="link36"></a>
...
## 37. [Punctuated Equilibria in Artificial Intelligence: The Institutional Scaling Law and the Speciation of Sovereign AI](https://arxiv.org/abs/2603.14664) <a id="link37"></a>
...
## 38. [The Institutional Scaling Law: Non-Monotonic Fitness, Capability-Trust Divergence, and Symbiogenetic Scaling in Generative AI](https://arxiv.org/abs/2603.14126) <a id="link38"></a>
...
## 39. [True 4-Bit Quantized Convolutional Neural Network Training on CPU: Achieving Full-Precision Parity](https://arxiv.org/abs/2603.13931) <a id="link39"></a>
...
## 40. [Is the reconstruction loss culprit? An attempt to outperform JEPA](https://arxiv.org/abs/2603.14131) <a id="link40"></a>
...
## 41. [Representation Alignment for Just Image Transformers is not Easier than You Think](https://arxiv.org/abs/2603.14366) <a id="link41"></a>
...
## 42. [WestWorld: A Knowledge-Encoded Scalable Trajectory World Model for Diverse Robotic Systems](https://arxiv.org/abs/2603.14392) <a id="link42"></a>
...
## 43. [Human-like Object Grouping in Self-supervised Vision Transformers](https://arxiv.org/abs/2603.13994) <a id="link43"></a>
...
## 44. [Exploring the Dimensions of a Variational Neuron](https://arxiv.org/abs/2603.13849) <a id="link44"></a>
...
## 45. [IGU-LoRA: Adaptive Rank Allocation via Integrated Gradients and Uncertainty-Aware Scoring](https://arxiv.org/abs/2603.13792) <a id="link45"></a>
...
## 46. [Align Forward, Adapt Backward: Closing the Discretization Gap in Logic Gate Networks](https://arxiv.org/abs/2603.14157) <a id="link46"></a>
...
## 47. [Pixel-level Scene Understanding in One Token: Visual States Need What-is-Where Composition](https://arxiv.org/abs/2603.13904) <a id="link47"></a>
...
## 48. [DASH: Dynamic Audio-Driven Semantic Chunking for Efficient Omnimodal Token Compression](https://arxiv.org/abs/2603.15685) <a id="link48"></a>
...
## 49. [Soft Mean Expected Calibration Error (SMECE): A Calibration Metric for Probabilistic Labels](https://arxiv.org/abs/2603.14092) <a id="link49"></a>
...
## 50. [ES-Merging: Biological MLLM Merging via Embedding Space Signals](https://arxiv.org/abs/2603.14405) <a id="link50"></a>
...
## 51. [SPARQ: Spiking Early-Exit Neural Networks for Energy-Efficient Edge AI](https://arxiv.org/abs/2603.14380) <a id="link51"></a>
...
## 52. [Exploiting temporal parallelism for LSTM Autoencoder acceleration on FPGA](https://arxiv.org/abs/2603.13982) <a id="link52"></a>
...
## 53. [Mitigating Overthinking in Large Reasoning Language Models via Reasoning Path Deviation Monitoring](https://arxiv.org/abs/2603.14251) <a id="link53"></a>
...
## 54. [Routing Channel-Patch Dependencies in Time Series Forecasting with Graph Spectral Decomposition](https://arxiv.org/abs/2603.13702) <a id="link54"></a>
...
## 55. [U-Face: An Efficient and Generalizable Framework for Unsupervised Facial Attribute Editing via Subspace Learning](https://arxiv.org/abs/2603.14004) <a id="link55"></a>
...
## 56. [On the Degrees of Freedom of Gridded Control Points in Learning-Based Medical Image Registration](https://arxiv.org/abs/2603.16940) <a id="link56"></a>
...
## 57. [High-Fidelity Compression of Seismic Velocity Models via SIREN Auto-Decoders](https://arxiv.org/abs/2603.14284) <a id="link57"></a>
...
## 58. [PA-Net: Precipitation-Adaptive Mixture-of-Experts for Long-Tail Rainfall Nowcasting](https://arxiv.org/abs/2603.13818) <a id="link58"></a>
