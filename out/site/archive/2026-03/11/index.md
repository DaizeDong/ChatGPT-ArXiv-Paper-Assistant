<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../10"><img src="../../../assets/nav/day/2026-03-11-prev.svg" alt="Previous Day 2026-03-10"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-03-11-center.svg" alt="Monthly Overview 2026-03"></a></div><div style="width: 33.33%; text-align: right;"><a href="../12"><img src="../../../assets/nav/day/2026-03-11-next.svg" alt="Next Day 2026-03-12"></a></div></div>
...
## 1. [Variational Routing: A Scalable Bayesian Framework for Calibrated Mixture-of-Experts Transformers](https://arxiv.org/abs/2603.09453) <a id="link1"></a>
...
## 2. [Uncovering a Winning Lottery Ticket with Continuously Relaxed Bernoulli Gates](https://arxiv.org/abs/2603.08914) <a id="link2"></a>
...
## 3. [Expressivity-Efficiency Tradeoffs for Hybrid Sequence Models](https://arxiv.org/abs/2603.08859) <a id="link3"></a>
...
## 4. [On the Width Scaling of Neural Optimizers Under Matrix Operator Norms I: Row/Column Normalization and Hyperparameter Transfer](https://arxiv.org/abs/2603.09952) <a id="link4"></a>
...
## 5. [Unveiling the Potential of Quantization with MXFP4: Strategies for Quantization Error Reduction](https://arxiv.org/abs/2603.08713) <a id="link5"></a>
...
## 6. [Exclusive Self Attention](https://arxiv.org/abs/2603.09078) <a id="link6"></a>
...
## 7. [From Semantics to Pixels: Coarse-to-Fine Masked Autoencoders for Hierarchical Visual Understanding](https://arxiv.org/abs/2603.09955) <a id="link7"></a>
...
## 8. [From Data Statistics to Feature Geometry: How Correlations Shape Superposition](https://arxiv.org/abs/2603.09972) <a id="link8"></a>
...
## 9. [Beyond Test-Time Training: Learning to Reason via Hardware-Efficient Optimal Control](https://arxiv.org/abs/2603.09221) <a id="link9"></a>
...
## 10. [Memorization capacity of deep ReLU neural networks characterized by width and depth](https://arxiv.org/abs/2603.09589) <a id="link10"></a>
...
## 11. [The Missing Memory Hierarchy: Demand Paging for LLM Context Windows](https://arxiv.org/abs/2603.09023) <a id="link11"></a>
...
## 12. [Generalized Reduction to the Isotropy for Flexible Equivariant Neural Fields](https://arxiv.org/abs/2603.08758) <a id="link12"></a>
...
## 13. [Mousse: Rectifying the Geometry of Muon with Curvature-Aware Preconditioning](https://arxiv.org/abs/2603.09697) <a id="link13"></a>
...
## 14. [An Empirical Study and Theoretical Explanation on Task-Level Model-Merging Collapse](https://arxiv.org/abs/2603.09463) <a id="link14"></a>
...
## 15. [Quantifying the Necessity of Chain of Thought through Opaque Serial Depth](https://arxiv.org/abs/2603.09786) <a id="link15"></a>
...
## 16. [Permutation-Equivariant 2D State Space Models: Theory and Canonical Architecture for Multivariate Time Series](https://arxiv.org/abs/2603.08753) <a id="link16"></a>
...
## 17. [A Variational Latent Equilibrium for Learning in Cortex](https://arxiv.org/abs/2603.09600) <a id="link17"></a>
...
## 18. [ARKV: Adaptive and Resource-Efficient KV Cache Management under Limited Memory Budget for Long-Context Inference in LLMs](https://arxiv.org/abs/2603.08727) <a id="link18"></a>
...
## 19. [GAST: Gradient-aligned Sparse Tuning of Large Language Models with Data-layer Selection](https://arxiv.org/abs/2603.09865) <a id="link19"></a>
...
## 20. [Zipage: Maintain High Request Concurrency for LLM Reasoning through Compressed PagedAttention](https://arxiv.org/abs/2603.08743) <a id="link20"></a>
...
## 21. [SoftJAX & SoftTorch: Empowering Automatic Differentiation Libraries with Informative Gradients](https://arxiv.org/abs/2603.08824) <a id="link21"></a>
...
## 22. [Routing without Forgetting](https://arxiv.org/abs/2603.09576) <a id="link22"></a>
...
## 23. [A Gaussian Comparison Theorem for Training Dynamics in Machine Learning](https://arxiv.org/abs/2603.09310) <a id="link23"></a>
...
## 24. [Curveball Steering: The Right Direction To Steer Isn't Always Linear](https://arxiv.org/abs/2603.09313) <a id="link24"></a>
...
## 25. [An accurate flatness measure to estimate the generalization performance of CNN models](https://arxiv.org/abs/2603.09016) <a id="link25"></a>
...
## 26. [Efficiently Aligning Draft Models via Parameter- and Data-Efficient Adaptation](https://arxiv.org/abs/2603.09527) <a id="link26"></a>
...
## 27. [Multi-DNN Inference of Sparse Models on Edge SoCs](https://arxiv.org/abs/2603.09642) <a id="link27"></a>
...
## 28. [What is Missing? Explaining Neurons Activated by Absent Concepts](https://arxiv.org/abs/2603.09787) <a id="link28"></a>
...
## 29. [Towards Understanding Adam Convergence on Highly Degenerate Polynomials](https://arxiv.org/abs/2603.09581) <a id="link29"></a>
...
## 30. [Transductive Generalization via Optimal Transport and Its Application to Graph Node Classification](https://arxiv.org/abs/2603.09257) <a id="link30"></a>
...
## 31. [DendroNN: Dendrocentric Neural Networks for Energy-Efficient Classification of Event-Based Data](https://arxiv.org/abs/2603.09274) <a id="link31"></a>
...
## 32. [On Catastrophic Forgetting in Low-Rank Decomposition-Based Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2603.09684) <a id="link32"></a>
...
## 33. [FlexServe: A Fast and Secure LLM Serving System for Mobile Devices with Flexible Resource Isolation](https://arxiv.org/abs/2603.09046) <a id="link33"></a>
...
## 34. [Evolving Prompt Adaptation for Vision-Language Models](https://arxiv.org/abs/2603.09493) <a id="link34"></a>
...
## 35. [Skip to the Good Part: Representation Structure & Inference-Time Layer Skipping in Diffusion vs. Autoregressive LLMs](https://arxiv.org/abs/2603.07475) <a id="link35"></a>
