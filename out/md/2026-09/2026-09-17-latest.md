...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">not reported</td>
            <td align="center">not reported</td>
            <td rowspan="2" align="center">629</td>
...
1. [Beyond the Previous Layer: Residual Predictive Structure in Sparse MoE Routing](#paper-2609-17940)
**Authors:** Hao Li, Yasuyuki Tahara, Yuichi Sei

## [Large-Scale Training Systems and Efficiency](#topic-training-systems) (3)

1. [COMPASS-ABS: Reducing Fragmentation in Shared GPU Clusters for Deep Learning Training Workloads](#paper-2609-18519)
**Authors:** Yukai Zhou, Hongfan Wu

2. [Gradient Descent with Stochastic Subspaces via Persistence of Memory](#paper-2609-18416)
**Authors:** Subhroshekhar Ghosh, Clement Z. Q. Ng, Pierre-Louis Poirion, Akiko Takeda

3. [FedPGT: Progressive Gradient Transmission for Vehicular Federated Learning over Time-Varying Channels](#paper-2609-18089)
...
1. [Reaching Every Position Without Searching: Rotating Sparse Wiring on the Hypercube as a Substitute for Attention](#paper-2609-18145)
**Authors:** Yoshiaki Takashita

2. [Beyond Random Couplings: Contrastive Noise Alignment in Generative Flows](#paper-2609-18488)
**Authors:** Lennart Wittke, Vinicius Azevedo

3. [The Attention Within: Consensus Dynamics in Selective State Space Models](#paper-2609-17997)
**Authors:** Jo\~ao Pedro Silvestre, \'Alvaro Rodr\'iguez Abella, Paulo Tabuada

4. [Double descent is the principle of least action](#paper-2609-19076)
**Authors:** Congzhou M Sha

5. [Infinite-Parameter LLMs: Generating and Adapting Weights from Live Data](#paper-2609-18842)
**Authors:** Jinli Hu, Ross M. Clarke, Yichuan Zhang, Jos\'e Miguel Hern\'andez-Lobato

6. [SAM-on-the-Curve: Sharpness-Aware Mode Connectivity for Robust Weight-Space Interpolation](#paper-2609-17748)
**Authors:** Alejandro Calatrava, Xu Zhang, Ren Wang

7. [QiT: Quantum-Inspired Transformer for Visual Recognition Task](#paper-2609-17789)
**Authors:** Badri N. Patro, Vijay Agneeswaran

8. [Objective vs. Search: Decomposing What Makes a Good Tokeniser](#paper-2609-19145)
**Authors:** Ahmetcan Yavuz, Clara Meister, Tiago Pimentel

9. [Beyond Embedding Transfer: Component Roles in Grokking Transfer and Stability](#paper-2609-18078)
**Authors:** Zeyu Jia

10. [Stability-Constrained Approximation in Spline KANs: Exact Layer Balancing and Budget-Compatible Saturation](#paper-2609-17619)
**Authors:** Aleksander Tankman

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (13)

1. [Higher-order pruning of experts in mixture-of-experts language models](#paper-2609-18916)
**Authors:** Alex M. Tseng, Prannay Kaul, Luca Zancato, Wei Xia, Stefano Soatto

2. [Fathom: Per-Query Read Depth for Sparse Decoding over Offloaded KV Caches](#paper-2609-17652)
**Authors:** Vivek Kalyanarangan

3. [GroupKV: Hierarchical KV Cache Management for Long-Context Diffusion LLM Inference](#paper-2609-17573)
**Authors:** Jinhao Wang, Zhexin Hu, Kangjie Zhou, Xin Zhou, Fangfang Liu

4. [OBC-Prune: Outcome-Based Calibration for Large Reasoning Model Pruning](#paper-2609-17890)
**Authors:** Ha Lan Nguyen, Huy Hoang Tran, Trac-Duy Tran, Dung D. Le

5. [The Other Half of the Memory Wall: Serving 35B MoEs from SSD with Trained Routing Prediction](#paper-2609-18063)
**Authors:** Yu Lin, Yiming Wang, Runyuan Cai, Hanze Liu, Xiaodong Zeng

6. [Colla-Q: Toward Collaborative Experts in MoE Quantization via Minimax Precision Balancing](#paper-2609-18131)
**Authors:** Eunju Shin, Jongbin Ryu

7. [ASPIRE: Asynchronous Batched Self-Speculative Decoding for Long-Context LLM Inference](#paper-2609-17943)
**Authors:** Amir Ziashahabi, Hossein Entezari Zarch, Lei Gao, Murali Annavaram, Salman Avestimehr

8. [Contiguity, Not Importance: Budgeted Repair of Stale KV Caches After Document Edits](#paper-2609-17983)
**Authors:** Mingyang Mao, Wyatt Mackey, Xiaomin Lin

9. [Accelerating Diffusion Sampling via Speculative Draft Trees](#paper-2609-17691)
**Authors:** Marcello Bullo, Yanxiao Liu, \"Oyk\"u S{\i}la G\"uner, Arpan Mukherjee, Deniz G\"und\"uz

10. [Token Latency Fairness: Performance Isolation for Multi-Tenant LLM Serving](#paper-2609-18112)
**Authors:** Dev Bali, Soujanya Ponnapalli, Yichuan Wang, Natacha Crooks, Scott Shenker, Matei Zaharia

11. [Ask the Tool, Don't Guess: Agent Tool Calls Hold Their Progress, and the Serving System Should Read It](#paper-2609-18849)
**Authors:** Yipeng Liu, Yingqiang Zhang, Feifei Li, Huanchen Zhang

12. [Not All Layers Need Tuning: Diagnosing and Directing Adaptation in Vision-Language-Action Models](#paper-2609-18084)
**Authors:** Shahram Najam Syed, Arthur Jakobsson, Prayuj Sachdev, Jeffrey Ichnowski

13. [rMuscle: Robotic Muscle Memory for Efficient Vision-Language-Action Model Inference](#paper-2609-19104)
...
### 1. [Beyond the Previous Layer: Residual Predictive Structure in Sparse MoE Routing](https://arxiv.org/abs/2609.17940) <a id="paper-2609-17940"></a>
...
### 1. [COMPASS-ABS: Reducing Fragmentation in Shared GPU Clusters for Deep Learning Training Workloads](https://arxiv.org/abs/2609.18519) <a id="paper-2609-18519"></a>
...
### 2. [Gradient Descent with Stochastic Subspaces via Persistence of Memory](https://arxiv.org/abs/2609.18416) <a id="paper-2609-18416"></a>
...
### 3. [FedPGT: Progressive Gradient Transmission for Vehicular Federated Learning over Time-Varying Channels](https://arxiv.org/abs/2609.18089) <a id="paper-2609-18089"></a>
...
### 1. [Reaching Every Position Without Searching: Rotating Sparse Wiring on the Hypercube as a Substitute for Attention](https://arxiv.org/abs/2609.18145) <a id="paper-2609-18145"></a>
...
### 2. [Beyond Random Couplings: Contrastive Noise Alignment in Generative Flows](https://arxiv.org/abs/2609.18488) <a id="paper-2609-18488"></a>
...
### 3. [The Attention Within: Consensus Dynamics in Selective State Space Models](https://arxiv.org/abs/2609.17997) <a id="paper-2609-17997"></a>
...
### 4. [Double descent is the principle of least action](https://arxiv.org/abs/2609.19076) <a id="paper-2609-19076"></a>
...
### 5. [Infinite-Parameter LLMs: Generating and Adapting Weights from Live Data](https://arxiv.org/abs/2609.18842) <a id="paper-2609-18842"></a>
...
### 6. [SAM-on-the-Curve: Sharpness-Aware Mode Connectivity for Robust Weight-Space Interpolation](https://arxiv.org/abs/2609.17748) <a id="paper-2609-17748"></a>
...
### 7. [QiT: Quantum-Inspired Transformer for Visual Recognition Task](https://arxiv.org/abs/2609.17789) <a id="paper-2609-17789"></a>
...
### 8. [Objective vs. Search: Decomposing What Makes a Good Tokeniser](https://arxiv.org/abs/2609.19145) <a id="paper-2609-19145"></a>
...
### 9. [Beyond Embedding Transfer: Component Roles in Grokking Transfer and Stability](https://arxiv.org/abs/2609.18078) <a id="paper-2609-18078"></a>
...
### 10. [Stability-Constrained Approximation in Spline KANs: Exact Layer Balancing and Budget-Compatible Saturation](https://arxiv.org/abs/2609.17619) <a id="paper-2609-17619"></a>
...
### 1. [Higher-order pruning of experts in mixture-of-experts language models](https://arxiv.org/abs/2609.18916) <a id="paper-2609-18916"></a>
...
### 2. [Fathom: Per-Query Read Depth for Sparse Decoding over Offloaded KV Caches](https://arxiv.org/abs/2609.17652) <a id="paper-2609-17652"></a>
...
### 3. [GroupKV: Hierarchical KV Cache Management for Long-Context Diffusion LLM Inference](https://arxiv.org/abs/2609.17573) <a id="paper-2609-17573"></a>
...
### 4. [OBC-Prune: Outcome-Based Calibration for Large Reasoning Model Pruning](https://arxiv.org/abs/2609.17890) <a id="paper-2609-17890"></a>
...
### 5. [The Other Half of the Memory Wall: Serving 35B MoEs from SSD with Trained Routing Prediction](https://arxiv.org/abs/2609.18063) <a id="paper-2609-18063"></a>
...
### 6. [Colla-Q: Toward Collaborative Experts in MoE Quantization via Minimax Precision Balancing](https://arxiv.org/abs/2609.18131) <a id="paper-2609-18131"></a>
...
### 7. [ASPIRE: Asynchronous Batched Self-Speculative Decoding for Long-Context LLM Inference](https://arxiv.org/abs/2609.17943) <a id="paper-2609-17943"></a>
...
### 8. [Contiguity, Not Importance: Budgeted Repair of Stale KV Caches After Document Edits](https://arxiv.org/abs/2609.17983) <a id="paper-2609-17983"></a>
...
### 9. [Accelerating Diffusion Sampling via Speculative Draft Trees](https://arxiv.org/abs/2609.17691) <a id="paper-2609-17691"></a>
...
### 10. [Token Latency Fairness: Performance Isolation for Multi-Tenant LLM Serving](https://arxiv.org/abs/2609.18112) <a id="paper-2609-18112"></a>
...
### 11. [Ask the Tool, Don't Guess: Agent Tool Calls Hold Their Progress, and the Serving System Should Read It](https://arxiv.org/abs/2609.18849) <a id="paper-2609-18849"></a>
...
### 12. [Not All Layers Need Tuning: Diagnosing and Directing Adaptation in Vision-Language-Action Models](https://arxiv.org/abs/2609.18084) <a id="paper-2609-18084"></a>
...
### 13. [rMuscle: Robotic Muscle Memory for Efficient Vision-Language-Action Model Inference](https://arxiv.org/abs/2609.19104) <a id="paper-2609-19104"></a>
