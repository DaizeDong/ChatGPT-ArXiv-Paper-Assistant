<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../30"><img src="../../../assets/nav/day/2025-10-31-prev.svg" alt="Previous Day 2025-10-30"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-10-31-center.svg" alt="Monthly Overview 2025-10"></a></div><div style="width: 33.33%; text-align: right;"><a href="../../2025-11/03"><img src="../../../assets/nav/day/2025-10-31-next.svg" alt="Next Day 2025-11-03"></a></div></div>

# Personalized Daily ArXiv Papers 2025-10-31

| *[gpt-5]*   | Prompt   | Completion   | Total   |
|:-----------:|:--------:|:------------:|:-------:|
| **Token**   | 40910    | 37710        | 78620   |
| **Cost**    | $0.05    | $0.38        | $0.43   |
...
3. [ExpertFlow: Adaptive Expert Scheduling and Memory Coordination for Efficient MoE Inference](#user-content-link3)
**Authors:** Zixu Shen, Kexin Chu, Yifan Zhang, Dawei Xiang, Runxin Wu, Wei Zhang

4. [Deep sequence models tend to memorize geometrically; it is unclear why](#user-content-link4)
**Authors:** Shahriar Noroozizadeh, Vaishnavh Nagarajan, Elan Rosenfeld, Sanjiv Kumar

5. [Mixture-of-Experts Operator Transformer for Large-Scale PDE Pre-Training](#user-content-link5)
**Authors:** Hong Wang, Haiyang Xin, Jie Wang, Xuanze Yang, Fei Zha, Huanshuo Dong, Yan Jiang

6. [Contrastive Predictive Coding Done Right for Mutual Information Estimation](#user-content-link6)
**Authors:** J. Jon Ryu, Pavan Yeddanapudi, Xiangxiang Xu, Gregory W. Wornell

7. [Implicit Bias of Per-sample Adam on Separable Data: Departure from the Full-batch Regime](#user-content-link7)
**Authors:** Beomhan Baek, Minhak Song, Chulhee Yun

8. [Polybasic Speculative Decoding Through a Theoretical Perspective](#user-content-link8)
**Authors:** Ruilin Wang, Huixia Li, Yuexiao Ma, Xiawu Zheng, Fei Chao, Xuefeng Xiao, Rongrong Ji

9. [Understanding Hardness of Vision-Language Compositionality from A Token-level Causal Lens](#user-content-link9)
**Authors:** Ziliang Chen, Tianang Xiao, Jusheng Zhang, Yongsen Zheng, Xipeng Chen

10. [LLMs Process Lists With General Filter Heads](#user-content-link10)
**Authors:** Arnab Sen Sharma, Giordano Rogers, Natalie Shapira, David Bau

11. [Learning Geometry: A Framework for Building Adaptive Manifold Models through Metric Optimization](#user-content-link11)
**Authors:** Di Zhang

12. [STaMP: Sequence Transformation and Mixed Precision for Low-Precision Activation Quantization](#user-content-link12)
**Authors:** Marco Federici, Riccardo Del Chiaro, Boris van Breugel, Paul Whatmough, Markus Nagel

13. [AttnCache: Accelerating Self-Attention Inference for LLM Prefill via Attention Cache](#user-content-link13)
...
14. [LoRAQuant: Mixed-Precision Quantization of LoRA to Ultra-Low Bits](#user-content-link14)
**Authors:** Amir Reza Mirzaei, Yuqiao Wen, Yanshuai Cao, Lili Mou

15. [Inference-Cost-Aware Dynamic Tree Construction for Efficient Inference in Large Language Models](#user-content-link15)
...
17. [Nirvana: A Specialized Generalist Model With Task-Aware Memory Mechanism](#user-content-link17)
**Authors:** Yuhua Jiang, Shuang Cheng, Yihao Liu, Ermo Hua, Che Jiang, Weigao Sun, Yu Cheng, Feifei Gao, Biqing Qi, Bowen Zhou

18. [Learning Pseudorandom Numbers with Transformers: Permuted Congruential Generators, Curricula, and Interpretability](#user-content-link18)
**Authors:** Tao Tao, Maissam Barkeshli

19. [The End of Manual Decoding: Towards Truly End-to-End Language Models](#user-content-link19)
**Authors:** Zhichao Wang, Dongyang Ma, Xinting Huang, Deng Cai, Tian Lan, Jiahao Xu, Haitao Mi, Xiaoying Tang, Yan Wang

20. [Likely Interpolants of Generative Models](#user-content-link20)
**Authors:** Frederik M\"obius Rygaard, Shen Zhu, Yinzhu Jin, S{\o}ren Hauberg, Tom Fletcher

21. [What's In My Human Feedback? Learning Interpretable Descriptions of Preference Data](#user-content-link21)
**Authors:** Rajiv Movva, Smitha Milli, Sewon Min, Emma Pierson

22. [Unravelling the Mechanisms of Manipulating Numbers in Language Models](#user-content-link22)
**Authors:** Michal \v{S}tef\'anik, Timothee Mickus, Marek Kadl\v{c}\'ik, Bertram H{\o}jer, Michal Spiegel, Ra\'ul V\'azquez, Aman Sinha, Josef Kucha\v{r}, Philipp Mondorf

23. [Angular Steering: Behavior Control via Rotation in Activation Space](#user-content-link23)
**Authors:** Hieu M. Vu, Tan M. Nguyen

24. [The Information-Theoretic Imperative: Compression and the Epistemic Foundations of Intelligence](#user-content-link24)
**Authors:** Christian Dittrich, Jennifer Flygare Kinne

25. [ReSpec: Towards Optimizing Speculative Decoding in Reinforcement Learning Systems](#user-content-link25)
**Authors:** Qiaoling Chen, Zijun Liu, Peng Sun, Shenggui Li, Guoteng Wang, Ziming Liu, Yonggang Wen, Siyuan Feng, Tianwei Zhang

26. [Clone Deterministic 3D Worlds with Geometrically-Regularized World Models](#user-content-link26)
**Authors:** Zaishuo Xia, Yukuan Lu, Xinyi Li, Yifan Xu, Yubei Chen

27. [Defeating the Training-Inference Mismatch via FP16](#user-content-link27)
**Authors:** Penghui Qi, Zichen Liu, Xiangxin Zhou, Tianyu Pang, Chao Du, Wee Sun Lee, Min Lin

28. [ConceptScope: Characterizing Dataset Bias via Disentangled Visual Concepts](#user-content-link28)
...
**Comment:** Model Architecture/Efficiency: introduces Kimi Delta Attention (linear attention) and hybrid with MLA, cutting KV cache and boosting throughput while surpassing full attention.
...
**Comment:** HPC + Compression/Efficiency: All-Reduce–compatible Top-K gradient compressor with contraction guarantees; communication-efficient distributed training.
...
## 3. [ExpertFlow: Adaptive Expert Scheduling and Memory Coordination for Efficient MoE Inference](https://arxiv.org/abs/2510.26730) <a id="link3"></a>
...
**Comment:** MoE Efficiency/HPC: adaptive expert prefetching and cache-aware routing for memory-constrained MoE inference with runtime-driven scheduling.
...
## 4. [Deep sequence models tend to memorize geometrically; it is unclear why](https://arxiv.org/abs/2510.26745) <a id="link4"></a>
...
**Comment:** Representation Learning: uncovers geometric memorization in deep sequence models with analysis linking to spectral bias; insights into training dynamics and embeddings.
...
## 5. [Mixture-of-Experts Operator Transformer for Large-Scale PDE Pre-Training](https://arxiv.org/abs/2510.25803) <a id="link5"></a>
...
**Comment:** Model Architecture: Mixture-of-Experts with router-gating and shared experts; Efficiency: sparse activation controls inference cost
...
## 6. [Contrastive Predictive Coding Done Right for Mutual Information Estimation](https://arxiv.org/abs/2510.25983) <a id="link6"></a>
...
**Comment:** Representation Learning: proposes InfoNCE-anchor for principled MI estimation and unifies contrastive objectives via proper scoring rules, clarifying what contrastive losses learn.
...
## 7. [Implicit Bias of Per-sample Adam on Separable Data: Departure from the Full-batch Regime](https://arxiv.org/abs/2510.26303) <a id="link7"></a>
...
**Comment:** Training dynamics/implicit bias: theoretical analysis of per-sample Adam vs full-batch, characterizing optimizer-induced max-margin geometry.
...
## 8. [Polybasic Speculative Decoding Through a Theoretical Perspective](https://arxiv.org/abs/2510.26527) <a id="link8"></a>
...
**Comment:** HPC/Efficiency: theoretical framework for multi-model (polybasic) speculative decoding with optimal inference time characterization and practical speedups.
...
## 9. [Understanding Hardness of Vision-Language Compositionality from A Token-level Causal Lens](https://arxiv.org/abs/2510.26302) <a id="link9"></a>
...
**Comment:** Representation Learning: token-level causal analysis of CLIP, identifying composition nonidentifiability and links to modality gaps.
...
## 10. [LLMs Process Lists With General Filter Heads](https://arxiv.org/abs/2510.26784) <a id="link10"></a>
...
**Comment:** Representation Learning: identifies causal, general-purpose ‘filter heads’ implementing a functional filtering operation across tasks
...
## 11. [Learning Geometry: A Framework for Building Adaptive Manifold Models through Metric Optimization](https://arxiv.org/abs/2510.26068) <a id="link11"></a>
...
**Comment:** Representation Learning/Model Architecture: learns an adaptive manifold via metric tensor optimization (discrete differential geometry), a foundational framework beyond parameter tuning.
...
## 12. [STaMP: Sequence Transformation and Mixed Precision for Low-Precision Activation Quantization](https://arxiv.org/abs/2510.26771) <a id="link12"></a>
...
**Comment:** Compression/Efficiency: low-precision activation quantization using sequence-dimension linear transforms and mixed-precision token retention; complements existing quantization.
...
## 13. [AttnCache: Accelerating Self-Attention Inference for LLM Prefill via Attention Cache](https://arxiv.org/abs/2510.25979) <a id="link13"></a>
...
**Comment:** Efficiency/HPC: attention-map caching and similarity retrieval to accelerate prefill self-attention in LLMs with minimal accuracy loss.
...
## 14. [LoRAQuant: Mixed-Precision Quantization of LoRA to Ultra-Low Bits](https://arxiv.org/abs/2510.26690) <a id="link14"></a>
...
**Comment:** Model Compression and Efficiency: mixed-precision post-training quantization of LoRA via SVD reparameterization to ultra-low bits.
...
## 15. [Inference-Cost-Aware Dynamic Tree Construction for Efficient Inference in Large Language Models](https://arxiv.org/abs/2510.26577) <a id="link15"></a>
...
**Comment:** Efficiency: inference-cost-aware speculative decoding with dynamic tree construction accounting for GPU/batch effects
...
**Comment:** Compression/Efficiency: fused low-rank adapters that incur zero or negligible inference latency overhead
...
## 17. [Nirvana: A Specialized Generalist Model With Task-Aware Memory Mechanism](https://arxiv.org/abs/2510.26083) <a id="link17"></a>
...
**Comment:** Model Architecture: specialized memory mechanism with task-aware trigger/updater for linear-time SGM inference and dynamic adaptation.
...
## 18. [Learning Pseudorandom Numbers with Transformers: Permuted Congruential Generators, Curricula, and Interpretability](https://arxiv.org/abs/2510.26792) <a id="link18"></a>
...
**Comment:** Representation Learning: analyzes how Transformers learn PRNG structure; scaling laws, curriculum necessity, and interpretable embeddings
...
## 19. [The End of Manual Decoding: Towards Truly End-to-End Language Models](https://arxiv.org/abs/2510.26697) <a id="link19"></a>
...
**Comment:** Model Architecture: augments transformers with lightweight heads that learn token-level temperature and top‑p, enabling end-to-end, dynamic decoding control.
...
## 20. [Likely Interpolants of Generative Models](https://arxiv.org/abs/2510.26266) <a id="link20"></a>
...
**Comment:** Representation Learning: principled interpolation scheme for generative models via likely transition paths with Riemannian-geodesic interpretation, no retraining required.
...
## 21. [What's In My Human Feedback? Learning Interpretable Descriptions of Preference Data](https://arxiv.org/abs/2510.26202) <a id="link21"></a>
...
**Comment:** Representation Learning: uses sparse autoencoders to learn interpretable latent features of human preference data for analysis and curation.
...
## 22. [Unravelling the Mechanisms of Manipulating Numbers in Language Models](https://arxiv.org/abs/2510.26285) <a id="link22"></a>
...
**Comment:** Representation Learning: probes numerical information processing in LLMs, yielding universal probes and layer-wise mechanism insights.
...
## 23. [Angular Steering: Behavior Control via Rotation in Activation Space](https://arxiv.org/abs/2510.26243) <a id="link23"></a>
...
**Comment:** Representation Learning: activation-space steering via geometric rotation (and adaptive variant) to control LLM behaviors.
...
## 24. [The Information-Theoretic Imperative: Compression and the Epistemic Foundations of Intelligence](https://arxiv.org/abs/2510.25883) <a id="link24"></a>
...
**Comment:** Representation Learning and Compression theory: argues compression efficiency drives causal representation discovery; testable predictions about rate–distortion and OOD generalization.
...
## 25. [ReSpec: Towards Optimizing Speculative Decoding in Reinforcement Learning Systems](https://arxiv.org/abs/2510.26475) <a id="link25"></a>
...
**Comment:** Efficiency/HPC: adapts speculative decoding to RL training with dynamic tuning and drafter distillation for faster rollouts
...
## 26. [Clone Deterministic 3D Worlds with Geometrically-Regularized World Models](https://arxiv.org/abs/2510.26782) <a id="link26"></a>
...
**Comment:** Representation Learning: geometric regularization to shape latent manifold topology for robust world-model rollouts
...
## 27. [Defeating the Training-Inference Mismatch via FP16](https://arxiv.org/abs/2510.26788) <a id="link27"></a>
...
**Comment:** HPC/Training optimization: shows FP16 precision mitigates training–inference mismatch in RL fine-tuning, improving stability and convergence
...
## 28. [ConceptScope: Characterizing Dataset Bias via Disentangled Visual Concepts](https://arxiv.org/abs/2510.26186) <a id="link28"></a>
...
**Comment:** Representation Learning: uses Sparse Autoencoders on foundation-model features to discover disentangled concepts and dataset bias
