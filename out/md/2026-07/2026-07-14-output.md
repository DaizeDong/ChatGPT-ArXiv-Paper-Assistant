...
<sub>Token counts are not reported for this run. 4 of 7 model calls succeeded, 3,148s of model wall clock.</sub>
...
1. [Decentralized Gradient Descent: Bottleneck Regimes and Budget Complexity](#paper-2607-12172)
**Authors:** Nicolò Michelusi

2. [Enhanced Byzantine-Robust Federated Learning Via Truncated-Quadratic Loss for Heterogeneous Data](#paper-2607-10970)
...
1. [Extending LLM Context via Associative Recurrent Memory](#paper-2607-11614)
...
2. [Self-Consistent Flow: Unifying Velocity and Endpoint Prediction for Rectified Flow Models](#paper-2607-12171)
...
6. [Emergent Hierarchical Monosemantic Neurons from the Group-Contrastive Forward-Forward Algorithm](#paper-2607-16295)
**Authors:** Yiming Tang, Qinglin Qi, Zhaoqian Yao, Harshvardhan Saini, Dianbo Liu

7. [Think Through a Bottleneck: Hourglass Reasoning for Rigorous Induction](#paper-2607-11696)
**Authors:** Huan Zhu

8. [An Exact Instrument for State Usage in Selective State-Space Models, and the Input-Driven Migration It Reveals](#paper-2607-11796)
**Authors:** Raktim Bhattacharya

9. [Backpropagation as a Nilpotent Linear System](#paper-2607-11289)
**Authors:** Ahmed Boughammoura

10. [Long-Memory Reservoir Computing for Data-Scarce Dengue Forecasting](#paper-2607-11272)
**Authors:** Rahul Goswami, Shinjini Paul, Palash Ghosh, Tanujit Chakraborty

11. [From Global to Factor-Wise Expert Composition in Discrete Diffusion Models](#paper-2607-11758)
**Authors:** Haozhe Huang, Yudong Xu, Abhijoy Mandal, Alán Aspuru-Guzik

12. [Are we Merging the Right Models? Impact of Expert Training Duration on Model Merging for LLMs](#paper-2607-11997)
**Authors:** Nikita Kozodoi, Zainab Afolabi, Jack Butler

13. [Sparse Inter-Layer Dependencies of Transformer FFN Neurons](#paper-2607-11990)
**Authors:** Johannes Knittel, Hanspeter Pfister

14. [A${}^2$BM: Alignment-Aware Bridge Matching for Image-to-Image Translation](#paper-2607-16294)
**Authors:** Aimi Okabayashi, Georges Le Bellier, Nicolas Audebert, Charlotte Pelletier, Thomas Corpetti, Nicolas Courty

15. [From Expressivity to Sample Complexity: Narrow Teachers for Transformers via C-RASP](#paper-2607-11760)
...
1. [OS-Pruner: Pruning Chains-of-Thought of Reasoning Models via Optimal Stopping](#paper-2607-11089)
**Authors:** Mohammed Ehab, Aymane El Gadarri, Vivek F. Farias, Adam Jozefiak, Ciamac C. Moallemi

2. [LiteTopK: Exploiting the Curse of Dimensionality for a Fused Indexer-TopK Kernel in Long-Context Sparse Attention](#paper-2607-11976)
**Authors:** Ziqi Yin, Jianyang Gao, Peiqi Yin, Jiangneng Li, Gao Cong

3. [FlashDiff: Efficient Regional Execution and Scheduling for Diffusion Model Serving](#paper-2607-12121)
**Authors:** Yaqi Qiao, Ping He, Songrun Xie, Ayush Barik, Chensong Zhang, Zhengzhong Tu, Fan Lai

4. [HCRMap: Pressure-Aware Hot-Expert Residency Mapping for 3.5D MoE Chiplet Inference](#paper-2607-11586)
**Authors:** Yongqin Zhang

5. [SpikeDS: Dual Sparsity Spikformer for Perineural Invasion Prediction in 3D MRI](#paper-2607-11986)
...
6. [StrideDiffusion: Accelerating Diffusion Models for Time-series Generation](#paper-2607-20545)
...
### 1. [Decentralized Gradient Descent: Bottleneck Regimes and Budget Complexity](https://arxiv.org/abs/2607.12172) <a id="paper-2607-12172"></a>
...
### 2. [Enhanced Byzantine-Robust Federated Learning Via Truncated-Quadratic Loss for Heterogeneous Data](https://arxiv.org/abs/2607.10970) <a id="paper-2607-10970"></a>
...
### 1. [Extending LLM Context via Associative Recurrent Memory](https://arxiv.org/abs/2607.11614) <a id="paper-2607-11614"></a>
...
### 2. [Self-Consistent Flow: Unifying Velocity and Endpoint Prediction for Rectified Flow Models](https://arxiv.org/abs/2607.12171) <a id="paper-2607-12171"></a>
...
### 6. [Emergent Hierarchical Monosemantic Neurons from the Group-Contrastive Forward-Forward Algorithm](https://arxiv.org/abs/2607.16295) <a id="paper-2607-16295"></a>
...
### 7. [Think Through a Bottleneck: Hourglass Reasoning for Rigorous Induction](https://arxiv.org/abs/2607.11696) <a id="paper-2607-11696"></a>
...
### 8. [An Exact Instrument for State Usage in Selective State-Space Models, and the Input-Driven Migration It Reveals](https://arxiv.org/abs/2607.11796) <a id="paper-2607-11796"></a>
...
### 9. [Backpropagation as a Nilpotent Linear System](https://arxiv.org/abs/2607.11289) <a id="paper-2607-11289"></a>
...
### 10. [Long-Memory Reservoir Computing for Data-Scarce Dengue Forecasting](https://arxiv.org/abs/2607.11272) <a id="paper-2607-11272"></a>
...
### 11. [From Global to Factor-Wise Expert Composition in Discrete Diffusion Models](https://arxiv.org/abs/2607.11758) <a id="paper-2607-11758"></a>
...
### 12. [Are we Merging the Right Models? Impact of Expert Training Duration on Model Merging for LLMs](https://arxiv.org/abs/2607.11997) <a id="paper-2607-11997"></a>
...
### 13. [Sparse Inter-Layer Dependencies of Transformer FFN Neurons](https://arxiv.org/abs/2607.11990) <a id="paper-2607-11990"></a>
...
### 14. [A${}^2$BM: Alignment-Aware Bridge Matching for Image-to-Image Translation](https://arxiv.org/abs/2607.16294) <a id="paper-2607-16294"></a>
...
### 15. [From Expressivity to Sample Complexity: Narrow Teachers for Transformers via C-RASP](https://arxiv.org/abs/2607.11760) <a id="paper-2607-11760"></a>
...
### 1. [OS-Pruner: Pruning Chains-of-Thought of Reasoning Models via Optimal Stopping](https://arxiv.org/abs/2607.11089) <a id="paper-2607-11089"></a>
...
### 2. [LiteTopK: Exploiting the Curse of Dimensionality for a Fused Indexer-TopK Kernel in Long-Context Sparse Attention](https://arxiv.org/abs/2607.11976) <a id="paper-2607-11976"></a>
...
### 3. [FlashDiff: Efficient Regional Execution and Scheduling for Diffusion Model Serving](https://arxiv.org/abs/2607.12121) <a id="paper-2607-12121"></a>
...
### 4. [HCRMap: Pressure-Aware Hot-Expert Residency Mapping for 3.5D MoE Chiplet Inference](https://arxiv.org/abs/2607.11586) <a id="paper-2607-11586"></a>
...
### 5. [SpikeDS: Dual Sparsity Spikformer for Perineural Invasion Prediction in 3D MRI](https://arxiv.org/abs/2607.11986) <a id="paper-2607-11986"></a>
...
### 6. [StrideDiffusion: Accelerating Diffusion Models for Time-series Generation](https://arxiv.org/abs/2607.20545) <a id="paper-2607-20545"></a>
