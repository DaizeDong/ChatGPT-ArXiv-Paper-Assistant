<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../02"><img src="../../../assets/nav/day/2026-03-03-prev.svg" alt="Previous Day 2026-03-02"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-03-03-center.svg" alt="Monthly Overview 2026-03"></a></div><div style="width: 33.33%; text-align: right;"><a href="../04"><img src="../../../assets/nav/day/2026-03-03-next.svg" alt="Next Day 2026-03-04"></a></div></div>
...
## 1. [ASTRA-bench: Evaluating Tool-Use Agent Reasoning and Action Planning with Personal User Context](https://arxiv.org/abs/2603.01357) <a id="link1"></a>
...
## 2. [Curvature-Weighted Capacity Allocation: A Minimum Description Length Framework for Layer-Adaptive Large Language Model Optimization](https://arxiv.org/abs/2603.00910) <a id="link2"></a>
...
## 3. [Recursive Models for Long-Horizon Reasoning](https://arxiv.org/abs/2603.02112) <a id="link3"></a>
...
## 4. [Expert Divergence Learning for MoE-based Language Models](https://arxiv.org/abs/2603.00054) <a id="link4"></a>
...
## 5. [Multi-Head Low-Rank Attention](https://arxiv.org/abs/2603.02188) <a id="link5"></a>
...
## 6. [Attn-QAT: 4-Bit Attention With Quantization-Aware Training](https://arxiv.org/abs/2603.00040) <a id="link6"></a>
...
## 7. [3BASiL: An Algorithmic Framework for Sparse plus Low-Rank Compression of LLMs](https://arxiv.org/abs/2603.01376) <a id="link7"></a>
...
## 8. [TriMoE: Augmenting GPU with AMX-Enabled CPU and DIMM-NDP for High-Throughput MoE Inference via Offloading](https://arxiv.org/abs/2603.01058) <a id="link8"></a>
...
## 9. [The Expressive Limits of Diagonal SSMs for State-Tracking](https://arxiv.org/abs/2603.01959) <a id="link9"></a>
...
## 10. [Training Dynamics of Softmax Self-Attention: Fast Global Convergence via Preconditioning](https://arxiv.org/abs/2603.01514) <a id="link10"></a>
...
## 11. [Quantitative Convergence of Wasserstein Gradient Flows of Kernel Mean Discrepancies](https://arxiv.org/abs/2603.01977) <a id="link11"></a>
...
## 12. [Diagnosing Generalization Failures from Representational Geometry Markers](https://arxiv.org/abs/2603.01879) <a id="link12"></a>
...
## 13. [CHLU: The Causal Hamiltonian Learning Unit as a Symplectic Primitive for Deep Learning](https://arxiv.org/abs/2603.01768) <a id="link13"></a>
...
## 14. [Grokking as a Phase Transition between Competing Basins: a Singular Learning Theory Approach](https://arxiv.org/abs/2603.01192) <a id="link14"></a>
...
## 15. [Weight Updates as Activation Shifts: A Principled Framework for Steering](https://arxiv.org/abs/2603.00425) <a id="link15"></a>
...
## 16. [NNiT: Width-Agnostic Neural Network Generation with Structurally Aligned Weight Spaces](https://arxiv.org/abs/2603.00180) <a id="link16"></a>
...
## 17. [Spectral Condition for $\mu$P under Width-Depth Scaling](https://arxiv.org/abs/2603.00541) <a id="link17"></a>
...
## 18. [Demystifying Group Relative Policy Optimization: Its Policy Gradient is a U-Statistic](https://arxiv.org/abs/2603.01162) <a id="link18"></a>
...
## 19. [Scalable Multi-Task Low-Rank Model Adaptation](https://arxiv.org/abs/2603.01526) <a id="link19"></a>
...
## 20. [Efficient Long-Horizon GUI Agents via Training-Free KV Cache Compression](https://arxiv.org/abs/2603.00188) <a id="link20"></a>
...
## 21. [Theoretical Perspectives on Data Quality and Synergistic Effects in Pre- and Post-Training Reasoning Models](https://arxiv.org/abs/2603.01293) <a id="link21"></a>
...
## 22. [A Decomposition Framework for Certifiably Optimal Orthogonal Sparse PCA](https://arxiv.org/abs/2603.01144) <a id="link22"></a>
...
## 23. [Whisper-MLA: Reducing GPU Memory Consumption of ASR Models based on MHA2MLA Conversion](https://arxiv.org/abs/2603.00563) <a id="link23"></a>
...
## 24. [Never Saddle for Reparameterized Steepest Descent as Mirror Flow](https://arxiv.org/abs/2603.02064) <a id="link24"></a>
...
## 25. [FreeAct: Freeing Activations for LLM Quantization](https://arxiv.org/abs/2603.01776) <a id="link25"></a>
...
## 26. [Scaling Laws of SignSGD in Linear Regression: When Does It Outperform SGD?](https://arxiv.org/abs/2603.02069) <a id="link26"></a>
...
## 27. [Quasar: Quantized Self-Speculative Acceleration for Rapid Inference via Memory-Efficient Verification](https://arxiv.org/abs/2603.01399) <a id="link27"></a>
...
## 28. [TiledAttention: a CUDA Tile SDPA Kernel for PyTorch](https://arxiv.org/abs/2603.01960) <a id="link28"></a>
...
## 29. [The Lattice Representation Hypothesis of Large Language Models](https://arxiv.org/abs/2603.01227) <a id="link29"></a>
...
## 30. [SageBwd: A Trainable Low-bit Attention](https://arxiv.org/abs/2603.02170) <a id="link30"></a>
...
## 31. [GPU-friendly and Linearly Convergent First-order Methods for Certifying Optimal $k$-sparse GLMs](https://arxiv.org/abs/2603.01306) <a id="link31"></a>
...
## 32. [Accelerating Single-Pass SGD for Generalized Linear Prediction](https://arxiv.org/abs/2603.01951) <a id="link32"></a>
...
## 33. [Random Features for Operator-Valued Kernels: Bridging Kernel Methods and Neural Operators](https://arxiv.org/abs/2603.00971) <a id="link33"></a>
...
## 34. [What Is the Geometry of the Alignment Tax?](https://arxiv.org/abs/2603.00047) <a id="link34"></a>
...
## 35. [Stateful Token Reduction for Long-Video Hybrid VLMs](https://arxiv.org/abs/2603.00198) <a id="link35"></a>
...
## 36. [Spectral Attention Steering for Prompt Highlighting](https://arxiv.org/abs/2603.01281) <a id="link36"></a>
...
## 37. [Rate-Distortion Signatures of Generalization and Information Trade-offs](https://arxiv.org/abs/2603.01568) <a id="link37"></a>
...
## 38. [On the Rate of Convergence of GD in Non-linear Neural Networks: An Adversarial Robustness Perspective](https://arxiv.org/abs/2603.02095) <a id="link38"></a>
...
## 39. [Symbol-Equivariant Recurrent Reasoning Models](https://arxiv.org/abs/2603.02193) <a id="link39"></a>
...
## 40. [Phase-Type Variational Autoencoders for Heavy-Tailed Data](https://arxiv.org/abs/2603.01800) <a id="link40"></a>
...
## 41. [MARS: Harmonizing Multimodal Convergence via Adaptive Rank Search](https://arxiv.org/abs/2603.00720) <a id="link41"></a>
...
## 42. [Polynomial Surrogate Training for Differentiable Ternary Logic Gate Networks](https://arxiv.org/abs/2603.00302) <a id="link42"></a>
...
## 43. [Invariant-Stratified Propagation for Expressive Graph Neural Networks](https://arxiv.org/abs/2603.01388) <a id="link43"></a>
...
## 44. [Discrete World Models via Regularization](https://arxiv.org/abs/2603.01748) <a id="link44"></a>
...
## 45. [Truth as a Trajectory: What Internal Representations Reveal About Large Language Model Reasoning](https://arxiv.org/abs/2603.01326) <a id="link45"></a>
...
## 46. [Polynomial Mixing for Efficient Self-supervised Speech Encoders](https://arxiv.org/abs/2603.00683) <a id="link46"></a>
...
## 47. [Nonconvex Latent Optimally Partitioned Block-Sparse Recovery via Log-Sum and Minimax Concave Penalties](https://arxiv.org/abs/2603.01304) <a id="link47"></a>
