...
HOT_ROOT_SITE_PAGE = "hot/index.md"
...
def site_hot_year_page_path(year: YearTuple) -> str:
    return f"hot/{year:04d}/index.md"


def site_hot_month_page_path(month: MonthTuple) -> str:
    year, month_num = month
    return f"hot/{year:04d}-{month_num:02d}/index.md"


def site_hot_day_page_path(date: DayTuple) -> str:
    year, month_num, day = date
    return f"hot/{year:04d}-{month_num:02d}-{day:02d}/index.md"
...
def site_hot_day_nav_asset_path(date: DayTuple, direction: str) -> str:
    year, month_num, day = date
    return f"assets/nav/hot/day/{year:04d}-{month_num:02d}-{day:02d}-{direction}.svg"
...
def site_hot_month_nav_asset_path(month: MonthTuple, direction: str) -> str:
    year, month_num = month
    return f"assets/nav/hot/month/{year:04d}-{month_num:02d}-{direction}.svg"
...
def site_hot_year_nav_asset_path(year: YearTuple, direction: str) -> str:
    return f"assets/nav/hot/year/{year:04d}-{direction}.svg"
