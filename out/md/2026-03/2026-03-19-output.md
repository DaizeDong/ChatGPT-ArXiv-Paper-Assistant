...
2. [Path-Constrained Mixture-of-Experts](#user-content-link2)
**Authors:** Zijin Gu, Tatiana Likhomanenko, Vimal Thilak, Jason Ramapuram, Navdeep Jaitly

3. [Learning When to Attend: Conditional Memory Access for Long-Context LLMs](#user-content-link3)
**Authors:** Sakshi Choudhary, Aditya Chattopadhyay, Luca Zancato, Elvis Nunez, Matthew Trager, Wei Xia, Stefano Soatto

4. [A Noise Sensitivity Exponent Controls Large Statistical-to-Computational Gaps in Single- and Multi-Index Models](#user-content-link4)
**Authors:** Leonardo Defilippis, Florent Krzakala, Bruno Loureiro, Antoine Maillard

5. [Operator-Theoretic Foundations and Policy Gradient Methods for General MDPs with Unbounded Costs](#user-content-link5)
...
7. [CARE: Covariance-Aware and Rank-Enhanced Decomposition for Enabling Multi-Head Latent Attention](#user-content-link7)
...
8. [Only relative ranks matter in weight-clustered large language models](#user-content-link8)
**Authors:** Borja Aizpurua, Sukhbinder Singh, Román Orús

9. [Beyond Muon: MUD (MomentUm Decorrelation) for Faster Transformer Training](#user-content-link9)
...
11. [A Dual Certificate Approach to Sparsity in Infinite-Width Shallow Neural Networks](#user-content-link11)
...
13. [Computation-Utility-Privacy Tradeoffs in Bayesian Estimation](#user-content-link13)
**Authors:** Sitan Chen, Jingqiu Ding, Mahbod Majid, Walter McKelvie

14. [Cohomological Obstructions to Global Counterfactuals: A Sheaf-Theoretic Foundation for Generative Causal Models](#user-content-link14)
**Authors:** Rui Wu, Hong Xie, Yongjun Li

15. [Beyond Outliers: A Data-Free Layer-wise Mixed-Precision Quantization Approach Driven by Numerical and Structural Dual-Sensitivity](#user-content-link15)
...
16. [The Phasor Transformer: Resolving Attention Bottlenecks on the Unit Circle](#user-content-link16)
...
18. [How do LLMs Compute Verbal Confidence](#user-content-link18)
**Authors:** Dharshan Kumaran, Arthur Conmy, Federico Barbero, Simon Osindero, Viorica Patraucean, Petar Velickovic

19. [Gaussian Process Limit Reveals Structural Benefits of Graph Transformers](#user-content-link19)
**Authors:** Nil Ayday, Lingchu Yang, Debarghya Ghoshdastidar

20. [Q-Drift: Quantization-Aware Drift Correction for Diffusion Model Sampling](#user-content-link20)
**Authors:** Sooyoung Ryu, Mathieu Salzmann, Saqib Javed

21. [Automated Grammar-based Algebraic Multigrid Design With Evolutionary Algorithms](#user-content-link21)
**Authors:** Dinesh Parthasarathy, Wayne Mitchell, Arjun Gambhir, Harald Köstler, Ulrich Rüde

22. [Learning Coordinate-based Convolutional Kernels for Continuous SE(3) Equivariant and Efficient Point Cloud Analysis](#user-content-link22)
**Authors:** Jaein Kim, Hee Bin Yoo, Dong-Sig Han, Byoung-Tak Zhang

23. [Learning Permutation Distributions via Reflected Diffusion on Ranks](#user-content-link23)
**Authors:** Sizhuang He, Yangtian Zhang, Shiyang Zhang, David van Dijk

24. [Learning-Augmented Algorithms for $k$-median via Online Learning](#user-content-link24)
**Authors:** Anish Hebbar, Rong Ge, Amit Kumar, Debmalya Panigrahi

25. [Stochastic set-valued optimization and its application to robust learning](#user-content-link25)
**Authors:** Tommaso Giovannelli, Jingfu Tan, Luis Nunes Vicente

26. [Identifying Latent Actions and Dynamics from Offline Data via Demonstrator Diversity](#user-content-link26)
**Authors:** Felix Schur

27. [CoVerRL: Breaking the Consensus Trap in Label-Free Reasoning via Generator-Verifier Co-Evolution](#user-content-link27)
**Authors:** Teng Pan, Yuchen Yan, Zixuan Wang, Ruiqing Zhang, Gaiyang Han, Wanqi Zhang, Weiming Lu, Jun Xiao, Yongliang Shen

28. [RHYME-XT: A Neural Operator for Spatiotemporal Control Systems](#user-content-link28)
**Authors:** Marijn Ruiter, Miguel Aguiar, Jake Rap, Karl H. Johansson, Amritam Das

29. [A Synthesizable RTL Implementation of Predictive Coding Networks](#user-content-link29)
**Authors:** Timothy Oh

30. [Tula: Optimizing Time, Cost, and Generalization in Distributed Large-Batch Training](#user-content-link30)
**Authors:** Sahil Tyagi, Feiyi Wang

31. [From Drop-off to Recovery: A Mechanistic Analysis of Segmentation in MLLMs](#user-content-link31)
**Authors:** Boyong Wu, Sanghwan Kim, Zeynep Akata

32. [Discovering Decoupled Functional Modules in Large Language Models](#user-content-link32)
**Authors:** Yanke Yu, Jin Li, Ying Sun, Ping Li, Zhefeng Wang, Yi Zheng

33. [Fundamental Limits of Neural Network Sparsification: Evidence from Catastrophic Interpretability Collapse](#user-content-link33)
**Authors:** Dip Roy, Rajiv Misra, Sanjay Kumar Singh

34. [Fine-Grained Post-Training Quantization for Large Vision Language Models with Quantization-Aware Integrated Gradients](#user-content-link34)
**Authors:** Ziwei Xiang, Fanhu Zeng, Hongjian Fang, Rui-Qi Wang, Renxing Chen, Yanan Zhu, Yi Chen, Peipei Yang, Xu-Yao Zhang

35. [RAMP: Reinforcement Adaptive Mixed Precision Quantization for Efficient On Device LLM Inference](#user-content-link35)
**Authors:** Arpit Singh Gautam, Saurabh Jha

36. [Inhibitory normalization of error signals improves learning in neural circuits](#user-content-link36)
**Authors:** Roy Henha Eyono, Daniel Levenstein, Arna Ghosh, Jonathan Cornford, Blake Richards

37. [KANtize: Exploring Low-bit Quantization of Kolmogorov-Arnold Networks for Efficient Inference](#user-content-link37)
**Authors:** Sohaib Errabii, Olivier Sentieys, Marcello Traiola

38. [Interpretability without actionability: mechanistic methods cannot correct language model errors despite near-perfect internal representations](#user-content-link38)
...
39. [DSS-GAN: Directional State Space GAN with Mamba backbone for Class-Conditional Image Synthesis](#user-content-link39)
...
**Comment:** Theory of ResNet training dynamics in the joint infinite depth-width-dimension limit with quantitative convergence rates.
...
## 2. [Path-Constrained Mixture-of-Experts](https://arxiv.org/abs/2603.18297) <a id="link2"></a>
...
**Comment:** MoE architecture innovation that constrains expert path space by sharing routers across layers, improving statistical efficiency.
...
## 3. [Learning When to Attend: Conditional Memory Access for Long-Context LLMs](https://arxiv.org/abs/2603.17484) <a id="link3"></a>
...
**Comment:** Conditional token-wise long-range attention layer that skips most global attention calls and includes systems support for efficient long-context training.
...
## 4. [A Noise Sensitivity Exponent Controls Large Statistical-to-Computational Gaps in Single- and Multi-Index Models](https://arxiv.org/abs/2603.17896) <a id="link4"></a>
...
**Comment:** Theory showing a Noise Sensitivity Exponent governs statistical-to-computational gaps in single- and multi-index learning models.
...
## 5. [Operator-Theoretic Foundations and Policy Gradient Methods for General MDPs with Unbounded Costs](https://arxiv.org/abs/2603.17875) <a id="link5"></a>
...
**Comment:** Develops operator-theoretic foundations for policy gradients in general MDPs with unbounded costs and broad state-action spaces.
...
**Comment:** Transformer analysis linking attention sinks to backpropagated gradient sinks as a training-time mechanism behind massive activations.
...
## 7. [CARE: Covariance-Aware and Rank-Enhanced Decomposition for Enabling Multi-Head Latent Attention](https://arxiv.org/abs/2603.17946) <a id="link7"></a>
...
**Comment:** Covariance-aware low-rank decomposition and nonuniform rank allocation for converting attention modules to MLA under fixed KV-cache budget.
...
## 8. [Only relative ranks matter in weight-clustered large language models](https://arxiv.org/abs/2603.17917) <a id="link8"></a>
...
**Comment:** Weight clustering study showing relative rank, not precise magnitude, is the key invariant for LLM compression.
...
## 9. [Beyond Muon: MUD (MomentUm Decorrelation) for Faster Transformer Training](https://arxiv.org/abs/2603.17970) <a id="link9"></a>
...
**Comment:** Optimizer innovation replacing Muon's polar orthogonalization with cheaper triangular whitening for faster transformer training.
...
**Comment:** Hardware-aware lossless compression system with fused decompression-GEMM for faster, lower-memory LLM inference.
...
## 11. [A Dual Certificate Approach to Sparsity in Infinite-Width Shallow Neural Networks](https://arxiv.org/abs/2603.17785) <a id="link11"></a>
...
**Comment:** Representation-learning theory: dual-certificate analysis proving sparsity and support bounds for TV-regularized infinite-width ReLU networks.
...
**Comment:** Provable learning-theoretic result that autocurriculum reduces sample and compute costs for reasoning-model SFT and RL.
...
## 13. [Computation-Utility-Privacy Tradeoffs in Bayesian Estimation](https://arxiv.org/abs/2603.18254) <a id="link13"></a>
...
**Comment:** Foundational theory for private Bayesian estimation with efficient near-Bayes-optimal algorithms and computational-statistical lower bounds.
...
## 14. [Cohomological Obstructions to Global Counterfactuals: A Sheaf-Theoretic Foundation for Generative Causal Models](https://arxiv.org/abs/2603.17384) <a id="link14"></a>
...
**Comment:** Foundational theory for generative causal models using sheaf-theoretic and topological analysis of global counterfactual consistency.
...
## 15. [Beyond Outliers: A Data-Free Layer-wise Mixed-Precision Quantization Approach Driven by Numerical and Structural Dual-Sensitivity](https://arxiv.org/abs/2603.17354) <a id="link15"></a>
...
**Comment:** Data-free mixed-precision quantization using a dual numerical/structural layer sensitivity metric for bit allocation.
...
## 16. [The Phasor Transformer: Resolving Attention Bottlenecks on the Unit Circle](https://arxiv.org/abs/2603.17433) <a id="link16"></a>
...
**Comment:** Alternative sequence architecture replacing dot-product attention with unit-circle phase states and FFT-based global token mixing.
...
**Comment:** Representation-learning theory for internal noise via variational kernel design and Gaussian Chaos Noise.
...
## 18. [How do LLMs Compute Verbal Confidence](https://arxiv.org/abs/2603.17839) <a id="link18"></a>
...
**Comment:** Mechanistic analysis locating and characterizing cached verbal-confidence representations beyond token log-probabilities in LLMs.
...
## 19. [Gaussian Process Limit Reveals Structural Benefits of Graph Transformers](https://arxiv.org/abs/2603.17569) <a id="link19"></a>
...
**Comment:** Theoretical analysis of graph transformers via infinite-width Gaussian process limits showing structural anti-oversmoothing benefits.
...
## 20. [Q-Drift: Quantization-Aware Drift Correction for Diffusion Model Sampling](https://arxiv.org/abs/2603.18095) <a id="link20"></a>
...
**Comment:** Proposes a principled sampler-side drift correction for post-training quantized diffusion models to counter accumulated quantization noise.
...
## 21. [Automated Grammar-based Algebraic Multigrid Design With Evolutionary Algorithms](https://arxiv.org/abs/2603.17641) <a id="link21"></a>
...
**Comment:** Presents an algorithmic HPC contribution by automatically discovering algebraic multigrid cycles with grammar-guided evolutionary search.
...
## 22. [Learning Coordinate-based Convolutional Kernels for Continuous SE(3) Equivariant and Efficient Point Cloud Analysis](https://arxiv.org/abs/2603.17538) <a id="link22"></a>
...
**Comment:** Introduces an SE(3)-equivariant kernel architecture using coordinate-based convolution kernels on double-coset domains.
...
## 23. [Learning Permutation Distributions via Reflected Diffusion on Ranks](https://arxiv.org/abs/2603.17353) <a id="link23"></a>
...
**Comment:** Proposes a new diffusion formulation for permutations via continuous soft-rank representations and generalized Plackett-Luce denoisers.
...
## 24. [Learning-Augmented Algorithms for $k$-median via Online Learning](https://arxiv.org/abs/2603.18157) <a id="link24"></a>
...
**Comment:** Foundational algorithms/theory: introduces an online-learning model for learning-augmented algorithms and gives guarantees for k-median.
...
## 25. [Stochastic set-valued optimization and its application to robust learning](https://arxiv.org/abs/2603.17691) <a id="link25"></a>
...
**Comment:** Foundational theory: develops stochastic set-valued optimization for robust learning via multi-objective reformulations with tail-sensitive objectives.
...
## 26. [Identifying Latent Actions and Dynamics from Offline Data via Demonstrator Diversity](https://arxiv.org/abs/2603.17577) <a id="link26"></a>
...
**Comment:** Provides identifiability theory for recovering latent actions and dynamics from offline trajectories using demonstrator diversity.
...
## 27. [CoVerRL: Breaking the Consensus Trap in Label-Free Reasoning via Generator-Verifier Co-Evolution](https://arxiv.org/abs/2603.17775) <a id="link27"></a>
...
**Comment:** Addresses representation-learning/training-dynamics via a generator-verifier co-evolution scheme that prevents diversity collapse in label-free reasoning.
...
## 28. [RHYME-XT: A Neural Operator for Spatiotemporal Control Systems](https://arxiv.org/abs/2603.17867) <a id="link28"></a>
...
**Comment:** Introduces a core architecture for neural operators by learning continuous-time flow maps on a projected latent subspace for spatiotemporal systems.
...
## 29. [A Synthesizable RTL Implementation of Predictive Coding Networks](https://arxiv.org/abs/2603.18066) <a id="link29"></a>
...
**Comment:** Systems-level hardware substrate for predictive coding networks implementing local learning dynamics directly in synthesizable RTL.
...
## 30. [Tula: Optimizing Time, Cost, and Generalization in Distributed Large-Batch Training](https://arxiv.org/abs/2603.18112) <a id="link30"></a>
...
**Comment:** Systems method for online optimization of batch size trading off distributed training time, cost, and generalization.
...
## 31. [From Drop-off to Recovery: A Mechanistic Analysis of Segmentation in MLLMs](https://arxiv.org/abs/2603.17228) <a id="link31"></a>
...
**Comment:** Mechanistic representation analysis of where segmentation information is lost and recovered across MLLM components.
...
## 32. [Discovering Decoupled Functional Modules in Large Language Models](https://arxiv.org/abs/2603.17823) <a id="link32"></a>
...
**Comment:** Unsupervised method for discovering decoupled functional modules across LLM layers.
...
## 33. [Fundamental Limits of Neural Network Sparsification: Evidence from Catastrophic Interpretability Collapse](https://arxiv.org/abs/2603.18056) <a id="link33"></a>
...
**Comment:** Empirical study of sparsification showing stable global metrics but catastrophic collapse of local interpretable features.
...
## 34. [Fine-Grained Post-Training Quantization for Large Vision Language Models with Quantization-Aware Integrated Gradients](https://arxiv.org/abs/2603.17809) <a id="link34"></a>
...
**Comment:** Model efficiency: fine-grained post-training quantization using integrated-gradients-based token sensitivity rather than coarse modality-level calibration.
...
## 35. [RAMP: Reinforcement Adaptive Mixed Precision Quantization for Efficient On Device LLM Inference](https://arxiv.org/abs/2603.17891) <a id="link35"></a>
...
**Comment:** Targets model compression with learned per-layer mixed-precision quantization and a new scale-folding preconditioning method.
...
## 36. [Inhibitory normalization of error signals improves learning in neural circuits](https://arxiv.org/abs/2603.17676) <a id="link36"></a>
...
**Comment:** Studies representation and training dynamics by showing that normalization of backpropagated error signals improves learning.
...
## 37. [KANtize: Exploring Low-bit Quantization of Kolmogorov-Arnold Networks for Efficient Inference](https://arxiv.org/abs/2603.17230) <a id="link37"></a>
...
**Comment:** Focuses on efficiency through low-bit quantization of KANs, including quantized spline-table inference for major BitOps reduction.
...
## 38. [Interpretability without actionability: mechanistic methods cannot correct language model errors despite near-perfect internal representations](https://arxiv.org/abs/2603.18353) <a id="link38"></a>
...
**Comment:** Representation analysis: tests whether sparse autoencoder features, probes, and steering can turn latent knowledge into corrected outputs.
...
## 39. [DSS-GAN: Directional State Space GAN with Mamba backbone for Class-Conditional Image Synthesis](https://arxiv.org/abs/2603.17637) <a id="link39"></a>
...
**Comment:** Model architecture: introduces a Mamba-based GAN generator with directional latent routing as a new class-conditioning mechanism.
