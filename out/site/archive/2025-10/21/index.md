<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../20"><img src="../../../assets/nav/day/2025-10-21-prev.svg" alt="Previous Day 2025-10-20"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-10-21-center.svg" alt="Monthly Overview 2025-10"></a></div><div style="width: 33.33%; text-align: right;"><a href="../22"><img src="../../../assets/nav/day/2025-10-21-next.svg" alt="Next Day 2025-10-22"></a></div></div>
...
## 1. [Unbiased Gradient Low-Rank Projection](https://arxiv.org/abs/2510.17802) <a id="link1"></a>
...
## 2. [Improving Model Representation and Reducing KV Cache via Skip Connections with First Value Heads](https://arxiv.org/abs/2510.16807) <a id="link2"></a>
...
## 5. [TeLLMe v2: An Efficient End-to-End Ternary LLM Prefill and Decode Accelerator with Table-Lookup Matmul on Edge FPGAs](https://arxiv.org/abs/2510.15926) <a id="link5"></a>
...
## 6. [Expert Merging in Sparse Mixture of Experts with Nash Bargaining](https://arxiv.org/abs/2510.16138) <a id="link6"></a>
...
## 7. [Sparse Transformer Architectures via Regularized Wasserstein Proximal Operator with $L_1$ Prior](https://arxiv.org/abs/2510.16356) <a id="link7"></a>
...
## 8. [Accelerating Frontier MoE Training with 3D Integrated Optics](https://arxiv.org/abs/2510.15893) <a id="link8"></a>
...
## 9. [AMS-QUANT: Adaptive Mantissa Sharing for Floating-point Quantization](https://arxiv.org/abs/2510.16045) <a id="link9"></a>
...
## 10. [One-Bit Quantization for Random Features Models](https://arxiv.org/abs/2510.16250) <a id="link10"></a>
...
## 11. [Localist LLMs with Recruitment Learning](https://arxiv.org/abs/2510.17358) <a id="link11"></a>
...
## 12. [Understanding and Improving Length Generalization in Hierarchical Sparse Attention Models](https://arxiv.org/abs/2510.17196) <a id="link12"></a>
...
## 13. [Fighter: Unveiling the Graph Convolutional Nature of Transformers in Time Series Modeling](https://arxiv.org/abs/2510.17106) <a id="link13"></a>
...
## 14. [CTR-LoRA: Curvature-Aware and Trust-Region Guided Low-Rank Adaptation for Large Language Models](https://arxiv.org/abs/2510.15962) <a id="link14"></a>
...
## 15. [Glyph: Scaling Context Windows via Visual-Text Compression](https://arxiv.org/abs/2510.17800) <a id="link15"></a>
...
## 16. [Long Exposure: Accelerating Parameter-Efficient Fine-Tuning for LLMs under Shadowy Sparsity](https://arxiv.org/abs/2510.15964) <a id="link16"></a>
...
## 17. [MuonBP: Faster Muon via Block-Periodic Orthogonalization](https://arxiv.org/abs/2510.16981) <a id="link17"></a>
...
## 18. [AMiD: Knowledge Distillation for LLMs with $\alpha$-mixture Assistant Distribution](https://arxiv.org/abs/2510.15982) <a id="link18"></a>
...
## 19. [FlexLink: Boosting your NVLink Bandwidth by 27% without accuracy concern](https://arxiv.org/abs/2510.15882) <a id="link19"></a>
...
## 20. [Compressing Many-Shots in In-Context Learning](https://arxiv.org/abs/2510.16092) <a id="link20"></a>
...
## 21. [Neuronal Group Communication for Efficient Neural representation](https://arxiv.org/abs/2510.16851) <a id="link21"></a>
...
## 22. [Algorithmic Primitives and Compositional Geometry of Reasoning in Language Models](https://arxiv.org/abs/2510.15987) <a id="link22"></a>
...
## 23. [Infinite Neural Operators: Gaussian processes on functions](https://arxiv.org/abs/2510.16675) <a id="link23"></a>
...
## 24. [Convergence Rates for Gradient Descent on the Edge of Stability in Overparametrised Least Squares](https://arxiv.org/abs/2510.17506) <a id="link24"></a>
...
## 25. [Diverse Influence Component Analysis: A Geometric Approach to Nonlinear Mixture Identifiability](https://arxiv.org/abs/2510.17040) <a id="link25"></a>
...
## 26. [SOLE: Hardware-Software Co-design of Softmax and LayerNorm for Efficient Transformer Inference](https://arxiv.org/abs/2510.17189) <a id="link26"></a>
...
## 27. [QSVD: Efficient Low-rank Approximation for Unified Query-Key-Value Weight Compression in Low-Precision Vision-Language Models](https://arxiv.org/abs/2510.16292) <a id="link27"></a>
...
## 28. [ZSPAPrune: Zero-Shot Prompt-Aware Token Pruning for Vision-Language Models](https://arxiv.org/abs/2510.17197) <a id="link28"></a>
...
## 29. [Bitwidth-Specific Logarithmic Arithmetic for Future Hardware-Accelerated Training](https://arxiv.org/abs/2510.17058) <a id="link29"></a>
...
## 30. [Symmetry and Generalisation in Neural Approximations of Renormalisation Transformations](https://arxiv.org/abs/2510.16591) <a id="link30"></a>
...
## 31. [Just-In-Time Piecewise-Linear Semantics for ReLU-type Networks](https://arxiv.org/abs/2510.17622) <a id="link31"></a>
...
## 32. [Asymptotically Stable Quaternion-valued Hopfield-structured Neural Network with Periodic Projection-based Supervised Learning Rules](https://arxiv.org/abs/2510.16607) <a id="link32"></a>
...
## 33. [Deeper with Riemannian Geometry: Overcoming Oversmoothing and Oversquashing for Graph Foundation Models](https://arxiv.org/abs/2510.17457) <a id="link33"></a>
...
## 34. [On the Impossibility of Retrain Equivalence in Machine Unlearning](https://arxiv.org/abs/2510.16629) <a id="link34"></a>
...
## 35. [How Does Label Noise Gradient Descent Improve Generalization in the Low SNR Regime?](https://arxiv.org/abs/2510.17526) <a id="link35"></a>
...
## 37. [Computational Budget Should Be Considered in Data Selection](https://arxiv.org/abs/2510.16806) <a id="link37"></a>
...
## 38. [Atlas-based Manifold Representations for Interpretable Riemannian Machine Learning](https://arxiv.org/abs/2510.17772) <a id="link38"></a>
...
## 39. [All You Need is One: Capsule Prompt Tuning with a Single Vector](https://arxiv.org/abs/2510.16670) <a id="link39"></a>
...
## 40. [Zeroth-Order Sharpness-Aware Learning with Exponential Tilting](https://arxiv.org/abs/2510.16157) <a id="link40"></a>
...
## 41. [MUG-V 10B: High-efficiency Training Pipeline for Large Video Generation Models](https://arxiv.org/abs/2510.17519) <a id="link41"></a>
...
## 42. [NeurIPT: Foundation Model for Neural Interfaces](https://arxiv.org/abs/2510.16548) <a id="link42"></a>
...
## 44. [Recurrent Attention-based Token Selection for Efficient Streaming Video-LLMs](https://arxiv.org/abs/2510.17364) <a id="link44"></a>
...
## 45. [Kelle: Co-design KV Caching and eDRAM for Efficient LLM Serving in Edge Computing](https://arxiv.org/abs/2510.16040) <a id="link45"></a>
...
## 46. [Early-stopping for Transformer model training](https://arxiv.org/abs/2510.16074) <a id="link46"></a>
...
## 47. [ZACH-ViT: A Zero-Token Vision Transformer with ShuffleStrides Data Augmentation for Robust Lung Ultrasound Classification](https://arxiv.org/abs/2510.17650) <a id="link47"></a>
...
## 48. [Facts in Stats: Impacts of Pretraining Diversity on Language Model Generalization](https://arxiv.org/abs/2510.16096) <a id="link48"></a>
...
## 49. [Breaking Memorization Barriers in LLM Code Fine-Tuning via Information Bottleneck for Improved Generalization](https://arxiv.org/abs/2510.16022) <a id="link49"></a>
...
## 50. [Memorizing Long-tail Data Can Help Generalization Through Composition](https://arxiv.org/abs/2510.16322) <a id="link50"></a>
...
## 51. [Protein Folding with Neural Ordinary Differential Equations](https://arxiv.org/abs/2510.16253) <a id="link51"></a>
...
## 52. [Bridging Symmetry and Robustness: On the Role of Equivariance in Enhancing Adversarial Robustness](https://arxiv.org/abs/2510.16171) <a id="link52"></a>
...
## 53. [DFNN: A Deep Fr\'echet Neural Network Framework for Learning Metric-Space-Valued Responses](https://arxiv.org/abs/2510.17072) <a id="link53"></a>
...
## 54. [Local properties of neural networks through the lens of layer-wise Hessians](https://arxiv.org/abs/2510.17486) <a id="link54"></a>
...
## 55. [Vector Quantization in the Brain: Grid-like Codes in World Models](https://arxiv.org/abs/2510.16039) <a id="link55"></a>
...
## 56. [Mapping Post-Training Forgetting in Language Models at Scale](https://arxiv.org/abs/2510.17776) <a id="link56"></a>
