<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../26"><img src="../../../assets/nav/day/2026-02-27-prev.svg" alt="Previous Day 2026-02-26"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-27-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../28"><img src="../../../assets/nav/day/2026-02-27-next.svg" alt="Next Day 2026-02-28"></a></div></div>
...
## 2. [PRAC: Principal-Random Subspace for LLM Activation Compression and Memory-Efficient Training](https://arxiv.org/abs/2602.23111) <a id="link2"></a>
...
## 3. [pQuant: Towards Effective Low-Bit Language Models via Decoupled Linear Quantization-Aware Training](https://arxiv.org/abs/2602.22592) <a id="link3"></a>
...
## 4. [S2O: Early Stopping for Sparse Attention via Online Permutation](https://arxiv.org/abs/2602.22575) <a id="link4"></a>
...
## 5. [InnerQ: Hardware-aware Tuning-free Quantization of KV Cache for Large Language Models](https://arxiv.org/abs/2602.23200) <a id="link5"></a>
...
## 6. [FlashOptim: Optimizers for Memory Efficient Training](https://arxiv.org/abs/2602.23349) <a id="link6"></a>
...
## 7. [Learning Tangent Bundles and Characteristic Classes with Autoencoder Atlases](https://arxiv.org/abs/2602.22873) <a id="link7"></a>
...
## 8. [Modality Collapse as Mismatched Decoding: Information-Theoretic Limits of Multimodal LLMs](https://arxiv.org/abs/2602.23136) <a id="link8"></a>
...
## 9. [Residual Koopman Spectral Profiling for Predicting and Preventing Transformer Training Instability](https://arxiv.org/abs/2602.22988) <a id="link9"></a>
...
## 10. [Accelerating LLM Pre-Training through Flat-Direction Dynamics Enhancement](https://arxiv.org/abs/2602.22681) <a id="link10"></a>
...
## 11. [veScale-FSDP: Flexible and High-Performance FSDP at Scale](https://arxiv.org/abs/2602.22437) <a id="link11"></a>
...
## 12. [Vectorizing the Trie: Efficient Constrained Decoding for LLM-based Generative Retrieval on Accelerators](https://arxiv.org/abs/2602.22647) <a id="link12"></a>
...
## 13. [Beyond NNGP: Large Deviations and Feature Learning in Bayesian Neural Networks](https://arxiv.org/abs/2602.22925) <a id="link13"></a>
...
## 14. [SideQuest: Model-Driven KV Cache Management for Long-Horizon Agentic Reasoning](https://arxiv.org/abs/2602.22603) <a id="link14"></a>
...
## 15. [Support Tokens, Stability Margins, and a New Foundation for Robust LLMs](https://arxiv.org/abs/2602.22271) <a id="link15"></a>
...
## 16. [Why Diffusion Language Models Struggle with Truly Parallel (Non-Autoregressive) Decoding?](https://arxiv.org/abs/2602.23225) <a id="link16"></a>
...
## 17. [A 1/R Law for Kurtosis Contrast in Balanced Mixtures](https://arxiv.org/abs/2602.22334) <a id="link17"></a>
...
## 18. [NoRA: Breaking the Linear Ceiling of Low-Rank Adaptation via Manifold Expansion](https://arxiv.org/abs/2602.22911) <a id="link18"></a>
...
## 19. [Affine-Scaled Attention: Towards Flexible and Stable Transformer Attention](https://arxiv.org/abs/2602.23057) <a id="link19"></a>
...
## 20. [AutoQRA: Joint Optimization of Mixed-Precision Quantization and Low-rank Adapters for Efficient LLM Fine-Tuning](https://arxiv.org/abs/2602.22268) <a id="link20"></a>
...
## 21. [Learning Physical Operators using Neural Operators](https://arxiv.org/abs/2602.23113) <a id="link21"></a>
...
## 22. [Fine-Tuning Without Forgetting In-Context Learning: A Theoretical Analysis of Linear Attention Models](https://arxiv.org/abs/2602.23197) <a id="link22"></a>
...
## 23. [RAIN-Merging: A Gradient-Free Method to Enhance Instruction Following in Large Reasoning Models with Preserved Thinking Format](https://arxiv.org/abs/2602.22538) <a id="link23"></a>
...
## 24. [Efficient Encoder-Free Fourier-based 3D Large Multimodal Model](https://arxiv.org/abs/2602.23153) <a id="link24"></a>
...
## 25. [Latent Matters: Learning Deep State-Space Models](https://arxiv.org/abs/2602.23050) <a id="link25"></a>
...
## 26. [Disentangling Shared and Target-Enriched Topics via Background-Contrastive Non-negative Matrix Factorization](https://arxiv.org/abs/2602.22387) <a id="link26"></a>
...
## 27. [Differentiable Zero-One Loss via Hypersimplex Projections](https://arxiv.org/abs/2602.23336) <a id="link27"></a>
...
## 28. [IBCircuit: Towards Holistic Circuit Discovery with Information Bottleneck](https://arxiv.org/abs/2602.22581) <a id="link28"></a>
...
## 29. [Orthogonal Weight Modification Enhances Learning Scalability and Convergence Efficiency without Gradient Backpropagation](https://arxiv.org/abs/2602.22259) <a id="link29"></a>
...
## 30. [Takeuchi's Information Criteria as Generalization Measures for DNNs Close to NTK Regime](https://arxiv.org/abs/2602.23219) <a id="link30"></a>
...
## 31. [Interpreting and Steering State-Space Models via Activation Subspace Bottlenecks](https://arxiv.org/abs/2602.22719) <a id="link31"></a>
...
## 32. [Causality $\neq$ Invariance: Function and Concept Vectors in LLMs](https://arxiv.org/abs/2602.22424) <a id="link32"></a>
...
## 33. [WaveSSM: Multiscale State-Space Models for Non-stationary Signal Attention](https://arxiv.org/abs/2602.22266) <a id="link33"></a>
...
## 34. [LLMServingSim 2.0: A Unified Simulator for Heterogeneous and Disaggregated LLM Serving Infrastructure](https://arxiv.org/abs/2602.23036) <a id="link34"></a>
...
## 35. [Generalization Bounds of Stochastic Gradient Descent in Homogeneous Neural Networks](https://arxiv.org/abs/2602.22936) <a id="link35"></a>
...
## 36. [pMoE: Prompting Diverse Experts Together Wins More in Visual Adaptation](https://arxiv.org/abs/2602.22938) <a id="link36"></a>
...
## 37. [Model Agreement via Anchoring](https://arxiv.org/abs/2602.23360) <a id="link37"></a>
...
## 38. [LUMOS: Democratizing SciML Workflows with L0-Regularized Learning for Unified Feature and Parameter Adaptation](https://arxiv.org/abs/2602.22537) <a id="link38"></a>
...
## 39. [GetBatch: Distributed Multi-Object Retrieval for ML Data Loading](https://arxiv.org/abs/2602.22434) <a id="link39"></a>
...
## 40. [GRAU: Generic Reconfigurable Activation Unit Design for Neural Network Hardware Accelerators](https://arxiv.org/abs/2602.22352) <a id="link40"></a>
