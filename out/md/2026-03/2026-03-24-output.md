> This is a remedial run for missed papers from 03/23/2026 to 03/23/2026.
> 
> Results generated on 03/26/2026.

# Personalized Daily ArXiv Papers 2026-03-24

| *[gpt-5.4]*   | Prompt   | Completion   | Total   |
|:-------------:|:--------:|:------------:|:-------:|
| **Token**     | 138301   | 5418         | 143719  |
| **Cost**      | $0.35    | $0.08        | $0.43   |

**Table of contents with paper titles:**

1. [Holistic Scaling Laws for Optimal Mixture-of-Experts Architecture Optimization](#user-content-link1)
**Authors:** Weilin Wan, Jingtao Han, Weizhong Zhang, Cheng Jin

2. [Quotient Geometry, Effective Curvature, and Implicit Bias in Simple Shallow Neural Networks](#user-content-link2)
**Authors:** Hang-Cheng Dong, Pengcheng Cheng

3. [Sparse but Critical: A Token-Level Analysis of Distributional Shifts in RLVR Fine-Tuning of LLMs](#user-content-link3)
**Authors:** Haoming Meng, Kexin Huang, Shaohang Wei, Chiyu Ma, Shuo Yang, Xue Wang, Guoyin Wang, Bolin Ding, Jingren Zhou

4. [Thinking Deeper, Not Longer: Depth-Recurrent Transformers for Compositional Generalization](#user-content-link4)
**Authors:** Hung-Hsuan Chen

5. [Functional Component Ablation Reveals Specialization Patterns in Hybrid Language Model Architectures](#user-content-link5)
**Authors:** Hector Borobia, Elies Seguí-Mas, Guillermina Tormo-Carbó

6. [Decoupling Exploration and Policy Optimization: Uncertainty Guided Tree Search for Hard Exploration](#user-content-link6)
**Authors:** Zakaria Mhammedi, James Cohan

7. [FAAR: Format-Aware Adaptive Rounding for NVFP4](#user-content-link7)
**Authors:** Hanglin Li, Shuchang Tian, Chen Lin, Zhiyong Zhao, Kun Zhan

8. [WorldCache: Content-Aware Caching for Accelerated Video World Models](#user-content-link8)
**Authors:** Umair Nawaz, Ahmed Heakl, Ufaq Khan, Abdelrahman Shaker, Salman Khan, Fahad Shahbaz Khan

9. [Scaling DoRA: High-Rank Adaptation via Factored Norms and Fused Kernels](#user-content-link9)
**Authors:** Alexandra Zelenin, Alexandra Zhuravlyova

10. [Data-Free Layer-Adaptive Merging via Fisher Information for Long-to-Short Reasoning LLMs](#user-content-link10)
**Authors:** Tian Xia

11. [INTRYGUE: Induction-Aware Entropy Gating for Reliable RAG Uncertainty Estimation](#user-content-link11)
**Authors:** Alexandra Bazarova, Andrei Volodichev, Daria Kotova, Alexey Zaytsev

12. [PRISM: Breaking the O(n) Memory Wall in Long-Context LLM Inference via O(1) Photonic Block Selection](#user-content-link12)
**Authors:** Hyoseok Park, Yeonsang Park

13. [On the Direction of RLVR Updates for LLM Reasoning: Identification and Exploitation](#user-content-link13)
...
14. [End-to-End Training for Unified Tokenization and Latent Denoising](#user-content-link14)
...
15. [DSPA: Dynamic SAE Steering for Data-Efficient Preference Alignment](#user-content-link15)
**Authors:** James Wedgwood, Aashiq Muhamed, Mona T. Diab, Virginia Smith

16. [MCLR: Improving Conditional Modeling in Visual Generative Models via Inter-Class Likelihood-Ratio Maximization and Establishing the Equivalence between Classifier-Free Guidance and Alignment Objectives](#user-content-link16)
**Authors:** Xiang Li, Yixuan Jia, Xiao Li, Jeffrey A. Fessler, Rongrong Wang, Qing Qu

17. [Confidence-Based Decoding is Provably Efficient for Diffusion Language Models](#user-content-link17)
**Authors:** Changxiao Cai, Gen Li

18. [Causal Evidence that Language Models use Confidence to Drive Behavior](#user-content-link18)
**Authors:** Dharshan Kumaran, Nathaniel Daw, Simon Osindero, Petar Velickovic, Viorica Patraucean

19. [Proximal Policy Optimization in Path Space: A Schrödinger Bridge Perspective](#user-content-link19)
**Authors:** Yuehu Gong, Zeyuan Wang, Yulin Chen, Yanwei Fu

20. [The Golden Subspace: Where Efficiency Meets Generalization in Continual Test-Time Adaptation](#user-content-link20)
**Authors:** Guannan Lai, Da-Wei Zhou, Zhenguo Li, Han-Jia Ye

21. [Overfitting and Generalizing with (PAC) Bayesian Prediction in Noisy Binary Classification](#user-content-link21)
**Authors:** Xiaohan Zhu, Mesrob I. Ohannessian, Nathan Srebro

22. [Bridging the Know-Act Gap via Task-Level Autoregressive Reasoning](#user-content-link22)
...
23. [Cognitive Training for Language Models: Towards General Capabilities via Cross-Entropy Games](#user-content-link23)
**Authors:** Clément Hongler, Franck Gabriel, Valentin Hartmann, Arthur Renard, Andrew Emil

24. [Show Me What You Don't Know: Efficient Sampling from Invariant Sets for Model Validation](#user-content-link24)
**Authors:** Armand Rousselot, Joran Wendebourg, Ullrich Köthe

25. [Kolmogorov Complexity Bounds for LLM Steganography and a Perplexity-Based Detection Proxy](#user-content-link25)
**Authors:** Andrii Shportko

26. [Toward a Theory of Hierarchical Memory for Language Agents](#user-content-link26)
**Authors:** Yashar Talebirad, Ali Parsaee, Csongor Y. Szepesvari, Amirhossein Nadiri, Osmar Zaiane

27. [mSFT: Addressing Dataset Mixtures Overfitting Heterogeneously in Multi-task SFT](#user-content-link27)
**Authors:** Woosung Koh, Jeyoung Jeon, Youngjin Song, Yujin Cheon, Soowon Oh, Jaehyeong Choi, Se-Young Yun

28. [The Dual Mechanisms of Spatial Reasoning in Vision-Language Models](#user-content-link28)
**Authors:** Kelly Cui, Nikhil Prakash, Ayush Raina, David Bau, Antonio Torralba, Tamar Rott Shaham

29. [Language Models Can Explain Visual Features via Steering](#user-content-link29)
...
30. [Sharper Generalization Bounds for Transformer](#user-content-link30)
**Authors:** Yawen Li, Tao Hu, Zhouhui Lian, Wan Tian, Yijie Peng, Huiming Zhang, Zhongyi Li

31. [Rethinking Token Reduction for Large Vision-Language Models](#user-content-link31)
**Authors:** Yi Wang, Haofei Zhang, Qihan Huang, Anda Cao, Gongfan Fang, Wei Wang, Xuan Jin, Jie Song, Mingli Song, Xinchao Wang

32. [What Do World Models Learn in RL? Probing Latent Representations in Learned Environment Simulators](#user-content-link32)
**Authors:** Xinyu Zhang

33. [CurvZO: Adaptive Curvature-Guided Sparse Zeroth-Order Optimization for Efficient LLM Fine-Tuning](#user-content-link33)
**Authors:** Shuo Wang, Ziyu Chen, Ming Tang

34. [λ-GELU: Learning Gating Hardness for Controlled ReLU-ization in Deep Networks](#user-content-link34)
**Authors:** Cristian Pérez-Corral, Alberto Fernández-Hernández, Jose I. Mestre, Manuel F. Dolz, Enrique S. Quintana-Ortí

35. [A Comparative Analysis of LLM Memorization at Statistical and Internal Levels: Cross-Model Commonalities and Model-Specific Signatures](#user-content-link35)
**Authors:** Bowen Chen, Namgi Han, Yusuke Miyao

36. [On the Interplay of Priors and Overparametrization in Bayesian Neural Network Posteriors](#user-content-link36)
**Authors:** Julius Kobialka, Emanuel Sommer, Chris Kolb, Juntae Kwon, Daniel Dold, David Rügamer

37. [Not All Layers Are Created Equal: Adaptive LoRA Ranks for Personalized Image Generation](#user-content-link37)
**Authors:** Donald Shenaj, Federico Errica, Antonio Carta

38. [Three Creates All: You Only Sample 3 Steps](#user-content-link38)
**Authors:** Yuren Cai, Guangyi Wang, Zongqing Li, Li Li, Zhihui Liu, Songzhi Su

39. [Learning Can Converge Stably to the Wrong Belief under Latent Reliability](#user-content-link39)
**Authors:** Zhipeng Zhang, Zhenjie Yao, Kai Li, Lei Yang

40. [Tiny Inference-Time Scaling with Latent Verifiers](#user-content-link40)
**Authors:** Davide Bucciarelli, Evelyn Turri, Lorenzo Baraldi, Marcella Cornia, Lorenzo Baraldi, Rita Cucchiara

41. [Counterfactual Credit Policy Optimization for Multi-Agent Collaboration](#user-content-link41)
**Authors:** Zhongyi Li, Wan Tian, Yikun Ban, Jinju Chen, Huiming Zhang, Yang Liu, Fuzhen Zhuang

42. [Adaptive Robust Estimator for Multi-Agent Reinforcement Learning](#user-content-link42)
...
43. [LipsAM: Lipschitz-Continuous Amplitude Modifier for Audio Signal Processing and its Application to Plug-and-Play Dereverberation](#user-content-link43)
**Authors:** Kazuki Matsumoto, Ren Uchida, Kohei Yatabe

44. [A Theoretical Framework for Energy-Aware Gradient Pruning in Federated Learning](#user-content-link44)
**Authors:** Emmanouil M. Athanasakos

45. [Chimera: Latency- and Performance-Aware Multi-agent Serving for Heterogeneous LLMs](#user-content-link45)
**Authors:** Kangqi Ni, Wenyue Hua, Xiaoxiang Shi, Jiang Guo, Shiyu Chang, Tianlong Chen

---

## 1. [Holistic Scaling Laws for Optimal Mixture-of-Experts Architecture Optimization](https://arxiv.org/abs/2603.21862) <a id="link1"></a>
...
**Comment:** MoE architecture mechanism: derives holistic scaling laws and fairness constraints to map compute budgets to optimal MoE configurations.
...
## 2. [Quotient Geometry, Effective Curvature, and Implicit Bias in Simple Shallow Neural Networks](https://arxiv.org/abs/2603.21502) <a id="link2"></a>
...
**Comment:** Representation learning theory: develops quotient-space geometry to remove parameter symmetries and analyze intrinsic curvature and implicit bias.
...
## 3. [Sparse but Critical: A Token-Level Analysis of Distributional Shifts in RLVR Fine-Tuning of LLMs](https://arxiv.org/abs/2603.22446) <a id="link3"></a>
...
**Comment:** Training dynamics: token-level analysis shows RLVR gains come from sparse critical distribution shifts and tests targeted interventions.
...
## 4. [Thinking Deeper, Not Longer: Depth-Recurrent Transformers for Compositional Generalization](https://arxiv.org/abs/2603.21676) <a id="link4"></a>
...
**Comment:** Architectural mechanism for depth-recurrent transformers that decouple parameter count from inference-time reasoning depth, with explicit stability design.
...
## 5. [Functional Component Ablation Reveals Specialization Patterns in Hybrid Language Model Architectures](https://arxiv.org/abs/2603.22473) <a id="link5"></a>
...
**Comment:** Functional ablation study of hybrid attention-SSM/linear-attention LMs revealing component specialization, positional importance, and redundancy patterns.
...
## 6. [Decoupling Exploration and Policy Optimization: Uncertainty Guided Tree Search for Hard Exploration](https://arxiv.org/abs/2603.22273) <a id="link6"></a>
...
**Comment:** New training paradigm that decouples exploration from policy optimization using uncertainty-guided tree search for hard exploration.
...
## 7. [FAAR: Format-Aware Adaptive Rounding for NVFP4](https://arxiv.org/abs/2603.22370) <a id="link7"></a>
...
**Comment:** Compression and efficient inference: introduces NVFP4-specific adaptive rounding and format-aligned fine-tuning for ultra-low-bit quantization.
...
## 8. [WorldCache: Content-Aware Caching for Accelerated Video World Models](https://arxiv.org/abs/2603.22286) <a id="link8"></a>
...
**Comment:** Content-aware activation caching for diffusion transformers with motion-adaptive reuse and warping, targeting efficient inference without retraining.
...
## 9. [Scaling DoRA: High-Rank Adaptation via Factored Norms and Fused Kernels](https://arxiv.org/abs/2603.22276) <a id="link9"></a>
...
**Comment:** Compression and efficient inference: introduces a memory-saving factored norm and fused kernels that make high-rank DoRA feasible without materializing dense BA products.
...
## 10. [Data-Free Layer-Adaptive Merging via Fisher Information for Long-to-Short Reasoning LLMs](https://arxiv.org/abs/2603.21705) <a id="link10"></a>
...
**Comment:** Training dynamics and model merging: gives a Fisher/Hessian-based theory for layer-adaptive merging and a data-free merging method.
...
## 11. [INTRYGUE: Induction-Aware Entropy Gating for Reliable RAG Uncertainty Estimation](https://arxiv.org/abs/2603.21607) <a id="link11"></a>
...
**Comment:** Mechanistic understanding: identifies an induction-head/entropy-neuron interaction in RAG and uses it for uncertainty gating.
...
## 12. [PRISM: Breaking the O(n) Memory Wall in Long-Context LLM Inference via O(1) Photonic Block Selection](https://arxiv.org/abs/2603.21576) <a id="link12"></a>
...
**Comment:** Memory-efficient inference systems: targets the KV-cache memory wall with O(1) photonic block selection for long-context decoding.
...
## 13. [On the Direction of RLVR Updates for LLM Reasoning: Identification and Exploitation](https://arxiv.org/abs/2603.22117) <a id="link13"></a>
...
**Comment:** Training-dynamics study identifying the direction of RLVR-induced log-probability updates as the key sparse signal, with test-time and training-time exploitation.
...
## 14. [End-to-End Training for Unified Tokenization and Latent Denoising](https://arxiv.org/abs/2603.22283) <a id="link14"></a>
...
**Comment:** Unified single-stage training of tokenizer and latent denoiser via shared generative encoder, directly changing latent-model training structure.
...
## 15. [DSPA: Dynamic SAE Steering for Data-Efficient Preference Alignment](https://arxiv.org/abs/2603.21461) <a id="link15"></a>
...
**Comment:** Data-efficient preference alignment via prompt-conditional SAE steering at inference time, offering mechanistic control without weight updates.
...
## 16. [MCLR: Improving Conditional Modeling in Visual Generative Models via Inter-Class Likelihood-Ratio Maximization and Establishing the Equivalence between Classifier-Free Guidance and Alignment Objectives](https://arxiv.org/abs/2603.22364) <a id="link16"></a>
...
**Comment:** Theoretical result equating classifier-free guidance with a likelihood-ratio alignment objective, giving a mechanistic account of conditional diffusion guidance.
...
## 17. [Confidence-Based Decoding is Provably Efficient for Diffusion Language Models](https://arxiv.org/abs/2603.22248) <a id="link17"></a>
...
**Comment:** First efficiency theory for confidence-based decoding in diffusion language models, linking expected iterations to target entropy.
...
## 18. [Causal Evidence that Language Models use Confidence to Drive Behavior](https://arxiv.org/abs/2603.22161) <a id="link18"></a>
...
**Comment:** Mechanistic evidence for an internal confidence representation causally steering LLM abstention behavior fits representation structure and model behavior analysis.
...
## 19. [Proximal Policy Optimization in Path Space: A Schrödinger Bridge Perspective](https://arxiv.org/abs/2603.21621) <a id="link19"></a>
...
**Comment:** Reformulating PPO in path space for diffusion/flow policies is a foundational training-objective contribution for generative policies.
...
## 20. [The Golden Subspace: Where Efficiency Meets Generalization in Continual Test-Time Adaptation](https://arxiv.org/abs/2603.21928) <a id="link20"></a>
...
**Comment:** Representation-structure result identifying a minimal adaptation subspace and linking it to classifier row space, with AGOP as an online estimator.
...
## 21. [Overfitting and Generalizing with (PAC) Bayesian Prediction in Noisy Binary Classification](https://arxiv.org/abs/2603.22644) <a id="link21"></a>
...
**Comment:** Theory of PAC-Bayesian prediction characterizing when Bayesian-style under-regularization overfits and when larger lambda yields vanishing excess risk.
...
## 22. [Bridging the Know-Act Gap via Task-Level Autoregressive Reasoning](https://arxiv.org/abs/2603.22619) <a id="link22"></a>
...
**Comment:** Architecture/training paper diagnosing the know-act gap as token-level autoregression entangling task selection with generation, then proposing task-level autoregressive reasoning.
...
## 23. [Cognitive Training for Language Models: Towards General Capabilities via Cross-Entropy Games](https://arxiv.org/abs/2603.22479) <a id="link23"></a>
...
**Comment:** Curriculum/meta-training proposal for skill discovery via cross-entropy games, directly targeting training dynamics and learning mechanisms.
...
## 24. [Show Me What You Don't Know: Efficient Sampling from Invariant Sets for Model Validation](https://arxiv.org/abs/2603.21782) <a id="link24"></a>
...
**Comment:** Representation learning theory and structure: training-free sampling from feature-invariance fibers gives a mechanistic probe of what representations preserve or discard.
...
## 25. [Kolmogorov Complexity Bounds for LLM Steganography and a Perplexity-Based Detection Proxy](https://arxiv.org/abs/2603.21567) <a id="link25"></a>
...
**Comment:** Representation/theory: gives an information-theoretic complexity bound for LLM steganography and connects it to a practical perplexity-based detection proxy.
...
## 26. [Toward a Theory of Hierarchical Memory for Language Agents](https://arxiv.org/abs/2603.21564) <a id="link26"></a>
...
**Comment:** Memory architecture theory: formalizes hierarchical memory for language agents via extraction, coarsening, and traversal operators.
...
## 27. [mSFT: Addressing Dataset Mixtures Overfitting Heterogeneously in Multi-task SFT](https://arxiv.org/abs/2603.21606) <a id="link27"></a>
...
**Comment:** Training dynamics: studies heterogeneous overfitting across dataset mixtures and proposes an iterative checkpoint-reverting multi-task SFT algorithm.
...
## 28. [The Dual Mechanisms of Spatial Reasoning in Vision-Language Models](https://arxiv.org/abs/2603.22278) <a id="link28"></a>
...
**Comment:** Mechanistic analysis of where spatial reasoning is represented inside VLMs, separating vision-encoder versus LM-backbone contributions.
...
## 29. [Language Models Can Explain Visual Features via Steering](https://arxiv.org/abs/2603.22593) <a id="link29"></a>
...
**Comment:** Automated interpretability method using causal steering of SAE vision features to elicit language explanations of learned visual concepts.
...
## 30. [Sharper Generalization Bounds for Transformer](https://arxiv.org/abs/2603.21541) <a id="link30"></a>
...
**Comment:** Theory paper deriving architecture-dependent generalization bounds for Transformers using offset Rademacher complexity and covering-number analysis.
...
## 31. [Rethinking Token Reduction for Large Vision-Language Models](https://arxiv.org/abs/2603.21701) <a id="link31"></a>
...
**Comment:** Learned prompt-agnostic token compression framework for LVLMs that unifies pruning and merging as a trainable compression mapping.
...
## 32. [What Do World Models Learn in RL? Probing Latent Representations in Learned Environment Simulators](https://arxiv.org/abs/2603.21546) <a id="link32"></a>
...
**Comment:** Interpretability study of world models showing linearly decodable state variables and causal use of latent directions across two architectures.
...
## 33. [CurvZO: Adaptive Curvature-Guided Sparse Zeroth-Order Optimization for Efficient LLM Fine-Tuning](https://arxiv.org/abs/2603.21725) <a id="link33"></a>
...
**Comment:** Memory-efficient fine-tuning method using curvature-guided sparse zeroth-order updates with adaptive coordinate selection from scalar feedback.
...
## 34. [λ-GELU: Learning Gating Hardness for Controlled ReLU-ization in Deep Networks](https://arxiv.org/abs/2603.21991) <a id="link34"></a>
...
**Comment:** Activation-design paper introducing learnable GELU hardness to study and control progressive ReLU-ization of deep networks.
...
## 35. [A Comparative Analysis of LLM Memorization at Statistical and Internal Levels: Cross-Model Commonalities and Model-Specific Signatures](https://arxiv.org/abs/2603.21658) <a id="link35"></a>
...
**Comment:** Cross-model mechanistic analysis of memorization, including shared decoding patterns and family-specific important attention heads.
...
## 36. [On the Interplay of Priors and Overparametrization in Bayesian Neural Network Posteriors](https://arxiv.org/abs/2603.22030) <a id="link36"></a>
...
**Comment:** Representation-learning theory/structure: analyzes how priors and overparameterization reshape Bayesian neural network posterior geometry via balancedness, weight reallocation, and prior conformity.
...
## 37. [Not All Layers Are Created Equal: Adaptive LoRA Ranks for Personalized Image Generation](https://arxiv.org/abs/2603.21884) <a id="link37"></a>
...
**Comment:** Adaptive per-layer LoRA rank selection directly targets compression/parameter-efficiency rather than using a fixed rank everywhere.
...
## 38. [Three Creates All: You Only Sample 3 Steps](https://arxiv.org/abs/2603.22375) <a id="link38"></a>
...
**Comment:** Few-step diffusion acceleration via layer-wise time-embedding optimization is a concrete efficient-inference mechanism with architectural insight.
...
## 39. [Learning Can Converge Stably to the Wrong Belief under Latent Reliability](https://arxiv.org/abs/2603.21491) <a id="link39"></a>
...
**Comment:** Training-dynamics paper on latent feedback reliability: uses trajectory-level signals and a slow trust variable to prevent stable convergence to wrong beliefs.
...
## 40. [Tiny Inference-Time Scaling with Latent Verifiers](https://arxiv.org/abs/2603.22492) <a id="link40"></a>
...
**Comment:** Efficient inference method: verifier operates directly on diffusion hidden states, avoiding decode/re-encode overhead in test-time scaling.
...
## 41. [Counterfactual Credit Policy Optimization for Multi-Agent Collaboration](https://arxiv.org/abs/2603.21563) <a id="link41"></a>
...
**Comment:** Multi-agent training-dynamics method for credit assignment: counterfactual agent-specific advantages reduce free-riding in collaborative LLM RL.
...
## 42. [Adaptive Robust Estimator for Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2603.21574) <a id="link42"></a>
...
**Comment:** Architecture mechanisms and training dynamics: introduces an adaptive robust estimator for noisy, heavy-tailed reward signals in multi-agent RL, directly targeting training stability and credit assignment.
...
## 43. [LipsAM: Lipschitz-Continuous Amplitude Modifier for Audio Signal Processing and its Application to Plug-and-Play Dereverberation](https://arxiv.org/abs/2603.21684) <a id="link43"></a>
...
**Comment:** Architecture mechanisms and training stability: provides a Lipschitz-continuous amplitude-modifier design with formal conditions for certified stable audio models.
...
## 44. [A Theoretical Framework for Energy-Aware Gradient Pruning in Federated Learning](https://arxiv.org/abs/2603.22465) <a id="link44"></a>
...
**Comment:** Compression and efficient training: proposes energy-aware gradient pruning with a cost-weighted selection rule grounded in a constrained projection formulation.
...
## 45. [Chimera: Latency- and Performance-Aware Multi-agent Serving for Heterogeneous LLMs](https://arxiv.org/abs/2603.22206) <a id="link45"></a>
...
**Comment:** Large-scale serving systems: predictive scheduling for heterogeneous LLM clusters using semantic routing, output-length prediction, and congestion-aware load balancing.
