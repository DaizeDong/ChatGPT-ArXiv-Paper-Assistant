...
<sub>Token counts are not reported for this run. 7 of 10 model calls succeeded, 4,110s of model wall clock.</sub>
...
2. [SeFoRA: Sketch-Aggregated Federated Low-Rank Adaptation with Heterogeneous Client Ranks](#paper-2608-10144)
**Authors:** Yue Xia, Tayyebeh Jahani-Nezhad, Mayank Bakshi, Rawad Bitar

3. [FedA2L: Adaptive layer-wise learning rate adjustment in decentralized federated learning](#paper-2608-09208)
**Authors:** Van Truong Vo, Khoa Nguyen, Taehong Kim

4. [Distributed Optimization with Streaming Data: A Temporal Weighting Perspective](#paper-2608-09565)
**Authors:** Muhammad Faraz Ul Abrar, NicolÃ² Michelusi, Erik G. Larsson

5. [FEAST: Federated Shared-Space Training for Resource-Heterogeneous Clients](#paper-2608-09250)
**Authors:** Bostan Khan, Masoud Daneshtalab

## [Architecture and Training Dynamics](#topic-architecture-training) (18)

1. [Generalized Convexity and Smoothness via Conjugate Duality: Optimization Theory for Deep Neural Networks](#paper-2608-09523)
**Authors:** Binchuan Qi
...
3. [MixFormer: Linear Transformer with Mixture of Memory Experts](#paper-2608-09468)
**Authors:** Yu Guo, Lei Duan

4. [The Matching Principle: When Does a Training Penalty Cover Deployment Shift?](#paper-2605-22800)
**Authors:** Vishal Rajput

5. [ZetaGPT: A Reference Implementation of Positional--Encoding--Free State--Space--Attention Language Models](#paper-2608-09432)
**Authors:** RÃ³isÃ­n Luo

6. [GradCuit: Credit-Assigned Gradient Flow Enables Robust and Interpretable Test-Time Latent Reasoning](#paper-2608-02585)
**Authors:** Zhaoxin Yu, Qi Shen, Hengli Li, Zhaowei Zhang, Song-Chun Zhu, Chi Zhang, Zilong Zheng

7. [BDH-CQ: In-Context Learning with Recurrent Latent Reasoning](#paper-2608-09888)
...
8. [Dynamic gain neuromodulation attenuates the stability gap under joint training](#paper-2507-14056)
...
10. [A Tight Lower Bound for Smooth Nonconvex Stochastic Optimization with Bounded Gradient Noise](#paper-2608-09004)
**Authors:** Jikai Jin

11. [Dual Space Preconditioning for Gradient Descent in the Overparameterized Regime](#paper-2603-10485)
**Authors:** Reza Ghane, Danil Akhtiamov, Babak Hassibi

12. [MoNo: Multiscale Optimal Transport Neural Operator for Solving PDEs on General Geometries](#paper-2608-09764)
**Authors:** Zijiang Yang, Xiaomeng Wu, Dongmei Fu

13. [The Kuramoto Neural Operator: Learning to Solve PDEs via Coupled Oscillator Dynamics](#paper-2608-10234)
**Authors:** Petr Badolia, Leonid Obukhov, Dmitry Bylinkin, Aleksandr Beznosikov

14. [Deciding When to Switch: E-Processes for Adaptive Minimax Training for Generative Adversarial Nets](#paper-2608-10096)
**Authors:** Hyunjoo Kim, Sicheng Wu, Agastya Venkatraman, Guang Lin, Sehwan Kim

15. [Minimum Block Width for Universal Approximation by Residual Neural Networks with Inner Width One](#paper-2607-04597)
**Authors:** Qi Zhou, Xuan Zhou, Xiao-Song Yang

16. [Deep Residual Echo State Networks: exploring residual orthogonal connections in untrained Recurrent Neural Networks](#paper-2508-21172)
**Authors:** Matteo Pinna, Andrea Ceni, Claudio Gallicchio

17. [Recurrent Neural Networks Beyond Time: Learning from Multiple Ordered Projections](#paper-2608-09690)
**Authors:** Vagan Terziyan, Artur Terziian, Oleksandra Vitko

18. [Closing the loop in learning with missing data](#paper-2608-09030)
**Authors:** Dimitrios Pylorof, Humberto E. Garcia

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (16)

1. [RL-Native Distillation: Exploiting Scored Trajectories for Few-Step Image Generation](#paper-2608-09226)
**Authors:** Yuhan Li, Fangao Zeng, Sicong Kang, Mengfei Xu, Hao Zhou, Wei Li, Pipei Huang, Bingbing Ni

2. [SemPIC: Learning Semantic Position-Independent KV Caches](#paper-2607-28069)
**Authors:** Hui Xie, Peng Xiao, Yutong Deng, Shuoran Dou, Jian Yang, Jinyang Guo

3. [From Sweep to Seam: Interleaved Cross-Block Post-Training Quantization](#paper-2608-09595)
**Authors:** Achille Jacquemond, Yuma Ichikawa, Akira Sakai

4. [Goose: Anisotropic Speculation Trees for Training-Free Speculative Decoding](#paper-2604-02047)
**Authors:** Tao Jin, Phuong Minh Nguyen, Naoya Inoue

5. [NeuroAda: Activating Each Neuron's Potential for Parameter-Efficient Fine-Tuning](#paper-2510-18940)
**Authors:** Zhi Zhang, Yixian Shen, Congfeng Cao, Ekaterina Shutova

6. [ROM: Real-time Overthinking Mitigation via Streaming Detection and Intervention](#paper-2603-22016)
**Authors:** Xinyan Wang, Xiaogeng Liu, Ming Pei, Chaowei Xiao

7. [Not All Visual Tokens Are Equally Safe to Remove:Consequence-Sensitive Visual Token Compression](#paper-2608-09176)
**Authors:** Jingbo Wen, Liang He, Mingyu Cao, Haoyu Wang, Minxuan Hu, Kangning Cui, Xilu Wang

8. [Depth-adaptive Inference of Looped Language Models via Continuous Depth Batching](#paper-2608-09444)
**Authors:** Kristian Schwethelm, Daniel Rueckert, Georgios Kaissis

9. [MoE-Prism: Disentangling Monolithic Experts for Elastic MoE Services via Model-System Co-Designs](#paper-2510-19366)
**Authors:** Xinfeng Xia, Xiaofeng Hou, Jiacheng Liu, Wenfeng Wang, Mingxuan Zhang, Peng Tang, Chao Li, Minyi Guo

10. [Omni2LoRA: Coherence-Preserving Parametric Memory for Efficient Omni Language Models](#paper-2608-09227)
**Authors:** Puneet Mathur, Manan Suri, Dinesh Manocha

11. [LookME: Lookup-Based Multimodal Embeddings for Layer Injection in Vision-Language Models](#paper-2607-16305)
...
13. [Rethinking Factor Sharing in Federated LoRA: A Rank-Aware Adaptive Approach](#paper-2608-09742)
**Authors:** Xinyi Xu, Bingnan Xiao, Shuang Qin, Gang Feng, Tony Q. S. Quek

14. [DUET: A Diversity-Quality Duet of Distillation Experts for Two-Step Video Generation](#paper-2608-09637)
**Authors:** Zian Li, Litong Gong, Borui Liao, Pengfei Liu, Xinyu Wang, Xinyuan Wei, Yifan Gao, Tiezheng Ge, Muhan Zhang

15. [On the Effect of Sampling Diversity in Scaling LLM Inference](#paper-2502-11027)
**Authors:** Tianchun Wang, Zichuan Liu, Yuanzhou Chen, Jonathan Light, Weiyang Liu, Haifeng Chen, Xiang Zhang, Wei Cheng

16. [A Tale of Two Temperatures: Simple, Efficient, and Diverse Sampling from Diffusion Language Models](#paper-2604-09921)
...
### 2. [SeFoRA: Sketch-Aggregated Federated Low-Rank Adaptation with Heterogeneous Client Ranks](https://arxiv.org/abs/2608.10144) <a id="paper-2608-10144"></a>
...
### 3. [FedA2L: Adaptive layer-wise learning rate adjustment in decentralized federated learning](https://arxiv.org/abs/2608.09208) <a id="paper-2608-09208"></a>
...
### 4. [Distributed Optimization with Streaming Data: A Temporal Weighting Perspective](https://arxiv.org/abs/2608.09565) <a id="paper-2608-09565"></a>
...
### 5. [FEAST: Federated Shared-Space Training for Resource-Heterogeneous Clients](https://arxiv.org/abs/2608.09250) <a id="paper-2608-09250"></a>
...
### 1. [Generalized Convexity and Smoothness via Conjugate Duality: Optimization Theory for Deep Neural Networks](https://arxiv.org/abs/2608.09523) <a id="paper-2608-09523"></a>
...
### 3. [MixFormer: Linear Transformer with Mixture of Memory Experts](https://arxiv.org/abs/2608.09468) <a id="paper-2608-09468"></a>
...
### 4. [The Matching Principle: When Does a Training Penalty Cover Deployment Shift?](https://arxiv.org/abs/2605.22800) <a id="paper-2605-22800"></a>
...
### 5. [ZetaGPT: A Reference Implementation of Positional--Encoding--Free State--Space--Attention Language Models](https://arxiv.org/abs/2608.09432) <a id="paper-2608-09432"></a>
...
### 6. [GradCuit: Credit-Assigned Gradient Flow Enables Robust and Interpretable Test-Time Latent Reasoning](https://arxiv.org/abs/2608.02585) <a id="paper-2608-02585"></a>
...
### 7. [BDH-CQ: In-Context Learning with Recurrent Latent Reasoning](https://arxiv.org/abs/2608.09888) <a id="paper-2608-09888"></a>
...
### 8. [Dynamic gain neuromodulation attenuates the stability gap under joint training](https://arxiv.org/abs/2507.14056) <a id="paper-2507-14056"></a>
...
### 10. [A Tight Lower Bound for Smooth Nonconvex Stochastic Optimization with Bounded Gradient Noise](https://arxiv.org/abs/2608.09004) <a id="paper-2608-09004"></a>
...
### 11. [Dual Space Preconditioning for Gradient Descent in the Overparameterized Regime](https://arxiv.org/abs/2603.10485) <a id="paper-2603-10485"></a>
...
### 12. [MoNo: Multiscale Optimal Transport Neural Operator for Solving PDEs on General Geometries](https://arxiv.org/abs/2608.09764) <a id="paper-2608-09764"></a>
...
### 13. [The Kuramoto Neural Operator: Learning to Solve PDEs via Coupled Oscillator Dynamics](https://arxiv.org/abs/2608.10234) <a id="paper-2608-10234"></a>
...
### 14. [Deciding When to Switch: E-Processes for Adaptive Minimax Training for Generative Adversarial Nets](https://arxiv.org/abs/2608.10096) <a id="paper-2608-10096"></a>
...
### 15. [Minimum Block Width for Universal Approximation by Residual Neural Networks with Inner Width One](https://arxiv.org/abs/2607.04597) <a id="paper-2607-04597"></a>
...
### 16. [Deep Residual Echo State Networks: exploring residual orthogonal connections in untrained Recurrent Neural Networks](https://arxiv.org/abs/2508.21172) <a id="paper-2508-21172"></a>
...
### 17. [Recurrent Neural Networks Beyond Time: Learning from Multiple Ordered Projections](https://arxiv.org/abs/2608.09690) <a id="paper-2608-09690"></a>
...
### 18. [Closing the loop in learning with missing data](https://arxiv.org/abs/2608.09030) <a id="paper-2608-09030"></a>
...
### 1. [RL-Native Distillation: Exploiting Scored Trajectories for Few-Step Image Generation](https://arxiv.org/abs/2608.09226) <a id="paper-2608-09226"></a>
...
### 2. [SemPIC: Learning Semantic Position-Independent KV Caches](https://arxiv.org/abs/2607.28069) <a id="paper-2607-28069"></a>
...
### 3. [From Sweep to Seam: Interleaved Cross-Block Post-Training Quantization](https://arxiv.org/abs/2608.09595) <a id="paper-2608-09595"></a>
...
### 4. [Goose: Anisotropic Speculation Trees for Training-Free Speculative Decoding](https://arxiv.org/abs/2604.02047) <a id="paper-2604-02047"></a>
...
### 5. [NeuroAda: Activating Each Neuron's Potential for Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2510.18940) <a id="paper-2510-18940"></a>
...
### 6. [ROM: Real-time Overthinking Mitigation via Streaming Detection and Intervention](https://arxiv.org/abs/2603.22016) <a id="paper-2603-22016"></a>
...
### 7. [Not All Visual Tokens Are Equally Safe to Remove:Consequence-Sensitive Visual Token Compression](https://arxiv.org/abs/2608.09176) <a id="paper-2608-09176"></a>
...
### 8. [Depth-adaptive Inference of Looped Language Models via Continuous Depth Batching](https://arxiv.org/abs/2608.09444) <a id="paper-2608-09444"></a>
...
### 9. [MoE-Prism: Disentangling Monolithic Experts for Elastic MoE Services via Model-System Co-Designs](https://arxiv.org/abs/2510.19366) <a id="paper-2510-19366"></a>
...
### 10. [Omni2LoRA: Coherence-Preserving Parametric Memory for Efficient Omni Language Models](https://arxiv.org/abs/2608.09227) <a id="paper-2608-09227"></a>
...
### 11. [LookME: Lookup-Based Multimodal Embeddings for Layer Injection in Vision-Language Models](https://arxiv.org/abs/2607.16305) <a id="paper-2607-16305"></a>
...
### 13. [Rethinking Factor Sharing in Federated LoRA: A Rank-Aware Adaptive Approach](https://arxiv.org/abs/2608.09742) <a id="paper-2608-09742"></a>
...
### 14. [DUET: A Diversity-Quality Duet of Distillation Experts for Two-Step Video Generation](https://arxiv.org/abs/2608.09637) <a id="paper-2608-09637"></a>
...
### 15. [On the Effect of Sampling Diversity in Scaling LLM Inference](https://arxiv.org/abs/2502.11027) <a id="paper-2502-11027"></a>
...
### 16. [A Tale of Two Temperatures: Simple, Efficient, and Diverse Sampling from Diffusion Language Models](https://arxiv.org/abs/2604.09921) <a id="paper-2604-09921"></a>
