<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../07"><img src="../../../assets/nav/day/2026-02-09-prev.svg" alt="Previous Day 2026-02-07"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-09-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../10"><img src="../../../assets/nav/day/2026-02-09-next.svg" alt="Next Day 2026-02-10"></a></div></div>
...
## 1. [To 2:4 Sparsity and Beyond: Neuron-level Activation Function to Accelerate LLM Pre-Training](https://arxiv.org/abs/2602.06183) <a id="link1"></a>
...
## 2. [MoSE: Mixture of Slimmable Experts for Efficient and Adaptive Language Models](https://arxiv.org/abs/2602.06154) <a id="link2"></a>
...
## 3. [POP: Online Structural Pruning Enables Efficient Inference of Large Foundation Models](https://arxiv.org/abs/2602.06822) <a id="link3"></a>
...
## 4. [Learning Rate Scaling across LoRA Ranks and Transfer to Full Finetuning](https://arxiv.org/abs/2602.06204) <a id="link4"></a>
...
## 5. [NanoQuant: Efficient Sub-1-Bit Quantization of Large Language Models](https://arxiv.org/abs/2602.06694) <a id="link5"></a>
...
## 6. [Emergent Low-Rank Training Dynamics in MLPs with Smooth Activations](https://arxiv.org/abs/2602.06208) <a id="link6"></a>
...
## 7. [SOCKET: SOft Collison Kernel EsTimator for Sparse Attention](https://arxiv.org/abs/2602.06283) <a id="link7"></a>
...
## 8. [Compressing LLMs with MoP: Mixture of Pruners](https://arxiv.org/abs/2602.06127) <a id="link8"></a>
...
## 9. [Cross-Modal Redundancy and the Geometry of Vision-Language Embeddings](https://arxiv.org/abs/2602.06218) <a id="link9"></a>
...
## 10. [EUGens: Efficient, Unified, and General Dense Layers](https://arxiv.org/abs/2410.09771) <a id="link10"></a>
...
## 11. [Optimal Learning-Rate Schedules under Functional Scaling Laws: Power Decay and Warmup-Stable-Decay](https://arxiv.org/abs/2602.06797) <a id="link11"></a>
...
## 12. [Uniform Spectral Growth and Convergence of Muon in LoRA-Style Matrix Factorization](https://arxiv.org/abs/2602.06385) <a id="link12"></a>
...
## 13. [Disentanglement by means of action-induced representations](https://arxiv.org/abs/2602.06741) <a id="link13"></a>
...
## 14. [High-Dimensional Limit of Stochastic Gradient Flow via Dynamical Mean-Field Theory](https://arxiv.org/abs/2602.06320) <a id="link14"></a>
...
## 15. [Inference-Time Rethinking with Latent Thought Vectors for Math Reasoning](https://arxiv.org/abs/2602.06584) <a id="link15"></a>
...
## 16. [Learning a Generative Meta-Model of LLM Activations](https://arxiv.org/abs/2602.06964) <a id="link16"></a>
...
## 17. [From Kepler to Newton: Inductive Biases Guide Learned World Models in Transformers](https://arxiv.org/abs/2602.06923) <a id="link17"></a>
...
## 18. [Canzona: A Unified, Asynchronous, and Load-Balanced Framework for Distributed Matrix-based Optimizers](https://arxiv.org/abs/2602.06079) <a id="link18"></a>
...
## 19. [Deep networks learn to parse uniform-depth context-free languages from local statistics](https://arxiv.org/abs/2602.06065) <a id="link19"></a>
...
## 20. [A Multiplicative Neural Network Architecture: Locality and Regularity of Appriximation](https://arxiv.org/abs/2602.06374) <a id="link20"></a>
...
## 21. [PackInfer: Compute- and I/O-Efficient Attention for Batched LLM Inference](https://arxiv.org/abs/2602.06072) <a id="link21"></a>
...
## 22. [Fine-Grained Model Merging via Modular Expert Recombination](https://arxiv.org/abs/2602.06552) <a id="link22"></a>
...
## 23. [Revisiting the Shape Convention of Transformer Language Models](https://arxiv.org/abs/2602.06471) <a id="link23"></a>
...
## 24. [Decoupling Variance and Scale-Invariant Updates in Adaptive Gradient Descent for Unified Vector and Matrix Optimization](https://arxiv.org/abs/2602.06880) <a id="link24"></a>
...
## 25. [Algebraic Robustness Verification of Neural Networks](https://arxiv.org/abs/2602.06105) <a id="link25"></a>
...
## 26. [HyPER: Bridging Exploration and Exploitation for Scalable LLM Reasoning with Hypothesis Path Expansion and Reduction](https://arxiv.org/abs/2602.06527) <a id="link26"></a>
...
## 27. [Explaining Grokking in Transformers through the Lens of Inductive Bias](https://arxiv.org/abs/2602.06702) <a id="link27"></a>
...
## 28. [Robustness Beyond Known Groups with Low-rank Adaptation](https://arxiv.org/abs/2602.06924) <a id="link28"></a>
...
## 29. [SHINE: A Scalable In-Context Hypernetwork for Mapping Context to LoRA in a Single Pass](https://arxiv.org/abs/2602.06358) <a id="link29"></a>
...
## 30. [When RL Meets Adaptive Speculative Training: A Unified Training-Serving System](https://arxiv.org/abs/2602.06932) <a id="link30"></a>
...
## 31. [SPARC: Separating Perception And Reasoning Circuits for Test-time Scaling of VLMs](https://arxiv.org/abs/2602.06566) <a id="link31"></a>
...
## 32. [Weisfeiler and Lehman Go Categorical](https://arxiv.org/abs/2602.06787) <a id="link32"></a>
...
## 33. [Vision Transformer Finetuning Benefits from Non-Smooth Components](https://arxiv.org/abs/2602.06883) <a id="link33"></a>
...
## 34. [Multi-Way Representation Alignment](https://arxiv.org/abs/2602.06205) <a id="link34"></a>
...
## 35. [Accelerating Vision Transformers on Brain Processing Unit](https://arxiv.org/abs/2602.06300) <a id="link35"></a>
...
## 36. [Not All Layers Need Tuning: Selective Layer Restoration Recovers Diversity](https://arxiv.org/abs/2602.06665) <a id="link36"></a>
...
## 37. [Endogenous Resistance to Activation Steering in Language Models](https://arxiv.org/abs/2602.06941) <a id="link37"></a>
...
## 38. [The Quantum Sieve Tracer: A Hybrid Framework for Layer-Wise Activation Tracing in Large Language Models](https://arxiv.org/abs/2602.06852) <a id="link38"></a>
...
## 39. [Diffeomorphism-Equivariant Neural Networks](https://arxiv.org/abs/2602.06695) <a id="link39"></a>
...
## 40. [Same Answer, Different Representations: Hidden instability in VLMs](https://arxiv.org/abs/2602.06652) <a id="link40"></a>
...
## 41. [Optimal rates for density and mode estimation with expand-and-sparsify representations](https://arxiv.org/abs/2602.06175) <a id="link41"></a>
