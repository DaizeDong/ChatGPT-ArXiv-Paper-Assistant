<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../15"><img src="../../../assets/nav/day/2026-01-16-prev.svg" alt="Previous Day 2026-01-15"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-01-16-center.svg" alt="Monthly Overview 2026-01"></a></div><div style="width: 33.33%; text-align: right;"><a href="../19"><img src="../../../assets/nav/day/2026-01-16-next.svg" alt="Next Day 2026-01-19"></a></div></div>
...
2. [STEM: Scaling Transformers with Embedding Modules](#user-content-link2)
...
3. [Bounded Hyperbolic Tangent: A Stable and Efficient Alternative to Pre-Layer Normalization in Large Language Models](#user-content-link3)
**Authors:** Hoyoon Byun, Youngjun Choi, Taero Kim, Sungrae Park, Kyungwoo Song

4. [Global Context Compression with Interleaved Vision-Text Transformation](#user-content-link4)
**Authors:** Dian Jiao, Jiaxin Duan, Shuai Zhao, Jiabing Leng, Yiran Zhang, Feng Huang

5. [The Geometry of Thought: Disclosing the Transformer as a Tropical Polynomial Circuit](#user-content-link5)
**Authors:** Faruk Alpay, Bilge Senturk

6. [MoST: Mixing Speech and Text with Modality-Aware Mixture of Experts](#user-content-link6)
**Authors:** Yuxuan Lou, Kai Yang, Yang You

7. [An analytic theory of convolutional neural network inverse problems solvers](#user-content-link7)
**Authors:** Minh Hai Nguyen, Quoc Bao Do, Edouard Pauwels, Pierre Weiss

8. [TRIM: Hybrid Inference via Targeted Stepwise Routing in Multi-Step Reasoning Tasks](#user-content-link8)
**Authors:** Vansh Kapoor, Aman Gupta, Hao Chen, Anurag Beniwal, Jing Huang, Aviral Kumar

9. [In-Context Operator Learning on the Space of Probability Measures](#user-content-link9)
**Authors:** Frank Cole, Dixi Wang, Yineng Chen, Yulong Lu, Rongjie Lai

10. [Unlabeled Data Can Provably Enhance In-Context Learning of Transformers](#user-content-link10)
**Authors:** Renpu Liu, Jing Yang

11. [Enhancing LUT-based Deep Neural Networks Inference through Architecture and Connectivity Optimization](#user-content-link11)
**Authors:** Binglei Lou, Ruilin Wu, Philip Leong

12. [Single-Stage Huffman Encoder for ML Compression](#user-content-link12)
...
13. [On the origin of neural scaling laws: from random graphs to natural language](#user-content-link13)
**Authors:** Maissam Barkeshli, Alberto Alfarano, Andrey Gromov

14. [Training-Trajectory-Aware Token Selection](#user-content-link14)
**Authors:** Zhanming Shen, Jiaqi Hu, Zeyu Qin, Hao Chen, Wentao Ye, Zenan Huang, Yihong Zhuang, Guoshan Lu, Junlin Zhou, Junbo Zhao

15. [A New Convergence Analysis of Plug-and-Play Proximal Gradient Descent Under Prior Mismatch](#user-content-link15)
**Authors:** Guixian Xu, Jinglai Li, Junqi Tang

16. [Understanding and Preserving Safety in Fine-Tuned LLMs](#user-content-link16)
**Authors:** Jiawen Zhang, Yangfan Hu, Kejia Chen, Lipeng He, Jiachen Ma, Jian Lou, Dan Li, Jian Liu, Xiaohu Yang, Ruoxi Jia

17. [LaViT: Aligning Latent Visual Thoughts for Multi-modal Reasoning](#user-content-link17)
**Authors:** Linquan Wu, Tianxiang Jiang, Yifei Dong, Haoyu Yang, Fengji Zhang, Shichaang Meng, Ai Xuan, Linqi Song, Jacky Keung

18. [Thinking Long, but Short: Stable Sequential Test-Time Scaling for Large Reasoning Models](#user-content-link18)
**Authors:** Michael R. Metel, Yufei Cui, Boxing Chen, Prasanna Parthasarathi

19. [Distributed Perceptron under Bounded Staleness, Partial Participation, and Noisy Communication](#user-content-link19)
...
## 2. [STEM: Scaling Transformers with Embedding Modules](https://arxiv.org/abs/2601.10639) <a id="link2"></a>
...
## 3. [Bounded Hyperbolic Tangent: A Stable and Efficient Alternative to Pre-Layer Normalization in Large Language Models](https://arxiv.org/abs/2601.09719) <a id="link3"></a>
...
## 4. [Global Context Compression with Interleaved Vision-Text Transformation](https://arxiv.org/abs/2601.10378) <a id="link4"></a>
...
## 5. [The Geometry of Thought: Disclosing the Transformer as a Tropical Polynomial Circuit](https://arxiv.org/abs/2601.09775) <a id="link5"></a>
...
## 6. [MoST: Mixing Speech and Text with Modality-Aware Mixture of Experts](https://arxiv.org/abs/2601.10272) <a id="link6"></a>
...
## 7. [An analytic theory of convolutional neural network inverse problems solvers](https://arxiv.org/abs/2601.10334) <a id="link7"></a>
...
**Comment:** Matches Representation Learning/Theory: provides an analytic LE-MMSE framework capturing CNN inductive biases (equivariance, locality) for inverse problems with strong empirical alignment.
...
## 8. [TRIM: Hybrid Inference via Targeted Stepwise Routing in Multi-Step Reasoning Tasks](https://arxiv.org/abs/2601.10245) <a id="link8"></a>
...
**Comment:** Matches Conditional/Dynamic Networks and Efficiency: step-level routing (TRIM) that sends only critical reasoning steps to larger models using uncertainty and process rewards, improving cost-accuracy tradeoffs.
...
## 9. [In-Context Operator Learning on the Space of Probability Measures](https://arxiv.org/abs/2601.09979) <a id="link9"></a>
...
**Comment:** Matches Representation Learning/Theory: proposes in-context operator learning on probability measures with scaling-law theory and explicit architectures for OT maps.
...
## 10. [Unlabeled Data Can Provably Enhance In-Context Learning of Transformers](https://arxiv.org/abs/2601.10058) <a id="link10"></a>
...
**Comment:** Representation Learning/Training Dynamics in Transformers: theoretical analysis showing CoT-augmented prompts let transformers emulate EM using unlabeled data for improved ICL.
...
## 11. [Enhancing LUT-based Deep Neural Networks Inference through Architecture and Connectivity Optimization](https://arxiv.org/abs/2601.09773) <a id="link11"></a>
...
**Comment:** Compression/Efficiency: LUT-based DNN architectural aggregation plus non-greedy sparse connectivity pruning/regrowth for FPGA-efficient inference.
...
## 12. [Single-Stage Huffman Encoder for ML Compression](https://arxiv.org/abs/2601.10673) <a id="link12"></a>
...
**Comment:** Matches Compression/Efficiency and HPC communication: proposes a single-stage Huffman encoder with fixed codebooks for on-the-fly tensor compression during distributed LLM training, removing codebook-gen/transmission overhead.
...
## 13. [On the origin of neural scaling laws: from random graphs to natural language](https://arxiv.org/abs/2601.10684) <a id="link13"></a>
...
**Comment:** Scaling laws theory: investigates origins of neural scaling exponents via simplified transformers and random-graph sequences.
...
## 14. [Training-Trajectory-Aware Token Selection](https://arxiv.org/abs/2601.10348) <a id="link14"></a>
...
**Comment:** Matches Compression/Efficiency and training dynamics: token-level objective (T3S) for distillation that mitigates trajectory bottlenecks in strong students, improving reasoning efficiency.
...
## 15. [A New Convergence Analysis of Plug-and-Play Proximal Gradient Descent Under Prior Mismatch](https://arxiv.org/abs/2601.09831) <a id="link15"></a>
...
**Comment:** Matches theoretical training analysis: first convergence proof for PnP-PGD under prior mismatch, relaxing restrictive assumptions.
...
## 16. [Understanding and Preserving Safety in Fine-Tuned LLMs](https://arxiv.org/abs/2601.10141) <a id="link16"></a>
...
**Comment:** Representation Learning/Training Dynamics: identifies a low-rank safety-gradient subspace and uses projection-based fine-tuning (SPF) to preserve safety while maintaining utility.
...
## 17. [LaViT: Aligning Latent Visual Thoughts for Multi-modal Reasoning](https://arxiv.org/abs/2601.10129) <a id="link17"></a>
...
**Comment:** Model Architecture/Training: aligns latent visual attention trajectories (visual thoughts) with curriculum sensory gating to enhance multimodal reasoning and grounding.
...
## 18. [Thinking Long, but Short: Stable Sequential Test-Time Scaling for Large Reasoning Models](https://arxiv.org/abs/2601.09855) <a id="link18"></a>
...
**Comment:** Matches Efficiency/HPC inference: introduces stable sequential test-time scaling (Min-Seek) with a custom KV-cache scheme enabling beyond-context reasoning at near-linear complexity.
...
## 19. [Distributed Perceptron under Bounded Staleness, Partial Participation, and Noisy Communication](https://arxiv.org/abs/2601.10705) <a id="link19"></a>
...
**Comment:** High Performance Computing/Distributed Training: semi-asynchronous perceptron with staleness-bucket aggregation under delays, partial participation, and noisy communication, with mistake bounds.
