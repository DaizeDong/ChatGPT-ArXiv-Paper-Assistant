<div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1.2fr) minmax(0, 1fr); align-items: center; width: 100%; gap: 16px; margin: 8px 0 20px;"><div></div><div style="display: flex; justify-content: center;"><a href=".." style="display: inline-flex; flex-direction: column; align-items: center; text-align: center; text-decoration: none; line-height: 1.25;"><strong style="display: block;">Monthly Overview</strong><span style="display: block; font-size: 14px; color: gray;">2025-01</span></a></div><div style="display: flex; justify-content: flex-end;"><a href="../21" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;"><span style="display: flex; flex-direction: column; align-items: flex-end; text-align: right; line-height: 1.25;"><strong style="display: block;">Next Day</strong><span style="display: block; font-size: 14px; color: gray;">2025-01-21</span></span><span style="font-size: 20px; line-height: 1; color: inherit;">&rarr;</span></a></div></div>
...
0. [FASP: Fast and Accurate Structured Pruning of Large Language Models](#user-content-link0)
**Authors:** Hanyu Hu, Pengxiang Zhao, Ping Li, Yi Zheng, Zhefeng Wang, Xiaoming Yuan

1. [LLM-Based Routing in Mixture of Experts: A Novel Framework for Trading](#user-content-link1)
**Authors:** Kuan-Ming Liu (National Chengchi University, College of Commerce), Ming-Chih Lo (National Yang Ming Chiao Tung University, College of Computer Science)

2. [Towards Understanding Extrapolation: a Causal Lens](#user-content-link2)
**Authors:** Lingjing Kong, Guangyi Chen, Petar Stojanov, Haoxuan Li, Eric P. Xing, Kun Zhang

3. [Mono-Forward: Backpropagation-Free Algorithm for Efficient Neural Network Training Harnessing Local Errors](#user-content-link3)
**Authors:** James Gong, Bruce Li, Waleed Abdulla

4. [Rethinking Post-Training Quantization: Introducing a Statistical Pre-Calibration Approach](#user-content-link4)
**Authors:** Alireza Ghaffari, Sharareh Younesian, Boxing Chen, Vahid Partovi Nia, Masoud Asgharian

5. [Enhancing Graph Representation Learning with Localized Topological Features](#user-content-link5)
**Authors:** Zuoyu Yan, Qi Zhao, Ze Ye, Tengfei Ma, Liangcai Gao, Zhi Tang, Yusu Wang, Chao Chen

6. [Merging Models on the Fly Without Retraining: A Sequential Approach to Scalable Continual Model Merging](#user-content-link6)
**Authors:** Anke Tang, Enneng Yang, Li Shen, Yong Luo, Han Hu, Bo Du, Dacheng Tao

7. [On Learning Informative Trajectory Embeddings for Imitation, Classification and Regression](#user-content-link7)
**Authors:** Zichang Ge, Changyu Chen, Arunesh Sinha, Pradeep Varakantham

8. [Fokker-Planck to Callan-Symanzik: evolution of weight matrices under training](#user-content-link8)
**Authors:** Wei Bu, Uri Kol, Ziming Liu

9. [Rational Tuning of LLM Cascades via Probabilistic Modeling](#user-content-link9)
**Authors:** Michael J. Zellinger, Matt Thomson

10. [MatrixNet: Learning over symmetry groups using learned group representations](#user-content-link10)
**Authors:** Lucas Laird, Circe Hsu, Asilata Bapat, Robin Walters

11. [Pruning for Sparse Diffusion Models based on Gradient Flow](#user-content-link11)
**Authors:** Ben Wan, Tianyi Zheng, Zhaoyu Chen, Yuxiao Wang, Jia Wang

12. [Large Language Model is Secretly a Protein Sequence Optimizer](#user-content-link12)
**Authors:** Yinkai Wang, Jiaxing He, Yuanqi Du, Xiaohui Chen, Jianan Canal Li, Li-Ping Liu, Xiaolin Xu, Soha Hassoun

13. [MOGNET: A Mux-residual quantized Network leveraging Online-Generated weights](#user-content-link13)
**Authors:** Van Thien Nguyen, William Guicquero, Gilles Sicard

14. [A Near-optimal Algorithm for Learning Margin Halfspaces with Massart Noise](#user-content-link14)
**Authors:** Ilias Diakonikolas, Nikos Zarifis

15. [Testing Noise Assumptions of Learning Algorithms](#user-content-link15)
**Authors:** Surbhi Goel, Adam R. Klivans, Konstantinos Stavropoulos, Arsen Vasilyan

16. [Task Vectors in In-Context Learning: Emergence, Formation, and Benefit](#user-content-link16)
**Authors:** Liu Yang, Ziqian Lin, Kangwook Lee, Dimitris Papailiopoulos, Robert Nowak

17. [Class Incremental Fault Diagnosis under Limited Fault Data via Supervised Contrastive Knowledge Distillation](#user-content-link17)
**Authors:** Hanrong Zhang, Yifei Yao, Zixuan Wang, Jiayuan Su, Mengxuan Li, Peng Peng, Hongwei Wang

18. [Free-Knots Kolmogorov-Arnold Network: On the Analysis of Spline Knots and Advancing Stability](#user-content-link18)
**Authors:** Liangwewi Nathan Zheng, Wei Emma Zhang, Lin Yue, Miao Xu, Olaf Maennel, Weitong Chen

19. [Gradient Descent Converges Linearly to Flatter Minima than Gradient Flow in Shallow Linear Networks](#user-content-link19)
**Authors:** Pierfrancesco Beneventano, Blake Woodworth

20. [Weight for Robustness: A Comprehensive Approach towards Optimal Fault-Tolerant Asynchronous ML](#user-content-link20)
**Authors:** Tehila Dahan, Kfir Y. Levy

21. [Towards Large Reasoning Models: A Survey of Reinforced Reasoning with Large Language Models](#user-content-link21)
...
22. [PAL: Prompting Analytic Learning with Missing Modality for Multi-Modal Class-Incremental Learning](#user-content-link22)
**Authors:** Xianghu Yue, Yiming Chen, Xueyi Zhang, Xiaoxue Gao, Mengling Feng, Mingrui Lao, Huiping Zhuang, Haizhou Li

23. [Reducing the Sensitivity of Neural Physics Simulators to Mesh Topology via Pretraining](#user-content-link23)
**Authors:** Nathan Vaska, Justin Goodwin, Robin Walters, Rajmonda S. Caceres

24. [Generating particle physics Lagrangians with transformers](#user-content-link24)
**Authors:** Yong Sheng Koay, Rikard Enberg, Stefano Moretti, Eliel Camargo-Molina

---
## 0. [FASP: Fast and Accurate Structured Pruning of Large Language Models](https://arxiv.org/abs/2501.09412) <a id="link0"></a>
**ArXiv ID:** 2501.09412
**Authors:** Hanyu Hu, Pengxiang Zhao, Ping Li, Yi Zheng, Zhefeng Wang, Xiaoming Yuan
...
## 1. [LLM-Based Routing in Mixture of Experts: A Novel Framework for Trading](https://arxiv.org/abs/2501.09636) <a id="link1"></a>
**ArXiv ID:** 2501.09636
**Authors:** Kuan-Ming Liu (National Chengchi University, College of Commerce), Ming-Chih Lo (National Yang Ming Chiao Tung University, College of Computer Science)
...
## 2. [Towards Understanding Extrapolation: a Causal Lens](https://arxiv.org/abs/2501.09163) <a id="link2"></a>
**ArXiv ID:** 2501.09163
**Authors:** Lingjing Kong, Guangyi Chen, Petar Stojanov, Haoxuan Li, Eric P. Xing, Kun Zhang
...
## 3. [Mono-Forward: Backpropagation-Free Algorithm for Efficient Neural Network Training Harnessing Local Errors](https://arxiv.org/abs/2501.09238) <a id="link3"></a>
**ArXiv ID:** 2501.09238
**Authors:** James Gong, Bruce Li, Waleed Abdulla
...
## 4. [Rethinking Post-Training Quantization: Introducing a Statistical Pre-Calibration Approach](https://arxiv.org/abs/2501.09107) <a id="link4"></a>
**ArXiv ID:** 2501.09107
**Authors:** Alireza Ghaffari, Sharareh Younesian, Boxing Chen, Vahid Partovi Nia, Masoud Asgharian
...
## 5. [Enhancing Graph Representation Learning with Localized Topological Features](https://arxiv.org/abs/2501.09178) <a id="link5"></a>
**ArXiv ID:** 2501.09178
**Authors:** Zuoyu Yan, Qi Zhao, Ze Ye, Tengfei Ma, Liangcai Gao, Zhi Tang, Yusu Wang, Chao Chen
...
## 6. [Merging Models on the Fly Without Retraining: A Sequential Approach to Scalable Continual Model Merging](https://arxiv.org/abs/2501.09522) <a id="link6"></a>
**ArXiv ID:** 2501.09522
**Authors:** Anke Tang, Enneng Yang, Li Shen, Yong Luo, Han Hu, Bo Du, Dacheng Tao
...
## 7. [On Learning Informative Trajectory Embeddings for Imitation, Classification and Regression](https://arxiv.org/abs/2501.09327) <a id="link7"></a>
**ArXiv ID:** 2501.09327
**Authors:** Zichang Ge, Changyu Chen, Arunesh Sinha, Pradeep Varakantham
...
## 8. [Fokker-Planck to Callan-Symanzik: evolution of weight matrices under training](https://arxiv.org/abs/2501.09659) <a id="link8"></a>
**ArXiv ID:** 2501.09659
**Authors:** Wei Bu, Uri Kol, Ziming Liu
...
## 9. [Rational Tuning of LLM Cascades via Probabilistic Modeling](https://arxiv.org/abs/2501.09345) <a id="link9"></a>
**ArXiv ID:** 2501.09345
**Authors:** Michael J. Zellinger, Matt Thomson
...
## 10. [MatrixNet: Learning over symmetry groups using learned group representations](https://arxiv.org/abs/2501.09571) <a id="link10"></a>
**ArXiv ID:** 2501.09571
**Authors:** Lucas Laird, Circe Hsu, Asilata Bapat, Robin Walters
...
## 11. [Pruning for Sparse Diffusion Models based on Gradient Flow](https://arxiv.org/abs/2501.09464) <a id="link11"></a>
**ArXiv ID:** 2501.09464
**Authors:** Ben Wan, Tianyi Zheng, Zhaoyu Chen, Yuxiao Wang, Jia Wang
...
## 12. [Large Language Model is Secretly a Protein Sequence Optimizer](https://arxiv.org/abs/2501.09274) <a id="link12"></a>
**ArXiv ID:** 2501.09274
**Authors:** Yinkai Wang, Jiaxing He, Yuanqi Du, Xiaohui Chen, Jianan Canal Li, Li-Ping Liu, Xiaolin Xu, Soha Hassoun
...
## 13. [MOGNET: A Mux-residual quantized Network leveraging Online-Generated weights](https://arxiv.org/abs/2501.09531) <a id="link13"></a>
**ArXiv ID:** 2501.09531
**Authors:** Van Thien Nguyen, William Guicquero, Gilles Sicard
...
## 14. [A Near-optimal Algorithm for Learning Margin Halfspaces with Massart Noise](https://arxiv.org/abs/2501.09691) <a id="link14"></a>
**ArXiv ID:** 2501.09691
**Authors:** Ilias Diakonikolas, Nikos Zarifis
...
## 15. [Testing Noise Assumptions of Learning Algorithms](https://arxiv.org/abs/2501.09189) <a id="link15"></a>
**ArXiv ID:** 2501.09189
**Authors:** Surbhi Goel, Adam R. Klivans, Konstantinos Stavropoulos, Arsen Vasilyan
...
## 16. [Task Vectors in In-Context Learning: Emergence, Formation, and Benefit](https://arxiv.org/abs/2501.09240) <a id="link16"></a>
**ArXiv ID:** 2501.09240
**Authors:** Liu Yang, Ziqian Lin, Kangwook Lee, Dimitris Papailiopoulos, Robert Nowak
...
## 17. [Class Incremental Fault Diagnosis under Limited Fault Data via Supervised Contrastive Knowledge Distillation](https://arxiv.org/abs/2501.09525) <a id="link17"></a>
**ArXiv ID:** 2501.09525
**Authors:** Hanrong Zhang, Yifei Yao, Zixuan Wang, Jiayuan Su, Mengxuan Li, Peng Peng, Hongwei Wang
...
## 18. [Free-Knots Kolmogorov-Arnold Network: On the Analysis of Spline Knots and Advancing Stability](https://arxiv.org/abs/2501.09283) <a id="link18"></a>
**ArXiv ID:** 2501.09283
**Authors:** Liangwewi Nathan Zheng, Wei Emma Zhang, Lin Yue, Miao Xu, Olaf Maennel, Weitong Chen
...
## 19. [Gradient Descent Converges Linearly to Flatter Minima than Gradient Flow in Shallow Linear Networks](https://arxiv.org/abs/2501.09137) <a id="link19"></a>
**ArXiv ID:** 2501.09137
**Authors:** Pierfrancesco Beneventano, Blake Woodworth
...
## 20. [Weight for Robustness: A Comprehensive Approach towards Optimal Fault-Tolerant Asynchronous ML](https://arxiv.org/abs/2501.09621) <a id="link20"></a>
**ArXiv ID:** 2501.09621
**Authors:** Tehila Dahan, Kfir Y. Levy
...
## 21. [Towards Large Reasoning Models: A Survey of Reinforced Reasoning with Large Language Models](https://arxiv.org/abs/2501.09686) <a id="link21"></a>
**ArXiv ID:** 2501.09686
**Authors:** Fengli Xu, Qianyue Hao, Zefang Zong, Jingwei Wang, Yunke Zhang, Jingyi Wang, Xiaochong Lan, Jiahui Gong, Tianjian Ouyang, Fanjin Meng, Chenyang Shao, Yuwei Yan, Qinglong Yang, Yiwen Song, Sijian Ren, Xinyuan Hu, Yu Li, Jie Feng, Chen Gao, Yong Li
...
## 22. [PAL: Prompting Analytic Learning with Missing Modality for Multi-Modal Class-Incremental Learning](https://arxiv.org/abs/2501.09352) <a id="link22"></a>
**ArXiv ID:** 2501.09352
**Authors:** Xianghu Yue, Yiming Chen, Xueyi Zhang, Xiaoxue Gao, Mengling Feng, Mingrui Lao, Huiping Zhuang, Haizhou Li
...
## 23. [Reducing the Sensitivity of Neural Physics Simulators to Mesh Topology via Pretraining](https://arxiv.org/abs/2501.09597) <a id="link23"></a>
**ArXiv ID:** 2501.09597
**Authors:** Nathan Vaska, Justin Goodwin, Robin Walters, Rajmonda S. Caceres
...
## 24. [Generating particle physics Lagrangians with transformers](https://arxiv.org/abs/2501.09729) <a id="link24"></a>
**ArXiv ID:** 2501.09729
**Authors:** Yong Sheng Koay, Rikard Enberg, Stefano Moretti, Eliel Camargo-Molina
