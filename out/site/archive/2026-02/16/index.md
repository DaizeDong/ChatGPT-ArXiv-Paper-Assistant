<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../13"><img src="../../../assets/nav/day/2026-02-16-prev.svg" alt="Previous Day 2026-02-13"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-16-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../17"><img src="../../../assets/nav/day/2026-02-16-next.svg" alt="Next Day 2026-02-17"></a></div></div>
...
1. [Stabilizing Native Low-Rank LLM Pretraining](#user-content-link1)
**Authors:** Paul Janson, Edouard Oyallon, Eugene Belilovsky

2. [LCSB: Layer-Cyclic Selective Backpropagation for Memory-Efficient On-Device LLM Fine-Tuning](#user-content-link2)
**Authors:** Juneyoung Park, Eunbeen Yoon, Seongwan Kim. Jaeho Lee

3. [HyperMLP: An Integrated Perspective for Sequence Modeling](#user-content-link3)
**Authors:** Jiecheng Lu, Shihao Yang

4. [SLA2: Sparse-Linear Attention with Learnable Routing and QAT](#user-content-link4)
**Authors:** Jintao Zhang, Haoxu Wang, Kai Jiang, Kaiwen Zheng, Youhe Jiang, Ion Stoica, Jianfei Chen, Jun Zhu, Joseph E. Gonzalez

5. [Multi-Head Attention as a Source of Catastrophic Forgetting in MoE Transformers](#user-content-link5)
...
6. [Why Deep Jacobian Spectra Separate: Depth-Induced Scaling and Singular-Vector Alignment](#user-content-link6)
**Authors:** Nathana\"el Haas, Franc\c{c}ois Gatine, Augustin M Cosse, Zied Bouraoui

7. [SD-MoE: Spectral Decomposition for Effective Expert Specialization](#user-content-link7)
...
8. [QuEPT: Quantized Elastic Precision Transformers with One-Shot Calibration for Multi-Bit Switching](#user-content-link8)
**Authors:** Ke Xu, Yixin Wang, Zhongcheng Li, Hao Cui, Jinshui Hu, Xingyi Zhang

9. [Vision Token Reduction via Attention-Driven Self-Compression for Efficient Multimodal Large Language Models](#user-content-link9)
**Authors:** Omer Faruk Deniz, Ruiyu Mao, Ruochen Li, Yapeng Tian, Latifur Khan

10. [Memory-Efficient Structured Backpropagation for On-Device LLM Fine-Tuning](#user-content-link10)
**Authors:** Juneyoung Park, Yuri Hong, Seongwan Kim, Jaeho Lee

11. [Rational Neural Networks have Expressivity Advantages](#user-content-link11)
**Authors:** Maosen Tang, Alex Townsend

12. [TriGen: NPU Architecture for End-to-End Acceleration of Large Language Models based on SW-HW Co-Design](#user-content-link12)
**Authors:** Jonghun Lee, Junghoon Lee, Hyeonjin Kim, Seoho Jeon, Jisup Yoon, Hyunbin Park, Meejeong Park, Heonjae Ha

13. [A Theoretical Analysis of Mamba's Training Dynamics: Filtering Relevant Features for Generalization in State Space Models](#user-content-link13)
**Authors:** Mugunthan Shandirasegaran, Hongkang Li, Songyang Zhang, Meng Wang, Shuai Zhang

14. [Transporting Task Vectors across Different Architectures without Training](#user-content-link14)
**Authors:** Filippo Rinaldi, Aniello Panariello, Giacomo Salici, Angelo Porrello, Simone Calderara

15. [Which Algorithms Can Graph Neural Networks Learn?](#user-content-link15)
**Authors:** Solveig Wittig, Antonis Vasileiou, Robert R. Nerem, Timo Stoll, Floris Geerts, Yusu Wang, Christopher Morris

16. [FlashSchNet: Fast and Accurate Coarse-Grained Neural Network Molecular Dynamics](#user-content-link16)
**Authors:** Pingzhi Li, Hongxuan Li, Zirui Liu, Xingcheng Lin, Tianlong Chen

17. [Quantization-Robust LLM Unlearning via Low-Rank Adaptation](#user-content-link17)
...
18. [Synaptic Activation and Dual Liquid Dynamics for Interpretable Bio-Inspired Models](#user-content-link18)
**Authors:** M\'onika Farsang, Radu Grosu

19. [CoPE-VideoLM: Codec Primitives For Efficient Video Language Models](#user-content-link19)
**Authors:** Sayan Deb Sarkar, R\'emi Pautrat, Ondrej Miksik, Marc Pollefeys, Iro Armeni, Mahdi Rad, Mihai Dusmanu

20. [Curriculum-DPO++: Direct Preference Optimization via Data and Model Curricula for Text-to-Image Generation](#user-content-link20)
**Authors:** Florinel-Alin Croitoru, Vlad Hondru, Radu Tudor Ionescu, Nicu Sebe, Mubarak Shah

21. [The Appeal and Reality of Recycling LoRAs with Adaptive Merging](#user-content-link21)
**Authors:** Haokun Liu, Gyung Hyun Je, Marco Ciccone, Zhenlin Xu, Prasanth YSS, Colin Raffel

22. [SWING: Unlocking Implicit Graph Representations for Graph Random Features](#user-content-link22)
**Authors:** Alessandro Manenti, Avinava Dubey, Arijit Sehanobish, Cesare Alippi, Krzysztof Choromanski

---

## 1. [Stabilizing Native Low-Rank LLM Pretraining](https://arxiv.org/abs/2602.12429) <a id="link1"></a>
...
**Comment:** Low‑rank Architecture/Training: native low‑rank transformer pretraining stabilized by spectral renormalization with orthogonalization (Spectron) and compute‑optimal scaling laws.
...
## 2. [LCSB: Layer-Cyclic Selective Backpropagation for Memory-Efficient On-Device LLM Fine-Tuning](https://arxiv.org/abs/2602.13073) <a id="link2"></a>
...
**Comment:** Memory Optimization/Efficiency: selective per-step layer backpropagation for LoRA fine-tuning on-device, with BCD interpretation and improved stability.
...
## 3. [HyperMLP: An Integrated Perspective for Sequence Modeling](https://arxiv.org/abs/2602.12601) <a id="link3"></a>
...
**Comment:** Matches Model Architecture: reinterprets attention as a dynamic MLP and proposes HyperMLP/HyperGLU with theory and empirical gains over softmax attention.
...
## 4. [SLA2: Sparse-Linear Attention with Learnable Routing and QAT](https://arxiv.org/abs/2602.12675) <a id="link4"></a>
...
**Comment:** Matches Model Architecture and Efficiency: improved sparse-linear attention with learnable routing and quantization-aware training for major speedups while preserving quality.
...
## 5. [Multi-Head Attention as a Source of Catastrophic Forgetting in MoE Transformers](https://arxiv.org/abs/2602.12587) <a id="link5"></a>
...
**Comment:** Model Architecture (MoE): identifies a pre-routing bottleneck from multi-head attention causing route collisions and proposes head-wise routing (MH-MoE) to mitigate catastrophic forgetting.
...
## 6. [Why Deep Jacobian Spectra Separate: Depth-Induced Scaling and Singular-Vector Alignment](https://arxiv.org/abs/2602.12384) <a id="link6"></a>
...
**Comment:** Matches Representation Learning: theoretical analysis of deep Jacobian spectra (scaling, separation, and singular-vector alignment) explaining implicit bias and low-rank behavior.
...
## 7. [SD-MoE: Spectral Decomposition for Effective Expert Specialization](https://arxiv.org/abs/2602.12556) <a id="link7"></a>
...
**Comment:** Model Architecture (MoE): spectral decomposition of parameters/gradients to decouple dominant subspaces and improve expert specialization with minimal overhead.
...
## 8. [QuEPT: Quantized Elastic Precision Transformers with One-Shot Calibration for Multi-Bit Switching](https://arxiv.org/abs/2602.12609) <a id="link8"></a>
...
**Comment:** Compression/Efficiency + Low‑rank + Quantization: one‑shot post‑training elastic multi‑bit switching with cascaded low‑rank adapters (MB‑CLoRA) and multi‑bit token merging; supports mixed precision and KV‑cache efficiency.
...
## 9. [Vision Token Reduction via Attention-Driven Self-Compression for Efficient Multimodal Large Language Models](https://arxiv.org/abs/2602.12618) <a id="link9"></a>
...
**Comment:** Compression/Efficiency: attention‑driven self‑compression that progressively reduces vision tokens within the LLM, FlashAttention‑compatible, cutting FLOPs and KV‑cache.
...
## 10. [Memory-Efficient Structured Backpropagation for On-Device LLM Fine-Tuning](https://arxiv.org/abs/2602.13069) <a id="link10"></a>
...
**Comment:** Matches Model Compression and Efficiency/HPC: structured backprop exploiting LoRA low-rank to cut memory with exact gradients for on-device fine-tuning.
...
## 11. [Rational Neural Networks have Expressivity Advantages](https://arxiv.org/abs/2602.12390) <a id="link11"></a>
...
**Comment:** Model Architecture: introduces trainable low-degree rational activation functions with provable expressivity/parameter-efficiency advantages, extending to transformer-style nonlinearities.
...
## 12. [TriGen: NPU Architecture for End-to-End Acceleration of Large Language Models based on SW-HW Co-Design](https://arxiv.org/abs/2602.12962) <a id="link12"></a>
...
**Comment:** Compression/Efficiency & HPC: microscaling low-precision compute, LUT-based nonlinear ops, and memory-aware scheduling via SW–HW co-design for LLM inference.
...
## 13. [A Theoretical Analysis of Mamba's Training Dynamics: Filtering Relevant Features for Generalization in State Space Models](https://arxiv.org/abs/2602.12499) <a id="link13"></a>
...
**Comment:** Model Architecture: theoretical analysis of selective SSMs (Mamba), showing input-dependent gating performs feature selection and establishing generalization/convergence bounds.
...
## 14. [Transporting Task Vectors across Different Architectures without Training](https://arxiv.org/abs/2602.12952) <a id="link14"></a>
...
**Comment:** Matches Representation Learning: training-free transport of task vectors across heterogeneous architectures via functional alignment of intermediate representations.
...
## 15. [Which Algorithms Can Graph Neural Networks Learn?](https://arxiv.org/abs/2602.13106) <a id="link15"></a>
...
**Comment:** Representation/Architecture theory: provides conditions for MPNNs to learn algorithms and generalize to arbitrary sizes; includes impossibility results and more expressive MPNN-like variants.
...
## 16. [FlashSchNet: Fast and Accurate Coarse-Grained Neural Network Molecular Dynamics](https://arxiv.org/abs/2602.13140) <a id="link16"></a>
...
**Comment:** Compression/Efficiency + HPC: IO-aware fused kernels (flash radial basis/message passing/aggregation) and channel‑wise 16‑bit quantization to cut HBM traffic and atomics for GNNs.
...
## 17. [Quantization-Robust LLM Unlearning via Low-Rank Adaptation](https://arxiv.org/abs/2602.13151) <a id="link17"></a>
...
**Comment:** Compression/Efficiency + Low‑rank: uses LoRA to concentrate unlearning updates that survive 4‑bit PTQ, improving quantization‑robust unlearning.
...
## 18. [Synaptic Activation and Dual Liquid Dynamics for Interpretable Bio-Inspired Models](https://arxiv.org/abs/2602.13017) <a id="link18"></a>
...
**Comment:** Conditional/Dynamic Networks: introduces liquid-capacitance dynamics with chemical synapses and synaptic activation for interpretable recurrent policies.
...
## 19. [CoPE-VideoLM: Codec Primitives For Efficient Video Language Models](https://arxiv.org/abs/2602.13191) <a id="link19"></a>
...
**Comment:** Efficiency: leverages video codec motion vectors/residuals with lightweight transformer encoders to cut tokens and compute for VideoLMs.
...
## 20. [Curriculum-DPO++: Direct Preference Optimization via Data and Model Curricula for Text-to-Image Generation](https://arxiv.org/abs/2602.13055) <a id="link20"></a>
...
**Comment:** Low-rank/Compression: progressive LoRA rank scheduling and layer-unfreezing curriculum for preference optimization in text-to-image models.
...
## 21. [The Appeal and Reality of Recycling LoRAs with Adaptive Merging](https://arxiv.org/abs/2602.12323) <a id="link21"></a>
...
**Comment:** Matches Model Compression and Efficiency: empirical and methodological study of adaptive merging of LoRAs (low-rank adapters) including a new merging approach.
...
## 22. [SWING: Unlocking Implicit Graph Representations for Graph Random Features](https://arxiv.org/abs/2602.12703) <a id="link22"></a>
...
**Comment:** Representation/Efficiency: introduces SWING for Graph Random Features on implicit graphs using linearized kernels via random features and importance sampling without graph materialization; accelerator-friendly.
