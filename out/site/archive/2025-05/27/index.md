<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../26"><img src="../../../assets/nav/day/2025-05-27-prev.svg" alt="Previous Day 2025-05-26"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-05-27-center.svg" alt="Monthly Overview 2025-05"></a></div><div style="width: 33.33%; text-align: right;"><a href="../28"><img src="../../../assets/nav/day/2025-05-27-next.svg" alt="Next Day 2025-05-28"></a></div></div>
...
12. [ELDeR: Getting Efficient LLMs through Data-Driven Regularized Layer-wise Pruning](#user-content-link12)
...
27. [Multiple Descents in Deep Learning as a Sequence of Order-Chaos Transitions](#user-content-link27)
...
40. [Chordless Structure: A Pathway to Simple and Expressive GNNs](#user-content-link40)
...
54. [HD-PiSSA: High-Rank Distributed Orthogonal Adaptation](#user-content-link54)
...
70. [AweDist: Attention-aware Embedding Distillation for New Input Token Embeddings](#user-content-link70)
...
## 24. [When fractional quasi p-norms concentrate](https://arxiv.org/abs/2505.19635) <a id="link24"></a>
...
## 65. [Revisiting Glorot Initialization for Long-Range Linear Recurrences](https://arxiv.org/abs/2505.19827) <a id="link65"></a>
...
## 66. [Scaling Laws for Gradient Descent and Sign Descent for Linear Bigram Models under Zipf's Law](https://arxiv.org/abs/2505.19227) <a id="link66"></a>
...
## 67. [Mitigating Deceptive Alignment via Self-Monitoring](https://arxiv.org/abs/2505.18807) <a id="link67"></a>
...
## 68. [Your Classifier Can Do More: Towards Bridging the Gaps in Classification, Robustness, and Generation](https://arxiv.org/abs/2505.19459) <a id="link68"></a>
...
## 69. [Efficient Data Selection at Scale via Influence Distillation](https://arxiv.org/abs/2505.19051) <a id="link69"></a>
...
## 70. [AweDist: Attention-aware Embedding Distillation for New Input Token Embeddings](https://arxiv.org/abs/2505.20133) <a id="link70"></a>
...
## 71. [Logic Gate Neural Networks are Good for Verification](https://arxiv.org/abs/2505.19932) <a id="link71"></a>
...
## 72. [Hierarchical-embedding autoencoder with a predictor (HEAP) as efficient architecture for learning long-term evolution of complex multi-scale physical systems](https://arxiv.org/abs/2505.18857) <a id="link72"></a>
...
## 73. [Hierarchical Mamba Meets Hyperbolic Geometry: A New Paradigm for Structured Language Embeddings](https://arxiv.org/abs/2505.18973) <a id="link73"></a>
...
## 74. [ThanoRA: Task Heterogeneity-Aware Multi-Task Low-Rank Adaptation](https://arxiv.org/abs/2505.18640) <a id="link74"></a>
...
## 75. [Model Stitching by Functional Latent Alignment](https://arxiv.org/abs/2505.20142) <a id="link75"></a>
...
## 76. [TabPFN: One Model to Rule Them All?](https://arxiv.org/abs/2505.20003) <a id="link76"></a>
...
## 77. [CoreMatching: A Co-adaptive Sparse Inference Framework with Token and Neuron Pruning for Comprehensive Acceleration of Vision-Language Models](https://arxiv.org/abs/2505.19235) <a id="link77"></a>
...
## 78. [Can Compressed LLMs Truly Act? An Empirical Evaluation of Agentic Capabilities in LLM Compression](https://arxiv.org/abs/2505.19433) <a id="link78"></a>
...
## 79. [Mind The Gap: Deep Learning Doesn't Learn Deeply](https://arxiv.org/abs/2505.18623) <a id="link79"></a>
...
## 80. [On the Role of Label Noise in the Feature Learning Process](https://arxiv.org/abs/2505.18909) <a id="link80"></a>
...
## 81. [PacTrain: Pruning and Adaptive Sparse Gradient Compression for Efficient Collective Communication in Distributed Deep Learning](https://arxiv.org/abs/2505.18563) <a id="link81"></a>
...
## 82. [Scalable Gaussian Processes with Low-Rank Deep Kernel Decomposition](https://arxiv.org/abs/2505.18526) <a id="link82"></a>
...
## 83. [Universal Reasoner: A Single, Composable Plug-and-Play Reasoner for Frozen LLMs](https://arxiv.org/abs/2505.19075) <a id="link83"></a>
...
## 84. [Hamiltonian Theory and Computation of Optimal Probability Density Control in High Dimensions](https://arxiv.org/abs/2505.18362) <a id="link84"></a>
