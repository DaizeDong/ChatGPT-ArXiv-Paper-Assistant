<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../12"><img src="../../../assets/nav/day/2026-03-13-prev.svg" alt="Previous Day 2026-03-12"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-03-13-center.svg" alt="Monthly Overview 2026-03"></a></div><div style="width: 33.33%; text-align: right;"><a href="../14"><img src="../../../assets/nav/day/2026-03-13-next.svg" alt="Next Day 2026-03-14"></a></div></div>
...
1. [Statistical and structural identifiability in representation learning](#user-content-link1)
**Authors:** Walter Nelson, Marco Fumero, Theofanis Karaletsos, Francesco Locatello

2. [Attention Sinks Are Provably Necessary in Softmax Transformers: Evidence from Trigger-Conditional Tasks](#user-content-link2)
...
4. [Alternating Gradient Flow Utility: A Unified Metric for Structural Pruning and Dynamic Routing in Deep Networks](#user-content-link4)
**Authors:** Tianhao Qian, Zhuoxuan Li, Jinde Cao, Xinli Shi, Leszek Rutkowski

5. [Slow-Fast Inference: Training-Free Inference Acceleration via Within-Sentence Support Stability](#user-content-link5)
**Authors:** Xingyu Xie, Zhaochen Yu, Yue Liao, Tao Wang, Kim-Chuan Toh, Shuicheng Yan

6. [AdaFuse: Accelerating Dynamic Adapter Inference via Token-Level Pre-Gating and Fused Kernel Optimization](#user-content-link6)
**Authors:** Qiyang Li, Rui Kong, Yuchen Li, Hengyi Cai, Shuaiqiang Wang, Linghe Kong, Guihai Chen, Dawei Yin

7. [Topological DeepONets and a generalization of the Chen-Chen operator approximation theorem](#user-content-link7)
**Authors:** Vugar Ismailov

8. [HiAP: A Multi-Granular Stochastic Auto-Pruning Framework for Vision Transformers](#user-content-link8)
**Authors:** Andy Li, Aiden Durrant, Milan Markovic, Georgios Leontidis

9. [GPrune-LLM: Generalization-Aware Structured Pruning for Large Language Models](#user-content-link9)
**Authors:** Xiaoyun Liu, Divya Saxena, Jiannong Cao, Yuqing Zhao, Yiying Dong, Penghui Ruan

10. [LongFlow: Efficient KV Cache Compression for Reasoning M](#user-content-link10)
**Authors:** Yi Su, Zhenxu Tian, Dan Qiao, Yuechi Zhou, Juntao Li, Min Zhang

11. [Disentangled Representation Learning through Unsupervised Symmetry Group Discovery](#user-content-link11)
**Authors:** Barthélémy Dang-Nhu, Louis Annabi, Sylvain Argentieri

12. [IndexCache: Accelerating Sparse Attention via Cross-Layer Index Reuse](#user-content-link12)
**Authors:** Yushi Bai, Qian Dong, Ting Jiang, Xin Lv, Zhengxiao Du, Aohan Zeng, Jie Tang, Juanzi Li

13. [Chemical Reaction Networks Learn Better than Spiking Neural Networks](#user-content-link13)
**Authors:** Sophie Jaffard, Ivo F. Sbalzarini

14. [Language Generation with Replay: A Learning-Theoretic View of Model Collapse](#user-content-link14)
**Authors:** Giorgio Racca, Michal Valko, Amartya Sanyal

15. [Neural Thickets: Diverse Task Experts Are Dense Around Pretrained Weights](#user-content-link15)
**Authors:** Yulu Gan, Phillip Isola

16. [Sinkhorn-Drifting Generative Models](#user-content-link16)
**Authors:** Ping He, Om Khangaonkar, Hamed Pirsiavash, Yikun Bai, Soheil Kolouri

17. [Pruning-induced phases in fully-connected neural networks: the eumentia, the dementia, and the amentia](#user-content-link17)
**Authors:** Haining Pan, Nakul Aggarwal, J. H. Pixley

18. [Fractional Rotation, Full Potential? Investigating Performance and Convergence of Partial RoPE](#user-content-link18)
**Authors:** Mohammad Aflah Khan, Krishna P. Gummadi, Manish Gupta, Abhilasha Ravichander

19. [Matching Features, Not Tokens: Energy-Based Fine-Tuning of Language Models](#user-content-link19)
**Authors:** Samy Jelassi, Mujin Kwun, Rosie Zhao, Yuanzhi Li, Nicolo Fusi, Yilun Du, Sham M. Kakade, Carles Domingo-Enrich

20. [Geometry-Aware Probabilistic Circuits via Voronoi Tessellations](#user-content-link20)
**Authors:** Sahil Sidheekh, Sriraam Natarajan

21. [Truth as a Compression Artifact in Language Model Training](#user-content-link21)
...
23. [Harnessing Data Asymmetry: Manifold Learning in the Finsler World](#user-content-link23)
**Authors:** Thomas Dagès, Simon Weber, Daniel Cremers, Ron Kimmel

24. [KernelFoundry: Hardware-aware evolutionary GPU kernel optimization](#user-content-link24)
**Authors:** Nina Wiedemann, Quentin Leboutet, Michael Paulitsch, Diana Wofk, Benjamin Ummenhofer

25. [Cornserve: A Distributed Serving System for Any-to-Any Multimodal Models](#user-content-link25)
**Authors:** Jae-Won Chung, Jeff J. Ma, Jisang Ahn, Yizhuo Liang, Akshay Jajoo, Myungjin Lee, Mosharaf Chowdhury

26. [AutoScout: Structured Optimization for Automating ML System Configuration](#user-content-link26)
**Authors:** Jimmy Shong, Yuhan Ding, Yihan Jiang, Liheng Jing, Haonan Chen, Gaokai Zhang, Aditya Akella, Fan Lai

27. [Separable neural architectures as a primitive for unified predictive and generative intelligence](#user-content-link27)
**Authors:** Reza T. Batley, Apurba Sarker, Rajib Mostakim, Andrew Klichine, Sourav Saha

28. [A Quantitative Characterization of Forgetting in Post-Training](#user-content-link28)
**Authors:** Krishnakumar Balasubramanian, Shiva Prasad Kasiviswanathan

29. [Diffusion Models Generalize but Not in the Way You Might Think](#user-content-link29)
**Authors:** Tim Kaiser, Markus Kollmann

30. [Exhaustive Circuit Mapping of a Single-Cell Foundation Model Reveals Massive Redundancy, Heavy-Tailed Hub Architecture, and Layer-Dependent Differentiation Control](#user-content-link30)
**Authors:** Ihor Kendiukhov

31. [Exponential-Family Membership Inference: From LiRA and RMIA to BaVarIA](#user-content-link31)
**Authors:** Rickard Brännvall

32. [Frequentist Consistency of Prior-Data Fitted Networks for Causal Inference](#user-content-link32)
**Authors:** Valentyn Melnychuk, Vahid Balazadeh, Stefan Feuerriegel, Rahul G. Krishnan

33. [Slack More, Predict Better: Proximal Relaxation for Probabilistic Latent Variable Model-based Soft Sensors](#user-content-link33)
**Authors:** Zehua Zou, Yiran Ma, Yulong Zhang, Zhengnan Li, Zeyu Yang, Jinhao Xie, Xiaoyu Jiang, Zhichao Chen

34. [HCP-DCNet: A Hierarchical Causal Primitive Dynamic Composition Network for Self-Improving Causal Understanding](#user-content-link34)
**Authors:** Ming Lei, Shufan Wu, Christophe Baehr

35. [One-Step Flow Policy: Self-Distillation for Fast Visuomotor Policies](#user-content-link35)
**Authors:** Shaolong Li, Lichao Sun, Yongchao Chen

36. [Revisiting Model Stitching In the Foundation Model Era](#user-content-link36)
**Authors:** Zheda Mai, Ke Zhang, Fu-En Wang, Zixiao Ken Wang, Albert Y. C. Chen, Lu Xia, Min Sun, Wei-Lun Chao, Cheng-Hao Kuo

37. [Byzantine-Robust Optimization under $(L_0, L_1)$-Smoothness](#user-content-link37)
**Authors:** Arman Bolatov, Samuel Horváth, Martin Takáč, Eduard Gorbunov

38. [A Stable Neural Statistical Dependence Estimator for Autoencoder Feature Analysis](#user-content-link38)
**Authors:** Bo Hu, Jose C Principe

39. [Probing Length Generalization in Mamba via Image Reconstruction](#user-content-link39)
**Authors:** Jan Rathjens, Robin Schiewer, Laurenz Wiskott, Anand Subramoney

40. [TaxBreak: Unmasking the Hidden Costs of LLM Inference Through Overhead Decomposition](#user-content-link40)
...
42. [Context-dependent manifold learning: A neuromodulated constrained autoencoder approach](#user-content-link42)
**Authors:** Jérôme Adriaens, Guillaume Drion, Pierre Sacré

43. [Global Evolutionary Steering: Refining Activation Steering Control via Cross-Layer Consistency](#user-content-link43)
**Authors:** Xinyan Jiang, Wenjing Yu, Di Wang, Lijie Hu

44. [NeuroLoRA: Context-Aware Neuromodulation for Parameter-Efficient Multi-Task Adaptation](#user-content-link44)
**Authors:** Yuxin Yang, Haoran Zhang, Mingxuan Li, Jiachen Xu, Ruoxi Shen, Zhenyu Wang, Tianhao Liu, Siqi Chen, Weilin Huang

45. [BiGain: Unified Token Compression for Joint Generation and Classification](#user-content-link45)
**Authors:** Jiacheng Liu, Shengkun Tang, Jiacheng Cui, Dongkuan Xu, Zhiqiang Shen

46. [SpectralGuard: Detecting Memory Collapse Attacks in State Space Models](#user-content-link46)
**Authors:** Davi Bonetto

47. [A Geometrically-Grounded Drive for MDL-Based Optimization in Deep Learning](#user-content-link47)
**Authors:** Ming Lei, Shufan Wu, Christophe Baehr

48. [Efficient Reasoning with Balanced Thinking](#user-content-link48)
**Authors:** Yulin Li, Tengyao Tu, Li Ding, Junjie Wang, Huiling Zhen, Yixin Chen, Yong Li, Zhuotao Tian

49. [Event-Driven Video Generation](#user-content-link49)
**Authors:** Chika Maduabuchi

50. [OrthoEraser: Coupled-Neuron Orthogonal Projection for Concept Erasure](#user-content-link50)
**Authors:** Chuancheng Shi, Wenhua Wu, Fei Shen, Xiaogang Zhu, Kun Hu, Zhiyong Wang

51. [Locating Demographic Bias at the Attention-Head Level in CLIP's Vision Encoder](#user-content-link51)
**Authors:** Alaa Yasser, Kittipat Phunjanna, Marcos Escudero Viñolo, Catarina Barata, Jenny Benois-Pineau

---

## 1. [Statistical and structural identifiability in representation learning](https://arxiv.org/abs/2603.11970) <a id="link1"></a>
...
## 2. [Attention Sinks Are Provably Necessary in Softmax Transformers: Evidence from Trigger-Conditional Tasks](https://arxiv.org/abs/2603.11487) <a id="link2"></a>
...
## 4. [Alternating Gradient Flow Utility: A Unified Metric for Structural Pruning and Dynamic Routing in Deep Networks](https://arxiv.org/abs/2603.12354) <a id="link4"></a>
...
## 5. [Slow-Fast Inference: Training-Free Inference Acceleration via Within-Sentence Support Stability](https://arxiv.org/abs/2603.12038) <a id="link5"></a>
...
## 6. [AdaFuse: Accelerating Dynamic Adapter Inference via Token-Level Pre-Gating and Fused Kernel Optimization](https://arxiv.org/abs/2603.11873) <a id="link6"></a>
...
## 7. [Topological DeepONets and a generalization of the Chen-Chen operator approximation theorem](https://arxiv.org/abs/2603.11972) <a id="link7"></a>
...
## 8. [HiAP: A Multi-Granular Stochastic Auto-Pruning Framework for Vision Transformers](https://arxiv.org/abs/2603.12222) <a id="link8"></a>
...
## 9. [GPrune-LLM: Generalization-Aware Structured Pruning for Large Language Models](https://arxiv.org/abs/2603.13418) <a id="link9"></a>
...
## 10. [LongFlow: Efficient KV Cache Compression for Reasoning M](https://arxiv.org/abs/2603.11504) <a id="link10"></a>
...
## 11. [Disentangled Representation Learning through Unsupervised Symmetry Group Discovery](https://arxiv.org/abs/2603.11790) <a id="link11"></a>
...
## 12. [IndexCache: Accelerating Sparse Attention via Cross-Layer Index Reuse](https://arxiv.org/abs/2603.12201) <a id="link12"></a>
...
## 13. [Chemical Reaction Networks Learn Better than Spiking Neural Networks](https://arxiv.org/abs/2603.12060) <a id="link13"></a>
...
## 14. [Language Generation with Replay: A Learning-Theoretic View of Model Collapse](https://arxiv.org/abs/2603.11784) <a id="link14"></a>
...
## 15. [Neural Thickets: Diverse Task Experts Are Dense Around Pretrained Weights](https://arxiv.org/abs/2603.12228) <a id="link15"></a>
...
## 16. [Sinkhorn-Drifting Generative Models](https://arxiv.org/abs/2603.12366) <a id="link16"></a>
...
## 17. [Pruning-induced phases in fully-connected neural networks: the eumentia, the dementia, and the amentia](https://arxiv.org/abs/2603.12316) <a id="link17"></a>
...
## 18. [Fractional Rotation, Full Potential? Investigating Performance and Convergence of Partial RoPE](https://arxiv.org/abs/2603.11611) <a id="link18"></a>
...
## 19. [Matching Features, Not Tokens: Energy-Based Fine-Tuning of Language Models](https://arxiv.org/abs/2603.12248) <a id="link19"></a>
...
## 20. [Geometry-Aware Probabilistic Circuits via Voronoi Tessellations](https://arxiv.org/abs/2603.11946) <a id="link20"></a>
...
## 21. [Truth as a Compression Artifact in Language Model Training](https://arxiv.org/abs/2603.11749) <a id="link21"></a>
...
## 23. [Harnessing Data Asymmetry: Manifold Learning in the Finsler World](https://arxiv.org/abs/2603.11396) <a id="link23"></a>
...
## 24. [KernelFoundry: Hardware-aware evolutionary GPU kernel optimization](https://arxiv.org/abs/2603.12440) <a id="link24"></a>
...
## 25. [Cornserve: A Distributed Serving System for Any-to-Any Multimodal Models](https://arxiv.org/abs/2603.12118) <a id="link25"></a>
...
## 26. [AutoScout: Structured Optimization for Automating ML System Configuration](https://arxiv.org/abs/2603.11603) <a id="link26"></a>
...
## 27. [Separable neural architectures as a primitive for unified predictive and generative intelligence](https://arxiv.org/abs/2603.12244) <a id="link27"></a>
...
## 28. [A Quantitative Characterization of Forgetting in Post-Training](https://arxiv.org/abs/2603.12163) <a id="link28"></a>
...
## 29. [Diffusion Models Generalize but Not in the Way You Might Think](https://arxiv.org/abs/2603.13419) <a id="link29"></a>
...
## 30. [Exhaustive Circuit Mapping of a Single-Cell Foundation Model Reveals Massive Redundancy, Heavy-Tailed Hub Architecture, and Layer-Dependent Differentiation Control](https://arxiv.org/abs/2603.11940) <a id="link30"></a>
...
## 31. [Exponential-Family Membership Inference: From LiRA and RMIA to BaVarIA](https://arxiv.org/abs/2603.11799) <a id="link31"></a>
...
## 32. [Frequentist Consistency of Prior-Data Fitted Networks for Causal Inference](https://arxiv.org/abs/2603.12037) <a id="link32"></a>
...
## 33. [Slack More, Predict Better: Proximal Relaxation for Probabilistic Latent Variable Model-based Soft Sensors](https://arxiv.org/abs/2603.11473) <a id="link33"></a>
...
## 34. [HCP-DCNet: A Hierarchical Causal Primitive Dynamic Composition Network for Self-Improving Causal Understanding](https://arxiv.org/abs/2603.12305) <a id="link34"></a>
...
## 35. [One-Step Flow Policy: Self-Distillation for Fast Visuomotor Policies](https://arxiv.org/abs/2603.12480) <a id="link35"></a>
...
## 36. [Revisiting Model Stitching In the Foundation Model Era](https://arxiv.org/abs/2603.12433) <a id="link36"></a>
...
## 37. [Byzantine-Robust Optimization under $(L_0, L_1)$-Smoothness](https://arxiv.org/abs/2603.12512) <a id="link37"></a>
...
## 38. [A Stable Neural Statistical Dependence Estimator for Autoencoder Feature Analysis](https://arxiv.org/abs/2603.11428) <a id="link38"></a>
...
## 39. [Probing Length Generalization in Mamba via Image Reconstruction](https://arxiv.org/abs/2603.12499) <a id="link39"></a>
...
## 40. [TaxBreak: Unmasking the Hidden Costs of LLM Inference Through Overhead Decomposition](https://arxiv.org/abs/2603.12465) <a id="link40"></a>
...
## 42. [Context-dependent manifold learning: A neuromodulated constrained autoencoder approach](https://arxiv.org/abs/2603.11673) <a id="link42"></a>
...
## 43. [Global Evolutionary Steering: Refining Activation Steering Control via Cross-Layer Consistency](https://arxiv.org/abs/2603.12298) <a id="link43"></a>
...
## 44. [NeuroLoRA: Context-Aware Neuromodulation for Parameter-Efficient Multi-Task Adaptation](https://arxiv.org/abs/2603.12378) <a id="link44"></a>
...
## 45. [BiGain: Unified Token Compression for Joint Generation and Classification](https://arxiv.org/abs/2603.12240) <a id="link45"></a>
...
## 46. [SpectralGuard: Detecting Memory Collapse Attacks in State Space Models](https://arxiv.org/abs/2603.12414) <a id="link46"></a>
...
## 47. [A Geometrically-Grounded Drive for MDL-Based Optimization in Deep Learning](https://arxiv.org/abs/2603.12304) <a id="link47"></a>
...
## 48. [Efficient Reasoning with Balanced Thinking](https://arxiv.org/abs/2603.12372) <a id="link48"></a>
...
## 49. [Event-Driven Video Generation](https://arxiv.org/abs/2603.13402) <a id="link49"></a>
...
## 50. [OrthoEraser: Coupled-Neuron Orthogonal Projection for Concept Erasure](https://arxiv.org/abs/2603.11493) <a id="link50"></a>
...
## 51. [Locating Demographic Bias at the Attention-Head Level in CLIP's Vision Encoder](https://arxiv.org/abs/2603.11793) <a id="link51"></a>
