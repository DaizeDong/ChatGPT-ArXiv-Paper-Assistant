<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../03"><img src="../../../assets/nav/day/2025-12-04-prev.svg" alt="Previous Day 2025-12-03"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-12-04-center.svg" alt="Monthly Overview 2025-12"></a></div><div style="width: 33.33%; text-align: right;"><a href="../05"><img src="../../../assets/nav/day/2025-12-04-next.svg" alt="Next Day 2025-12-05"></a></div></div>
...
1. [Cache What Lasts: Token Retention for Memory-Bounded KV Cache in LLMs](#user-content-link1)
**Authors:** Ngoc Bui, Shubham Sharma, Simran Lamba, Saumitra Mishra, Rex Ying

2. [Fairy2i: Training Complex LLMs from Real LLMs with All Parameters in $\{\pm 1, \pm i\}$](#user-content-link2)
**Authors:** Feiyu Wang, Xinyu Tan, Bokai Huang, Yihao Zhang, Guoan Wang, Peizhuang Cong, Tong Yang

3. [Understanding and Harnessing Sparsity in Unified Multimodal Models](#user-content-link3)
**Authors:** Shwai He, Chaorui Deng, Ang Li, Shen Yan

4. [UniQL: Unified Quantization and Low-rank Compression for Adaptive Edge LLMs](#user-content-link4)
...
6. [Enforcing Orderedness to Improve Feature Consistency](#user-content-link6)
**Authors:** Sophie L. Wang, Alex Quach, Nithin Parsan, John J. Yang

7. [A note on the impossibility of conditional PAC-efficient reasoning in large language models](#user-content-link7)
**Authors:** Hao Zeng

8. [When does Gaussian equivalence fail and how to fix it: Non-universal behavior of random features with quadratic scaling](#user-content-link8)
**Authors:** Garrett G. Wen, Hong Hu, Yue M. Lu, Zhou Fan, Theodor Misiakiewicz

9. [Globally optimized SVD compression of LLMs via Fermi-function-based rank selection and gauge fixing](#user-content-link9)
**Authors:** Roman Rausch, David Jansen, Sukhbinder Singh, Rom\'an Or\'us

10. [A Preliminary Study on the Promises and Challenges of Native Top-$k$ Sparse Attention](#user-content-link10)
**Authors:** Di Xiu, Hongyin Tang, Bolin Rong, Lizhi Yan, Jingang Wang, Yifan Lu, Xunliang Cai

11. [Think Before You Prune: Self-Reflective Structured Pruning for Reasoning Language Models](#user-content-link11)
**Authors:** Ziyan Wang, Enmao Diao, Qi Le, Pu Wang, Guanchu Wang, Minwoo Lee, Shu-ping Yeh, Li Yang

12. [Convergence for Discrete Parameter Updates](#user-content-link12)
**Authors:** Paul Wilson, Fabio Zanasi, George Constantinides

13. [PSA: Pyramid Sparse Attention for Efficient Video Understanding and Generation](#user-content-link13)
**Authors:** Xiaolong Li, Youping Gu, Xi Lin, Weijie Wang, Bohan Zhuang

14. [CUDA-L2: Surpassing cuBLAS Performance for Matrix Multiplication through Reinforcement Learning](#user-content-link14)
**Authors:** Songqiao Su, Xiaofei Sun, Xiaoya Li, Albert Wang, Jiwei Li, Chris Shum

15. [Data Curation Through the Lens of Spectral Dynamics: Static Limits, Dynamic Acceleration, and Practical Oracles](#user-content-link15)
**Authors:** Yizhou Zhang, Lun Du

16. [Dynamical Properties of Tokens in Self-Attention and Effects of Positional Encoding](#user-content-link16)
**Authors:** Duy-Tung Pham, An The Nguyen, Viet-Hoang Tran, Nhan-Phu Chung, Xin T. Tong, Tan M. Nguyen, Thieu N. Vo

17. [Diagonalizing the Softmax: Hadamard Initialization for Tractable Cross-Entropy Dynamics](#user-content-link17)
**Authors:** Connall Garrod, Jonathan P. Keating, Christos Thrampoulidis

18. [Ada-MoGE: Adaptive Mixture of Gaussian Expert Model for Time Series Forecasting](#user-content-link18)
**Authors:** Zhenliang Ni, Xiaowen Ma, Zhenkai Wu, Shuai Xiao, Han Shu, Xinghao Chen

19. [Probabilistic Foundations of Fuzzy Simplicial Sets for Nonlinear Dimensionality Reduction](#user-content-link19)
**Authors:** Janis Keck (Hannaneh), Lukas Silvester Barth (Hannaneh), Fatemeh (Hannaneh), Fahimi, Parvaneh Joharinad, J\"urgen Jost

20. [Model Recovery at the Edge under Resource Constraints for Physical AI](#user-content-link20)
**Authors:** Bin Xu, Ayan Banerjee, Sandeep K. S. Gupta

21. [AaPE: Aliasing-aware Patch Embedding for Self-Supervised Audio Representation Learning](#user-content-link21)
**Authors:** Kohei Yamamoto, Kosuke Okusa

22. [Optical Context Compression Is Just (Bad) Autoencoding](#user-content-link22)
**Authors:** Ivan Yee Lee, Cheng Yang, Taylor Berg-Kirkpatrick

23. [VLA Models Are More Generalizable Than You Think: Revisiting Physical and Spatial Modeling](#user-content-link23)
**Authors:** Weiqi Li, Quande Zhang, Ruifeng Zhai, Liang Lin, Guangrun Wang

24. [Exploring Depth Generalization in Large Language Models for Solving Recursive Logic Tasks](#user-content-link24)
**Authors:** Zhiyuan He

25. [From monoliths to modules: Decomposing transducers for efficient world modelling](#user-content-link25)
**Authors:** Alexander Boyd, Franz Nowak, David Hyland, Manuel Baltieri, Fernando E. Rosas

26. [Learning Network Sheaves for AI-native Semantic Communication](#user-content-link26)
**Authors:** Enrico Grimaldi, Mario Edoardo Pandolfo, Gabriele D'Acunto, Sergio Barbarossa, Paolo Di Lorenzo

27. [Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models](#user-content-link27)
**Authors:** Xiwen Wei, Mustafa Munir, Radu Marculescu

28. [Tuning-Free Structured Sparse Recovery of Multiple Measurement Vectors using Implicit Regularization](#user-content-link28)
**Authors:** Lakshmi Jayalal, Sheetal Kalyani

29. [Better World Models Can Lead to Better Post-Training Performance](#user-content-link29)
**Authors:** Prakhar Gupta, Henry Conklin, Sarah-Jane Leslie, Andrew Lee

30. [Too Late to Recall: Explaining the Two-Hop Problem in Multimodal Knowledge Retrieval](#user-content-link30)
**Authors:** Constantin Venhoff, Ashkan Khakzar, Sonia Joseph, Philip Torr, Neel Nanda

31. [Domain Feature Collapse: Implications for Out-of-Distribution Detection and Solutions](#user-content-link31)
**Authors:** Hong Yang, Devroop Kar, Qi Yu, Alex Ororbia, Travis Desell

---

## 1. [Cache What Lasts: Token Retention for Memory-Bounded KV Cache in LLMs](https://arxiv.org/abs/2512.03324) <a id="link1"></a>
...
## 2. [Fairy2i: Training Complex LLMs from Real LLMs with All Parameters in $\{\pm 1, \pm i\}$](https://arxiv.org/abs/2512.02901) <a id="link2"></a>
...
## 3. [Understanding and Harnessing Sparsity in Unified Multimodal Models](https://arxiv.org/abs/2512.02351) <a id="link3"></a>
...
## 4. [UniQL: Unified Quantization and Low-rank Compression for Adaptive Edge LLMs](https://arxiv.org/abs/2512.03383) <a id="link4"></a>
...
## 6. [Enforcing Orderedness to Improve Feature Consistency](https://arxiv.org/abs/2512.02194) <a id="link6"></a>
...
## 7. [A note on the impossibility of conditional PAC-efficient reasoning in large language models](https://arxiv.org/abs/2512.03057) <a id="link7"></a>
...
## 8. [When does Gaussian equivalence fail and how to fix it: Non-universal behavior of random features with quadratic scaling](https://arxiv.org/abs/2512.03325) <a id="link8"></a>
...
## 9. [Globally optimized SVD compression of LLMs via Fermi-function-based rank selection and gauge fixing](https://arxiv.org/abs/2512.03062) <a id="link9"></a>
...
## 10. [A Preliminary Study on the Promises and Challenges of Native Top-$k$ Sparse Attention](https://arxiv.org/abs/2512.03494) <a id="link10"></a>
...
## 11. [Think Before You Prune: Self-Reflective Structured Pruning for Reasoning Language Models](https://arxiv.org/abs/2512.02185) <a id="link11"></a>
...
## 12. [Convergence for Discrete Parameter Updates](https://arxiv.org/abs/2512.04051) <a id="link12"></a>
...
## 13. [PSA: Pyramid Sparse Attention for Efficient Video Understanding and Generation](https://arxiv.org/abs/2512.04025) <a id="link13"></a>
...
## 14. [CUDA-L2: Surpassing cuBLAS Performance for Matrix Multiplication through Reinforcement Learning](https://arxiv.org/abs/2512.02551) <a id="link14"></a>
...
## 15. [Data Curation Through the Lens of Spectral Dynamics: Static Limits, Dynamic Acceleration, and Practical Oracles](https://arxiv.org/abs/2512.02409) <a id="link15"></a>
...
## 16. [Dynamical Properties of Tokens in Self-Attention and Effects of Positional Encoding](https://arxiv.org/abs/2512.03058) <a id="link16"></a>
...
## 17. [Diagonalizing the Softmax: Hadamard Initialization for Tractable Cross-Entropy Dynamics](https://arxiv.org/abs/2512.04006) <a id="link17"></a>
...
## 18. [Ada-MoGE: Adaptive Mixture of Gaussian Expert Model for Time Series Forecasting](https://arxiv.org/abs/2512.02061) <a id="link18"></a>
...
## 19. [Probabilistic Foundations of Fuzzy Simplicial Sets for Nonlinear Dimensionality Reduction](https://arxiv.org/abs/2512.03899) <a id="link19"></a>
...
## 20. [Model Recovery at the Edge under Resource Constraints for Physical AI](https://arxiv.org/abs/2512.02283) <a id="link20"></a>
...
## 21. [AaPE: Aliasing-aware Patch Embedding for Self-Supervised Audio Representation Learning](https://arxiv.org/abs/2512.03637) <a id="link21"></a>
...
## 22. [Optical Context Compression Is Just (Bad) Autoencoding](https://arxiv.org/abs/2512.03643) <a id="link22"></a>
...
## 23. [VLA Models Are More Generalizable Than You Think: Revisiting Physical and Spatial Modeling](https://arxiv.org/abs/2512.02902) <a id="link23"></a>
...
## 24. [Exploring Depth Generalization in Large Language Models for Solving Recursive Logic Tasks](https://arxiv.org/abs/2512.02677) <a id="link24"></a>
...
## 25. [From monoliths to modules: Decomposing transducers for efficient world modelling](https://arxiv.org/abs/2512.02193) <a id="link25"></a>
...
## 26. [Learning Network Sheaves for AI-native Semantic Communication](https://arxiv.org/abs/2512.03248) <a id="link26"></a>
...
## 27. [Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models](https://arxiv.org/abs/2512.03125) <a id="link27"></a>
...
## 28. [Tuning-Free Structured Sparse Recovery of Multiple Measurement Vectors using Implicit Regularization](https://arxiv.org/abs/2512.03393) <a id="link28"></a>
...
## 29. [Better World Models Can Lead to Better Post-Training Performance](https://arxiv.org/abs/2512.03400) <a id="link29"></a>
...
## 30. [Too Late to Recall: Explaining the Two-Hop Problem in Multimodal Knowledge Retrieval](https://arxiv.org/abs/2512.03276) <a id="link30"></a>
...
## 31. [Domain Feature Collapse: Implications for Out-of-Distribution Detection and Solutions](https://arxiv.org/abs/2512.04034) <a id="link31"></a>
