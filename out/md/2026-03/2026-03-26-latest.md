...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">181118</td>
            <td align="center">6076</td>
            <td align="center">187194</td>
...
1. [MSA: Memory Sparse Attention for Efficient End-to-End Memory Model Scaling to 100M Tokens](#user-content-link1)
...
2. [Latent Algorithmic Structure Precedes Grokking: A Mechanistic Study of ReLU MLPs on Modular Arithmetic](#user-content-link2)
**Authors:** Anand Swaroop

3. [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](#user-content-link3)
**Authors:** Andrea Manzoni

4. [Manifold Generalization Provably Proceeds Memorization in Diffusion Models](#user-content-link4)
**Authors:** Zebang Shen, Ya-Ping Hsieh, Niao He

5. [Deep Neural Regression Collapse](#user-content-link5)
**Authors:** Akshay Rangamani, Altay Unal

6. [Beyond Masks: Efficient, Flexible Diffusion Language Models via Deletion-Insertion Processes](#user-content-link6)
...
7. [DVM: Real-Time Kernel Generation for Dynamic AI Models](#user-content-link7)
**Authors:** Jingzhi Fang, Xiong Gao, Renwei Zhang, Zichun Ye, Lei Chen, Jie Zhao, Chengnuo Huang, Hui Xu, Xuefeng Jin

8. [The Geometric Price of Discrete Logic: Context-driven Manifold Dynamics of Number Representations](#user-content-link8)
**Authors:** Long Zhang, Dai-jun Lin, Wei-neng Chen

9. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](#user-content-link9)
**Authors:** Fatih Ilhan, Gaowen Liu, Ramana Rao Kompella, Selim Furkan Tekin, Tiansheng Huang, Zachary Yahn, Yichang Xu, Ling Liu

10. [Perturbation: A simple and efficient adversarial tracer for representation learning in language models](#user-content-link10)
**Authors:** Joshua Rozner, Cory Shain

11. [Minimal Sufficient Representations for Self-interpretable Deep Neural Networks](#user-content-link11)
**Authors:** Zhiyao Tan, Liu Li, Huazhen Lin

12. [HDPO: Hybrid Distillation Policy Optimization via Privileged Self-Distillation](#user-content-link12)
**Authors:** Ken Ding

13. [Kirchhoff-Inspired Neural Networks for Evolving High-Order Perception](#user-content-link13)
...
14. [Polynomial Speedup in Diffusion Models with the Multilevel Euler-Maruyama Method](#user-content-link14)
**Authors:** Arthur Jacot

15. [Uniform Laws of Large Numbers in Product Spaces](#user-content-link15)
**Authors:** Ron Holzman, Shay Moran, Alexander Shlimovich

16. [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](#user-content-link16)
**Authors:** Jimyung Hong, Jaehyung Kim

17. [The Diminishing Returns of Early-Exit Decoding in Modern LLMs](#user-content-link17)
**Authors:** Rui Wei, Rui Du, Hanfei Yu, Devesh Tiwari, Jian Li, Zhaozhuo Xu, Hao Wang

18. [Circuit Complexity of Hierarchical Knowledge Tracing and Implications for Log-Precision Transformers](#user-content-link18)
**Authors:** Naiming Liu, Richard Baraniuk, Shashank Sonkar

19. [Inspection and Control of Self-Generated-Text Recognition Ability in Llama3-8b-Instruct](#user-content-link19)
**Authors:** Christopher Ackerman, Nina Panickssery

20. [Stochastic Dimension-Free Zeroth-Order Estimator for High-Dimensional and High-Order PINNs](#user-content-link20)
...
22. [Project and Generate: Divergence-Free Neural Operators for Incompressible Flows](#user-content-link22)
**Authors:** Xigui Li, Hongwei Zhang, Ruoxi Jiang, Deshu Chen, Chensen Lin, Limei Han, Yuan Qi, Xin Guo, Yuan Cheng

23. [Boost Like a (Var)Pro: Trust-Region Gradient Boosting via Variable Projection](#user-content-link23)
**Authors:** Abhijit Chowdhary, Elizabeth Newman, Deepanshu Verma

24. [Evidence for Limited Metacognition in LLMs](#user-content-link24)
**Authors:** Christopher Ackerman

25. [The Alignment Tax: Response Homogenization in Aligned LLMs and Its Implications for Uncertainty Estimation](#user-content-link25)
**Authors:** Mingyi Liu

26. [Identification of NMF by choosing maximum-volume basis vectors](#user-content-link26)
**Authors:** Qianqian Qi, Zhongming Chen, Peter G. M. van der Heijden

27. [StateLinFormer: Stateful Training Enhancing Long-term Memory in Navigation](#user-content-link27)
**Authors:** Zhiyuan Chen, Yuxuan Zhong, Fan Wang, Bo Yu, Pengtao Shao, Shaoshan Liu, Ning Ding

28. [Self-Distillation for Multi-Token Prediction](#user-content-link28)
**Authors:** Guoliang Zhao, Ruobing Xie, An Wang, Shuaipeng Li, Huaibing Xie, Xingwu Sun

29. [Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep](#user-content-link29)
**Authors:** Tianyi Liu, Ye Lu, Linfeng Zhang, Chen Cai, Jianjun Gao, Yi Wang, Kim-Hui Yap, Lap-Pui Chau

30. [Mitigating Object Hallucinations in LVLMs via Attention Imbalance Rectification](#user-content-link30)
**Authors:** Han Sun, Qin Li, Peixin Wang, Min Zhang

31. [PDGMM-VAE: A Variational Autoencoder with Adaptive Per-Dimension Gaussian Mixture Model Priors for Nonlinear ICA](#user-content-link31)
**Authors:** Yuan-Hao Wei, Yan-Jie Sun

32. [Why the Maximum Second Derivative of Activations Matters for Adversarial Robustness](#user-content-link32)
**Authors:** Yunrui Yu, Hang Su, Jun Zhu

33. [Resolving gradient pathology in physics-informed epidemiological models](#user-content-link33)
**Authors:** Nickson Golooba, Woldegebriel Assefa Woldegerima

34. [Linear-Nonlinear Fusion Neural Operator for Partial Differential Equations](#user-content-link34)
**Authors:** Heng Wu, Junjie Wang, Benzhuo Lu

35. [TuneShift-KD: Knowledge Distillation and Transfer for Fine-tuned Models](#user-content-link35)
**Authors:** Yushi Guan, Jeanine Ohene-Agyei, Daniel Kwan, Jean Sebastien Dandurand, Yifei Zhang, Nandita Vijaykumar

36. [Cost-Sensitive Neighborhood Aggregation for Heterophilous Graphs: When Does Per-Edge Routing Help?](#user-content-link36)
**Authors:** Eyal Weiss

37. [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](#user-content-link37)
**Authors:** Jeonghye Kim, Xufang Luo, Minbeom Kim, Sangmook Lee, Dohyung Kim, Jiwon Jeon, Dongsheng Li, Yuqing Yang

38. [KARMA: Knowledge-Action Regularized Multimodal Alignment for Personalized Search at Taobao](#user-content-link38)
**Authors:** Zhi Sun, Wenming Zhang, Yi Wei, Liren Yu, Zhixuan Zhang, Dan Ou, Haihong Tang

39. [Probing Ethical Framework Representations in Large Language Models: Structure, Entanglement, and Methodological Challenges](#user-content-link39)
**Authors:** Weilun Xu, Alexander Rusnak, Frederic Kaplan

40. [Towards Effective Experiential Learning: Dual Guidance for Utilization and Internalization](#user-content-link40)
**Authors:** Fei Bai, Zhipeng Chen, Chuan Hao, Ming Yang, Ran Tao, Bryan Dai, Wayne Xin Zhao, Jian Yang, Hongteng Xu

41. [CGRL: Causal-Guided Representation Learning for Graph Out-of-Distribution Generalization](#user-content-link41)
**Authors:** Bowen Lu, Liangqiang Yang, Teng Li

---

## 1. [MSA: Memory Sparse Attention for Efficient End-to-End Memory Model Scaling to 100M Tokens](https://arxiv.org/abs/2603.23516) <a id="link1"></a>
...
## 2. [Latent Algorithmic Structure Precedes Grokking: A Mechanistic Study of ReLU MLPs on Modular Arithmetic](https://arxiv.org/abs/2603.23784) <a id="link2"></a>
...
## 3. [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](https://arxiv.org/abs/2603.24044) <a id="link3"></a>
...
## 4. [Manifold Generalization Provably Proceeds Memorization in Diffusion Models](https://arxiv.org/abs/2603.23792) <a id="link4"></a>
...
## 5. [Deep Neural Regression Collapse](https://arxiv.org/abs/2603.23805) <a id="link5"></a>
...
## 6. [Beyond Masks: Efficient, Flexible Diffusion Language Models via Deletion-Insertion Processes](https://arxiv.org/abs/2603.23507) <a id="link6"></a>
...
## 7. [DVM: Real-Time Kernel Generation for Dynamic AI Models](https://arxiv.org/abs/2603.24239) <a id="link7"></a>
...
## 8. [The Geometric Price of Discrete Logic: Context-driven Manifold Dynamics of Number Representations](https://arxiv.org/abs/2603.23577) <a id="link8"></a>
...
## 9. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](https://arxiv.org/abs/2603.23914) <a id="link9"></a>
...
## 10. [Perturbation: A simple and efficient adversarial tracer for representation learning in language models](https://arxiv.org/abs/2603.23821) <a id="link10"></a>
...
## 11. [Minimal Sufficient Representations for Self-interpretable Deep Neural Networks](https://arxiv.org/abs/2603.24041) <a id="link11"></a>
...
## 12. [HDPO: Hybrid Distillation Policy Optimization via Privileged Self-Distillation](https://arxiv.org/abs/2603.23871) <a id="link12"></a>
...
## 13. [Kirchhoff-Inspired Neural Networks for Evolving High-Order Perception](https://arxiv.org/abs/2603.23977) <a id="link13"></a>
...
## 14. [Polynomial Speedup in Diffusion Models with the Multilevel Euler-Maruyama Method](https://arxiv.org/abs/2603.24594) <a id="link14"></a>
...
## 15. [Uniform Laws of Large Numbers in Product Spaces](https://arxiv.org/abs/2603.24493) <a id="link15"></a>
...
## 16. [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](https://arxiv.org/abs/2603.23985) <a id="link16"></a>
...
## 17. [The Diminishing Returns of Early-Exit Decoding in Modern LLMs](https://arxiv.org/abs/2603.23701) <a id="link17"></a>
...
## 18. [Circuit Complexity of Hierarchical Knowledge Tracing and Implications for Log-Precision Transformers](https://arxiv.org/abs/2603.23823) <a id="link18"></a>
...
## 19. [Inspection and Control of Self-Generated-Text Recognition Ability in Llama3-8b-Instruct](https://arxiv.org/abs/2410.02064) <a id="link19"></a>
...
## 20. [Stochastic Dimension-Free Zeroth-Order Estimator for High-Dimensional and High-Order PINNs](https://arxiv.org/abs/2603.24002) <a id="link20"></a>
...
## 22. [Project and Generate: Divergence-Free Neural Operators for Incompressible Flows](https://arxiv.org/abs/2603.24500) <a id="link22"></a>
...
## 23. [Boost Like a (Var)Pro: Trust-Region Gradient Boosting via Variable Projection](https://arxiv.org/abs/2603.23658) <a id="link23"></a>
...
## 24. [Evidence for Limited Metacognition in LLMs](https://arxiv.org/abs/2509.21545) <a id="link24"></a>
...
## 25. [The Alignment Tax: Response Homogenization in Aligned LLMs and Its Implications for Uncertainty Estimation](https://arxiv.org/abs/2603.24124) <a id="link25"></a>
...
## 26. [Identification of NMF by choosing maximum-volume basis vectors](https://arxiv.org/abs/2603.24227) <a id="link26"></a>
...
## 27. [StateLinFormer: Stateful Training Enhancing Long-term Memory in Navigation](https://arxiv.org/abs/2603.23571) <a id="link27"></a>
...
## 28. [Self-Distillation for Multi-Token Prediction](https://arxiv.org/abs/2603.23911) <a id="link28"></a>
...
## 29. [Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep](https://arxiv.org/abs/2603.24260) <a id="link29"></a>
...
## 30. [Mitigating Object Hallucinations in LVLMs via Attention Imbalance Rectification](https://arxiv.org/abs/2603.24058) <a id="link30"></a>
...
## 31. [PDGMM-VAE: A Variational Autoencoder with Adaptive Per-Dimension Gaussian Mixture Model Priors for Nonlinear ICA](https://arxiv.org/abs/2603.23547) <a id="link31"></a>
...
## 32. [Why the Maximum Second Derivative of Activations Matters for Adversarial Robustness](https://arxiv.org/abs/2603.23860) <a id="link32"></a>
...
## 33. [Resolving gradient pathology in physics-informed epidemiological models](https://arxiv.org/abs/2603.23799) <a id="link33"></a>
...
## 34. [Linear-Nonlinear Fusion Neural Operator for Partial Differential Equations](https://arxiv.org/abs/2603.24143) <a id="link34"></a>
...
## 35. [TuneShift-KD: Knowledge Distillation and Transfer for Fine-tuned Models](https://arxiv.org/abs/2603.24518) <a id="link35"></a>
...
## 36. [Cost-Sensitive Neighborhood Aggregation for Heterophilous Graphs: When Does Per-Edge Routing Help?](https://arxiv.org/abs/2603.24291) <a id="link36"></a>
...
## 37. [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://arxiv.org/abs/2603.24472) <a id="link37"></a>
...
## 38. [KARMA: Knowledge-Action Regularized Multimodal Alignment for Personalized Search at Taobao](https://arxiv.org/abs/2603.22779) <a id="link38"></a>
...
## 39. [Probing Ethical Framework Representations in Large Language Models: Structure, Entanglement, and Methodological Challenges](https://arxiv.org/abs/2603.23659) <a id="link39"></a>
...
## 40. [Towards Effective Experiential Learning: Dual Guidance for Utilization and Internalization](https://arxiv.org/abs/2603.24093) <a id="link40"></a>
...
## 41. [CGRL: Causal-Guided Representation Learning for Graph Out-of-Distribution Generalization](https://arxiv.org/abs/2603.24304) <a id="link41"></a>
