<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../15"><img src="../../../assets/nav/day/2025-12-16-prev.svg" alt="Previous Day 2025-12-15"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-12-16-center.svg" alt="Monthly Overview 2025-12"></a></div><div style="width: 33.33%; text-align: right;"><a href="../17"><img src="../../../assets/nav/day/2025-12-16-next.svg" alt="Next Day 2025-12-17"></a></div></div>
...
2. [CoDeQ: End-to-End Joint Model Compression with Dead-Zone Quantizer for High-Sparsity and Low-Precision Networks](#user-content-link2)
**Authors:** Jonathan Wensh{\o}j, Tong Chen, Bob Pepin, Raghavendra Selvan

3. [Superposition as Lossy Compression: Measure with Sparse Autoencoders and Connect to Adversarial Vulnerability](#user-content-link3)
**Authors:** Leonard Bereska, Zoe Tzifa-Kratira, Reza Samavi, Efstratios Gavves

4. [Extending the Context of Pretrained LLMs by Dropping Their Positional Embeddings](#user-content-link4)
**Authors:** Yoav Gelberg, Koshi Eguchi, Takuya Akiba, Edoardo Cetin

5. [BOOST: BOttleneck-Optimized Scalable Training Framework for Low-Rank Large Language Models](#user-content-link5)
**Authors:** Zhengyang Wang, Ziyue Liu, Ruijie Zhang, Avinash Maurya, Paul Hovland, Bogdan Nicolae, Franck Cappello, Zheng Zhang

6. [SkipCat: Rank-Maximized Low-Rank Compression of Large Language Models via Shared Projection and Block Skipping](#user-content-link6)
**Authors:** Yu-Chen Lu, Sheng-Feng Yu, Hui-Hsien Weng, Pei-Shuo Wang, Yu-Fang Hu, Liang Hung-Chun, Hung-Yueh Chiang, Kai-Chiang Wu

7. [Error-Free Linear Attention is a Free Lunch: Exact Solution from Continuous-Time Dynamics](#user-content-link7)
**Authors:** Jingdi Lei, Di Zhang, Soujanya Poria

8. [Improving Recursive Transformers with Mixture of LoRAs](#user-content-link8)
**Authors:** Mohammadmahdi Nouriborji, Morteza Rohanian, Omid Rohanian

9. [Phase transitions reveal hierarchical structure in deep neural networks](#user-content-link9)
**Authors:** Ibrahim Talha Ersoy, Andr\'es Fernando Cardozo Licha, Karoline Wiesner

10. [Resting Neurons, Active Insights: Improving Input Sparsification for Large Language Models](#user-content-link10)
**Authors:** Haotian Xu, Tian Gao, Tsui-Wei Weng, Tengfei Ma

11. [Universality of high-dimensional scaling limits of stochastic gradient descent](#user-content-link11)
**Authors:** Reza Gheissari, Aukosh Jagannath

12. [V-Rex: Real-Time Streaming Video LLM Acceleration via Dynamic KV Cache Retrieval](#user-content-link12)
**Authors:** Donghyuk Kim, Sejeong Yang, Wonjin Shin, Joo-Young Kim

13. [SeVeDo: A Heterogeneous Transformer Accelerator for Low-Bit Inference via Hierarchical Group Quantization and SVD-Guided Mixed Precision](#user-content-link13)
**Authors:** Yuseon Choi, Sangjin Kim, Jungjun Oh, Byeongcheol Kim, Hoi-Jun Yoo

14. [D-STEER - Preference Alignment Techniques Learn to Behave, not to Believe -- Beneath the Surface, DPO as Steering Vector Perturbation in Activation Space](#user-content-link14)
**Authors:** Samarth Raina, Saksham Aggarwal, Aman Chadha, Vinija Jain, Amitava Das

15. [Optimized Architectures for Kolmogorov-Arnold Networks](#user-content-link15)
**Authors:** James Bagrow, Josh Bongard

16. [Self-Motivated Growing Neural Network for Adaptive Architecture via Local Structural Plasticity](#user-content-link16)
**Authors:** Yiyang Jia, Chengxu Zhou

17. [Efficient Vision-Language Reasoning via Adaptive Token Pruning](#user-content-link17)
**Authors:** Xue Li, Xiaonan Song, Henry Hu

18. [Exploring the Design Space of Transition Matching](#user-content-link18)
**Authors:** Uriel Singer, Yaron Lipman

19. [CXL-SpecKV: A Disaggregated FPGA Speculative KV-Cache for Datacenter LLM Serving](#user-content-link19)
**Authors:** Dong Liu, Yanxuan Yu

20. [Spiking Manifesto](#user-content-link20)
**Authors:** Eugene Izhikevich

21. [Stopping Rules for Stochastic Gradient Descent via Anytime-Valid Confidence Sequences](#user-content-link21)
**Authors:** Liviu Aolaritei, Michael I. Jordan

22. [State over Tokens: Characterizing the Role of Reasoning Tokens](#user-content-link22)
**Authors:** Mosh Levy, Zohar Elyoseph, Shauli Ravfogel, Yoav Goldberg

23. [Achieving Approximate Symmetry Is Exponentially Easier than Exact Symmetry](#user-content-link23)
**Authors:** Behrooz Tahmasebi, Melanie Weber

24. [CORE: Contrastive Masked Feature Reconstruction on Graphs](#user-content-link24)
**Authors:** Jianyuan Bo, Yuan Fang

25. [Qonvolution: Towards Learning High-Frequency Signals with Queried Convolution](#user-content-link25)
...
26. [Near-Zero-Overhead Freshness for Recommendation Systems via Inference-Side Model Updates](#user-content-link26)
**Authors:** Wenjun Yu, Sitian Chen, Cheng Chen, Amelie Chi Zhou

27. [Alada: Alternating Adaptation of Momentum Method for Memory-Efficient Matrix Optimization](#user-content-link27)
**Authors:** Xiaoyu He, Yu Cai, Jin Jia, Canxi Huang, Wenqing Chen, Zibin Zheng

28. [Uncovering the Role of Initial Saliency in U-Shaped Attention Bias: Scaling Initial Token Weight for Enhanced Long-Text Processing](#user-content-link28)
**Authors:** Zewen Qiang, Sendong Zhao, Haochun Wang, Bing Qin, Ting Liu

29. [Wait, Wait, Wait... Why Do Reasoning Models Loop?](#user-content-link29)
**Authors:** Charilaos Pipis, Shivam Garg, Vasilis Kontonis, Vaishnavi Shrivastava, Akshay Krishnamurthy, Dimitris Papailiopoulos

30. [Scalable Formal Verification via Autoencoder Latent Space Abstraction](#user-content-link30)
**Authors:** Robert Reed, Morteza Lahijanian, Luca Laurenti

31. [Efficient Adaptive Rejection Sampling for Accelerating Speculative Decoding in Large Language Models](#user-content-link31)
**Authors:** Chendong Sun

32. [PAC-Bayes Bounds for Multivariate Linear Regression and Linear Autoencoders](#user-content-link32)
**Authors:** Ruixin Guo, Ruoming Jin, Xinyu Li, Yang Zhou

33. [High-Dimensional Tensor Discriminant Analysis: Low-Rank Discriminant Structure, Representation Synergy, and Theoretical Guarantees](#user-content-link33)
**Authors:** Elynn Chen, Yuefeng Han, Jiayu Li

34. [DP-CSGP: Differentially Private Stochastic Gradient Push with Compressed Communication](#user-content-link34)
...
## 2. [CoDeQ: End-to-End Joint Model Compression with Dead-Zone Quantizer for High-Sparsity and Low-Precision Networks](https://arxiv.org/abs/2512.12981) <a id="link2"></a>
...
## 3. [Superposition as Lossy Compression: Measure with Sparse Autoencoders and Connect to Adversarial Vulnerability](https://arxiv.org/abs/2512.13568) <a id="link3"></a>
...
## 4. [Extending the Context of Pretrained LLMs by Dropping Their Positional Embeddings](https://arxiv.org/abs/2512.12167) <a id="link4"></a>
...
## 5. [BOOST: BOttleneck-Optimized Scalable Training Framework for Low-Rank Large Language Models](https://arxiv.org/abs/2512.12131) <a id="link5"></a>
...
## 6. [SkipCat: Rank-Maximized Low-Rank Compression of Large Language Models via Shared Projection and Block Skipping](https://arxiv.org/abs/2512.13494) <a id="link6"></a>
...
## 7. [Error-Free Linear Attention is a Free Lunch: Exact Solution from Continuous-Time Dynamics](https://arxiv.org/abs/2512.12602) <a id="link7"></a>
...
## 8. [Improving Recursive Transformers with Mixture of LoRAs](https://arxiv.org/abs/2512.12880) <a id="link8"></a>
...
## 9. [Phase transitions reveal hierarchical structure in deep neural networks](https://arxiv.org/abs/2512.11866) <a id="link9"></a>
...
## 10. [Resting Neurons, Active Insights: Improving Input Sparsification for Large Language Models](https://arxiv.org/abs/2512.12744) <a id="link10"></a>
...
## 11. [Universality of high-dimensional scaling limits of stochastic gradient descent](https://arxiv.org/abs/2512.13634) <a id="link11"></a>
...
## 12. [V-Rex: Real-Time Streaming Video LLM Acceleration via Dynamic KV Cache Retrieval](https://arxiv.org/abs/2512.12284) <a id="link12"></a>
...
## 13. [SeVeDo: A Heterogeneous Transformer Accelerator for Low-Bit Inference via Hierarchical Group Quantization and SVD-Guided Mixed Precision](https://arxiv.org/abs/2512.12930) <a id="link13"></a>
...
## 14. [D-STEER - Preference Alignment Techniques Learn to Behave, not to Believe -- Beneath the Surface, DPO as Steering Vector Perturbation in Activation Space](https://arxiv.org/abs/2512.11838) <a id="link14"></a>
...
## 15. [Optimized Architectures for Kolmogorov-Arnold Networks](https://arxiv.org/abs/2512.12448) <a id="link15"></a>
...
## 16. [Self-Motivated Growing Neural Network for Adaptive Architecture via Local Structural Plasticity](https://arxiv.org/abs/2512.12713) <a id="link16"></a>
...
## 17. [Efficient Vision-Language Reasoning via Adaptive Token Pruning](https://arxiv.org/abs/2512.12701) <a id="link17"></a>
...
## 18. [Exploring the Design Space of Transition Matching](https://arxiv.org/abs/2512.12465) <a id="link18"></a>
...
## 19. [CXL-SpecKV: A Disaggregated FPGA Speculative KV-Cache for Datacenter LLM Serving](https://arxiv.org/abs/2512.11920) <a id="link19"></a>
...
## 20. [Spiking Manifesto](https://arxiv.org/abs/2512.11843) <a id="link20"></a>
...
## 21. [Stopping Rules for Stochastic Gradient Descent via Anytime-Valid Confidence Sequences](https://arxiv.org/abs/2512.13123) <a id="link21"></a>
...
## 22. [State over Tokens: Characterizing the Role of Reasoning Tokens](https://arxiv.org/abs/2512.12777) <a id="link22"></a>
...
## 23. [Achieving Approximate Symmetry Is Exponentially Easier than Exact Symmetry](https://arxiv.org/abs/2512.11855) <a id="link23"></a>
...
## 24. [CORE: Contrastive Masked Feature Reconstruction on Graphs](https://arxiv.org/abs/2512.13235) <a id="link24"></a>
...
## 25. [Qonvolution: Towards Learning High-Frequency Signals with Queried Convolution](https://arxiv.org/abs/2512.12898) <a id="link25"></a>
...
## 26. [Near-Zero-Overhead Freshness for Recommendation Systems via Inference-Side Model Updates](https://arxiv.org/abs/2512.12295) <a id="link26"></a>
...
## 27. [Alada: Alternating Adaptation of Momentum Method for Memory-Efficient Matrix Optimization](https://arxiv.org/abs/2512.13034) <a id="link27"></a>
...
## 28. [Uncovering the Role of Initial Saliency in U-Shaped Attention Bias: Scaling Initial Token Weight for Enhanced Long-Text Processing](https://arxiv.org/abs/2512.13109) <a id="link28"></a>
...
## 29. [Wait, Wait, Wait... Why Do Reasoning Models Loop?](https://arxiv.org/abs/2512.12895) <a id="link29"></a>
...
## 30. [Scalable Formal Verification via Autoencoder Latent Space Abstraction](https://arxiv.org/abs/2512.13593) <a id="link30"></a>
...
## 31. [Efficient Adaptive Rejection Sampling for Accelerating Speculative Decoding in Large Language Models](https://arxiv.org/abs/2512.13194) <a id="link31"></a>
...
## 32. [PAC-Bayes Bounds for Multivariate Linear Regression and Linear Autoencoders](https://arxiv.org/abs/2512.12905) <a id="link32"></a>
...
## 33. [High-Dimensional Tensor Discriminant Analysis: Low-Rank Discriminant Structure, Representation Synergy, and Theoretical Guarantees](https://arxiv.org/abs/2512.12122) <a id="link33"></a>
...
## 34. [DP-CSGP: Differentially Private Stochastic Gradient Push with Compressed Communication](https://arxiv.org/abs/2512.13583) <a id="link34"></a>
