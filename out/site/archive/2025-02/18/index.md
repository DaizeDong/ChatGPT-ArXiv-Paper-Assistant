...
<td style="border: none; padding: 0px; width: 33%;">
            <div style="display: flex; align-items: center; gap: 5px;">
                <a href="../17" style="text-decoration: none; color: inherit;">
                    <strong style="color: black; font-size: 18px;">&larr;</strong>
                </a>
                <div style="text-align: center;">
                    <a href="../17" style="text-decoration: none;">
                        <strong>Previous Day</strong>
                    </a>
                    <br>
                    <a href="../17" style="text-decoration: none; font-size: 14px; color: gray;">
                        2025-02-17
                    </a>
                </div>
            </div>
...
<td style="border: none; padding: 0px; width: 33%;">
            <div style="display: flex; align-items: center; gap: 5px; justify-content: flex-end; width: 100%;">
                <div style="text-align: center;">
                    <a href="../19" style="text-decoration: none;">
                        <strong>Next Day</strong>
                    </a>
                    <br>
                    <a href="../19" style="text-decoration: none; font-size: 14px; color: gray;">
                        2025-02-19
                    </a>
                </div>
                <a href="../19" style="text-decoration: none; color: inherit;">
