<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../29"><img src="../../../assets/nav/day/2025-12-30-prev.svg" alt="Previous Day 2025-12-29"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-12-30-center.svg" alt="Monthly Overview 2025-12"></a></div><div style="width: 33.33%; text-align: right;"><a href="../31"><img src="../../../assets/nav/day/2025-12-30-next.svg" alt="Next Day 2025-12-31"></a></div></div>
...
2. [End-to-End Test-Time Training for Long Context](#user-content-link2)
...
3. [MoR: Mixture Of Representations For Mixed-Precision Training](#user-content-link3)
**Authors:** Bor-Yiing Su, Peter Dykas, Mike Chrzanowski, Jatin Chhugani

4. [Breaking the Memory Wall: Exact Analytical Differentiation via Tiled Operator-Space Evolution](#user-content-link4)
**Authors:** Shuhuan Wang, Yuzhen Xie, Jiayi Li, Yinliang Diao

5. [Efficient MoE Inference with Fine-Grained Scheduling of Disaggregated Expert Parallelism](#user-content-link5)
**Authors:** Xinglin Pan, Shaohuai Shi, Wenxiang Lin, Yuxin Wang, Zhenheng Tang, Wei Wang, Xiaowen Chu

6. [Pruning as a Game: Equilibrium-Driven Sparsification of Neural Networks](#user-content-link6)
**Authors:** Zubair Shah, Noaman Khan

7. [Coupling Experts and Routers in Mixture-of-Experts via an Auxiliary Loss](#user-content-link7)
**Authors:** Ang Lv, Jin Ma, Yiyuan Ma, Siyuan Qiao

8. [Likelihood-Preserving Embeddings for Statistical Inference](#user-content-link8)
**Authors:** Deniz Akdemir

9. [Gradient Dynamics of Attention: How Cross-Entropy Sculpts Bayesian Manifolds](#user-content-link9)
**Authors:** Naman Aggarwal, Siddhartha R. Dalal, Vishal Misra

10. [The Bayesian Geometry of Transformer Attention](#user-content-link10)
**Authors:** Naman Aggarwal, Siddhartha R. Dalal, Vishal Misra

11. [AFA-LoRA: Enabling Non-Linear Adaptations in LoRA with Activation Function Annealing](#user-content-link11)
**Authors:** Jiacheng Li, Jianchao Tan, Zhidong Yang, Feiye Huo, Yerui Sun, Yuchen Xie, Xunliang Cai

12. [Towards Unsupervised Causal Representation Learning via Latent Additive Noise Model Causal Autoencoders](#user-content-link12)
**Authors:** Hans Jarett J. Ong, Brian Godwin S. Lim, Dominic Dayta, Renzo Roel P. Tan, Kazushi Ikeda

13. [On Harnessing Idle Compute at the Edge for Foundation Model Training](#user-content-link13)
**Authors:** Leyang Xue, Meghana Madhyastha, Myungjin Lee, Amos Storkey, Randal Burns, Mahesh K. Marina

14. [Visual Language Hypothesis](#user-content-link14)
**Authors:** Xiu Li

15. [Mirage Persistent Kernel: A Compiler and Runtime for Mega-Kernelizing Tensor Programs](#user-content-link15)
...
16. [Interpretable Safety Alignment via SAE-Constructed Low-Rank Subspace Adaptation](#user-content-link16)
**Authors:** Dianyun Wang, Qingsen Ma, Yuhu Shang, Zhifeng Lu, Lechen Ning, Zhenbo Xu, Huijia Wu, Zhaofeng He

17. [The Law of Multi-Model Collaboration: Scaling Limits of Model Ensembling for Large Language Models](#user-content-link17)
**Authors:** Dakuan Lu, Jiaqi Zhang, Cheng Yuan, Jiawei Shao, Chi Zhang, Xuelong Li

18. [On the Existence and Behaviour of Secondary Attention Sinks](#user-content-link18)
**Authors:** Jeffrey T. H. Wong, Cheng Zhang, Louis Mahon, Wayne Luk, Anton Isopoussu, Yiren Zhao

19. [FRoD: Full-Rank Efficient Fine-Tuning with Rotational Degrees for Fast Convergence](#user-content-link19)
**Authors:** Guoan Wan, Tianyu Chen, Fangzheng Feng, Haoyi Zhou, Runhua Xu

20. [The Quest for Winning Tickets in Low-Rank Adapters](#user-content-link20)
**Authors:** Hamed Damirchi, Cristian Rodriguez-Opazo, Ehsan Abbasnejad, Zhen Zhang, Javen Shi

21. [Communication Compression for Distributed Learning with Aggregate and Server-Guided Feedback](#user-content-link21)
**Authors:** Tomas Ortega, Chun-Yin Huang, Xiaoxiao Li, Hamid Jafarkhani

22. [Merge before Forget: A Single LoRA Continual Learning via Continual Merging](#user-content-link22)
**Authors:** Fuli Qiao, Mehrdad Mahdavi

23. [Optimizing Resource Allocation for Geographically-Distributed Inference by Large Language Models](#user-content-link23)
**Authors:** Tingyang Sun, Ting He, Bo Ji, Parimal Parag

24. [Transformer Reconstructed with Dynamic Value Attention](#user-content-link24)
**Authors:** Xiaowei Wang

25. [Theoretical Foundations of Scaling Law in Familial Models](#user-content-link25)
**Authors:** Huan Song, Qingfei Zhao, Ting Long, Shuyu Tian, Hongjun An, Jiawei Shao, Chi Zhang, Xuelong Li

26. [Random Controlled Differential Equations](#user-content-link26)
**Authors:** Francesco Piatti, Thomas Cass, William F. Turner

27. [Clipped Gradient Methods for Nonsmooth Convex Optimization under Heavy-Tailed Noise: A Refined Analysis](#user-content-link27)
**Authors:** Zijian Liu

28. [Semiparametric Preference Optimization: Your Language Model is Secretly a Single-Index Model](#user-content-link28)
**Authors:** Nathan Kallus

29. [Decomposing Task Vectors for Refined Model Editing](#user-content-link29)
**Authors:** Hamed Damirchi, Ehsan Abbasnejad, Zhen Zhang, Javen Shi

30. [GLUE: Gradient-free Learning to Unify Experts](#user-content-link30)
**Authors:** Jong-Ik Park, Shreyas Chaudhari, Srinivasa Pranav, Carlee Joe-Wong, Jos\'e M. F. Moura

31. [Rethinking Fine-Tuning: Unlocking Hidden Capabilities in Vision-Language Models](#user-content-link31)
**Authors:** Mingyuan Zhang, Yue Bai, Yifan Wang, Yiyang Huang, Yun Fu

32. [Splitwise: Collaborative Edge-Cloud Inference for LLMs via Lyapunov-Assisted DRL](#user-content-link32)
**Authors:** Abolfazl Younesi, Abbas Shabrang Maryan, Elyas Oustad, Zahra Najafabadi Samani, Mohsen Ansari, Thomas Fahringer

33. [Completed Hyperparameter Transfer across Modules, Width, Depth, Batch and Duration](#user-content-link33)
**Authors:** Bruno Mlodozeniec, Pierre Ablin, Louis B\'ethune, Dan Busbridge, Michal Klein, Jason Ramapuram, Marco Cuturi

34. [Beyond Centralization: Provable Communication Efficient Decentralized Multi-Task Learning](#user-content-link34)
**Authors:** Donghwa Kang, Shana Moothedath

35. [Understanding the Mechanisms of Fast Hyperparameter Transfer](#user-content-link35)
**Authors:** Nikhil Ghosh, Denny Wu, Alberto Bietti

36. [How Much Data Is Enough? Uniform Convergence Bounds for Generative & Vision-Language Models under Low-Dimensional Structure](#user-content-link36)
**Authors:** Paul M. Thompson

37. [The Affine Divergence: Aligning Activation Updates Beyond Normalisation](#user-content-link37)
**Authors:** George Bird

38. [LLMBoost: Make Large Language Models Stronger with Boosting](#user-content-link38)
...
39. [A general framework for deep learning](#user-content-link39)
**Authors:** William Kengne, Modou Wade

40. [Frequency Regularization: Unveiling the Spectral Inductive Bias of Deep Neural Networks](#user-content-link40)
**Authors:** Jiahao Lu

41. [Multiple Token Divergence: Measuring and Steering In-Context Computation Density](#user-content-link41)
**Authors:** Vincent Herrmann, Eric Alcaide, Michael Wand, J\"urgen Schmidhuber

42. [Do Latent Tokens Think? A Causal and Adversarial Analysis of Chain-of-Continuous-Thought](#user-content-link42)
...
## 2. [End-to-End Test-Time Training for Long Context](https://arxiv.org/abs/2512.23675) <a id="link2"></a>
...
**Comment:** Treats long-context handling as test-time training with meta-learned initialization on a standard sliding-window Transformer; achieves constant-latency inference — strong efficiency/training-dynamics innovation.
...
## 3. [MoR: Mixture Of Representations For Mixed-Precision Training](https://arxiv.org/abs/2512.22804) <a id="link3"></a>
...
**Comment:** Matches Compression/Efficiency: dynamic per-tensor and sub-tensor mixed-precision selection (FP8 vs BF16) based on tensor properties to robustly scale low-precision training.
...
## 4. [Breaking the Memory Wall: Exact Analytical Differentiation via Tiled Operator-Space Evolution](https://arxiv.org/abs/2512.23068) <a id="link4"></a>
...
**Comment:** Matches High Performance Computing: O(1) memory exact differentiation for SSMs via tiled operator-space evolution (PGF), enabling long-sequence training/sensitivity analysis on limited hardware.
...
## 5. [Efficient MoE Inference with Fine-Grained Scheduling of Disaggregated Expert Parallelism](https://arxiv.org/abs/2512.21487) <a id="link5"></a>
...
**Comment:** HPC + MoE: fine-grained scheduling for disaggregated expert parallelism to optimize MoE inference throughput with algorithmic solver.
...
## 6. [Pruning as a Game: Equilibrium-Driven Sparsification of Neural Networks](https://arxiv.org/abs/2512.22106) <a id="link6"></a>
...
**Comment:** Core compression: game-theoretic formulation where sparsity emerges at equilibrium; yields an interpretable pruning algorithm.
...
## 7. [Coupling Experts and Routers in Mixture-of-Experts via an Auxiliary Loss](https://arxiv.org/abs/2512.23447) <a id="link7"></a>
...
**Comment:** Direct MoE advancement: auxiliary expert–router coupling loss aligning router embeddings with expert capabilities; computationally efficient and scales with experts, matching the MoE architecture criterion.
...
## 8. [Likelihood-Preserving Embeddings for Statistical Inference](https://arxiv.org/abs/2512.22638) <a id="link8"></a>
...
**Comment:** Likelihood-preserving embeddings with explicit bounds (approximate sufficient statistics); strong theory for representation learning/compression for inference.
...
## 9. [Gradient Dynamics of Attention: How Cross-Entropy Sculpts Bayesian Manifolds](https://arxiv.org/abs/2512.22473) <a id="link9"></a>
...
**Comment:** Matches: Representation Learning (theoretical gradient dynamics of attention) explaining how cross-entropy sculpts internal geometry.
...
## 10. [The Bayesian Geometry of Transformer Attention](https://arxiv.org/abs/2512.22471) <a id="link10"></a>
...
**Comment:** Matches Representation Learning and Architecture Analysis: mechanistic evidence that transformer attention implements Bayesian inference via geometric roles of residuals/FFN/attention.
...
## 11. [AFA-LoRA: Enabling Non-Linear Adaptations in LoRA with Activation Function Annealing](https://arxiv.org/abs/2512.22455) <a id="link11"></a>
...
**Comment:** Compression/Efficiency: PEFT (LoRA) with annealed activation to gain non-linear expressivity while remaining mergeable for efficient adaptation.
...
## 12. [Towards Unsupervised Causal Representation Learning via Latent Additive Noise Model Causal Autoencoders](https://arxiv.org/abs/2512.22150) <a id="link12"></a>
...
**Comment:** Representation Learning: causal autoencoder with ANM inductive bias and identifiability analysis; architectural innovation via differentiable ANM layer in WAE.
...
## 13. [On Harnessing Idle Compute at the Edge for Foundation Model Training](https://arxiv.org/abs/2512.22142) <a id="link13"></a>
...
**Comment:** Distributed training innovation for edge devices via selective hybrid tensor parallelism and PS-centric design (HPC/distributed training).
...
## 14. [Visual Language Hypothesis](https://arxiv.org/abs/2512.23335) <a id="link14"></a>
...
**Comment:** Matches: Representation Learning (topological theory of semantics) and Model Architecture (architectural requirements for topology change).
...
## 15. [Mirage Persistent Kernel: A Compiler and Runtime for Mega-Kernelizing Tensor Programs](https://arxiv.org/abs/2512.22219) <a id="link15"></a>
...
**Comment:** Matches: High Performance Computing (compiler/runtime mega-kernelization, SM-level task graphs for end-to-end fusion).
...
## 16. [Interpretable Safety Alignment via SAE-Constructed Low-Rank Subspace Adaptation](https://arxiv.org/abs/2512.23260) <a id="link16"></a>
...
**Comment:** Matches: Model Compression and Efficiency (low-rank subspace adapters) and Representation Learning (SAE-based interpretable feature subspace).
...
## 17. [The Law of Multi-Model Collaboration: Scaling Limits of Model Ensembling for Large Language Models](https://arxiv.org/abs/2512.23340) <a id="link17"></a>
...
**Comment:** Foundational scaling-law theory for ensembling LLMs (multi-model collaboration), directly addressing model architecture/ensembling limits and diversity effects.
...
## 18. [On the Existence and Behaviour of Secondary Attention Sinks](https://arxiv.org/abs/2512.22213) <a id="link18"></a>
...
**Comment:** Mechanistic analysis of attention sinks (secondary sinks) in Transformers — deep representation/architecture insight into attention behavior and MLP roles.
...
## 19. [FRoD: Full-Rank Efficient Fine-Tuning with Rotational Degrees for Fast Convergence](https://arxiv.org/abs/2512.23485) <a id="link19"></a>
...
**Comment:** Matches Model Compression and Efficiency: parameter-efficient fine-tuning via hierarchical decomposition and sparse rotational full-rank updates for faster, robust convergence.
...
## 20. [The Quest for Winning Tickets in Low-Rank Adapters](https://arxiv.org/abs/2512.22495) <a id="link20"></a>
...
**Comment:** Matches Compression/Efficiency and Sparsity: extends Lottery Ticket Hypothesis to LoRA and introduces Partial-LoRA for sparse low-rank adapters with large parameter savings.
...
## 21. [Communication Compression for Distributed Learning with Aggregate and Server-Guided Feedback](https://arxiv.org/abs/2512.22623) <a id="link21"></a>
...
**Comment:** Matches Distributed Training/Communication Compression: CAFe and CAFe-S enable biased compression with aggregate/server-guided feedback and convergence guarantees without client-side state.
...
## 22. [Merge before Forget: A Single LoRA Continual Learning via Continual Merging](https://arxiv.org/abs/2512.23017) <a id="link22"></a>
...
**Comment:** Compression/Efficiency: continual LoRA merging with orthogonal basis and time-aware scaling, maintaining constant memory and mitigating interference.
...
## 23. [Optimizing Resource Allocation for Geographically-Distributed Inference by Large Language Models](https://arxiv.org/abs/2512.21884) <a id="link23"></a>
...
**Comment:** HPC/Systems: optimization of block placement and request routing for geographically distributed LLM inference with validated performance models and provable guarantees.
...
## 24. [Transformer Reconstructed with Dynamic Value Attention](https://arxiv.org/abs/2512.22212) <a id="link24"></a>
...
**Comment:** Matches: Model Architecture (Dynamic Value Attention replacing multi-head+FFN) and Efficiency (reduced heads and training time).
...
## 25. [Theoretical Foundations of Scaling Law in Familial Models](https://arxiv.org/abs/2512.23407) <a id="link25"></a>
...
**Comment:** Matches Scaling Laws/Architecture: unified scaling law L(N,D,G) for familial models with early exits/relay inference, quantifying granularity alongside size and data.
...
## 26. [Random Controlled Differential Equations](https://arxiv.org/abs/2512.23670) <a id="link26"></a>
...
**Comment:** Model Architecture and Efficiency: random-feature controlled differential equation reservoirs with only a linear readout; kernel-limit theory for efficient time-series representation learning.
...
## 27. [Clipped Gradient Methods for Nonsmooth Convex Optimization under Heavy-Tailed Noise: A Refined Analysis](https://arxiv.org/abs/2512.23178) <a id="link27"></a>
...
**Comment:** Optimization theory for SGD with gradient clipping under heavy-tailed noise; refined rates and lower bounds (training dynamics/optimization).
...
## 28. [Semiparametric Preference Optimization: Your Language Model is Secretly a Single-Index Model](https://arxiv.org/abs/2512.21917) <a id="link28"></a>
...
**Comment:** Matches: Representation Learning (preference alignment via semiparametric single-index modeling) with theoretical policy error bounds.
...
## 29. [Decomposing Task Vectors for Refined Model Editing](https://arxiv.org/abs/2512.22511) <a id="link29"></a>
...
**Comment:** Matches: Representation Learning (task vector decomposition into shared/unique subspaces) enabling controlled model editing.
...
## 30. [GLUE: Gradient-free Learning to Unify Experts](https://arxiv.org/abs/2512.22467) <a id="link30"></a>
...
**Comment:** Matches Model Architecture: gradient-free convex weight-space mixing (SPSA-learned mixture coefficients) to unify multiple pretrained experts for initialization.
...
## 31. [Rethinking Fine-Tuning: Unlocking Hidden Capabilities in Vision-Language Models](https://arxiv.org/abs/2512.23073) <a id="link31"></a>
...
**Comment:** Matches Model Architecture and Efficiency: mask fine-tuning with learnable gating scores to reconfigure internal subnetworks in VLMs without weight updates.
...
## 32. [Splitwise: Collaborative Edge-Cloud Inference for LLMs via Lyapunov-Assisted DRL](https://arxiv.org/abs/2512.23310) <a id="link32"></a>
...
**Comment:** Matches Systems/HPC for inference: fine-grained transformer sub-block partitioning across edge–cloud optimized via Lyapunov-assisted DRL to minimize latency/energy under bandwidth variability.
...
## 33. [Completed Hyperparameter Transfer across Modules, Width, Depth, Batch and Duration](https://arxiv.org/abs/2512.22382) <a id="link33"></a>
...
**Comment:** Matches HPC/Training Optimization: Complete^(d) parameterization for transferring global and per-module hyperparameters across width, depth, batch size, and training duration.
...
## 34. [Beyond Centralization: Provable Communication Efficient Decentralized Multi-Task Learning](https://arxiv.org/abs/2512.22675) <a id="link34"></a>
...
**Comment:** HPC/Distributed training and Representation Learning: communication-efficient decentralized multi-task learning with shared low-rank structure and provable time/communication/sample complexity.
...
## 35. [Understanding the Mechanisms of Fast Hyperparameter Transfer](https://arxiv.org/abs/2512.22768) <a id="link35"></a>
...
**Comment:** Training dynamics/scale-aware tuning: theoretical framework for fast hyperparameter transfer (including μP) and compute-optimal grid search across model width.
...
## 36. [How Much Data Is Enough? Uniform Convergence Bounds for Generative & Vision-Language Models under Low-Dimensional Structure](https://arxiv.org/abs/2512.23109) <a id="link36"></a>
...
**Comment:** Finite-sample uniform convergence bounds under low-dimensional prompt/embedding structure (representation learning theory).
...
## 37. [The Affine Divergence: Aligning Activation Updates Beyond Normalisation](https://arxiv.org/abs/2512.22247) <a id="link37"></a>
...
**Comment:** Matches: Model Architecture (new normalization mechanisms including PatchNorm) and Representation Learning (training dynamics aligning activation updates).
...
## 38. [LLMBoost: Make Large Language Models Stronger with Boosting](https://arxiv.org/abs/2512.22309) <a id="link38"></a>
...
**Comment:** Matches: Model Architecture (boosting-style ensemble with cross-model attention) and Efficiency (near-parallel inference).
...
## 39. [A general framework for deep learning](https://arxiv.org/abs/2512.23425) <a id="link39"></a>
...
**Comment:** Matches: Model Compression and Efficiency (sparse-penalized DNN) and Representation Learning theory (minimax-optimal excess risk under mixing).
...
## 40. [Frequency Regularization: Unveiling the Spectral Inductive Bias of Deep Neural Networks](https://arxiv.org/abs/2512.22192) <a id="link40"></a>
...
**Comment:** Provides representation learning and training-dynamics insights by quantifying spectral inductive bias of regularizers (SSR metric) and analyzing frequency behavior in CNNs.
...
## 41. [Multiple Token Divergence: Measuring and Steering In-Context Computation Density](https://arxiv.org/abs/2512.22944) <a id="link41"></a>
...
**Comment:** Introduces a metric (Multiple Token Divergence) for in-context computation density and a decoding method (Divergence Steering), offering insights and control over computational dynamics in LMs — representation/efficiency criterion.
...
## 42. [Do Latent Tokens Think? A Causal and Adversarial Analysis of Chain-of-Continuous-Thought](https://arxiv.org/abs/2512.21711) <a id="link42"></a>
...
**Comment:** Causal/adversarial analysis of latent tokens in Chain-of-Continuous-Thought, revealing shortcut behavior — insightful representation/behavioral analysis of LM reasoning.
