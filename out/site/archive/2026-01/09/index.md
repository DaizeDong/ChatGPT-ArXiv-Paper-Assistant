<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../08"><img src="../../../assets/nav/day/2026-01-09-prev.svg" alt="Previous Day 2026-01-08"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-01-09-center.svg" alt="Monthly Overview 2026-01"></a></div><div style="width: 33.33%; text-align: right;"><a href="../12"><img src="../../../assets/nav/day/2026-01-09-next.svg" alt="Next Day 2026-01-12"></a></div></div>
...
1. [Token Maturation: Autoregressive Language Generation via Continuous Token Dynamics](#user-content-link1)
**Authors:** Oshri Naparstek

2. [CuMA: Aligning LLMs with Sparse Cultural Values via Demographic-Aware Mixture of Adapters](#user-content-link2)
**Authors:** Ao Sun, Xiaoyu Wang, Zhe Tan, Yu Li, Jiachen Zhu, Shu Su, Yuheng Jia

3. [ADEPT: Adaptive Dynamic Early-Exit Process for Transformers](#user-content-link3)
**Authors:** Sangmin Yoo, Srikanth Malla, Chiho Choi, Wei D. Lu, Joon Hee Choi

4. [A Scheduling Framework for Efficient MoE Inference on Edge GPU-NDP Systems](#user-content-link4)
**Authors:** Qi Wu, Chao Fang, Jiayuan Chen, Ye Lin, Yueqi Zhang, Yichuan Bai, Yuan Du, Li Du

5. [The Illusion of Specialization: Unveiling the Domain-Invariant "Standing Committee" in Mixture-of-Experts Models](#user-content-link5)
**Authors:** Yan Wang, Yitao Xu, Nanhan Shen, Jinyan Su, Jimin Huang, Zining Zhu

6. [When Models Manipulate Manifolds: The Geometry of a Counting Task](#user-content-link6)
**Authors:** Wes Gurnee, Emmanuel Ameisen, Isaac Kauvar, Julius Tarng, Adam Pearce, Chris Olah, Joshua Batson

7. [Robust Reasoning as a Symmetry-Protected Topological Phase](#user-content-link7)
**Authors:** Ilmo Sung

8. [RelayLLM: Efficient Reasoning via Collaborative Decoding](#user-content-link8)
**Authors:** Chengsong Huang, Tong Zheng, Langlin Huang, Jinyuan Li, Haolin Liu, Jiaxin Huang

9. [Bare-Metal Tensor Virtualization: Overcoming the Memory Wall in Edge-AI Inference on ARM64](#user-content-link9)
**Authors:** Bugra Kilictas, Faruk Alpay

10. [Excess Description Length of Learning Generalizable Predictors](#user-content-link10)
**Authors:** Elizabeth Donoway, Hailey Joren, Fabien Roger, Jan Leike

11. [Token-Level LLM Collaboration via FusionRoute](#user-content-link11)
**Authors:** Nuoya Xiong, Yuhang Zhou, Hanqing Zeng, Zhaorun Chen, Furong Huang, Shuchao Bi, Lizhu Zhang, Zhuokai Zhao

12. [Learnable Multipliers: Freeing the Scale of Language Model Matrix Layers](#user-content-link12)
**Authors:** Maksim Velikanov, Ilyas Chahed, Jingwei Zuo, Dhia Eddine Rhaiem, Younes Belkada, Hakim Hacid

13. [Prior-Informed Zeroth-Order Optimization with Adaptive Direction Alignment for Memory-Efficient LLM Fine-Tuning](#user-content-link13)
**Authors:** Feihu Jin, Shipeng Cen, Ying Tan

14. [Paradoxical noise preference in RNNs](#user-content-link14)
**Authors:** Noah Eckstein, Manoj Srinivasan

15. [Controllable LLM Reasoning via Sparse Autoencoder-Based Steering](#user-content-link15)
**Authors:** Yi Fang, Wenjie Wang, Mingfeng Xue, Boyi Deng, Fengli Xu, Dayiheng Liu, Fuli Feng

16. [Bridging Distance and Spectral Positional Encodings via Anchor-Based Diffusion Geometry Approximation](#user-content-link16)
**Authors:** Zimo Yan, Zheng Xie, Runfan Duan, Chang Liu, Wumei Du

17. [Anti-Length Shift: Dynamic Outlier Truncation for Training Efficient Reasoning Models](#user-content-link17)
**Authors:** Wei Wu, Liyi Chen, Congxi Xiao, Tianfu Wang, Qimeng Wang, Chengqiang Lu, Yan Gao, Yi Wu, Yao Hu, Hui Xiong

18. [Distributed Online Convex Optimization with Efficient Communication: Improved Algorithm and Lower bounds](#user-content-link18)
**Authors:** Sifan Yang, Wenhao Yang, Wei Jiang, Lijun Zhang

19. [Discontinuous Galerkin finite element operator network for solving non-smooth PDEs](#user-content-link19)
**Authors:** Kapil Chawla, Youngjoon Hong, Jae Yong Lee, Sanghyun Lee

20. [An Algebraic Representation Theorem for Linear GENEOs in Geometric Machine Learning](#user-content-link20)
**Authors:** Francesco Conti, Patrizio Frosini, Nicola Quercioli

21. [Density Matrix RNN (DM-RNN): A Quantum Information Theoretic Framework for Modeling Musical Context and Polyphony](#user-content-link21)
**Authors:** Joonwon Seo, Mariana Montiel

22. [Safety-Utility Conflicts Are Not Global: Surgical Alignment via Head-Level Diagnosis](#user-content-link22)
**Authors:** Wang Cai, Yilin Wen, Jinchang Hou, Du Su, Guoqiu Wang, Zhonghou Lv, Chenfu Bao, Yunfang Wu

23. [FocusUI: Efficient UI Grounding via Position-Preserving Visual Token Selection](#user-content-link23)
**Authors:** Mingyu Ouyang, Kevin Qinghong Lin, Mike Zheng Shou, Hwee Tou Ng

24. [Scaling Trends for Multi-Hop Contextual Reasoning in Mid-Scale Language Models](#user-content-link24)
**Authors:** Brady Steele, Micah Katz

25. [MQ-GNN: A Multi-Queue Pipelined Architecture for Scalable and Efficient GNN Training](#user-content-link25)
**Authors:** Irfan Ullah, Young-Koo Lee

26. [Aligned explanations in neural networks](#user-content-link26)
**Authors:** Corentin Lobet, Francesca Chiaromonte

27. [Not All Steps are Informative: On the Linearity of LLMs' RLVR Training](#user-content-link27)
**Authors:** Tianle Wang, Zhongyuan Wu, Shenghao Jin, Hao Xu, Wei Chen, Ning Miao

28. [Layer-Order Inversion: Rethinking Latent Multi-Hop Reasoning in Large Language Models](#user-content-link28)
**Authors:** Xukai Liu, Ye Liu, Jipeng Zhang, Yanghai Zhang, Kai Zhang, Qi Liu

29. [Layer-wise Positional Bias in Short-Context Language Modeling](#user-content-link29)
**Authors:** Maryam Rahimi, Mahdi Nouri, Yadollah Yaghoobzadeh

---

## 1. [Token Maturation: Autoregressive Language Generation via Continuous Token Dynamics](https://arxiv.org/abs/2601.04854) <a id="link1"></a>
...
## 2. [CuMA: Aligning LLMs with Sparse Cultural Values via Demographic-Aware Mixture of Adapters](https://arxiv.org/abs/2601.04885) <a id="link2"></a>
...
## 3. [ADEPT: Adaptive Dynamic Early-Exit Process for Transformers](https://arxiv.org/abs/2601.03700) <a id="link3"></a>
...
## 4. [A Scheduling Framework for Efficient MoE Inference on Edge GPU-NDP Systems](https://arxiv.org/abs/2601.03992) <a id="link4"></a>
...
## 5. [The Illusion of Specialization: Unveiling the Domain-Invariant "Standing Committee" in Mixture-of-Experts Models](https://arxiv.org/abs/2601.03425) <a id="link5"></a>
...
## 6. [When Models Manipulate Manifolds: The Geometry of a Counting Task](https://arxiv.org/abs/2601.04480) <a id="link6"></a>
...
## 7. [Robust Reasoning as a Symmetry-Protected Topological Phase](https://arxiv.org/abs/2601.05240) <a id="link7"></a>
...
## 8. [RelayLLM: Efficient Reasoning via Collaborative Decoding](https://arxiv.org/abs/2601.05167) <a id="link8"></a>
...
## 9. [Bare-Metal Tensor Virtualization: Overcoming the Memory Wall in Edge-AI Inference on ARM64](https://arxiv.org/abs/2601.03324) <a id="link9"></a>
...
## 10. [Excess Description Length of Learning Generalizable Predictors](https://arxiv.org/abs/2601.04728) <a id="link10"></a>
...
## 11. [Token-Level LLM Collaboration via FusionRoute](https://arxiv.org/abs/2601.05106) <a id="link11"></a>
...
## 12. [Learnable Multipliers: Freeing the Scale of Language Model Matrix Layers](https://arxiv.org/abs/2601.04890) <a id="link12"></a>
...
## 13. [Prior-Informed Zeroth-Order Optimization with Adaptive Direction Alignment for Memory-Efficient LLM Fine-Tuning](https://arxiv.org/abs/2601.04710) <a id="link13"></a>
...
## 14. [Paradoxical noise preference in RNNs](https://arxiv.org/abs/2601.04539) <a id="link14"></a>
...
## 15. [Controllable LLM Reasoning via Sparse Autoencoder-Based Steering](https://arxiv.org/abs/2601.03595) <a id="link15"></a>
...
## 16. [Bridging Distance and Spectral Positional Encodings via Anchor-Based Diffusion Geometry Approximation](https://arxiv.org/abs/2601.04517) <a id="link16"></a>
...
## 17. [Anti-Length Shift: Dynamic Outlier Truncation for Training Efficient Reasoning Models](https://arxiv.org/abs/2601.03969) <a id="link17"></a>
...
## 18. [Distributed Online Convex Optimization with Efficient Communication: Improved Algorithm and Lower bounds](https://arxiv.org/abs/2601.04907) <a id="link18"></a>
...
## 19. [Discontinuous Galerkin finite element operator network for solving non-smooth PDEs](https://arxiv.org/abs/2601.03668) <a id="link19"></a>
...
## 20. [An Algebraic Representation Theorem for Linear GENEOs in Geometric Machine Learning](https://arxiv.org/abs/2601.03910) <a id="link20"></a>
...
## 21. [Density Matrix RNN (DM-RNN): A Quantum Information Theoretic Framework for Modeling Musical Context and Polyphony](https://arxiv.org/abs/2601.04592) <a id="link21"></a>
...
## 22. [Safety-Utility Conflicts Are Not Global: Surgical Alignment via Head-Level Diagnosis](https://arxiv.org/abs/2601.04262) <a id="link22"></a>
...
## 23. [FocusUI: Efficient UI Grounding via Position-Preserving Visual Token Selection](https://arxiv.org/abs/2601.03928) <a id="link23"></a>
...
**Comment:** Matches Compression/Efficiency: instruction-conditioned visual token selection with positional continuity (PosPad) for efficient VLM grounding.
...
## 24. [Scaling Trends for Multi-Hop Contextual Reasoning in Mid-Scale Language Models](https://arxiv.org/abs/2601.04254) <a id="link24"></a>
...
**Comment:** Architecture/scaling analysis showing MoE reasoning performance aligns with active parameters—core insight into MoE inference compute scaling.
...
## 25. [MQ-GNN: A Multi-Queue Pipelined Architecture for Scalable and Efficient GNN Training](https://arxiv.org/abs/2601.04707) <a id="link25"></a>
...
**Comment:** Multi-queue pipelined GNN training with asynchronous updates, caching, and adaptive queue sizing—systems/HPC innovation for scalable training.
...
## 26. [Aligned explanations in neural networks](https://arxiv.org/abs/2601.04378) <a id="link26"></a>
...
**Comment:** Matches Model Architecture (pseudo-linear PiNets enabling aligned, instance-wise linear predictions) and Representation Learning (linearly readable features).
...
## 27. [Not All Steps are Informative: On the Linearity of LLMs' RLVR Training](https://arxiv.org/abs/2601.04537) <a id="link27"></a>
...
**Comment:** Matches High-Performance/Training Efficiency (algorithmic extrapolation of weights/logits to reduce RLVR computation) and training dynamics analysis.
...
## 28. [Layer-Order Inversion: Rethinking Latent Multi-Hop Reasoning in Large Language Models](https://arxiv.org/abs/2601.03542) <a id="link28"></a>
...
**Comment:** Representation learning/training dynamics: layer-wise analysis of multi-hop reasoning with a probabilistic recall-and-extract framework explaining internal composition.
...
## 29. [Layer-wise Positional Bias in Short-Context Language Modeling](https://arxiv.org/abs/2601.04098) <a id="link29"></a>
...
**Comment:** Representation learning/training dynamics: layer-wise positional bias profiling via attribution, revealing recency/primacy patterns across depth.
