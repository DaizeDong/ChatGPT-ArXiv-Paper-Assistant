...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">116876</td>
            <td align="center">4798</td>
            <td align="center">121674</td>
...
1. [Labeled Compression Schemes for Concept Classes of Finite Functions](#user-content-link1)
**Authors:** Benchong Li

2. [Perturbation: A simple and efficient adversarial tracer for representation learning in language models](#user-content-link2)
**Authors:** Joshua Rozner, Cory Shain

3. [MSA: Memory Sparse Attention for Efficient End-to-End Memory Model Scaling to 100M Tokens](#user-content-link3)
...
4. [Latent Algorithmic Structure Precedes Grokking: A Mechanistic Study of ReLU MLPs on Modular Arithmetic](#user-content-link4)
**Authors:** Anand Swaroop

5. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](#user-content-link5)
**Authors:** Fatih Ilhan, Gaowen Liu, Ramana Rao Kompella, Selim Furkan Tekin, Tiansheng Huang, Zachary Yahn, Yichang Xu, Ling Liu

6. [Manifold Generalization Provably Proceeds Memorization in Diffusion Models](#user-content-link6)
**Authors:** Zebang Shen, Ya-Ping Hsieh, Niao He

7. [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](#user-content-link7)
**Authors:** Andrea Manzoni

8. [StateLinFormer: Stateful Training Enhancing Long-term Memory in Navigation](#user-content-link8)
**Authors:** Zhiyuan Chen, Yuxuan Zhong, Fan Wang, Bo Yu, Pengtao Shao, Shaoshan Liu, Ning Ding

9. [Inspection and Control of Self-Generated-Text Recognition Ability in Llama3-8b-Instruct](#user-content-link9)
**Authors:** Christopher Ackerman, Nina Panickssery

10. [The Geometric Price of Discrete Logic: Context-driven Manifold Dynamics of Number Representations](#user-content-link10)
**Authors:** Long Zhang, Dai-jun Lin, Wei-neng Chen

11. [Identification of NMF by choosing maximum-volume basis vectors](#user-content-link11)
**Authors:** Qianqian Qi, Zhongming Chen, Peter G. M. van der Heijden

12. [Beyond Masks: Efficient, Flexible Diffusion Language Models via Deletion-Insertion Processes](#user-content-link12)
...
13. [Polynomial Speedup in Diffusion Models with the Multilevel Euler-Maruyama Method](#user-content-link13)
**Authors:** Arthur Jacot

14. [Deep Neural Regression Collapse](#user-content-link14)
**Authors:** Akshay Rangamani, Altay Unal

15. [DVM: Real-Time Kernel Generation for Dynamic AI Models](#user-content-link15)
**Authors:** Jingzhi Fang, Xiong Gao, Renwei Zhang, Zichun Ye, Lei Chen, Jie Zhao, Chengnuo Huang, Hui Xu, Xuefeng Jin

16. [Minimal Sufficient Representations for Self-interpretable Deep Neural Networks](#user-content-link16)
**Authors:** Zhiyao Tan, Liu Li, Huazhen Lin

17. [Likelihood hacking in probabilistic program synthesis](#user-content-link17)
**Authors:** Jacek Karwowski, Younesse Kaddar, Zihuiwen Ye, Nikolay Malkin, Sam Staton

18. [AVO: Agentic Variation Operators for Autonomous Evolutionary Search](#user-content-link18)
...
19. [The Alignment Tax: Response Homogenization in Aligned LLMs and Its Implications for Uncertainty Estimation](#user-content-link19)
**Authors:** Mingyi Liu

20. [Kirchhoff-Inspired Neural Networks for Evolving High-Order Perception](#user-content-link20)
...
21. [A Theory of LLM Information Susceptibility](#user-content-link21)
**Authors:** Zhuo-Yang Song, Hua Xing Zhu

22. [Why the Maximum Second Derivative of Activations Matters for Adversarial Robustness](#user-content-link22)
**Authors:** Yunrui Yu, Hang Su, Jun Zhu

23. [The Diminishing Returns of Early-Exit Decoding in Modern LLMs](#user-content-link23)
**Authors:** Rui Wei, Rui Du, Hanfei Yu, Devesh Tiwari, Jian Li, Zhaozhuo Xu, Hao Wang

24. [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](#user-content-link24)
**Authors:** Jimyung Hong, Jaehyung Kim

25. [Resolving gradient pathology in physics-informed epidemiological models](#user-content-link25)
**Authors:** Nickson Golooba, Woldegebriel Assefa Woldegerima

26. [Self-Distillation for Multi-Token Prediction](#user-content-link26)
**Authors:** Guoliang Zhao, Ruobing Xie, An Wang, Shuaipeng Li, Huaibing Xie, Xingwu Sun

27. [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](#user-content-link27)
**Authors:** Jeonghye Kim, Xufang Luo, Minbeom Kim, Sangmook Lee, Dohyung Kim, Jiwon Jeon, Dongsheng Li, Yuqing Yang

28. [Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep](#user-content-link28)
**Authors:** Tianyi Liu, Ye Lu, Linfeng Zhang, Chen Cai, Jianjun Gao, Yi Wang, Kim-Hui Yap, Lap-Pui Chau

29. [Mitigating Object Hallucinations in LVLMs via Attention Imbalance Rectification](#user-content-link29)
**Authors:** Han Sun, Qin Li, Peixin Wang, Min Zhang

30. [Towards Effective Experiential Learning: Dual Guidance for Utilization and Internalization](#user-content-link30)
**Authors:** Fei Bai, Zhipeng Chen, Chuan Hao, Ming Yang, Ran Tao, Bryan Dai, Wayne Xin Zhao, Jian Yang, Hongteng Xu

31. [Sparse Autoencoders for Interpretable Medical Image Representation Learning](#user-content-link31)
**Authors:** Philipp Wesp, Robbie Holland, Vasiliki Sideri-Lampretsa, Sergios Gatidis

32. [Dual-Gated Epistemic Time-Dilation: Autonomous Compute Modulation in Asynchronous MARL](#user-content-link32)
**Authors:** Igor Jankowski

33. [Upper Entropy for 2-Monotone Lower Probabilities](#user-content-link33)
**Authors:** Tuan-Anh Vu, S\'ebastien Destercke, Fr\'ed\'eric Pichon

---

## 1. [Labeled Compression Schemes for Concept Classes of Finite Functions](https://arxiv.org/abs/2603.23561) <a id="link1"></a>
...
## 2. [Perturbation: A simple and efficient adversarial tracer for representation learning in language models](https://arxiv.org/abs/2603.23821) <a id="link2"></a>
...
## 3. [MSA: Memory Sparse Attention for Efficient End-to-End Memory Model Scaling to 100M Tokens](https://arxiv.org/abs/2603.23516) <a id="link3"></a>
...
## 4. [Latent Algorithmic Structure Precedes Grokking: A Mechanistic Study of ReLU MLPs on Modular Arithmetic](https://arxiv.org/abs/2603.23784) <a id="link4"></a>
...
## 5. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](https://arxiv.org/abs/2603.23914) <a id="link5"></a>
...
## 6. [Manifold Generalization Provably Proceeds Memorization in Diffusion Models](https://arxiv.org/abs/2603.23792) <a id="link6"></a>
...
## 7. [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](https://arxiv.org/abs/2603.24044) <a id="link7"></a>
...
## 8. [StateLinFormer: Stateful Training Enhancing Long-term Memory in Navigation](https://arxiv.org/abs/2603.23571) <a id="link8"></a>
...
## 9. [Inspection and Control of Self-Generated-Text Recognition Ability in Llama3-8b-Instruct](https://arxiv.org/abs/2410.02064) <a id="link9"></a>
...
## 10. [The Geometric Price of Discrete Logic: Context-driven Manifold Dynamics of Number Representations](https://arxiv.org/abs/2603.23577) <a id="link10"></a>
...
**Comment:** Analyzes how context induces geometric/topological deformation in residual representations to form discrete logical boundaries, with causal ablations.
...
## 11. [Identification of NMF by choosing maximum-volume basis vectors](https://arxiv.org/abs/2603.24227) <a id="link11"></a>
...
**Comment:** Provides an identifiability theorem and algorithm for maximum-volume-constrained NMF, directly relevant to representation structure and sparse factorization theory.
...
## 12. [Beyond Masks: Efficient, Flexible Diffusion Language Models via Deletion-Insertion Processes](https://arxiv.org/abs/2603.23507) <a id="link12"></a>
...
**Comment:** Introduces a new deletion-insertion diffusion architecture for language modeling with algorithmic gains in variable-length generation efficiency.
...
## 13. [Polynomial Speedup in Diffusion Models with the Multilevel Euler-Maruyama Method](https://arxiv.org/abs/2603.24594) <a id="link13"></a>
...
**Comment:** Proposes a multilevel Euler-Maruyama sampling method that gives a principled polynomial speedup for diffusion inference using multi-fidelity drifts.
...
## 14. [Deep Neural Regression Collapse](https://arxiv.org/abs/2603.23805) <a id="link14"></a>
...
**Comment:** Shows Neural Regression Collapse extends into hidden layers, characterizing low-rank feature formation and training dynamics in deep regression networks.
...
## 15. [DVM: Real-Time Kernel Generation for Dynamic AI Models](https://arxiv.org/abs/2603.24239) <a id="link15"></a>
...
**Comment:** Presents a real-time compiler with bytecode VM execution and dynamic fusion for materially changing execution efficiency of dynamic AI models.
...
## 16. [Minimal Sufficient Representations for Self-interpretable Deep Neural Networks](https://arxiv.org/abs/2603.24041) <a id="link16"></a>
...
**Comment:** Studies minimal sufficient representations in deep networks with theory for recovering minimal dimension and variables, squarely about representation structure.
...
## 17. [Likelihood hacking in probabilistic program synthesis](https://arxiv.org/abs/2603.24126) <a id="link17"></a>
...
**Comment:** Identifies and formalizes a training failure mode in RL for probabilistic program synthesis, with language-level constraints preventing reward hacking.
...
## 18. [AVO: Agentic Variation Operators for Autonomous Evolutionary Search](https://arxiv.org/abs/2603.24517) <a id="link18"></a>
...
**Comment:** Autonomous evolutionary search discovers micro-architectural attention kernel optimizations, a strong systems/efficient inference contribution beyond routine tuning.
...
## 19. [The Alignment Tax: Response Homogenization in Aligned LLMs and Its Implications for Uncertainty Estimation](https://arxiv.org/abs/2603.24124) <a id="link19"></a>
...
**Comment:** Analyzes how alignment training induces response homogenization, giving concrete insight into training dynamics and uncertainty behavior.
...
## 20. [Kirchhoff-Inspired Neural Networks for Evolving High-Order Perception](https://arxiv.org/abs/2603.23977) <a id="link20"></a>
...
**Comment:** Proposes a new state-variable neural layer derived from Kirchhoff-style ODE updates, squarely in core architectural mechanism design.
...
## 21. [A Theory of LLM Information Susceptibility](https://arxiv.org/abs/2603.23626) <a id="link21"></a>
...
**Comment:** Representation/training theory: proposes a formal theory of LLM information susceptibility with scaling-law-style constraints on when fixed vs nested architectures can improve performance.
...
## 22. [Why the Maximum Second Derivative of Activations Matters for Adversarial Robustness](https://arxiv.org/abs/2603.23860) <a id="link22"></a>
...
**Comment:** Studies activation curvature as a mechanistic driver of robustness via Hessian behavior, connecting architectural nonlinearity design to training/generalization dynamics.
...
## 23. [The Diminishing Returns of Early-Exit Decoding in Modern LLMs](https://arxiv.org/abs/2603.23701) <a id="link23"></a>
...
**Comment:** Provides an analysis and benchmark of when early-exit decoding works across architectures, directly about efficient inference and architectural redundancy.
...
## 24. [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](https://arxiv.org/abs/2603.23985) <a id="link24"></a>
...
**Comment:** Training-free structured pruning via task-merged dimension-wise importance scores is a clear compression and sparsity contribution.
...
## 25. [Resolving gradient pathology in physics-informed epidemiological models](https://arxiv.org/abs/2603.23799) <a id="link25"></a>
...
**Comment:** Introduces conflict-gated gradient scaling to resolve gradient conflict in physics-informed training, directly targeting training stability via gradient geometry.
...
## 26. [Self-Distillation for Multi-Token Prediction](https://arxiv.org/abs/2603.23911) <a id="link26"></a>
...
**Comment:** Inference-efficiency method for multi-token prediction using self-distillation to raise head acceptance and stabilize multi-head training.
...
## 27. [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://arxiv.org/abs/2603.24472) <a id="link27"></a>
...
**Comment:** Analyzes a post-training dynamics mechanism: self-distillation suppresses epistemic verbalization, harming OOD reasoning.
...
## 28. [Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep](https://arxiv.org/abs/2603.24260) <a id="link28"></a>
...
**Comment:** Heterogeneous caching for diffusion transformers introduces a new token-selection/cache design for reducing redundant attention computation at inference.
...
## 29. [Mitigating Object Hallucinations in LVLMs via Attention Imbalance Rectification](https://arxiv.org/abs/2603.24058) <a id="link29"></a>
...
**Comment:** Identifies attention imbalance as a mechanistic cause of LVLM hallucination and proposes a decoding-time attention reallocation intervention.
...
## 30. [Towards Effective Experiential Learning: Dual Guidance for Utilization and Internalization](https://arxiv.org/abs/2603.24093) <a id="link30"></a>
...
**Comment:** Large-scale training dynamics: introduces a closed-loop RLVR framework that explicitly uses and internalizes past trajectories via an experience bank to change exploration and optimization behavior.
...
## 31. [Sparse Autoencoders for Interpretable Medical Image Representation Learning](https://arxiv.org/abs/2603.23794) <a id="link31"></a>
...
**Comment:** Uses uncertainty-gated asynchronous execution in MARL to reduce inference frequency, a dynamic-computation mechanism tied to training and credit assignment.
...
## 32. [Dual-Gated Epistemic Time-Dilation: Autonomous Compute Modulation in Asynchronous MARL](https://arxiv.org/abs/2603.23722) <a id="link32"></a>
...
**Comment:** Introduces an SMDP-aligned asynchronous training method with autonomous compute modulation, targeting efficient inference and training dynamics.
...
## 33. [Upper Entropy for 2-Monotone Lower Probabilities](https://arxiv.org/abs/2603.23558) <a id="link33"></a>
...
**Comment:** Computational analysis of upper entropy for 2-monotone lower probabilities gives a strongly polynomial algorithm for uncertainty quantification.
