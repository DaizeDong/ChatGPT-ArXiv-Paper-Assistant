<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../11"><img src="../../../assets/nav/day/2025-12-12-prev.svg" alt="Previous Day 2025-12-11"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-12-12-center.svg" alt="Monthly Overview 2025-12"></a></div><div style="width: 33.33%; text-align: right;"><a href="../15"><img src="../../../assets/nav/day/2025-12-12-next.svg" alt="Next Day 2025-12-15"></a></div></div>

# Personalized Daily ArXiv Papers 2025-12-12

| *[gpt-5]*   | Prompt   | Completion   | Total   |
|:-----------:|:--------:|:------------:|:-------:|
| **Token**   | 34982    | 30291        | 65273   |
| **Cost**    | $0.04    | $0.3         | $0.35   |
...
1. [SparseSwaps: Tractable LLM Pruning Mask Refinement at Scale](#user-content-link1)
**Authors:** Max Zimmer, Christophe Roux, Moritz Wagner, Deborah Hendrych, Sebastian Pokutta

2. [The Operator Origins of Neural Scaling Laws: A Generalized Spectral Transport Dynamics of Deep Learning](#user-content-link2)
**Authors:** Yizhou Zhang

3. [Beyond the Black Box: Identifiable Interpretation and Control in Generative Models via Causal Minimality](#user-content-link3)
**Authors:** Lingjing Kong, Shaoan Xie, Guangyi Chen, Yuewen Sun, Xiangchen Song, Eric P. Xing, Kun Zhang

4. [Unlocking the Address Book: Dissecting the Sparse Semantic Structure of LLM Key-Value Caches via Sparse Autoencoders](#user-content-link4)
...
5. [Stronger Normalization-Free Transformers](#user-content-link5)
**Authors:** Mingzhi Chen, Taiming Lu, Jiachen Zhu, Mingjie Sun, Zhuang Liu

6. [Supervised Learning of Random Neural Architectures Structured by Latent Random Fields on Compact Boundaryless Multiply-Connected Manifolds](#user-content-link6)
**Authors:** Christian Soize

7. [Learning by Analogy: A Causal Framework for Composition Generalization](#user-content-link7)
**Authors:** Lingjing Kong, Shaoan Xie, Yang Jiao, Yetian Chen, Yanhui Guo, Simone Shao, Yan Gao, Guangyi Chen, Kun Zhang

8. [Bidirectional Normalizing Flow: From Data to Noise and Back](#user-content-link8)
**Authors:** Yiyang Lu, Qiao Sun, Xianbang Wang, Zhicheng Jiang, Hanhong Zhao, Kaiming He

9. [Interpretable Embeddings with Sparse Autoencoders: A Data Analysis Toolkit](#user-content-link9)
**Authors:** Nick Jiang, Xiaoqing Sun, Lisa Dunlap, Lewis Smith, Neel Nanda

10. [Design Space Exploration of DMA based Finer-Grain Compute Communication Overlap](#user-content-link10)
**Authors:** Shagnik Pal, Shaizeen Aga, Suchita Pati, Mahzabeen Islam, Lizy K. John

11. [Uncertainty-Preserving QBNNs: Multi-Level Quantization of SVI-Based Bayesian Neural Networks for Image Classification](#user-content-link11)
**Authors:** Hendrik Borras, Yong Wu, Bernhard Klein, Holger Fr\"oning

12. [What matters for Representation Alignment: Global Information or Spatial Structure?](#user-content-link12)
**Authors:** Jaskirat Singh, Xingjian Leng, Zongze Wu, Liang Zheng, Richard Zhang, Eli Shechtman, Saining Xie

13. [LGAN: An Efficient High-Order Graph Neural Network via the Line Graph Aggregation](#user-content-link13)
**Authors:** Lin Du, Lu Bai, Jincheng Li, Lixin Cui, Hangyuan Du, Lichi Zhang, Yuting Chen, Zhao Li

14. [Multi-Granular Node Pruning for Circuit Discovery](#user-content-link14)
**Authors:** Muhammad Umair Haider, Hammad Rizwan, Hassan Sajjad, A. B. Siddique

15. [Mull-Tokens: Modality-Agnostic Latent Thinking](#user-content-link15)
...
16. [Neuronal Attention Circuit (NAC) for Representation Learning](#user-content-link16)
**Authors:** Waleed Razzaq, Izis Kankaraway, Yun-Bo Zhao

17. [Investigating The Functional Roles of Attention Heads in Vision Language Models: Evidence for Reasoning Modules](#user-content-link17)
**Authors:** Yanbei Jiang, Xueqi Ma, Shu Liu, Sarah Monazam Erfani, Tongliang Liu, James Bailey, Jey Han Lau, Krista A. Ehinger

18. [Hybrid Learning and Optimization-Based Dynamic Scheduling for DL Workloads on Heterogeneous GPU Clusters](#user-content-link18)
**Authors:** Shruti Dongare, Redwan Ibne Seraj Khan, Hadeel Albahar, Nannan Zhao, Diego Melendez Maita, Ali R. Butt

19. [Is the Information Bottleneck Robust Enough? Towards Label-Noise Resistant Information Bottleneck Learning](#user-content-link19)
**Authors:** Yi Huang, Qingyun Sun, Yisen Gao, Haonan Yuan, Xingcheng Fu, Jianxin Li

---

## 1. [SparseSwaps: Tractable LLM Pruning Mask Refinement at Scale](https://arxiv.org/abs/2512.10922) <a id="link1"></a>
...
**Comment:** Model Compression and Efficiency: LLM pruning mask refinement via tractable optimal 1-swaps computed from Gram matrices; GPU-scalable.
...
## 2. [The Operator Origins of Neural Scaling Laws: A Generalized Spectral Transport Dynamics of Deep Learning](https://arxiv.org/abs/2512.10427) <a id="link2"></a>
...
**Comment:** Foundational training dynamics: derives a spectral transport–dissipation PDE linking operator geometry to neural scaling laws and double descent, unifying NTK vs feature learning.
...
## 3. [Beyond the Black Box: Identifiable Interpretation and Control in Generative Models via Causal Minimality](https://arxiv.org/abs/2512.10720) <a id="link3"></a>
...
**Comment:** Representation Learning: identifiability and interpretable control via causal minimality with sparsity/compression constraints in generative models.
...
## 4. [Unlocking the Address Book: Dissecting the Sparse Semantic Structure of LLM Key-Value Caches via Sparse Autoencoders](https://arxiv.org/abs/2512.10547) <a id="link4"></a>
...
**Comment:** Model Efficiency + Representation Learning: decomposes KV caches via Top-K sparse autoencoders (sparsity without shrinkage bias) with a dual-budget scheme, informing cache compression/interpretability.
...
## 5. [Stronger Normalization-Free Transformers](https://arxiv.org/abs/2512.10938) <a id="link5"></a>
...
**Comment:** Model Architecture: introduces Derf, a point-wise function enabling stronger normalization-free Transformers, outperforming LayerNorm/RMSNorm/DyT across domains.
...
## 6. [Supervised Learning of Random Neural Architectures Structured by Latent Random Fields on Compact Boundaryless Multiply-Connected Manifolds](https://arxiv.org/abs/2512.10407) <a id="link6"></a>
...
**Comment:** Strong match to Model Architecture (and sparsity): a geometry-aware generative process where architectures/weights emerge from a latent random field on manifolds, yielding sparse connectivity and theoretical properties.
...
## 7. [Learning by Analogy: A Causal Framework for Composition Generalization](https://arxiv.org/abs/2512.10669) <a id="link7"></a>
...
**Comment:** Representation Learning: causal modularity framework with identifiable hierarchical latent structure enabling compositional generalization.
...
## 8. [Bidirectional Normalizing Flow: From Data to Noise and Back](https://arxiv.org/abs/2512.10953) <a id="link8"></a>
...
**Comment:** Model Architecture/Efficiency: relaxes exact invertibility in normalizing flows to enable faster sampling with improved flexibility.
...
## 9. [Interpretable Embeddings with Sparse Autoencoders: A Data Analysis Toolkit](https://arxiv.org/abs/2512.10092) <a id="link9"></a>
...
**Comment:** Representation Learning: uses sparse autoencoders to build interpretable, controllable embeddings (sparse concept features) for large-scale text data analysis.
...
## 10. [Design Space Exploration of DMA based Finer-Grain Compute Communication Overlap](https://arxiv.org/abs/2512.10236) <a id="link10"></a>
...
**Comment:** High Performance Computing: finer-grain compute–communication overlap (FiCCO) with GPU DMA offload and scheduling heuristics for distributed ML training/inference.
...
## 11. [Uncertainty-Preserving QBNNs: Multi-Level Quantization of SVI-Based Bayesian Neural Networks for Image Classification](https://arxiv.org/abs/2512.10602) <a id="link11"></a>
...
**Comment:** Direct match to Model Compression and Efficiency: proposes multi-level quantization (VPQ/SPQ/JQ) for SVI-based Bayesian NNs with logarithmic variance quantization and uncertainty-preserving activations.
...
## 12. [What matters for Representation Alignment: Global Information or Spatial Structure?](https://arxiv.org/abs/2512.10794) <a id="link12"></a>
...
**Comment:** Strongly matches Representation Learning: analyzes which aspects (spatial structure vs. global semantics) drive representational alignment in generative training and proposes simple architectural/normalization tweaks (iREPA).
...
## 13. [LGAN: An Efficient High-Order Graph Neural Network via the Line Graph Aggregation](https://arxiv.org/abs/2512.10735) <a id="link13"></a>
...
**Comment:** Strong match to Model Architecture/Efficiency: proposes a high-order GNN via line graph aggregation with provable greater expressivity than 2-WL and lower time complexity.
...
## 14. [Multi-Granular Node Pruning for Circuit Discovery](https://arxiv.org/abs/2512.10903) <a id="link14"></a>
...
**Comment:** Sparsity/Pruning for circuit discovery with multi-granular learnable masks; improves interpretability while maintaining performance.
...
## 15. [Mull-Tokens: Modality-Agnostic Latent Thinking](https://arxiv.org/abs/2512.10941) <a id="link15"></a>
...
**Comment:** Matches Model Architecture and Representation Learning: introduces modality-agnostic latent tokens for internal multimodal reasoning, enabling dynamic latent thinking without tool calls.
...
## 16. [Neuronal Attention Circuit (NAC) for Representation Learning](https://arxiv.org/abs/2512.10282) <a id="link16"></a>
...
**Comment:** Model Architecture: introduces a continuous-time attention mechanism with sparse gates and Top-K interaction selection, with theoretical guarantees on stability and approximation.
...
## 17. [Investigating The Functional Roles of Attention Heads in Vision Language Models: Evidence for Reasoning Modules](https://arxiv.org/abs/2512.10300) <a id="link17"></a>
...
**Comment:** Representation Learning/Mechanistic Interpretability: identifies sparse functional attention heads mediating multimodal reasoning in VLMs via probing and interventions.
...
## 18. [Hybrid Learning and Optimization-Based Dynamic Scheduling for DL Workloads on Heterogeneous GPU Clusters](https://arxiv.org/abs/2512.10271) <a id="link18"></a>
...
**Comment:** Matches High Performance Computing: proposes a hybrid RL+MILP scheduler (RLTune) for heterogeneous GPU clusters, improving utilization/JCT without per-job profiling.
...
## 19. [Is the Information Bottleneck Robust Enough? Towards Label-Noise Resistant Information Bottleneck Learning](https://arxiv.org/abs/2512.10573) <a id="link19"></a>
...
**Comment:** Representation Learning: robust Information Bottleneck with mutual information bounds and disentanglement under label noise.
