...
<sub>Token counts are not reported for this run. 20 of 37 model calls succeeded, 16,825s of model wall clock.</sub>
...
1. [SubZero+: Efficient Zeroth-Order LLM Fine-Tuning via Large Learning Rates](#paper-2608-15665)
...
3. [EMASAM: a Computationally Efficient Sharpness-Aware Minimization via EMA-Guided Perturbations](#paper-2608-15105)
**Authors:** Tanapat Ratchatorn, Masayuki Tanaka

4. [Deterministic Adam-Inspired Methods with Accelerated Convergence Rate](#paper-2604-08742)
**Authors:** Yaxin Yu, Long Chen, Zeyi Xu

5. [UniFed-VLM: Federated Instruction Tuning for Vision-Language Models with Multiple Heterogeneity](#paper-2608-15516)
...
1. [Directional Curvature from Armijo Backtracking: A Low-Cost Sharpness Probe and a Calibration-Free Learning-Rate Safeguard for Adam](#paper-2607-03998)
**Authors:** Ashmitha R, J̦rg Frochte

2. [Second-Moment Memory in Coordinatewise Adam](#paper-2608-15824)
...
4. [QuantumPhaseNet: A Gauge-Covariant Geometric and Quantum-Spectral Theory of Semantic Concept Hierarchies with Prototype Validation of a Classical Quantum-Inspired Model](#paper-2608-15820)
**Authors:** Kiyotaka Kasubuchi, Kazuo Fukiya

5. [Layers Matter: Why Continual Learning Regularization Should Be Layer-Adaptive](#paper-2608-15901)
...
6. [Near-Equilibrium Propagation training in nonlinear wave systems](#paper-2510-16084)
...
2. [The Distributional View of Knowledge Distillation](#paper-2608-15215)
**Authors:** Gordei Verbii, Juho Lee

3. [LACE-SVD: Loss-Aware SVD with Cumulative Error Correction for LLM Compression](#paper-2607-03057)
**Authors:** Zhuowen Liu, Longkun Hao, Shiyu Feng, Xiaowen Chang, Ruiqun Li, Changqun Li

4. [SAPE: Sandwich Adapters for Parameter Efficiency in Large Language Model Fine-Tuning](#paper-2608-15360)
**Authors:** Mohammad Aref Jafari-Raddani, Morteza Mohajjel Kafshdooz

5. [FedPA-LoRA: Product-Aligned Framework for Mitigating Aggregation and Initialization Errors in Heterogeneous Federated LoRA](#paper-2608-15381)
**Authors:** Juseok Jeon, Ramy E. Ali, Doyun Kwon, Myungbeom Her, Jinhwi Kim, Jinhyun So

6. [DeltaLog: Deferred Materialization of Recurrent States for Linear Attention Decoding](#paper-2608-15533)
**Authors:** Junqing Lin, Jingwei Sun, Guangzhong Sun

7. [Pricing the Risk of Runtime Compression: Anytime-Valid Admission and a Served-Output Law for Compressed Serving State](#paper-2608-15810)
**Authors:** Fanzhe Wei, Li Liu

8. [KV-Rescue: Recovering Reasoning Language Model KV Eviction Loss via Stepwise Interleaving](#paper-2608-15797)
**Authors:** Minsoo Cheong, Woosang Lim, Vincent-Daniel Yun, Sungjoo Yoo

9. [Rethinking Token-wise Feature Caching: Accelerating Diffusion Transformers with Dual Feature Caching](#paper-2412-18911)
**Authors:** Chang Zou, Shikang Zheng, Evelyn Zhang, Runlin Guo, Haohang Xu, Zhengyi Shi, Conghui He, Xuming Hu, Linfeng Zhang

10. [Algorithm-Architecture Co-Design for Efficient VLA Inference via Speculative Inference and Verification](#paper-2608-15636)
**Authors:** Chunyu Qi, Zhuoran Song, Jian Weng, Haozhe Jiang, Xueyuan Liu, Naifeng Jing, Guanghui He, Xiaoyao Liang, Haibing Guan

11. [Global Simulation-Guided Dynamic Operator Scheduling for Efficient Multi-Tenant Model Serving](#paper-2608-15762)
**Authors:** Weinan Liu, Zeyuan Ding, Dian Ding, Chengcheng Wan, Lu Tang, Guangtao Xue, Jiwu Shu, Yiming Zhang

12. [Runtime Observability for Heterogeneous Attention Memory](#paper-2608-05863)
**Authors:** Fanzhe Wei, Li Liu, Ziyang Wang, Chenyu Wang

13. [Funnel of Thoughts: Efficient Test-Time Scaling via Early Voting and Rollout Pruning](#paper-2608-15065)
**Authors:** Chanhee Park, Sungbin Han, Jeongho Yoon, Seongtae Hong, Heuiseok Lim

14. [Whole-Piece Training for Symbolic Music Language Models via Full-Horizon Compressed Recurrence](#paper-2602-19816)
**Authors:** Yungang Yi, Weihua Li, Matthew Kuo, Catherine Shi, Quan Bai

15. [PhaseLoRA: Control-Regime-Conditioned Low-Rank Adaptation for Continuous-Action Vision-Language-Action Policies](#paper-2608-15285)
...
### 1. [SubZero+: Efficient Zeroth-Order LLM Fine-Tuning via Large Learning Rates](https://arxiv.org/abs/2608.15665) <a id="paper-2608-15665"></a>
...
### 3. [EMASAM: a Computationally Efficient Sharpness-Aware Minimization via EMA-Guided Perturbations](https://arxiv.org/abs/2608.15105) <a id="paper-2608-15105"></a>
...
### 4. [Deterministic Adam-Inspired Methods with Accelerated Convergence Rate](https://arxiv.org/abs/2604.08742) <a id="paper-2604-08742"></a>
...
### 5. [UniFed-VLM: Federated Instruction Tuning for Vision-Language Models with Multiple Heterogeneity](https://arxiv.org/abs/2608.15516) <a id="paper-2608-15516"></a>
...
### 1. [Directional Curvature from Armijo Backtracking: A Low-Cost Sharpness Probe and a Calibration-Free Learning-Rate Safeguard for Adam](https://arxiv.org/abs/2607.03998) <a id="paper-2607-03998"></a>
...
### 2. [Second-Moment Memory in Coordinatewise Adam](https://arxiv.org/abs/2608.15824) <a id="paper-2608-15824"></a>
...
### 4. [QuantumPhaseNet: A Gauge-Covariant Geometric and Quantum-Spectral Theory of Semantic Concept Hierarchies with Prototype Validation of a Classical Quantum-Inspired Model](https://arxiv.org/abs/2608.15820) <a id="paper-2608-15820"></a>
...
### 5. [Layers Matter: Why Continual Learning Regularization Should Be Layer-Adaptive](https://arxiv.org/abs/2608.15901) <a id="paper-2608-15901"></a>
...
### 6. [Near-Equilibrium Propagation training in nonlinear wave systems](https://arxiv.org/abs/2510.16084) <a id="paper-2510-16084"></a>
...
### 2. [The Distributional View of Knowledge Distillation](https://arxiv.org/abs/2608.15215) <a id="paper-2608-15215"></a>
...
### 3. [LACE-SVD: Loss-Aware SVD with Cumulative Error Correction for LLM Compression](https://arxiv.org/abs/2607.03057) <a id="paper-2607-03057"></a>
...
### 4. [SAPE: Sandwich Adapters for Parameter Efficiency in Large Language Model Fine-Tuning](https://arxiv.org/abs/2608.15360) <a id="paper-2608-15360"></a>
...
### 5. [FedPA-LoRA: Product-Aligned Framework for Mitigating Aggregation and Initialization Errors in Heterogeneous Federated LoRA](https://arxiv.org/abs/2608.15381) <a id="paper-2608-15381"></a>
...
### 6. [DeltaLog: Deferred Materialization of Recurrent States for Linear Attention Decoding](https://arxiv.org/abs/2608.15533) <a id="paper-2608-15533"></a>
...
### 7. [Pricing the Risk of Runtime Compression: Anytime-Valid Admission and a Served-Output Law for Compressed Serving State](https://arxiv.org/abs/2608.15810) <a id="paper-2608-15810"></a>
...
### 8. [KV-Rescue: Recovering Reasoning Language Model KV Eviction Loss via Stepwise Interleaving](https://arxiv.org/abs/2608.15797) <a id="paper-2608-15797"></a>
...
### 9. [Rethinking Token-wise Feature Caching: Accelerating Diffusion Transformers with Dual Feature Caching](https://arxiv.org/abs/2412.18911) <a id="paper-2412-18911"></a>
...
### 10. [Algorithm-Architecture Co-Design for Efficient VLA Inference via Speculative Inference and Verification](https://arxiv.org/abs/2608.15636) <a id="paper-2608-15636"></a>
...
### 11. [Global Simulation-Guided Dynamic Operator Scheduling for Efficient Multi-Tenant Model Serving](https://arxiv.org/abs/2608.15762) <a id="paper-2608-15762"></a>
...
### 12. [Runtime Observability for Heterogeneous Attention Memory](https://arxiv.org/abs/2608.05863) <a id="paper-2608-05863"></a>
...
### 13. [Funnel of Thoughts: Efficient Test-Time Scaling via Early Voting and Rollout Pruning](https://arxiv.org/abs/2608.15065) <a id="paper-2608-15065"></a>
...
### 14. [Whole-Piece Training for Symbolic Music Language Models via Full-Horizon Compressed Recurrence](https://arxiv.org/abs/2602.19816) <a id="paper-2602-19816"></a>
...
### 15. [PhaseLoRA: Control-Regime-Conditioned Low-Rank Adaptation for Continuous-Action Vision-Language-Action Policies](https://arxiv.org/abs/2608.15285) <a id="paper-2608-15285"></a>
