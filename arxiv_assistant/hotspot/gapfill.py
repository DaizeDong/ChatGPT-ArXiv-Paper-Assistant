...
from arxiv_assistant.hotspot.support import run_journal
...
REUSE_ADAPTERS: dict[str, str] = {
    "hf_daily": "arxiv_assistant.hotspot.sources.reuse_hf_daily",
    "ainews": "arxiv_assistant.hotspot.sources.reuse_ainews",
    "agents_radar": "arxiv_assistant.hotspot.sources.reuse_agents_radar",
    "horizon": "arxiv_assistant.hotspot.sources.reuse_horizon",
    "scholar_inbox": "arxiv_assistant.hotspot.sources.reuse_scholar_inbox",
}
