<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../12"><img src="../../../assets/nav/day/2025-11-13-prev.svg" alt="Previous Day 2025-11-12"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-13-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../14"><img src="../../../assets/nav/day/2025-11-13-next.svg" alt="Next Day 2025-11-14"></a></div></div>
...
## 2. [BayesQ: Uncertainty-Guided Bayesian Quantization](https://arxiv.org/abs/2511.08821) <a id="link2"></a>
...
## 3. [Mixture-of-Channels: Exploiting Sparse FFNs for Efficient LLMs Pre-Training and Inference](https://arxiv.org/abs/2511.09323) <a id="link3"></a>
...
## 5. [Branching Flows: Discrete, Continuous, and Manifold Flow Matching with Splits and Deletions](https://arxiv.org/abs/2511.09465) <a id="link5"></a>
...
## 6. [Extreme Model Compression with Structured Sparsity at Low Precision](https://arxiv.org/abs/2511.08360) <a id="link6"></a>
...
## 7. [Bayesian Mixture of Experts For Large Language Models](https://arxiv.org/abs/2511.08968) <a id="link7"></a>
...
## 8. [DynaKV: Enabling Accurate and Efficient Long-Sequence LLM Decoding on Smartphones](https://arxiv.org/abs/2511.07427) <a id="link8"></a>
...
## 9. [Think-at-Hard: Selective Latent Iterations to Improve Reasoning Language Models](https://arxiv.org/abs/2511.08577) <a id="link9"></a>
...
## 10. [A Circular Argument : Does RoPE need to be Equivariant for Vision?](https://arxiv.org/abs/2511.08368) <a id="link10"></a>
...
## 11. [LLM Inference Beyond a Single Node: From Bottlenecks to Mitigations with Fast All-Reduce Communication](https://arxiv.org/abs/2511.09557) <a id="link11"></a>
...
## 12. [When is a System Discoverable from Data? Discovery Requires Chaos](https://arxiv.org/abs/2511.08860) <a id="link12"></a>
...
## 13. [Group Equivariance Meets Mechanistic Interpretability: Equivariant Sparse Autoencoders](https://arxiv.org/abs/2511.09432) <a id="link13"></a>
...
## 14. [Sharp Eyes and Memory for VideoLLMs: Information-Aware Visual Token Pruning for Efficient and Reliable VideoLLM Reasoning](https://arxiv.org/abs/2511.08003) <a id="link14"></a>
...
## 16. [Alignment-Constrained Dynamic Pruning for LLMs: Identifying and Preserving Alignment-Critical Circuits](https://arxiv.org/abs/2511.07482) <a id="link16"></a>
...
## 17. [Training Language Models to Explain Their Own Computations](https://arxiv.org/abs/2511.08579) <a id="link17"></a>
...
## 18. [SparseRM: A Lightweight Preference Modeling with Sparse Autoencoder](https://arxiv.org/abs/2511.07896) <a id="link18"></a>
...
## 19. [ImagebindDC: Compressing Multi-modal Data with Imagebind-based Condensation](https://arxiv.org/abs/2511.08263) <a id="link19"></a>
...
## 20. [Synera: Synergistic LLM Serving across Device and Cloud at Scale](https://arxiv.org/abs/2511.07423) <a id="link20"></a>
...
## 21. [Factorization-in-Loop: Proximal Fill-in Minimization for Sparse Matrix Reordering](https://arxiv.org/abs/2511.09093) <a id="link21"></a>
...
## 22. [GeoGNN: Quantifying and Mitigating Semantic Drift in Text-Attributed Graphs](https://arxiv.org/abs/2511.09042) <a id="link22"></a>
...
## 23. [A General Method for Proving Networks Universal Approximation Property](https://arxiv.org/abs/2511.07857) <a id="link23"></a>
...
## 24. [Unsupervised Feature Selection Through Group Discovery](https://arxiv.org/abs/2511.09166) <a id="link24"></a>
...
## 25. [Multi-step Predictive Coding Leads To Simplicity Bias](https://arxiv.org/abs/2511.09290) <a id="link25"></a>
...
## 26. [Abstract Gradient Training: A Unified Certification Framework for Data Poisoning, Unlearning, and Differential Privacy](https://arxiv.org/abs/2511.09400) <a id="link26"></a>
