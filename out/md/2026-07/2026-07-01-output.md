> This is a remedial run for missed papers from 06/30/2026 to 06/30/2026.
> 
...
<sub>Token counts are not reported for this run. 6 of 6 model calls succeeded, 1,903s of model wall clock.</sub>
...
1. [Random Reshuffling Dominates Stochastic Gradient Descent](#paper-2606-32005)
**Authors:** Zijian Liu
...
3. [Revisiting the Volume Hypothesis](#paper-2606-31282)
**Authors:** Ari Pakman, Lior Kreimer, Yakir Berchenko

4. [DPPE: Rethinking Camera-Based Positional Encoding for Scaling Multi-View Transformers](#paper-2606-31585)
**Authors:** Shun Kenney, Teppei Suzuki

5. [Signed-Permutation Coordinate Transport for RMSNorm Transformers](#paper-2606-31963)
**Authors:** John Sweeney

6. [Fora: From Weight-Space to Function-Space Protection in Capability-Preserving Fine-Tuning](#paper-2606-31092)
**Authors:** Rui Zhou, Tianci Xie

7. [Evil Spectra: How Optimisers can Amplify or Suppress Emergent Misalignment](#paper-2606-31591)
...
9. [MSNN-LINet: Cross-Modal Learning via Continuous Linear Integration](#paper-2606-31135)
**Authors:** Gabriel Clinger

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (11)

1. [Nonlinearity-Aware LoRA: Structured Gate Adaptation under Low-Rank Constraints](#paper-2606-31717)
**Authors:** Shuai Yuan, Sudong Cai, Bingzhi Chen, Shuyuan Zheng, Chuan Xiao, Makoto Onizuka, Rui Mao

2. [CORA: Per-Slice Coherent Orthogonal Rotation for SVD-based Low-Rank Adaptation](#paper-2607-02576)
**Authors:** Pengcheng Wang, Ziran Liu, Wei Wang, Wei Jiang

3. [Attend, Transform, or Silence: Operator-Level Visual Skipping for Efficient Multimodal LLM Inference](#paper-2606-31903)
**Authors:** Zhaoyang Luo, Runmin Dong, Miao Yang, Fan Wei, Yushan Lai, Bin Luo, Haohuan Fu

4. [Compressing What Matters: Neuron Importance Meets Data-Aware Low Rank Approximation for Language Model Compression](#paper-2607-18284)
**Authors:** Athanasios Ntovas, Alexandros Doumanoglou, Petros Drakoulis, Dimitris Zarpalas

5. [FRAME: Learning the Adaptation Domain with a Mixture of Fractional-Fourier Experts](#paper-2607-00162)
**Authors:** Tom Saliencro, Maya Lindqvist, Rohan Desai, Priya Nair, Daniel Whitmore

6. [Mixture-of-Control: State-Aware Fine-Tuning for Transformer-based Models](#paper-2606-31397)
**Authors:** Duc Anh Nguyen, Tien Ngoc Luu, Tung Pham, Toan Tran

7. [Geometry-Preserving Orthonormal Initialization for Low-Rank Adaptation in RLVR](#paper-2606-31813)
**Authors:** Ruijia Zhang, Jiacheng Zhu, Hanqing Zhu, Laixi Shi

8. [OTCache: Optimal Transport for Geometry-Aware Caching in Diffusion Models](#paper-2606-31026)
**Authors:** Huanlin Gao, Fang Zhao, Qiang Hui, Fuyuan Shi, Shaoan Zhao, Yantao Li, Chao Tan, Ting Lu, Yuren You, Kai Wang, Shiguo Lian

9. [Fork-Think with Confidence](#paper-2606-31484)
**Authors:** Zena Al-Khalili, Rafi Hakim, Dietrich Klakow, Ji-Ung Lee

10. [CHERRY: Compressed Hierarchical Experts with Recurrent Representational Yield](#paper-2606-31796)
**Authors:** Dohyeon Kwon, Youngjin Park

11. [SLIM-RL: Risk-Budgeted Random-Masking RL for Diffusion LLMs Without Trajectory Slicing](#paper-2607-00208)
...
**Comment:** A trained hard top-1 token router preserves unit-scale updates when composing frozen LoRA experts.

**Topic Match:** Expert routing and router training are the core integration mechanism; frozen low-rank experts also reduce trainable-parameter requirements.
...
**Comment:** Hard-label consensus reduces federated distillation communication to logarithmic bits per output vocabulary.

**Topic Match:** The core is a communication-efficient distributed training protocol, although validation is on standard federated benchmarks.
...
### 1. [Random Reshuffling Dominates Stochastic Gradient Descent](https://arxiv.org/abs/2606.32005) <a id="paper-2606-32005"></a>
...
**Comment:** Proves finite-epoch convergence advantages of random reshuffling over SGD for smooth convex objectives.

**Topic Match:** The contribution explains optimization dynamics induced by data ordering, with guarantees restricted to smooth convex objectives.
...
**Comment:** Activation-norm regularization targets radial inflation to accelerate delayed generalization.

**Topic Match:** The paper analyzes optimization geometry and tests a training intervention, with evidence currently limited to small algorithmic models.
...
### 3. [Revisiting the Volume Hypothesis](https://arxiv.org/abs/2606.31282) <a id="paper-2606-31282"></a>
...
**Comment:** Separates SGD's implicit bias from basin-volume effects as training-set size grows.

**Topic Match:** The core investigates how optimization and loss-landscape volume influence generalization, with evidence limited to binary networks.
...
### 4. [DPPE: Rethinking Camera-Based Positional Encoding for Scaling Multi-View Transformers](https://arxiv.org/abs/2606.31585) <a id="paper-2606-31585"></a>
...
**Comment:** Decouples rotational and translational positional information to remove a diagnosed transformer-training bottleneck.

**Topic Match:** A positional-encoding identifiability problem and its remedy explain training saturation in scaled multi-view transformers.
...
### 5. [Signed-Permutation Coordinate Transport for RMSNorm Transformers](https://arxiv.org/abs/2606.31963) <a id="paper-2606-31963"></a>
...
**Comment:** RMSNorm symmetry analysis identifies signed permutations required for coordinate and optimizer-state transport.

**Topic Match:** Normalization symmetries provide a substantive architectural connection, while the core centers on cross-checkpoint coordinate alignment and interpretability-tool transport.
...
### 6. [Fora: From Weight-Space to Function-Space Protection in Capability-Preserving Fine-Tuning](https://arxiv.org/abs/2606.31092) <a id="paper-2606-31092"></a>
...
**Comment:** Activation-derived projectors constrain fine-tuning updates to preserve existing capabilities.

**Topic Match:** Update geometry provides the strongest training connection; the central objective is capability preservation during post-training, with PEFT as an extension.
...
### 7. [Evil Spectra: How Optimisers can Amplify or Suppress Emergent Misalignment](https://arxiv.org/abs/2606.31591) <a id="paper-2606-31591"></a>
...
**Comment:** Optimizer-induced LoRA singular-value spectra explain behavioral differences and motivate spectral regularization.

**Topic Match:** The optimizer-to-spectrum mechanism provides a substantive training-dynamics connection, although the central outcome is post-training alignment.
...
**Comment:** Modulo-routed global errors enable backpropagation-free credit assignment in excitatory/inhibitory networks.

**Topic Match:** The contribution directly changes credit assignment, although its biological constraints and small-scale evidence limit large-model relevance.
...
### 9. [MSNN-LINet: Cross-Modal Learning via Continuous Linear Integration](https://arxiv.org/abs/2606.31135) <a id="paper-2606-31135"></a>
...
**Comment:** Diagnoses initialization-induced gradient corruption in a continuously fused neural network.

**Topic Match:** The fusion operator and initialization analysis provide a partial architectural match, with evidence confined to small RGB-D classifiers.
...
### 1. [Nonlinearity-Aware LoRA: Structured Gate Adaptation under Low-Rank Constraints](https://arxiv.org/abs/2606.31717) <a id="paper-2606-31717"></a>
...
**Comment:** Gate-sensitive low-rank updates allocate adaptation capacity to responsive nonlinear channels.

**Topic Match:** Parameter-efficient adaptation is central; the analysis of gate selection and effective homogeneity also explains adaptation dynamics.
...
### 2. [CORA: Per-Slice Coherent Orthogonal Rotation for SVD-based Low-Rank Adaptation](https://arxiv.org/abs/2607.02576) <a id="paper-2607-02576"></a>
...
**Comment:** Coupled rotations of sliced SVD bases reduce the trainable parameters required for adaptation.

**Topic Match:** The core is a new low-rank adaptation parameterization with explicit parameter savings and comparative fine-tuning results.
...
### 3. [Attend, Transform, or Silence: Operator-Level Visual Skipping for Efficient Multimodal LLM Inference](https://arxiv.org/abs/2606.31903) <a id="paper-2606-31903"></a>
...
**Comment:** Operator-level skipping bypasses visual-token attention and FFN updates while preserving the complete token sequence.

**Topic Match:** Selective operator execution directly reduces large-model inference compute and introduces a finer-grained conditional-computation mechanism.
...
### 4. [Compressing What Matters: Neuron Importance Meets Data-Aware Low Rank Approximation for Language Model Compression](https://arxiv.org/abs/2607.18284) <a id="paper-2607-18284"></a>
...
**Comment:** Combines neuron importance with data-aware low-rank approximation to compress language-model weights.

**Topic Match:** The compression objective and dynamic allocation of compression rates directly address LLM memory cost and approximation quality.
...
### 5. [FRAME: Learning the Adaptation Domain with a Mixture of Fractional-Fourier Experts](https://arxiv.org/abs/2607.00162) <a id="paper-2607-00162"></a>
...
**Comment:** Learnable fractional-Fourier orders adapt the basis of each low-rank expert's weight update.

**Topic Match:** A learned update basis is a direct parameter-efficient adaptation mechanism; expert parameterization is the substantive innovation.
...
### 6. [Mixture-of-Control: State-Aware Fine-Tuning for Transformer-based Models](https://arxiv.org/abs/2606.31397) <a id="paper-2606-31397"></a>
...
**Comment:** Sparse mixing of control states enables memory-efficient adaptation across transformer blocks.

**Topic Match:** Efficient state-based adaptation is central, with cross-block control mixing providing an additional architectural contribution.
...
### 7. [Geometry-Preserving Orthonormal Initialization for Low-Rank Adaptation in RLVR](https://arxiv.org/abs/2606.31813) <a id="paper-2606-31813"></a>
...
**Comment:** Orthonormal LoRA initialization preserves adaptation geometry and stabilizes training under verifiable rewards.

**Topic Match:** LoRA initialization is the central mechanism; its theory connects parameter-efficient adaptation to training stability and explains failures of alternative initializations.
...
### 8. [OTCache: Optimal Transport for Geometry-Aware Caching in Diffusion Models](https://arxiv.org/abs/2606.31026) <a id="paper-2606-31026"></a>
...
**Comment:** Transport-inspired interpolation predicts diffusion caching schedules across inference budgets.

**Topic Match:** Caching-policy design directly reduces computation in large diffusion models, qualifying as a substantive inference-efficiency mechanism.
...
### 9. [Fork-Think with Confidence](https://arxiv.org/abs/2606.31484) <a id="paper-2606-31484"></a>
...
**Comment:** Confidence-selected branching reduces redundant reasoning continuations and their token cost.

**Topic Match:** The core is an inference-compute allocation rule that reduces reasoning tokens and runtime across models.
...
### 10. [CHERRY: Compressed Hierarchical Experts with Recurrent Representational Yield](https://arxiv.org/abs/2606.31796) <a id="paper-2606-31796"></a>
...
**Comment:** A heal-after-merge training loop compresses 48 layers into six recurrently shared blocks at near-dense loss.

**Topic Match:** Measured recurrent weight sharing supplies a concrete compression and training mechanism, although the abstract mixes it with extensive model-family results.
...
### 11. [SLIM-RL: Risk-Budgeted Random-Masking RL for Diffusion LLMs Without Trajectory Slicing](https://arxiv.org/abs/2607.00208) <a id="paper-2607-00208"></a>
...
**Comment:** Avoids trajectory-slicing expansion through a risk-controlled random-masking RL objective.

**Topic Match:** Reduced training-sample expansion creates an efficiency connection, but the central contribution remains a diffusion-LLM RL objective and rollout strategy.
