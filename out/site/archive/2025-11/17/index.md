<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../14"><img src="../../../assets/nav/day/2025-11-17-prev.svg" alt="Previous Day 2025-11-14"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-17-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../18"><img src="../../../assets/nav/day/2025-11-17-next.svg" alt="Next Day 2025-11-18"></a></div></div>
...
## 2. [Multistability of Self-Attention Dynamics in Transformers](https://arxiv.org/abs/2511.11553) <a id="link2"></a>
...
## 3. [FarSkip-Collective: Unhobbling Blocking Communication in Mixture of Experts Models](https://arxiv.org/abs/2511.11505) <a id="link3"></a>
...
## 4. [Optimizing Mixture of Block Attention](https://arxiv.org/abs/2511.11571) <a id="link4"></a>
...
## 5. [$\pi$-Attention: Periodic Sparse Transformers for Efficient Long-Context Modeling](https://arxiv.org/abs/2511.10696) <a id="link5"></a>
...
## 7. [Fast and Expressive Multi-Token Prediction with Probabilistic Circuits](https://arxiv.org/abs/2511.11346) <a id="link7"></a>
...
## 8. [Leveraging Parameter Space Symmetries for Reasoning Skill Transfer in LLMs](https://arxiv.org/abs/2511.10850) <a id="link8"></a>
...
## 9. [MMA-Sim: Bit-Accurate Reference Model of Tensor Cores and Matrix Cores](https://arxiv.org/abs/2511.10909) <a id="link9"></a>
...
## 11. [On-Device Fine-Tuning via Backprop-Free Zeroth-Order Optimization](https://arxiv.org/abs/2511.11362) <a id="link11"></a>
...
## 12. [Private Zeroth-Order Optimization with Public Data](https://arxiv.org/abs/2511.10859) <a id="link12"></a>
...
## 13. [From Parameter to Representation: A Closed-Form Approach for Controllable Model Merging](https://arxiv.org/abs/2511.10943) <a id="link13"></a>
...
## 14. [Test-Time Steering for Lossless Text Compression via Weighted Product of Experts](https://arxiv.org/abs/2511.10660) <a id="link14"></a>
