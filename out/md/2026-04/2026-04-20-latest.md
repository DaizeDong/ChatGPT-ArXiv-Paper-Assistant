...
1. [Collective Kernel EFT for Pre-activation ResNets](#paper-2604-15742)
**Authors:** Hidetoshi Kawase, Toshihiro Ota

2. [Closing the Theory-Practice Gap in Spiking Transformers via Effective Dimension](#paper-2604-15769)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

3. [When Do Early-Exit Networks Generalize? A PAC-Bayesian Theory of Adaptive Depth](#paper-2604-15764)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

4. [Neural Continuous-Time Markov Chain: Discrete Diffusion via Decoupled Jump Timing and Direction](#paper-2604-15694)
...
2. [Breaking the Training Barrier of Billion-Parameter Universal Machine Learning Interatomic Potentials](#paper-2604-15821)
...
3. [SecureRouter: Encrypted Routing for Efficient Secure Inference](#paper-2604-15499)
**Authors:** Yukuan Zhang, Mengxin Zheng, Qian Lou

## [Representation Learning Theory and Structure](#topic-representation-structure) (2)

1. [Hallucination as Trajectory Commitment: Causal Evidence for Asymmetric Attractor Dynamics in Transformer Generation](#paper-2604-15400)
**Authors:** G. Aytug Akarlar

2. [Geometric regularization of autoencoders via observed stochastic dynamics](#paper-2604-16282)
...
1. [Sample Complexity Bounds for Stochastic Shortest Path with a Generative Model](#paper-2604-16111)
...
3. [The Harder Path: Last Iterate Convergence for Uncoupled Learning in Zero-Sum Games with Bandit Feedback](#paper-2604-16087)
...
### 1. [Collective Kernel EFT for Pre-activation ResNets](https://arxiv.org/abs/2604.15742) <a id="paper-2604-15742"></a>
...
**Comment:** Finite-width ResNet theory via a collective-kernel EFT that derives stochastic kernel recursions and pinpoints where G-only closure breaks.

**Topic Match:** The core contribution is a mechanistic analysis of residual-network training dynamics and kernel evolution, making architecture/training dynamics the best fit.
...
### 2. [Closing the Theory-Practice Gap in Spiking Transformers via Effective Dimension](https://arxiv.org/abs/2604.15769) <a id="paper-2604-15769"></a>
...
**Comment:** Provides an expressivity and spike-complexity theory for spiking self-attention with effective-dimension-based design rules.

**Topic Match:** Its main contribution is theoretical understanding of a specialized attention architecture and how architectural choices determine expressivity and compute.
...
**Comment:** Provides PAC-Bayesian generalization bounds for early-exit networks in terms of expected depth and exit entropy.

**Topic Match:** Although early exit improves efficiency, the paper's main contribution is theoretical understanding of adaptive-depth architectures and their generalization behavior.
...
### 4. [Neural Continuous-Time Markov Chain: Discrete Diffusion via Decoupled Jump Timing and Direction](https://arxiv.org/abs/2604.15694) <a id="paper-2604-15694"></a>
...
**Comment:** Reparameterizes reverse CTMC diffusion into separate jump timing and jump direction heads with corresponding KL decomposition.

**Topic Match:** The work introduces a cleaner first-principles architecture and objective decomposition for discrete diffusion dynamics, making architectural mechanism the best fit.
...
**Comment:** Sequential Monte Carlo speculative decoding replaces rollback-heavy rejection with importance-weighted particle resampling for faster inference.

**Topic Match:** The paper's core idea is a new inference algorithm that improves LLM throughput by changing the verification mechanism in speculative decoding.
...
### 2. [Breaking the Training Barrier of Billion-Parameter Universal Machine Learning Interatomic Potentials](https://arxiv.org/abs/2604.15821) <a id="paper-2604-15821"></a>
...
**Comment:** Introduces a high-dimensional distributed training framework for billion-parameter MoE interatomic models, overcoming second-derivative and exascale communication bottlenecks.

**Topic Match:** The strongest fit is large-scale training systems: the paper's key value is enabling billion-parameter training efficiently at exascale, even though it also uses MoE architecture.
...
### 3. [SecureRouter: Encrypted Routing for Efficient Secure Inference](https://arxiv.org/abs/2604.15499) <a id="paper-2604-15499"></a>
...
**Comment:** Uses encrypted input-adaptive routing among transformer models to cut MPC secure-inference latency with joint router/model-pool co-design.

**Topic Match:** The primary contribution is efficient secure inference through adaptive routing and MPC-aware model design, fitting efficiency/compression more than architecture analysis.
...
### 1. [Hallucination as Trajectory Commitment: Causal Evidence for Asymmetric Attractor Dynamics in Transformer Generation](https://arxiv.org/abs/2604.15400) <a id="paper-2604-15400"></a>
...
**Comment:** Gives causal evidence that hallucination arises from asymmetric attractor dynamics and early trajectory commitment in transformer generation.

**Topic Match:** The main value is mechanistic understanding of internal trajectory dynamics and attractor structure in transformer representations.
...
### 2. [Geometric regularization of autoencoders via observed stochastic dynamics](https://arxiv.org/abs/2604.16282) <a id="paper-2604-16282"></a>
...
**Comment:** Adds tangent-bundle and inverse-consistency regularization to autoencoders, with theory linking learned charts to latent SDE and dynamics accuracy.

**Topic Match:** This is fundamentally about geometric structure and identifiability of learned latent representations, with substantial theoretical treatment.
...
### 1. [Sample Complexity Bounds for Stochastic Shortest Path with a Generative Model](https://arxiv.org/abs/2604.16111) <a id="paper-2604-16111"></a>
...
**Comment:** Provides near-tight sample-complexity bounds for stochastic shortest path learning with a generative model, including hardness when c_min=0.

**Topic Match:** This is a strong fit to foundational RL because it advances theory of learnability and sample complexity in a general sequential decision setting.
...
**Comment:** Analyzes how partner-induced gradient noise destabilizes cooperation and proposes robustness at the policy-gradient level, with theory on stability and welfare tradeoffs.

**Topic Match:** This is foundational multi-agent RL on learning dynamics under non-stationarity, with new theory and an algorithm targeting cooperative stability.
...
### 3. [The Harder Path: Last Iterate Convergence for Uncoupled Learning in Zero-Sum Games with Bandit Feedback](https://arxiv.org/abs/2604.16087) <a id="paper-2604-16087"></a>
...
**Comment:** Gives optimal-rate last-iterate convergence results for uncoupled zero-sum learning with bandit feedback, including matching lower bounds and new algorithms.

**Topic Match:** The paper is a foundational learning-in-games result squarely within RL/game-learning theory, focused on convergence dynamics rather than applications.
