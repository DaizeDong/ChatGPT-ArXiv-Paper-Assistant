<div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1.2fr) minmax(0, 1fr); align-items: center; width: 100%; gap: 16px; margin: 8px 0 20px;"><div style="display: flex; justify-content: flex-start;"><a href="../17" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;"><span style="font-size: 20px; line-height: 1; color: inherit;">&larr;</span><span style="display: flex; flex-direction: column; align-items: flex-start; line-height: 1.25;"><strong style="display: block;">Previous Day</strong><span style="display: block; font-size: 14px; color: gray;">2025-02-17</span></span></a></div><div style="display: flex; justify-content: center;"><a href=".." style="display: inline-flex; flex-direction: column; align-items: center; text-align: center; text-decoration: none; line-height: 1.25;"><strong style="display: block;">Monthly Overview</strong><span style="display: block; font-size: 14px; color: gray;">2025-02</span></a></div><div style="display: flex; justify-content: flex-end;"><a href="../19" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;"><span style="display: flex; flex-direction: column; align-items: flex-end; text-align: right; line-height: 1.25;"><strong style="display: block;">Next Day</strong><span style="display: block; font-size: 14px; color: gray;">2025-02-19</span></span><span style="font-size: 20px; line-height: 1; color: inherit;">&rarr;</span></a></div></div>
...
12. [Large Language-Geometry Model: When LLM meets Equivariance](#user-content-link12)
...
26. [Approximation of Permutation Invariant Polynomials by Transformers: Efficient Construction in Column-Size](#user-content-link26)
...
41. [On Vanishing Gradients, Over-Smoothing, and Over-Squashing in GNNs: Bridging Recurrent and Graph Learning](#user-content-link41)
...
55. [Diversified Sampling Improves Scaling LLM inference](#user-content-link55)
...
71. [K-Edit: Language Model Editing with Contextual Knowledge Awareness](#user-content-link71)
...
86. [Large Language Models and Mathematical Reasoning Failures](#user-content-link86)
...
## 68. [Continual Quantization-Aware Pre-Training: When to transition from 16-bit to 1.58-bit pre-training for BitNet language models?](https://arxiv.org/abs/2502.11895) <a id="link68"></a>
...
## 69. [The Relationship between No-Regret Learning and Online Conformal Prediction](https://arxiv.org/abs/2502.10947) <a id="link69"></a>
...
## 70. [Learning Identifiable Structures Helps Avoid Bias in DNN-based Supervised Causal Learning](https://arxiv.org/abs/2502.10883) <a id="link70"></a>
...
## 71. [K-Edit: Language Model Editing with Contextual Knowledge Awareness](https://arxiv.org/abs/2502.10626) <a id="link71"></a>
...
## 72. [Smoothing Out Hallucinations: Mitigating LLM Hallucination with Smoothed Knowledge Distillation](https://arxiv.org/abs/2502.11306) <a id="link72"></a>
...
## 73. [LLM-Lasso: A Robust Framework for Domain-Informed Feature Selection and Regularization](https://arxiv.org/abs/2502.10648) <a id="link73"></a>
...
## 74. [ReReLRP - Remembering and Recognizing Tasks with LRP](https://arxiv.org/abs/2502.10789) <a id="link74"></a>
...
## 75. [On the kernel learning problem](https://arxiv.org/abs/2502.11665) <a id="link75"></a>
...
## 76. [Error Bound Analysis for the Regularized Loss of Deep Linear Neural Networks](https://arxiv.org/abs/2502.11152) <a id="link76"></a>
...
## 77. [Revisiting Weak-to-Strong Generalization in Theory and Practice: Reverse KL vs. Forward KL](https://arxiv.org/abs/2502.11107) <a id="link77"></a>
...
## 78. [MixMin: Finding Data Mixtures via Convex Minimization](https://arxiv.org/abs/2502.10510) <a id="link78"></a>
...
## 79. [Teaching LLMs According to Their Aptitude: Adaptive Reasoning for Mathematical Problem Solving](https://arxiv.org/abs/2502.12022) <a id="link79"></a>
...
## 80. [Neuron Platonic Intrinsic Representation From Dynamics Using Contrastive Learning](https://arxiv.org/abs/2502.10425) <a id="link80"></a>
...
## 81. [Revealing Bias Formation in Deep Neural Networks Through the Geometric Mechanisms of Human Visual Decoupling](https://arxiv.org/abs/2502.11809) <a id="link81"></a>
...
## 82. [Cognitive Neural Architecture Search Reveals Hierarchical Entailment](https://arxiv.org/abs/2502.11141) <a id="link82"></a>
...
## 83. [LLM4GNAS: A Large Language Model Based Toolkit for Graph Neural Architecture Search](https://arxiv.org/abs/2502.10459) <a id="link83"></a>
...
## 84. [PRISM: Self-Pruning Intrinsic Selection Method for Training-Free Multimodal Data Selection](https://arxiv.org/abs/2502.12119) <a id="link84"></a>
...
## 85. [Fast Proxies for LLM Robustness Evaluation](https://arxiv.org/abs/2502.10487) <a id="link85"></a>
...
## 86. [Large Language Models and Mathematical Reasoning Failures](https://arxiv.org/abs/2502.11574) <a id="link86"></a>
...
## 87. [A recurrent vision transformer shows signatures of primate visual attention](https://arxiv.org/abs/2502.10955) <a id="link87"></a>
...
## 88. [ADO: Automatic Data Optimization for Inputs in LLM Prompts](https://arxiv.org/abs/2502.11436) <a id="link88"></a>
...
## 89. [An Empirical Analysis of Uncertainty in Large Language Model Evaluations](https://arxiv.org/abs/2502.10709) <a id="link89"></a>
...
## 90. [MuSC: Improving Complex Instruction Following with Multi-granularity Self-Contrastive Training](https://arxiv.org/abs/2502.11541) <a id="link90"></a>
