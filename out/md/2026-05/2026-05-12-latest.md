...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">848095</td>
            <td align="center">66557</td>
            <td align="center">914652</td>
            <td rowspan="2" align="center">2121</td>
            <td rowspan="2" align="center">1450</td>
...
<table>
    ...
    <tbody>
        <tr><td><a href="#topic-architecture-training">Architecture and Training Dynamics</a></td><td align="center">147</td></tr>
        <tr><td><a href="#topic-training-systems">Training Algorithms That Change What Is Possible</a></td><td align="center">15</td></tr>
...
## [Architecture and Training Dynamics](#topic-architecture-training) (147)

1. [Muown: Row-Norm Control for Muon Optimization](#paper-2605-10797)
**Authors:** Kai Lion, Florian H\"ubler, Bingcong Li, Antonio Orvieto, Niao He

2. [A Single-Layer Model Can Do Language Modeling](#paper-2605-10643)
**Authors:** Zanmin Wang

3. [Priming: Hybrid State Space Models From Pre-trained Transformers](#paper-2605-08301)
...
4. [Scratchpad Patching: Decoupling Compute from Patch Size in Byte-Level Language Models](#paper-2605-09630)
**Authors:** Lin Zheng, Vasilisa Bashlovkina, Timothy Dozat, Dan Garrette, Laura Rimell, Joshua Maynez

5. [Sparse Layers are Critical to Scaling Looped Language Models](#paper-2605-09165)
**Authors:** Ryan Lee, Jacob Biloki, Edward J. Hu, Jonathan May

6. [Kaczmarz Linear Attention](#paper-2605-08587)
**Authors:** Jiaxuan Zou, Ruifeng Ren, Yong Liu

7. [Mixture of Layers with Hybrid Attention](#paper-2605-09516)
**Authors:** Ivan Ternovtsii, Yurii Bilak

8. [Repeated-Token Counting Reveals a Dissociation Between Representations and Outputs](#paper-2605-09239)
**Authors:** Sohan Venkatesh

9. [Infinite Mask Diffusion for Few-Step Distillation](#paper-2605-10518)
**Authors:** Jaehoon Yoo, Wonjung Kim, Chanhyuk Lee, Seunghoon Hong

10. [In-Context Fixation: When Demonstrated Labels Override Semantics in Few-Shot Classification](#paper-2605-08295)
**Authors:** Ming Liu

11. [Attention Drift: What Autoregressive Speculative Decoding Models Learn](#paper-2605-09992)
**Authors:** Do\u{g}a\c{c} Eldenk, Payal Mohapatra, Yigitcan Comlek, Kaan Oktay, Hongyang Zhang, Stephen Xia

12. [ELF: Embedded Language Flows](#paper-2605-10938)
**Authors:** Keya Hu, Linlu Qiu, Yiyang Lu, Hanhong Zhao, Tianhong Li, Yoon Kim, Jacob Andreas, Kaiming He

13. [Optimizer-Induced Mode Connectivity: From AdamW to Muon](#paper-2605-09991)
**Authors:** Fangzhao Zhang, Sungyoon Kim, Erica Zhang, Yiqi Jiang, Mert Pilanci

14. [Key-Value Means](#paper-2605-09877)
**Authors:** Daniel Goldstein, Eugene Cheah

15. [Structured Recurrent Mixers for Massively Parallelized Sequence Generation](#paper-2605-08696)
**Authors:** Benjamin L. Badger

16. [Sparsity Moves Computation: How FFN Architecture Reshapes Attention in Small Transformers](#paper-2605-09403)
**Authors:** Gabriel Smithline, Chris Mascioli

17. [Path-Dependent Denoising: A Non-Conservative Field Perspective on Order Collapse in Diffusion Language Models](#paper-2605-09303)
**Authors:** Jeonseong Kim

18. [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](#paper-2605-09314)
**Authors:** Xiangkun Sun, Lingkai Kong, Aoqi Zhang, Liang Zeng, Tonghan Wang

19. [Belief or Circuitry? Causal Evidence for In-Context Graph Learning](#paper-2605-08405)
**Authors:** Katharine Kowalyshyn, Timothy Duggan, Daniel Little, Michael C Hughes

20. [Accelerating Zeroth-Order Spectral Optimization with Partial Orthogonalization from Power Iteration](#paper-2605-09034)
**Authors:** Jiahe Chen, Ziye Ma

21. [Neural Weight Norm = Kolmogorov Complexity](#paper-2605-10878)
**Authors:** Tiberiu Musat

22. [Self-Attention as a Covariance Readout: A Unified View of In-Context Learning and Repetition](#paper-2605-10466)
**Authors:** Haoren Xu, Guanhua Fang

23. [Towards Understanding Continual Factual Knowledge Acquisition of Language Models: From Theory to Algorithm](#paper-2605-10640)
**Authors:** Haoyu Wang, Yifan Shang, Zhongxiang Sun, Weijie Yu, Xiao Zhang, Jun Xu

24. [Compander-Aligned Query Geometry for Quantized Zeroth-Order Optimization](#paper-2605-10673)
**Authors:** Yao Shu, Zilin Zhu

25. [Dimension-Free Saddle-Point Escape in Muon](#paper-2605-09331)
**Authors:** Yanlin Long, Yufei Gu, Zeke Xie

26. [The two clocks and the innovation window: When and how generative models learn rules](#paper-2605-10019)
**Authors:** Binxu Wang, Emma Lucia Byrnes Finn, Bingbin Liu

27. [The Global Empirical NTK: Self-Referential Bias and Dimensionality of Gradient Descent Learning](#paper-2605-08746)
**Authors:** James Hazelden, Laura Driscoll, Eli Shlizerman, Eric Shea-Brown

28. [A Game Theoretic Free Energy Analysis of Higher Order Synergy in Attention Heads of Large Language Models](#paper-2605-09515)
**Authors:** Djamel Bouchaffra

29. [Intrinsic Muon: Spectral Optimization on Riemannian Matrix Manifolds](#paper-2605-09238)
**Authors:** Yibang Li, Bihari Lal Pandey, Ravi Sah, Andi Han, Cyrus Mostajeran, Pratik Jawanpuria, Bamdev Mishra

30. [Kinetic theory for Transformers and the lost-in-the-middle phenomenon](#paper-2605-09213)
**Authors:** Mitia Duerinckx, Borjan Geshkovski, Stefano Rossi

31. [A Single Neuron Is Sufficient to Bypass Safety Alignment in Large Language Models](#paper-2605-08513)
**Authors:** Hamid Kazemi, Atoosa Chegini, Maria Safi

32. [The Geometry of Forgetting: Temporal Knowledge Drift as an Independent Axis in LLM Representations](#paper-2605-09195)
**Authors:** Rania Elbadry, Ahmed Heakl, Fan Zhang, Dani Bouch, Yuxia Wang, Preslav Nakov, Zhuohan Xie

33. [The Extrapolation Cliff in On-Policy Distillation of Near-Deterministic Structured Outputs](#paper-2605-08737)
**Authors:** Xin Li, Hao Jiang, Annan Wang, Yichi Zhang, Chau Yuen

34. [Geometry Conflict: Explaining and Controlling Forgetting in LLM Continual Post-Training](#paper-2605-09608)
...
35. [Transformers Can Implement Preconditioned Richardson Iteration for In-Context Gaussian Kernel Regression](#paper-2605-08475)
**Authors:** Mingsong Yan, Dongyang Li, Charles Kulick, Sui Tang

36. [Factual recall in linear associative memories: sharp asymptotics and mechanistic insights](#paper-2605-10795)
**Authors:** Alessio Giorlandino, Sebastian Goldt, Antoine Maillard

37. [Model Capacity Determines Grokking through Competing Memorisation and Generalisation Speeds](#paper-2605-09724)
**Authors:** Yiding Song, Hanming Ye

38. [From Syntax to Semantics: Unveiling the Emergence of Chirality in SMILES Translation Models](#paper-2605-09949)
**Authors:** Zehao Li, Yasuhiro Yoshikai, Shumpei Nemoto, Hiroyuki Kusuhara, Tadahaya Mizuno

39. [The Cancellation Hypothesis in Critic-Free RL: From Outcome Rewards to Token Credits](#paper-2605-08666)
**Authors:** Tianhao Cheng, Zeyu Huang, Zihan Qiu, Yu Cheng, Edoardo Ponti, Yinghui Xu, Ivan Titov, Zenglin Xu

40. [Teaching LLMs to See Graphs: Unifying Text and Structural Reasoning](#paper-2605-10247)
**Authors:** Dario Vajda

41. [Hidden Error Awareness in Chain-of-Thought Reasoning: The Signal Is Diagnostic, Not Causal](#paper-2605-09502)
**Authors:** Aojie Yuan, Zhiyuan Julian Su, Haiyue Zhang, Yi Nian, Yue Zhao

42. [bViT: Investigating Single-Block Recurrence in Vision Transformers for Image Recognition](#paper-2605-10661)
**Authors:** Michal Byra, Pawel Olszowiec, Grzegorz Stefanski, Grzegorz Gruszczynski, Alberto Presta

43. [fmxcoders: Factorized Masked Crosscoders for Cross-Layer Feature Discovery](#paper-2605-09438)
**Authors:** Andreas D. Demou, Panagiotis Koromilas, James Oldfield, Yannis Panagakis, Mihalis A. Nicolaou

44. [Phases of Muon: When Muon Eclipses SignSGD](#paper-2605-09552)
**Authors:** Elliot Paquette, Noah Marshall, Lucas Benigni, Guangyuan Wang, Atish Agarwala, Courtney Paquette

45. [Beyond Language: Format-Agnostic Reasoning Subspaces in Large Language Models](#paper-2605-09496)
**Authors:** Aojie Yuan, Zhiyuan Su

46. [Locking Pretrained Weights via Deep Low-Rank Residual Distillation](#paper-2605-10777)
**Authors:** Keitaro Sakamoto, Pierre Ablin, Federico Danieli, Marco Cuturi

47. [Fitting Multilinear Polynomials for Logic Gate Networks](#paper-2605-08657)
**Authors:** Youngsung Kim

48. [Towards Effective Theory of LLMs: A Representation Learning Approach](#paper-2605-09294)
**Authors:** Muhammed Ustaomeroglu, Guannan Qu

49. [Continual Harness: Online Adaptation for Self-Improving Foundation Agents](#paper-2605-09998)
**Authors:** Seth Karten, Joel Zhang, Tersoo Upaa Jr, Ruirong Feng, Wenzhe Li, Chengshuai Shi, Chi Jin, Kiran Vodrahalli

50. [AdaPreLoRA: Adafactor Preconditioned Low-Rank Adaptation](#paper-2605-08734)
**Authors:** Ziyun Liu, Fengmiao Bian, Jian-Feng Cai

51. [CoCoDA: Co-evolving Compositional DAG for Tool-Augmented Agents](#paper-2605-08399)
**Authors:** Ziyang Yu, Qiyue Li, Liang Zhao

52. [Embeddings for Preferences, Not Semantics](#paper-2605-08360)
**Authors:** Carter Blair, Ariel D. Procaccia, Milind Tambe

53. [Positional LSH: Binary Block Matrix Approximation for Attention with Linear Biases](#paper-2605-09472)
**Authors:** Daniel Wolfson, Tal Wagner

54. [A Qualitative Test-Risk Mechanism for Scaling Behavior in Normalized Residual Networks](#paper-2605-08297)
**Authors:** Daning Cheng, Zeyu Liu, Jun Sun, Fen Xia, Boyang Zhang, Dongping Liu, Yunquan Zhang

55. [The Wittgensteinian Representation Hypothesis: Is Language the Attractor of Multimodal Convergence?](#paper-2605-09352)
**Authors:** Zhaoyang Zhang, Run Shao, Dongyue Wu, Jiajie Teng, Chao Tao, Jingdong Chen, Haifeng Li

56. [Unmasking On-Policy Distillation: Where It Helps, Where It Hurts, and Why](#paper-2605-10889)
...
57. [Intrinsic Guardrails: How Semantic Geometry of Personality Interacts with Emergent Misalignment in LLMs](#paper-2605-10633)
**Authors:** Krishak Aneja, Manas Mittal, Anmol Goel, Ponnurangam Kumaraguru, Vamshi Krishna Bonagiri

58. [HoReN: Normalized Hopfield Retrieval for Large-Scale Sequential Model Editing](#paper-2605-08143)
**Authors:** Yuan Fang, Yi Xie, Xuming Ran

59. [SMIXAE: Towards Unsupervised Manifold Discovery in Language Models](#paper-2605-09224)
**Authors:** Collin Francel

60. [Cross-Family Universality of Behavioral Axes via Anchor-Projected Representations](#paper-2605-09875)
**Authors:** Su-Hyeon Kim, Yo-Sub Han

61. [When to Re-Commit: Temporal Abstraction Discovery for Long-Horizon Vision-Language Reasoning](#paper-2605-09860)
**Authors:** Chen Li, Zhantao Yang, Fangyi Chen, Han Zhang, Anudeepsekhar Bolimera, Marios Savvides

62. [Bilinear autoencoders find interpretable manifolds](#paper-2605-08891)
**Authors:** Thomas Dooms, Ward Gauderis, Geraint Wiggins, Jose Oramas

63. [Continuous Latent Contexts Enable Efficient Online Learning in Transformers](#paper-2605-09867)
**Authors:** Emile Anand, Abdullah Ateyeh, Xinyuan Cao, Max Dabagia

64. [Predicting Plasticity in Deep Continual Learning: A Theoretical Perspective](#paper-2605-09044)
**Authors:** Jiuqi Wang, Jayanth Srinivasa, Claire Chen, Shuze Daniel Liu, Ali Payani, Shangtong Zhang

65. [Lattice Deduction Transformers](#paper-2605-08605)
**Authors:** Liam Davis, Leopold Haller, Alberto Alfarano, Mark Santolucito

66. [What Time Is It? How Data Geometry Makes Time Conditioning Optional for Flow Matching](#paper-2605-08344)
**Authors:** Alec Helbling, Sebastian Gutierrez Hernandez, Benjamin Hoover, Duen Horng Chau, Parikshit Ram

67. [Complex-Valued Phase-Coherent Transformer](#paper-2605-10123)
**Authors:** Leona Hioki

68. [Why Do Aligned LLMs Remain Jailbreakable: Refusal-Escape Directions, Operator-Level Sources, and Safety-Utility Trade-off](#paper-2605-08878)
**Authors:** Yu Chen, Yuanhao Liu, Qi Cao

69. [On Variance Reduction in Learning Mean Flows](#paper-2605-09235)
**Authors:** Juanwu Lu, Ziran Wang

70. [Do multimodal models imagine electric sheep?](#paper-2605-09693)
**Authors:** Santhosh Kumar Ramakrishnan, Carl Vondrick, Raja Giryes, Philipp Kr\"ahenb\"uhl, Vladlen Koltun

71. [The Propagation Field: A Geometric Substrate Theory of Deep Learning](#paper-2605-08529)
**Authors:** Xingrui Gu

72. [TIDES: Implicit Time-Awareness in Selective State Space Models](#paper-2605-09742)
**Authors:** Taylan Soydan, Miguel A. Bessa, Dirk Mohr, Rui Barreira

73. [Diagnosing Spectral Ceilings in Equivariant Neural Force Fields](#paper-2605-08286)
**Authors:** Hyunmog Kim

74. [Reasoning emerges from constrained inference manifolds in large language models](#paper-2605-08142)
...
75. [Mitigating Many-shot Jailbreak Attacks with One Single Demonstration](#paper-2605-08277)
**Authors:** Kejia Chen, Jiawen Zhang, Boheng Li, Pengcheng Li, Jian Lou, Zunlei Feng, Mingli Song, Ruoxi Jia, Tianwei Zhang

76. [HyperTransport: Amortized Conditioning of T2I Generative Models](#paper-2605-08254)
**Authors:** Valentino Maiorca, Eleonora Gualdoni, Xavier Suau, Marco Cuturi, Luca Zappella, Pau Rodr\'iguez

77. [Exactness Matters for Physical Rule Enforcement](#paper-2605-08285)
**Authors:** Bum Jun Kim

78. [SkillMaster: Toward Autonomous Skill Mastery in LLM Agents](#paper-2605-08693)
**Authors:** Min Yang, Jinghua Piao, Xu Xia, Xiaochong Lan, Jiaju Chen, Yongshun Gong, Yong Li

79. [Causal Dimensionality of Transformer Representations: Measurement, Scaling, and Layer Structure](#paper-2605-08740)
**Authors:** Nilesh Sarkar, Dawar Jyoti Deka

80. [Quantifying Concentration Phenomena of Mean-Field Transformers in the Low-Temperature Regime](#paper-2605-10931)
**Authors:** Albert Alcalde, Leon Bungert, Konstantin Riedl, Tim Roith

81. [Normalization Equivariance for Arbitrary Backbones, with Application to Image Denoising](#paper-2605-08193)
**Authors:** Youssef Saied, Fran\c{c}ois Fleuret

82. [ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](#paper-2605-10819)
...
83. [NoiseRater: Meta-Learned Noise Valuation for Diffusion Model Training](#paper-2605-08144)
...
84. [Scaling Limits of Long-Context Transformers](#paper-2605-08505)
**Authors:** Giuseppe Bruno, Shi Chen, Zhengjiang Lin, Yury Polyanskiy, Philippe Rigollet

85. [Elucidating Representation Degradation Problem in Diffusion Model Training](#paper-2605-10790)
**Authors:** Zhipeng Yao, Dazhou Li, Zitong Zhang, Durude Mahee, Fan Zhu, Wenbin Zhang, Xinwei He, Yeying Jin, Rui Yu

86. [Controlling Transient Amplification Improves Long-horizon Rollouts](#paper-2605-08856)
**Authors:** Adeel Pervez, Francesco Locatello

87. [The Echo Amplifies the Knowledge: Somatic Marker Analogues in Language Models via Emotion Vector Re-Injection](#paper-2605-08611)
**Authors:** Jared Glover

88. [Workspace Optimization: How to Train Your Agent](#paper-2605-09650)
**Authors:** Elad Sarafian, Gal Kaplun, Ron Banner, Daniel Soudry, Boris Ginsburg

89. [When Attention Beats Fourier: Multi-Scale Transformers for PDE Solving on Irregular Domains](#paper-2605-08318)
**Authors:** Brandon Yee, Pairie Koh, Jack Rodriguez, Mihir Tekal

90. [Latent Geometry Beyond Search: Amortizing Planning in World Models](#paper-2605-08732)
**Authors:** Hoang Nguyen, Xiaohao Xu, Xiaonan Huang

91. [HS-FNO: History-Space Fourier Neural Operator for Non-Markovian Partial Differential Equations](#paper-2605-09523)
**Authors:** Lennon J. Shikhman

92. [VORT: Adaptive Power-Law Memory for NLP Transformers](#paper-2605-08966)
**Authors:** Nabil Mlaiki

93. [Neural Information Causality](#paper-2605-09316)
**Authors:** Jeongho Bang, Marcin Paw{\l}owski

94. [Hyperparameter Transfer for Dense Associative Memories](#paper-2605-10164)
**Authors:** Roi Holtzman, Dmitry Krotov, Boris Hanin

95. [Why Zeroth-Order Adaptation May Forget Less: A Randomized Shaping Theory](#paper-2605-10658)
**Authors:** Yao Shu, Jian Mu, Zhongxiang Dai

96. [Continuity Laws for Sequential Models](#paper-2605-08539)
**Authors:** Annan Yu, Dongwei Lyu, N. Benjamin Erichson

97. [Consolidation-Expansion Operator Mechanics:A Unified Framework for Adaptive Learning](#paper-2605-09968)
**Authors:** Debashis Guha

98. [One for All: A Non-Linear Transformer can Enable Cross-Domain Generalization for In-Context Reinforcement Learning](#paper-2605-09727)
**Authors:** Bowen He, Juncheng Dong, Lin Lin, Xiang Cheng

99. [Convergence Analysis of Newton's Method for Neural Networks in the Overparameterized Limit](#paper-2605-08352)
**Authors:** Konstantin Riedl, Konstantinos Spiliopoulos, Justin Sirignano

100. [Tensor Product Representation Probes Reveal Shared Structure Across Linear Directions](#paper-2605-09967)
**Authors:** Andrew Lee, Fernanda Vi\'egas, Martin Wattenberg

101. [Deterministic Decomposition of Stochastic Generative Dynamics](#paper-2605-08794)
**Authors:** Xingyu Song, Yuan Mei, Naoya Takeishi

102. [The Benefits of Temporal Correlations: SGD Learns k-Juntas from Random Walks Efficiently](#paper-2605-10237)
**Authors:** Elisabetta Cornacchia, Dan Mikulincer, Elchanan Mossel

103. [The Polynomial Counting Capabilities of Message Passing Neural Networks](#paper-2605-10393)
**Authors:** Marco S\"alzer, Pascal Bergstr\"a{\ss}er, Anthony W. Lin

104. [Path-Coupled Bellman Flows for Distributional Reinforcement Learning](#paper-2605-08253)
**Authors:** Boyang Xu, Qing Zou, Siqin Yang, Hao Yan

105. [Recovering Physical Dynamics from Discrete Observations via Intrinsic Differential Consistency](#paper-2605-08454)
**Authors:** Yuxiang Luo, Andrew Perrault

106. [Improving Generalization by Permutation Routing Across Model Copies](#paper-2605-09256)
**Authors:** Shuhei Kashiwamura, Timothee Leleu

107. [Learning Theory of Transformers: Local-to-Global Approximation via Softmax Partition of Unity](#paper-2605-08811)
**Authors:** Zhongjie Shi, Wenjing Liao

108. [EquiMem: Calibrating Shared Memory in Multi-Agent Debate via Game-Theoretic Equilibrium](#paper-2605-09278)
**Authors:** Yuqiao Meng, Sakshi Sunil Narvekar, Luoxi Tang, Rupali Rajendra Vaje, Yingxue Zhang, Muchao Ye, Zhaohan Xi

109. [Don't Fix the Basis -- Learn It: Spectral Representation with Adaptive Basis Learning for PDEs](#paper-2605-10451)
**Authors:** Xuxiang Zhao, Angelica I. Aviles-Rivero

110. [Zero-shot Imitation Learning by Latent Topology Mapping](#paper-2605-08450)
**Authors:** Maxwell J. Jacobson, Yexiang Xue

111. [RelFlexformer: Efficient Attention 3D-Transformers for Integrable Relative Positional Encodings](#paper-2605-10706)
**Authors:** Byeongchan Kim, Arijit Sehanobish, Avinava Dubey, Min-hwan Oh, Krzysztof Choromanski

112. [HH-SAE: Discovering and Steering Hierarchical Knowledge of Complex Manifolds](#paper-2605-10536)
**Authors:** Honghan Wu, Tianyan Wang, Jiacong Mi, Zhoyang Jiang, Yunsoo Kim

113. [Revisiting Policy Gradients for Restricted Policy Classes: Escaping Myopic Local Optima with $k$-step Policy Gradients](#paper-2605-10909)
**Authors:** Alex DeWeese, Guannan Qu

114. [FRACTAL: SSM with Fractional Recurrent Architecture for Computational Temporal Analysis of Long Sequences](#paper-2605-08833)
**Authors:** Mengqi Li, Wensheng Lin, Jinshuai Yang, Lixin Li

115. [Beyond Static Bias: Adaptive Multi-Fidelity Bandits with Improving Proxies](#paper-2605-08558)
**Authors:** Muyun Lu, Haoyang Hong, Huazheng Wang, Ying Lin

116. [CATO: Charted Attention for Neural PDE Operators](#paper-2605-09016)
**Authors:** Chun-Wun Cheng, Sifan Wang, Carola-Bibiane Sch\"onlieb, Angelica I. Aviles-Rivero

117. [RAwR: Role-Aware Rewiring via Approximate Equitable Partition](#paper-2605-09457)
...
118. [The Geometric Structure of Models Learning Sparse Data](#paper-2605-08464)
**Authors:** Thomas Walker, T. Mitchell Roddenberry, Ahmed Imtiaz Humayun, Randall Balestriero, Richard Baraniuk

119. [Generative Actor-Critic with Soft Bridge Policies](#paper-2605-08733)
**Authors:** Ke He, Le He, Shunpu Tang, Yafei Wang, Lisheng Fan

120. [Quantile-Coupled Flow Matching for Distributional Reinforcement Learning](#paper-2605-08515)
**Authors:** Michael Groom, Victor-Alexandru Darvariu, Lars Kunze, James Wilson, Nick Hawes

121. [Near-Optimal Last-Iterate Convergence for Zero-Sum Games with Bandit Feedback and Opponent Actions](#paper-2605-09363)
**Authors:** Soumita Hait, Ping Li, Haipeng Luo, Mengxiao Zhang

122. [Minimal Filling Architectures of Polynomial Neural Networks: Counterexamples, Frontier Search, and Defects](#paper-2605-09609)
**Authors:** Kevin Dao, Jose Israel Rodriguez

123. [A Deep Risk Estimator for Known Operator Learning](#paper-2605-08517)
**Authors:** Andreas Maier, Md Hasan, Paulina Conrad, Paula Andrea Perez-Toro

124. [Characterizing the Generalization Error of Random Feature Regression with Arbitrary Data-Augmentation](#paper-2605-10290)
**Authors:** Lucas Morisset, Alain Durmus, Adrien Hardy

125. [Measuring and Decomposing Mode Separation via the Canonical Diffusion](#paper-2605-08777)
**Authors:** Shaul Tolkovsky, Ori Meidler, Or Zuk

126. [Physical probes expose and alleviate chemical-environment collapse in molecular representations](#paper-2605-10429)
**Authors:** Jiebin Fang, Zidi Yan, Churu Mao, Yongjun Jiang, Xinyi Tang, Lei Miao, Dan Lu, Yun Huang, Wanjing Ding, Zhongjun Ma

127. [Embedding Dimension Lower Bounds for Universality of Deep Sets and Janossy Pooling](#paper-2605-08377)
**Authors:** Ali Syed, Aditya Nambiar, Jonathan W. Siegel

128. [Policy Gradient Methods for Non-Markovian Reinforcement Learning](#paper-2605-10816)
**Authors:** Avik Kar, Siddharth Chandak, Rahul Singh, Soumitra Sinhahajari, Eric Moulines, Shalabh Bhatnagar, Nicholas Bambos

129. [Parameterized Complexity of Stationarity Testing for Piecewise-Affine Functions and Shallow CNN Losses](#paper-2605-10219)
**Authors:** Yuhan Ye

130. [Mistake-Bounded Language Generation](#paper-2605-10809)
**Authors:** Jon Kleinberg, Charlotte Peale, Omer Reingold

131. [Anchoring the Eigengap: Cross-Modal Spectral Stabilization for Sample-Efficient Representation Learning](#paper-2605-08764)
...
132. [From Passive Reuse to Active Reasoning: Grounding Large Language Models for Neuro-Symbolic Experience Replay](#paper-2605-09419)
**Authors:** Yanan Xiao, Yixiang Tang, Zechen Feng, Lu Jiang, Minghao Yin, Pengyang Wang

133. [Natural Policy Gradient as Doubly Smoothed Policy Iteration: A Bellman-Operator Framework](#paper-2605-10671)
**Authors:** Phalguni Nanda, Zaiwei Chen

134. [The Reciprocity Gradient](#paper-2605-08323)
**Authors:** Yue Lin, Pascal Poupart, Shuhui Zhu, Dan Qiao, Wenhao Li, Yuan Liu, Hongyuan Zha, Baoxiang Wang

135. [The Value of Mechanistic Priors in Sequential Decision Making](#paper-2605-10018)
**Authors:** Itai Shufaro, Gal Benor, Shie Mannor

136. [The Power of Second Order Methods for Sequence Preconditioning](#paper-2605-08390)
**Authors:** Annie Marsden, Elad Hazan

137. [LaWM: Least Action World Models for Long-Horizon Physical Consistency from Visual Observations](#paper-2605-08279)
**Authors:** Qixin Xiao, Maani Ghaffari

138. [Non-Parametric Rehearsal Learning via Conditional Mean Embeddings](#paper-2605-08999)
**Authors:** Wen-Bo Du, Tian-Zuo Wang, Han-Jia Ye, Zhi-Hua Zhou

139. [Learnability and Competition in High-Dimensional Multi-Component ICA](#paper-2605-08552)
**Authors:** Eser Ilke Genc, Samet Demir, Zafer Dogan

140. [Learning When to Stop: Selective Imitation Learning Under Arbitrary Dynamics Shift](#paper-2605-09183)
**Authors:** Surbhi Goel, Jonathan Pei, James Wang

141. [Central Limit Theorem for Two-Time-Scale Approximate Distributionally Robust RL](#paper-2605-08417)
**Authors:** Shengbo Wang, Zexi Zhang

142. [Generalization Error Bounds for Picard-Type Operator Learning in Nonlinear Parabolic PDEs](#paper-2605-10277)
**Authors:** Koichi Taniguchi, Sho Sonoda

143. [Exact Fixed-Point Constraints in Neural-ODEs with Provable Universality](#paper-2605-10613)
**Authors:** Feliciano Giuseppe Pacifico, Duccio Fanelli, Lorenzo Buffoni, Lorenzo Chicchi, Diego Febbe, Raffaele Marino

144. [Shields to Guarantee Probabilistic Safety in MDPs](#paper-2605-10888)
**Authors:** Linus Heck, Filip Mac\'ak, Roman Andriushchenko, Milan \v{C}e\v{s}ka, Sebastian Junges

145. [The Pok\'emon Theorem and other Fairness Impossibility Results](#paper-2605-09221)
**Authors:** Daniel Matsui Smola, Alex Smola

146. [Switching-Geometry Analysis of Deflated Q-Value Iteration](#paper-2605-10811)
**Authors:** Donghwan Lee

147. [On Characterizing Learnability for Adversarial Noisy Bandits](#paper-2605-09200)
**Authors:** Steve Hanneke, Kun Wang

## [Training Algorithms That Change What Is Possible](#topic-training-systems) (15)

1. [Practical Scaling Laws: Converting Compute into Performance in a Data-Constrained World](#paper-2605-09189)
**Authors:** Christopher M. Bryant, Hao Liu

2. [Lakestream: A Consistent and Brokerless Data Plane for Large Foundation Model Training](#paper-2605-09994)
...
3. [ReLibra: Routing-Replay-Guided Load Balancing for MoE Training in Reinforcement Learning](#paper-2605-08639)
**Authors:** Chao Jin, Xinming Wei, Yinmin Zhong, Chengxu Yang, Bingyang Wu, Ruidong Zhu, Zili Zhang, Yuliang Liu, Xin Jin

4. [BubbleSpec: Turning Long-Tail Bubbles into Speculative Rollout Drafts for Synchronous Reinforcement Learning](#paper-2605-08862)
**Authors:** Yuhang Xu, Kaibin Tian, Yang Tian, Zhice Yang, Yifeng Yu, Yan Li, Shengzhong Liu, Fan Wu, Guihai Chen

5. [RubiConv -- Efficient Boundary-Respecting Convolutions](#paper-2605-08451)
**Authors:** Linda Friso, Annie Marsden, Xinyi Chen, Arushi Gupta, Peter Bartlett, Mark Braverman, Elad Hazan

6. [SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning](#paper-2605-09423)
**Authors:** Haoqiang Kang, Xiaokang Ye, Yuhan Liu, Siddhant Hitesh Mantri, Lingjun Mao, James Fleming, Drishti Regmi, Lianhui Qin

7. [Core-Halo Decomposition: Decentralizing Large-Scale Fixed-Point Problems](#paper-2605-08681)
**Authors:** Haixiang, Yang Xu, Jiefu Zhang, Xudong Wu, Zihan Zhou, Jun He, Jiayu Chen

8. [Block-Wise Differentiable Sinkhorn Attention: Tail-Refinement Gradients with a Gap-Aware Dustbin Bridge](#paper-2605-08123)
**Authors:** Dylan Forde

9. [TRAM: Training Approximate Multiplier Structures for Low-Power AI Accelerators](#paper-2605-08231)
**Authors:** Chang Meng, Hanyu Wang, Yuyang Ye, Mingfei Yu, Wayne Burleson, Giovanni De Micheli

10. [Adversary-Robust Learning from Fully Asynchronous Directional Derivative Estimates](#paper-2605-09337)
**Authors:** Anik Kumar Paul, Nibedita Roy, Nagesh Talagani, Swetha Ganesh, Gugan Thoppe, Alexandre Reiffers-Masson

11. [Function-Space ADMM for Decentralized Federated Learning: A Control Theoretic Perspective](#paper-2605-09356)
**Authors:** Akihito Taya, Yuuki Nishiyama, Kaoru Sezaki

12. [Unveiling High-Probability Generalization in Decentralized SGD](#paper-2605-10205)
**Authors:** Jiahuan Wang, Ping Luo, Ziqing Wen, Dongsheng Li, Tao Sun

13. [PMCTS: Particle Monte Carlo Tree Search for Principled Parallelized Inference Time Scaling](#paper-2605-08982)
**Authors:** Yaniv Oren, Viliam Vadocz, Joery A. de Vries, Wendelin B\"ohmer, Matthijs T. J. Spaan, Hendrik Baier

14. [LoKA: Low-precision Kernel Applications for Recommendation Models At Scale](#paper-2605-10886)
...
15. [Sharp feature-learning transitions and Bayes-optimal neural scaling laws in extensive-width networks](#paper-2605-10395)
**Authors:** Minh-Toan Nguyen, Jean Barbier

## [MoE Where It Changes the Design Space](#topic-moe-training) (3)

1. [Hierarchical Mixture-of-Experts with Two-Stage Optimization](#paper-2605-08292)
**Authors:** Gleb Molodtsov, Alexander Miasnikov, Aleksandr Beznosikov

2. [DECO: Sparse Mixture-of-Experts with Dense-Comparable Performance on End-Side Devices](#paper-2605-10933)
**Authors:** Chenyang Song, Weilin Zhao, Xu Han, Chaojun Xiao, Yingfa Chen, Zhiyuan Liu

3. [SDG-MoE: Signed Debate Graph Mixture-of-Experts](#paper-2605-08322)
...
1. [BCJR-QAT: A Differentiable Relaxation of Trellis-Coded Weight Quantization](#paper-2605-10655)
**Authors:** Venugopalan Iyengar

2. [Not All Thoughts Need HBM: Semantics-Aware Memory Hierarchy for LLM Reasoning](#paper-2605-09490)
**Authors:** Aojie Yuan, Tianqi Shen, Dajun Zhang

3. [Nectar: Neural Estimation of Cached-Token Attention via Regression](#paper-2605-09778)
**Authors:** Jo\~ao Monteiro, Michal Klein, Pierre Ablin, Marco Cuturi

4. [Compute Where it Counts: Self Optimizing Language Models](#paper-2605-10875)
**Authors:** Yash Akhauri, Mohamed S. Abdelfattah

5. [PARD-2: Target-Aligned Parallel Draft Model for Dual-Mode Speculative Decoding](#paper-2605-08632)
**Authors:** Zihao An, Taichi Liu, Ziqiong Liu, Dong Li, Ruofeng Liu, Emad Barsoum

6. [ConQuR: Corner Aligned Activation Quantization via Optimized Rotations for LLMs](#paper-2605-10793)
**Authors:** Chayne Thrash, Ali Abbasi, Soheil Kolouri

7. [LAQuant: A Simple Overhead-free Large Reasoning Model Quantization by Layer-wise Lookahead Loss](#paper-2605-08755)
**Authors:** Euntae Choi, Sumin Song, Sungjoo Yoo

8. [Test-Time Speculation](#paper-2605-09329)
**Authors:** Avinash Kumar, Sujay Sanghavi, Poulami Das

9. [KV-RM: Regularizing KV-Cache Movement for Static-Graph LLM Serving](#paper-2605-09735)
**Authors:** Zhiqing Zhong, Zhijing Ye, Jian Zhang, Weijian Zheng, Bolun Sun, Xiaodong Yu

10. [Make Each Token Count: Towards Improving Long-Context Performance with KV Cache Eviction](#paper-2605-09649)
**Authors:** Ngoc Bui, Hieu Trung Nguyen, Arman Cohan, Rex Ying

11. [AdaPaD: Adaptive Parallel Deflation for PEFT with Self-Correcting Rank Discovery](#paper-2605-10741)
**Authors:** Barbara Su, Fangshuo Liao, Anastasios Kyrillidis

12. [Queryable LoRA: Instruction-Regularized Routing Over Shared Low-Rank Update Atoms](#paper-2605-08423)
**Authors:** Omatharv Bharat Vaidya, Connor T. Jerzak, Nhat Ho, Chandrajit Bajaj

13. [TileQ: Efficient Low-Rank Quantization of Mixture-of-Experts with 2D Tiling](#paper-2605-09281)
**Authors:** Hongyaoxing Gu, Xinzhe Chen, Lijuan Hu, Fangfang Liu

14. [GELATO: Generative Entropy- and Lyapunov-based Adaptive Token Offloading for Device-Edge Speculative LLM Inference](#paper-2605-10124)
**Authors:** Zengzipeng Tang, Yuxuan Sun, Wei Chen, Jianwen Ding, Bo Ai

15. [Prospective Compression in Human Abstraction Learning](#paper-2605-09985)
...
16. [Selection Plateau and a Sparsity-Dependent Hierarchy of Pruning Features](#paper-2605-09345)
**Authors:** Guangqi Li, Yongxin Li

17. [Skill-CMIB: Multimodal Agent Skill for Consistent Action via Conditional Multimodal Information Bottleneck](#paper-2605-08526)
**Authors:** Zihan Huang, Junda Wu, Tong Yu, Qianqi Yan, Rohan Surana, Uttaran Bhattacharya, Lina Yao, Xin Eric Wang, Julian McAuley

18. [Optimality of Sub-network Laplace Approximations: New Results and Methods](#paper-2605-09075)
**Authors:** Swarnali Raha, Kshitij Khare, Rohit K Patra

---

## Architecture and Training Dynamics (147) <a id="topic-architecture-training"></a>

### 1. [Muown: Row-Norm Control for Muon Optimization](https://arxiv.org/abs/2605.10797) <a id="paper-2605-10797"></a>
...
**Comment:** Separates row magnitude from direction to control Muon's spectral-norm drift during pretraining.

**Topic Match:** The optimizer parameterization directly addresses pretraining stability and hyperparameter sensitivity, with comparisons spanning 124M to 2.7B parameters.
...
### 2. [A Single-Layer Model Can Do Language Modeling](https://arxiv.org/abs/2605.10643) <a id="paper-2605-10643"></a>
...
**Comment:** Replaces stacked per-layer states with a single recurrent block and shared matrix memory.

**Topic Match:** Directly tests removing architectural depth from a language model, reporting explicit perplexity gaps against deep baselines at 130M parameters.
...
### 3. [Priming: Hybrid State Space Models From Pre-trained Transformers](https://arxiv.org/abs/2605.08301) <a id="paper-2605-08301"></a>
...
**Comment:** Converts pretrained Transformers into hybrids, enabling controlled comparisons of SSM layer designs at substantial scale.

**Topic Match:** Architectural conversion and matched SSM-layer comparisons are central; the gains require alignment and post-training phases.
...
### 4. [Scratchpad Patching: Decoupling Compute from Patch Size in Byte-Level Language Models](https://arxiv.org/abs/2605.09630) <a id="paper-2605-09630"></a>
...
**Comment:** Decouples context-refresh compute from byte-patch size by inserting transient scratchpads while holding patch size fixed.

**Topic Match:** Changes the internal structure of tokenizer-free models to address stale within-patch context and separate compute allocation from patch-cache size.
...
### 5. [Sparse Layers are Critical to Scaling Looped Language Models](https://arxiv.org/abs/2605.09165) <a id="paper-2605-09165"></a>
...
**Comment:** Identifies changing expert selection across loops as the mechanism that restores expressivity under layer weight sharing.

**Topic Match:** Explains when repeated transformer layers scale successfully, with expert-routing divergence supplying the architectural mechanism.
...
### 6. [Kaczmarz Linear Attention](https://arxiv.org/abs/2605.08587) <a id="paper-2605-08587"></a>
...
**Comment:** Derives a key-norm-normalized delta-rule update while holding the recurrent state, gates, and parallel algorithm fixed.

**Topic Match:** The contribution changes the recurrent layer's state-update rule and tests it in language-model pretraining.
...
### 7. [Mixture of Layers with Hybrid Attention](https://arxiv.org/abs/2605.09516) <a id="paper-2605-09516"></a>
...
**Comment:** Replaces monolithic full-width layers with routed thin blocks, using shared attention to preserve global token coverage.

**Topic Match:** The central contribution changes transformer block structure; sparse routing enables the new layout.
...
### 8. [Repeated-Token Counting Reveals a Dissociation Between Representations and Outputs](https://arxiv.org/abs/2605.09239) <a id="paper-2605-09239"></a>
...
**Comment:** Localises counting errors to a late MLP that overwrites an accurately represented count, with controls across two model families.

**Topic Match:** Identifies a concrete layer computation responsible for an output failure, making this an analysis of computational organisation.
...
### 9. [Infinite Mask Diffusion for Few-Step Distillation](https://arxiv.org/abs/2605.10518) <a id="paper-2605-10518"></a>
...
**Comment:** Replaces the deterministic single-state mask to reduce the factorization-error floor of simultaneous token updates.

**Topic Match:** Changes the masking mechanism of diffusion language models; the reported few-step gains additionally require distillation.
...
### 10. [In-Context Fixation: When Demonstrated Labels Override Semantics in Few-Shot Classification](https://arxiv.org/abs/2605.08295) <a id="paper-2605-08295"></a>
...
**Comment:** Uses controlled label inventories and causal activation patching to identify how demonstration labels override semantic answers.

**Topic Match:** Explains an encode-then-override computation inside transformer layers, with causal interventions supporting the proposed output-vocabulary binding mechanism.
...
### 11. [Attention Drift: What Autoregressive Speculative Decoding Models Learn](https://arxiv.org/abs/2605.09992) <a id="paper-2605-09992"></a>
...
**Comment:** Links drafter attention drift to recurrent residual growth and tests normalization interventions that improve depth generalization.

**Topic Match:** The core result explains a residual-and-normalization failure in trained drafting architectures through targeted architectural interventions.
...
### 12. [ELF: Embedded Language Flows](https://arxiv.org/abs/2605.10938) <a id="paper-2605-10938"></a>
...
**Comment:** Keeps diffusion trajectories in continuous embedding space until a final shared-weight mapping to tokens.

**Topic Match:** Changes the representation and flow-matching formulation of diffusion language models; experimental scale and concrete baselines are unspecified.
...
### 13. [Optimizer-Induced Mode Connectivity: From AdamW to Muon](https://arxiv.org/abs/2605.09991) <a id="paper-2605-09991"></a>
...
**Comment:** Characterizes optimizer-dependent solution geometry and tests its spectral signatures in GPT-2 pretraining.

**Topic Match:** Directly studies how optimizer choice organizes trained solutions, combining connectivity results with language-model pretraining observations.
...
### 14. [Key-Value Means](https://arxiv.org/abs/2605.09877) <a id="paper-2605-09877"></a>
...
**Comment:** Introduces a block-recurrent attention layer whose state can remain fixed or grow with context.

**Topic Match:** The core contribution is the attention-state recurrence and its integration into trained transformer layers.
...
### 15. [Structured Recurrent Mixers for Massively Parallelized Sequence Generation](https://arxiv.org/abs/2605.08696) <a id="paper-2605-08696"></a>
...
### 16. [Sparsity Moves Computation: How FFN Architecture Reshapes Attention in Small Transformers](https://arxiv.org/abs/2605.09403) <a id="paper-2605-09403"></a>
...
**Comment:** Random routing nearly matches learned routing, implicating structural sparsity in shifting computation from FFNs into attention.

**Topic Match:** Routing and capacity controls test how FFN design reorganizes Transformer computation; evidence remains confined to one-layer synthetic tasks.
...
### 17. [Path-Dependent Denoising: A Non-Conservative Field Perspective on Order Collapse in Diffusion Language Models](https://arxiv.org/abs/2605.09303) <a id="paper-2605-09303"></a>
...
**Comment:** Identifies compatibility of denoising conditionals as the criterion for order-independent diffusion decoding, with pair-swap diagnostics.

**Topic Match:** Examines whether a diffusion language model's learned conditionals actually support order-free generation.
...
### 18. [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](https://arxiv.org/abs/2605.09314) <a id="paper-2605-09314"></a>
...
**Comment:** Traces answer selection to attention copying and a rank-one routing feature constructed by earlier heads.

**Topic Match:** The core contribution explains what an attention circuit computes and how earlier layers construct its routing signal, using causal interventions.
...
### 19. [Belief or Circuitry? Causal Evidence for In-Context Graph Learning](https://arxiv.org/abs/2605.08405) <a id="paper-2605-08405"></a>
...
**Comment:** Uses causal interventions and negative controls to distinguish global topology inference from local transition copying.

**Topic Match:** The contribution tests competing accounts of how LLM computation is organized, with controls that could falsify the proposed mechanism.
...
### 20. [Accelerating Zeroth-Order Spectral Optimization with Partial Orthogonalization from Power Iteration](https://arxiv.org/abs/2605.09034) <a id="paper-2605-09034"></a>
...
**Comment:** Explains why full orthogonalisation mishandles noisy zeroth-order gradients and substitutes dominant-direction power iteration.

**Topic Match:** The core contribution changes an optimiser's treatment of spectral directions under gradient noise; validation is confined to language-model fine-tuning.
...
### 21. [Neural Weight Norm = Kolmogorov Complexity](https://arxiv.org/abs/2605.10878) <a id="paper-2605-10878"></a>
...
**Comment:** Connects fixed-precision weight norms to Kolmogorov complexity, giving regularization a description-length interpretation.

**Topic Match:** The central result explains a standard training regularizer through parameterization; consequences for actual language-model optimization remain untested here.
...
### 22. [Self-Attention as a Covariance Readout: A Unified View of In-Context Learning and Repetition](https://arxiv.org/abs/2605.10466) <a id="paper-2605-10466"></a>
...
**Comment:** Derives a covariance-readout limit of softmax attention linking in-context gradient updates to repetitive generation.

**Topic Match:** Directly analyses the computation induced by attention and residual stacking, under restrictive input-distribution assumptions.
...
### 23. [Towards Understanding Continual Factual Knowledge Acquisition of Language Models: From Theory to Algorithm](https://arxiv.org/abs/2605.10640) <a id="paper-2605-10640"></a>
...
**Comment:** Explains why replay changes factual-retention dynamics while parameter regularisation only changes convergence speed.

**Topic Match:** Connects continual-pretraining interventions to transformer convergence and forgetting dynamics.
...
### 24. [Compander-Aligned Query Geometry for Quantized Zeroth-Order Optimization](https://arxiv.org/abs/2605.10673) <a id="paper-2605-10673"></a>
...
**Comment:** Aligns low-bit zeroth-order queries with the compander grid, eliminating the query-time rounding residual.

**Topic Match:** The main contribution is optimizer query geometry, with a low-precision training consequence tested in matched NF4 Qwen/Llama fine-tuning.
...
### 25. [Dimension-Free Saddle-Point Escape in Muon](https://arxiv.org/abs/2605.09331) <a id="paper-2605-09331"></a>
...
**Comment:** Attributes dimension-free Muon saddle escape to spectral shaping under gap and incoherence assumptions.

**Topic Match:** Targets the mechanism of an optimizer used in LLM training; the abstract presents conditional theory without a language-model training demonstration.
...
### 26. [The two clocks and the innovation window: When and how generative models learn rules](https://arxiv.org/abs/2605.10019) <a id="paper-2605-10019"></a>
...
**Comment:** Separates rule-learning time, which depends on complexity, from memorization time, which chiefly tracks dataset size.

**Topic Match:** Studies autoregressive training dynamics and their dependence on data and capacity; the broader predictive claims rest on synthetic rule tasks.
...
### 27. [The Global Empirical NTK: Self-Referential Bias and Dimensionality of Gradient Descent Learning](https://arxiv.org/abs/2605.08746) <a id="paper-2605-08746"></a>
...
**Comment:** Factorizes finite-width training dynamics into parameter-to-state and state-to-state effects, exposing structural learning bottlenecks.

**Topic Match:** The analysis connects transformer architecture to gradient-driven representation learning, although its scope is broader than language models.
...
### 28. [A Game Theoretic Free Energy Analysis of Higher Order Synergy in Attention Heads of Large Language Models](https://arxiv.org/abs/2605.09515) <a id="paper-2605-09515"></a>
...
**Comment:** Analyzes higher-order attention-head redundancy and tests low marginal contribution as a criterion for head pruning.

**Topic Match:** Attention-head interactions fit architectural analysis; the entropy surrogate and perplexity increase from 28.4 to 33.4 weaken the claimed mechanistic and pruning conclusions.
...
### 29. [Intrinsic Muon: Spectral Optimization on Riemannian Matrix Manifolds](https://arxiv.org/abs/2605.09238) <a id="paper-2605-09238"></a>
...
**Comment:** Constructs intrinsic spectral optimizer updates whose fixed-rank convergence constants are independent of factor conditioning.

**Topic Match:** Optimizer geometry is the core contribution; its stated language-model validation uses LoRA fine-tuning and provides no experimental scale or named dataset.
...
### 30. [Kinetic theory for Transformers and the lost-in-the-middle phenomenon](https://arxiv.org/abs/2605.09213) <a id="paper-2605-09213"></a>
...
**Comment:** Derives a U-shaped retrieval profile from correlations in an idealised causal-attention system.

**Topic Match:** The matching contribution is a mechanistic analysis of causal attention; its demonstrated scope is a toy decoder model under explicit assumptions.
...
### 31. [A Single Neuron Is Sufficient to Bypass Safety Alignment in Large Language Models](https://arxiv.org/abs/2605.08513) <a id="paper-2605-08513"></a>
...
**Comment:** Uses causal interventions to distinguish single-neuron refusal gates from neurons encoding harmful concepts.

**Topic Match:** Internal gating mechanisms are closest to architectural analysis, but safety-alignment bypass is the paper's core subject.
...
### 32. [The Geometry of Forgetting: Temporal Knowledge Drift as an Independent Axis in LLM Representations](https://arxiv.org/abs/2605.09195) <a id="paper-2605-09195"></a>
...
**Comment:** Separates temporal knowledge drift from correctness and uncertainty through controlled cross-cutoff representation tests.

**Topic Match:** Closest to representation analysis; the central contribution is detecting outdated answers through representational geometry.
...
### 33. [The Extrapolation Cliff in On-Policy Distillation of Near-Deterministic Structured Outputs](https://arxiv.org/abs/2605.08737) <a id="paper-2605-08737"></a>
...
**Comment:** Derives a measurable extrapolation threshold and tests predicted format-collapse boundaries with preregistered interventions.

**Topic Match:** Diagnoses distillation optimization, but the instability concerns structured-output formatting rather than architectural destabilization.
...
### 34. [Geometry Conflict: Explaining and Controlling Forgetting in LLM Continual Post-Training](https://arxiv.org/abs/2605.09608) <a id="paper-2605-09608"></a>
...
**Comment:** Connects forgetting to incompatibility between task-update covariance and the evolving model state.

**Topic Match:** Covariance-guided merging addresses continual post-training; the abstract does not identify destabilization of an architectural component.
...
### 35. [Transformers Can Implement Preconditioned Richardson Iteration for In-Context Gaussian Kernel Regression](https://arxiv.org/abs/2605.08475) <a id="paper-2605-08475"></a>
...
**Comment:** Identifies softmax attention and MLP arithmetic as components of a preconditioned Richardson solver.

**Topic Match:** The attention/MLP decomposition is mechanistic, but the trained task is Gaussian-process regression rather than language modeling.
...
### 36. [Factual recall in linear associative memories: sharp asymptotics and mechanistic insights](https://arxiv.org/abs/2605.10795) <a id="paper-2605-10795"></a>
...
**Comment:** Derives a sharp factual-storage capacity threshold and explains how optimised linear memories improve on Hebbian storage.

**Topic Match:** Closest to architectural capacity analysis; the results establish properties of minimal linear associative networks without testing language-model training.
...
### 37. [Model Capacity Determines Grokking through Competing Memorisation and Generalisation Speeds](https://arxiv.org/abs/2605.09724) <a id="paper-2605-09724"></a>
...
**Comment:** Explains capacity-dependent grokking through the crossing of separately measured memorisation and generalisation times.

**Topic Match:** Closest to training-dynamics analysis; the demonstrated subject is modular-arithmetic grokking, with no language-model training result.
...
### 38. [From Syntax to Semantics: Unveiling the Emergence of Chirality in SMILES Translation Models](https://arxiv.org/abs/2605.09949) <a id="paper-2605-09949"></a>
...
**Comment:** Links abrupt chiral-token learning to encoder representation reconstruction, supported by targeted attention-head ablations.

**Topic Match:** The training-dynamics analysis is structurally relevant; its core subject and demonstrated system are chemical SMILES translation.
...
### 39. [The Cancellation Hypothesis in Critic-Free RL: From Outcome Rewards to Token Credits](https://arxiv.org/abs/2605.08666) <a id="paper-2605-08666"></a>
...
**Comment:** Identifies cancellation between shared-token gradients as an implicit source of token-level credit assignment.

**Topic Match:** Token-gradient coupling is training-dynamics analysis, but the subject is RLVR post-training without architectural destabilization.
...
### 40. [Teaching LLMs to See Graphs: Unifying Text and Structural Reasoning](https://arxiv.org/abs/2605.10247) <a id="paper-2605-10247"></a>
...
**Comment:** Injects graph structure through attention biases while preserving node-permutation equivariance and pretrained-model compatibility.

**Topic Match:** Attention design is the nearest architectural connection; the contribution primarily serves graph understanding and GraphRAG.
...
### 41. [Hidden Error Awareness in Chain-of-Thought Reasoning: The Signal Is Diagnostic, Not Causal](https://arxiv.org/abs/2605.09502) <a id="paper-2605-09502"></a>
...
**Comment:** Tests whether decodable hidden-state error signals can causally change generated answers.

**Topic Match:** Internal-state analysis is the nearest fit, but the core subject is reasoning-error interpretability rather than the mechanism producing those representations.
...
### 42. [bViT: Investigating Single-Block Recurrence in Vision Transformers for Image Recognition](https://arxiv.org/abs/2605.10661) <a id="paper-2605-10661"></a>
...
**Comment:** Reuses one transformer block across depth while holding the training recipe and compute budget fixed.

**Topic Match:** Block sharing changes architectural parameterization, but the contribution and validation concern vision transformers.
...
### 43. [fmxcoders: Factorized Masked Crosscoders for Cross-Layer Feature Discovery](https://arxiv.org/abs/2605.09438) <a id="paper-2605-09438"></a>
...
**Comment:** Shared cross-layer factors and layer masking prevent crosscoder latents from depending on a single layer.

**Topic Match:** The architectural intervention modifies an interpretability tool whose central output is feature discovery.
...
### 44. [Phases of Muon: When Muon Eclipses SignSGD](https://arxiv.org/abs/2605.09552) <a id="paper-2605-09552"></a>
...
**Comment:** Identifies batch-size and covariance regimes governing spectral preconditioning and optimizer preference.

**Topic Match:** Optimizer dynamics is the nearest category, but the core is stochastic optimization analysis on a least-squares surrogate.
...
### 45. [Beyond Language: Format-Agnostic Reasoning Subspaces in Large Language Models](https://arxiv.org/abs/2605.09496) <a id="paper-2605-09496"></a>
...
**Comment:** Uses targeted patching and ablation to test a shared cross-format concept subspace.

**Topic Match:** The study centers on reasoning representations and introduces a benchmark, without identifying a mechanism of training or architectural stability.
...
### 46. [Locking Pretrained Weights via Deep Low-Rank Residual Distillation](https://arxiv.org/abs/2605.10777) <a id="paper-2605-10777"></a>
...
**Comment:** Uses deep low-rank MLP replacements to separate retained forward capability from backpropagation cost.

**Topic Match:** MLP replacement changes architectural optimization behavior, but the core contribution is an anti-adaptation defense.
...
### 47. [Fitting Multilinear Polynomials for Logic Gate Networks](https://arxiv.org/abs/2605.08657) <a id="paper-2605-08657"></a>
...
**Comment:** Identifies redundant gate-mixture directions and repairs interaction-gradient starvation through a four-coefficient soft-VQ parameterization.

**Topic Match:** Parameterization and gradient propagation are the nearest architectural topics; the demonstrated models are Boolean gate classifiers, not language models.
...
### 48. [Towards Effective Theory of LLMs: A Representation Learning Approach](https://arxiv.org/abs/2605.09294) <a id="paper-2605-09294"></a>
...
**Comment:** Learns coarse-grained variables that track and steer hidden-state trajectories.

**Topic Match:** Representation analysis is the closest topic, but the main contribution is an interpretability framework rather than an explanation of the underlying computational mechanism.
...
### 49. [Continual Harness: Online Adaptation for Self-Improving Foundation Agents](https://arxiv.org/abs/2605.09998) <a id="paper-2605-09998"></a>
...
**Comment:** Automates agent-harness refinement online within a single uninterrupted environment run.

**Topic Match:** Adaptive computation is the nearest fit, but the changing components are agent prompts, tools, skills, and memory, with a post-training co-learning extension.
...
### 50. [AdaPreLoRA: Adafactor Preconditioned Low-Rank Adaptation](https://arxiv.org/abs/2605.08734) <a id="paper-2605-08734"></a>
...
**Comment:** An Adafactor-weighted factor solve approximates full-weight preconditioning while retaining LoRA-level optimizer memory.

**Topic Match:** Optimizer design is the closest category, but its core subject is explicitly excluded parameter-efficient fine-tuning.
...
### 51. [CoCoDA: Co-evolving Compositional DAG for Tool-Augmented Agents](https://arxiv.org/abs/2605.08399) <a id="paper-2605-08399"></a>
...
**Comment:** Uses a typed compositional tool DAG to coordinate library growth, retrieval, and planner learning.

**Topic Match:** Tool composition is nearest to modular computation, but the contribution is an external agent framework with post-training planner updates.
...
### 52. [Embeddings for Preferences, Not Semantics](https://arxiv.org/abs/2605.08360) <a id="paper-2605-08360"></a>
...
**Comment:** Uses correlation-breaking synthetic data to separate preferential similarity from semantic nuisance.

**Topic Match:** Representation-learning objectives are the nearest fit; the core application is preference prediction for collective decisions.
...
### 53. [Positional LSH: Binary Block Matrix Approximation for Attention with Linear Biases](https://arxiv.org/abs/2605.09472) <a id="paper-2605-09472"></a>
...
**Comment:** Expresses ALiBi positional bias through random binary block masks and derives uniform attention-approximation bounds.

**Topic Match:** The formal connection concerns positional attention structure, while the operational contribution accelerates existing long-context ALiBi attention.
...
### 54. [A Qualitative Test-Risk Mechanism for Scaling Behavior in Normalized Residual Networks](https://arxiv.org/abs/2605.08297) <a id="paper-2605-08297"></a>
...
**Comment:** Decomposes residual depth expansion into representational gain, optimization gain, and generalization transfer.

**Topic Match:** Residual-block optimization is the architectural connection; the generic theorem supplies no language-model training setting.
...
### 55. [The Wittgensteinian Representation Hypothesis: Is Language the Attractor of Multimodal Convergence?](https://arxiv.org/abs/2605.09352) <a id="paper-2605-09352"></a>
...
**Comment:** Uses asymmetric representation alignment to test whether cross-modal convergence preferentially approaches language geometry.

**Topic Match:** Closest to representation analysis; the core subject is cross-modal alignment and an attractor hypothesis, with no demonstrated language-training mechanism.
...
### 56. [Unmasking On-Policy Distillation: Where It Helps, Where It Hurts, and Why](https://arxiv.org/abs/2605.10889) <a id="paper-2605-10889"></a>
...
**Comment:** Estimates ideal per-token update directions to diagnose when distillation gradients help or hurt student success.

**Topic Match:** Gradient diagnostics are closest to training dynamics, but the core subject is reasoning-model post-training distillation.
...
### 57. [Intrinsic Guardrails: How Semantic Geometry of Personality Interacts with Emergent Misalignment in LLMs](https://arxiv.org/abs/2605.10633) <a id="paper-2605-10633"></a>
...
**Comment:** Finds activation directions conserved through fine-tuning and transfers them to regulate emergent misalignment.

**Topic Match:** Tracks activation geometry across fine-tuning, but the core contribution is safety steering through personality directions.
...
### 58. [HoReN: Normalized Hopfield Retrieval for Large-Scale Sequential Model Editing](https://arxiv.org/abs/2605.08143) <a id="paper-2605-08143"></a>
...
**Comment:** Uses normalized Hopfield retrieval to stabilize routing across many sequential factual edits.

**Topic Match:** The Hopfield layer wrapper implements an external-memory editing system, outside the requested training mechanisms.
...
### 59. [SMIXAE: Towards Unsupervised Manifold Discovery in Language Models](https://arxiv.org/abs/2605.09224) <a id="paper-2605-09224"></a>
...
**Comment:** Uses sparse mixtures of autoencoders to recover multidimensional structures in Gemma activations.

**Topic Match:** Closest to hidden-representation analysis; the contribution is post-hoc feature discovery using an auxiliary autoencoder.
...
### 60. [Cross-Family Universality of Behavioral Axes via Anchor-Projected Representations](https://arxiv.org/abs/2605.09875) <a id="paper-2605-09875"></a>
...
**Comment:** Transfers behavioural directions between model families through a shared anchor-coordinate representation.

**Topic Match:** Closest to hidden-state analysis; the core contribution is cross-family interpretability and behavioural steering.
...
### 61. [When to Re-Commit: Temporal Abstraction Discovery for Long-Horizon Vision-Language Reasoning](https://arxiv.org/abs/2605.09860) <a id="paper-2605-09860"></a>
...
**Comment:** Learns state-dependent action commitment depth instead of using a fixed number of actions between observations.

**Topic Match:** Policy parameterization is the nearest architectural fit, but the contribution concerns vision-language planning and temporal action abstraction.
...
### 62. [Bilinear autoencoders find interpretable manifolds](https://arxiv.org/abs/2605.08891) <a id="paper-2605-08891"></a>
...
**Comment:** Uses quadratic latent forms to recover nonlinear manifolds in language-model activations.

**Topic Match:** The contribution is an interpretability tool for manifold discovery, without explaining the training mechanism that produces those manifolds.
...
### 63. [Continuous Latent Contexts Enable Efficient Online Learning in Transformers](https://arxiv.org/abs/2605.09867) <a id="paper-2605-09867"></a>
...
**Comment:** Uses compact latent context tokens to store the state of online learning algorithms inside transformers.

**Topic Match:** The architectural construction serves persistent memory for synthetic online decision tasks, outside language-model training.
...
### 64. [Predicting Plasticity in Deep Continual Learning: A Theoretical Perspective](https://arxiv.org/abs/2605.09044) <a id="paper-2605-09044"></a>
...
**Comment:** Tests rank-based plasticity diagnostics against counterexamples and proposes a gradient-based bound on future optimisation gain.

**Topic Match:** Closest to optimisation dynamics; validation concerns continual regression and MNIST rather than language-model training.
...
### 65. [Lattice Deduction Transformers](https://arxiv.org/abs/2605.08605) <a id="paper-2605-08605"></a>
...
**Comment:** Projects a recurrent transformer's latent state through a deduction lattice between forward passes.

**Topic Match:** The recurrent architecture is the closest fit, but its core subject is small constraint-solving reasoners rather than language-model training.
...
### 66. [What Time Is It? How Data Geometry Makes Time Conditioning Optional for Flow Matching](https://arxiv.org/abs/2605.08344) <a id="paper-2605-08344"></a>
...
**Comment:** Explains when data geometry makes flow-matching time conditioning dispensable.

**Topic Match:** Removing conditioning is an architectural mechanism, but the claim and experiments concern continuous image generation rather than language-model training.
...
### 67. [Complex-Valued Phase-Coherent Transformer](https://arxiv.org/abs/2605.10123) <a id="paper-2605-10123"></a>
...
**Comment:** Replaces softmax token competition with phase-preserving, non-competing attention gates.

**Topic Match:** Attention architecture is the closest category; the structural proposal is demonstrated on retrieval and classification rather than language-model training.
...
### 68. [Why Do Aligned LLMs Remain Jailbreakable: Refusal-Escape Directions, Operator-Level Sources, and Safety-Utility Trade-off](https://arxiv.org/abs/2605.08878) <a id="paper-2605-08878"></a>
...
**Comment:** Decomposes refusal-escape directions into normalization, residual-wiring, and terminal operator contributions.

**Topic Match:** Operator-level structure is the closest architectural topic, but the core question is jailbreak safety rather than architectural training instability.
...
### 69. [On Variance Reduction in Learning Mean Flows](https://arxiv.org/abs/2605.09235) <a id="paper-2605-09235"></a>
...
**Comment:** Identifies the control-variate coefficient behind unstable MeanFlow gradients and predicts its bias-variance effects.

**Topic Match:** The analysis explains an objective-induced training instability, but its subject is continuous generative flow models rather than language models.
...
### 70. [Do multimodal models imagine electric sheep?](https://arxiv.org/abs/2605.09693) <a id="paper-2605-09693"></a>
...
**Comment:** Shows that action-sequence supervision induces intermediate visual-state representations in a vision-language model.

**Topic Match:** The representational finding arises from visual-puzzle post-training and concerns emergent world modelling.
...
### 71. [The Propagation Field: A Geometric Substrate Theory of Deep Learning](https://arxiv.org/abs/2605.08529) <a id="paper-2605-08529"></a>
...
**Comment:** Treats hidden-state trajectories and layer Jacobians as explicit training objectives.

**Topic Match:** Propagation geometry connects to training dynamics, but the demonstrated contributions concern PDE systems, vision, and continual learning.
...
### 72. [TIDES: Implicit Time-Awareness in Selective State Space Models](https://arxiv.org/abs/2605.09742) <a id="paper-2605-09742"></a>
...
**Comment:** Separates input selectivity from physical sampling intervals by moving input dependence into the state matrix.

**Topic Match:** Selective SSM design is the closest category, but the trained models address irregular time-series classification and ODE regression.
...
### 73. [Diagnosing Spectral Ceilings in Equivariant Neural Force Fields](https://arxiv.org/abs/2605.08286) <a id="paper-2605-08286"></a>
...
**Comment:** Tests a predicted angular-frequency recoverability boundary using controlled injections and frozen-backbone probes.

**Topic Match:** Architectural mechanism analysis is the nearest category, but the models are molecular force fields; the evidence carefully limits its claim to degree-bounded probes.
...
### 74. [Reasoning emerges from constrained inference manifolds in large language models](https://arxiv.org/abs/2605.08142) <a id="paper-2605-08142"></a>
...
**Comment:** Proposes geometric conditions connecting representation compression and information preservation to stable inference dynamics.

**Topic Match:** Internal-dynamics analysis is the nearest category, but the core subject is inference-time reasoning diagnosis rather than architecture or training mechanisms.
...
### 75. [Mitigating Many-shot Jailbreak Attacks with One Single Demonstration](https://arxiv.org/abs/2605.08277) <a id="paper-2605-08277"></a>
...
**Comment:** Connects demonstration-induced activation drift to a counteracting update from one safety demonstration.

**Topic Match:** Activation dynamics supplies a mechanistic connection, but the core contribution is an inference-time jailbreak defense.
...
### 76. [HyperTransport: Amortized Conditioning of T2I Generative Models](https://arxiv.org/abs/2605.08254) <a id="paper-2605-08254"></a>
...
**Comment:** Amortizes unseen-concept activation interventions with an encoder-conditioned hypernetwork.

**Topic Match:** Learned activation conditioning is the closest architectural mechanism, but the target models generate images.
...
### 77. [Exactness Matters for Physical Rule Enforcement](https://arxiv.org/abs/2605.08285) <a id="paper-2605-08285"></a>
...
**Comment:** Identifies target distortion by a repair operator as a predictor of whether constraint enforcement helps or harms forecasting.

**Topic Match:** Studies constraints inside autoregressive architectures, but the models perform physical and hierarchical forecasting rather than language-model training.
...
### 78. [SkillMaster: Toward Autonomous Skill Mastery in LLM Agents](https://arxiv.org/abs/2605.08693) <a id="paper-2605-08693"></a>
...
**Comment:** Separates task-solving and skill-editing advantages to stabilize joint agent training.

**Topic Match:** Training-objective design is the nearest category; the core contribution is agent post-training and skill-bank management.
...
### 79. [Causal Dimensionality of Transformer Representations: Measurement, Scaling, and Layer Structure](https://arxiv.org/abs/2605.08740) <a id="paper-2605-08740"></a>
...
**Comment:** Contrasts SAE dictionary width with measured output-causal capacity across Transformer layers.

**Topic Match:** SAE-based capacity measurement dominates without identifying its producing mechanism; the reported equal causal counts are imposed by calibration.
...
### 80. [Quantifying Concentration Phenomena of Mean-Field Transformers in the Low-Temperature Regime](https://arxiv.org/abs/2605.10931) <a id="paper-2605-10931"></a>
...
**Comment:** Derives when low-temperature self-attention concentrates token states onto a weight-induced projection.

**Topic Match:** Attention dynamics provide the architectural connection, but the core contribution is an inference-time mean-field differential-equation analysis.
...
### 81. [Normalization Equivariance for Arbitrary Backbones, with Application to Image Denoising](https://arxiv.org/abs/2605.08193) <a id="paper-2605-08193"></a>
...
**Comment:** Moves exact normalization equivariance from internal-layer constraints to an input-output wrapper.

**Topic Match:** The factorization changes architectural constraints, but it addresses brightness and contrast equivariance in image denoising.
...
### 82. [ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](https://arxiv.org/abs/2605.10819) <a id="paper-2605-10819"></a>
...
**Comment:** Imposes composition and reversal consistency on latent action transitions before joint policy training.

**Topic Match:** The architectural mechanism concerns robot policies and video-derived action representations, outside language-model training.
...
### 83. [NoiseRater: Meta-Learned Noise Valuation for Diffusion Model Training](https://arxiv.org/abs/2605.08144) <a id="paper-2605-08144"></a>
...
**Comment:** Meta-learns noise-sample importance and converts soft training weights into hard noise selection.

**Topic Match:** The contribution changes training-objective weighting, but the trained diffusion models generate images.
...
### 84. [Scaling Limits of Long-Context Transformers](https://arxiv.org/abs/2605.08505) <a id="paper-2605-08505"></a>
...
**Comment:** Derives how attention temperature must scale with key density to maintain selectivity.

**Topic Match:** This is an asymptotic analysis of long-context attention under random-key assumptions, without a language-model training result.
...
### 85. [Elucidating Representation Degradation Problem in Diffusion Model Training](https://arxiv.org/abs/2605.10790) <a id="paper-2605-10790"></a>
...
**Comment:** Links noise-dependent target recoverability to NTK spectral weakening and reallocates optimization effort accordingly.

**Topic Match:** Diffusion optimization fits training dynamics conceptually, but the abstract establishes no language-model training setting.
...
### 86. [Controlling Transient Amplification Improves Long-horizon Rollouts](https://arxiv.org/abs/2605.08856) <a id="paper-2605-08856"></a>
...
**Comment:** Links rollout instability to non-normal, non-commuting Jacobians and directly regularizes that mechanism.

**Topic Match:** Architectural dynamics is the nearest category; the trained models are physical simulators and climate predictors.
...
### 87. [The Echo Amplifies the Knowledge: Somatic Marker Analogues in Language Models via Emotion Vector Re-Injection](https://arxiv.org/abs/2605.08611) <a id="paper-2605-08611"></a>
...
**Comment:** Re-injects sparse-autoencoder emotion features during recall to alter memory-conditioned decisions.

**Topic Match:** Activation interventions are the nearest architectural fit, but the core contribution is emotional memory and behavioral steering.
...
### 88. [Workspace Optimization: How to Train Your Agent](https://arxiv.org/abs/2605.09650) <a id="paper-2605-09650"></a>
...
**Comment:** Optimizes persistent workspace artifacts through interaction, counterexamples, and textual feedback.

**Topic Match:** The closest connection is an optimization procedure, but its trainable objects are external agent artifacts rather than model internals.
...
### 89. [When Attention Beats Fourier: Multi-Scale Transformers for PDE Solving on Irregular Domains](https://arxiv.org/abs/2605.08318) <a id="paper-2605-08318"></a>
...
**Comment:** Identifies the sign change in physics-regularization benefits across diffusion-dominated and chaotic PDE regimes.

**Topic Match:** Architecture selection and inductive bias are the nearest topics; the experimental subject is PDE solving rather than language-model training.
...
### 90. [Latent Geometry Beyond Search: Amortizing Planning in World Models](https://arxiv.org/abs/2605.08732) <a id="paper-2605-08732"></a>
...
**Comment:** A goal-conditioned inverse-dynamics model replaces iterative planning in a structured latent space.

**Topic Match:** The changed computation is control and planning in a pretrained visual world model, outside language-model training.
...
### 91. [HS-FNO: History-Space Fourier Neural Operator for Non-Markovian Partial Differential Equations](https://arxiv.org/abs/2605.09523) <a id="paper-2605-09523"></a>
...
**Comment:** Replaces learned history transport with exact shift-and-append updates while predicting only the newly exposed slice.

**Topic Match:** History-state parameterization is architectural, but all demonstrated models are PDE surrogates.
...
### 92. [VORT: Adaptive Power-Law Memory for NLP Transformers](https://arxiv.org/abs/2605.08966) <a id="paper-2605-08966"></a>
...
**Comment:** Introduces trainable power-law retention implemented through a finite collection of recurrent exponential accumulators.

**Topic Match:** The retention architecture targets long-lag memory, with evidence confined to synthetic retrieval and copying rather than language-model training.
...
### 93. [Neural Information Causality](https://arxiv.org/abs/2605.09316) <a id="paper-2605-09316"></a>
...
**Comment:** Separates representation-information diagnostics from independently certified interface-capacity bounds.

**Topic Match:** Representation bottlenecks provide the architectural connection; the contribution is a communication-theoretic framework without a language-model training result.
...
### 94. [Hyperparameter Transfer for Dense Associative Memories](https://arxiv.org/abs/2605.10164) <a id="paper-2605-10164"></a>
...
**Comment:** Derives hyperparameter-transfer prescriptions for shared weights and sharply peaked activations in dense associative memories.

**Topic Match:** Hyperparameter transfer is the nearest architectural topic; no language-model training setting is identified.
...
### 95. [Why Zeroth-Order Adaptation May Forget Less: A Randomized Shaping Theory](https://arxiv.org/abs/2605.10658) <a id="paper-2605-10658"></a>
...
**Comment:** Holds expected update norm fixed and isolates how randomized shaping changes exposure to anisotropic retention curvature.

**Topic Match:** Local optimizer geometry is the nearest fit, but the core is general continual-adaptation forgetting and stochastic-gradient analysis without an LM setting.
...
### 96. [Continuity Laws for Sequential Models](https://arxiv.org/abs/2605.08539) <a id="paper-2605-08539"></a>
...
**Comment:** Tests whether state-space model predictions remain consistent under temporal refinement.

**Topic Match:** Continuous-time sequence modeling is the core subject, with no language-model training setting identified.
...
### 97. [Consolidation-Expansion Operator Mechanics:A Unified Framework for Adaptive Learning](https://arxiv.org/abs/2605.09968) <a id="paper-2605-09968"></a>
...
**Comment:** Uses noncommutativity between consolidation and expansion as a convergence diagnostic and stopping signal.

**Topic Match:** Convergence theory is the nearest fit, but the developed language-model application controls recursive inference budgets.
...
### 98. [One for All: A Non-Linear Transformer can Enable Cross-Domain Generalization for In-Context Reinforcement Learning](https://arxiv.org/abs/2605.09727) <a id="paper-2605-09727"></a>
...
**Comment:** Connects nonlinear transformer computation to kernel temporal-difference learning with shared cross-domain weights.

**Topic Match:** Transformer operator design is the closest architectural topic, but the trained system performs in-context reinforcement learning.
...
### 99. [Convergence Analysis of Newton's Method for Neural Networks in the Overparameterized Limit](https://arxiv.org/abs/2605.08352) <a id="paper-2605-08352"></a>
...
**Comment:** Derives regularization scaling that makes infinite-width Newton dynamics converge uniformly across frequencies.

**Topic Match:** Optimizer parameterization is the nearest category, but the contribution concerns generic infinite-width networks without a language-model training setting.
...
### 100. [Tensor Product Representation Probes Reveal Shared Structure Across Linear Directions](https://arxiv.org/abs/2605.09967) <a id="paper-2605-09967"></a>
...
**Comment:** Factors board-state probes into position, color, and binding components.

**Topic Match:** The subject is probing a board-game model's representations, without explaining how training creates the factorization.
...
### 101. [Deterministic Decomposition of Stochastic Generative Dynamics](https://arxiv.org/abs/2605.08794) <a id="paper-2605-08794"></a>
...
**Comment:** Separates marginal probability transport from score-dependent stochastic effects in a generative drift.

**Topic Match:** Generative dynamics is the nearest architectural category, but the abstract does not establish a language-model or discrete-token training contribution.
...
### 102. [The Benefits of Temporal Correlations: SGD Learns k-Juntas from Random Walks Efficiently](https://arxiv.org/abs/2605.10237) <a id="paper-2605-10237"></a>
...
**Comment:** Shows how a temporal-difference objective exploits correlated samples to make sparse Boolean functions efficiently learnable.

**Topic Match:** The nearest connection is optimisation theory; the core subject is SGD learnability of Boolean juntas.
...
### 103. [The Polynomial Counting Capabilities of Message Passing Neural Networks](https://arxiv.org/abs/2605.10393) <a id="paper-2605-10393"></a>
...
**Comment:** Characterises when mean-aggregation message passing can express polynomial counting constraints.

**Topic Match:** Closest to architectural expressivity theory; the results concern graph neural networks and graph logic.
...
### 104. [Path-Coupled Bellman Flows for Distributional Reinforcement Learning](https://arxiv.org/abs/2605.08253) <a id="paper-2605-08253"></a>
...
**Comment:** Couples Bellman flow paths through shared noise to control training-target variance.

**Topic Match:** The optimization-target design trains return-distribution models for reinforcement learning, outside the language-model scope.
...
### 105. [Recovering Physical Dynamics from Discrete Observations via Intrinsic Differential Consistency](https://arxiv.org/abs/2605.08454) <a id="paper-2605-08454"></a>
...
**Comment:** Replaces local derivative supervision with semigroup consistency, which also determines adaptive solver step sizes.

**Topic Match:** Introduces a structural constraint on learned dynamics, but evaluates physical-flow recovery and PDE forecasting rather than language-model training.
...
### 106. [Improving Generalization by Permutation Routing Across Model Copies](https://arxiv.org/abs/2605.09256) <a id="paper-2605-09256"></a>
...
**Comment:** Replaces parameter averaging between replicas with permutation-routed learning messages through mixed computational paths.

**Topic Match:** Replica coupling is an architectural training mechanism, but no language-model setting or accounting for the cost of M model copies is provided.
...
### 107. [Learning Theory of Transformers: Local-to-Global Approximation via Softmax Partition of Unity](https://arxiv.org/abs/2605.08811) <a id="paper-2605-08811"></a>
...
**Comment:** Explains how softmax attention combines local approximations into a global predictor.

**Topic Match:** The guarantees concern regression approximation on Euclidean domains and manifolds, outside the language-model training scope.
...
### 108. [EquiMem: Calibrating Shared Memory in Multi-Agent Debate via Game-Theoretic Equilibrium](https://arxiv.org/abs/2605.09278) <a id="paper-2605-09278"></a>
...
**Comment:** Replaces heuristic shared-memory validation with equilibrium-based calibration of updates.

**Topic Match:** State-update mechanisms are the nearest architectural analogue, but this work calibrates external multi-agent memory at inference time.
...
### 109. [Don't Fix the Basis -- Learn It: Spectral Representation with Adaptive Basis Learning for PDEs](https://arxiv.org/abs/2605.10451) <a id="paper-2605-10451"></a>
...
**Comment:** Learns an invertible, spatially adaptive spectral frame while retaining O(N log N) complexity.

**Topic Match:** Learned spectral layers are architectural mechanisms, but these layers train PDE surrogates rather than language models.
...
### 110. [Zero-shot Imitation Learning by Latent Topology Mapping](https://arxiv.org/abs/2605.08450) <a id="paper-2605-08450"></a>
...
**Comment:** Makes learned behaviors composable through latent hubs and hub-to-hub policies.

**Topic Match:** Latent-state organization is the nearest architectural connection, but the work concerns imitation-learning policies and maze planning.
...
### 111. [RelFlexformer: Efficient Attention 3D-Transformers for Integrable Relative Positional Encodings](https://arxiv.org/abs/2605.10706) <a id="paper-2605-10706"></a>
...
**Comment:** Generalizes Fourier-based relative-position attention from regular grids to arbitrary 3D token locations.

**Topic Match:** Changes positional-attention design, but the models and evaluation target 3D data rather than language-model training.
...
### 112. [HH-SAE: Discovering and Steering Hierarchical Knowledge of Complex Manifolds](https://arxiv.org/abs/2605.10536) <a id="paper-2605-10536"></a>
...
**Comment:** Factorises sparse-autoencoder representations into contextual, atomic and compositional levels.

**Topic Match:** Representation architecture is the nearest connection; the demonstrated applications concern clinical and fraud data.
...
### 113. [Revisiting Policy Gradients for Restricted Policy Classes: Escaping Myopic Local Optima with $k$-step Policy Gradients](https://arxiv.org/abs/2605.10909) <a id="paper-2605-10909"></a>
...
**Comment:** Uses coupled k-step policy gradients to escape restricted-policy local optima with explicit convergence guarantees.

**Topic Match:** Closest to optimisation algorithms; the actual training problem concerns MDP policies and reinforcement learning.
...
### 114. [FRACTAL: SSM with Fractional Recurrent Architecture for Computational Temporal Analysis of Long Sequences](https://arxiv.org/abs/2605.08833) <a id="paper-2605-08833"></a>
...
**Comment:** Fractional projection measures sharpen recent-signal sensitivity while preserving scale-invariant recurrent memory.

**Topic Match:** The closest category is SSM architecture, but the core subject is long-sequence modeling evaluated on Long Range Arena.
...
### 115. [Beyond Static Bias: Adaptive Multi-Fidelity Bandits with Improving Proxies](https://arxiv.org/abs/2605.08558) <a id="paper-2605-08558"></a>
...
**Comment:** Uses improving low-fidelity proxies to replace repeated high-fidelity confirmations in bandit evaluation.

**Topic Match:** Adaptive optimization is the nearest category; the LLM judge is an application of the bandit algorithm, not the subject of a reliability audit.
...
### 116. [CATO: Charted Attention for Neural PDE Operators](https://arxiv.org/abs/2605.09016) <a id="paper-2605-09016"></a>
...
**Comment:** Learns a coordinate chart that determines the geometry used by axial attention.

**Topic Match:** Attention design is the nearest architectural category; the trained models are neural PDE operators on meshes.
...
### 117. [RAwR: Role-Aware Rewiring via Approximate Equitable Partition](https://arxiv.org/abs/2605.09457) <a id="paper-2605-09457"></a>
...
**Comment:** Uses approximate equitable partitions to rewire communication between nodes with matching structural roles.

**Topic Match:** Architectural signal propagation is the nearest category; the core contribution is graph-neural-network rewiring for graph prediction.
...
### 118. [The Geometric Structure of Models Learning Sparse Data](https://arxiv.org/abs/2605.08464) <a id="paper-2605-08464"></a>
...
**Comment:** Links feature-learning dynamics to Jacobian alignment and introduces a regularizer that induces it.

**Topic Match:** Training geometry is the closest connection, but the demonstrations concern grokking and tabular classifiers rather than language-model training.
...
### 119. [Generative Actor-Critic with Soft Bridge Policies](https://arxiv.org/abs/2605.08733) <a id="paper-2605-08733"></a>
...
**Comment:** Uses stochastic bridge policies to obtain a tractable entropy objective with one actor forward pass.

**Topic Match:** Policy parameterization and optimization are the nearest architectural connection; the contribution concerns continuous-control reinforcement learning.
...
### 120. [Quantile-Coupled Flow Matching for Distributional Reinforcement Learning](https://arxiv.org/abs/2605.08515) <a id="paper-2605-08515"></a>
...
**Comment:** Aligns flow-matching targets with the Wasserstein training objective through quantile-based coupling.

**Topic Match:** Objective design provides the training-mechanism connection, but the trained model is a distributional reinforcement-learning critic.
...
### 121. [Near-Optimal Last-Iterate Convergence for Zero-Sum Games with Bandit Feedback and Opponent Actions](https://arxiv.org/abs/2605.09363) <a id="paper-2605-09363"></a>
...
**Comment:** Shows that observing opponent actions enables optimal-rate last-iterate convergence with bandit feedback.

**Topic Match:** Optimization theory is the nearest category; the core result concerns zero-sum games and feedback information, without a language-model training mechanism.
...
### 122. [Minimal Filling Architectures of Polynomial Neural Networks: Counterexamples, Frontier Search, and Defects](https://arxiv.org/abs/2605.09609) <a id="paper-2605-09609"></a>
...
**Comment:** Disproves a unimodal-width conjecture for minimal filling architectures using a symbolically certified counterexample.

**Topic Match:** Architecture expressivity is the nearest category; the subject is polynomial neural-network geometry without a language-model training setting.
...
### 123. [A Deep Risk Estimator for Known Operator Learning](https://arxiv.org/abs/2605.08517) <a id="paper-2605-08517"></a>
...
**Comment:** Derives how replacing learned layers with known operators changes risk bounds and sample requirements.

**Topic Match:** Known-operator layer replacement is an architectural question, but the demonstrated setting is CT reconstruction and physics-informed networks.
...
### 124. [Characterizing the Generalization Error of Random Feature Regression with Arbitrary Data-Augmentation](https://arxiv.org/abs/2605.10290) <a id="paper-2605-10290"></a>
...
**Comment:** Characterizes augmentation-induced regression error using population quantities and augmentation moments.

**Topic Match:** Regularization analysis is the nearest training connection, but the setting is frozen-feature regression.
...
### 125. [Measuring and Decomposing Mode Separation via the Canonical Diffusion](https://arxiv.org/abs/2605.08777) <a id="paper-2605-08777"></a>
...
**Comment:** Separates barrier-induced mode fragmentation from dispersion using score-based diffusion autocorrelation.

**Topic Match:** Analysis of learned distributions is the nearest fit, but the contribution is a density-geometry diagnostic tested on images and molecular dynamics.
...
### 126. [Physical probes expose and alleviate chemical-environment collapse in molecular representations](https://arxiv.org/abs/2605.10429) <a id="paper-2605-10429"></a>
...
**Comment:** Uses atom-resolved spectral supervision to recover chemical distinctions lost by topological molecular representations.

**Topic Match:** Representation learning is the nearest architectural category, but CLAIM trains molecular encoders rather than language models.
...
### 127. [Embedding Dimension Lower Bounds for Universality of Deep Sets and Janossy Pooling](https://arxiv.org/abs/2605.08377) <a id="paper-2605-08377"></a>
...
**Comment:** Derives embedding-width lower bounds for universal permutation-invariant architectures.

**Topic Match:** Embedding dimension is an architectural design constraint, but the theorem concerns point-set networks rather than language-model training.
...
### 128. [Policy Gradient Methods for Non-Markovian Reinforcement Learning](https://arxiv.org/abs/2605.10816) <a id="paper-2605-10816"></a>
...
**Comment:** Jointly optimizes recurrent agent-state dynamics and control policies through a policy-gradient theorem.

**Topic Match:** Recurrent-state optimization provides the architectural connection, but the method trains agents in non-Markovian reinforcement-learning environments.
...
### 129. [Parameterized Complexity of Stationarity Testing for Piecewise-Affine Functions and Shallow CNN Losses](https://arxiv.org/abs/2605.10219) <a id="paper-2605-10219"></a>
...
**Comment:** Establishes dimension-parameterized tractability and hardness boundaries for testing stationarity.

**Topic Match:** Optimization foundations are the nearest category; the analysis concerns piecewise-affine functions and shallow CNN losses.
...
### 130. [Mistake-Bounded Language Generation](https://arxiv.org/abs/2605.10809) <a id="paper-2605-10809"></a>
...
**Comment:** Separates cumulative generation mistakes from last-mistake convergence and proves a trade-off between their guarantees.

**Topic Match:** Formal learnability is the nearest training-theory category; the paper studies abstract language classes rather than neural language-model training.
...
### 131. [Anchoring the Eigengap: Cross-Modal Spectral Stabilization for Sample-Efficient Representation Learning](https://arxiv.org/abs/2605.08764) <a id="paper-2605-08764"></a>
...
**Comment:** Relates data efficiency to covariance eigenmodes that remain recoverable above finite-sample noise.

**Topic Match:** The training-dynamics analysis concerns visual representation learning and medical imaging under data scarcity.
...
### 132. [From Passive Reuse to Active Reasoning: Grounding Large Language Models for Neuro-Symbolic Experience Replay](https://arxiv.org/abs/2605.09419) <a id="paper-2605-09419"></a>
...
**Comment:** LLM-induced behavioral rules reweight replay samples through differentiable logical grounding.

**Topic Match:** The trained system is a reinforcement-learning policy; the language model supplies zero-shot rules for replay selection.
...
### 133. [Natural Policy Gradient as Doubly Smoothed Policy Iteration: A Bellman-Operator Framework](https://arxiv.org/abs/2605.10671) <a id="paper-2605-10671"></a>
...
**Comment:** Recasts natural policy gradient as smoothed policy iteration to establish geometric convergence.

**Topic Match:** Optimization theory is the nearest topic, but the results concern reinforcement-learning policy updates rather than language-model training.
...
### 134. [The Reciprocity Gradient](https://arxiv.org/abs/2605.08323) <a id="paper-2605-08323"></a>
...
**Comment:** Backpropagates reward analytically through learned opponent policies and branching reputation chains.

**Topic Match:** Optimization mechanics are the nearest connection, but the method trains policies for strategic interactions.
...
### 135. [The Value of Mechanistic Priors in Sequential Decision Making](https://arxiv.org/abs/2605.10018) <a id="paper-2605-10018"></a>
...
**Comment:** Relates mechanistic-prior bias to sample efficiency and quantifies the penalty from confidently wrong priors.

**Topic Match:** Learning with structural priors is closest to training dynamics, but the analysis concerns sequential decisions and drug-dosing simulations.
...
### 136. [The Power of Second Order Methods for Sequence Preconditioning](https://arxiv.org/abs/2605.08390) <a id="paper-2605-08390"></a>
...
**Comment:** Pairs sequence preconditioning with second-order updates to obtain polylogarithmic regret.

**Topic Match:** Optimizer and preconditioner analysis is the nearest topic, but the subject is online prediction of linear dynamical systems.
...
### 137. [LaWM: Least Action World Models for Long-Horizon Physical Consistency from Visual Observations](https://arxiv.org/abs/2605.08279) <a id="paper-2605-08279"></a>
...
**Comment:** A learned discrete Lagrangian defines latent transitions through a variational integrator.

**Topic Match:** The new transition architecture trains physical world models, outside the language-model scope.
...
### 138. [Non-Parametric Rehearsal Learning via Conditional Mean Embeddings](https://arxiv.org/abs/2605.08999) <a id="paper-2605-08999"></a>
...
**Comment:** Uses conditional mean embeddings to estimate action-induced outcome changes without parametric dynamics assumptions.

**Topic Match:** Learning-objective design is the closest category; the contribution concerns kernel-based decision intervention.
...
### 139. [Learnability and Competition in High-Dimensional Multi-Component ICA](https://arxiv.org/abs/2605.08552) <a id="paper-2605-08552"></a>
...
**Comment:** Predicts when orthogonalization makes jointly learned ICA components compete and narrows their stable learning-rate window.

**Topic Match:** Training dynamics is the nearest category; the analysis concerns independent component analysis rather than language models.
...
### 140. [Learning When to Stop: Selective Imitation Learning Under Arbitrary Dynamics Shift](https://arxiv.org/abs/2605.09183) <a id="paper-2605-09183"></a>
...
**Comment:** Derives horizon-free guarantees for selective imitation with abstention under dynamics shift.

**Topic Match:** Learning-algorithm theory is the nearest available category; the subject is imitation-learning policies under environment shift.
...
### 141. [Central Limit Theorem for Two-Time-Scale Approximate Distributionally Robust RL](https://arxiv.org/abs/2605.08417) <a id="paper-2605-08417"></a>
...
**Comment:** Removes the adversarial inner optimization through a first-order, small-ambiguity Bellman approximation.

**Topic Match:** Optimization dynamics is the nearest category; the contribution concerns distributionally robust reinforcement learning.
...
### 142. [Generalization Error Bounds for Picard-Type Operator Learning in Nonlinear Parabolic PDEs](https://arxiv.org/abs/2605.10277) <a id="paper-2605-10277"></a>
...
**Comment:** Separates Picard truncation error from estimation error, allowing greater iteration depth without unbounded statistical complexity.

**Topic Match:** Architectural learning theory is the nearest category, but the contribution concerns PDE solution operators rather than language-model training.
...
### 143. [Exact Fixed-Point Constraints in Neural-ODEs with Provable Universality](https://arxiv.org/abs/2605.10613) <a id="paper-2605-10613"></a>
...
**Comment:** Enforces prescribed fixed points exactly while preserving a Neural ODE's universal approximation property.

**Topic Match:** Constrained network parameterization is architectural, but the subject is Neural ODEs evaluated on physical models.
...
### 144. [Shields to Guarantee Probabilistic Safety in MDPs](https://arxiv.org/abs/2605.10888) <a id="paper-2605-10888"></a>
...
**Comment:** Characterizes the safety-permissiveness tradeoff in probabilistic policy shields.

**Topic Match:** Algorithmic constraints provide only a loose connection to this category; MDP safety is outside the training scope.
...
### 145. [The Pok\'emon Theorem and other Fairness Impossibility Results](https://arxiv.org/abs/2605.09221) <a id="paper-2605-09221"></a>
...
**Comment:** Derives representation-collapse and residual-fairness bounds from conditional-embedding constraints.

**Topic Match:** Representation constraints provide the nearest connection; the core subject is fairness impossibility theory.
...
### 146. [Switching-Geometry Analysis of Deflated Q-Value Iteration](https://arxiv.org/abs/2605.10811) <a id="paper-2605-10811"></a>
...
**Comment:** Shows that scalar recentering preserves greedy policies while sharpening the characterization of Q-iteration convergence.

**Topic Match:** Optimization dynamics is the nearest category; the analyzed algorithm is MDP value iteration.
...
### 147. [On Characterizing Learnability for Adversarial Noisy Bandits](https://arxiv.org/abs/2605.09200) <a id="paper-2605-09200"></a>
...
**Comment:** Characterizes adversarial bandit learnability through a convexified maximin-volume criterion.

**Topic Match:** Learning-theory foundations are the nearest available category; the subject is bandit learnability rather than model construction or training.
...
## Training Algorithms That Change What Is Possible (15) <a id="topic-training-systems"></a>

### 1. [Practical Scaling Laws: Converting Compute into Performance in a Data-Constrained World](https://arxiv.org/abs/2605.09189) <a id="paper-2605-09189"></a>
...
**Comment:** Separates unique corpus size from cumulative training exposures, allowing repetition to vary while available data stays fixed.

**Topic Match:** The scaling law directly configures model size, corpus acquisition, and repeated-data training, with validation on five published LLM grids.
...
### 2. [Lakestream: A Consistent and Brokerless Data Plane for Large Foundation Model Training](https://arxiv.org/abs/2605.09994) <a id="paper-2605-09994"></a>
...
**Comment:** Defines atomic global batches tied to checkpoints for consistent distributed training recovery.

**Topic Match:** Training infrastructure is the nearest category, but the contribution concerns data-plane consistency, ingestion throughput, and recovery rather than a training algorithm.
...
### 3. [ReLibra: Routing-Replay-Guided Load Balancing for MoE Training in Reinforcement Learning](https://arxiv.org/abs/2605.08639) <a id="paper-2605-08639"></a>
...
**Comment:** Uses rollout routing replay to balance expert workloads at micro-batch granularity.

**Topic Match:** Expert placement and replication improve execution throughput, placing the contribution within the excluded MoE systems category.
...
### 4. [BubbleSpec: Turning Long-Tail Bubbles into Speculative Rollout Drafts for Synchronous Reinforcement Learning](https://arxiv.org/abs/2605.08862) <a id="paper-2605-08862"></a>
...
**Comment:** Preserves synchronous RL updates while using idle GPU time to prepare speculative rollout drafts.

**Topic Match:** Training systems is the nearest category, but the contribution is rollout scheduling and decoding throughput with the algorithm unchanged.
...
### 5. [RubiConv -- Efficient Boundary-Respecting Convolutions](https://arxiv.org/abs/2605.08451) <a id="paper-2605-08451"></a>
...
**Comment:** Computes convolutions over packed training sequences while preserving document boundaries.

**Topic Match:** The contribution accelerates execution of existing convolutional models, placing it within the throughput-engineering exclusion.
...
### 6. [SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning](https://arxiv.org/abs/2605.09423) <a id="paper-2605-09423"></a>
...
**Comment:** Couples executable environment generation with learner feedback to construct adaptive embodied-training curricula.

**Topic Match:** Environment generation and curricula are nearest to training systems, but this is embodied-agent simulation infrastructure.
...
### 7. [Core-Halo Decomposition: Decentralizing Large-Scale Fixed-Point Problems](https://arxiv.org/abs/2605.08681) <a id="paper-2605-08681"></a>
...
**Comment:** Separates block write ownership from overlapping read context to preserve the original fixed-point operator.

**Topic Match:** Decentralized algorithms are the nearest systems topic, but no language-model training algorithm or experiment is specified.
...
### 8. [Block-Wise Differentiable Sinkhorn Attention: Tail-Refinement Gradients with a Gap-Aware Dustbin Bridge](https://arxiv.org/abs/2605.08123) <a id="paper-2605-08123"></a>
...
**Comment:** Differentiates a fixed-depth Sinkhorn refinement using one reference tile and linear auxiliary memory.

**Topic Match:** The central result is a memory-efficient TPU backward-pass implementation, demonstrated on protein sequences outside the language-model scope.
...
### 9. [TRAM: Training Approximate Multiplier Structures for Low-Power AI Accelerators](https://arxiv.org/abs/2605.08231) <a id="paper-2605-08231"></a>
...
**Comment:** Jointly optimizes approximate-multiplier structure and model weights to reduce arithmetic power consumption.

**Topic Match:** Numerical co-design is the nearest training-systems category, but the contribution targets accelerator power for vision models.
...
### 10. [Adversary-Robust Learning from Fully Asynchronous Directional Derivative Estimates](https://arxiv.org/abs/2605.09337) <a id="paper-2605-09337"></a>
...
**Comment:** Combines fully asynchronous signed-projection updates with two-timescale bias correction for adversarial workers.

**Topic Match:** Asynchronous optimization is the nearest systems topic, but the demonstrated training setting is MNIST classification.
...
### 11. [Function-Space ADMM for Decentralized Federated Learning: A Control Theoretic Perspective](https://arxiv.org/abs/2605.09356) <a id="paper-2605-09356"></a>
...
**Comment:** Performs decentralized consensus in function space and projects updates back to parameters through distillation.

**Topic Match:** Decentralized optimization is the nearest systems topic; the stated setting is non-IID edge learning without a language-model training demonstration.
...
### 12. [Unveiling High-Probability Generalization in Decentralized SGD](https://arxiv.org/abs/2605.10205) <a id="paper-2605-10205"></a>
...
**Comment:** Tightens decentralized SGD generalization guarantees from inverse-confidence to logarithmic-confidence dependence.

**Topic Match:** Decentralized optimization is the nearest systems topic, but this is generalization-bound analysis without language-model training or a new distributed training algorithm.
...
### 13. [PMCTS: Particle Monte Carlo Tree Search for Principled Parallelized Inference Time Scaling](https://arxiv.org/abs/2605.08982) <a id="paper-2605-08982"></a>
...
**Comment:** Parallelizes tree search while preserving formal policy-improvement guarantees.

**Topic Match:** A parallel algorithm with an invariant is the nearest systems connection, but this algorithm scales inference rather than training.
...
### 14. [LoKA: Low-precision Kernel Applications for Recommendation Models At Scale](https://arxiv.org/abs/2605.10886) <a id="paper-2605-10886"></a>
...
**Comment:** Profiles per-layer numerical error and modifies sensitive model components to support stable FP8 training.

**Topic Match:** Low-precision training is the nearest topic, but the entire framework targets recommendation models.
...
### 15. [Sharp feature-learning transitions and Bayes-optimal neural scaling laws in extensive-width networks](https://arxiv.org/abs/2605.10395) <a id="paper-2605-10395"></a>
...
**Comment:** Relates recoverable feature count to the data budget and optimal student width.

**Topic Match:** The scaling laws concern a synthetic one-hidden-layer teacher-student problem and do not establish how to configure language-model runs.
...
### 1. [Hierarchical Mixture-of-Experts with Two-Stage Optimization](https://arxiv.org/abs/2605.08292) <a id="paper-2605-08292"></a>
...
**Comment:** Assigns traffic balancing to expert groups and specialization to experts within each group.

**Topic Match:** Directly changes routing objectives for balance, specialization, and collapse, with 7B-model pretraining and targeted ablations.
...
### 2. [DECO: Sparse Mixture-of-Experts with Dense-Comparable Performance on End-Side Devices](https://arxiv.org/abs/2605.10933) <a id="paper-2605-10933"></a>
...
**Comment:** Tests dense-comparable quality at fixed total parameters and training tokens while activating only 20% of experts.

**Topic Match:** Differentiable routing, routed/shared expert weighting, and activation stability are substantive expert-design contributions.
...
### 3. [SDG-MoE: Signed Debate Graph Mixture-of-Experts](https://arxiv.org/abs/2605.08322) <a id="paper-2605-08322"></a>
...
**Comment:** Adds signed interactions among selected experts with explicit stability conditions for their resulting dynamics.

**Topic Match:** Communication between expert representations changes sparse-layer computation and specialization, making this an expert-design contribution.
...
### 1. [BCJR-QAT: A Differentiable Relaxation of Trellis-Coded Weight Quantization](https://arxiv.org/abs/2605.10655) <a id="paper-2605-10655"></a>
...
**Comment:** Makes trellis-coded weight optimization differentiable by replacing Viterbi selection with BCJR path expectations.

**Topic Match:** The mechanism enables quantization-aware optimization of trellis codes; demonstrated gains depend on a specific distillation schedule and narrow evaluation.
...
### 2. [Not All Thoughts Need HBM: Semantics-Aware Memory Hierarchy for LLM Reasoning](https://arxiv.org/abs/2605.09490) <a id="paper-2605-09490"></a>
...
**Comment:** Separates GPU cache residency from token deletion through exact CPU offloading.

**Topic Match:** The memory savings concern serving and combine established offloading and eviction primitives; they do not change language-model training.
...
### 3. [Nectar: Neural Estimation of Cached-Token Attention via Regression](https://arxiv.org/abs/2605.09778) <a id="paper-2605-09778"></a>
...
**Comment:** Replaces a fixed context's KV cache with learned attention-output and normalizer functions.

**Topic Match:** This is inference cache compression requiring context-specific fitting and accepting approximation error, so the gain is conditional.
...
### 4. [Compute Where it Counts: Self Optimizing Language Models](https://arxiv.org/abs/2605.10875) <a id="paper-2605-10875"></a>
...
**Comment:** Learns token-wise allocations of attention sparsity, MLP pruning, and activation precision.

**Topic Match:** Compression-budget allocation is the central mechanism, but it combines existing primitives to optimize frozen-model inference efficiency.
...
### 5. [PARD-2: Target-Aligned Parallel Draft Model for Dual-Mode Speculative Decoding](https://arxiv.org/abs/2605.08632) <a id="paper-2605-08632"></a>
...
**Comment:** Aligns draft-model optimization with consecutive token acceptance through confidence-adaptive weighting.

**Topic Match:** The central contribution is lossless inference acceleration through a better draft-training objective.
...
### 6. [ConQuR: Corner Aligned Activation Quantization via Optimized Rotations for LLMs](https://arxiv.org/abs/2605.10793) <a id="paper-2605-10793"></a>
...
**Comment:** Uses closed-form Procrustes rotation updates and online calibration to reduce activation-quantization calibration requirements.

**Topic Match:** Quantization is the nearest registry topic; the core contribution is post-training calibration for deployment.
...
### 7. [LAQuant: A Simple Overhead-free Large Reasoning Model Quantization by Layer-wise Lookahead Loss](https://arxiv.org/abs/2605.08755) <a id="paper-2605-08755"></a>
...
**Comment:** Uses a one-layer lookahead quantization loss to preserve the next layer's residual stream.

**Topic Match:** Weight-only QAT is the compression connection; the demonstrated benefit is deployment-oriented and depends on calibration and additional tuning.
...
### 8. [Test-Time Speculation](https://arxiv.org/abs/2605.09329) <a id="paper-2605-09329"></a>
...
**Comment:** Adapts speculative draft models using verification feedback to recover acceptance length during generation.

**Topic Match:** Online draft distillation targets speculative-decoding efficiency, within the excluded inference-throughput category.
...
### 9. [KV-RM: Regularizing KV-Cache Movement for Static-Graph LLM Serving](https://arxiv.org/abs/2605.09735) <a id="paper-2605-09735"></a>
...
**Comment:** Separates logical KV histories from physical storage to support paged cache movement beneath a fixed-shape decoder.

**Topic Match:** Cache efficiency is the nearest topic; this is a serving-runtime memory-management contribution.
...
### 10. [Make Each Token Count: Towards Improving Long-Context Performance with KV Cache Eviction](https://arxiv.org/abs/2605.09649) <a id="paper-2605-09649"></a>
...
**Comment:** Globally calibrated retention gates allocate KV capacity across layers, heads, and modalities.

**Topic Match:** Memory efficiency is the closest category, but the core subject is long-context cache eviction during inference.
...
### 11. [AdaPaD: Adaptive Parallel Deflation for PEFT with Self-Correcting Rank Discovery](https://arxiv.org/abs/2605.10741) <a id="paper-2605-10741"></a>
...
**Comment:** Jointly refines rank-one directions so deflation errors self-correct and per-module rank emerges under a fixed adapter budget.

**Topic Match:** Closest to low-rank efficiency methods; the central subject is adaptive parameter-efficient fine-tuning.
...
### 12. [Queryable LoRA: Instruction-Regularized Routing Over Shared Low-Rank Update Atoms](https://arxiv.org/abs/2605.08423) <a id="paper-2605-08423"></a>
...
**Comment:** Makes low-rank updates input-dependent through a shared, queryable bank of update atoms.

**Topic Match:** The low-rank parameterization serves parameter-efficient fine-tuning, an explicitly excluded core subject.
...
### 13. [TileQ: Efficient Low-Rank Quantization of Mixture-of-Experts with 2D Tiling](https://arxiv.org/abs/2605.09281) <a id="paper-2605-09281"></a>
...
**Comment:** Shares low-rank factors across expert input and output dimensions through two-dimensional tiling.

**Topic Match:** Low-rank weight compression is the closest topic; the method is post-training quantization for MoE deployment.
...
### 14. [GELATO: Generative Entropy- and Lyapunov-based Adaptive Token Offloading for Device-Edge Speculative LLM Inference](https://arxiv.org/abs/2605.10124) <a id="paper-2605-10124"></a>
...
**Comment:** Combines entropy-guided drafting with a Lyapunov controller to manage speculative-decoding throughput under energy constraints.

**Topic Match:** Efficiency is the nearest registry topic; the contribution concerns device-edge inference scheduling.
...
### 15. [Prospective Compression in Human Abstraction Learning](https://arxiv.org/abs/2605.09985) <a id="paper-2605-09985"></a>
...
**Comment:** Tests prospective versus retrospective compression using curricula designed to separate their predictions.

**Topic Match:** Compression is the nearest registry concept, but it describes human program-library acquisition rather than model compression.
...
### 16. [Selection Plateau and a Sparsity-Dependent Hierarchy of Pruning Features](https://arxiv.org/abs/2605.09345) <a id="paper-2605-09345"></a>
...
**Comment:** Tests which scorer features escape equal-ranking pruning plateaus at fixed sparsity.

**Topic Match:** Pruning-score expressiveness is the central compression question, but the proposed hierarchy is demonstrated only on a small vision setting.
...
### 17. [Skill-CMIB: Multimodal Agent Skill for Consistent Action via Conditional Multimodal Information Bottleneck](https://arxiv.org/abs/2605.08526) <a id="paper-2605-08526"></a>
...
**Comment:** Separately compresses textual skills and the predictive perceptual residual remaining after conditioning on text.

**Topic Match:** Information compression is the closest category; its objects are agent skills and stored perceptual information.
...
### 18. [Optimality of Sub-network Laplace Approximations: New Results and Methods](https://arxiv.org/abs/2605.09075) <a id="paper-2605-09075"></a>
...
**Comment:** Derives predictive-variance guarantees for principled sparse Hessian subset selection.

**Topic Match:** Sparse approximation is the closest category; the contribution concerns posterior uncertainty rather than language-model training.
