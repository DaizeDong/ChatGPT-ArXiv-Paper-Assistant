...
2. [Self-Regularized Learning Methods](#user-content-link2)
**Authors:** Max Schölpple, Liu Fanghui, Ingo Steinwart

3. [Transformers are Bayesian Networks](#user-content-link3)
**Authors:** Gregory Coppola

4. [MDM-Prime-v2: Binary Encoding and Index Shuffling Enable Compute-optimal Scaling of Diffusion Language Models](#user-content-link4)
...
6. [High-dimensional estimation with missing data: Statistical and computational limits](#user-content-link6)
**Authors:** Kabir Aladin Verchand, Ankit Pensia, Saminul Haque, Rohith Kuditipudi

7. [BATQuant: Outlier-resilient MXFP4 Quantization via Learnable Block-wise Optimization](#user-content-link7)
**Authors:** Ji-Fu Li, Manyi Zhang, Xiaobo Xia, Han Bao, Haoli Bai, Zhenhua Dong, Xianzhi Yu

8. [An Efficient Heterogeneous Co-Design for Fine-Tuning on a Single GPU](#user-content-link8)
**Authors:** Ruijia Yang, Zeyi Wen

9. [High-Dimensional Gaussian Mean Estimation under Realizable Contamination](#user-content-link9)
**Authors:** Ilias Diakonikolas, Daniel M. Kane, Thanasis Pittas

10. [Knowledge Localization in Mixture-of-Experts LLMs Using Cross-Lingual Inconsistency](#user-content-link10)
**Authors:** Lucas Bandarkar, Alan Ansell, Trevor Cohn

11. [Understanding Quantization of Optimizer States in LLM Pre-training: Dynamics of State Staleness and Effectiveness of State Resets](#user-content-link11)
**Authors:** Kristi Topollai, Anna Choromanska

12. [GIST: Gauge-Invariant Spectral Transformers for Scalable Graph Neural Operators](#user-content-link12)
**Authors:** Mattia Rigotti, Nicholas Thumiger, Thomas Frick

13. [Unifying Optimization and Dynamics to Parallelize Sequential Computation: A Guide to Parallel Newton Methods for Breaking Sequential Bottlenecks](#user-content-link13)
**Authors:** Xavier Gonzalez

14. [Capability-Guided Compression: Toward Interpretability-Aware Budget Allocation for Large Language Models](#user-content-link14)
**Authors:** Rishaank Gupta

15. [NANOZK: Layerwise Zero-Knowledge Proofs for Verifiable Large Language Model Inference](#user-content-link15)
**Authors:** Zhaohui Geoffrey Wang

16. [Decoding the Critique Mechanism in Large Reasoning Models](#user-content-link16)
**Authors:** Hoang Phan, Quang H. Nguyen, Hung T. Q. Le, Xiusi Chen, Heng Ji, Khoa D. Doan

17. [Early Quantization Shrinks Codebook: A Simple Fix for Diversity-Preserving Tokenization](#user-content-link17)
**Authors:** Wenhao Zhao, Qiran Zou, Rushi Shah, Yudi Wu, Zhouhan Lin, Dianbo Liu

18. [Self-Aware Markov Models for Discrete Reasoning](#user-content-link18)
**Authors:** Gregor Kornhardt, Jannis Chemseddine, Christian Wald, Gabriele Steidl

19. [Efficient LLM Serving for Agentic Workflows: A Data Systems Perspective](#user-content-link19)
**Authors:** Noppanat Wadlom, Junyi Shen, Yao Lu

20. [Demystifing Video Reasoning](#user-content-link20)
...
21. [Transformers Can Learn Rules They've Never Seen: Proof of Computation Beyond Interpolation](#user-content-link21)
**Authors:** Andy Gray

22. [SOMP: Scalable Gradient Inversion for Large Language Models via Subspace-Guided Orthogonal Matching Pursuit](#user-content-link22)
**Authors:** Yibo Li, Qiongxiu Li

23. [NeuronSpark: A Spiking Neural Network Language Model with Selective State Space Dynamics](#user-content-link23)
**Authors:** Zhengzheng Tang

24. [Trained Persistent Memory for Frozen Encoder--Decoder LLMs: Six Architectural Methods](#user-content-link24)
**Authors:** Hong Jeong

25. [Optimal uncertainty bounds for multivariate kernel regression under bounded noise: A Gaussian process-based dual function](#user-content-link25)
**Authors:** Amon Lahr, Anna Scampicchio, Johannes Köhler, Melanie N. Zeilinger

26. [Online Semi-infinite Linear Programming: Efficient Algorithms via Function Approximation](#user-content-link26)
**Authors:** Yiming Zong, Jiashuo Jiang

27. [SF-Mamba: Rethinking State Space Model for Vision](#user-content-link27)
**Authors:** Masakazu Yoshimura, Teruaki Hayashi, Yuki Hoshino, Wei-Yao Wang, Takeshi Ohashi

28. [V-Co: A Closer Look at Visual Representation Alignment via Co-Denoising](#user-content-link28)
**Authors:** Han Lin, Xichen Pan, Zun Wang, Yue Zhang, Chu Wang, Jaemin Cho, Mohit Bansal

29. [Pre-training LLM without Learning Rate Decay Enhances Supervised Fine-Tuning](#user-content-link29)
**Authors:** Kazuki Yano, Shun Kiyono, Sosuke Kobayashi, Sho Takase, Jun Suzuki

30. [Grid-World Representations in Transformers Reflect Predictive Geometry](#user-content-link30)
**Authors:** Sasha Brenner, Thomas R. Knösche, Nico Scherf

31. [Catching rationalization in the act: detecting motivated reasoning before and after CoT via activation probing](#user-content-link31)
**Authors:** Parsa Mirtaheri, Mikhail Belkin

32. [PRISM: Demystifying Retention and Interaction in Mid-Training](#user-content-link32)
**Authors:** Bharat Runwal, Ashish Agrawal, Anurag Roy, Rameswar Panda

33. [Behavioral Steering in a 35B MoE Language Model via SAE-Decoded Probe Vectors: One Agency Axis, Not Five Traits](#user-content-link33)
**Authors:** Jia Qing Yap

34. [Dependence Fidelity and Downstream Inference Stability in Generative Models](#user-content-link34)
**Authors:** Nazia Riasat

35. [Parallel In-context Learning for Large Vision Language Models](#user-content-link35)
**Authors:** Shin'ya Yamaguchi, Daiki Chijiwa, Tamao Sakao, Taku Hasegawa

36. [Efficient Reasoning on the Edge](#user-content-link36)
...
37. [Implementation of tangent linear and adjoint models for neural networks based on a compiler library tool](#user-content-link37)
...
## 2. [Self-Regularized Learning Methods](https://arxiv.org/abs/2603.17160) <a id="link2"></a>
...
## 3. [Transformers are Bayesian Networks](https://arxiv.org/abs/2603.17063) <a id="link3"></a>
...
## 4. [MDM-Prime-v2: Binary Encoding and Index Shuffling Enable Compute-optimal Scaling of Diffusion Language Models](https://arxiv.org/abs/2603.16077) <a id="link4"></a>
...
## 6. [High-dimensional estimation with missing data: Statistical and computational limits](https://arxiv.org/abs/2603.16712) <a id="link6"></a>
...
## 7. [BATQuant: Outlier-resilient MXFP4 Quantization via Learnable Block-wise Optimization](https://arxiv.org/abs/2603.16590) <a id="link7"></a>
...
## 8. [An Efficient Heterogeneous Co-Design for Fine-Tuning on a Single GPU](https://arxiv.org/abs/2603.16428) <a id="link8"></a>
...
## 9. [High-Dimensional Gaussian Mean Estimation under Realizable Contamination](https://arxiv.org/abs/2603.16798) <a id="link9"></a>
...
## 10. [Knowledge Localization in Mixture-of-Experts LLMs Using Cross-Lingual Inconsistency](https://arxiv.org/abs/2603.17102) <a id="link10"></a>
...
## 11. [Understanding Quantization of Optimizer States in LLM Pre-training: Dynamics of State Staleness and Effectiveness of State Resets](https://arxiv.org/abs/2603.16731) <a id="link11"></a>
...
## 12. [GIST: Gauge-Invariant Spectral Transformers for Scalable Graph Neural Operators](https://arxiv.org/abs/2603.16849) <a id="link12"></a>
...
## 13. [Unifying Optimization and Dynamics to Parallelize Sequential Computation: A Guide to Parallel Newton Methods for Breaking Sequential Bottlenecks](https://arxiv.org/abs/2603.16850) <a id="link13"></a>
...
## 14. [Capability-Guided Compression: Toward Interpretability-Aware Budget Allocation for Large Language Models](https://arxiv.org/abs/2603.16440) <a id="link14"></a>
...
## 15. [NANOZK: Layerwise Zero-Knowledge Proofs for Verifiable Large Language Model Inference](https://arxiv.org/abs/2603.18046) <a id="link15"></a>
...
## 16. [Decoding the Critique Mechanism in Large Reasoning Models](https://arxiv.org/abs/2603.16331) <a id="link16"></a>
...
## 17. [Early Quantization Shrinks Codebook: A Simple Fix for Diversity-Preserving Tokenization](https://arxiv.org/abs/2603.17052) <a id="link17"></a>
...
## 18. [Self-Aware Markov Models for Discrete Reasoning](https://arxiv.org/abs/2603.16661) <a id="link18"></a>
...
## 19. [Efficient LLM Serving for Agentic Workflows: A Data Systems Perspective](https://arxiv.org/abs/2603.16104) <a id="link19"></a>
...
## 20. [Demystifing Video Reasoning](https://arxiv.org/abs/2603.16870) <a id="link20"></a>
...
## 21. [Transformers Can Learn Rules They've Never Seen: Proof of Computation Beyond Interpolation](https://arxiv.org/abs/2603.17019) <a id="link21"></a>
...
## 22. [SOMP: Scalable Gradient Inversion for Large Language Models via Subspace-Guided Orthogonal Matching Pursuit](https://arxiv.org/abs/2603.16761) <a id="link22"></a>
...
## 23. [NeuronSpark: A Spiking Neural Network Language Model with Selective State Space Dynamics](https://arxiv.org/abs/2603.16148) <a id="link23"></a>
...
## 24. [Trained Persistent Memory for Frozen Encoder--Decoder LLMs: Six Architectural Methods](https://arxiv.org/abs/2603.16413) <a id="link24"></a>
...
## 25. [Optimal uncertainty bounds for multivariate kernel regression under bounded noise: A Gaussian process-based dual function](https://arxiv.org/abs/2603.16481) <a id="link25"></a>
...
## 26. [Online Semi-infinite Linear Programming: Efficient Algorithms via Function Approximation](https://arxiv.org/abs/2603.16200) <a id="link26"></a>
...
## 27. [SF-Mamba: Rethinking State Space Model for Vision](https://arxiv.org/abs/2603.16423) <a id="link27"></a>
...
## 28. [V-Co: A Closer Look at Visual Representation Alignment via Co-Denoising](https://arxiv.org/abs/2603.16792) <a id="link28"></a>
...
## 29. [Pre-training LLM without Learning Rate Decay Enhances Supervised Fine-Tuning](https://arxiv.org/abs/2603.16127) <a id="link29"></a>
...
## 30. [Grid-World Representations in Transformers Reflect Predictive Geometry](https://arxiv.org/abs/2603.16689) <a id="link30"></a>
...
## 31. [Catching rationalization in the act: detecting motivated reasoning before and after CoT via activation probing](https://arxiv.org/abs/2603.17199) <a id="link31"></a>
...
## 32. [PRISM: Demystifying Retention and Interaction in Mid-Training](https://arxiv.org/abs/2603.17074) <a id="link32"></a>
...
## 33. [Behavioral Steering in a 35B MoE Language Model via SAE-Decoded Probe Vectors: One Agency Axis, Not Five Traits](https://arxiv.org/abs/2603.16335) <a id="link33"></a>
...
## 34. [Dependence Fidelity and Downstream Inference Stability in Generative Models](https://arxiv.org/abs/2603.17041) <a id="link34"></a>
...
## 35. [Parallel In-context Learning for Large Vision Language Models](https://arxiv.org/abs/2603.16092) <a id="link35"></a>
...
## 36. [Efficient Reasoning on the Edge](https://arxiv.org/abs/2603.16867) <a id="link36"></a>
...
## 37. [Implementation of tangent linear and adjoint models for neural networks based on a compiler library tool](https://arxiv.org/abs/2603.16976) <a id="link37"></a>
