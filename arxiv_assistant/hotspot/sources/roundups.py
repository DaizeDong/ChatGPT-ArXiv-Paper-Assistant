...
from arxiv_assistant.hotspot.support.source_fetch import clip_text, fetch_text, is_fresh, load_roundup_registry, normalize_url
...
def _extract_page_date(page_html: str) -> str | None:
    ...
    from arxiv_assistant.hotspot.support.source_fetch import parse_datetime
    soup = BeautifulSoup(page_html, "html.parser")
