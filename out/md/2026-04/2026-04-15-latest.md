...
2. [Rethinking On-Policy Distillation of Large Language Models: Phenomenology, Mechanism, and Recipe](#paper-2604-13016)
...
4. [Drawing on Memory: Dual-Trace Encoding Improves Cross-Session Recall in LLM Agents](#paper-2604-12948)
...
6. [A Bayesian Perspective on the Role of Epistemic Uncertainty for Delayed Generalization in In-Context Learning](#paper-2604-12434)
**Authors:** Abdessamed Qchohi, Simone Rossi

7. [M$^\star$: Every Task Deserves Its Own Memory Harness](#paper-2604-11811)
**Authors:** Wenbo Pan, Shujie Liu, Xiangyang Zhou, Shiwei Zhang, Wanlu Shi, Mirror Xu, Xiaohua Jia

8. [Understanding and Improving Continuous Adversarial Training for LLMs via In-context Learning Theory](#paper-2604-12817)
**Authors:** Shaopeng Fu, Di Wang

9. [Robust Optimization for Mitigating Reward Hacking with Correlated Proxies](#paper-2604-12086)
**Authors:** Zixuan Liu, Xiaolin Sun, Zizhan Zheng

10. [Loop Corrections to the Training and Generalization Errors of Random Feature Models](#paper-2604-12827)
**Authors:** Taeyoung Kim

11. [Algorithmic Analysis of Dense Associative Memory: Finite-Size Guarantees and Adversarial Robustness](#paper-2604-12811)
**Authors:** Madhava Gaikwad

12. [Information-Geometric Decomposition of Generalization Error in Unsupervised Learning](#paper-2604-12340)
**Authors:** Gilhan Kim

## [Training Algorithms That Change What Is Possible](#topic-training-systems) (2)

1. [PipeLive: Efficient Live In-place Pipeline Parallelism Reconfiguration for Dynamic LLM Serving](#paper-2604-12171)
**Authors:** Xu Bai, Muhammed Tawfiqul Islam, Chen Wang, Adel N. Toosi

2. [Decentralized Learning via Random Walk with Jumps](#paper-2604-12260)
...
1. [LoSA: Locality Aware Sparse Attention for Block-Wise Diffusion Language Models](#paper-2604-12056)
...
5. [When to Forget: A Memory Governance Primitive](#paper-2604-12007)
**Authors:** Baris Simsek

6. [ProbeLogits: Kernel-Level LLM Inference Primitives for AI-Native Operating Systems](#paper-2604-11943)
**Authors:** Daeyeon Son

7. [Aethon: A Reference-Based Replication Primitive for Constant-Time Instantiation of Stateful AI Agents](#paper-2604-12129)
...
### 2. [Rethinking On-Policy Distillation of Large Language Models: Phenomenology, Mechanism, and Recipe](https://arxiv.org/abs/2604.13016) <a id="paper-2604-13016"></a>
...
**Comment:** Identifies teacher-student distribution compatibility and new teacher capabilities as conditions for successful on-policy distillation.

**Topic Match:** The work analyzes training dynamics, but its core subject is post-training distillation rather than architectural destabilization.
...
**Comment:** Replaces fixed video token grids with variable-length sequences whose early tokens capture coarse structure.

**Topic Match:** Learned tokenization is closest to architecture_training, but the tokenizer and downstream training concern video generation.
...
### 4. [Drawing on Memory: Dual-Trace Encoding Improves Cross-Session Recall in LLM Agents](https://arxiv.org/abs/2604.12948) <a id="paper-2604-12948"></a>
...
**Comment:** Pairs stored facts with contextual scene traces to improve cross-session recall.

**Topic Match:** Representation design is the nearest connection, but the intervention changes external agent memory records rather than model training.
...
**Comment:** Conditions one-step flow matching on semantic sub-modes to reduce MSE-induced averaging across modes.

**Topic Match:** Generative training mechanisms are closest to architecture_training, but the models generate images rather than language.
...
### 6. [A Bayesian Perspective on the Role of Epistemic Uncertainty for Delayed Generalization in In-Context Learning](https://arxiv.org/abs/2604.12434) <a id="paper-2604-12434"></a>
...
**Comment:** Links delayed generalization and epistemic-uncertainty peaks to a shared spectral mechanism.

**Topic Match:** Grokking concerns training dynamics, but the demonstration remains in modular-arithmetic ICL and a simplified Bayesian linear model.
...
### 7. [M$^\star$: Every Task Deserves Its Own Memory Harness](https://arxiv.org/abs/2604.11811) <a id="paper-2604-11811"></a>
...
**Comment:** Jointly evolves memory schemas, storage logic, and workflow instructions for each task.

**Topic Match:** Architecture is the nearest registry label, but the contribution concerns agent memory programs rather than model internals or training.
...
### 8. [Understanding and Improving Continuous Adversarial Training for LLMs via In-context Learning Theory](https://arxiv.org/abs/2604.12817) <a id="paper-2604-12817"></a>
...
**Comment:** Connects adversarial robustness to embedding singular values and derives a corresponding regularizer.

**Topic Match:** Embedding regularization is the nearest training mechanism, but the core contribution is jailbreak defense.
...
### 9. [Robust Optimization for Mitigating Reward Hacking with Correlated Proxies](https://arxiv.org/abs/2604.12086) <a id="paper-2604-12086"></a>
...
**Comment:** Optimizes policies against the worst reward proxy satisfying an explicit correlation constraint.

**Topic Match:** Objective design is nearest to architecture_training, but the core subject is reward robustness in reinforcement learning.
...
### 10. [Loop Corrections to the Training and Generalization Errors of Random Feature Models](https://arxiv.org/abs/2604.12827) <a id="paper-2604-12827"></a>
...
### 11. [Algorithmic Analysis of Dense Associative Memory: Finite-Size Guarantees and Adversarial Robustness](https://arxiv.org/abs/2604.12811) <a id="paper-2604-12811"></a>
...
### 12. [Information-Geometric Decomposition of Generalization Error in Unsupervised Learning](https://arxiv.org/abs/2604.12340) <a id="paper-2604-12340"></a>
...
**Comment:** Exactly decomposes KL generalization error and derives a rank-selection cutoff for regularized PCA.

**Topic Match:** Statistical generalization theory is the closest topic, but the concrete application is Gaussian PCA rather than language-model training.
...
### 1. [PipeLive: Efficient Live In-place Pipeline Parallelism Reconfiguration for Dynamic LLM Serving](https://arxiv.org/abs/2604.12171) <a id="paper-2604-12171"></a>
...
**Comment:** Maintains KV consistency while resizing caches and moving pipeline layers during live reconfiguration.

**Topic Match:** Pipeline parallelism is closest to training_systems, but this is a serving reconfiguration system.
...
### 2. [Decentralized Learning via Random Walk with Jumps](https://arxiv.org/abs/2604.12260) <a id="paper-2604-12260"></a>
...
**Comment:** Adds long-range jumps to prevent correlated-update entrapment in decentralized random-walk optimization.

**Topic Match:** Decentralized optimization is the closest topic, but the abstract establishes no language-model training setting.
...
### 1. [LoSA: Locality Aware Sparse Attention for Block-Wise Diffusion Language Models](https://arxiv.org/abs/2604.12056) <a id="paper-2604-12056"></a>
...
**Comment:** Reuses prefix-attention outputs for stable denoising tokens to reduce the KV working set.

**Topic Match:** Sparse attention and cache reuse fit the efficiency label most closely, but the contribution accelerates inference in existing diffusion models.
...
### 5. [When to Forget: A Memory Governance Primitive](https://arxiv.org/abs/2604.12007) <a id="paper-2604-12007"></a>
...
**Comment:** Estimates success frequency conditional on retrieving a memory to guide its suppression or deprecation.

**Topic Match:** Memory selection and pruning provide the closest connection, but the contribution governs external agent memory rather than model parameters or training.
...
**Comment:** Uses calibrated token logits as a classifier requiring no additional training for kernel-mediated agent actions.

**Topic Match:** Avoiding an additional trained classifier is the closest efficiency connection, but the contribution is operating-system safety enforcement.
...
### 7. [Aethon: A Reference-Based Replication Primitive for Constant-Time Instantiation of Stateful AI Agents](https://arxiv.org/abs/2604.12129) <a id="paper-2604-12129"></a>
...
**Comment:** Uses references and copy-on-write overlays to separate agent creation cost from inherited state size.

**Topic Match:** Memory sharing is nearest to efficiency_scaling, but this is an agent-runtime abstraction rather than model compression or training.
