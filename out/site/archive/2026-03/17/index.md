...
## 1. [Learning to Recall with Transformers Beyond Orthogonal Embeddings](https://arxiv.org/abs/2603.15923) <a id="link1"></a>
...
## 2. [Mamba-3: Improved Sequence Modeling using State Space Principles](https://arxiv.org/abs/2603.15569) <a id="link2"></a>
...
## 3. [Deep learning and the rate of approximation by flows](https://arxiv.org/abs/2603.15363) <a id="link3"></a>
...
## 4. [Lost in Aggregation: On a Fundamental Expressivity Limit of Message-Passing Graph Neural Networks](https://arxiv.org/abs/2603.14846) <a id="link4"></a>
...
## 5. [Mixture-of-Depths Attention](https://arxiv.org/abs/2603.15619) <a id="link5"></a>
...
## 6. [A Family of LLMs Liberated from Static Vocabularies](https://arxiv.org/abs/2603.15953) <a id="link6"></a>
...
## 7. [Local Urysohn Width: A Topological Complexity Measure for Classification](https://arxiv.org/abs/2603.15412) <a id="link7"></a>
...
## 9. [IConE: Batch Independent Collapse Prevention for Self-Supervised Representation Learning](https://arxiv.org/abs/2603.15263) <a id="link9"></a>
...
## 10. [Self-Distillation of Hidden Layers for Self-Supervised Representation Learning](https://arxiv.org/abs/2603.15553) <a id="link10"></a>
...
## 11. [Grokking as a Variance-Limited Phase Transition: Spectral Gating and the Epsilon-Stability Threshold](https://arxiv.org/abs/2603.15492) <a id="link11"></a>
...
## 12. [FlashSampling: Fast and Memory-Efficient Exact Sampling](https://arxiv.org/abs/2603.15854) <a id="link12"></a>
...
## 13. [Directional Routing in Transformers](https://arxiv.org/abs/2603.14923) <a id="link13"></a>
...
## 14. [Determinism in the Undetermined: Deterministic Output in Charge-Conserving Continuous-Time Neuromorphic Systems with Temporal Stochasticity](https://arxiv.org/abs/2603.15987) <a id="link14"></a>
...
## 15. [Thinking in Latents: Adaptive Anchor Refinement for Implicit Reasoning in LLMs](https://arxiv.org/abs/2603.15051) <a id="link15"></a>
...
## 16. [Gauge-Equivariant Intrinsic Neural Operators for Geometry-Consistent Learning of Elliptic PDE Maps](https://arxiv.org/abs/2603.14734) <a id="link16"></a>
...
## 17. [Spiking Layer-Adaptive Magnitude-based Pruning](https://arxiv.org/abs/2603.14946) <a id="link17"></a>
...
## 18. [Dataset Distillation Efficiently Encodes Low-Dimensional Representations from Gradient-Based Learning of Non-Linear Tasks](https://arxiv.org/abs/2603.14830) <a id="link18"></a>
...
## 19. [MoLoRA: Composable Specialization via Per-Token Adapter Routing](https://arxiv.org/abs/2603.15965) <a id="link19"></a>
...
## 20. [Massive Redundancy in Gradient Transport Enables Sparse Online Learning](https://arxiv.org/abs/2603.15195) <a id="link20"></a>
...
## 21. [Mostly Text, Smart Visuals: Asymmetric Text-Visual Pruning for Large Vision-Language Models](https://arxiv.org/abs/2603.16001) <a id="link21"></a>
...
## 22. [More Test-Time Compute Can Hurt: Overestimation Bias in LLM Beam Search](https://arxiv.org/abs/2603.15377) <a id="link22"></a>
...
## 23. [Deriving Hyperparameter Scaling Laws via Modern Optimization Theory](https://arxiv.org/abs/2603.15958) <a id="link23"></a>
...
## 24. [Ablate and Rescue: A Causal Analysis of Residual Stream Hyper-Connections](https://arxiv.org/abs/2603.14833) <a id="link24"></a>
...
## 25. [Token Coherence: Adapting MESI Cache Protocols to Minimize Synchronization Overhead in Multi-Agent LLM Systems](https://arxiv.org/abs/2603.15183) <a id="link25"></a>
...
## 26. [W2T: LoRA Weights Already Know What They Can Do](https://arxiv.org/abs/2603.15990) <a id="link26"></a>
...
## 27. [SCAN: Sparse Circuit Anchor Interpretable Neuron for Lifelong Knowledge Editing](https://arxiv.org/abs/2603.15226) <a id="link27"></a>
...
## 28. [Mask Is What DLLM Needs: A Masked Data Training Paradigm for Diffusion LLMs](https://arxiv.org/abs/2603.15803) <a id="link28"></a>
...
## 29. [Preconditioned One-Step Generative Modeling for Bayesian Inverse Problems in Function Spaces](https://arxiv.org/abs/2603.14798) <a id="link29"></a>
...
## 30. [LLM as Graph Kernel: Rethinking Message Passing on Text-Rich Graphs](https://arxiv.org/abs/2603.14937) <a id="link30"></a>
...
## 31. [Parallelised Differentiable Straightest Geodesics for 3D Meshes](https://arxiv.org/abs/2603.15780) <a id="link31"></a>
...
## 32. [Why AI systems don't learn and what to do about it: Lessons on autonomous learning from cognitive science](https://arxiv.org/abs/2603.15381) <a id="link32"></a>
...
## 33. [Rethinking Machine Unlearning: Models Designed to Forget via Key Deletion](https://arxiv.org/abs/2603.15033) <a id="link33"></a>
...
## 34. [Transition Flow Matching](https://arxiv.org/abs/2603.15689) <a id="link34"></a>
...
## 35. [In-Context Symbolic Regression for Robustness-Improved Kolmogorov-Arnold Networks](https://arxiv.org/abs/2603.15250) <a id="link35"></a>
...
## 36. [Chain-of-Trajectories: Unlocking the Intrinsic Generative Optimality of Diffusion Models via Graph-Theoretic Planning](https://arxiv.org/abs/2603.14704) <a id="link36"></a>
...
## 37. [Unbiased and Biased Variance-Reduced Forward-Reflected-Backward Splitting Methods for Stochastic Composite Inclusions](https://arxiv.org/abs/2603.15576) <a id="link37"></a>
...
## 38. [Understanding Reasoning in LLMs through Strategic Information Allocation under Uncertainty](https://arxiv.org/abs/2603.15500) <a id="link38"></a>
...
## 39. [PhasorFlow: A Python Library for Unit Circle Based Computing](https://arxiv.org/abs/2603.15886) <a id="link39"></a>
...
## 40. [Universe Routing: Why Self-Evolving Agents Need Epistemic Control](https://arxiv.org/abs/2603.14799) <a id="link40"></a>
...
## 41. [Fold-CP: A Context Parallelism Framework for Biomolecular Modeling](https://arxiv.org/abs/2603.14806) <a id="link41"></a>
...
## 42. [Interpretable Classification of Time Series Using Euler Characteristic Surfaces](https://arxiv.org/abs/2603.15079) <a id="link42"></a>
...
## 43. [Meta-TTRL: A Metacognitive Framework for Self-Improving Test-Time Reinforcement Learning in Unified Multimodal Models](https://arxiv.org/abs/2603.15724) <a id="link43"></a>
...
## 44. [Point-Identification of a Robust Predictor Under Latent Shift with Imperfect Proxies](https://arxiv.org/abs/2603.15158) <a id="link44"></a>
...
## 45. [MONET: Modeling and Optimization of neural NEtwork Training from Edge to Data Centers](https://arxiv.org/abs/2603.15002) <a id="link45"></a>
...
## 46. [AdapterTune: Zero-Initialized Low-Rank Adapters for Frozen Vision Transformers](https://arxiv.org/abs/2603.14706) <a id="link46"></a>
...
## 47. [SimCert: Probabilistic Certification for Behavioral Similarity in Deep Neural Network Compression](https://arxiv.org/abs/2603.14818) <a id="link47"></a>
...
## 48. [Controlled Langevin Dynamics for Sampling of Feedforward Neural Networks Trained with Minibatches](https://arxiv.org/abs/2603.15367) <a id="link48"></a>
...
## 49. [Accelerating Byzantine-Robust Distributed Learning with Compressed Communication via Double Momentum and Variance Reduction](https://arxiv.org/abs/2603.15144) <a id="link49"></a>
...
## 50. [Mechanistic Origin of Moral Indifference in Language Models](https://arxiv.org/abs/2603.15615) <a id="link50"></a>
...
## 51. [Effective Distillation to Hybrid xLSTM Architectures](https://arxiv.org/abs/2603.15590) <a id="link51"></a>
...
## 52. [MobileLLM-Flash: Latency-Guided On-Device LLM Design for Industry Scale](https://arxiv.org/abs/2603.15954) <a id="link52"></a>
...
## 53. [Selective Memory for Artificial Intelligence: Write-Time Gating with Hierarchical Archiving](https://arxiv.org/abs/2603.15994) <a id="link53"></a>
...
## 54. [Masked BRep Autoencoder via Hierarchical Graph Transformer](https://arxiv.org/abs/2603.14927) <a id="link54"></a>
...
## 55. [TabKD: Tabular Knowledge Distillation through Interaction Diversity of Learned Feature Bins](https://arxiv.org/abs/2603.15481) <a id="link55"></a>
...
## 56. [Mechanistic Foundations of Goal-Directed Control](https://arxiv.org/abs/2603.15248) <a id="link56"></a>
...
## 57. [Tackling Over-smoothing on Hypergraphs: A Ricci Flow-guided Neural Diffusion Approach](https://arxiv.org/abs/2603.15696) <a id="link57"></a>
...
## 58. [PrototypeNAS: Rapid Design of Deep Neural Networks for Microcontroller Units](https://arxiv.org/abs/2603.15106) <a id="link58"></a>
...
## 59. [Embedding-Aware Feature Discovery: Bridging Latent Representations and Interpretable Features in Event Sequences](https://arxiv.org/abs/2603.15713) <a id="link59"></a>
...
## 60. [CATFormer: When Continual Learning Meets Spiking Transformers With Dynamic Thresholds](https://arxiv.org/abs/2603.15184) <a id="link60"></a>
...
## 61. [100x Cost & Latency Reduction: Performance Analysis of AI Query Approximation using Lightweight Proxy Models](https://arxiv.org/abs/2603.15970) <a id="link61"></a>
...
## 62. [AnoleVLA: Lightweight Vision-Language-Action Model with Deep State Space Models for Mobile Manipulation](https://arxiv.org/abs/2603.15046) <a id="link62"></a>
