<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../06"><img src="../../../assets/nav/day/2026-02-07-prev.svg" alt="Previous Day 2026-02-06"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-07-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../09"><img src="../../../assets/nav/day/2026-02-07-next.svg" alt="Next Day 2026-02-09"></a></div></div>
...
1. [RaBiT: Residual-Aware Binarization Training for Accurate and Efficient LLMs](#user-content-link1)
**Authors:** Youngcheon You, Banseok Lee, Minseop Choi, Seonyoung Kim, Hyochan Chong, Changdong Kim, Youngmin Kim, Dongkyu Kim

2. [OmniMoE: An Efficient MoE by Orchestrating Atomic Experts at Scale](#user-content-link2)
**Authors:** Jingze Shi, Zhangyang Peng, Yizhang Zhu, Yifan Wu, Guang Liu, Yuyu Luo

3. [SLAY: Geometry-Aware Spherical Linearized Attention with Yat-Kernel](#user-content-link3)
**Authors:** Jose Miguel Luna, Taha Bouhsine, Krzysztof Choromanski

4. [ZeroS: Zero-Sum Linear Attention for Efficient Transformers](#user-content-link4)
**Authors:** Jiecheng Lu, Xu Han, Yan Sun, Viresh Pati, Yubin Kim, Siddhartha Somani, Shihao Yang

5. [CoPE: Clipped RoPE as A Scalable Free Lunch for Long Context LLMs](#user-content-link5)
**Authors:** Haoran Li, Sucheng Ren, Alan Yuille, Feng Wang

6. [Regularized Calibration with Successive Rounding for Post-Training Quantization](#user-content-link6)
**Authors:** Seohyeon Cha, Huancheng Chen, Dongjun Kim, Haoran Zhang, Kevin Chan, Gustavo de Veciana, Haris Vikalo

7. [Double-P: Hierarchical Top-P Sparse Attention for Long-Context LLMs](#user-content-link7)
...
8. [CSRv2: Unlocking Ultra-Sparse Embeddings](#user-content-link8)
**Authors:** Lixuan Guo, Yifei Wang, Tiansheng Wen, Yifan Wang, Aosong Feng, Bo Chen, Stefanie Jegelka, Chenyu You

9. [Shared LoRA Subspaces for almost Strict Continual Learning](#user-content-link9)
**Authors:** Prakhar Kaushik, Ankit Vaidya, Shravan Chaudhari, Rama Chellappa, Alan Yuille

10. [Nonlinearity as Rank: Generative Low-Rank Adapter with Radial Basis Functions](#user-content-link10)
**Authors:** Yihao Ouyang, Shiwei Li, Haozhao Wang, Xiandi Luo, Zhuoqi Hu, Yuetong Song, Qiyu Qin, Yichen Li, Ruixuan Li

11. [CoSA: Compressed Sensing-Based Adaptation of Large Language Models](#user-content-link11)
**Authors:** Songtao Wei, Yi Li, Bohan Zhang, Zhichun Guo, Ying Huang, Yuede Ji, Miao Yin, Guanpeng Li, Bingzhe Li

12. [Transport and Merge: Cross-Architecture Merging for Large Language Models](#user-content-link12)
**Authors:** Chenhang Cui, Binyun Yang, Fei Shen, Yuxin Chen, Jingnan Zheng, Xiang Wang, An Zhang, Tat-Seng Chua

13. [When Shared Knowledge Hurts: Spectral Over-Accumulation in Model Merging](#user-content-link13)
**Authors:** Yayuan Li, Ze Peng, Jian Zhang, Jintao Guo, Yue Duan, Yinghuan Shi

14. [Variational Speculative Decoding: Rethinking Draft Training from Token Likelihood to Sequence Acceptance](#user-content-link14)
**Authors:** Xiandong Zou, Jianshu Li, Jing Huang, Pan Zhou

15. [Conditional Diffusion Guidance under Hard Constraint: A Stochastic Analysis Approach](#user-content-link15)
**Authors:** Zhengyi Guo, Wenpin Tang, Renyuan Xu

16. [SDFP: Speculative Decoding with FIT-Pruned Models for Training-Free and Plug-and-Play LLM Acceleration](#user-content-link16)
**Authors:** Hanyu Wei, Zunhai Su, Peng Lu, Chao Li, Spandan Tiwari, Ashish Sirasao, Yuhan Dong

17. [FlashBlock: Attention Caching for Efficient Long-Context Block Diffusion](#user-content-link17)
**Authors:** Zhuokun Chen, Jianfei Cai, Bohan Zhuang

18. [A logical re-conception of neural networks: Hamiltonian bitwise part-whole architecture](#user-content-link18)
**Authors:** E Bowen, R Granger, A Rodriguez

19. [Shiva-DiT: Residual-Based Differentiable Top-$k$ Selection for Efficient Diffusion Transformers](#user-content-link19)
...
20. [Learning Compact Boolean Networks](#user-content-link20)
**Authors:** Shengpu Wang, Yuhao Mao, Yani Zhang, Martin Vechev

21. [DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching](#user-content-link21)
**Authors:** Chang Zou, Changlin Li, Yang Li, Patrol Li, Jianbing Wu, Xiao He, Songtao Liu, Zhao Zhong, Kailin Huang, Linfeng Zhang

22. [Temporal Pair Consistency for Variance-Reduced Flow Matching](#user-content-link22)
**Authors:** Chika Maduabuchi, Jindong Wang

23. [Internalizing LLM Reasoning via Discovery and Replay of Latent Actions](#user-content-link23)
**Authors:** Zhenning Shi, Yijia Zhu, Junhan Shi, Xun Zhang, Lei Wang, Congcong Miao

24. [Correctness-Optimized Residual Activation Lens (CORAL): Transferrable and Calibration-Aware Inference-Time Steering](#user-content-link24)
**Authors:** Miranda Muqing Miao, Young-Min Cho, Lyle Ungar

25. [NEX: Neuron Explore-Exploit Scoring for Label-Free Chain-of-Thought Selection and Model Ranking](#user-content-link25)
**Authors:** Kang Chen, Zhuoka Feng, Sihan Zhao, Kai Xiong, Junjie Nian, Yaoning Wang, Changyi Xiao, Yixin Cao

26. [Refine and Purify: Orthogonal Basis Optimization with Null-Space Denoising for Conditional Representation Learning](#user-content-link26)
**Authors:** Jiaquan Wang, Yan Lyu, Chen Li, Yuheng Jia

27. [Depth-Wise Emergence of Prediction-Centric Geometry in Large Language Models](#user-content-link27)
**Authors:** Shahar Haim, Daniel C McNamee

28. [Inverse Depth Scaling From Most Layers Being Similar](#user-content-link28)
**Authors:** Yizhou Liu, Sara Kangaslahti, Ziming Liu, Jeff Gore

29. [DLM-Scope: Mechanistic Interpretability of Diffusion Language Models via Sparse Autoencoders](#user-content-link29)
**Authors:** Xu Wang, Bingqing Jiang, Yu Wan, Baosong Yang, Lingpeng Kong, Difan Zou

30. [Determining Energy Efficiency Sweet Spots in Production LLM Inference](#user-content-link30)
...
## 1. [RaBiT: Residual-Aware Binarization Training for Accurate and Efficient LLMs](https://arxiv.org/abs/2602.05367) <a id="link1"></a>
...
## 2. [OmniMoE: An Efficient MoE by Orchestrating Atomic Experts at Scale](https://arxiv.org/abs/2602.05711) <a id="link2"></a>
...
## 3. [SLAY: Geometry-Aware Spherical Linearized Attention with Yat-Kernel](https://arxiv.org/abs/2602.04915) <a id="link3"></a>
...
## 4. [ZeroS: Zero-Sum Linear Attention for Efficient Transformers](https://arxiv.org/abs/2602.05230) <a id="link4"></a>
...
## 5. [CoPE: Clipped RoPE as A Scalable Free Lunch for Long Context LLMs](https://arxiv.org/abs/2602.05258) <a id="link5"></a>
...
## 6. [Regularized Calibration with Successive Rounding for Post-Training Quantization](https://arxiv.org/abs/2602.05902) <a id="link6"></a>
...
## 7. [Double-P: Hierarchical Top-P Sparse Attention for Long-Context LLMs](https://arxiv.org/abs/2602.05191) <a id="link7"></a>
...
## 8. [CSRv2: Unlocking Ultra-Sparse Embeddings](https://arxiv.org/abs/2602.05735) <a id="link8"></a>
...
## 9. [Shared LoRA Subspaces for almost Strict Continual Learning](https://arxiv.org/abs/2602.06043) <a id="link9"></a>
...
## 10. [Nonlinearity as Rank: Generative Low-Rank Adapter with Radial Basis Functions](https://arxiv.org/abs/2602.05709) <a id="link10"></a>
...
## 11. [CoSA: Compressed Sensing-Based Adaptation of Large Language Models](https://arxiv.org/abs/2602.05148) <a id="link11"></a>
...
## 12. [Transport and Merge: Cross-Architecture Merging for Large Language Models](https://arxiv.org/abs/2602.05495) <a id="link12"></a>
...
## 13. [When Shared Knowledge Hurts: Spectral Over-Accumulation in Model Merging](https://arxiv.org/abs/2602.05536) <a id="link13"></a>
...
## 14. [Variational Speculative Decoding: Rethinking Draft Training from Token Likelihood to Sequence Acceptance](https://arxiv.org/abs/2602.05774) <a id="link14"></a>
...
## 15. [Conditional Diffusion Guidance under Hard Constraint: A Stochastic Analysis Approach](https://arxiv.org/abs/2602.05533) <a id="link15"></a>
...
## 16. [SDFP: Speculative Decoding with FIT-Pruned Models for Training-Free and Plug-and-Play LLM Acceleration](https://arxiv.org/abs/2602.05499) <a id="link16"></a>
...
## 17. [FlashBlock: Attention Caching for Efficient Long-Context Block Diffusion](https://arxiv.org/abs/2602.05305) <a id="link17"></a>
...
## 18. [A logical re-conception of neural networks: Hamiltonian bitwise part-whole architecture](https://arxiv.org/abs/2602.04911) <a id="link18"></a>
...
## 19. [Shiva-DiT: Residual-Based Differentiable Top-$k$ Selection for Efficient Diffusion Transformers](https://arxiv.org/abs/2602.05605) <a id="link19"></a>
...
## 20. [Learning Compact Boolean Networks](https://arxiv.org/abs/2602.05830) <a id="link20"></a>
...
## 21. [DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching](https://arxiv.org/abs/2602.05449) <a id="link21"></a>
...
## 22. [Temporal Pair Consistency for Variance-Reduced Flow Matching](https://arxiv.org/abs/2602.04908) <a id="link22"></a>
...
## 23. [Internalizing LLM Reasoning via Discovery and Replay of Latent Actions](https://arxiv.org/abs/2602.04925) <a id="link23"></a>
...
## 24. [Correctness-Optimized Residual Activation Lens (CORAL): Transferrable and Calibration-Aware Inference-Time Steering](https://arxiv.org/abs/2602.06022) <a id="link24"></a>
...
## 25. [NEX: Neuron Explore-Exploit Scoring for Label-Free Chain-of-Thought Selection and Model Ranking](https://arxiv.org/abs/2602.05805) <a id="link25"></a>
...
## 26. [Refine and Purify: Orthogonal Basis Optimization with Null-Space Denoising for Conditional Representation Learning](https://arxiv.org/abs/2602.05464) <a id="link26"></a>
...
## 27. [Depth-Wise Emergence of Prediction-Centric Geometry in Large Language Models](https://arxiv.org/abs/2602.04931) <a id="link27"></a>
...
## 28. [Inverse Depth Scaling From Most Layers Being Similar](https://arxiv.org/abs/2602.05970) <a id="link28"></a>
...
## 29. [DLM-Scope: Mechanistic Interpretability of Diffusion Language Models via Sparse Autoencoders](https://arxiv.org/abs/2602.05859) <a id="link29"></a>
...
## 30. [Determining Energy Efficiency Sweet Spots in Production LLM Inference](https://arxiv.org/abs/2602.05695) <a id="link30"></a>
