<div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1.2fr) minmax(0, 1fr); align-items: center; width: 100%; gap: 16px; margin: 8px 0 20px;"><div style="display: flex; justify-content: flex-start;"><a href="../21" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;"><span style="font-size: 20px; line-height: 1; color: inherit;">&larr;</span><span style="display: flex; flex-direction: column; align-items: flex-start; line-height: 1.25;"><strong style="display: block;">Previous Day</strong><span style="display: block; font-size: 14px; color: gray;">2025-01-21</span></span></a></div><div style="display: flex; justify-content: center;"><a href=".." style="display: inline-flex; flex-direction: column; align-items: center; text-align: center; text-decoration: none; line-height: 1.25;"><strong style="display: block;">Monthly Overview</strong><span style="display: block; font-size: 14px; color: gray;">2025-01</span></a></div><div style="display: flex; justify-content: flex-end;"><a href="../23" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;"><span style="display: flex; flex-direction: column; align-items: flex-end; text-align: right; line-height: 1.25;"><strong style="display: block;">Next Day</strong><span style="display: block; font-size: 14px; color: gray;">2025-01-23</span></span><span style="font-size: 20px; line-height: 1; color: inherit;">&rarr;</span></a></div></div>
...
13. [ProKeR: A Kernel Perspective on Few-Shot Adaptation of Large Vision-Language Models](#user-content-link13)
...
28. [EDoRA: Efficient Weight-Decomposed Low-Rank Adaptation via Singular Value Decomposition](#user-content-link28)
...
43. [Can Safety Fine-Tuning Be More Principled? Lessons Learned from Cybersecurity](#user-content-link43)
...
58. [With Great Backbones Comes Great Adversarial Transferability](#user-content-link58)
...
## 64. [Optimizing Pretraining Data Mixtures with LLM-Estimated Utility](https://arxiv.org/abs/2501.11747) <a id="link64"></a>
...
## 65. [Mutual Regression Distance](https://arxiv.org/abs/2501.10617) <a id="link65"></a>
...
## 66. [A Hybrid Supervised and Self-Supervised Graph Neural Network for Edge-Centric Applications](https://arxiv.org/abs/2501.12309) <a id="link66"></a>
...
## 67. [CDW-CoT: Clustered Distance-Weighted Chain-of-Thoughts Reasoning](https://arxiv.org/abs/2501.12226) <a id="link67"></a>
...
## 68. [VARGPT: Unified Understanding and Generation in a Visual Autoregressive Multimodal Large Language Model](https://arxiv.org/abs/2501.12327) <a id="link68"></a>
...
## 69. [Disentangled Interpretable Representation for Efficient Long-term Time Series Forecasting](https://arxiv.org/abs/2411.17257) <a id="link69"></a>
