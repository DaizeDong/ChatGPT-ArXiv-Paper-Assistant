<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../23"><img src="../../../assets/nav/day/2026-02-24-prev.svg" alt="Previous Day 2026-02-23"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-02-24-center.svg" alt="Monthly Overview 2026-02"></a></div><div style="width: 33.33%; text-align: right;"><a href="../25"><img src="../../../assets/nav/day/2026-02-24-next.svg" alt="Next Day 2026-02-25"></a></div></div>
...
1. [A Replicate-and-Quantize Strategy for Plug-and-Play Load Balancing of Sparse Mixture-of-Experts LLMs](#user-content-link1)
**Authors:** Zijie Liu, Jie Peng, Jinhao Duan, Zirui Liu, Kaixiong Zhou, Mingfu Liang, Luke Simon, Xi Liu, Zhaozhuo Xu, Tianlong Chen

2. [Why ReLU? A Bit-Model Dichotomy for Deep Network Training](#user-content-link2)
**Authors:** Ilan Doron-Arad, Elchanan Mossel

3. [PCA-VAE: Differentiable Subspace Quantization without Codebook Collapse](#user-content-link3)
**Authors:** Hao Lu, Onur C. Koyun, Yongxin Guo, Zhengjie Zhu, Abbas Alili, Metin Nafi Gurcan

4. [Toward Manifest Relationality in Transformers via Symmetry Reduction](#user-content-link4)
**Authors:** J. Fran\c{c}ois, L. Ravera

5. [Incremental Learning of Sparse Attention Patterns in Transformers](#user-content-link5)
**Authors:** O\u{g}uz Kaan Y\"uksel, Rodrigo Alvarez Lucendo, Nicolas Flammarion

6. [Path-conditioned training: a principled way to rescale ReLU neural networks](#user-content-link6)
**Authors:** Arthur Lebeurrier, Titouan Vayer, R\'emi Gribonval

7. [Regularity of Second-Order Elliptic PDEs in Spectral Barron Spaces](#user-content-link7)
**Authors:** Ziang Chen, Liqiang Huang, Mengxuan Yang, Shengxuan Zhou

8. [Adaptation to Intrinsic Dependence in Diffusion Language Models](#user-content-link8)
**Authors:** Yunxiao Zhao, Changxiao Cai

9. [RPU -- A Reasoning Processing Unit](#user-content-link9)
**Authors:** Matthew Adiletta, Gu-Yeon Wei, David Brooks

10. [Celo2: Towards Learned Optimization Free Lunch](#user-content-link10)
**Authors:** Abhinav Moudgil, Boris Knyazev, Eugene Belilovsky

11. [IDLM: Inverse-distilled Diffusion Language Models](#user-content-link11)
**Authors:** David Li, Nikita Gushchin, Dmitry Abulkhanov, Eric Moulines, Ivan Oseledets, Maxim Panov, Alexander Korotin

12. [Attention Deficits in Language Models: Causal Explanations for Procedural Hallucinations](#user-content-link12)
**Authors:** Ahmed Karim, Fatima Sheaib, Zein Khamis, Maggie Chlon, Jad Awada, Leon Chlon

13. [Manifold-Aligned Generative Transport](#user-content-link13)
**Authors:** Xinyu Tian, Xiaotong Shen

14. [Smoothness Adaptivity in Constant-Depth Neural Networks: Optimal Rates via Smooth Activations](#user-content-link14)
**Authors:** Yuhao Liu, Zilin Wang, Lei Wu, Shaobo Zhang

15. [Decentralized Attention Fails Centralized Signals: Rethinking Transformers for Medical Time Series](#user-content-link15)
**Authors:** Guoqi Yu, Juncheng Wang, Chen Yang, Jing Qin, Angelica I. Aviles-Rivero, Shujun Wang

16. [Scaling Laws for Precision in High-Dimensional Linear Regression](#user-content-link16)
**Authors:** Dechen Zhang, Xuan Tang, Yingyu Liang, Difan Zou

17. [Bayesian Lottery Ticket Hypothesis](#user-content-link17)
**Authors:** Nicholas Kuhn, Arvid Weyrauch, Lars Heyen, Achim Streit, Markus G\"otz, Charlotte Debus

18. [DUET-VLM: Dual stage Unified Efficient Token reduction for VLM Training and Inference](#user-content-link18)
**Authors:** Aditya Kumar Singh, Hitesh Kandala, Pratik Prabhanjan Brahma, Zicheng Liu, Emad Barsoum

19. [Training-Free Generative Modeling via Kernelized Stochastic Interpolants](#user-content-link19)
...
20. [On the Equivalence of Random Network Distillation, Deep Ensembles, and Bayesian Inference](#user-content-link20)
**Authors:** Moritz A. Zanger, Yijun Wu, Pascal R. Van der Vaart, Wendelin B\"ohmer, Matthijs T. J. Spaan

21. [K-Search: LLM Kernel Generation via Co-Evolving Intrinsic World Model](#user-content-link21)
**Authors:** Shiyi Cao, Ziming Mao, Joseph E. Gonzalez, Ion Stoica

22. [Training-Free Cross-Architecture Merging for Graph Neural Networks](#user-content-link22)
**Authors:** Rishabh Bhattacharya, Vikaskumar Kalsariya, Naresh Manwani

23. [A Markovian View of Iterative-Feedback Loops in Image Generative Models: Neural Resonance and Model Collapse](#user-content-link23)
**Authors:** Vibhas Kumar Vats, David J. Crandall, Samuel Goree

24. [Online Realizable Regression and Applications for ReLU Networks](#user-content-link24)
**Authors:** Ilan Doron-Arad, Idan Mehalel, Elchanan Mossel

25. [Implicit Bias and Convergence of Matrix Stochastic Mirror Descent](#user-content-link25)
**Authors:** Danil Akhtiamov, Reza Ghane, Babak Hassibi

26. [I Dropped a Neural Net](#user-content-link26)
**Authors:** Hyunwoo Park

27. [A Theory of How Pretraining Shapes Inductive Bias in Fine-Tuning](#user-content-link27)
**Authors:** Nicolas Anguita, Francesco Locatello, Andrew M. Saxe, Marco Mondelli, Flavia Mancini, Samuel Lippl, Clementine Domine

28. [Behavior Learning (BL): Learning Hierarchical Optimization Structures from Data](#user-content-link28)
**Authors:** Zhenyao Ma, Yue Liang, Dongxu Li

29. [A Computationally Efficient Multidimensional Vision Transformer](#user-content-link29)
**Authors:** Alaa El Ichi, Khalide Jbilou

30. [Grokking Finite-Dimensional Algebra](#user-content-link30)
**Authors:** Pascal Jr Tikeng Notsawo, Guillaume Dumas, Guillaume Rabusseau

31. [Understanding the Curse of Unrolling](#user-content-link31)
**Authors:** Sheheryar Mehmood, Florian Knoll, Peter Ochs

32. [Partial Soft-Matching Distance for Neural Representational Comparison with Partial Unit Correspondence](#user-content-link32)
**Authors:** Chaitanya Kapoor, Alex H. Williams, Meenakshi Khosla

33. [Hiding in Plain Text: Detecting Concealed Jailbreaks via Activation Disentanglement](#user-content-link33)
**Authors:** Amirhossein Farzam, Majid Behabahani, Mani Malek, Yuriy Nevmyvaka, Guillermo Sapiro

34. [Transformers for dynamical systems learn transfer operators in-context](#user-content-link34)
**Authors:** Anthony Bao, Jeffrey Lai, William Gilpin

35. [Spilled Energy in Large Language Models](#user-content-link35)
**Authors:** Adrian Robert Minut, Hazem Dewidar, Iacopo Masi

36. [Information-Guided Noise Allocation for Efficient Diffusion Training](#user-content-link36)
...
37. [Relational Feature Caching for Accelerating Diffusion Transformers](#user-content-link37)
**Authors:** Byunggwan Son, Jeimin Jeon, Jeongwoo Choi, Bumsub Ham

38. [Insertion Based Sequence Generation with Learnable Order Dynamics](#user-content-link38)
**Authors:** Dhruvesh Patel, Benjamin Rozonoyer, Gaurav Pandey, Tahira Naseem, Ram\'on Fernandez Astudillo, Andrew McCallum

39. [Laplacian Multi-scale Flow Matching for Generative Modeling](#user-content-link39)
**Authors:** Zelin Zhao, Petr Molodyk, Haotian Xue, Yongxin Chen

40. [Dirichlet Scale Mixture Priors for Bayesian Neural Networks](#user-content-link40)
**Authors:** August Arnstad, Leiv R{\o}nneberg, Geir Storvik

41. [VecFormer: Towards Efficient and Generalizable Graph Transformer with Graph Token Attention](#user-content-link41)
...
42. [Spectral bias in physics-informed and operator learning: Analysis and mitigation guidelines](#user-content-link42)
**Authors:** Siavash Khodakarami, Vivek Oommen, Nazanin Ahmadi Daryakenari, Maxim Beekenkamp, George Em Karniadakis

---

## 1. [A Replicate-and-Quantize Strategy for Plug-and-Play Load Balancing of Sparse Mixture-of-Experts LLMs](https://arxiv.org/abs/2602.19938) <a id="link1"></a>
...
## 2. [Why ReLU? A Bit-Model Dichotomy for Deep Network Training](https://arxiv.org/abs/2602.19017) <a id="link2"></a>
...
## 3. [PCA-VAE: Differentiable Subspace Quantization without Codebook Collapse](https://arxiv.org/abs/2602.18904) <a id="link3"></a>
...
## 4. [Toward Manifest Relationality in Transformers via Symmetry Reduction](https://arxiv.org/abs/2602.18948) <a id="link4"></a>
...
## 5. [Incremental Learning of Sparse Attention Patterns in Transformers](https://arxiv.org/abs/2602.19143) <a id="link5"></a>
...
## 6. [Path-conditioned training: a principled way to rescale ReLU neural networks](https://arxiv.org/abs/2602.19799) <a id="link6"></a>
...
## 7. [Regularity of Second-Order Elliptic PDEs in Spectral Barron Spaces](https://arxiv.org/abs/2602.19381) <a id="link7"></a>
...
## 8. [Adaptation to Intrinsic Dependence in Diffusion Language Models](https://arxiv.org/abs/2602.20126) <a id="link8"></a>
...
## 9. [RPU -- A Reasoning Processing Unit](https://arxiv.org/abs/2602.18568) <a id="link9"></a>
...
## 10. [Celo2: Towards Learned Optimization Free Lunch](https://arxiv.org/abs/2602.19142) <a id="link10"></a>
...
## 11. [IDLM: Inverse-distilled Diffusion Language Models](https://arxiv.org/abs/2602.19066) <a id="link11"></a>
...
## 12. [Attention Deficits in Language Models: Causal Explanations for Procedural Hallucinations](https://arxiv.org/abs/2602.19239) <a id="link12"></a>
...
## 13. [Manifold-Aligned Generative Transport](https://arxiv.org/abs/2602.19600) <a id="link13"></a>
...
## 14. [Smoothness Adaptivity in Constant-Depth Neural Networks: Optimal Rates via Smooth Activations](https://arxiv.org/abs/2602.19691) <a id="link14"></a>
...
## 15. [Decentralized Attention Fails Centralized Signals: Rethinking Transformers for Medical Time Series](https://arxiv.org/abs/2602.18473) <a id="link15"></a>
...
## 16. [Scaling Laws for Precision in High-Dimensional Linear Regression](https://arxiv.org/abs/2602.19241) <a id="link16"></a>
...
## 17. [Bayesian Lottery Ticket Hypothesis](https://arxiv.org/abs/2602.18825) <a id="link17"></a>
...
## 18. [DUET-VLM: Dual stage Unified Efficient Token reduction for VLM Training and Inference](https://arxiv.org/abs/2602.18846) <a id="link18"></a>
...
## 19. [Training-Free Generative Modeling via Kernelized Stochastic Interpolants](https://arxiv.org/abs/2602.20070) <a id="link19"></a>
...
## 20. [On the Equivalence of Random Network Distillation, Deep Ensembles, and Bayesian Inference](https://arxiv.org/abs/2602.19964) <a id="link20"></a>
...
## 21. [K-Search: LLM Kernel Generation via Co-Evolving Intrinsic World Model](https://arxiv.org/abs/2602.19128) <a id="link21"></a>
...
## 22. [Training-Free Cross-Architecture Merging for Graph Neural Networks](https://arxiv.org/abs/2602.19332) <a id="link22"></a>
...
## 23. [A Markovian View of Iterative-Feedback Loops in Image Generative Models: Neural Resonance and Model Collapse](https://arxiv.org/abs/2602.19033) <a id="link23"></a>
...
## 24. [Online Realizable Regression and Applications for ReLU Networks](https://arxiv.org/abs/2602.19172) <a id="link24"></a>
...
## 25. [Implicit Bias and Convergence of Matrix Stochastic Mirror Descent](https://arxiv.org/abs/2602.18997) <a id="link25"></a>
...
## 26. [I Dropped a Neural Net](https://arxiv.org/abs/2602.19845) <a id="link26"></a>
...
## 27. [A Theory of How Pretraining Shapes Inductive Bias in Fine-Tuning](https://arxiv.org/abs/2602.20062) <a id="link27"></a>
...
## 28. [Behavior Learning (BL): Learning Hierarchical Optimization Structures from Data](https://arxiv.org/abs/2602.20152) <a id="link28"></a>
...
## 29. [A Computationally Efficient Multidimensional Vision Transformer](https://arxiv.org/abs/2602.19982) <a id="link29"></a>
...
## 30. [Grokking Finite-Dimensional Algebra](https://arxiv.org/abs/2602.19533) <a id="link30"></a>
...
## 31. [Understanding the Curse of Unrolling](https://arxiv.org/abs/2602.19733) <a id="link31"></a>
...
## 32. [Partial Soft-Matching Distance for Neural Representational Comparison with Partial Unit Correspondence](https://arxiv.org/abs/2602.19331) <a id="link32"></a>
...
## 33. [Hiding in Plain Text: Detecting Concealed Jailbreaks via Activation Disentanglement](https://arxiv.org/abs/2602.19396) <a id="link33"></a>
...
## 34. [Transformers for dynamical systems learn transfer operators in-context](https://arxiv.org/abs/2602.18679) <a id="link34"></a>
...
## 35. [Spilled Energy in Large Language Models](https://arxiv.org/abs/2602.18671) <a id="link35"></a>
...
## 36. [Information-Guided Noise Allocation for Efficient Diffusion Training](https://arxiv.org/abs/2602.18647) <a id="link36"></a>
...
## 37. [Relational Feature Caching for Accelerating Diffusion Transformers](https://arxiv.org/abs/2602.19506) <a id="link37"></a>
...
## 38. [Insertion Based Sequence Generation with Learnable Order Dynamics](https://arxiv.org/abs/2602.18695) <a id="link38"></a>
...
## 39. [Laplacian Multi-scale Flow Matching for Generative Modeling](https://arxiv.org/abs/2602.19461) <a id="link39"></a>
...
## 40. [Dirichlet Scale Mixture Priors for Bayesian Neural Networks](https://arxiv.org/abs/2602.19859) <a id="link40"></a>
...
## 41. [VecFormer: Towards Efficient and Generalizable Graph Transformer with Graph Token Attention](https://arxiv.org/abs/2602.19622) <a id="link41"></a>
...
## 42. [Spectral bias in physics-informed and operator learning: Analysis and mitigation guidelines](https://arxiv.org/abs/2602.19265) <a id="link42"></a>
