> This is a remedial run for missed papers from 08/18/2026 to 08/18/2026.
> 
...
<sub>Token counts are not reported for this run. 16 of 18 model calls succeeded, 5,381s of model wall clock.</sub>
...
1. [Belayer: Efficient Fault Tolerance for LLM Agentic RL Training](#paper-2608-14635)
**Authors:** Jiecheng Zhou, Qinghao Hu, Peng Sun, Xingcheng Zhang, Weiming Zhang

2. [Row-Stochastic Matrices Can Provably Outperform Doubly Stochastic Matrices in Decentralized Learning](#paper-2511-19513)
**Authors:** Bing Liu, Boao Kong, Limin Lu, Kun Yuan, Chengcheng Zhao

3. [Federated Compositional Muon Optimizer for Matrix-Wise Models](#paper-2608-12710)
**Authors:** Wang Yan, Feihu Huang

4. [Efficient Resource Optimization for Split Federated Learning](#paper-2608-17849)
**Authors:** Wei Wei, Xianhao Chen

5. [Accelerating Visual On-Policy Distillation with Batched Speculative Jacobi Rollouts](#paper-2608-18183)
**Authors:** Bingqi Shan, Zhehao Yu, Kenhong Lin, Baoquan Zhang

## [Architecture and Training Dynamics](#topic-architecture-training) (14)

1. [Dynamic Compression in Recurrent Networks](#paper-2608-17896)
**Authors:** Jyothish Pari, Ryan Bahlous-Boldi, Pulkit Agrawal

2. [Think Shallow, Solve Deep: Controlling Recurrent Dynamics for Reliable Test-Time Depth](#paper-2608-18222)
**Authors:** Ivan Viakhirev, Kirill Borodin, Amirah Almutairi, Serguei Barannikov, Maxim Abramov, Grach Mkrtchian

3. [Allocating Recurrent Compute in Looped Language Models](#paper-2608-18230)
**Authors:** Ruhai Lin, Yiyang Guo, Rui-Jie Zhu, Hao Ye, Jason K. Eshraghian

4. [Center-Manifold Reduction of Learning at Bifurcations: Interference and Rich Learning in Recurrent Neural Networks](#paper-2605-12763)
...
6. [SingularClip: Preventing Spectral Collapse to Maintain Plasticity in Continual and Reinforcement Learning](#paper-2608-18319)
**Authors:** Tyler Kastner, Nimrod De La Vega, Amir-massoud Farahmand

7. [Demystifying Training-Time Augmentation for Data-Constrained Language Model Pretraining](#paper-2606-16246)
**Authors:** Michael K. Chen, Xikun Zhang, Fan Bai, Zhengding Hu, Zhen Wang

8. [When to Review: Spaced Repetition for Continual Pre-Training of Language Models](#paper-2608-17530)
**Authors:** Alankar Atreya, Devesh Batra, Yoages Kumar Mantri, Geremy Bantug, Greig A Cowan, Raad Khraishi

9. [HyPE-GT: where Graph Transformers meet Hyperbolic Positional Encodings](#paper-2312-06576)
**Authors:** Kushal Bose, Swagatam Das

10. [Low-dimensional topology of deep neural networks](#paper-2606-31856)
**Authors:** Junyu Ren, Lek-Heng Lim

11. [SurgicalMamba: Dual-Path SSD with State Regramming for Online Surgical Phase Recognition](#paper-2605-14889)
**Authors:** Sukju Oh, Sukkyu Sun

12. [Spikformer V2: Join the High Accuracy Club on ImageNet with an SNN Ticket](#paper-2401-02020)
**Authors:** Zhaokun Zhou, Yijie Lu, Kaiwei Che, Wei Fang, Keyu Tian, Qihao Peng, Yuesheng Zhu, Shuicheng Yan, Yonghong Tian, Li Yuan

13. [Where a New Concept Must Enter: Entry Point Gates Cross-Task Usability in Unified Multimodal Models](#paper-2608-17564)
**Authors:** Zongyang Qiu, Yihan Wu, Kaixuan Fan, Bo Li, Hui Xiong

14. [LoopVLA: Learning Sufficiency in Recurrent Refinement for Vision-Language-Action Models](#paper-2605-09948)
...
1. [TileMix: Tile-Centric Mixed-Precision Attention for LLM Inference Acceleration](#paper-2608-17336)
**Authors:** Hanzhi Zhang, Qiao Zhang, Qinglei Cao, Heng Fan, Yan Huang, Kewei Sha, Yunhe Feng

2. [MoNe: Modular Neural Memory for Efficient Long Context Inference](#paper-2608-17616)
...
3. [Optimize Your Sampling: Tuned Diffusion Sampling with Bayesian Optimization](#paper-2608-18040)
**Authors:** Travis Zhang, Christian Belardi, Justin Lovelace, Jin Peng Zhou, Saebyeol Shin, Carla P. Gomes, Kilian Q. Weinberger

4. [WAM-Diff2: Hierarchical AR-to-Diffusion Distillation for Highly Efficient Autonomous Driving VLA](#paper-2608-01035)
**Authors:** Zhihao Zhu, Hanlin Shang, Mingwang Xu, Feipeng Cai, Zhuolin He, Yaoyi Li, Jianhua Han, Hang Xu, Siyu Zhu

5. [CORAM: Coherent Orthogonal Rotation for Model Merging](#paper-2608-17366)
**Authors:** Xinyi Sui, Ziran Liu, Nam Ling, Wei Wang, Wei Jiang

6. [The Integer Alibi: Localizing Cross-Kernel Divergence in INT8-Quantized LLM Inference](#paper-2608-13756)
...
### 1. [Belayer: Efficient Fault Tolerance for LLM Agentic RL Training](https://arxiv.org/abs/2608.14635) <a id="paper-2608-14635"></a>
...
**Comment:** Selective GPU-state reuse and coordinated environment checkpoints reduce recovery costs while preserving training-state consistency.

**Topic Match:** Distributed recovery protocols and checkpoint scheduling are substantive training-systems contributions, despite their agentic-RL setting.
...
### 2. [Row-Stochastic Matrices Can Provably Outperform Doubly Stochastic Matrices in Decentralized Learning](https://arxiv.org/abs/2511.19513) <a id="paper-2511-19513"></a>
...
**Comment:** Weighted-Hilbert-space analysis yields conditions where row-stochastic decentralized optimization converges faster.

**Topic Match:** Its contribution is a distributed learning algorithm and convergence analysis with practical communication-topology implications.
...
### 3. [Federated Compositional Muon Optimizer for Matrix-Wise Models](https://arxiv.org/abs/2608.12710) <a id="paper-2608-12710"></a>
...
**Comment:** Combines compositional gradient tracking, orthogonalized momentum, and variance reduction in a federated matrix optimizer with convergence guarantees.

**Topic Match:** A distributed optimizer is the core contribution, although evaluation on federated compositional problems leaves large-scale pretraining relevance indirect.
...
### 4. [Efficient Resource Optimization for Split Federated Learning](https://arxiv.org/abs/2608.17849) <a id="paper-2608-17849"></a>
...
**Comment:** Provides polynomial-time optimal model splitting and a (1+epsilon)-approximation for joint splitting and resource allocation.

**Topic Match:** New partitioning and allocation algorithms directly optimize distributed training cost, although the setting is edge federated learning rather than large-model pretraining.
...
### 5. [Accelerating Visual On-Policy Distillation with Batched Speculative Jacobi Rollouts](https://arxiv.org/abs/2608.18183) <a id="paper-2608-18183"></a>
...
**Comment:** Batches independently advancing speculative Jacobi rollouts and compacts execution as images finish, reducing on-policy training time.

**Topic Match:** The core contribution is a training-rollout execution schedule; parallel decoding and adaptive compaction also directly address computational efficiency.
...
### 1. [Dynamic Compression in Recurrent Networks](https://arxiv.org/abs/2608.17896) <a id="paper-2608-17896"></a>
...
**Comment:** Selective history rescanning lets recurrent models revise fixed-size states through additional recurrent updates.

**Topic Match:** The core contribution changes recurrent sequence computation and establishes a state-capacity versus compute tradeoff; evidence comes from controlled tasks with retained raw history.
...
### 2. [Think Shallow, Solve Deep: Controlling Recurrent Dynamics for Reliable Test-Time Depth](https://arxiv.org/abs/2608.18222) <a id="paper-2608-18222"></a>
...
**Comment:** A terminal fixed-point objective controls recurrent dynamics to improve reliability when increasing test-time depth.

**Topic Match:** Directly analyzes recurrent computation through dynamical regimes, a sufficient depth-safety condition, and training interventions that change extrapolation behavior.
...
### 3. [Allocating Recurrent Compute in Looped Language Models](https://arxiv.org/abs/2608.18230) <a id="paper-2608-18230"></a>
...
**Comment:** Loops Gated DeltaNet mixers while executing each dense FFN once, reducing projection FLOPs in the recurrent backbone by 45.9%.

**Topic Match:** Selective recurrence directly changes architectural compute allocation, supported by influence analysis and controlled measurements of capability versus computation.
...
### 4. [Center-Manifold Reduction of Learning at Bifurcations: Interference and Rich Learning in Recurrent Neural Networks](https://arxiv.org/abs/2605.12763) <a id="paper-2605-12763"></a>
...
**Comment:** Center-manifold reduction explains low-rank gradient geometry and abrupt loss changes near RNN bifurcations.

**Topic Match:** The work directly analyzes optimization and interference dynamics induced by architectural state transitions.
...
**Comment:** Uses cross-difficulty Relative Transfer to explain curriculum optimization dynamics and derive adaptive sampling.

**Topic Match:** The core contribution explains how data scheduling changes optimization dynamics, qualifying despite its reasoning post-training setting.
...
### 6. [SingularClip: Preventing Spectral Collapse to Maintain Plasticity in Continual and Reinforcement Learning](https://arxiv.org/abs/2608.18319) <a id="paper-2608-18319"></a>
...
**Comment:** Links weight-spectrum anisotropy to plasticity loss and periodically clips singular values to preserve trainability.

**Topic Match:** A mechanistic analysis and intervention for lost trainability form the core contribution; continual-learning and RL experiments test that training-dynamics mechanism.
...
### 7. [Demystifying Training-Time Augmentation for Data-Constrained Language Model Pretraining](https://arxiv.org/abs/2606.16246) <a id="paper-2606-16246"></a>
...
**Comment:** Training-time augmentation delays multi-epoch pretraining overfitting on fixed corpora.

**Topic Match:** The central result concerns autoregressive pretraining dynamics, with secondary gains in data and compute efficiency.
...
### 8. [When to Review: Spaced Repetition for Continual Pre-Training of Language Models](https://arxiv.org/abs/2608.17530) <a id="paper-2608-17530"></a>
...
**Comment:** Schedules per-example replay using perplexity-based recall signals and SM-2 review state during continual pretraining.

**Topic Match:** Adaptive replay directly changes the retention and acquisition dynamics of language-model pretraining; novelty comes from adapting an established scheduling principle.
...
### 9. [HyPE-GT: where Graph Transformers meet Hyperbolic Positional Encodings](https://arxiv.org/abs/2312.06576) <a id="paper-2312-06576"></a>
...
**Comment:** Learnable hyperbolic positional encodings capture graph hierarchy and mitigate oversmoothing in deep graph networks.

**Topic Match:** The contribution introduces and theoretically analyzes a positional-encoding mechanism, with applicability and evidence concentrated on graph architectures.
...
### 10. [Low-dimensional topology of deep neural networks](https://arxiv.org/abs/2606.31856) <a id="paper-2606-31856"></a>
...
**Comment:** Uses linking-number changes to isolate the expressive effects of residual skips, attention, and nonmonotonic activations.

**Topic Match:** Directly analyzes architectural mechanisms through topological expressivity, although implications for large-model training remain indirect.
...
### 11. [SurgicalMamba: Dual-Path SSD with State Regramming for Online Surgical Phase Recognition](https://arxiv.org/abs/2605.14889) <a id="paper-2605-14889"></a>
...
**Comment:** Adds content-dependent state rotations to SSD recurrence while preserving its semiseparable structure and linear per-frame cost.

**Topic Match:** State regramming changes the recurrent computational mechanism, with associative-recall experiments supporting applicability beyond surgical recognition.
...
### 12. [Spikformer V2: Join the High Accuracy Club on ImageNet with an SNN Ticket](https://arxiv.org/abs/2401.02020) <a id="paper-2401-02020"></a>
...
**Comment:** Multiply-free spiking self-attention introduces sparse, energy-efficient Transformer computation.

**Topic Match:** The primary contribution is a new attention architecture, with sparse spike-based computation providing a secondary efficiency match.
...
### 13. [Where a New Concept Must Enter: Entry Point Gates Cross-Task Usability in Unified Multimodal Models](https://arxiv.org/abs/2608.17564) <a id="paper-2608-17564"></a>
...
**Comment:** Identifies a layer-dependent semantic-alignment window governing transfer between multimodal understanding and generation.

**Topic Match:** Shared-pathway interventions provide an architectural connection, but the central contribution concerns concept binding and representation transfer, which this feed generally excludes.
...
### 14. [LoopVLA: Learning Sufficiency in Recurrent Refinement for Vision-Language-Action Models](https://arxiv.org/abs/2605.09948) <a id="paper-2605-09948"></a>
...
**Comment:** Shared-block recurrence with learned sufficiency scores allocates refinement depth according to action quality.

**Topic Match:** Learned adaptive computation is the central architectural mechanism, with parameter and inference savings; its formulation remains specific to robotic action prediction.
...
### 1. [TileMix: Tile-Centric Mixed-Precision Attention for LLM Inference Acceleration](https://arxiv.org/abs/2608.17336) <a id="paper-2608-17336"></a>
...
**Comment:** Routes attention score tiles through FP16 or INT8 computation inside a fused kernel with shared online softmax.

**Topic Match:** A new spatial mixed-precision kernel directly improves long-context prefill efficiency while preserving dense attention connectivity.
...
### 2. [MoNe: Modular Neural Memory for Efficient Long Context Inference](https://arxiv.org/abs/2608.17616) <a id="paper-2608-17616"></a>
...
**Comment:** Fast-weight key/value generation reduces long-context query compute and GPU memory without backbone retraining.

**Topic Match:** The modular mechanism decouples query cost from context length and reports approximately 80% compute and peak-memory reductions at 128K, providing a concrete efficiency contribution.
...
### 3. [Optimize Your Sampling: Tuned Diffusion Sampling with Bayesian Optimization](https://arxiv.org/abs/2608.18040) <a id="paper-2608-18040"></a>
...
**Comment:** Bayesian-optimized timestep schedules reduce diffusion inference cost by roughly 10x.

**Topic Match:** Its primary contribution materially reduces model-running cost without retraining.
...
### 4. [WAM-Diff2: Hierarchical AR-to-Diffusion Distillation for Highly Efficient Autonomous Driving VLA](https://arxiv.org/abs/2608.01035) <a id="paper-2608-01035"></a>
...
**Comment:** Three-stage hierarchical distillation converts autoregressive VLAs into parallel diffusion decoders, delivering a reported 2.8x decoding speedup.

**Topic Match:** The core conversion method changes model computation and directly reduces decoding cost, qualifying despite driving-specific validation.
...
### 5. [CORAM: Coherent Orthogonal Rotation for Model Merging](https://arxiv.org/abs/2608.17366) <a id="paper-2608-17366"></a>
...
**Comment:** SVD-factor manifold averaging merges specialist checkpoints without joint retraining.

**Topic Match:** The efficiency connection comes from avoiding joint retraining; the central advance improves checkpoint-merging geometry and quality, with no demonstrated change to training or execution cost.
...
### 6. [The Integer Alibi: Localizing Cross-Kernel Divergence in INT8-Quantized LLM Inference](https://arxiv.org/abs/2608.13756) <a id="paper-2608-13756"></a>
...
**Comment:** Localizes INT8-kernel output divergence to scale application and rounding after exact integer accumulation.

**Topic Match:** Quantized-kernel numerics directly touches efficiency methods, but the contribution establishes reproducibility and conformance rather than reducing model computation or memory costs.
