...
from arxiv_assistant.hotspot.support.dates import (
    is_supported_hotspot_date,
    is_supported_hotspot_month,
    is_supported_hotspot_year,
)
from arxiv_assistant.hotspot.support.cluster import title_similarity
from arxiv_assistant.hotspot.support.schema import HotspotItem
from arxiv_assistant.hotspot.support.source_fetch import parse_datetime, url_title_consistent
...
def _is_title_duplicate(title: str, seen: list[str], sim_threshold: float = 0.55) -> bool:
    ...
    longer subtitle.
    """
    from arxiv_assistant.hotspot.support.cluster import significant_title_tokens
...
def _build_source_sections(raw_items: list[HotspotItem], report: dict[str, Any], topic_lookup: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
    from arxiv_assistant.hotspot.filter import _item_engineering_score
