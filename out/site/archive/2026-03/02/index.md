<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../../2026-02/28"><img src="../../../assets/nav/day/2026-03-02-prev.svg" alt="Previous Day 2026-02-28"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2026-03-02-center.svg" alt="Monthly Overview 2026-03"></a></div><div style="width: 33.33%; text-align: right;"><a href="../03"><img src="../../../assets/nav/day/2026-03-02-next.svg" alt="Next Day 2026-03-03"></a></div></div>
...
## 2. [On De-Individuated Neurons: Continuous Symmetries Enable Dynamic Topologies](https://arxiv.org/abs/2602.23405) <a id="link2"></a>
...
## 3. [Quant Experts: Token-aware Adaptive Error Reconstruction with Mixture of Experts for Large Vision-Language Models Quantization](https://arxiv.org/abs/2602.24059) <a id="link3"></a>
...
## 4. [GRAIL: Post-hoc Compensation by Linear Reconstruction for Compressed Networks](https://arxiv.org/abs/2602.23795) <a id="link4"></a>
...
## 5. [InfoNCE Induces Gaussian Distribution](https://arxiv.org/abs/2602.24012) <a id="link5"></a>
...
## 6. [Taming Momentum: Rethinking Optimizer States Through Low-Rank Approximation](https://arxiv.org/abs/2602.24283) <a id="link6"></a>
...
## 7. [Provable Subspace Identification of Nonlinear Multi-view CCA](https://arxiv.org/abs/2602.23785) <a id="link7"></a>
...
## 8. [Efficient Discovery of Approximate Causal Abstractions via Neural Mechanism Sparsification](https://arxiv.org/abs/2602.24266) <a id="link8"></a>
...
## 9. [Memory Caching: RNNs with Growing Memory](https://arxiv.org/abs/2602.24281) <a id="link9"></a>
...
## 10. [Compositional Generalization Requires Linear, Orthogonal Representations in Vision Embedding Models](https://arxiv.org/abs/2602.24264) <a id="link10"></a>
...
## 11. [Optimizer-Induced Low-Dimensional Drift and Transverse Dynamics in Transformer Training](https://arxiv.org/abs/2602.23696) <a id="link11"></a>
...
## 12. [CoME: Empowering Channel-of-Mobile-Experts with Informative Hybrid-Capabilities Reasoning](https://arxiv.org/abs/2602.24142) <a id="link12"></a>
...
## 13. [LK Losses: Direct Acceptance Rate Optimization for Speculative Decoding](https://arxiv.org/abs/2602.23881) <a id="link13"></a>
...
## 14. [Universality of Shallow and Deep Neural Networks on Non-Euclidean Spaces](https://arxiv.org/abs/2602.23381) <a id="link14"></a>
...
## 15. [Rudder: Steering Prefetching in Distributed GNN Training using LLM Agents](https://arxiv.org/abs/2602.23556) <a id="link15"></a>
...
## 16. [Brain-OF: An Omnifunctional Foundation Model for fMRI, EEG and MEG](https://arxiv.org/abs/2602.23410) <a id="link16"></a>
...
## 17. [Intrinsic Lorentz Neural Network](https://arxiv.org/abs/2602.23981) <a id="link17"></a>
...
## 18. [Who Guards the Guardians? The Challenges of Evaluating Identifiability of Learned Representations](https://arxiv.org/abs/2602.24278) <a id="link18"></a>
...
## 19. [A Mixed Diet Makes DINO An Omnivorous Vision Encoder](https://arxiv.org/abs/2602.24181) <a id="link19"></a>
...
## 20. [ODAR: Principled Adaptive Routing for LLM Reasoning via Active Inference](https://arxiv.org/abs/2602.23681) <a id="link20"></a>
...
## 21. [MuViT: Multi-Resolution Vision Transformers for Learning Across Scales in Microscopy](https://arxiv.org/abs/2602.24222) <a id="link21"></a>
...
## 22. [KEEP: A KV-Cache-Centric Memory Management System for Efficient Embodied Planning](https://arxiv.org/abs/2602.23592) <a id="link22"></a>
...
## 23. [Task-Centric Acceleration of Small-Language Models](https://arxiv.org/abs/2602.24174) <a id="link23"></a>
