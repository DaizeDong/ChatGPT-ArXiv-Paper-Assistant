<div style="display: flex; align-items: flex-start; justify-content: space-between; width: 100%;"><div style="width: 33.33%; text-align: left;"><a href="../04"><img src="../../../assets/nav/day/2025-11-05-prev.svg" alt="Previous Day 2025-11-04"></a></div><div style="width: 33.33%; text-align: center;"><a href=".."><img src="../../../assets/nav/day/2025-11-05-center.svg" alt="Monthly Overview 2025-11"></a></div><div style="width: 33.33%; text-align: right;"><a href="../06"><img src="../../../assets/nav/day/2025-11-05-next.svg" alt="Next Day 2025-11-06"></a></div></div>
...
## 1. [On the Emergence of Induction Heads for In-Context Learning](https://arxiv.org/abs/2511.01033) <a id="link1"></a>
...
## 2. [Flashlight: PyTorch Compiler Extensions to Accelerate Attention Variants](https://arxiv.org/abs/2511.02043) <a id="link2"></a>
...
## 3. [LongCat-Flash-Omni Technical Report](https://arxiv.org/abs/2511.00279) <a id="link3"></a>
...
## 4. [Opportunistic Expert Activation: Batch-Aware Expert Routing for Faster Decode Without Retraining](https://arxiv.org/abs/2511.02237) <a id="link4"></a>
...
## 5. [FP8-Flow-MoE: A Casting-Free FP8 Recipe without Double Quantization Error](https://arxiv.org/abs/2511.02302) <a id="link5"></a>
...
## 6. [Scalable Processing-Near-Memory for 1M-Token LLM Inference: CXL-Enabled KV-Cache Management Beyond GPU Limits](https://arxiv.org/abs/2511.00321) <a id="link6"></a>
...
## 8. [Isotropic Curvature Model for Understanding Deep Learning Optimization: Is Gradient Orthogonalization Optimal?](https://arxiv.org/abs/2511.00674) <a id="link8"></a>
...
## 9. [MISA: Memory-Efficient LLMs Optimization with Module-wise Importance Sampling](https://arxiv.org/abs/2511.00056) <a id="link9"></a>
...
## 10. [The Hidden Power of Normalization: Exponential Capacity Control in Deep Neural Networks](https://arxiv.org/abs/2511.00958) <a id="link10"></a>
...
## 11. [Loquetier: A Virtualized Multi-LoRA Framework for Unified LLM Fine-tuning and Serving](https://arxiv.org/abs/2511.00101) <a id="link11"></a>
...
## 12. [ExplicitLM: Decoupling Knowledge from Parameters via Explicit Memory Banks](https://arxiv.org/abs/2511.01581) <a id="link12"></a>
...
## 13. [Eliminating Multi-GPU Performance Taxes: A Systems Approach to Efficient Distributed LLMs](https://arxiv.org/abs/2511.02168) <a id="link13"></a>
...
## 14. [From Models to Operators: Rethinking Autoscaling Granularity for Large Generative Models](https://arxiv.org/abs/2511.02248) <a id="link14"></a>
...
## 15. [Bayesian Natural Gradient Fine-Tuning of CLIP Models via Kalman Filtering](https://arxiv.org/abs/2511.01694) <a id="link15"></a>
...
## 16. [A new class of Markov random fields enabling lightweight sampling](https://arxiv.org/abs/2511.02373) <a id="link16"></a>
...
## 17. [Optimal Singular Damage: Efficient LLM Inference in Low Storage Regimes](https://arxiv.org/abs/2511.02681) <a id="link17"></a>
...
## 18. [Bulk-boundary decomposition of neural networks](https://arxiv.org/abs/2511.02003) <a id="link18"></a>
...
## 19. [Federated Attention: A Distributed Paradigm for Collaborative LLM Inference over Edge Networks](https://arxiv.org/abs/2511.02647) <a id="link19"></a>
...
## 20. [Language Modeling With Factorization Memory](https://arxiv.org/abs/2511.00315) <a id="link20"></a>
...
## 21. [Calibration Across Layers: Understanding Calibration Evolution in LLMs](https://arxiv.org/abs/2511.00280) <a id="link21"></a>
...
## 22. [Efficiently Training A Flat Neural Network Before It has been Quantizated](https://arxiv.org/abs/2511.01462) <a id="link22"></a>
...
## 23. [From Uniform to Adaptive: General Skip-Block Mechanisms for Efficient PDE Neural Operators](https://arxiv.org/abs/2511.00032) <a id="link23"></a>
...
## 24. [Apriel-H1: Towards Efficient Enterprise Reasoning Models](https://arxiv.org/abs/2511.02651) <a id="link24"></a>
...
## 25. [LLM Probing with Contrastive Eigenproblems: Improving Understanding and Applicability of CCS](https://arxiv.org/abs/2511.02089) <a id="link25"></a>
...
## 26. [Calibrating and Rotating: A Unified Framework for Weight Conditioning in PEFT](https://arxiv.org/abs/2511.00051) <a id="link26"></a>
...
## 27. [Optimizing Attention on GPUs by Exploiting GPU Architectural NUMA Effects](https://arxiv.org/abs/2511.02132) <a id="link27"></a>
...
## 28. [Redundancy Maximization as a Principle of Associative Memory Learning](https://arxiv.org/abs/2511.02584) <a id="link28"></a>
...
## 29. [Efficient Vector Symbolic Architectures from Histogram Recovery](https://arxiv.org/abs/2511.01838) <a id="link29"></a>
...
## 30. [Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Framework with Efficient LLM Serving](https://arxiv.org/abs/2511.01633) <a id="link30"></a>
...
## 31. [A Proof of Learning Rate Transfer under $\mu$P](https://arxiv.org/abs/2511.01734) <a id="link31"></a>
...
## 32. [Accelerated Frank-Wolfe Algorithms: Complementarity Conditions and Sparsity](https://arxiv.org/abs/2511.02821) <a id="link32"></a>
...
## 33. [Belief Dynamics Reveal the Dual Nature of In-Context Learning and Activation Steering](https://arxiv.org/abs/2511.00617) <a id="link33"></a>
...
## 34. [Real-time Continual Learning on Intel Loihi 2](https://arxiv.org/abs/2511.01553) <a id="link34"></a>
...
## 35. [Adam Reduces a Unique Form of Sharpness: Theoretical Insights Near the Minimizer Manifold](https://arxiv.org/abs/2511.02773) <a id="link35"></a>
...
## 36. [DTS: Enhancing Large Reasoning Models via Decoding Tree Sketching](https://arxiv.org/abs/2511.00640) <a id="link36"></a>
...
## 37. [More Than A Shortcut: A Hyperbolic Approach To Early-Exit Networks](https://arxiv.org/abs/2511.00641) <a id="link37"></a>
...
## 38. [Shared Parameter Subspaces and Cross-Task Linearity in Emergently Misaligned Behavior](https://arxiv.org/abs/2511.02022) <a id="link38"></a>
...
## 39. [Natural Building Blocks for Structured World Models: Theory, Evidence, and Scaling](https://arxiv.org/abs/2511.02091) <a id="link39"></a>
...
## 40. [CudaForge: An Agent Framework with Hardware Feedback for CUDA Kernel Optimization](https://arxiv.org/abs/2511.01884) <a id="link40"></a>
...
## 41. [EchoLSTM: A Self-Reflective Recurrent Network for Stabilizing Long-Range Memory](https://arxiv.org/abs/2511.01950) <a id="link41"></a>
...
## 42. [Energy-Efficient Deep Learning Without Backpropagation: A Rigorous Evaluation of Forward-Only Algorithms](https://arxiv.org/abs/2511.01061) <a id="link42"></a>
...
## 43. [In Good GRACEs: Principled Teacher Selection for Knowledge Distillation](https://arxiv.org/abs/2511.02833) <a id="link43"></a>
...
## 44. [Forget BIT, It is All about TOKEN: Towards Semantic Information Theory for LLMs](https://arxiv.org/abs/2511.01202) <a id="link44"></a>
...
## 45. [When, What, and How: Rethinking Retrieval-Enhanced Speculative Decoding](https://arxiv.org/abs/2511.01282) <a id="link45"></a>
...
## 46. [ConMeZO: Adaptive Descent-Direction Sampling for Gradient-Free Finetuning of Large Language Models](https://arxiv.org/abs/2511.02757) <a id="link46"></a>
...
## 47. [In Situ Training of Implicit Neural Compressors for Scientific Simulations via Sketch-Based Regularization](https://arxiv.org/abs/2511.02659) <a id="link47"></a>
...
## 48. [A Non-Adversarial Approach to Idempotent Generative Modelling](https://arxiv.org/abs/2511.02614) <a id="link48"></a>
...
## 49. [Re-FORC: Adaptive Reward Prediction for Efficient Chain-of-Thought Reasoning](https://arxiv.org/abs/2511.02130) <a id="link49"></a>
...
## 50. [OmniField: Conditioned Neural Fields for Robust Multimodal Spatiotemporal Learning](https://arxiv.org/abs/2511.02205) <a id="link50"></a>
...
## 51. [How Focused Are LLMs? A Quantitative Study via Repetitive Deterministic Prediction Tasks](https://arxiv.org/abs/2511.00763) <a id="link51"></a>
...
## 52. [Generalizing Test-time Compute-optimal Scaling as an Optimizable Graph](https://arxiv.org/abs/2511.00086) <a id="link52"></a>
...
## 53. [DoFlow: Causal Generative Flows for Interventional and Counterfactual Time-Series Prediction](https://arxiv.org/abs/2511.02137) <a id="link53"></a>
...
## 54. [Mutual Information guided Visual Contrastive Learning](https://arxiv.org/abs/2511.00028) <a id="link54"></a>
...
## 55. [The stability of shallow neural networks on spheres: A sharp spectral analysis](https://arxiv.org/abs/2511.02625) <a id="link55"></a>
...
## 56. [Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement](https://arxiv.org/abs/2511.01706) <a id="link56"></a>
