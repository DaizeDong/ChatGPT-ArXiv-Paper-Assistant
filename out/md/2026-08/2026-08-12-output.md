...
<sub>Token counts are not reported for this run. 5 of 7 model calls succeeded, 3,660s of model wall clock.</sub>
...
2. [Native Multi-Dimensional Subquadratic Operators via Input Dependent Long Convolutions](#paper-2607-19378)
...
3. [Spherical Flows for Sampling Categorical Data](#paper-2605-05629)
**Authors:** Jannis Chemseddine, Gregor Kornhardt, Gabriele Steidl

4. [Diffract: Spectral View of LLM Domain Adaptation](#paper-2608-10850)
...
5. [Three Tokens Force Exponential Feature Rank in Nonnegative Kernel Attention](#paper-2608-11427)
**Authors:** Vicente Opazo

6. [Convergence of Sign-based Random Reshuffling Algorithms for Nonconvex Optimization](#paper-2310-15976)
**Authors:** Zhen Qin, Zhishuai Liu, Pan Xu

7. [Convergence Guarantees of Gradient Descent for Neural Networks via Generalized Lipschitz Smoothness](#paper-2608-11479)
**Authors:** Siqiao Mu, Diego Klabjan

## [Efficiency, Compression, and Large-Scale Training](#topic-efficiency-scaling) (13)

1. [SQuaT: Self-Supervised Knowledge Distillation via Student-Aware Quantized Teacher Features](#paper-2608-10709)
...
4. [ReRound: Reconstructive Rounding to Resolve Midpoint Ambiguity in Calibration-Free LLM Quantization](#paper-2608-11045)
...
7. [HoloQ-VLA: Uniform W4A4 Quantization of Vision-Language-Action Models](#paper-2605-28803)
**Authors:** Xinyu Wang, Mingze Li, Sicheng Lyu, Dongxiu Liu, Kaicheng Yang, Ziyu Zhao, Yufei Cui, Xiao-Wen Chang, Peng Lu

8. [Do LLMs Benefit From Their Own Words?](#paper-2602-24287)
...
9. [Putting Registers to Work: Task Registers for Token Pruning in Vision Transformers](#paper-2608-10989)
**Authors:** Hongsen Cao, Mona Jaber, Shanxin Yuan, Ahmed Sayed

10. [UPAIR: Diagnosing Reasoning States via Uncertainty-Progress Alignment for Selective Intervention](#paper-2607-17188)
**Authors:** Cheng Yan, Zhijun Fan, Guangyang Ye, Fan Xu, Xiang Xia, Yawei Wang, Wuyang Zhang

11. [GLAM: Efficient Continual Learning at Scale via Grouped LoRA Adapter Merging](#paper-2509-13211)
**Authors:** Irene Testa, Luigi Quarantiello, Eric Nuertey Coleman, Samrat Mukherjee, Julio Hurtado, Vincenzo Lomonaco

12. [Dynamic Context Adapters: Efficiently Infusing History into Vision-and-Language Models](#paper-2608-10525)
**Authors:** Yuhang Song, Bor-Jiun Lin, Jiaxu Liu, Te-Chuan Chiu, Anh Nguyen, Chun-Yi Lee

13. [TACTICL: Task-Aware Compression of Tabular ICL Models](#paper-2608-10837)
...
### 2. [Native Multi-Dimensional Subquadratic Operators via Input Dependent Long Convolutions](https://arxiv.org/abs/2607.19378) <a id="paper-2607-19378"></a>
...
### 3. [Spherical Flows for Sampling Categorical Data](https://arxiv.org/abs/2605.05629) <a id="paper-2605-05629"></a>
...
### 4. [Diffract: Spectral View of LLM Domain Adaptation](https://arxiv.org/abs/2608.10850) <a id="paper-2608-10850"></a>
...
### 5. [Three Tokens Force Exponential Feature Rank in Nonnegative Kernel Attention](https://arxiv.org/abs/2608.11427) <a id="paper-2608-11427"></a>
...
### 6. [Convergence of Sign-based Random Reshuffling Algorithms for Nonconvex Optimization](https://arxiv.org/abs/2310.15976) <a id="paper-2310-15976"></a>
...
### 7. [Convergence Guarantees of Gradient Descent for Neural Networks via Generalized Lipschitz Smoothness](https://arxiv.org/abs/2608.11479) <a id="paper-2608-11479"></a>
...
### 1. [SQuaT: Self-Supervised Knowledge Distillation via Student-Aware Quantized Teacher Features](https://arxiv.org/abs/2608.10709) <a id="paper-2608-10709"></a>
...
### 4. [ReRound: Reconstructive Rounding to Resolve Midpoint Ambiguity in Calibration-Free LLM Quantization](https://arxiv.org/abs/2608.11045) <a id="paper-2608-11045"></a>
...
### 7. [HoloQ-VLA: Uniform W4A4 Quantization of Vision-Language-Action Models](https://arxiv.org/abs/2605.28803) <a id="paper-2605-28803"></a>
...
### 8. [Do LLMs Benefit From Their Own Words?](https://arxiv.org/abs/2602.24287) <a id="paper-2602-24287"></a>
...
### 9. [Putting Registers to Work: Task Registers for Token Pruning in Vision Transformers](https://arxiv.org/abs/2608.10989) <a id="paper-2608-10989"></a>
...
### 10. [UPAIR: Diagnosing Reasoning States via Uncertainty-Progress Alignment for Selective Intervention](https://arxiv.org/abs/2607.17188) <a id="paper-2607-17188"></a>
...
### 11. [GLAM: Efficient Continual Learning at Scale via Grouped LoRA Adapter Merging](https://arxiv.org/abs/2509.13211) <a id="paper-2509-13211"></a>
...
### 12. [Dynamic Context Adapters: Efficiently Infusing History into Vision-and-Language Models](https://arxiv.org/abs/2608.10525) <a id="paper-2608-10525"></a>
...
### 13. [TACTICL: Task-Aware Compression of Tabular ICL Models](https://arxiv.org/abs/2608.10837) <a id="paper-2608-10837"></a>
