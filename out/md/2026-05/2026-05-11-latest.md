...
<table>
    ...
    <tbody>
        ...
        <tr><td><a href="#topic-representation-structure">Representation Learning Theory and Structure</a></td><td align="center">16</td></tr>
        <tr><td><a href="#topic-memory-systems">Memory Structures and Agent Memory Systems</a></td><td align="center">2</td></tr>
        <tr><td><a href="#topic-world-models-open-ended-rl">World Models, Exploration, and Open-Ended Reinforcement Learning</a></td><td align="center">7</td></tr>
    </tbody>
</table>
...
1. [PolarAdamW: Disentangling Spectral Control and Schur Gauge-Equivariance in Matrix Optimisation](#paper-2605-07067)
...
4. [A Rod Flow Model for Adam at the Edge of Stability](#paper-2605-06821)
**Authors:** Eric Regis, Sinho Chewi

5. [Rethinking State Tracking in Recurrent Models Through Error Control Dynamics](#paper-2605-07755)
**Authors:** Jiwan Chung, Heechan Choi, Seon Joo Kim

6. [Revisiting Transformer Layer Parameterization Through Causal Energy Minimization](#paper-2605-07588)
**Authors:** Jin Xu, Camille Couturier, Victor R\"uhle, Saravan Rajmohan, James Hensman

7. [Muon with Nesterov Momentum: Heavy-Tailed Noise and (Randomized) Inexact Polar Decomposition](#paper-2605-06884)
**Authors:** Sayantan Choudhury, Xiaoran Cheng, Martin Tak\'a\v{c}, Sen Na, Mladen Kolar

8. [Star Elastic: Many-in-One Reasoning LLMs with Efficient Budget Control](#paper-2605-07182)
...
9. [Self-Programmed Execution for Language-Model Agents](#paper-2605-06898)
**Authors:** Luke J. O'Connor

10. [Fast Byte Latent Transformer](#paper-2605-08044)
...
11. [When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](#paper-2605-07969)
**Authors:** Ahmad Aghapour, Erhan Bayraktar

12. [Bifurcation Models: Learning Set-Valued Solution Maps with Weight-Tied Dynamics](#paper-2605-07277)
**Authors:** Caleb Jore, Jialin Liu

13. [Training-Induced Escape from Token Clustering in a Mean-Field Formulation of Transformers](#paper-2605-07772)
**Authors:** Noboru Isobe, Daisuke Inoue, Masaaki Imaizumi

14. [Cross-Attention and Encoder-Decoder Transformers: A Logical Characterization](#paper-2605-07705)
**Authors:** Veeti Ahvonen, Damian Heiman, Antti Kuusisto, Miguel Moreno, Matias Selin

15. [Randomness is sometimes necessary for coordination](#paper-2605-06825)
**Authors:** Rohan Patil, Jai Malegaonkar, Henrik I. Christensen

16. [A Theory of Online Learning with Autoregressive Chain-of-Thought Reasoning](#paper-2605-06819)
**Authors:** Ilan Doron-Arad, Idan Mehalel, Elchanan Mossel

17. [Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training](#paper-2605-07063)
**Authors:** Pingbang Hu, Xueshen Liu, Z. Morley Mao, Jiaqi W. Ma

18. [Every Feedforward Neural Network Definable in an o-Minimal Structure Has Finite Sample Complexity](#paper-2605-07097)
**Authors:** Anastasis Kratsios, Gregory Cousins, Haitz S\'aez de Oc\'ariz Borde, Bum Jun Kim, Simone Brugiapaglia

19. [Why DDIM Hallucinates More than DDPM: A Theoretical Analysis of Reverse Dynamics](#paper-2605-06831)
**Authors:** Muhammad H. Ashiq, Samanyu Arora, Abhinav N. Harish, Ishaan Kharbanda, Hung Yun Tseng, Grigorios G. Chrysos

20. [STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation](#paper-2605-08029)
...
21. [The Position Curse: LLMs Struggle to Locate the Last Few Items in a List](#paper-2605-07127)
**Authors:** Zhanqi Zhang, Hua-Dong Xiong, Robert C. Wilson, Mikio Aoi, Marcelo G. Mattar, Li Ji-An

22. [GazeVLM: Active Vision via Internal Attention Control for Multimodal Reasoning](#paper-2605-07817)
**Authors:** Brown Ebouky, Gabriele Carrino, Niccolo Avogaro, Christoph Studer, Andrea Bartezzaghi, Mattia Rigotti

23. [Bilevel Graph Structure Learning, Revisited: Inner-Channel Origins of the Reported Gain](#paper-2605-07577)
**Authors:** Minkyoung Kim, Beakcheol Jang

24. [Normalizing Trajectory Models](#paper-2605-08078)
**Authors:** Jiatao Gu, Tianrong Chen, Ying Shen, David Berthelot, Shuangfei Zhai, Josh Susskind

25. [Globally Optimal Training of Spiking Neural Networks via Parameter Reconstruction](#paper-2605-08022)
**Authors:** Himanshu Udupi, Xiaocong Yang, ChengXiang Zhai

26. [The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](#paper-2605-07686)
**Authors:** Wenhua Nie, Junlin Liu, Jianan Wu, Zijie Meng, Yilong Fan, Zhang Zijian, Haoran Zheng, Jyh-Shing Roger Jang

27. [Same Signal, Opposite Meaning: Direction-Informed Adaptive Learning for LLM Agents](#paper-2605-06908)
**Authors:** Ziming Li, Jiatan Huang, Xiaoguang Guo, Guilin Wang, Chuxu Zhang

28. [Learned Lagrangian Models of PDEs via Euler-Lagrange Residual Minimization](#paper-2605-07157)
...
1. [Beyond LoRA vs. Full Fine-Tuning: Gradient-Guided Optimizer Routing for LLM Adaptation](#paper-2605-07111)
...
3. [CSR: Infinite-Horizon Real-Time Policies with Massive Cached State Representations](#paper-2605-07325)
**Authors:** Robin Karlsson, Go Suzui

4. [An Efficient Hybrid Sparse Attention with CPU-GPU Parallelism for Long-Context Inference](#paper-2605-07719)
**Authors:** Feiyu Yao, Zhixiong Niu, Xiaqing Li, Yongqiang Xiong, Juan Fang, Qian Wang

5. [Future Validity is the Missing Statistic: From Impossibility to $\Phi$-Estimation for Grammar-Faithful Speculative Decoding](#paper-2605-07698)
**Authors:** Wenhua Nie, Zijie Meng, Kun Zou, Zheng Lin, Ziwei Li, Haoran Zheng, Jyh-Shing Roger Jang, Hao Zhang

6. [Beyond Factor Aggregation: Gauge-Aware Low-Rank Server Representations for Federated LoRA](#paper-2605-06733)
**Authors:** Jinqian Chen, Chang Liu, Jihua Zhu

7. [Direction-Preserving Number Representations](#paper-2605-07662)
**Authors:** Bardia Zadeh, George A. Constantinides

8. [Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?](#paper-2605-07072)
**Authors:** Andy Dong, Ayfer \"Ozg\"ur

9. [KL for a KL: On-Policy Distillation with Control Variate Baseline](#paper-2605-07865)
**Authors:** Minjae Oh, Sangjun Song, Gyubin Choi, Yunho Choi, Yohan Jo

10. [Resource-Element Energy Difference for Noncoherent Over-the-Air Federated Learning](#paper-2605-07263)
**Authors:** Hao Chen, Zavareh Bozorgasl

## [Representation Learning Theory and Structure](#topic-representation-structure) (16)

1. [Pretraining Induces a Reusable Spectral Basis for Downstream Task Adaptation](#paper-2605-07302)
**Authors:** Junjie Yu, Yue Wang, Zihan Deng, Yan Zhu, Wenxiao Ma, Quanying Liu

2. [Continuous First, Discrete Later: VQ-VAEs Without Dimensional Collapse](#paper-2605-06870)
**Authors:** Xinyu Zhao, Nikita Karagodin, Hamed Hassani, Sinan Hersek, Paul Pu Liang, Yury Polyanskiy

3. [Tree SAE: Learning Hierarchical Feature Structures in Sparse Autoencoders](#paper-2605-07922)
**Authors:** Tue M. Cao, Hoang X. Nhat, Raed Alharbi, My T. Thai

4. [Does Your Neural Network Extrapolate? Feature Engineering as Identifiability Bias for OOD Generalization](#paper-2605-07483)
**Authors:** Leonel Aguilar, Jan Nagler, Christoph Hoelscher, Nino Antulov-Fantulin

5. [Characterizing and Correcting Effective Target Shift in Online Learning](#paper-2605-07886)
**Authors:** Ziyan Li, Naoki Hiratani

6. [Structured Coupling for Flow Matching](#paper-2605-07676)
**Authors:** Xavier Sumba, Carles Balsells-Rodas, Yingzhen Li

7. [Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning](#paper-2605-07980)
**Authors:** Chris Elliott, Daniel Murfet

8. [Distributional simplicity bias and effective convexity in Energy Based Models](#paper-2605-07844)
**Authors:** Aur\'elien Decelle, Alfonso de Jes\'us Navas G\'omez, Beatriz Seoane

9. [When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification](#paper-2605-07120)
**Authors:** Wenjie Guan, Jelena Bradic

10. [Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions](#paper-2605-07984)
**Authors:** Nicole Ma, Nick Rui

11. [Tool Calling is Linearly Readable and Steerable in Language Models](#paper-2605-07990)
...
12. [Extracting Search Trees from LLM Reasoning Traces Reveals Myopic Planning](#paper-2605-06840)
**Authors:** Sixing Chen, Ji-An Li, Saner Cakir, Sinan Akcali, Kayla Lee, Marcelo G. Mattar

13. [Learning Large-Scale Modular Addition with an Auxiliary Modulus](#paper-2605-07648)
**Authors:** Hanato Kikuchi, Ryosuke Masuya, Kazuhiko Kawamoto, Hiroshi Kera

14. [When Does a Language Model Commit? A Finite-Answer Theory of Pre-Verbalization Commitment](#paper-2605-06723)
**Authors:** Long Zhang, Wei-neng Chen, Feng-feng Wei, Zi-bo Qin

15. [PLOT: Progressive Localization via Optimal Transport in Neural Causal Abstraction](#paper-2605-06979)
**Authors:** Jonathn Chang, Arya Datla, Ziv Goldfeld

16. [Interpreting Reinforcement Learning Agents with Susceptibilities](#paper-2605-08007)
...
1. [CASCADE: Case-Based Continual Adaptation for Large Language Models During Deployment](#paper-2605-06702)
**Authors:** Siyuan Guo, Yali Du, Hechang Chen, Yi Chang, Jun Wang

2. [MEMOREPAIR: Barrier-First Cascade Repair in Agentic Memory](#paper-2605-07242)
**Authors:** Yang Zhao, Chengxiao Dai, Mengying Kou, Yue Xiu

## [World Models, Exploration, and Open-Ended Reinforcement Learning](#topic-world-models-open-ended-rl) (7)

1. [AGWM: Affordance-Grounded World Models for Environments with Compositional Prerequisites](#paper-2605-06841)
...
2. [Predictive but Not Plannable: RC-aux for Latent World Models](#paper-2605-07278)
**Authors:** Wenyuan Li, Guang Li, Keisuke Maeda, Takahiro Ogawa, Miki Haseyama

3. [Convergence and Emergence of In-Context Reinforcement Learning with Chain of Thought](#paper-2605-07123)
**Authors:** Zixuan Xie, Xinyu Liu, Rohan Chandra, Shangtong Zhang

4. [Learning Visual Feature-Based World Models via Residual Latent Action](#paper-2605-07079)
**Authors:** Xinyu Zhang, Zhengtong Xu, Yutian Tao, Yeping Wang, Yu She, Abdeslam Boularias

5. [Finite-Time Analysis of MCTS in Continuous POMDP Planning](#paper-2605-07703)
**Authors:** Da Kong, Vadim Indelman

6. [On the Divergence of Differential Temporal Difference Learning without Local Clocks](#paper-2605-06874)
**Authors:** David Antrobius, Shangtong Zhang

7. [Drifting Field Policy: A One-Step Generative Policy via Wasserstein Gradient Flow](#paper-2605-07727)
...
### 1. [PolarAdamW: Disentangling Spectral Control and Schur Gauge-Equivariance in Matrix Optimisation](https://arxiv.org/abs/2605.07067) <a id="paper-2605-07067"></a>
...
### 4. [A Rod Flow Model for Adam at the Edge of Stability](https://arxiv.org/abs/2605.06821) <a id="paper-2605-06821"></a>
...
### 5. [Rethinking State Tracking in Recurrent Models Through Error Control Dynamics](https://arxiv.org/abs/2605.07755) <a id="paper-2605-07755"></a>
...
### 6. [Revisiting Transformer Layer Parameterization Through Causal Energy Minimization](https://arxiv.org/abs/2605.07588) <a id="paper-2605-07588"></a>
...
### 7. [Muon with Nesterov Momentum: Heavy-Tailed Noise and (Randomized) Inexact Polar Decomposition](https://arxiv.org/abs/2605.06884) <a id="paper-2605-06884"></a>
...
### 8. [Star Elastic: Many-in-One Reasoning LLMs with Efficient Budget Control](https://arxiv.org/abs/2605.07182) <a id="paper-2605-07182"></a>
...
### 9. [Self-Programmed Execution for Language-Model Agents](https://arxiv.org/abs/2605.06898) <a id="paper-2605-06898"></a>
...
### 10. [Fast Byte Latent Transformer](https://arxiv.org/abs/2605.08044) <a id="paper-2605-08044"></a>
...
### 11. [When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](https://arxiv.org/abs/2605.07969) <a id="paper-2605-07969"></a>
...
### 12. [Bifurcation Models: Learning Set-Valued Solution Maps with Weight-Tied Dynamics](https://arxiv.org/abs/2605.07277) <a id="paper-2605-07277"></a>
...
### 13. [Training-Induced Escape from Token Clustering in a Mean-Field Formulation of Transformers](https://arxiv.org/abs/2605.07772) <a id="paper-2605-07772"></a>
...
### 14. [Cross-Attention and Encoder-Decoder Transformers: A Logical Characterization](https://arxiv.org/abs/2605.07705) <a id="paper-2605-07705"></a>
...
### 15. [Randomness is sometimes necessary for coordination](https://arxiv.org/abs/2605.06825) <a id="paper-2605-06825"></a>
...
### 16. [A Theory of Online Learning with Autoregressive Chain-of-Thought Reasoning](https://arxiv.org/abs/2605.06819) <a id="paper-2605-06819"></a>
...
### 17. [Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training](https://arxiv.org/abs/2605.07063) <a id="paper-2605-07063"></a>
...
### 18. [Every Feedforward Neural Network Definable in an o-Minimal Structure Has Finite Sample Complexity](https://arxiv.org/abs/2605.07097) <a id="paper-2605-07097"></a>
...
### 19. [Why DDIM Hallucinates More than DDPM: A Theoretical Analysis of Reverse Dynamics](https://arxiv.org/abs/2605.06831) <a id="paper-2605-06831"></a>
...
### 20. [STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation](https://arxiv.org/abs/2605.08029) <a id="paper-2605-08029"></a>
...
### 21. [The Position Curse: LLMs Struggle to Locate the Last Few Items in a List](https://arxiv.org/abs/2605.07127) <a id="paper-2605-07127"></a>
...
### 22. [GazeVLM: Active Vision via Internal Attention Control for Multimodal Reasoning](https://arxiv.org/abs/2605.07817) <a id="paper-2605-07817"></a>
...
### 23. [Bilevel Graph Structure Learning, Revisited: Inner-Channel Origins of the Reported Gain](https://arxiv.org/abs/2605.07577) <a id="paper-2605-07577"></a>
...
### 24. [Normalizing Trajectory Models](https://arxiv.org/abs/2605.08078) <a id="paper-2605-08078"></a>
...
### 25. [Globally Optimal Training of Spiking Neural Networks via Parameter Reconstruction](https://arxiv.org/abs/2605.08022) <a id="paper-2605-08022"></a>
...
### 26. [The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](https://arxiv.org/abs/2605.07686) <a id="paper-2605-07686"></a>
...
### 27. [Same Signal, Opposite Meaning: Direction-Informed Adaptive Learning for LLM Agents](https://arxiv.org/abs/2605.06908) <a id="paper-2605-06908"></a>
...
### 28. [Learned Lagrangian Models of PDEs via Euler-Lagrange Residual Minimization](https://arxiv.org/abs/2605.07157) <a id="paper-2605-07157"></a>
...
### 1. [Beyond LoRA vs. Full Fine-Tuning: Gradient-Guided Optimizer Routing for LLM Adaptation](https://arxiv.org/abs/2605.07111) <a id="paper-2605-07111"></a>
...
### 3. [CSR: Infinite-Horizon Real-Time Policies with Massive Cached State Representations](https://arxiv.org/abs/2605.07325) <a id="paper-2605-07325"></a>
...
### 4. [An Efficient Hybrid Sparse Attention with CPU-GPU Parallelism for Long-Context Inference](https://arxiv.org/abs/2605.07719) <a id="paper-2605-07719"></a>
...
### 5. [Future Validity is the Missing Statistic: From Impossibility to $\Phi$-Estimation for Grammar-Faithful Speculative Decoding](https://arxiv.org/abs/2605.07698) <a id="paper-2605-07698"></a>
...
### 6. [Beyond Factor Aggregation: Gauge-Aware Low-Rank Server Representations for Federated LoRA](https://arxiv.org/abs/2605.06733) <a id="paper-2605-06733"></a>
...
### 7. [Direction-Preserving Number Representations](https://arxiv.org/abs/2605.07662) <a id="paper-2605-07662"></a>
...
### 8. [Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?](https://arxiv.org/abs/2605.07072) <a id="paper-2605-07072"></a>
...
### 9. [KL for a KL: On-Policy Distillation with Control Variate Baseline](https://arxiv.org/abs/2605.07865) <a id="paper-2605-07865"></a>
...
### 10. [Resource-Element Energy Difference for Noncoherent Over-the-Air Federated Learning](https://arxiv.org/abs/2605.07263) <a id="paper-2605-07263"></a>
...
## Representation Learning Theory and Structure (16) <a id="topic-representation-structure"></a>

### 1. [Pretraining Induces a Reusable Spectral Basis for Downstream Task Adaptation](https://arxiv.org/abs/2605.07302) <a id="paper-2605-07302"></a>
...
### 2. [Continuous First, Discrete Later: VQ-VAEs Without Dimensional Collapse](https://arxiv.org/abs/2605.06870) <a id="paper-2605-06870"></a>
...
### 3. [Tree SAE: Learning Hierarchical Feature Structures in Sparse Autoencoders](https://arxiv.org/abs/2605.07922) <a id="paper-2605-07922"></a>
...
### 4. [Does Your Neural Network Extrapolate? Feature Engineering as Identifiability Bias for OOD Generalization](https://arxiv.org/abs/2605.07483) <a id="paper-2605-07483"></a>
...
### 5. [Characterizing and Correcting Effective Target Shift in Online Learning](https://arxiv.org/abs/2605.07886) <a id="paper-2605-07886"></a>
...
### 6. [Structured Coupling for Flow Matching](https://arxiv.org/abs/2605.07676) <a id="paper-2605-07676"></a>
...
### 7. [Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning](https://arxiv.org/abs/2605.07980) <a id="paper-2605-07980"></a>
...
### 8. [Distributional simplicity bias and effective convexity in Energy Based Models](https://arxiv.org/abs/2605.07844) <a id="paper-2605-07844"></a>
...
### 9. [When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification](https://arxiv.org/abs/2605.07120) <a id="paper-2605-07120"></a>
...
### 10. [Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions](https://arxiv.org/abs/2605.07984) <a id="paper-2605-07984"></a>
...
### 11. [Tool Calling is Linearly Readable and Steerable in Language Models](https://arxiv.org/abs/2605.07990) <a id="paper-2605-07990"></a>
...
### 12. [Extracting Search Trees from LLM Reasoning Traces Reveals Myopic Planning](https://arxiv.org/abs/2605.06840) <a id="paper-2605-06840"></a>
...
### 13. [Learning Large-Scale Modular Addition with an Auxiliary Modulus](https://arxiv.org/abs/2605.07648) <a id="paper-2605-07648"></a>
...
### 14. [When Does a Language Model Commit? A Finite-Answer Theory of Pre-Verbalization Commitment](https://arxiv.org/abs/2605.06723) <a id="paper-2605-06723"></a>
...
### 15. [PLOT: Progressive Localization via Optimal Transport in Neural Causal Abstraction](https://arxiv.org/abs/2605.06979) <a id="paper-2605-06979"></a>
...
### 16. [Interpreting Reinforcement Learning Agents with Susceptibilities](https://arxiv.org/abs/2605.08007) <a id="paper-2605-08007"></a>
...
### 1. [CASCADE: Case-Based Continual Adaptation for Large Language Models During Deployment](https://arxiv.org/abs/2605.06702) <a id="paper-2605-06702"></a>
...
### 2. [MEMOREPAIR: Barrier-First Cascade Repair in Agentic Memory](https://arxiv.org/abs/2605.07242) <a id="paper-2605-07242"></a>
...
## World Models, Exploration, and Open-Ended Reinforcement Learning (7) <a id="topic-world-models-open-ended-rl"></a>

### 1. [AGWM: Affordance-Grounded World Models for Environments with Compositional Prerequisites](https://arxiv.org/abs/2605.06841) <a id="paper-2605-06841"></a>
...
### 2. [Predictive but Not Plannable: RC-aux for Latent World Models](https://arxiv.org/abs/2605.07278) <a id="paper-2605-07278"></a>
...
### 3. [Convergence and Emergence of In-Context Reinforcement Learning with Chain of Thought](https://arxiv.org/abs/2605.07123) <a id="paper-2605-07123"></a>
...
### 4. [Learning Visual Feature-Based World Models via Residual Latent Action](https://arxiv.org/abs/2605.07079) <a id="paper-2605-07079"></a>
...
### 5. [Finite-Time Analysis of MCTS in Continuous POMDP Planning](https://arxiv.org/abs/2605.07703) <a id="paper-2605-07703"></a>
...
### 6. [On the Divergence of Differential Temporal Difference Learning without Local Clocks](https://arxiv.org/abs/2605.06874) <a id="paper-2605-06874"></a>
...
### 7. [Drifting Field Policy: A One-Step Generative Policy via Wasserstein Gradient Flow](https://arxiv.org/abs/2605.07727) <a id="paper-2605-07727"></a>
