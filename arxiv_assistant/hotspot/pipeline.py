...
from arxiv_assistant.hotspot.sources.ainews import fetch_hotspot_items as fetch_ainews_items
from arxiv_assistant.hotspot.sources.analysis_feeds import fetch_hotspot_items as fetch_analysis_feed_items
from arxiv_assistant.hotspot.sources.github import fetch_hotspot_items as fetch_github_items
from arxiv_assistant.hotspot.sources.hf_papers import fetch_hotspot_items as fetch_hf_items
from arxiv_assistant.hotspot.sources.hn import fetch_hotspot_items as fetch_hn_items
from arxiv_assistant.hotspot.sources.local_papers import fetch_hotspot_items as fetch_local_paper_items
from arxiv_assistant.hotspot.sources.model_hubs import fetch_hotspot_items as fetch_model_hub_items
from arxiv_assistant.hotspot.sources.official_blogs import fetch_hotspot_items as fetch_official_blog_items
from arxiv_assistant.hotspot.sources.reddit import fetch_hotspot_items as fetch_reddit_items
from arxiv_assistant.hotspot.sources.roundups import fetch_hotspot_items as fetch_roundup_items
from arxiv_assistant.hotspot.sources.x_ainews import fetch_hotspot_items as fetch_x_ainews_items
from arxiv_assistant.hotspot.sources.twitterapi import fetch_hotspot_items as fetch_x_twitterapi_items
from arxiv_assistant.hotspot.sources.agent_scout import fetch_hotspot_items as fetch_agent_scout_items
from arxiv_assistant.hotspot.enrich import enrich_items_batch, enrich_items_heuristic
from arxiv_assistant.hotspot.dedup import classify_cross_day, cluster_intraday, match_crossday
from arxiv_assistant.hotspot.story import Story, apply_cross_day_penalty, group_into_stories, score_stories, select_and_categorize
from arxiv_assistant.renderers.hotspot.render_hot_daily import render_hot_daily_md
from arxiv_assistant.hotspot.support.config import build_hotspot_paths, ensure_parent_dirs
from arxiv_assistant.hotspot.support.schema import HotspotItem
from arxiv_assistant.hotspot.support.source_fetch import api_usage_scope, reset_api_usage, snapshot_api_usage
...
from arxiv_assistant.hotspot.date_verify import verify as date_verify
from arxiv_assistant.hotspot.store import _open_story_store
...
def kernel_run(*args, **kwargs):
    from arxiv_assistant.hotspot.kernel import run as _run
...
def _build_market_signal_items(
    ...
    *,
    ...
    from arxiv_assistant.hotspot.filter import _item_engineering_score, _item_substance_score, ARTIFACT_PATTERNS
...
def fetch_source_payloads(
    ...
    if use_subagent_routes:
        from arxiv_assistant.hotspot.support.source_routes import iter_subagent_sources
    ...
    if _subagent_browser_routes:
        ...
        from arxiv_assistant.hotspot.sources.browser_source_fetch import fetch_source_via_browser
