...
<table>
    ...
    <tbody>
        ...
        <tr><td><a href="#topic-architecture-training">Architecture and Training Dynamics</a></td><td align="center">41</td></tr>
...
1. [daVinci-LLM:Towards the Science of Pretraining](#paper-2603-27164)
...
## [Architecture and Training Dynamics](#topic-architecture-training) (41)

1. [Rethinking Language Model Scaling under Transferable Hypersphere Optimization](#paper-2603-28743)
**Authors:** Liliang Ren, Yang Liu, Yelong Shen, Weizhu Chen

2. [MuonEq: Balancing Before Orthogonalization with Lightweight Equilibration](#paper-2603-28254)
**Authors:** Da Chang, Qiankun Shi, Lvgang Zhang, Yu Li, Ruijie Zhang, Yao Lu, Yongxiang Liu, Ganzhao Yuan

3. [Categorical Perception in Large Language Model Hidden States: Structural Warping at Digit-Count Boundaries](#paper-2603-28258)
**Authors:** Jon-Paul Cacioli

4. [Preconditioned Attention: Enhancing Efficiency in Transformers](#paper-2603-27153)
**Authors:** Hemanth Saratchandran

5. [The Geometric Cost of Normalization: Affine Bounds on the Bayesian Complexity of Neural Networks](#paper-2603-27432)
**Authors:** Sungbae Chun

6. [Arithmetic OOD Failure Unfolds in Stages in Minimal GPTs](#paper-2603-26828)
**Authors:** Seine A. Shintani

7. [GeoBlock: Inferring Block Granularity from Dependency Geometry in Diffusion Language Models](#paper-2603-26675)
**Authors:** Lipeng Wan, Junjie Ma, Jianhui Gu, Zeyang Liu, Xuyang Lu, Xuguang Lan

8. [MolmoPoint: Better Pointing for VLMs with Grounding Tokens](#paper-2603-28069)
...
9. [Variational Neurons in Transformers for Language Modeling](#paper-2603-28219)
**Authors:** Yves Ruffenach

10. [LogicDiff: Logic-Guided Denoising Improves Reasoning in Masked Diffusion Language Models](#paper-2603-26771)
**Authors:** Shaik Aman

11. [The Geometry of Harmful Intent: Training-Free Anomaly Detection via Angular Deviation in LLM Residual Streams](#paper-2603-27412)
**Authors:** Isaac Llorente-Saguer

12. [Temporal Credit Is Free](#paper-2603-28750)
**Authors:** Aur Shalev Merin

13. [Squish and Release: Exposing Hidden Hallucinations by Making Them Surface as Safety Signals](#paper-2603-26829)
**Authors:** Nathaniel Oh, Paul Attie

14. [LACE: Loss-Adaptive Capacity Expansion for Continual Learning](#paper-2603-28611)
**Authors:** Shivnath Tathe

15. [Stop Probing, Start Coding: Why Linear Probes and Sparse Autoencoders Fail at Compositional Generalisation](#paper-2603-28744)
**Authors:** Vit\'oria Barin Pacela, Shruti Joshi, Isabela Camacho, Simon Lacoste-Julien, David Klindt

16. [Test-Time Instance-Specific Parameter Composition: A New Paradigm for Adaptive Generative Modeling](#paper-2603-27665)
**Authors:** Minh-Tuan Tran, Xuan-May Le, Quan Hung Tran, Mehrtash Harandi, Dinh Phung, Trung Le

17. [SARL: Label-Free Reinforcement Learning by Rewarding Reasoning Topology](#paper-2603-27977)
**Authors:** Yifan Wang, Bolian Li, David Cho, Ruqi Zhang, Fanping Sui, Ananth Grama

18. [ATLAS-RTC: Closing the Loop on LLM Agent Output with Token-Level Runtime Control](#paper-2603-27905)
**Authors:** Christopher Cruz

19. [High dimensional theory of two-phase optimizers](#paper-2603-26954)
**Authors:** Atish Agarwala

20. [ERPO: Token-Level Entropy-Regulated Policy Optimization for Large Reasoning Models](#paper-2603-28204)
**Authors:** Song Yu, Li Li

21. [Explaining, Verifying, and Aligning Semantic Hierarchies in Vision-Language Model Embeddings](#paper-2603-26798)
...
22. [Physics-Guided Transformer (PGT): Physics-Aware Attention Mechanism for PINNs](#paper-2603-27929)
**Authors:** Ehsan Zeraatkar, Rodion Podorozhny, Jelena Te\v{s}i\'c

23. [On the Loss Landscape Geometry of Regularized Deep Matrix Factorization: Uniqueness and Sharpness](#paper-2603-27072)
**Authors:** Anil Kamber, Rahul Parhi

24. [Next-Token Prediction and Regret Minimization](#paper-2603-28499)
**Authors:** Mehryar Mohri, Clayton Sanford, Jon Schneider, Kiran Vodrahalli, Yifan Wu

25. [Spectral Higher-Order Neural Networks](#paper-2603-28420)
**Authors:** Gianluca Peri, Timoteo Carletti, Duccio Fanelli, Diego Febbe

26. [Geometry-aware similarity metrics for neural representations on Riemannian and statistical manifolds](#paper-2603-28764)
**Authors:** N Alex Cayco Gajic, Arthur Pellegrino

27. [Attention Frequency Modulation: Training-Free Spectral Modulation of Diffusion Cross-Attention](#paper-2603-28114)
**Authors:** Seunghun Oh, Unsang Park

28. [Diffusion Maps is not Dimensionality Reduction](#paper-2603-28037)
**Authors:** Julio Candanedo, Alejandro Pati\~no

29. [Gaussian Joint Embeddings For Self-Supervised Representation Learning](#paper-2603-26799)
**Authors:** Yongchao Huang

30. [Interpretable Physics Extraction from Data for Linear Dynamical Systems using Lie Generator Networks](#paper-2603-27442)
**Authors:** Shafayeth Jamil, Rehan Kapadia

31. [Universal Approximation Constraints of Narrow ResNets: The Tunnel Effect](#paper-2603-28591)
**Authors:** Christian Kuehn, Sara-Viola Kuntz, Tobias W\"ohrer

32. [Can We Change the Stroke Size for Easier Diffusion?](#paper-2603-26783)
**Authors:** Yunwei Bai, Ying Kiat Tan, Yao Shu, Tsuhan Chen

33. [DSO: Dual-Scale Neural Operators for Stable Long-term Fluid Dynamics Forecasting](#paper-2603-26800)
**Authors:** Huanshuo Dong, Hao Wu, Hong Wang, Qin-Yi Zhang, Zhezheng Hao

34. [Lipschitz verification of neural networks through training](#paper-2603-28113)
**Authors:** Simon Kuang, Yuezhu Xu, S. Sivaranjani, Xinfan Lin

35. [On the Asymptotics of Self-Supervised Pre-training: Two-Stage M-Estimation and Representation Symmetry](#paper-2603-27631)
**Authors:** Mohammad Tinati, Stephen Tu

36. [Semantic Interaction Information mediates compositional generalization in latent space](#paper-2603-27134)
**Authors:** John Schwarcz

37. [Stepwise Credit Assignment for GRPO on Flow-Matching Models](#paper-2603-28718)
...
38. [The Price of Meaning: Why Every Semantic Memory System Forgets](#paper-2603-27116)
**Authors:** Sambartha Ray Barman, Andrey Starenky, Sofia Bodnar, Nikhil Narasimhan, Ashwin Gopinath

39. [Expectation Error Bounds for Transfer Learning in Linear Regression and Linear Neural Networks](#paper-2603-28739)
**Authors:** Meitong Liu, Christopher Jung, Rui Li, Xue Feng, Han Zhao

40. [A Tight Expressivity Hierarchy for GNN-Based Entity Resolution in Master Data Management](#paper-2603-27154)
**Authors:** Ashwin Ganesan

41. [Kernel Dynamics under Path Entropy Maximization](#paper-2603-27880)
**Authors:** Jnaneshwar Das

## [Training Algorithms That Change What Is Possible](#topic-training-systems) (7)

1. [OptINC: Optical In-Network-Computing for Scalable Distributed Learning](#paper-2603-28290)
**Authors:** Sijie Fei, Grace Li Zhang, Bing Li, Ulf Schlichtmann

2. [Robust Batch-Level Query Routing for Large Language Models under Cost and Capacity Constraints](#paper-2603-26796)
**Authors:** Jelena Markovic-Voronov, Kayhan Behdin, Yuanda Xu, Zhengze Zhou, Zhipeng Wang, Rahul Mazumder

3. [Heddle: A Distributed Orchestration System for Agentic RL Rollout](#paper-2603-28101)
**Authors:** Zili Zhang, Yinmin Zhong, Chengxu Yang, Chao Jin, Bingyang Wu, Xinming Wei, Yuliang Liu, Xin Jin

4. [A Step Toward Federated Pretraining of Multimodal Large Language Models](#paper-2603-26786)
**Authors:** Baochen Xiong, Yifan Xu, Xiaoshan Yang, Yaguang Song, Yaowei Wang, Changsheng Xu

5. [Taming the Instability: A Robust Second-Order Optimizer for Federated Learning over Non-IID Data](#paper-2603-28316)
**Authors:** Yuanqiao Zhang, Tiantian He, Yuan Gao, Yixin Wang, Yew-Soon Ong, Maoguo Gong, A. K. Qin, Hui Li

6. [Scalable Maximum Entropy Population Synthesis via Persistent Contrastive Divergence](#paper-2603-27312)
**Authors:** Mirko Degli Esposti

7. [Gradient Manipulation in Distributed Stochastic Gradient Descent with Strategic Agents: Truthful Incentives with Convergence Guarantees](#paper-2603-27962)
**Authors:** Ziqin Chen, Yongqiang Wang

## [MoE Where It Changes the Design Space](#topic-moe-training) (1)

1. [On Token's Dilemma: Dynamic MoE with Drift-Aware Token Assignment for Continual Learning of Large Vision Language Models](#paper-2603-27481)
...
1. [HISA: Efficient Hierarchical Indexing for Fine-Grained Sparse Attention](#paper-2603-28458)
...
2. [RSR-core: A High-Performance Engine for Low-Bit Matrix-Vector Multiplication](#paper-2603-27462)
**Authors:** Mohsen Dehghankar, Abolfazl Asudeh

3. [TurboAngle: Near-Lossless KV Cache Compression via Uniform Angle Quantization](#paper-2603-27467)
**Authors:** Dipkumar Patel

4. [Spectral Signatures of Data Quality: Eigenvalue Tail Index as a Diagnostic for Label Noise in Neural Networks](#paper-2603-27885)
**Authors:** Matthew Loftus

5. [AdaptToken: Entropy-based Adaptive Token Selection for MLLM Long Video Understanding](#paper-2603-28696)
**Authors:** Haozhe Qi, Kevin Qu, Mahdi Rad, Rui Wang, Alexander Mathis, Marc Pollefeys

6. [KVSculpt: KV Cache Compression as Distillation](#paper-2603-27819)
**Authors:** Bo Jiang, Sian Jin

7. [ScoutAttention: Efficient KV Cache Offloading via Layer-Ahead CPU Pre-computation for LLM Inference](#paper-2603-27138)
**Authors:** Qiuyang Zhang, Kai Zhou, Ding Tang, Kai Lu, Cheng Li, Zhenyu Yang, Peng Xu, Jiguang Wan

8. [Sparse-by-Design Cross-Modality Prediction: L0-Gated Representations for Reliable and Efficient Learning](#paper-2603-26801)
**Authors:** Filippo Cenacchi

9. [Expert Streaming: Accelerating Low-Batch MoE Inference via Multi-chiplet Architecture and Dynamic Expert Trajectory Scheduling](#paper-2603-27624)
...
10. [FEMBA on the Edge: Physiologically-Aware Pre-Training, Quantization, and Deployment of a Bidirectional Mamba EEG Foundation Model on an Ultra-low Power Microcontroller](#paper-2603-26716)
**Authors:** Anna Tegon, Nicholas Lehmann, Yawei Li, Andrea Cossettini, Luca Benini, Thorir Mar Ingolfsson

11. [ITQ3_S: High-Fidelity 3-bit LLM Inference via Interleaved Ternary Quantization with Rotation-Domain Smoothing](#paper-2603-27914)
**Authors:** Edward J. Yoon

12. [Beyond Dataset Distillation: Lossless Dataset Concentration via Diffusion-Assisted Distribution Alignment](#paper-2603-27987)
**Authors:** Tongfei Liu, Yufan Liu, Bing Li, Weiming Hu

13. [IsoQuant: Hardware-Aligned SO(4) Isoclinic Rotations for LLM KV Cache Compression](#paper-2603-28430)
**Authors:** Zhongping Ji

14. [EdgeDiT: Hardware-Aware Diffusion Transformers for Efficient On-Device Image Generation](#paper-2603-28405)
**Authors:** Sravanth Kodavanti, Manjunath Arveti, Sowmya Vajrala, Srinivas Miriyala, Vikram N R

15. [Unsupervised Behavioral Compression: Learning Low-Dimensional Policy Manifolds through State-Occupancy Matching](#paper-2603-27044)
**Authors:** Andrea Fraschini, Davide Tenedini, Riccardo Zamboni, Mirco Mutti, Marcello Restelli

16. [GSR-GNN: Training Acceleration and Memory-Saving Framework of Deep GNNs on Circuit Graph](#paper-2603-27156)
**Authors:** Yuebo Luo, Shiyang Li, Yifei Feng, Vishal Kancharla, Shaoyi Huang, Caiwen Ding

17. [RecycleLoRA: Rank-Revealing QR-Based Dual-LoRA Subspace Adaptation for Domain Generalized Semantic Segmentation](#paper-2603-28142)
**Authors:** Chanseul Cho, Seokju Yun, Jeaseong Jeon, Seungjae Moon, Youngmin Ro

18. [Steering Sparse Autoencoder Latents to Control Dynamic Head Pruning in Vision Transformers (Student Abstract)](#paper-2603-26743)
...
### 1. [daVinci-LLM:Towards the Science of Pretraining](https://arxiv.org/abs/2603.27164) <a id="paper-2603-27164"></a>
...
**Comment:** Uses 200+ controlled pretraining ablations to explain data-processing and curriculum choices for a 3B model trained across 8T tokens.

**Topic Match:** An open model report that explains training decisions through controlled studies of processing depth, domain saturation, and curriculum balance.
...
## Architecture and Training Dynamics (41) <a id="topic-architecture-training"></a>

### 1. [Rethinking Language Model Scaling under Transferable Hypersphere Optimization](https://arxiv.org/abs/2603.28743) <a id="paper-2603-28743"></a>

**ArXiv ID:** 2603.28743

**Primary Topic:** Architecture and Training Dynamics

**Also Matches:** Training Algorithms That Change What Is Possible, MoE Where It Changes the Design Space
...
**Comment:** HyperP transfers one base learning rate across width, depth, token budget, and MoE granularity under fixed-norm Muon optimization.

**Topic Match:** Scale-transferable parameterization is central, with additional contributions to run configuration, stability, and RMS-preserving MoE gating.
...
### 2. [MuonEq: Balancing Before Orthogonalization with Lightweight Equilibration](https://arxiv.org/abs/2603.28254) <a id="paper-2603-28254"></a>
...
**Comment:** Row-normalizing Muon's momentum before Newton-Schulz orthogonalization corrects marginal scale mismatch with O(m+n) auxiliary state.

**Topic Match:** An optimizer modification with a spectral mechanism and direct C4 pretraining comparisons against Muon at 130M and 350M parameters.
...
### 3. [Categorical Perception in Large Language Model Hidden States: Structural Warping at Digit-Count Boundaries](https://arxiv.org/abs/2603.28258) <a id="paper-2603-28258"></a>
...
**Comment:** Tests tokenization discontinuities as a source of categorical hidden-state geometry using boundary controls and dissociation from explicit category knowledge.

**Topic Match:** Connects input tokenization to representation formation across model families; direct tokenizer interventions supporting the causal claim are not reported.
...
### 4. [Preconditioned Attention: Enhancing Efficiency in Transformers](https://arxiv.org/abs/2603.27153) <a id="paper-2603-27153"></a>
...
**Comment:** A conditioning matrix inside each attention head targets ill-conditioning that obstructs optimization.

**Topic Match:** Directly changes attention to improve training dynamics. Evidence is limited by unspecified experimental settings and unaccounted overhead from added per-head matrices.
...
### 5. [The Geometric Cost of Normalization: Affine Bounds on the Bayesian Complexity of Neural Networks](https://arxiv.org/abs/2603.27432) <a id="paper-2603-27432"></a>
...
**Comment:** LayerNorm's centering reduces the next weight matrix's local learning coefficient by exactly m/2, while RMSNorm preserves it.

**Topic Match:** Directly explains a structural consequence of normalization choice through a falsifiable affine-versus-curved geometry criterion; full-model training consequences remain untested.
...
### 6. [Arithmetic OOD Failure Unfolds in Stages in Minimal GPTs](https://arxiv.org/abs/2603.26828) <a id="paper-2603-26828"></a>
...
**Comment:** Matched training-data interventions isolate learned layout, carry-semantics, and recomposition barriers in minimal GPTs.

**Topic Match:** The core is causal analysis of how trained computation is organized, with useful controls but evidence confined to small addition models.
...
### 7. [GeoBlock: Inferring Block Granularity from Dependency Geometry in Diffusion Language Models](https://arxiv.org/abs/2603.26675) <a id="paper-2603-26675"></a>
...
**Comment:** Attention-derived token dependencies determine which diffusion blocks can be refined in parallel.

**Topic Match:** Dependency-aware block refinement fits non-autoregressive generation, though its contribution is confined to decoding an already trained model.
...
### 8. [MolmoPoint: Better Pointing for VLMs with Grounding Tokens](https://arxiv.org/abs/2603.28069) <a id="paper-2603-28069"></a>
...
**Comment:** Hierarchical pointing tokens directly select visual regions at progressively finer spatial resolution.

**Topic Match:** The output representation is architectural, but its core contribution and validation are specific to visual grounding, pointing, and tracking.
...
### 9. [Variational Neurons in Transformers for Language Modeling](https://arxiv.org/abs/2603.28219) <a id="paper-2603-28219"></a>
...
**Comment:** Replaces deterministic feed-forward neurons with local variational units while retaining the Transformer backbone.

**Topic Match:** The modified feed-forward block directly concerns layer design, but variational uncertainty modeling is an explicitly excluded core subject.
...
### 10. [LogicDiff: Logic-Guided Denoising Improves Reasoning in Masked Diffusion Language Models](https://arxiv.org/abs/2603.26771) <a id="paper-2603-26771"></a>
...
**Comment:** Replaces confidence-based unmasking with logical-dependency ordering in a masked diffusion decoder.

**Topic Match:** Discrete-diffusion generation is relevant, but the core contribution is a reasoning-specific inference scheduler with an added classification head.
...
### 11. [The Geometry of Harmful Intent: Training-Free Anomaly Detection via Angular Deviation in LLM Residual Streams](https://arxiv.org/abs/2603.27412) <a id="paper-2603-27412"></a>
...
**Comment:** Tests whether harmful-intent geometry persists after removing the refusal direction from residual activations.

**Topic Match:** Residual-stream ablation is closest to architecture analysis; the principal contribution is a harmful-prompt detector.
...
### 12. [Temporal Credit Is Free](https://arxiv.org/abs/2603.28750) <a id="paper-2603-28750"></a>
...
**Comment:** Replaces recurrent Jacobian propagation with immediate derivatives for online adaptation.

**Topic Match:** Recurrent credit assignment is the nearest architecture topic, but the demonstrations concern neural data and streaming tasks, with no language-model training result.
...
### 13. [Squish and Release: Exposing Hidden Hallucinations by Making Them Surface as Safety Signals](https://arxiv.org/abs/2603.26829) <a id="paper-2603-26829"></a>
...
**Comment:** Uses activation interventions to separate a localized detector body from directions controlling false-premise detection.

**Topic Match:** Circuit interventions provide an architectural connection, but hallucination and safety detection remain the core subjects.
...
### 14. [LACE: Loss-Adaptive Capacity Expansion for Continual Learning](https://arxiv.org/abs/2603.28611) <a id="paper-2603-28611"></a>
...
**Comment:** Grows projection width online when sustained loss deviations indicate insufficient representational capacity.

**Topic Match:** Dynamic capacity is architectural, but GPT-2 is only probed; expanded-model language pretraining and final expansion costs are not established.
...
### 15. [Stop Probing, Start Coding: Why Linear Probes and Sparse Autoencoders Fail at Compositional Generalisation](https://arxiv.org/abs/2603.28744) <a id="paper-2603-28744"></a>
...
**Comment:** FISTA on learned dictionaries and an oracle dictionary isolate dictionary learning as the SAE failure source.

**Topic Match:** The controlled mechanism analysis concerns sparse-autoencoder dictionary learning, an interpretability-tool subject outside the language-model training feed.
...
### 16. [Test-Time Instance-Specific Parameter Composition: A New Paradigm for Adaptive Generative Modeling](https://arxiv.org/abs/2603.27665) <a id="paper-2603-27665"></a>
...
**Comment:** Generates input-conditioned weight adaptations once before a pretrained model's generation trajectory.

**Topic Match:** Dynamic parameterization is the closest architecture topic, but the result concerns test-time adaptation of unspecified generative models without a language-model training demonstration.
...
### 17. [SARL: Label-Free Reinforcement Learning by Rewarding Reasoning Topology](https://arxiv.org/abs/2603.27977) <a id="paper-2603-27977"></a>
...
**Comment:** Uses the small-world topology of reasoning-step graphs as a label-free reinforcement-learning reward.

**Topic Match:** Training-objective design is the nearest connection, but this is reasoning-oriented post-training rather than an architectural stability contribution.
...
### 18. [ATLAS-RTC: Closing the Loop on LLM Agent Output with Token-Level Runtime Control](https://arxiv.org/abs/2603.27905) <a id="paper-2603-27905"></a>
...
**Comment:** Token-level feedback uses masking, biasing, and rollback to enforce output contracts during generation.

**Topic Match:** Decoding control is the nearest architectural connection, but the mechanism is an external runtime intervention.
...
### 19. [High dimensional theory of two-phase optimizers](https://arxiv.org/abs/2603.26954) <a id="paper-2603-26954"></a>
...
**Comment:** Analyzes how local updates and nested momentum change noise generation and the effective Hessian spectrum.

**Topic Match:** Optimizer dynamics are the nearest topic, but the core contribution is stochastic-gradient analysis of linear regression, without a language-model training result.
...
### 20. [ERPO: Token-Level Entropy-Regulated Policy Optimization for Large Reasoning Models](https://arxiv.org/abs/2603.28204) <a id="paper-2603-28204"></a>
...
**Comment:** Changes GRPO credit assignment from sequence-wide advantages to entropy-sensitive token-level signals.

**Topic Match:** Optimization dynamics provide the nearest connection, but the contribution concerns reasoning post-training rather than architectural destabilization.
...
### 21. [Explaining, Verifying, and Aligning Semantic Hierarchies in Vision-Language Model Embeddings](https://arxiv.org/abs/2603.26798) <a id="paper-2603-26798"></a>
...
**Comment:** Ontology comparisons expose a trade-off between embedding hierarchy plausibility and zero-shot classification accuracy.

**Topic Match:** Representation organization is the nearest connection, but this is post-hoc semantic analysis of vision-language encoders.
...
### 22. [Physics-Guided Transformer (PGT): Physics-Aware Attention Mechanism for PINNs](https://arxiv.org/abs/2603.27929) <a id="paper-2603-27929"></a>
...
**Comment:** Builds diffusion and causality constraints into attention logits through a heat-kernel bias.

**Topic Match:** Attention design is the closest match, but the trained models reconstruct physical fields rather than predict text.
...
### 23. [On the Loss Landscape Geometry of Regularized Deep Matrix Factorization: Uniqueness and Sharpness](https://arxiv.org/abs/2603.27072) <a id="paper-2603-27072"></a>
...
**Comment:** Derives how weight decay constrains minimizer uniqueness and curvature in deep linear networks.

**Topic Match:** Regularization dynamics are the nearest topic, but the contribution stays within deep matrix-factorization theory without establishing consequences for language-model training.
...
### 24. [Next-Token Prediction and Regret Minimization](https://arxiv.org/abs/2603.28499) <a id="paper-2603-28499"></a>
...
**Comment:** Characterizes when adversarial regret can improve while preserving next-token prediction accuracy, with a sharp full-history versus bounded-context distinction.

**Topic Match:** Transformer realizability connects this to architecture theory, but the trained predictors concern opponent actions rather than text pretraining.
...
### 25. [Spectral Higher-Order Neural Networks](https://arxiv.org/abs/2603.28420) <a id="paper-2603-28420"></a>
...
**Comment:** Uses a spectral parameterization of higher-order neuron interactions to address stability and parameter growth.

**Topic Match:** Higher-order neuron coupling is architectural work, but the abstract establishes no language-model training setting.
...
### 26. [Geometry-aware similarity metrics for neural representations on Riemannian and statistical manifolds](https://arxiv.org/abs/2603.28764) <a id="paper-2603-28764"></a>
...
**Comment:** Compares intrinsic representation geometry using Riemannian metrics instead of extrinsic state-space similarity.

**Topic Match:** Representation analysis is the nearest topic; the contribution is a comparison framework without an established language-model training mechanism.
...
### 27. [Attention Frequency Modulation: Training-Free Spectral Modulation of Diffusion Cross-Attention](https://arxiv.org/abs/2603.28114) <a id="paper-2603-28114"></a>
...
**Comment:** Measures and intervenes on cross-attention's spatial frequency progression during diffusion denoising.

**Topic Match:** Attention dynamics provide the nearest architectural connection; the intervention controls image diffusion at inference time.
...
### 28. [Diffusion Maps is not Dimensionality Reduction](https://arxiv.org/abs/2603.28037) <a id="paper-2603-28037"></a>
...
**Comment:** Oracle chart reconstruction distinguishes useful spectral coordinates from direct recovery of an intrinsic low-dimensional chart.

**Topic Match:** Representation analysis is the nearest registry connection, but the study concerns manifold embeddings rather than language-model architecture or training.
...
### 29. [Gaussian Joint Embeddings For Self-Supervised Representation Learning](https://arxiv.org/abs/2603.26799) <a id="paper-2603-26799"></a>
...
**Comment:** Explicit joint latent densities replace deterministic prediction with closed-form conditional inference.

**Topic Match:** Representation-learning objectives are the closest fit, but the contribution concerns probabilistic alignment on synthetic and vision tasks.
...
### 30. [Interpretable Physics Extraction from Data for Linear Dynamical Systems using Lie Generator Networks](https://arxiv.org/abs/2603.27442) <a id="paper-2603-27442"></a>
...
**Comment:** Constrains the learned generator to skew-symmetric minus positive diagonal form, making stability and dissipation structural.

**Topic Match:** Architectural parameterization is the closest match; the models identify physical dynamical systems.
...
### 31. [Universal Approximation Constraints of Narrow ResNets: The Tunnel Effect](https://arxiv.org/abs/2603.28591) <a id="paper-2603-28591"></a>
...
**Comment:** Bounds how residual-to-skip strength controls approximation failures in narrow ResNets.

**Topic Match:** Residual architecture is the nearest topic, but the work concerns approximation theory and low-dimensional examples without a language-model connection.
...
### 32. [Can We Change the Stroke Size for Easier Diffusion?](https://arxiv.org/abs/2603.26783) <a id="paper-2603-26783"></a>
...
### 33. [DSO: Dual-Scale Neural Operators for Stable Long-term Fluid Dynamics Forecasting](https://arxiv.org/abs/2603.26800) <a id="paper-2603-26800"></a>
...
**Comment:** Separate local and global processing paths target distinct causes of unstable long-horizon predictions.

**Topic Match:** Architectural decomposition is the closest fit, but the subject is neural operators for fluid forecasting.
...
### 34. [Lipschitz verification of neural networks through training](https://arxiv.org/abs/2603.28113) <a id="paper-2603-28113"></a>
...
**Comment:** Trains networks so the product of layerwise Lipschitz bounds becomes tight enough for direct verification.

**Topic Match:** Architectural constraints are the closest fit, but the subject is robustness verification, with broad structural claims demonstrated on MNIST networks.
...
### 35. [On the Asymptotics of Self-Supervised Pre-training: Two-Stage M-Estimation and Representation Symmetry](https://arxiv.org/abs/2603.27631) <a id="paper-2603-27631"></a>
...
**Comment:** Uses representation symmetry to characterize how pretraining uncertainty propagates into downstream estimation.

**Topic Match:** Training theory is the closest fit, but the results concern statistical representation estimators rather than language-model architecture or optimization.
...
### 36. [Semantic Interaction Information mediates compositional generalization in latent space](https://arxiv.org/abs/2603.27134) <a id="paper-2603-27134"></a>
...
**Comment:** Separate inference and embedding modules address the circular dependence between identifying latent variables and learning their interactions.

**Topic Match:** Modular learning dynamics are the closest fit, but the models solve a gridworld meta-learning problem rather than language-model training.
...
### 37. [Stepwise Credit Assignment for GRPO on Flow-Matching Models](https://arxiv.org/abs/2603.28718) <a id="paper-2603-28718"></a>
...
**Comment:** Uses intermediate reward improvements to assign denoising-step credit in flow-model reinforcement learning.

**Topic Match:** Credit-assignment design is closest to training dynamics, but the target is image-generation policy optimization.
...
### 38. [The Price of Meaning: Why Every Semantic Memory System Forgets](https://arxiv.org/abs/2603.27116) <a id="paper-2603-27116"></a>
...
**Comment:** Derives interference and retention limits from the finite-dimensional geometry of semantic retrieval.

**Topic Match:** Representational capacity provides the nearest architectural connection, but semantic memory systems are the core subject.
...
### 39. [Expectation Error Bounds for Transfer Learning in Linear Regression and Linear Neural Networks](https://arxiv.org/abs/2603.28739) <a id="paper-2603-28739"></a>
...
**Comment:** Derives exact auxiliary-task error decompositions and principled task weights for linear transfer models.

**Topic Match:** Task weighting connects to training theory, but the demonstrated setting is linear regression and under-parameterized linear networks.
...
### 40. [A Tight Expressivity Hierarchy for GNN-Based Entity Resolution in Master Data Management](https://arxiv.org/abs/2603.27154) <a id="paper-2603-27154"></a>
...
**Comment:** Proves the minimal message-passing adaptations and depths required to compute specific entity-matching predicates.

**Topic Match:** Minimal sufficient architecture is the closest topic; the results concern database entity-resolution GNNs.
...
### 41. [Kernel Dynamics under Path Entropy Maximization](https://arxiv.org/abs/2603.27880) <a id="paper-2603-27880"></a>
...
**Comment:** Treats the representation kernel as a dynamical variable whose evolution changes the optimization geometry.

**Topic Match:** Evolving kernels connect to training-dynamics theory, but the variational framework supplies no language-model training demonstration.
...
### 1. [OptINC: Optical In-Network-Computing for Scalable Distributed Learning](https://arxiv.org/abs/2603.28290) <a id="paper-2603-28290"></a>
...
**Comment:** Moves gradient averaging and quantization into optical interconnects during distributed training.

**Topic Match:** Distributed aggregation is closest to training systems; the contribution reduces communication overhead without establishing a new optimization invariant.
...
### 2. [Robust Batch-Level Query Routing for Large Language Models under Cost and Capacity Constraints](https://arxiv.org/abs/2603.26796) <a id="paper-2603-26796"></a>
...
**Comment:** Batch-level model assignment enforces joint cost and capacity limits under uncertain quality estimates.

**Topic Match:** Closest to systems, but the contribution concerns inference allocation rather than distributed training.
...
### 3. [Heddle: A Distributed Orchestration System for Agentic RL Rollout](https://arxiv.org/abs/2603.28101) <a id="paper-2603-28101"></a>
...
**Comment:** Uses trajectory-aware scheduling and resource allocation to reduce long-tail delays in agentic RL rollouts.

**Topic Match:** Rollout orchestration is training infrastructure, but its contribution is throughput rather than a new training algorithm.
...
### 4. [A Step Toward Federated Pretraining of Multimodal Large Language Models](https://arxiv.org/abs/2603.26786) <a id="paper-2603-26786"></a>
...
**Comment:** Canonical-space aggregation reduces interference between independently trained cross-modal projectors.

**Topic Match:** Federated optimization is the closest topic, but only the alignment projector is trained while the language model and vision encoder remain frozen.
...
### 5. [Taming the Instability: A Robust Second-Order Optimizer for Federated Learning over Non-IID Data](https://arxiv.org/abs/2603.28316) <a id="paper-2603-28316"></a>
...
**Comment:** Preserves local curvature during federated aggregation while detecting unstable gradients and resetting optimizer state.

**Topic Match:** Federated optimizer stability is closest to distributed training algorithms, but language-model training is not established.
...
### 6. [Scalable Maximum Entropy Population Synthesis via Persistent Contrastive Divergence](https://arxiv.org/abs/2603.27312) <a id="paper-2603-27312"></a>
...
**Comment:** Persistent contrastive divergence replaces exponential exact expectations with stochastic Gibbs estimates.

**Topic Match:** The algorithm changes feasible fitting scale, but it trains census population models rather than language models.
...
### 7. [Gradient Manipulation in Distributed Stochastic Gradient Descent with Strategic Agents: Truthful Incentives with Convergence Guarantees](https://arxiv.org/abs/2603.27962) <a id="paper-2603-27962"></a>
...
**Comment:** Introduces distributed incentives that jointly guarantee truthful gradient reporting and accurate convergence.

**Topic Match:** The incentive and convergence guarantees concern distributed optimization, but no language-model training setting is identified.
...
### 1. [On Token's Dilemma: Dynamic MoE with Drift-Aware Token Assignment for Continual Learning of Large Vision Language Models](https://arxiv.org/abs/2603.27481) <a id="paper-2603-27481"></a>
...
**Comment:** Drift-aware token assignment prevents newly added experts from attracting tokens served by established experts.

**Topic Match:** Router stability during expert expansion is the core contribution and qualifies despite the continual-tuning setting; evidence lacks named evaluation settings and expert-growth cost accounting.
...
### 1. [HISA: Efficient Hierarchical Indexing for Fine-Grained Sparse Attention](https://arxiv.org/abs/2603.28458) <a id="paper-2603-28458"></a>
...
**Comment:** A hierarchical block-to-token indexer reduces sparse-attention search while closely preserving token selections.

**Topic Match:** The contribution accelerates an existing model's long-context indexer without retraining, placing it in excluded inference-efficiency work.
...
### 2. [RSR-core: A High-Performance Engine for Low-Bit Matrix-Vector Multiplication](https://arxiv.org/abs/2603.27462) <a id="paper-2603-27462"></a>
...
**Comment:** Implements redundant-segment reduction as CPU and CUDA kernels for binary and ternary matrix-vector products.

**Topic Match:** Low-bit computation connects to efficiency, but the contribution implements an existing algorithm for faster inference.
...
### 3. [TurboAngle: Near-Lossless KV Cache Compression via Uniform Angle Quantization](https://arxiv.org/abs/2603.27467) <a id="paper-2603-27467"></a>
...
**Comment:** Angular quantization with per-layer precision allocation reduces KV-cache storage across seven language models.

**Topic Match:** The core is post-training cache quantization with model-specific precision tuning; reported quality preservation does not establish a new training capability.
...
### 4. [Spectral Signatures of Data Quality: Eigenvalue Tail Index as a Diagnostic for Label Noise in Neural Networks](https://arxiv.org/abs/2603.27885) <a id="paper-2603-27885"></a>
...
**Comment:** Separates label-noise effects from hyperparameter effects on weight-spectrum diagnostics through controlled positive and negative results.

**Topic Match:** Attributing model properties to training-data quality is the nearest fit; the experiments concern image classifiers.
...
### 5. [AdaptToken: Entropy-based Adaptive Token Selection for MLLM Long Video Understanding](https://arxiv.org/abs/2603.28696) <a id="paper-2603-28696"></a>
...
**Comment:** Response entropy allocates a global visual-token budget and supplies an early-stopping signal.

**Topic Match:** Token reduction is closest to efficiency, but the core contribution is training-free long-video inference.
...
### 6. [KVSculpt: KV Cache Compression as Distillation](https://arxiv.org/abs/2603.27819) <a id="paper-2603-27819"></a>
...
**Comment:** Optimizes a smaller unconstrained set of keys and values to preserve each layer's attention behavior.

**Topic Match:** The mechanism is cache compression for inference, requiring an additional optimization procedure and demonstrated on one model with 2048-token contexts.
...
### 7. [ScoutAttention: Efficient KV Cache Offloading via Layer-Ahead CPU Pre-computation for LLM Inference](https://arxiv.org/abs/2603.27138) <a id="paper-2603-27138"></a>
...
**Comment:** Layer-ahead CPU attention precomputation reduces stalls when KV caches are offloaded.

**Topic Match:** The contribution is inference offloading and computation overlap, which the feed explicitly excludes.
...
### 8. [Sparse-by-Design Cross-Modality Prediction: L0-Gated Representations for Reliable and Efficient Learning](https://arxiv.org/abs/2603.26801) <a id="paper-2603-26801"></a>
...
**Comment:** Hard-concrete feature gates impose L0 sparsity on classifier-facing representations across modalities.

**Topic Match:** Representation sparsity is the closest topic, but this applies an existing gating primitive to graph, tabular, and text classification rather than language-model training.
...
### 9. [Expert Streaming: Accelerating Low-Batch MoE Inference via Multi-chiplet Architecture and Dynamic Expert Trajectory Scheduling](https://arxiv.org/abs/2603.27624) <a id="paper-2603-27624"></a>
...
**Comment:** Fully sharded expert streams balance chiplet memory and computation during low-batch MoE inference.

**Topic Match:** This is hardware execution and scheduling for MoE inference, explicitly excluded despite its sharding terminology and memory savings.
...
### 10. [FEMBA on the Edge: Physiologically-Aware Pre-Training, Quantization, and Deployment of a Bidirectional Mamba EEG Foundation Model on an Ultra-low Power Microcontroller](https://arxiv.org/abs/2603.26716) <a id="paper-2603-26716"></a>
...
**Comment:** Quantization-aware training stabilizes 2-bit state-space weights against activation outliers.

**Topic Match:** Low-bit compression is the nearest topic, but the trained model processes EEG for wearable deployment.
...
### 11. [ITQ3_S: High-Fidelity 3-bit LLM Inference via Interleaved Ternary Quantization with Rotation-Domain Smoothing](https://arxiv.org/abs/2603.27914) <a id="paper-2603-27914"></a>
...
**Comment:** Combines Hadamard-domain outlier smoothing with ternary coding under a three-bit weight budget.

**Topic Match:** Weight compression is the closest topic, but this is post-training inference quantization; named model evaluations and quantified quality tradeoffs are absent.
...
### 12. [Beyond Dataset Distillation: Lossless Dataset Concentration via Diffusion-Assisted Distribution Alignment](https://arxiv.org/abs/2603.27987) <a id="paper-2603-27987"></a>
...
**Comment:** Uses diffusion-assisted distribution alignment to concentrate training data, claiming lossless task performance in higher-data regimes.

**Topic Match:** Training-data compression is closest to efficiency; the target is visual recognition rather than language-model pretraining.
...
### 13. [IsoQuant: Hardware-Aligned SO(4) Isoclinic Rotations for LLM KV Cache Compression](https://arxiv.org/abs/2603.28430) <a id="paper-2603-28430"></a>
...
**Comment:** Four-dimensional quaternion rotations reduce decorrelation cost for low-bit vector quantization.

**Topic Match:** The contribution is quantization-kernel engineering. Evidence includes credit for explicitly limiting validation to synthetic vectors and deferring end-to-end cache evaluation.
...
### 14. [EdgeDiT: Hardware-Aware Diffusion Transformers for Efficient On-Device Image Generation](https://arxiv.org/abs/2603.28405) <a id="paper-2603-28405"></a>
...
**Comment:** Hardware-aware structural pruning reduces diffusion-transformer memory and computation on mobile NPUs.

**Topic Match:** Structural compression is the nearest topic, but this is deployment engineering for image generators.
...
### 15. [Unsupervised Behavioral Compression: Learning Low-Dimensional Policy Manifolds through State-Occupancy Matching](https://arxiv.org/abs/2603.27044) <a id="paper-2603-27044"></a>
...
**Comment:** Compresses policy parameters by matching long-horizon state occupancy instead of immediate actions.

**Topic Match:** Low-dimensional parameter compression is the closest fit; the target is continuous-control RL policies rather than language models.
...
### 16. [GSR-GNN: Training Acceleration and Memory-Saving Framework of Deep GNNs on Circuit Graph](https://arxiv.org/abs/2603.27156) <a id="paper-2603-27156"></a>
...
**Comment:** Reversible residual modules and sparse representations enable substantially deeper GNN training within memory limits.

**Topic Match:** Training-memory reduction is the nearest topic, but the models and applications are circuit GNNs rather than language models.
...
### 17. [RecycleLoRA: Rank-Revealing QR-Based Dual-LoRA Subspace Adaptation for Domain Generalized Semantic Segmentation](https://arxiv.org/abs/2603.28142) <a id="paper-2603-28142"></a>
...
**Comment:** Rank-revealing QR assigns major and minor pretrained subspaces to separate low-rank adapters.

**Topic Match:** Low-rank parameterization is the nearest connection, but the core subject is parameter-efficient adaptation for semantic segmentation.
...
### 18. [Steering Sparse Autoencoder Latents to Control Dynamic Head Pruning in Vision Transformers (Student Abstract)](https://arxiv.org/abs/2603.26743) <a id="paper-2603-26743"></a>
...
**Comment:** Sparse-latent steering selects class-specific attention-head subsets while reducing head usage.

**Topic Match:** Attention-head pruning is closest to efficiency, but the contribution targets vision classifiers and SAE-based interpretability.
