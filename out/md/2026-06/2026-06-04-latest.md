...
2. [A Geometric Characterization of the Stationary Plateau for Two-Layer Neural Networks](#paper-2606-04327)
**Authors:** Tian Ding, Dawei Li, Ruoyu Sun

3. [Pseudospectral Bounds for Transient Amplification in Coupled Gradient Descent](#paper-2606-04031)
**Authors:** Ahanaf Hasan Ariq

4. [Adaptive Patching Is Harder Than It Looks For Time-Series Forecasting](#paper-2606-04074)
**Authors:** Federico Zucchi, Yi Xie, Chao Zhang, Keyuan Luo, Thomas Lampert, Ziyue Li

5. [Flatness and Generalization: Learning Multi-Index Models with Homogeneous Neural Networks](#paper-2606-04429)
**Authors:** Harsh Vardhan, Hossein Taheri, Arya Mazumdar

6. [Beyond Structural Symmetries: Linear Mode Connectivity via Neuron Identifiability](#paper-2606-04754)
...
2. [AlphaQ: Calibration-Free Bit Allocation for Mixture-of-Experts Quantization](#paper-2606-04980)
**Authors:** Wanqi Yang, Yuexiao Ma, Alexander Conzelmann, Xiawu Zheng, Michael W. Mahoney, T. Konstantin Rusch, Shiwei Liu

3. [LazyAttention: Efficient Retrieval-Augmented Generation with Deferred Positional Encoding](#paper-2606-04302)
**Authors:** Haocheng Xia, Mihir Pamnani, Hanxi Fang, Supawit Chockchowwat, Yongjoo Park

4. [Near-Optimal Decentralized Stochastic Convex Optimization over Networks](#paper-2606-04757)
**Authors:** Nitai Kluger, Amit Attia, Tomer Koren

## [Representation Learning Theory and Structure](#topic-representation-structure) (1)

1. [Bayes-Sufficient Representations in Supervised Learning](#paper-2606-04045)
**Authors:** Vasileios Sevetlidis

## [Memory Structures and Agent Memory Systems](#topic-memory-systems) (2)

1. [SaliMory: Orchestrating Cognitive Memory for Conversational Agents](#paper-2606-04120)
...
2. [Cartridges at Scale: Training Modular KV Caches over Large Document Collections](#paper-2606-04557)
...
1. [What Type of Inference is Active Inference?](#paper-2606-04935)
**Authors:** Wouter W. L. Nuijten, Mykola Lukashchuk, Thijs van de Laar, Bert de Vries

2. [From Ticks to Flows: Dynamics of Neural Reinforcement Learning in Continuous Environments](#paper-2606-04275)
**Authors:** Saket Tiwari, Tejas Kotwal, George Konidaris

3. [A Goal-Set Characterization of Task Composition in the Boolean Task Algebra](#paper-2606-04053)
...
### 2. [A Geometric Characterization of the Stationary Plateau for Two-Layer Neural Networks](https://arxiv.org/abs/2606.04327) <a id="paper-2606-04327"></a>
...
### 3. [Pseudospectral Bounds for Transient Amplification in Coupled Gradient Descent](https://arxiv.org/abs/2606.04031) <a id="paper-2606-04031"></a>
...
### 4. [Adaptive Patching Is Harder Than It Looks For Time-Series Forecasting](https://arxiv.org/abs/2606.04074) <a id="paper-2606-04074"></a>
...
### 5. [Flatness and Generalization: Learning Multi-Index Models with Homogeneous Neural Networks](https://arxiv.org/abs/2606.04429) <a id="paper-2606-04429"></a>
...
### 6. [Beyond Structural Symmetries: Linear Mode Connectivity via Neuron Identifiability](https://arxiv.org/abs/2606.04754) <a id="paper-2606-04754"></a>
...
### 2. [AlphaQ: Calibration-Free Bit Allocation for Mixture-of-Experts Quantization](https://arxiv.org/abs/2606.04980) <a id="paper-2606-04980"></a>
...
### 3. [LazyAttention: Efficient Retrieval-Augmented Generation with Deferred Positional Encoding](https://arxiv.org/abs/2606.04302) <a id="paper-2606-04302"></a>
...
### 4. [Near-Optimal Decentralized Stochastic Convex Optimization over Networks](https://arxiv.org/abs/2606.04757) <a id="paper-2606-04757"></a>
...
### 1. [Bayes-Sufficient Representations in Supervised Learning](https://arxiv.org/abs/2606.04045) <a id="paper-2606-04045"></a>
...
### 1. [SaliMory: Orchestrating Cognitive Memory for Conversational Agents](https://arxiv.org/abs/2606.04120) <a id="paper-2606-04120"></a>
...
### 2. [Cartridges at Scale: Training Modular KV Caches over Large Document Collections](https://arxiv.org/abs/2606.04557) <a id="paper-2606-04557"></a>
...
### 1. [What Type of Inference is Active Inference?](https://arxiv.org/abs/2606.04935) <a id="paper-2606-04935"></a>
...
### 2. [From Ticks to Flows: Dynamics of Neural Reinforcement Learning in Continuous Environments](https://arxiv.org/abs/2606.04275) <a id="paper-2606-04275"></a>
...
### 3. [A Goal-Set Characterization of Task Composition in the Boolean Task Algebra](https://arxiv.org/abs/2606.04053) <a id="paper-2606-04053"></a>
